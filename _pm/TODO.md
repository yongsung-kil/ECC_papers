...
> Claude 마지막 확인: 2026-08-12 18:17:53
...
- [x] 상세 모달에 분석 MD 전문 표시 (2026-08-12): 클릭 시 raw.githubusercontent에서 해당 md fetch → 자체 렌더러로 JSON 블록까지 전부 표시. "분석 MD ↗" 링크는 제거(실패 시 폴백 링크로만), 전 코퍼스 6,214편 렌더 검증 + 헤드리스 브라우저 확인

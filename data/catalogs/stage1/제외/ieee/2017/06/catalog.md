...
- **Status**: ❌
- **Reason**: 임펄스 잡음/Rayleigh 채널 LDPC 성능 분석(density evolution)뿐, 새 디코더·구성·HW 기여 없음 무선응용 특이적
- **ID**: ieee:7879830
- **Type**: journal
- **Published**: June 2017
- **Authors**: Zhen Mei, Martin Johnston, Stéphane Le Goff +1
- **PDF**: https://ieeexplore.ieee.org/document/7879830
...
- **Status**: ❌
- **Reason**: 연접 RS/LDPC WER 반해석적 성능평가, 표준 LDPC 사용 성능분석일 뿐 신규 디코더/구성 없음
- **ID**: ieee:7865919
- **Type**: journal
- **Published**: June 2017
- **Authors**: Adriaan Suls, Julie Neckebroek, Yannick Lefevre +2
- **PDF**: https://ieeexplore.ieee.org/document/7865919
...
- **Status**: ❌
- **Reason**: polar SCL용 CRC 설계, 부호 비의존적 BP 이식 기법 아님, 원칙 제외
- **ID**: ieee:7862172
- **Type**: journal
- **Published**: June 2017
- **Authors**: Qingshuang Zhang, Aijun Liu, Xiaofei Pan +1
- **PDF**: https://ieeexplore.ieee.org/document/7862172
...
- **Status**: ❌
- **Reason**: 분산스토리지 LRC availability 멤버십행렬 설계, LDPC ECC 디코더/구성 아님
- **ID**: ieee:7879256
- **Type**: journal
- **Published**: June 2017
- **Authors**: Yi-Sheng Su
- **PDF**: https://ieeexplore.ieee.org/document/7879256
...
- **Status**: ❌
- **Reason**: 산업용 무선 제어 네트워크 설계, LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:7589996
- **Type**: journal
- **Published**: June 2017
- **Authors**: Michele Luvisotto, Zhibo Pang, Dacfey Dzung
- **PDF**: https://ieeexplore.ieee.org/document/7589996
...
- **Status**: ❌
- **Reason**: 불신뢰 게이트로 선형변환 계산하는 ENCODED 기법 — LDPC ECC 부호설계/디코더/HW 이식 기법 아님
- **ID**: ieee:7894180
- **Type**: journal
- **Published**: June 2017
- **Authors**: Yaoqing Yang, Pulkit Grover, Soummya Kar
- **PDF**: https://ieeexplore.ieee.org/document/7894180
...
- **Status**: ❌
- **Reason**: dirty paper coding(전송측 간섭 사전제거) 채널코딩 기법, 바이너리 LDPC BP 이식 기법 없음
- **ID**: ieee:7864394
- **Type**: journal
- **Published**: June 2017
- **Authors**: Taehyun Kim, Kyunghoon Kwon, Jun Heo
- **PDF**: https://ieeexplore.ieee.org/document/7864394
...
- **Status**: ❌
- **Reason**: compressive sensing/coding theory용 low-coherence frame 구성 — LDPC 부호설계·디코더·HW 이식 기법 없음
- **ID**: ieee:7885104
- **Type**: journal
- **Published**: June 2017
- **Authors**: Matthew Thill, Babak Hassibi
- **PDF**: https://ieeexplore.ieee.org/document/7885104
...
- **Status**: ❌
- **Reason**: OFDM-MFSK 비코히어런트 MIMO 무선 검출기, LDPC는 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:7913689
- **Type**: journal
- **Published**: June 2017
- **Authors**: Evgeny Tsimbalo, Robert J. Piechocki, Andrew Nix +1
- **PDF**: https://ieeexplore.ieee.org/document/7913689
- **Abstract**: We propose a non-coherent transmission system based on orthogonal frequency division multiplexing (OFDM) for use in low-power applications. The proposed system uses M-ary frequency shift keying (MFSK) and employs two transmitting and two receiving antennas, with encoding performed across the space, frequency and time domains. For the resulting scheme, we develop a novel optimal non-coherent detector that produces soft bit information for a state-of-the-art error correction decoder. The proposed solution eliminates the need for channel knowledge and enables a simple receiver structure. Simulation results demonstrate up to 8 dB of coding gain for the proposed scheme compared to single-antenna OFDM-MFSK. When compared with coherent systems based on OFDM and binary phase shift keying, the designed scheme offers a receiver sensitivity gain of 9 dB and beyond.

## Enhanced Successive Cancellation List Decoding of Polar Codes

- **Status**: ❌
- **Reason**: polar SCL 비정렬 선택기 HW, polar 경로메트릭 전용이라 LDPC BP 이식 불가
- **ID**: ieee:7867834
- **Type**: journal
- **Published**: June 2017
- **Authors**: Sha Shi, Bing Han, Jing-Liang Gao +1
- **PDF**: https://ieeexplore.ieee.org/document/7867834
- **Abstract**: Polar codes can be efficiently decoded by the successive cancellation list (SCL) algorithm in which the sorter plays an important role. The sorter, however, is time-consuming. We significantly improve this decoding scheme by developing a new non-sorting direct selection method for the SCL algorithm. In the non-sorting strategy, we design a new selector for choosing the L best surviving paths, which is achieved by exploiting the bitwise comparison of the candidate path metrics. The analysis and simulation results show that, for M-bit length path metrics, our direct selection method with time complexity O(ML) is superior to the latest simplified bubble sorter and the quick sorting strategy whose time complexity is O(ML2) and O(ML log L), respectively. In the scenario of short codeword length and large list size, our selector can remarkably reduce the latency and the hardware resource consumption while not assuming that the metrics in the decoding are sorted.
...
- **Status**: ❌
- **Reason**: ATSC 3.0 LDM 채널추정/분리 알고리즘 — LDPC ECC와 무관, 떼어낼 기법 없음
- **ID**: ieee:7986164
- **Type**: conference
- **Published**: 7-9 June 2
- **Authors**: Liang Zhang, Wei Li, Yiyan Wu +12
- **PDF**: https://ieeexplore.ieee.org/document/7986164
...
- **Status**: ❌
- **Reason**: ATSC 3.0 MIMO 파일럿/채널추정 성능평가 — LDPC ECC와 무관, 떼어낼 기법 없음
- **ID**: ieee:7986237
- **Type**: conference
- **Published**: 7-9 June 2
- **Authors**: Takuya Shitomi, Eduardo Garro, Kenichi Murayama +1
- **PDF**: https://ieeexplore.ieee.org/document/7986237
...
- **Status**: ❌
- **Reason**: LDM/ISDB-T 방송 시스템 구현, LDPC는 표준 요소 부수 언급, 새 기법 없음
- **ID**: ieee:7986130
- **Type**: conference
- **Published**: 7-9 June 2
- **Authors**: Ricardo Seriacopi Rabaça, Cristiano Akamine, George Henrique Maranhão Garcia de Oliveira +1
- **PDF**: https://ieeexplore.ieee.org/document/7986130
...
## Exact BER calculation of TCM-MAPSK using product trellis algorithm for DVB applications

- **Status**: ❌
- **Reason**: TCM-MAPSK BER 정확 계산(DVB) — LDPC는 부수 언급, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7986135
- **Type**: conference
- **Published**: 7-9 June 2
- **Authors**: Junghwan Kim, Philip Iyamabo
- **PDF**: https://ieeexplore.ieee.org/document/7986135
...
- **Status**: ❌
- **Reason**: NOMA 희소 확산수열 설계 및 MPA 다중사용자 검출로 채널 ECC 아님, 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:8108689
- **Type**: conference
- **Published**: 4-7 June 2
- **Authors**: Ting Qi, Wei Feng, Youzheng Wang
- **PDF**: https://ieeexplore.ieee.org/document/8108689
...
- **Status**: ❌
- **Reason**: 생체신호 열화 검출에 ECC 원리 차용(MRF) — 실제 LDPC 부호/디코더 아님
- **ID**: ieee:7961852
- **Type**: conference
- **Published**: 30 May-3 J
- **Authors**: João Neves, Hugo Proença
- **PDF**: https://ieeexplore.ieee.org/document/7961852
...
## Design of synchronous structure of receiver at very low SNR

- **Status**: ❌
- **Reason**: 저SNR 위성 수신기 동기화 구조 설계 — 통신 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:8298641
- **Type**: conference
- **Published**: 3-5 June 2
- **Authors**: Yang Jie, Guangxia Li, Hongpeng Zhu +1
- **PDF**: https://ieeexplore.ieee.org/document/8298641
- **Abstract**: Communication at very low signal-to-noise ratios(SNR) is of great importance for power limited satellite applications. Making use of the information between the encoded data, the iterative decoding algorithm makes decoding and synchronization together possible at very low SNR. Existing literatures mainly focus on the estimation of single parameter. However, parameters affect each other in practical systems, it is important to rationally design the order in which the parameters are estimated. This paper analyzes the estimation requirements of parameters, proposes a complete receiver structure with short frame header, selects a predictive algorithm to reduce the timing and frequency offset to a narrow range, and then improves the computational complexity of the iterative decoding algorithm. The simulation results show that the proposed scheme has good synchronization performance, high transmission efficiency and can tolerate large parameter deviations at very low SNR mode.

## A new error correction scheme based on concatenation of self-orthogonal codes and accumulate codes

- **Status**: ❌
- **Reason**: self-orthogonal code+accumulate 연접, MTD 디코딩 — 비-LDPC 부호이며 BP 이식 기법 없음
- **ID**: ieee:7998434
- **Type**: conference
- **Published**: 29-30 June
- **Authors**: G. V. Ovechkin, D. S. Demidov, D. Zh. Satybaldina +1
- **PDF**: https://ieeexplore.ieee.org/document/7998434
- **Abstract**: Multithreshold decoders (MTD) for the self-orthogonal codes (SOC) are considered. It is shown that applying of MTD for the well chosen codes provides almost optimum decoding. Noted that MTD using is difficult to provide a low decoding error probability at the a large noise level due to a small code distance of SOC. For reducing the error probability we propose a concatenated coding scheme formed by SOC and a nonredundant accumulate code. Simulation results show that these concatenated codes allow decrease BER decoding on four decimal orders at the almost optimum decoding area of the used SOC.

## Robust directional-diffusive hybrid molecular communication with parity-check erasure coding

- **Status**: ❌
- **Reason**: 분자통신 parity-check erasure coding — erasure FEC, 떼어낼 바이너리 LDPC 기법 없음
- **ID**: ieee:8023282
- **Type**: conference
- **Published**: 27-30 June
- **Authors**: Hiroaki Egashira, Junichi Suzuki, Jonathan S. Mitzman +2
- **PDF**: https://ieeexplore.ieee.org/document/8023282
- **Abstract**: This paper investigates a robustness enhancement protocols for biologically-enabled machines (or bio-nanomachines) to reliably exchange information by means of molecules in the aqueous, intrabody environment. The proposed protocol performs forward error correction (FEC) for directional-diffusive hybrid transports, in which molecules travel through two different transports: directional and diffusive transports. It allows the transmitter bio-nanomachine to encode molecules in a redundant manner with parity-check erasure codes. The receiver bio-nanomachine can recover the information embedded in lost molecules. Simulation results show that the proposed protocol enhances robustness against molecule losses and in turn improves communication performance. They also reveal the impacts of FEC overhead and molecule redundancy on the communication performance.

## Graph-based Joint Source Channel LDPC decoding for cooperative communication with error-corrupted relay observations

- **Status**: ❌
- **Reason**: JSC-LDPC 협력통신 디코딩 — 소스채널결합, 응용 특이적, 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:7986521
- **Type**: conference
- **Published**: 26-30 June
- **Authors**: Marwa Ben Abdessalem, Amin Zribi, Tad Matsumoto +1
- **PDF**: https://ieeexplore.ieee.org/document/7986521
...
- **Status**: ❌
- **Reason**: 5G small cell 에너지·자원관리 — LDPC와 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:7986275
- **Type**: conference
- **Published**: 26-30 June
- **Authors**: Animesh Yadav, Octavia A. Dobre, Nirwan Ansari
- **PDF**: https://ieeexplore.ieee.org/document/7986275
...
- **Status**: ❌
- **Reason**: 상관소스용 분산소스코딩(joint source decoding) EXIT 설계, 채널 ECC가 아닌 소스코딩 응용
- **ID**: ieee:8007069
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Mohamad Khas, Hamid Saeedi, Reza Asvadi
- **PDF**: https://ieeexplore.ieee.org/document/8007069
...
- **Status**: ❌
- **Reason**: RS 부호의 반복 연판정 복호 — 비-LDPC 부호 중심, GF 변환 기반이라 이식성 낮음
- **ID**: ieee:8006546
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Shu Lin, Khaled Abdel-Ghaffar, Juane Li +1
- **PDF**: https://ieeexplore.ieee.org/document/8006546
...
- **Status**: ❌
- **Reason**: polar subcode 구성, 비-LDPC
- **ID**: ieee:8006852
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Peter Trifonov, Grigorii Trofimiuk
- **PDF**: https://ieeexplore.ieee.org/document/8006852
...
- **Status**: ❌
- **Reason**: BICM 코히어런트/논코히어런트 복조용 LDPC 설계 점근분석, 무선 응용특이적이며 떼어낼 일반 ECC 기법 없음
- **ID**: ieee:8007061
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Charles-Ugo Piat-Durozoi, Charly Poulliat, Nathalie Thomas +2
- **PDF**: https://ieeexplore.ieee.org/document/8007061
...
- **Status**: ❌
- **Reason**: GLDPC 일반화 제약 앙상블의 rate-성능 tradeoff 이론 분석, BEC 한정 P-PD, 떼어낼 새 디코더/HW 약함
- **ID**: ieee:8006552
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Yanfang Liu, Pablo M. Olmos, Tobias Koch
- **PDF**: https://ieeexplore.ieee.org/document/8006552
...
- **Status**: ❌
- **Reason**: 분산컴퓨팅 coded computation 응용, LDPC는 선형시간 디코딩 부수 언급일 뿐 채널 ECC 신규기법 없음
- **ID**: ieee:8006963
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Kangwook Lee, Changho Suh, Kannan Ramchandran
- **PDF**: https://ieeexplore.ieee.org/document/8006963
...
## Timing-drift channel model and marker-based error correction coding

- **Status**: ❌
- **Reason**: 삽입/삭제/타이밍드리프트 채널용 marker-based IDS 부호로 비-LDPC, NAND LDPC BP에 이식할 기법 없음
- **ID**: ieee:8006868
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Haruhiko Kaneko
- **PDF**: https://ieeexplore.ieee.org/document/8006868
- **Abstract**: Several types of insertion/deletion/substitution error correction codings have been proposed for channels with imperfect synchronization. Most of the conventional coding schemes assume insertion/deletion errors of bit granularity, while in some applications, e.g. bit patterned media recording, insertion/deletion errors occur as a result of accumulation of small synchronization errors. This paper considers a timing-drift channel model in which a fraction of bit (i.e., 1 /ν-bit) is inserted and deleted, and describes application of conventional marker-based IDS error correction coding to the channel. Also simulation results show bit error rates of the marker-based coding.

## Permuted successive cancellation decoding for polar codes

- **Status**: ❌
- **Reason**: polar code SC 디코딩 변형으로 비-LDPC, 디코더가 부호 비의존적이지 않아 LDPC BP에 이식 불가
- **ID**: ieee:8007003
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Sarit Buzaglo, Arman Fazeli, Paul H. Siegel +2
- **PDF**: https://ieeexplore.ieee.org/document/8007003
...
- **Status**: ❌
- **Reason**: sparse superposition 부호 전용 GAMP 디코더, 바이너리 LDPC 아님
- **ID**: ieee:8006798
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Erdem Biyik, Jean Barbier, Mohamad Dia
- **PDF**: https://ieeexplore.ieee.org/document/8006798
...
- **Status**: ❌
- **Reason**: LT(rateless) fountain 코드 + q-ary erasure 채널 — 비-LDPC erasure 부호, NAND 채널 ECC 기법 아님
- **ID**: ieee:8006639
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Carolyn Mayer, Christine A. Kelley
- **PDF**: https://ieeexplore.ieee.org/document/8006639
...
- **Status**: ❌
- **Reason**: q-ary multi-bit 채널상 비이진 LDPC 유한길이 디코딩·edge-labeling — 비이진 LDPC 제외
- **ID**: ieee:8006721
- **Type**: conference
- **Published**: 25-30 June
- **Authors**: Rami Cohen, Yuval Cassuto
- **PDF**: https://ieeexplore.ieee.org/document/8006721
...
- **Status**: ❌
- **Reason**: MRAM/NoC 메모리기반 컴퓨팅 DB검색 아키텍처, LDPC ECC와 무관
- **ID**: ieee:8010167
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: M. Rizk, J-Ph. Diguet, N. Onizawa +5
- **PDF**: https://ieeexplore.ieee.org/document/8010167
...
## ARINC664 bus function test and its fault injection based on Ethernet card

- **Status**: ❌
- **Reason**: ARINC664 항공버스 기능시험·결함주입, LDPC와 무관
- **ID**: ieee:8282824
- **Type**: conference
- **Published**: 18-20 June
- **Authors**: Dongning Qu, Bo Yang, Tao Gao +2
- **PDF**: https://ieeexplore.ieee.org/document/8282824
- **Abstract**: Aviation bus is the communication highway for the airborne terminal systems. ARINC 664 is the new generation of aviation bus standard. Compared with the former ARINC 429 bus, it uses Virtual Links to replace the electric cables. The Avionics Full Duplex Switched Ethernet (AFDX) is built on the protocol of ARINC 664. The communication function of ARINC 664 should be tested before application. This paper introduces a PXI-based ARINC 664 bus test system using C# language and NI Measurement Studio. The hardware includes a PXI-1042 case, a PXI-8115 controller and a PXI-C664 simulation card. Considering the AFDX and Ethernet have the similar basic structure, we use Ethernet card to analyze the data frames of AFDX. Using the Ethernet card of PXI-8115, the data frames can be extracted from the AFDX. After analyzing the structure of the frames, fault frames can be generated to test the communication function of AFDX. Some fault frames are injected into the network. The test results have shown that the ARINC 664 bus function test based on Ethernet card is practicable.

## Channel coding for enhanced mobile broadband communication in 5G systems

- **Status**: ❌
- **Reason**: 5G eMBB용 turbo/LDPC/polar 표준 부호 성능비교만 — 신규 디코더·구성·HW 기여 없음, 무선응용 비교
- **ID**: ieee:7980697
- **Type**: conference
- **Published**: 12-15 June
- **Authors**: Heshani Gamage, Nandana Rajatheva, Matti Latva-aho
- **PDF**: https://ieeexplore.ieee.org/document/7980697
...
- **Status**: ❌
- **Reason**: 5G 스펙트럼 자원관리(SDN/NFV) — LDPC/ECC 무관
- **ID**: ieee:7980749
- **Type**: conference
- **Published**: 12-15 June
- **Authors**: Shah Nawaz Khan, Adrian Kliks, Tao Chen +3
- **PDF**: https://ieeexplore.ieee.org/document/7980749
- **Abstract**: The next generation of mobile networks, 5G, is currently under development by the industry, academia and international standard organizations. The key drivers of 5G are to provide incomparable more capacity (1000×), extremely lower latency (sub-millisecond) and to accommodate `any' type of user (e.g. machines) in the network. Software-defined networking (SDN) and network function virtualization (NFV) technologies promise to bring an unprecedented level of flexibility in resource management. This paper presents a radio frequency spectrum management framework that is suitable to programmable 5G networks, under the overarching architecture of the 5G PPP COHERENT project. It also provides description of the recent advances and up-to-date initiatives for resource management in programmable 5G networks. The core contribution consists in the design of an SDN-enabled spectrum management application (SMA), and the related abstraction models that have been developed to enable flexible spectrum management. This paper demonstrates that suitable policy and topology abstraction models are key to spectrum management and sharing process.

## Correlated insertion/deletion error correction coding for bit-patterned media

- **Status**: ❌
- **Reason**: 비트패턴드 매체 삽입/삭제 오류정정 — LDPC 아님, 떼어낼 BP 디코더 기법 없음
- **ID**: ieee:7990968
- **Type**: conference
- **Published**: 12-14 June
- **Authors**: Yusei Suzuki, Haruhiko Kaneko
- **PDF**: https://ieeexplore.ieee.org/document/7990968
- **Abstract**: This paper presents channel model and error correction coding for correlated insertion/deletion errors in high-density magnetic recording media. Simulation results show that the bit error rate can be lowered by the presented coding.

## Improving performance of multithreshold decoder over binary erasure channel

- **Status**: ❌
- **Reason**: 자기직교부호(SOC)+멀티스레숄드 디코더(MTD) — 비-LDPC, 떼어낼 바이너리 LDPC BP 기법 없음
- **ID**: ieee:7977234
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: N. Grinchenko, A. Gromov, G. Ovechkin
- **PDF**: https://ieeexplore.ieee.org/document/7977234
- **Abstract**: The article discusses self-orthogonal error-correcting codes (SOC) for the decoding of which multithreshold algorithms (MTD) are usually used. The work gives the results of the research of MTD efficiency in binary erasure channels. Also new, longer and more efficient convolutional SOCs are received, comparative analysis of MTD efficiency and the efficiency of best methods to recover erasures is made. It is offered new concatenated code consisting of SOC and parity-check code for binary erasure channel allowing to decrease bit unrecovered erasure probability in the area of MTD efficient operation to 2..3 decimal orders. Lower bounds on bit unrecovered erasure probabilities for a decoder of the concatenated code are given; the its simulation results are discussed.

## Physical layer secrecy for wireless communication systems using adaptive HARQ with error contamination

- **Status**: ❌
- **Reason**: 무선 물리계층 보안+HARQ 응용, LDPC는 베이스라인이고 스크램블러/인터리버 보안 메커니즘 — 떼어낼 NAND ECC 기법 없음
- **ID**: ieee:7994823
- **Type**: conference
- **Published**: 11-14 June
- **Authors**: Ahmadreza Amirzadeh, Mohamed Haj Taieb, Jean-Yves Chouinard
- **PDF**: https://ieeexplore.ieee.org/document/7994823
...
- **Status**: ❌
- **Reason**: Wyner-Ziv 비디오 소스코딩(binning, Raptor)으로 채널 ECC가 아니며 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:7556416
- **Type**: journal
- **Published**: 1 June 201
- **Authors**: Wen Ji, Xiangyang Ji, Yiqiang Chen
- **PDF**: https://ieeexplore.ieee.org/document/7556416

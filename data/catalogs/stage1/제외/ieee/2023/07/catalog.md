...
- **Status**: ❌
- **Reason**: 비이진(NB-LDPC) 심볼 플리핑 디코딩—판단절차 0번 즉시 제외
- **ID**: ieee:10050147
- **Type**: journal
- **Published**: July 2023
...
- **Status**: ❌
- **Reason**: 비이진(non-binary GF(q)) LDPC 디코더—판단절차 0번에 의해 즉시 제외
- **ID**: ieee:10032576
- **Type**: journal
- **Published**: July 2023
...
- **Status**: ❌
- **Reason**: Cellular link adaptation / rateless retransmission scheme; no extractable LDPC decoder/HW/code-design technique.
- **ID**: ieee:10132391
- **Type**: journal
- **Published**: July 2023
...
- **Status**: ❌
- **Reason**: 온라인 fountain code(RL 기반 오버헤드 감소)—fountain/erasure 명시적 제외 대상
- **ID**: ieee:10119212
- **Type**: journal
- **Published**: July 2023
...
- **Status**: ❌
- **Reason**: Polar code scaling exponent 순수 이론 bound, LDPC 디코더/HW/구성으로 이어지지 않음
- **ID**: ieee:10063203
- **Type**: journal
- **Published**: July 2023
...
- **Status**: ❌
- **Reason**: 확률적 양자 오류정정(Knill-Laflamme 일반화), 양자 전용 개념 의존—원칙 제외
- **ID**: ieee:10063938
- **Type**: journal
- **Published**: July 2023
...
- **Status**: ❌
- **Reason**: Optical access P2MP transceiver with entropy loading / constellation shaping; no LDPC ECC technique.
- **ID**: ieee:10153945
- **Type**: journal
- **Published**: July 2023
...
- **Status**: ❌
- **Reason**: LDPC를 비밀키 reconciliation에 적용하나 표준 LDPC 사용, 떼어낼 새 디코더·코드설계 기법 없음(CSB+HARQ 시스템 기여).
- **ID**: ieee:10271035
- **Type**: conference
- **Published**: 8-10 July 
...
- **Status**: ❌
- **Reason**: PUF 기반 타원곡선 암호 FPGA 구현; LDPC ECC 무관
- **ID**: ieee:10270847
- **Type**: conference
- **Published**: 8-10 July 
...
- **Status**: ❌
- **Reason**: C-V2X Doppler 키 생성; LDPC 무관
- **ID**: ieee:10270831
- **Type**: conference
- **Published**: 8-10 July 
...
- **Status**: ❌
- **Reason**: 메모리 ECC 스페큘러티브 캐시 HW지만 LDPC 아님, 일반 ECC 검출/태그 구조 기여로 NAND LDPC 이식 기법 없음.
- **ID**: ieee:10213102
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 물리계층 보안(PLS) 종합 리뷰, LDPC/ECC 디코더 기법 무관.
- **ID**: ieee:10257614
- **Type**: conference
- **Published**: 7-9 July 2
...
- **Status**: ❌
- **Reason**: 무선용 ADDPC-EDAC 패리티체크 부호 신규 제안이나 LDPC 아니고 NAND LDPC ECC로 이식할 기법 없음
- **ID**: ieee:10193041
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 5G PD-NOMA BER 분석에 LDPC가 표준 인코딩으로 부수 언급될 뿐, 떼어낼 새 디코더·코드설계·HW 기법 없음
- **ID**: ieee:10306916
- **Type**: conference
- **Published**: 6-8 July 2
...
- **Status**: ❌
- **Reason**: 터보 코더 저전력 VLSI 설계로 LDPC와 무관, 클럭게이팅 등은 LDPC ECC 이식 기여 아님
- **ID**: ieee:10307894
- **Type**: conference
- **Published**: 6-8 July 2
...
- **Status**: ❌
- **Reason**: LoRa 멀티홉에 표준 regular binary 16x32 LDPC와 교과서 peeling 디코더를 그대로 적용한 수준, 새 기여 없음
- **ID**: ieee:10335410
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 물리계층 보안 키 생성에 randomized LDPC 사용, 보안 응용 특이적이고 떼어낼 새 ECC 기법 없음
- **ID**: ieee:10201818
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 육각형 HQAM 변조 설계; LDPC/패리티는 부수, ECC 디코더·코드설계 기여 없음
- **ID**: ieee:10212916
- **Type**: conference
- **Published**: 30 June-2 
...
- **Status**: ❌
- **Reason**: 수중음향 polar-BICM 제안; LDPC는 비교 베이스라인일 뿐, 이식할 LDPC 기법 없음
- **ID**: ieee:10212576
- **Type**: conference
- **Published**: 30 June-2 
...
- **Status**: ❌
- **Reason**: Radio Stripes 무선 시스템에 표준 LDPC 적용한 성능 평가; 떼어낼 새 ECC 기법 없음
- **ID**: ieee:10221509
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 항공 광전송 FEC; 표준 DVB-S2 IRA-LDPC 단순 재사용, 새 디코더·구성 기여 없음
- **ID**: ieee:10221478
- **Type**: conference
- **Published**: 3-6 July 2
...
- **Status**: ❌
- **Reason**: LIS 무선 시스템 등화기 성능; LDPC는 부수 적용, 떼어낼 ECC 기법 없음
- **ID**: ieee:10221448
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Ali Gashtasbi, Mário Marques da Silva, Rui Dinis
...
- **Status**: ❌
- **Reason**: Polar code 비트플립 디코딩(GSCLAF) — LDPC 아님, 이식 대상 아님
- **ID**: ieee:10225069
- **Type**: conference
- **Published**: 29 June-3 
...
- **Status**: ❌
- **Reason**: Bluetooth에 표준 LDPC 적용 + Viterbi LLR 추출, 응용 특이적이며 새 디코더·부호설계 기여 없음
- **ID**: ieee:10202150
- **Type**: conference
- **Published**: 28 June-1 
...
- **Status**: ❌
- **Reason**: FSO OAM에 표준 QC-LDPC 그대로 적용한 BER 평가; 신규 디코더/구성 기여 없음
- **ID**: ieee:10207427
- **Type**: conference
...
- **Status**: ❌
- **Reason**: QKD 정보조정(MDR) 인코더 — 채널 ECC 아닌 reconciliation, 표준 QC-LDPC FF/latency 추정뿐 새 디코더/HW 기법 약함, 원칙 제외
- **ID**: ieee:10207471
- **Type**: conference
- **Published**: 2-6 July 2
...
- **Status**: ❌
- **Reason**: 광통신 NN 소프트 디맵퍼 — 디코더가 아닌 디맵핑/변조 도메인 특이적, LDPC BP에 떼어낼 기법 없음
- **ID**: ieee:10209891
- **Type**: conference
- **Published**: 2-6 July 2
...
- **Status**: ❌
- **Reason**: 확률적 성형(PCS)+다차원 변조 광전송; LDPC 디코더/코드설계 기여 없음, 채널코딩 ECC 기법 아님
- **ID**: ieee:10209722
- **Type**: conference
- **Published**: 2-6 July 2
...
- **Status**: ❌
- **Reason**: Polar vs LDPC 비교 서베이성 평가(표준 부호 성능·복잡도 비교), 신규 디코더·구성 기여 없음 — 제외
- **ID**: ieee:10206234
- **Type**: conference
...
- **Status**: ❌
- **Reason**: IoT free-ride code로 payload+extra 동시전송, AoI 평가 — LDPC는 베이스라인, 떼어낼 ECC 기법 없는 응용 특이적
- **ID**: ieee:10226950
- **Type**: conference

...
- **Status**: ❌
- **Reason**: 비이진(NB) LDPC Min-max CNU VLSI 아키텍처 — 비이진 전용 HW, 바이너리 기준에 따라 제외
- **ID**: ieee:6204079
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: APSK 성좌용 비트매핑/coded modulation 최적화 — 변조 응용 특이적, 떼어낼 ECC 기법 없음
- **ID**: ieee:6188493
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC 디코딩 알고리즘 — 바이너리 한정 기준에 따라 제외
- **ID**: ieee:6185522
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 비이진 GF(q) LDPC/IRA 변조부호 설계, 비이진 제외
- **ID**: ieee:6170858
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 비이진 QC-LDPC 디코더 VLSI 아키텍처 — 비이진 LDPC는 제외
- **ID**: ieee:6132390
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: OFDM 무선 응용 특이적 protograph LDPC-OFDM 시간-주파수 코드; Rayleigh 페이딩 채널 매핑이 핵심, NAND에 떼어낼 신규 디코더/구성 없음
- **ID**: ieee:6232090
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 비이진 LDPC coded modulation, 광통신 대역폭 응용 — 비이진 + 응용 특이적으로 제외
- **ID**: ieee:6188503
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 소거채널 AL-FEC 적응형 rateless LDPC, NAND 채널 ECC 아닌 erasure 응용
- **ID**: ieee:6166373
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: wire-tap 보안(security gap), scrambling+HARQ — 보안 응용, 새 LDPC ECC 기법 없음
- **ID**: ieee:6151133
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 비이진 부호+QAM 채널우도 추정 — 비이진 LDPC 대상으로 제외
- **ID**: ieee:6189816
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 협력추정용 소스코딩(SR-TCQ+LDPC 압축), 채널 ECC 아님
- **ID**: ieee:6166361
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: Affine Grassmann/Reed-Muller 계열 선형부호 이론 — LDPC 아님, 떼어낼 BP 디코더 기법 없음
- **ID**: ieee:6146432
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 비이진 irregular LDPC + 네트워크코딩 결합, 무선망 응용 — 비이진 + 응용 특이적으로 제외
- **ID**: ieee:6196275
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: Huffman/VLC 소스코딩 soft 디코딩 + JSCC, LDPC는 베이스라인 — 채널 ECC 기법 아님
- **ID**: ieee:6189017
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 양방향 중계망 PNC 결합 채널-네트워크 디코딩, protograph RA 부호 응용 특이적이며 NAND LDPC BP에 떼어낼 기법 없음
- **ID**: ieee:6185513
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 암호화 영상 scalable 소스코딩 — 채널 ECC 아님
- **ID**: ieee:6151830
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: TDS-OFDM 채널추정 기법, LDPC ECC 무관
- **ID**: ieee:6157662
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: OFDM 타이밍 동기/채널추정, LDPC는 부수 언급뿐 떼어낼 ECC 기법 없음
- **ID**: ieee:6162929
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: 분산 영상 압축(소스코딩) particle BP — 채널 ECC 아님
- **ID**: ieee:6151826
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: DVB-SH 방송용 split FEC/타임인터리빙, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:6164281
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: MIMO 시공간 성좌설계, LDPC ECC 무관
- **ID**: ieee:6175870
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ❌
- **Reason**: ATSC DTV 추가데이터전송 응용으로 LDPC 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:6241733
- **Type**: conference
...
- **Status**: ❌
- **Reason**: DVB-T2 표준 RS+LDPC 인코더 FPGA 구현(인코더·인터리버 중심), 표준부호 단순 구현으로 새 디코더·구성 기여 없음
- **ID**: ieee:6241749
- **Type**: conference
- **Published**: 4-6 June 2
...
- **Status**: ❌
- **Reason**: MIMO-OFDM 방송 필드 실험, LDPC는 표준 부호 부수 사용으로 이식할 신규 기법 없음
- **ID**: ieee:6264234
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LDPC-RS product code, 비-LDPC(RS) 결합 + DTV 응용 특이적 적응 디코딩으로 바이너리 LDPC BP 이식성 약함
- **ID**: ieee:6264305
- **Type**: conference
- **Published**: 27-29 June
...
- **Status**: ❌
- **Reason**: LDPC-CPM 결합 위성통신, weighted extrinsic info exchange는 CPM 반복검출 특이적이며 떼어낼 순수 LDPC BP 기법 약함
- **ID**: ieee:6285821
- **Type**: conference
...
- **Status**: ❌
- **Reason**: P-LDPC 기반 JSCC 의료영상 전송, 소스-채널 결합으로 떼어낼 채널 ECC 기법 없음
- **ID**: ieee:6296241
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LDPC-STBC 이미지 전송 비동기 협력 MIMO, girth-4 제거는 교과서 수준이며 무선응용 특이적
- **ID**: ieee:6296575
- **Type**: conference
- **Published**: 25-27 June
...
- **Status**: ❌
- **Reason**: M-ary(비이진) LDPC 확률적 디코딩 복잡도 저감, 비이진 LDPC라 제외
- **ID**: ieee:6258660
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 광네트워크 다차원 탄력 라우팅, LDPC 코드변조는 부수 베이스라인, 떼어낼 ECC 기법 없음
- **ID**: ieee:6260850
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: polar code 생성행렬 분극 분석, 순수 이론·디코더/HW로 안 이어짐
- **ID**: ieee:6292929
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Reed-Solomon용 stochastic Chase 디코더, 비-LDPC 부호 의존적이라 바이너리 LDPC BP에 이식 불가
- **ID**: ieee:6328942
- **Type**: conference
- **Published**: 17-20 June
...
- **Status**: ❌
- **Reason**: OFDM 채널추정 기법, LDPC는 부수 언급뿐
- **ID**: ieee:6292970
- **Type**: conference
- **Published**: 17-20 June
...
- **Status**: ❌
- **Reason**: NC-OFDM 응용 특이적; 표준 density evolution+PEG로 부호 설계, 새 디코더/구성 기여 없음
- **ID**: ieee:6363932
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 삽입/삭제/치환 채널용 watermark+LDPC 역연접 코드; 동기화 채널 특화, NAND에 떼어낼 일반 LDPC 기법 없음
- **ID**: ieee:6364769
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 삽입/삭제+ISI 채널의 마커코드+LDPC 동기화/등화 MAP 검출기; NAND에 없는 동기화 오류 채널 특화, 떼어낼 일반 LDPC 디코더 기법 없음
- **ID**: ieee:6364246
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 비이진(F256) IRA 부호 — non-binary GF(q) LDPC는 제외 대상
- **ID**: ieee:6363976
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 물리계층 보안 wiretap+erasure 상관, nonsystematic LDPC를 보안용으로 사용, 떼어낼 ECC 기법 없음
- **ID**: ieee:6363737
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: Time-frequency packing/FTN 변조+검출 기법; LDPC는 DVB-S2 표준 부호 부수 언급, 떼어낼 ECC/디코더 기법 없음
- **ID**: ieee:6363926
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 물리계층 네트워크 코딩(양방향 릴레이) 응용 특이적; 채널 디코딩은 부수 언급, NAND LDPC에 떼어낼 디코더·구성 기법 없음
- **ID**: ieee:6364213
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 분산소스코딩(DSC) 비디오 스트리밍; 소스코딩이지 채널 ECC 아님, LDPC 미언급
- **ID**: ieee:6363933
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 셀룰러 네트워크 에너지 효율 분석; ECC/LDPC 무관
- **ID**: ieee:6364142
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 터보부호+DRP 인터리버; 인터리버 기법은 LDPC BP에 이식되는 부호비의존 디코더 기법 아님, 제외
- **ID**: ieee:6364028
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: 비지도 크라우드소싱 신뢰도 분석; LDPC/ECC 무관
- **ID**: ieee:6364014
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ❌
- **Reason**: VLC 기가비트 baseband, 표준 LDPC 채널코더 사용에 그쳐 신규 기여 없음
- **ID**: ieee:6363739
- **Type**: conference
- **Published**: 10-15 June

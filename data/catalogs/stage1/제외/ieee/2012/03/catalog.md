...
- **Status**: ❌
- **Reason**: 광 전송 실험, LDPC 무관(QAM/위상복구/등화), ECC 기법 없음
- **ID**: ieee:6192255
- **Type**: conference
- **Published**: 4-8 March 
- **Authors**: X. Zhou, L. E. Nelson, R. Isaac +5
- **PDF**: https://ieeexplore.ieee.org/document/6192255
- **Abstract**: Employing time-domain hybrid QAM, training-assisted phase recovery and cascaded equalization, we successfully transmitted ten 494.85Gbit/s PDM-32/64QAM DWDM signals at 8.25b/s/Hz net spectral efficiency (SE) over 40×100km, achieving a record terrestrial SE⋅distance product of 33,000-km b/s/Hz.

## Comparison analysis of OFDM signal performance with Cyclic prefix and LDPC codes over AWGN channel

- **Status**: ❌
- **Reason**: OFDM PAPR/cyclic prefix vs LDPC 성능 비교, 표준 log-domain 디코딩 — 무선 응용 비교, 신규 기법 없음
- **ID**: ieee:6215999
- **Type**: conference
- **Published**: 30-31 Marc
- **Authors**: Rashmi K. Bhatial, Ganesh Joshi, Shaikh Rakhshan Anjum
- **PDF**: https://ieeexplore.ieee.org/document/6215999
- **Abstract**: Orthogonal frequency division multiplexing has a high tolerance to multipath signals and is spectrally efficient making it good candidate high data rate systems. It is a very promising technology using adaptive rate algorithm serves well to improve performance. It appears to be a good modulation technique for high performance systems but still it has drawback such as high peak to average power ratio (PAPR) which can be reduced by use of various techniques PTS(Partial transmit sequence), Cyclic prefix and PRC (Peak reduction carriers). In this paper cyclic prefix method and a most efficient LDPC (Low density parity check) codes are compared to reduce the problem of PAPR. For LDPC codes at the receiver end the received message is decoded using Log domain algorithm and performance is analysed. Graph is observed between BER of cyclic prefix and LDPC codes using BPSK modulation over AWGN channel for constant Eb/No. of 3 dB.

## An effective H-ARQ scheme for LDPC-coded broadband power line communication system

- **Status**: ❌
- **Reason**: H-ARQ + UEP + QAM 변조 결합 통신 응용, LDPC는 베이스라인이고 떼어낼 부호/디코더 신규 기법 없음
- **ID**: ieee:6201343
- **Type**: conference
- **Published**: 27-30 Marc
- **Authors**: Qi Zhang, Fang Yang, Jian Song +2
- **PDF**: https://ieeexplore.ieee.org/document/6201343
- **Abstract**: Automatic repeat request (ARQ) is a widely used technique in communication systems for transmission error control. In this paper, a Hybrid-ARQ (H-ARQ) scheme for LDPC coded system with low complexity and reduced additional transmission cost is proposed. This H-ARQ scheme exploit the unequal error protection (UEP) property in irregular LDPC coding and high-order quadrature amplitude modulation (QAM), where the bits with less protection are retransmitted with improved protection. Simulation results based on the power line communication (PLC) G.hn system demonstrate the advantage and flexibility of the proposed scheme over traditional H-ARQ scheme.

## Performance improvement of G.hn system based on bit mapping technique

- **Status**: ❌
- **Reason**: G.hn 표준 QC-LDPC에 bit mapping/UEP — 표준 부호 응용+변조 매핑, 새 디코더/구성/HW 기여 없음
- **ID**: ieee:6201306
- **Type**: conference
- **Published**: 27-30 Marc
- **Authors**: Keqian Yan, Kewu Peng, Fang Yang +2
- **PDF**: https://ieeexplore.ieee.org/document/6201306
- **Abstract**: A new specification for power line communication (PLC), named G.hn, has been developed recently for the existing-wire home networking. G.hn system specifies a coded modulation scheme based on quasi-cyclic low-density parity-check (QC-LDPC) codes and quadrature amplitude modulations (QAMs). In this paper, we present a bit mapping strategy to exploit the unequal error protection (UEP) property inherent in the irregular LDPC codes and high-order constellations, which can effectively improve the reliability of the whole coded modulation system with no penalty. The method to design the bit mapping scheme is also investigated via the analysis of extrinsic information transfer (EXIT) charts. Simulation results reveal that the appropriate bit mapping scheme can achieve considerable gains in the G.hn system.

## A suboptimal embedding algorithm with low complexity for binary data hiding

- **Status**: ❌
- **Reason**: binary data hiding 스테가노그래피 임베딩, 채널 ECC가 아님
- **ID**: ieee:6288247
- **Type**: conference
- **Published**: 25-30 Marc
- **Authors**: Jyun-Jie Wang, Houshou Chen
- **PDF**: https://ieeexplore.ieee.org/document/6288247
...
- **Status**: ❌
- **Reason**: GPU Tomlinson-Harashima precoding, LDPC와 무관한 무선 프리코딩 가속
- **ID**: ieee:6288207
- **Type**: conference
- **Published**: 25-30 Marc
- **Authors**: Fernando Domene, Sandra Roger, Carla Ramiro +2
- **PDF**: https://ieeexplore.ieee.org/document/6288207
...
- **Status**: ❌
- **Reason**: OFDM-IDMA 무선 시스템에 표준 QC-LDPC 적용 성능 분석; 새 디코더/구성 기여 없는 무선 응용
- **ID**: ieee:6187974
- **Type**: conference
- **Published**: 23-25 Marc
- **Authors**: Zhen-hua Wang, Ge-fei Yu, You-peng Zhang +3
- **PDF**: https://ieeexplore.ieee.org/document/6187974
- **Abstract**: To meet the need of high rate and high reliability for next generation of wireless mobile communication system, in this paper, we designed a new communications system of OFDM-IDMA based on QC-LDPC. The performance under different coding rate, different length of frame is analyzed, and we also compared the performance with the system based on convolutional codes, the simulation results show that this new system can provide greater coding gain and better communications service, it is very suitable for high-speed data transmission and also has very far-reaching significance for the future of digital communication systems.

## Performance Evaluation of Turbo Product Codes over the PPM-based Satellite Optical Channel

- **Status**: ❌
- **Reason**: 위성 광통신 turbo product code+PPM; 비-LDPC 부호이며 떼어낼 LDPC BP 이식 기법 없음
- **ID**: ieee:6188069
- **Type**: conference
- **Published**: 23-25 Marc
- **Authors**: Huixi Liao, Qingjun Zhang, Liying Tan +1
- **PDF**: https://ieeexplore.ieee.org/document/6188069
...
- **Status**: ❌
- **Reason**: LDPC-coded OFDM 성능 리뷰; 표준 LDPC 부수 응용, 떼어낼 신규 기법 없음
- **ID**: ieee:6194503
- **Type**: conference
- **Published**: 15-17 Marc
- **Authors**: Madhusmita Mishra, Sarat Kumar Patra, A K Turuk
- **PDF**: https://ieeexplore.ieee.org/document/6194503

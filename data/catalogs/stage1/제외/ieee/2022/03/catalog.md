...
- **Status**: ❌
- **Reason**: ISDB-T/ATSC 3.0 표준 LDPC를 표준 SPA/MSA로 비교만 — 새 기여 없는 표준 부호·기법 재사용, 방송 응용.
- **ID**: ieee:9665205
- **Type**: journal
...
- **Status**: ❌
- **Reason**: 물리계층 보안용 multilevel coding, punctured LDPC를 보안 목적으로 사용 — ECC 신뢰성용 새 디코더/구성 기여 아님, 보안 응용 특이적.
- **ID**: ieee:9690167
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: SC-LDPC chain loop 구성의 점근 임계값(BEC) 분석 — erasure 채널 앙상블 이론, NAND 고전 LDPC에 이식할 새 디코더/HW 없음.
- **ID**: ieee:9663207
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: NB-LDPC(비이진) 디코더 HW — 비이진 LDPC는 제외 대상
- **ID**: ieee:9583586
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: Polar-coded modulation 설계 — polar 부호 전용, LDPC는 비교 베이스라인일 뿐 떼어낼 LDPC 기법 없음.
- **ID**: ieee:9678982
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: VQA용 시맨틱 통신 신경망 — 시맨틱 통신, 떼어낼 ECC 기법 없음
- **ID**: ieee:9653664
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: 코드드 분산컴퓨팅 행렬-벡터곱, partial recovery — LDPC ECC 아님, 분산컴퓨팅 stragglers 대응
- **ID**: ieee:9641837
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: 양자 스태빌라이저 코드, coherent noise 완화 — 양자 전용 개념 의존, qLDPC 원칙 제외
- **ID**: ieee:9624967
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: BP-XOR 코드 기반 분산 행렬곱 fault-tolerance — erasure/분산컴퓨팅용, 채널 ECC 디코더 기법 아님
- **ID**: ieee:9632620
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: Sparse NOMA 스펙트럼 효율 closed-form 이론 — 무선 다중접속 용량 분석, LDPC ECC 디코더/HW/구성 아님.
- **ID**: ieee:9718537
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: Random access SIC scheme for IoT; density evolution used for subchannel distribution, no LDPC decoder/code-design technique to port
- **ID**: ieee:9344839
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: MIMO 전송 기법, message-passing 검출기 — 무선 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:9627077
- **Type**: journal
- **Published**: March 2022
...
- **Status**: ❌
- **Reason**: q-ary symmetric channel 기반 partial-retransmission ARQ 기법; 비이진 채널·hard-decision MP 재전송 프로토콜이라 바이너리 NAND LDPC ECC 이식 기법 없음
- **ID**: ieee:9741642
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 800G-ZR용 OFEC(staircase 계열) FPGA 구현; 이식 가능한 바이너리 LDPC 기법 없음
- **ID**: ieee:9748672
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 구면성형(sphere shaping) 비선형 간섭 완화; 성상 성형이며 ECC 아님
- **ID**: ieee:9748613
- **Type**: conference
- **Published**: 6-10 March
...
- **Status**: ❌
- **Reason**: 광통신 WL MIMO 이퀄라이저; LDPC 무관
- **ID**: ieee:9748236
- **Type**: conference
- **Published**: 6-10 March
...
- **Status**: ❌
- **Reason**: ESS 엔트로피 로딩(성형); 소스/성형 기법이며 채널 ECC 아님
- **ID**: ieee:9748820
- **Type**: conference
- **Published**: 6-10 March
...
- **Status**: ❌
- **Reason**: 화성 중계망 LDPC 구현/운용(CCSDS rate-1/2) — 표준 부호 적용 사례, 새 디코더/구성/HW 기여 없음
- **ID**: ieee:9843399
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 화성 6G Cloud-RAN 아키텍처 — LDPC는 BER 평가 베이스라인일 뿐, 떼어낼 ECC 기법 없음
- **ID**: ieee:9843703
- **Type**: conference
- **Published**: 5-12 March
...
- **Status**: ❌
- **Reason**: Perseverance 화성 중계망 운용/준비 — ECC 무관 미션 운영 논문
- **ID**: ieee:9843762
- **Type**: conference
- **Published**: 5-12 March
...
- **Status**: ❌
- **Reason**: 달-지구 광통신 단말 시스템 설계, LDPC/ECC 기법 없음
- **ID**: ieee:9749725
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 펄스 셰이핑 필터+표준 rate-adaptive LDPC 5G 응용 — LDPC 부수 언급, 떼어낼 새 기법 없음
- **ID**: ieee:9767149
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LDPC+BP 일반 설명·시뮬레이터 수준, 교과서적이고 새 디코더/HW 기여 불명확
- **ID**: ieee:9763119
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LoRaWAN 응용계층 컨볼루션/파운틴 결합 데이터복구 코딩; erasure/fountain 계열, NAND LDPC 이식 기법 없음
- **ID**: ieee:9167471
- **Type**: journal

...
- **Status**: ❌
- **Reason**: QC-LDPC used only to build Construction D' lattices for power-constrained channels; lattice/shaping focus, no portable LDPC ECC technique
- **ID**: ieee:9695410
- **Type**: journal
- **Published**: April 2022
- **Authors**: Fan Zhou, Brian M. Kurkoski
- **PDF**: https://ieeexplore.ieee.org/document/9695410
...
- **Status**: ❌
- **Reason**: Unsourced random access의 AMP+CCS 디코딩 — 압축센싱/희소회귀 기반, NAND 바이너리 LDPC ECC 이식 기법 아님
- **ID**: ieee:9654225
- **Type**: journal
- **Published**: April 2022
- **Authors**: Vamsi K. Amalladinne, Asit Kumar Pradhan, Cynthia Rush +2
- **PDF**: https://ieeexplore.ieee.org/document/9654225
...
- **Status**: ❌
- **Reason**: BP joint detection/decoding for ReRAM uses polar codes (genetic-algorithm constructed), not binary LDPC; no LDPC ECC technique
- **ID**: ieee:9726199
- **Type**: journal
- **Published**: April 2022
- **Authors**: Ce Sun, Kui Cai, Guanghui Song +2
- **PDF**: https://ieeexplore.ieee.org/document/9726199
...
- **Status**: ❌
- **Reason**: ALOHA/coded multiple access 네트워크 calculus 분석 — LDPC ECC와 무관
- **ID**: ieee:9604910
- **Type**: journal
- **Published**: April 2022
- **Authors**: Tzu-Hsuan Liu, Che-Hao Yu, Yi-Jheng Lin +3
- **PDF**: https://ieeexplore.ieee.org/document/9604910
...
- **Status**: ❌
- **Reason**: 노이즈 group testing 정보이론 bound — 디코더/HW/코드설계로 안 이어짐
- **ID**: ieee:9663174
- **Type**: journal
- **Published**: April 2022
- **Authors**: Oliver Gebhard, Oliver Johnson, Philipp Loick +1
- **PDF**: https://ieeexplore.ieee.org/document/9663174

...
- **Status**: ❌
- **Reason**: GLDPC(constraint=BCH/RS 블록코드), 표준 GLDPC가 LDPC 대비 열세라 결론, 바이너리 LDPC ECC에 새 이식 기법 없음
- **ID**: ieee:4450790
- **Type**: journal
- **Published**: February 2
- **Authors**: Nenad Miladinovic, Marc P.C. Fossorier
- **PDF**: https://ieeexplore.ieee.org/document/4450790
...
- **Status**: ❌
- **Reason**: layered space-time용 BP 채널 검출기, LDPC ECC 디코더 아닌 채널검출로 이식 기법 없음
- **ID**: ieee:4444758
- **Type**: journal
- **Published**: February 2
- **Authors**: Jun Hu, Tolga M. Duman
- **PDF**: https://ieeexplore.ieee.org/document/4444758
...
- **Status**: ❌
- **Reason**: MIMO 공간시간 선형분산(LD) 코드 설계로 LDPC ECC와 무관, 떼어낼 기법 없음
- **ID**: ieee:4450834
- **Type**: journal
- **Published**: February 2
- **Authors**: Che Lin, Venugopal V. Veeravalli
- **PDF**: https://ieeexplore.ieee.org/document/4450834
...
- **Status**: ❌
- **Reason**: 멀티캐리어 적응변조+표준 LDPC 응용 연구, 새 디코더/구성/HW 기여 없음(표준 부호 단순 사용)
- **ID**: ieee:6072486
- **Type**: journal
- **Published**: Feb. 2008
- **Authors**: Huo Yongging, Peng Qicong, Shao Huaizong
- **PDF**: https://ieeexplore.ieee.org/document/6072486
...
- **Status**: ❌
- **Reason**: Repeat-Zigzag-Hadamard 터보형 부호(비-LDPC), 디코더가 부호 의존적이며 바이너리 LDPC BP로 이식할 기법 없음
- **ID**: ieee:4439857
- **Type**: journal
- **Published**: Feb. 2008
- **Authors**: Kai Li, Guosen Yue, Xiaodong Wang +1
- **PDF**: https://ieeexplore.ieee.org/document/4439857
...
- **Status**: ❌
- **Reason**: DVB-S2 표준 LDPC+BCH codec 저전력 구현이나 표준 부호 그대로 사용, 새 디코더/구성 기여 불명확 (위성 응용)
- **ID**: ieee:4523181
- **Type**: conference
- **Published**: 3-7 Feb. 2
- **Authors**: P. Urard, L. Paumier, V. Heinrich +2
- **PDF**: https://ieeexplore.ieee.org/document/4523181
- **Abstract**: The design of a full Broadcast + Interactive Services compliant 2nd Generation Satellite Digital Video Broadcast (DVB-S2) [1] codec is presented. Previously published silicon implementations respecting this stringent standard reports power consumption between 800mW and 1020mW [5]. This large power consumption is related to long Low-Density Parity Check (LDPC) codes [2] and has always been a barrier to the adoption of long LDPC codes in wireless transmissions for portable devices. This silicon demonstrates a drastic reduction of power consumption when decoding HDTV frames and shows that long LDPC codes can also be used on portable devices to allow close-to-Shannon-limit transmissions.

## Non-binary LDPC codes vs. Reed-Solomon codes

- **Status**: ❌
- **Reason**: 비이진(non-binary) QC-LDPC 및 RS 대체 - 비이진 LDPC는 제외 대상
- **ID**: ieee:4601044
- **Type**: conference
- **Published**: 27 Jan.-1 
- **Authors**: Bo Zhou, Li Zhang, Jingyu Kang +4
- **PDF**: https://ieeexplore.ieee.org/document/4601044
...
- **Status**: ❌
- **Reason**: 압축센싱 = 실수 선형코드 기반 소스코딩, 채널 ECC 아님
- **ID**: ieee:4601055
- **Type**: conference
- **Published**: 27 Jan.-1 
- **Authors**: Fan Zhang, Henry D. Pfister
- **PDF**: https://ieeexplore.ieee.org/document/4601055
...
- **Status**: ❌
- **Reason**: expander code 최소거리 bound 서베이, 구체 신규 디코더/구성/HW 없음
- **ID**: ieee:4601075
- **Type**: conference
- **Published**: 27 Jan.-1 
- **Authors**: Vitaly Skachek
- **PDF**: https://ieeexplore.ieee.org/document/4601075
...
- **Status**: ❌
- **Reason**: 디코딩 반복수/전력 이론 bound, 디코더/HW/구성 구체 기여 없음
- **ID**: ieee:4601064
- **Type**: conference
- **Published**: 27 Jan.-1 
- **Authors**: Anant Sahai, Pulkit Grover
- **PDF**: https://ieeexplore.ieee.org/document/4601064
...
- **Status**: ❌
- **Reason**: turbo-coded DS-CDMA EM 채널추정, 비-LDPC이고 채널추정 기법으로 BP 이식성 없음
- **ID**: ieee:4475555
- **Type**: conference
- **Published**: 26-27 Feb.
- **Authors**: Don Torrieri, Neelu Bijukchhe, Amitav Mukherjee +1
- **PDF**: https://ieeexplore.ieee.org/document/4475555
...
## Iterative Equalization and FEC Decoding in Optical Communication Systems: Concepts and Performance

- **Status**: ❌
- **Reason**: 광통신 iterative equalization+외부 RS, 최적화 LDPC 부수 언급, 떼어낼 신규 기법 없음
- **ID**: ieee:4528502
- **Type**: conference
- **Published**: 24-28 Feb.
- **Authors**: W. Sauer-Greff, R. Urbansky
- **PDF**: https://ieeexplore.ieee.org/document/4528502
- **Abstract**: MLSE and turbo equalization with convolutional and LDPC codes in presence of PMD channels and outer RS codes are compared. Optimized LDPC codes reduce the gap to information theoretic bounds to the order of ldB.

## Iterative Decoding for Low-Density Parity-Check Lattices

- **Status**: ❌
- **Reason**: LDPC lattice에 sum/max-product 적용 성능평가만; lattice 전용 구성으로 바이너리 NAND LDPC에 새로 이식할 기여 없음
- **ID**: ieee:4493778
- **Type**: conference
- **Published**: 17-20 Feb.
- **Authors**: Young-Seob Choi, Ihn-Jung Baik, Sae-Young Chung
- **PDF**: https://ieeexplore.ieee.org/document/4493778
- **Abstract**: Low-density parity-check (LDPC) lattices are introduced by Sadeghi et al. (2006). The construction method of such lattices and the decoding algorithm based on the min-sum algorithm are also proposed in [1]. In this paper we apply two iterative message passing algorithms, the sum-product algorithm and the max-product algorithm, to the Tanner graph representation of LDPC lattices. We evaluate the performance of two iterative message passing algorithms.

## A New Efficient 16-QAM Mapping Approach for Iterative Receiver using Turbo Codes over SISO Channel

- **Status**: ❌
- **Reason**: 16-QAM 매핑+turbo iterative receiver 설계; LDPC는 부수 언급, 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:4493792
- **Type**: conference
- **Published**: 17-20 Feb.
- **Authors**: Sangbong Oh, Akmal Fayziyev, Jongsub Cha +2
- **PDF**: https://ieeexplore.ieee.org/document/4493792
- **Abstract**: Iterative receivers (IR) have a feedback between demapper and channel decoder and iteratively improve estimation of the transmitted information. On the contrary, in conventional receivers, demapper and channel decoder work their functions independently. In such conventional systems, powerful error control codes (turbo codes, for example) usually promise better performance. However, we will show that in IR with multilevel modulation, powerful error control codes do not always guarantee better performance. That is, when we design IR, a careful attention to combining mapping and error control code must be paid. In this paper, we design IR for communication systems with turbo codes and the 16-QAM modulation. In performance comparisons, we will show that in some cases the IR for the system with convolutional code can have better performance than that of the turbo code. Our work answers why the turbo code has poor performance and present a good mapping which gives insights into a general design rule for mapping with powerful error control codes such as turbo and LDPC codes.

## Adaptive Inter-Cell Interference Management for Downlink FH-OFDMA Systems

- **Status**: ❌
- **Reason**: FH-OFDMA 셀간 간섭관리 무선응용 특이적; LDPC는 베이스라인, 이식할 ECC 기법 없음
- **ID**: ieee:4493944
- **Type**: conference
- **Published**: 17-20 Feb.
- **Authors**: Jin Bae Park, Young Jin Sang, Seong-Lyun Kim +1
- **PDF**: https://ieeexplore.ieee.org/document/4493944
- **Abstract**: For a cellular system, the system throughput as well as the throughput at a cell edge are among the most important evaluation measures for the requirements on the system performance. Several inter-cell interference mitigation techniques have been proposed to meet the cell-edge users' needs in downlink. Each interference mitigation scheme has been found that they have pros and cons at the same time. In this paper, an adaptive inter-cell interference management scheme is proposed for an LDPC-coded FH-OFDMA system to combat the inter-cell interference in downlink cellular environment. Based on the knowledge on other cells that we can utilize without dynamic cooperation between cells, different decoding methods can be applied to maximize the performance for the cell-edge users. It is shown that a significant gain can be obtained, especially at the cell boundary using the proposed scheme.

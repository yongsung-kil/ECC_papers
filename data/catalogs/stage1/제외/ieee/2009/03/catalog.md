...
- **Status**: ❌
- **Reason**: LDGM+LDPC 소스코딩/SCSI binning 이론(최적 인코딩/디코딩 존재성), 떼어낼 NAND ECC 디코더 기법 없음
- **ID**: ieee:4787613
- **Type**: journal
...
- **Status**: ❌
- **Reason**: GF(q) 비이진 LDPC density evolution/도수분포 최적화, 비이진은 제외 대상
- **ID**: ieee:4787626
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: 비이진 LDPC ML 디코딩 성능 상계(순수 이론 bound), 바이너리 아님+디코더/HW로 안 이어짐
- **ID**: ieee:4787607
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: DG-LDPC의 BEC stability bound 순수 이론, 디코더/HW/구체 코드설계로 이어지지 않음
- **ID**: ieee:4787610
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: 다중 트렐리스 검출(FB 알고리즘) 채널추정 기법, LDPC는 부수적 반복검출 베이스라인, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:4799048
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: Wyner-Ziv 비디오 소스코딩(분산 소스코딩)에서 LDPC는 Slepian-Wolf 베이스라인일 뿐, NAND 채널 ECC로 떼어낼 기법 없음
- **ID**: ieee:4782072
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: L2/L3 캐시 ECC 면적절감 아키텍처(parity+선택적 ECC). LDPC 무관, NAND LDPC ECC에 이식할 부호/디코더/HW 기법 없음
- **ID**: ieee:4626951
- **Type**: journal
- **Published**: March 2009
- **Authors**: Soontae Kim
...
- **Status**: ❌
- **Reason**: 주파수홉 적응코딩+turbo product code 무선 응용, LDPC 무관
- **ID**: ieee:4799056
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: 협력적 정보은닉(워터마킹) 부호설계 및 capacity bound. LDPC 무관, ECC 채널코딩 기법 아님
- **ID**: ieee:4781896
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: turbo 주파수영역 등화기 유한블록 성능분석(EXIT 차트 대안). 비-LDPC이며 등화기 성능예측 기법으로 LDPC BP에 이식할 디코더 기법 없음
- **ID**: ieee:4555268
- **Type**: journal
- **Published**: March 2009
...
- **Status**: ❌
- **Reason**: MIMO sphere detection+LDPC 표준 min-sum/layered 결합 — 표준 기법 재사용, 새 디코더 기여 없음
- **ID**: ieee:5069222
- **Type**: conference
- **Published**: 6-8 March 
...
- **Status**: ❌
- **Reason**: 비이진 girth-8 LDPC(광통신); non-binary 제외
- **ID**: ieee:5032303
- **Type**: conference
...
- **Status**: ❌
- **Reason**: EXIT-chart 최적화 irregular LDPC의 OOK 광전송 동작점 분석; 표준 기법, 떼어낼 신규 디코더/구성 없음
- **ID**: ieee:5032873
- **Type**: conference
- **Published**: 22-26 Marc
...
- **Status**: ❌
- **Reason**: 표준 LDPC+RS concatenated FEC 프레임 구조 제안; 새 디코더/구성/HW 기여 없음, 광통신 응용 특이적
- **ID**: ieee:5032470
- **Type**: conference
- **Published**: 22-26 Marc
...
- **Status**: ❌
- **Reason**: 변조 포맷·Shannon limit 슬라이드 발표(서베이성); 구체적 신규 LDPC 기법 없음
- **ID**: ieee:5032554
- **Type**: conference
- **Published**: 22-26 Marc
- **Authors**: Andrew D. Ellis
- **PDF**: https://ieeexplore.ieee.org/document/5032554
- **Abstract**: This article consists of a collection of slides from the author's conference presentation. The complete oral presentation in text form was not made available for publication as part of the conference proceedings. Some of the specific areas/topics discussed include: Trends in optical communication Trends in optical communication; Shannon limit; Generic communication theory Generic communication theory; Forward Error Correction Codes; Optical Systems; Capacity limit for non-linear systems; Multi-level modulation formats; and Breaking the current limit.

## On unequal error protection with low density parity check codes in scalable video coding

- **Status**: ❌
- **Reason**: 스케일러블 비디오 UEP에 표준 LDPC 적용+비트할당 - LDPC 부수사용, 새 디코더/구성 없음
- **ID**: ieee:5054826
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LDGM 기반 CSS 양자코드(qLDPC) - 양자 EC, 스태빌라이저 의존(제외)
- **ID**: ieee:5054696
- **Type**: conference
- **Published**: 18-20 Marc
...
- **Status**: ❌
- **Reason**: Slepian-Wolf 분산 소스코딩(압축)용 BP 디코딩 - 채널 ECC 아님(소스코딩 제외)
- **ID**: ieee:5054685
- **Type**: conference
- **Published**: 18-20 Marc
...
- **Status**: ❌
- **Reason**: 인지무선 협력센싱을 LDPC codebook+BP로 추론 - 검출 응용, 채널 ECC 디코더 기법 아님
- **ID**: ieee:5054784
- **Type**: conference
- **Published**: 18-20 Marc
...
- **Status**: ❌
- **Reason**: WSN 합의형성용 LDPC-like BP - 채널 ECC 아님, 떼어낼 디코더 기법 없음
- **ID**: ieee:5054828
- **Type**: conference
- **Published**: 18-20 Marc
- **Authors**: M. Shukair, K. Namuduri
- **PDF**: https://ieeexplore.ieee.org/document/5054828
- **Abstract**: In this paper, we apply belief propagation algorithm for consensus building in distributed wireless sensor networks (WSN). The objective is to achieve convergence to a global consensus value at all sensor nodes in the network. In order to implement the proposed belief propagation algorithm in a WSN, we introduce virtual fusion center nodes, which serve as sensors as well as local fusion centers in the sensor network. This paper also investigates the structure of WSNs that achieves convergence asymptotically, and guarantees achieving global consensus at all sensor nodes. Our results suggest that introducing certain range of irregularity in the network structure results in an improvement in the rate of convergence.

## Multipath multi-stream distributed reliable video delivery in Wireless Sensor Networks

- **Status**: ❌
- **Reason**: WSN 비디오 전송 아키텍처, LDPC는 부수 채널코딩 언급뿐 - 떼어낼 ECC 기법 없음
- **ID**: ieee:5054718
- **Type**: conference
- **Published**: 18-20 Marc
...
- **Status**: ❌
- **Reason**: Slepian-Wolf 압축 기반 상관소스 협력코딩 - 소스코딩/무선응용, 떼어낼 ECC 기법 없음
- **ID**: ieee:5054801
- **Type**: conference
- **Published**: 18-20 Marc
...
- **Status**: ❌
- **Reason**: compressive sensing + 비선형 아날로그 JSCC — LDPC 채널코딩 아님
- **ID**: ieee:5054682
- **Type**: conference
- **Published**: 18-20 Marc
...
- **Status**: ❌
- **Reason**: Slepian-Wolf 분산소스코딩용 punctured LDPC 설계 — 소스 코딩 압축 응용, 채널 ECC 아님
- **ID**: ieee:4976492
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 아날로그 결합 소스채널 코딩(공간채움곡선+MMSE) — LDPC 아니고 JSCC, 떼어낼 ECC 기법 없음
- **ID**: ieee:4976454
- **Type**: conference
- **Published**: 16-18 Marc
...
- **Status**: ❌
- **Reason**: 블록암호 암호화 데이터 압축 — 소스 코딩/보안, 채널 ECC 아님
- **ID**: ieee:4976465
- **Type**: conference
- **Published**: 16-18 Marc

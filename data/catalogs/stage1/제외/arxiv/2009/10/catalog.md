...
- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC의 erasure 디코딩 - non-binary LDPC 대상이므로 제외
- **ID**: arxiv:0910.1922v1
- **Type**: preprint
- **Published**: 2009-10-10
- **Authors**: Valentin Savin
- **PDF**: https://arxiv.org/pdf/0910.1922v1

...
- **Status**: ❌
- **Reason**: 소스코딩(SCSI)+list decoding, RS/BCH 비-LDPC 부호 기반—채널 ECC 아니고 떼어낼 바이너리 LDPC 기법 없음
- **ID**: arxiv:1110.6698v1
- **Type**: preprint
- **Published**: 2011-10-31
- **Authors**: Mortuza Ali, Margreta Kuijper
- **PDF**: https://arxiv.org/pdf/1110.6698v1
...
- **Status**: ❌
- **Reason**: Markov 채널 LDPC 통계역학 해석(replica/density evolution 동등성)—순수 이론 분석, 신규 디코더/HW/구성으로 안 이어짐
- **ID**: arxiv:1110.1930v1
- **Type**: preprint
- **Published**: 2011-10-10
- **Authors**: Ryuhei Mori, Toshiyuki Tanaka
- **PDF**: https://arxiv.org/pdf/1110.1930v1
- **Abstract**: Low-density parity-check (LDPC) codes on symmetric memoryless channels have been analyzed using statistical physics by several authors. In this paper, statistical mechanical analysis of LDPC codes is performed for asymmetric memoryless channels and general Markov channels. It is shown that the saddle point equations of the replica symmetric solution for a Markov channel is equivalent to the density evolution of the belief propagation on the factor graph representing LDPC codes on the Markov channel. The derivation uses the method of types for Markov chain.

...
- **Status**: ❌
- **Reason**: turbo/LDPC 반복 demapping 스케줄링(무선 수신기 응용), 부호 비의존 BP 디코더 기법 아님
- **ID**: arxiv:1203.5037v1
- **Type**: preprint
- **Published**: 2012-03-22
- **Authors**: Salim Haddad, Amer Baghdadi, Michel Jezequel
- **PDF**: https://arxiv.org/pdf/1203.5037v1
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC를 대형 MIMO에 적용; non-binary LDPC는 제외 대상
- **ID**: arxiv:1203.0960v1
- **Type**: preprint
- **Published**: 2012-03-05
- **Authors**: Puripong Suthisopapan, Kenta Kasai, Anupap Meesomboon +1
- **PDF**: https://arxiv.org/pdf/1203.0960v1

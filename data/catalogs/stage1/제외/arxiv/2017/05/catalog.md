...
- **Status**: ❌
- **Reason**: non-binary QC-LDPC(GF(q)) 패리티검사 구성 - 비이진 LDPC 제외
- **ID**: arxiv:1705.10717v1
- **Type**: preprint
- **Published**: 2017-05-30
- **Authors**: Stanislav Kruglik, Valeriya Potapova, Alexey Frolov
- **PDF**: https://arxiv.org/pdf/1705.10717v1
...
- **Status**: ❌
- **Reason**: QKD 정보조정(reconciliation)+해시 검증 - 채널 ECC 아니고 떼어낼 신규 디코더/HW 없음
- **ID**: arxiv:1705.06664v3
- **Type**: preprint
- **Published**: 2017-05-18
- **Authors**: A. K. Fedorov, E. O. Kiktenko, A. S. Trushechkin
- **PDF**: https://arxiv.org/pdf/1705.06664v3
...
- **Status**: ❌
- **Reason**: trapping/stopping set 서베이 - 신규 디코더/구성/HW 기여 없는 리뷰
- **ID**: arxiv:1705.05996v1
- **Type**: preprint
- **Published**: 2017-05-17
- **Authors**: Aiden Price, Joanne Hall
- **PDF**: https://arxiv.org/pdf/1705.05996v1

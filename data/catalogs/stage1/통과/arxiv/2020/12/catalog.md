# arXiv — 2020-12 (1차선별 통과)


## Trapping Sets of Quantum LDPC Codes

- **Status**: ✅
- **Reason**: 양자 LDPC지만 trapping set 식별/분류로 코드·디코더 개선 및 error floor 완화—고전 바이너리 LDPC TS 분석에서 유래한 기법으로 이식 가능성 있어 애매하여 살림(E/C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2012.15297v2
- **Type**: preprint
- **Published**: 2020-12-30
- **Authors**: Nithin Raveendran, Bane Vasić
- **PDF**: https://arxiv.org/pdf/2012.15297v2

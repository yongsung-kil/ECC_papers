# arXiv — 2020-04 (1차선별 통과)


## Comparison of Windowed-Decoder Configurations for Spatially Coupled LDPC Codes Under Equal-Complexity Constraints

- **Status**: ✅
- **Reason**: SC-LDPC 윈도우 디코더 구성 최적화(window size/update strategy/early termination, 복잡도 정규화) — 바이너리 LDPC 디코더 기법으로 NAND에 이식 가능(C/E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2004.12973v1
- **Type**: preprint
- **Published**: 2020-04-27
- **Authors**: Janik Frenzel, Stefan Müller-Weinfurtner, Johannes Huber +1
- **PDF**: https://arxiv.org/pdf/2004.12973v1
...
- **Status**: ✅
- **Reason**: SC-LDPC의 버스트 소거채널 유한길이 성능·error floor·stopping set 분석 — 바이너리 코드설계(E) 이식 가능(전반부 cyclic polar는 부수)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2004.06875v1
- **Type**: preprint
- **Published**: 2020-04-15
- **Authors**: Narayanan Rengaswamy
- **PDF**: https://arxiv.org/pdf/2004.06875v1
...
- **Status**: ✅
- **Reason**: MLC NAND 플래시 read-voltage threshold/LLR 최적화 + DNN, LDPC 디코딩 성능 — 카테고리 A 직접 해당
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2004.05340v1
- **Type**: preprint
- **Published**: 2020-04-11
- **Authors**: Cheng Wang, Kang Wei, Lingjun Kong +4
- **PDF**: https://arxiv.org/pdf/2004.05340v1

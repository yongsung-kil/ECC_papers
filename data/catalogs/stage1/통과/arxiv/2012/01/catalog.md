...
- **Status**: ✅
- **Reason**: 바이너리 LDPC 기반 product code 신규 구성+신규 디코딩 알고리즘 2종(스토리지 자기기록) — B/C/E
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:1201.1065v1
- **Type**: preprint
- **Published**: 2012-01-05
- **Authors**: Vo Tam Van, Seiichi Mita
- **PDF**: https://arxiv.org/pdf/1201.1065v1

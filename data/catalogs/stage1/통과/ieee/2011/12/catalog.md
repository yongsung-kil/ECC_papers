# IEEE Xplore — 2011-12 (1차선별 통과)


## A Unified Framework for Linear-Programming Based Communication Receivers

- **Status**: ✅
- **Reason**: SPA 기반 수신기를 LP 수신기로 변환하는 통합 프레임워크 + pseudoconfiguration 개념, LDPC LP 디코딩 기법으로 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6042890
- **Type**: journal
...
- **Status**: ✅
- **Reason**: QC-LDPC error floor 낮추는 backtracking 디코더 HW(FPGA/VLSI) 구현, 플래시 스토리지 명시, C/D 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:5954141
- **Type**: journal
- **Published**: Dec. 2011
...
- **Status**: ✅
- **Reason**: LDPC+FSC 결합 LP 디코딩 + 반복 근사 LP 디코더, 자기스토리지 저BER 타깃, BP 이식 가능 디코더 기법(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:5993490
- **Type**: journal
- **Published**: Dec. 2011
...
- **Status**: ✅
- **Reason**: PEG 기반 girth 최대화 QC-LDPC 구성 — 사이클 제거·코드설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6146165
- **Type**: conference
- **Published**: 7-9 Dec. 2
...
- **Status**: ✅
- **Reason**: BPM write-error 채널용 LLR 수정 LDPC 디코딩 — NAND write/retention LLR 보정과 유사, 디코더 기법(C) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6146112
- **Type**: conference
- **Published**: 7-9 Dec. 2
...
- **Status**: ✅
- **Reason**: SFT+cyclic shift 기반 QC-LDPC 패리티행렬 새 구성법, HW 친화 구조 주장 — 코드설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6146084
- **Type**: conference
- **Published**: 7-9 Dec. 2
...
- **Status**: ✅
- **Reason**: NAND flash MLC LDPC 직접, mutual-information 최적 read 양자화(A) 핵심 대상
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6134417
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: binary image의 redundant parity-check로 stopping set 제거→BP 성능개선, 부호 비의존 바이너리 LDPC BEC 디코딩 이식 가능(C/E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6134315
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: packet-based LDPC verification-based 디코딩(EVA) FER 분석, 디코더 변형 이식 가능성(애매, Phase3)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6133747
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: E: PBRL rate-compatible LDPC 신규 구성, short blocklength, error floor 없음, BP 디코딩 — 바이너리 LDPC 설계 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6134051
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: C: EP를 BP에 결합한 노이즈 적응(온라인 SNR 추정) LDPC 디코더 — NAND LLR 추정에 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6133838
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: E: 유한길이 LDPC의 trapping/absorbing/stopping set 전수탐색 알고리즘, QC 최적화 포함 — error floor 분석에 직접 이식
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6133832
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: non-concatenated LDPC 부호 설계+error floor 최소화 후처리+FPGA 디코더, error floor/HW 기법 이식 가능(E/D)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6133616
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: HW-friendly LDPC 코드설계+고처리량 저전력 디코더 구현, cyclic shift 제약 QC-LDPC 구성(D/E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6134485
- **Type**: conference
- **Published**: 5-9 Dec. 2
...
- **Status**: ✅
- **Reason**: QC-LDPC 신규 구성(행분할 기반, large girth)→코드설계(E) 이식 가능 바이너리
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6150451
- **Type**: conference
- **Published**: 17-19 Dec.
...
- **Status**: ✅
- **Reason**: 수정 WiMAX QC-LDPC 저복잡도 디코더 아키텍처, min-sum BNU/CNU+word-length 최적화. HW 아키텍처(D) 이식 가능
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:6174313
- **Type**: conference
- **Published**: 13-16 Dec.
...
- **Status**: ✅
- **Reason**: 6.72Gb/s LDPC 디코더 칩, layered 병렬 아키텍처+제로게이트 message permutation network(D 이식 가능).
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:6131868
- **Type**: conference
- **Published**: 12-14 Dec.
...
- **Status**: ✅
- **Reason**: 데이터 스토리지용 고율 장길이 QC-LDPC 설계, density/differential evolution+ACE로 error floor 저감(B/E 신규 기여).
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6140871
- **Type**: conference
- **Published**: 12-14 Dec.

# IEEE Xplore — 2015-02 (1차선별 통과)


## Variable-Node-Based Dynamic Scheduling Strategy for Belief-Propagation Decoding of LDPC Codes

- **Status**: ✅
- **Reason**: LDPC BP의 변수노드 기반 동적 스케줄링 디코더 알고리즘 — 진동노드 억제, NAND BP에 직접 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6994784
- **Type**: journal
- **Published**: Feb. 2015
- **Authors**: Xingcheng Liu, Yuanbin Zhang, Ru Cui
- **PDF**: https://ieeexplore.ieee.org/document/6994784
...
- **Status**: ✅
- **Reason**: 바이너리 LDPC 차수분포 최적화로 빠른 수렴 코드 설계(E) — BEC지만 이식 가능한 코드설계 기법, 애매하여 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6998058
- **Type**: journal
- **Published**: Feb. 2015
- **Authors**: Vahid Jamali, Yasser Karimian, Johannes Huber +1
- **PDF**: https://ieeexplore.ieee.org/document/6998058
...
- **Status**: ✅
- **Reason**: stochastic LDPC 디코더 칩, re-permutation 라우팅 네트워크·CNU/VNU HW 아키텍처 — 이식 가능 HW(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:6923493
- **Type**: journal
- **Published**: Feb. 2015
- **Authors**: Xin-Ru Lee, Chih-Lung Chen, Hsie-Chia Chang +1
- **PDF**: https://ieeexplore.ieee.org/document/6923493
...
- **Status**: ✅
- **Reason**: LDPC 키 reconciliation의 quantization 고려 LLR 유도 — 정보조정이나 떼어낼 LLR 양자화 기법(D) 존재로 애매하여 살림
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:7052129
- **Type**: conference
- **Published**: 2-5 Feb. 2
- **Authors**: Oana Graur, Nazia Islam, Alexandra Filip +1
- **PDF**: https://ieeexplore.ieee.org/document/7052129
...
- **Status**: ✅
- **Reason**: C: ANN+LUT 기반 비반복 LDPC 디코더 — 신경망 디코더 기법, 바이너리 LDPC BP 대체 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7510219
- **Type**: conference
- **Published**: 13-15 Feb.
- **Authors**: Dinesh Kumar, Alkesh Agrawal, Gopal Singh Phartiyal
- **PDF**: https://ieeexplore.ieee.org/document/7510219
...
- **Status**: ✅
- **Reason**: SC-LDPC Zigzag-window 디코더 신규 제안 + 코드패밀리 설계 — 바이너리 디코더/코드설계(C/E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7309001
- **Type**: conference
- **Published**: 1-6 Feb. 2
- **Authors**: Shadi Abu-Surra, Eran Pisek, Rakesh Taori
- **PDF**: https://ieeexplore.ieee.org/document/7309001
...
- **Status**: ✅
- **Reason**: 결함 메모리에서 LDPC majority-logic 디코더 신뢰성 분석 — NAND 메모리 관련 디코더 분석(C) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7308965
- **Type**: conference
- **Published**: 1-6 Feb. 2
- **Authors**: Elsa Dupraz, David Declercq, Bane Vasić
- **PDF**: https://ieeexplore.ieee.org/document/7308965

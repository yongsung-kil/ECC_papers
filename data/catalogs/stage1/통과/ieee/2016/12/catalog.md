# IEEE Xplore — 2016-12 (1차선별 통과)


## Construction of Quasi-Cyclic LDPC Codes via Masking With Successive Cycle Elimination

- **Status**: ✅
- **Reason**: QC-LDPC 신규 구성: masking + successive cycle elimination으로 사이클 제거 (E. 이식 가능 코드 설계, 바이너리)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7565543
- **Type**: journal
- **Published**: Dec. 2016
...
- **Status**: ✅
- **Reason**: variable-regular LDPC의 LETS(트래핑셋) 특성화·탐색 알고리즘, error floor 관련 코드설계(E, 바이너리)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7575635
- **Type**: journal
- **Published**: Dec. 2016
...
- **Status**: ✅
- **Reason**: 유한길이 LDPC 코드 설계용 EXIT/dispersion 추적 분석(E), 바이너리 LDPC BP 반복 추적에 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7841834
- **Type**: conference
- **Published**: 4-8 Dec. 2
...
- **Status**: ✅
- **Reason**: I-CRMP 등 신규 column-row 메시지패싱 스케줄로 LDPC BP 수렴 가속(C), NAND LDPC 디코더에 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7841913
- **Type**: conference
- **Published**: 4-8 Dec. 2
...
- **Status**: ✅
- **Reason**: regular LDPC Min-Sum FPGA 디코더, Benes 기반 비차단 상호연결망으로 코드 유연성 제공하는 신규 HW 아키텍처(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:7822016
- **Type**: conference
- **Published**: 20-21 Dec.
...
- **Status**: ✅
- **Reason**: MLC NAND 플래시 LDPC, 비균일 검출+소프트 LLR 양자화, 수정 MSRBI-MLGD 디코더 - NAND 직접(A)+디코더(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7849731
- **Type**: conference
- **Published**: 19-21 Dec.
...
- **Status**: ✅
- **Reason**: girth/ACE 분포 계산 알고리즘(SETA subgraph) - 사이클 제거·코드설계 도구(E), 바이너리 LDPC Tanner graph 적용
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7843313
- **Type**: conference
- **Published**: 19-21 Dec.
...
- **Status**: ✅
- **Reason**: IRMP 신규 메시지패싱 스케줄로 BP 디코딩 개선 — 부호 비의존 디코더 기법(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7917141
- **Type**: conference
- **Published**: 15-18 Dec.
...
- **Status**: ✅
- **Reason**: spatially-coupled RA(LDPC계열) 코드 설계 + density evolution, 바이너리; 릴레이채널이나 SC 코드설계 이식 여지로 살림(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7833556
- **Type**: conference
- **Published**: 14-16 Dec.
...
- **Status**: ✅
- **Reason**: A: MLC 플래시 워크로드 인지 차등 ECC, ISPP/ECC 강도 트레이드오프로 NAND SSD 직접
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7823793
- **Type**: conference
- **Published**: 13-16 Dec.
...
- **Status**: ✅
- **Reason**: flooded Min-Sum 디코더의 메모리 결함 내성 신뢰성 분석 - 디코더 HW/아키텍처 관점(D) 이식 가능
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:7841271
- **Type**: conference
- **Published**: 11-14 Dec.

...
- **Status**: ❌
- **Reason**: Sinkhorn balancing으로 스도쿠 풀이, ECC와 개념 연결만 언급 — LDPC 디코더·구성 신규 기여 없음
- **ID**: ieee:4804943
- **Type**: journal
- **Published**: April 2009
...
- **Status**: ❌
- **Reason**: 수중 MIMO 등화기(SPRE)+BP 검출 - LDPC는 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:4815408
- **Type**: journal
- **Published**: April 2009
...
- **Status**: ❌
- **Reason**: RS·simplex 부호로 OFDM PAPR 저감, 비-LDPC이며 무선 응용 특이적, 떼어낼 디코더 기법 없음
- **ID**: ieee:4802318
- **Type**: journal
- **Published**: April 2009
...
- **Status**: ❌
- **Reason**: CPFSK 변조용 코드설계(EXIT/degree 최적화) - 무선 변조 특이적, NAND 이식성 낮음
- **ID**: ieee:4907452
- **Type**: journal
- **Published**: April 2009
...
- **Status**: ❌
- **Reason**: Compress-spread-forward 다단말 소스코딩+무선 스트리밍, ECC 디코더·구성 기여 없음
- **ID**: ieee:4814349
- **Type**: journal
- **Published**: April 2009
...
- **Status**: ❌
- **Reason**: UEP-LDPC를 Gaussian approximation으로 설계해 이미지 전송 품질 향상; 응용 특이적이고 새 디코더/HW 기여 없음
- **ID**: ieee:4918009
- **Type**: conference
- **Published**: 5-8 April 
...
- **Status**: ❌
- **Reason**: 무선 fading EGC 수신기 LDPC 응용; large girth QC-LDPC도 교과서 수준 구성으로 새 코드설계 기여 없음
- **ID**: ieee:4917856
- **Type**: conference
- **Published**: 5-8 April 
...
- **Status**: ❌
- **Reason**: noncoherent 채널 pilot-assisted BPSK용 LLR 유도, 통신 채널 특이적 메트릭, NAND LDPC에 이식할 기법 없음
- **ID**: ieee:4917788
- **Type**: conference
- **Published**: 5-8 April 
...
- **Status**: ❌
- **Reason**: 바이너리 dirty-paper coding 실용화 (random binning); 표준 QC-LDPC 사용일 뿐 새 디코더/구성/HW 기여 없음, 소스/사이드정보 코딩 응용
- **ID**: ieee:4917852
- **Type**: conference
- **Published**: 5-8 April 
...
- **Status**: ❌
- **Reason**: 채널 적응 bit interleaver 설계 + surrogate BEC 분석, 통신 응용 특이적, 떼어낼 LDPC 디코더/HW 없음
- **ID**: ieee:4917627
- **Type**: conference
- **Published**: 5-8 April 
...
- **Status**: ❌
- **Reason**: 소프트웨어 워터마킹/보안 논문, LDPC ECC와 무관
- **ID**: ieee:5170389
- **Type**: conference
...
- **Status**: ❌
- **Reason**: PLC 채널 적응 스킴 응용으로 LDPC ECC 기법 무관, 떼어낼 디코더/구성 없음
- **ID**: ieee:4913438
- **Type**: conference
- **Published**: 29 March-1
...
- **Status**: ❌
- **Reason**: WLAN MIMO-OFDM LDPC 성능평가. 표준 LDPC를 베이스라인으로 응용, 신규 기법 없음
- **ID**: ieee:5010560
- **Type**: conference
...
- **Status**: ❌
- **Reason**: IEEE 802.11n 불규칙 LDPC 성능평가. 표준 인코더/디코더 응용, 신규 기여 없음
- **ID**: ieee:5010561
- **Type**: conference
- **Published**: 28-30 Apri
- **Authors**: Salwa Serag Eldin, Mohamed Nasr, Salah Khamees +2
...
- **Status**: ❌
- **Reason**: HF-IP용 유한체 기반 단길이 QC-LDPC 구성. 비-LDPC(STANAG) 대체용 표준 구성, 새 코드설계 기법 약함; 무선 응용 특이적
- **ID**: ieee:5235581
- **Type**: conference
- **Published**: 28-30 Apri
...
- **Status**: ❌
- **Reason**: BICM-ID 변조/디매핑 기법, LDPC는 베이스라인이고 떼어낼 디코더/코드설계 기여 없음 (무선통신 변조 특이적)
- **ID**: ieee:5073425
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: MIMO GLA에서 LDPC 코드레이트/변조차수 최적화일 뿐 떼어낼 LDPC 디코더/구성/HW 신규 기여 없음
- **ID**: ieee:5073749
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: 소스코딩+변조 결합(JSCC), LDPC ECC 기법 아님
- **ID**: ieee:5073638
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: General Linear Group 기반 비이진 LDPC, 비이진 LDPC라 제외
- **ID**: ieee:5073713
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: OFDM 채널추정+파일럿 심볼 기법, IRA 코딩은 부수적이고 통신 응용 특이적, 떼어낼 ECC 기법 없음
- **ID**: ieee:5073485
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: OFDM/OQAM 인지무선 스펙트럼효율 분석, LDPC 부수 언급도 없고 ECC 기법 없음
- **ID**: ieee:5073859
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: rateless/fountain 코드 도수분포 적응으로 NAND 채널 ECC와 무관, 떼어낼 바이너리 LDPC 기법 없음
- **ID**: ieee:5073827
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: MIMO ML 구체(sphere/stack) 병렬 디코더로 LDPC 무관, 이식 가능 LDPC 기법 없음
- **ID**: ieee:5073768
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: 협력 기지국 업링크 전력제어로 채널코딩과 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:5073887
- **Type**: conference
- **Published**: 26-29 Apri
...
- **Status**: ❌
- **Reason**: LDPC-LDGM vs Raptor 패킷레벨 FEC 효율 비교 — fountain/erasure·JSCC 영역, 떼어낼 채널 ECC 디코더 기법 없음
- **ID**: ieee:5068986
- **Type**: conference
- **Published**: 22-24 Apri
...
- **Status**: ❌
- **Reason**: turbo codes EXIT chart 분석 — 비-LDPC, 부호 비의존 디코더 기법 아님(분석 도구), 떼어낼 BP 이식 기법 없음
- **ID**: ieee:5068930
- **Type**: conference
- **Published**: 22-24 Apri
...
- **Status**: ❌
- **Reason**: 네트워크 측정용 counter braids 아키텍처, sparse graph 코드 영감이나 채널 ECC가 아니고 LDPC BP 디코더로 이식할 기법 아님
- **ID**: ieee:5061958
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 분산 소스 코딩(Slepian-Wolf 압축)+터보 코드, 채널 ECC 아님이고 떼어낼 LDPC BP 기법 없음
- **ID**: ieee:4960124
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 분산 소스 코딩(Slepian-Wolf) 기반 이미지 인증, 소스 코딩이라 채널 ECC 아님
- **ID**: ieee:4959875
- **Type**: conference
- **Published**: 19-24 Apri
...
- **Status**: ❌
- **Reason**: 분산 가설검정(distance testing)에 syndrome code 사용, 소스코딩/Slepian-Wolf 류로 채널 ECC 아님
- **ID**: ieee:4959707
- **Type**: conference
- **Published**: 19-24 Apri
...
- **Status**: ❌
- **Reason**: 무선 보안 dialog codes - 비-LDPC 보안 코딩, NAND ECC와 무관
- **ID**: ieee:5211946
- **Type**: conference

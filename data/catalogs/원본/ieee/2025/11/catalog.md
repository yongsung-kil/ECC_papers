...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] NB-LDPC(길이 1024, 부호율 0.5) 코드가 CCM 무선 보안 통신에 적용되었으나 NB-LDPC 자체는 이식 가능 기법(E)에 해당; 응용 도메인 특이성으로 Phase 3 재검토 필요
- **ID**: ieee:11023168
- **Type**: journal
...
- **Status**: ❌
- **Reason**: Voronoi 성상도 N차원 회전으로 페이딩 채널 다이버시티 향상을 다루는 무선 변조 논문으로 LDPC 언급 없고 이식 가능한 ECC 기법 없음
- **ID**: ieee:11157912
- **Type**: journal
- **Published**: November 2
- **Authors**: Ryo Tozawa, Eiji Okamoto, Naoto Horiike +1
...
- **Status**: ❌
- **Reason**: BMST-LDPC를 이용한 희소 소스의 JSCC(소스-채널 결합 부호화)로, LDPC는 베이스라인 컴포넌트이며 이식 가능한 ECC 기법 없음
- **ID**: ieee:11025846
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] GLDPC 코드의 bit flipping BDD 알고리즘 오류정정 성능 분석(랜덤 오류·워스트케이스 오류 하한 도출)이 이식 가능한 디코더 알고리즘 기법(C)이며, 비이진 GLDPC 확장도 포함.
- **ID**: ieee:11164952
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: 극부호(polar code) 연접 구조의 정지 집합 분석 논문으로, LDPC 관련 내용이 없고 이식 가능한 LDPC 기법 없음
- **ID**: ieee:11039767
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: Wi-Fi 8용 확률적 성형(probabilistic shaping) 논문으로 LDPC는 인코더 컴포넌트로만 사용되며 이식 가능한 LDPC 설계·디코더 기법 없음
- **ID**: ieee:11059934
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: CV-QKD 보안 시스템 논문으로 LDPC는 THz 채널에서의 비밀키 전송거리 개선을 위한 부수 수단으로만 언급됨 — 이식 가능한 디코더/HW/코드설계 기법 없음.
- **ID**: ieee:11069272
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: LCMA(격자 코드 기반 다중 접속) 연구로 LDPC는 비교 baseline으로만 등장하며 이식 가능한 LDPC 관련 기법이 없음.
- **ID**: ieee:11152029
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: PAC(폴라-컨볼루션) 코드의 순차 디코딩 복잡도 분석 논문으로 LDPC는 비교 baseline으로만 언급되며 이식 가능한 LDPC 기법 없음.
- **ID**: ieee:11155881
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] MDS array 코드의 이레이저 디코딩(LU 분해 기반) 및 효율적 인코딩/디코딩 기법을 제시하며, 대규모 스토리지 시스템 직접 적용을 목표로 함 — B(스토리지 ECC) 및 E(코드 설계) 해당.
- **ID**: ieee:11165514
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: 자기지도 학습 기반 시맨틱 통신 프레임워크 논문으로 LDPC 언급 없고 시맨틱 통신 특이적이며 이식 가능한 ECC 기법 없음
- **ID**: ieee:11024114
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: Wi-Fi 25년 역사 튜토리얼로, LDPC는 PHY 구성 요소 중 하나로 부수 언급되며 떼어낼 독자적 ECC 기법 없음.
- **ID**: ieee:11429621
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: ODMA 비소스 다중접속 전송 기법 논문으로 LDPC 관련 없고 무선 다중접속 특이적이며 떼어낼 ECC 기법 없음
- **ID**: ieee:11006717
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: 무선 다중사용자 업링크 간섭 억압을 위한 일반화 최근접 이웃 디코딩 수신기 구조로, LDPC 관련 이식 가능 기법 없음
- **ID**: ieee:11030549
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: Spatially coupled 베르누이 행렬 기반 그룹 테스팅(pooled data) 문제로, LDPC가 직접 등장하지 않고 NAND ECC에 이식 가능한 채널코딩 기법 없음.
- **ID**: ieee:11168964
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: 무선 랜덤 액세스용 SC-CW 시그니처 코드 논문으로 LDPC와 무관하며, 이식 가능한 LDPC 디코더·코드설계 기법 없음.
- **ID**: ieee:11146730
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: Chebyshev 거리 기반 순열 코드 연구로, LDPC/ECC와 무관하며 NAND 플래시 ECC에 이식 가능한 디코더·HW·코드설계 기법 없음.
- **ID**: ieee:11168942
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: 듀얼-폴라 JSCC(소스-채널 결합) 전용 CR-BP 디코더로, JSCC 특화 구조라 채널 코딩 LDPC에 독립적으로 이식할 수 있는 기법 없음.
- **ID**: ieee:11123431
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: UAV 스웜 궤적 계획 및 물리계층 키 생성 논문으로 LDPC ECC와 무관
- **ID**: ieee:11037556
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: 무선 분산 학습의 강인성 정보이론적 분석 논문으로 LDPC ECC와 무관
- **ID**: ieee:11069261
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: SC-SCMA 무선 다중접속 검출 논문으로, LDPC는 공동 검출-디코딩에서 부수적으로 언급될 뿐 이식 가능한 LDPC 디코더·HW·코드설계 기법 없음
- **ID**: ieee:11024121
- **Type**: journal
- **Published**: Nov. 2025
...
- **Status**: ❌
- **Reason**: 광전송 OSNR 측정 논문으로 FEC는 부수 언급 수준이며 LDPC 코드설계·디코더 기법 없음
- **ID**: ieee:11282420
- **Type**: conference
- **Published**: 9-13 Nov. 
...
- **Status**: ❌
- **Reason**: THz 무선 실험에서 LDPC를 기성 코드로 평가만 하며 새로운 디코더·코드설계 기법 없음
- **ID**: ieee:11351268
- **Type**: conference
- **Published**: 9-12 Nov. 
...
- **Status**: ❌
- **Reason**: 6G MIMO-OFDM NOMA 분석 논문으로 LDPC 미언급, 이식 가능한 ECC 기법 없음
- **ID**: ieee:11365759
- **Type**: conference
- **Published**: 9-12 Nov. 
...
- **Status**: ❌
- **Reason**: 무선 grant-free 접속 CFO 보상 논문으로 LLR은 사용자 검출용이며 LDPC 이식 가능 기법 없음
- **ID**: ieee:11351025
- **Type**: conference
- **Published**: 9-12 Nov. 
...
- **Status**: ❌
- **Reason**: 지구-달 통신 링크 시뮬레이션으로 LDPC·ECC 기법 전혀 없음
- **ID**: ieee:11383966
- **Type**: conference
- **Published**: 8-10 Nov. 
...
- **Status**: ❌
- **Reason**: LDPC 비밀공유(secret sharing) 보안 응용으로 채널 ECC와 무관하며 이식 가능한 디코더·코드설계 기법 없음
- **ID**: ieee:11385099
- **Type**: conference
- **Published**: 7-9 Nov. 2
...
- **Status**: ❌
- **Reason**: Polar 코드 + GFDM Massive MIMO 논문이며 LDPC 관련 기법 없음. 무선 응용 특이적.
- **ID**: ieee:11350801
- **Type**: conference
- **Published**: 7-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 유선 이더넷 전력 최적화(CPU·TCAM·포트) 논문. ECC·LDPC 내용 전무.
- **ID**: ieee:11401902
- **Type**: conference
- **Published**: 7-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 은닉 타이밍 채널 신뢰성을 위한 ECC 비교 연구로, LDPC는 적합하지 않다는 결론만 도출하며 새로운 기법 없음
- **ID**: ieee:11309533
- **Type**: conference
- **Published**: 6-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 신호처리 응용 전반의 광범위한 서베이 논문으로, LDPC 관련 이식 가능한 기법 없음
- **ID**: ieee:11388350
- **Type**: conference
- **Published**: 6-8 Nov. 2
...
- **Status**: ❌
- **Reason**: LIS/6G용 딥러닝 수신기(MRC/EGC 간섭 제거) 논문; LDPC 내용 없고 NAND ECC와 무관.
- **ID**: ieee:11394350
- **Type**: conference
- **Published**: 5-9 Nov. 2
...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] 비이진 LDPC 패리티 검사 행렬 휴리스틱 인코딩 알고리즘(E)으로 NAND 비이진 LDPC 코드 설계에 이식 가능.
- **ID**: ieee:11350880
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: Raptor Code 기반 FSO 시스템으로 LDPC는 비교 대상 언급뿐; 이식 가능한 LDPC 디코더·HW·코드설계 기법 없음.
- **ID**: ieee:11349847
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 광섬유용 TCM-LDPC 결합 수신기 구조로 광통신 특이적; 독립적으로 이식 가능한 LDPC 알고리즘·HW 없음.
- **ID**: ieee:11349848
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: QKD 네트워크 정보 조정 방식으로 보안·QKD 응용 특이적; LDPC ECC 기법 없음.
- **ID**: ieee:11349946
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 폴라 부호 변조+광통신 응용 특이적, LDPC 아니며 떼어낼 ECC 기법 없음
- **ID**: ieee:11350889
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 신경망 soft-decision demapper가 핵심이며 LDPC 직접 언급 없음; NAND LDPC ECC 관련 기법 없음.
- **ID**: ieee:11350726
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 광통신 특이적 Volterra 비선형 등화가 핵심이며 FEC는 보조적 역할; 이식 가능한 LDPC 기법 없음.
- **ID**: ieee:11350864
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 50G/B50G PON 아키텍처 개요 발표로 FEC/LDPC 구체 기법 없음.
- **ID**: ieee:11350772
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: 광통신 FEC-assisted 등화 알고리즘으로 LDPC는 보조적 역할; NAND LDPC에 이식할 독립 기법 없음.
- **ID**: ieee:11349870
- **Type**: conference
- **Published**: 5-8 Nov. 2
...
- **Status**: ❌
- **Reason**: QKD 정보조정용 LDPC 샘플링율 최적화, 보안 응용 특이적이며 떼어낼 ECC 기법 없음
- **ID**: ieee:11301492
- **Type**: conference
- **Published**: 5-7 Nov. 2
...
- **Status**: ❌
- **Reason**: Hamming graph 기반 LRC 코드 이론, LDPC 디코더/HW로 이어지지 않는 순수 코드이론
- **ID**: ieee:11301429
- **Type**: conference
- **Published**: 5-7 Nov. 2
...
- **Status**: ❌
- **Reason**: Wi-Fi 8 HARQ+LDPC 성능분석, 무선 응용 특이적이며 LDPC는 베이스라인
- **ID**: ieee:11345390
- **Type**: conference
- **Published**: 5-7 Nov. 2
...
- **Status**: ❌
- **Reason**: 6G THz 양자광통신 개념·소프트출력 검출기 논의, WLAN LDPC는 부수 언급 — 이식 가능한 LDPC 기법 없음
- **ID**: ieee:11439655
- **Type**: conference
- **Published**: 4-6 Nov. 2
...
- **Status**: ❌
- **Reason**: BCH-Polar 캐스케이드 코드와 SCL 디코딩의 유전알고리즘 설계, LDPC 무관 + 무선 응용 특이적, 이식 가능 기법 없음
- **ID**: ieee:11322161
- **Type**: conference
- **Published**: 28-30 Nov.
...
- **Status**: ❌
- **Reason**: 5G+MEC 실시간 전송과 ITCN 진단 논문, LDPC는 HARQ 보안의 부수 언급일 뿐 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:11322151
- **Type**: conference
- **Published**: 28-30 Nov.
...
- **Status**: ❌
- **Reason**: 가시광통신(VLC) 기술 개론 리뷰, LDPC 언급 없고 떼어낼 ECC 기법 없음
- **ID**: ieee:11450627
- **Type**: conference
- **Published**: 28-29 Nov.
...
- **Status**: ❌
- **Reason**: Vector Symbol Decoding의 딥러닝 오류위치 탐지 — VSD 전용 기법, LDPC 디코더로 이식 불명확
- **ID**: ieee:11279869
- **Type**: conference
- **Published**: 26-28 Nov.
...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] 이진·비이진 LDPC 디코더 GPU 구현 — 이식 가능한 디코더 알고리즘·HW(C/D), QKD는 맥락일 뿐
- **ID**: ieee:11318914
- **Type**: conference
- **Published**: 25-28 Nov.
...
- **Status**: ❌
- **Reason**: IRSA 랜덤액세스+DRL — LDPC 채널부호 아님, 이식 가능 ECC 디코더 없음
- **ID**: ieee:11304049
- **Type**: conference
- **Published**: 25-27 Nov.
...
- **Status**: ❌
- **Reason**: DI-QKD 양자 키 분배 시스템 — 양자/보안 도메인, LDPC 부호·디코더 기법 없음 (원칙 제외)
- **ID**: ieee:11344594
- **Type**: conference
- **Published**: 2-5 Nov. 2
...
- **Status**: ❌
- **Reason**: GRAND 디코더(code-agnostic) for NOMA/멀티유저 - LDPC 디코더 아니며 NAND 이식 기법 부재, 무선 멀티유저 특이적
- **ID**: ieee:11270656
- **Type**: conference
- **Published**: 17-19 Nov.
...
- **Status**: ❌
- **Reason**: 드론 PUF 기반 물리계층 키 생성/보안. LDPC 언급 자체가 없고 ECC 기법 무관
- **ID**: ieee:11354957
- **Type**: conference
- **Published**: 14-17 Nov.
...
- **Status**: ❌
- **Reason**: 생체인증 fuzzy commitment에서 LDPC를 매칭용 ECC로 부수 사용. 떼어낼 새 디코더/구성/HW 기여 없음
- **ID**: ieee:11354628
- **Type**: conference
- **Published**: 14-17 Nov.
...
- **Status**: ❌
- **Reason**: 디지털 워터마킹에서 LDPC를 오류정정으로 사용. 코드설계/디코더 새 기여 없는 응용 특이
- **ID**: ieee:11385203
- **Type**: conference
- **Published**: 14-16 Nov.
...
- **Status**: ❌
- **Reason**: DVB-S2의 표준 LDPC-BCH 연접부호 BER 성능 측정. 표준 부호 단순 평가, 새 기여 없음
- **ID**: ieee:11383947
- **Type**: conference
- **Published**: 14-16 Nov.
...
- **Status**: ❌
- **Reason**: 포스트양자 사이버보안 방법론에서 LDPC 기반 crypto-code를 부수 언급. 떼어낼 ECC 기법 없음
- **ID**: ieee:11267930
- **Type**: conference
- **Published**: 14-16 Nov.
...
- **Status**: ❌
- **Reason**: AMC 변조 임계 전략 분석, LDPC 무관(ECC 기법 없음)
- **ID**: ieee:11416407
- **Type**: conference
- **Published**: 14-16 Nov.
- **Authors**: Yue Wang
...
- **Status**: ❌
- **Reason**: NTRU KEM 대상 SCA-LDPC 부채널 키복구 공격 — 보안/공격용, 채널코딩 ECC 기여 없음, 원칙 제외
- **ID**: ieee:11310913
- **Type**: conference
- **Published**: 10-12 Nov.
...
- **Status**: ❌
- **Reason**: 5G-NR 표준 LDPC 인코더 FPGA 구현 — 표준 부호 그대로 사용, 디코더/새 코드설계 기여 없음(인코더만)
- **ID**: ieee:11317207
- **Type**: conference
- **Published**: 10-12 Nov.
...
- **Status**: ❌
- **Reason**: 위성-지상 스펙트럼 공존(빔/전력 제어, Q-러닝) — LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:11317599
- **Type**: conference
- **Published**: 10-12 Nov.

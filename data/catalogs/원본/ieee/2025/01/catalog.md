...
- **Status**: ❌
- **Reason**: BICM-ID + PAS의 바이너리 레이블링 및 EXIT 분석 논문으로, LDPC 디코더/HW/코드설계 이식 기법 없음 — 무선/광통신 특이적
- **ID**: ieee:10604777
- **Type**: journal
- **Published**: January 20
- **Authors**: Mamoru Komatsu, Akira Naka
- **PDF**: https://ieeexplore.ieee.org/document/10604777
...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] 비이진 LDPC 외부 코드 + AMP-BP 디코더 알고리즘 이식 가능 (C/E); 스토리지용 비이진 LDPC 설계 및 BP 변형 기법 직접 활용 가능
- **ID**: ieee:10750868
- **Type**: journal
- **Published**: Jan. 2025
- **Authors**: Jamison R. Ebert, Jean-Francois Chamberland, Krishna R. Narayanan
- **PDF**: https://ieeexplore.ieee.org/document/10750868
...
- **Status**: ❌
- **Reason**: RIS 보조 다중 사용자 시스템의 MMSE LLR 정제·IDD 논문 — LDPC는 코딩 컴포넌트, 이식 가능한 LDPC 디코더/HW 기법 없음
- **ID**: ieee:10747209
- **Type**: journal
- **Published**: Jan. 2025
- **Authors**: Roberto C. G. Porto, Rodrigo C. de Lamare
- **PDF**: https://ieeexplore.ieee.org/document/10747209
...
- **Status**: ❌
- **Reason**: 항공선 massive MIMO 시맨틱 통신·빔포밍 논문으로, LDPC 언급 없음 — JSCC/시맨틱 통신 특이적
- **ID**: ieee:10680080
- **Type**: journal
- **Published**: Jan. 2025
- **Authors**: Minghui Wu, Zhen Gao, Zhaocheng Wang +3
- **PDF**: https://ieeexplore.ieee.org/document/10680080
...
- **Status**: ❌
- **Reason**: 광무선 IM/DD 채널 기하학적 컨스텔레이션 쉐이핑이 핵심; LDPC는 예시로만 등장하며 이식 가능한 LDPC 기법 없음
- **ID**: ieee:10778185
- **Type**: journal
- **Published**: Jan. 2025
- **Authors**: Suhua Zhou, Tianqi Li, Zhaoxi Fang +2
- **PDF**: https://ieeexplore.ieee.org/document/10778185
...
## Low-Power CRC-BCH Error Correction Integrated with LFSR and Clock Gating: A Comparative Analysis

- **Status**: ❌
- **Reason**: 우주 방사선 대비 CRC-BCH ECC 아키텍처 논문으로, LDPC 내용 없음
- **ID**: ieee:10903738
- **Type**: conference
- **Published**: 6-8 Jan. 2
- **Authors**: Karthik Velagapudi, Shuo Wu, Nan Wang
- **PDF**: https://ieeexplore.ieee.org/document/10903738
- **Abstract**: This paper presents a low-power, Clock-Gated Integrated CRC-BCH (Cyclic Redundancy Check - Bose-Chaudhuri-Hocquenghem) Error Correction Code (ECC) architecture designed to address single-event upsets (SEUs) and multi-cell upsets (MCUs) in space applications. ECCs are essential for ensuring reliable data transmission and reception in avionics and memory systems, which are increasingly prone to faults due to cosmic radiation, thereby necessitating robust fault detection and correction mechanisms. In this work, a Linear Feedback Shift Register (LFSR) based fault injector simulator was introduced within the CRC-BCH module to evaluate its error detection and correction capabilities under various fault scenarios. Additionally, a Clock Gating Integrated Circuit (CGIC) was implemented to optimize power consumption. The proposed design achieves significant power efficiency while maintaining high performance and reliability, making it highly suitable for power-sensitive, high-reliability environments.

## A Comparison of LDPC and Polar Code on High Level Modulated MIMO-OFDM-EAC-NOMA System

- **Status**: ❌
- **Reason**: MIMO-OFDM-NOMA 무선 응용 특이적; LDPC는 비교 베이스라인이고 결론은 Polar 우위, 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:10857515
- **Type**: conference
- **Published**: 3-5 Jan. 2
- **Authors**: Nguyen Thu Nga, Nguyen Van Huy, Nguyen Minh Phuc +2
- **PDF**: https://ieeexplore.ieee.org/document/10857515
- **Abstract**: For beyond 5G communication, Non-Orthogonal Multiple Access (NOMA) is an emerging multiplexing technique for a high number of users sharing the same source allocation. The joint of Orthogonal Frequency Division Multiplexing (OFDM) with NOMA improves the overall channel capacity and central efficiency of the system. Generally, the successive interference cancellation (SIC) method is used for detection users' power value at the NOMA decoding stage at low level of digital modulation. However, the ergodicity and comparison (EAC) scheme is an actual solution for high order modulation format such as 64-quadrature amplitude modulation (QAM) or even 256-QAM in 5G/6G Massive MIMO-NOMA wireless networks. Therefore, this paper focuses on the combination of EAC-NOMA scheme to the channel decoding algorithm of Low density parity check (LDPC) and Polar code (PC) on the 16×16 MIMO-OFDM-NOMA system. By assigning the power scheme, with different order of QAM, the higher power of the user, the lower of the attained BER as NOMA feature. For deploying channel decoding scheme, if increasing the number of MIMO antennas, the obtained BERs are decreased. Additionally, among the LDPC-BP, LDPC-LAMS and PC channel decoding algorithm, PC achieves the best system's performance. In our system, we propose to use PC-MMSE in Massive MIMO-OFDM-EAC-NOMA system due to the most effectiveness in error detection and error correction. From our simulation system, we propose the power ratio for user is 0.25: 0.75 as user 1: user 2, respectively.

## Deploying Deep Learning to Improve the Performance of MIMO-OFDM Systems Using LDPC Channel Coding in V2X Communications

- **Status**: ❌
- **Reason**: V2X MIMO-OFDM에서 ANN으로 path gain 학습; LDPC는 단순 채널코딩 베이스라인, LDPC 디코더 자체 개선 아님(무선 특이적)
- **ID**: ieee:10857550
- **Type**: conference
- **Published**: 3-5 Jan. 2
- **Authors**: Nguyen Thu Nga, Nguyen Dinh Duc, Trinh Manh Tien
- **PDF**: https://ieeexplore.ieee.org/document/10857550
- **Abstract**: This paper focuses on the application of Deep Learning technology to improve the performance of V2X (Vehicle-to-Everything) communication systems. Of the Multiple-input Multiple-output Orthogonal Frequency Division Multiplexing (MIMO-OFDM) system over a traffic environment, supported by Dedicated Short-Range Communication (DSRC) technology, we deploy channel coding algorithm of Low-density parity-check code (LDPC) for correcting error derived from the transmission media. Artificial Neural Network (ANN), an algorithm that can interpret raw data, is used to simulate real-world data. We apply ANN with layers as a mathematical model to train the path gain parameter, which thereafter examined the system performance BER of 5G channel coding MIMO-OFDM system over Rayleigh fading channel. We evaluate the BER and the throughput at different vehicle speeds of 60 km/h or 120 km/h as well as training process of 50 data samples or 250 data samples in scenarios of $\mathbf{2}\times \mathbf{2}$ or $\mathbf{4}\times \mathbf{4}$ MIMO antennas deployed DSRC technique. From the simulation results, training model for optimizing path gain has yielded positive results in terms of system performance and throughput, even at lower 50 data sample training. It can be said that the moving speeds of vehicles significantly affect the performance of DSRC systems due to the influence of the Doppler effect. After ANN training, if speeding up the velocity, the throughputs of $\mathbf{4}\times \mathbf{4}$ MIMO-OFDM system are increasing at lower data sample training.

## Short Blocklength Nonbinary Raptor-Like LDPC Coding Systems Design and Simulation

- **Status**: ❌
- **Reason**: Nonbinary GF(2^q) QC-LDPC 코드 설계 — 비이진 LDPC는 원칙 제외 (절차 0)
- **ID**: ieee:10820840
- **Type**: journal
- **Published**: 2025
- **Authors**: Jakub Hyla, Wojciech Sułek
- **PDF**: https://ieeexplore.ieee.org/document/10820840
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC 디코더 PiM HW — 비이진 LDPC는 기준상 즉시 제외
- **ID**: ieee:11218833
- **Type**: journal
- **Published**: 2025
- **Authors**: Oscar Ferraz, Vitor Silva, Gabriel Falcão
- **PDF**: https://ieeexplore.ieee.org/document/11218833
...
- **Status**: ✅
- **Reason**: CCSDS 바이너리 LDPC BP 디코더 종료검출/거부확률 분석 — C 관련 디코더 동작, 애매하므로 살림(Phase3)
- **ID**: ieee:10833618
- **Type**: journal
- **Published**: 2025
- **Authors**: Rebecca Giuliani, Massimo Battaglioni, Marco Baldi +2
- **PDF**: https://ieeexplore.ieee.org/document/10833618
...
- **Status**: ❌
- **Reason**: Polar 부호 SCL 디코딩 개선 — LDPC가 비교 대상일 뿐, Polar 전용 기법으로 이식 불가
- **ID**: ieee:11267413
- **Type**: journal
- **Published**: 2025
- **Authors**: Zongmiao He, Yangjun Chen, Shipeng Gao +3
- **PDF**: https://ieeexplore.ieee.org/document/11267413
- **Abstract**: In the case of short code, polar code demonstrates superior performance compared with Low Density Parity Check (LDPC) code. Particularly in low coding rate scenario, the complexity of Polar code encoding and decoding is significantly lower than that of LDPC code. The technological advantage of Polar code makes it of great value in special application scenarios such as satellite communication and ocean communication. The polar coding scheme can significantly improve the transmission reliability of the communication system, because the satellite spread spectrum communication system generally adopts short code design.In the research of decoding algorithm, the original Serial Cancellation (SC) decoding algorithm has simple rules, but the decoding effect is not ideal under the limited code length, and the serial decoding mechanism leads to large decoding delay. The Successive Cancellation List (SCL) decoding algorithm improves decoding performance by increasing the number of decoding search path. However, maintaining multiple decoding paths can multiply the decoding complexity. Fast node-based decoding algorithm aims to accelerate decoding and reduce latency by defining and simplifying the decoding process for specific nodes, yet they do not optimize the decoding paths. In view of the above problems, this paper proposes a Simplified Parity Check-based Cyclic Redundancy Check (CRC)-Aided Successive Cancellation List (S-PC-CASCL) decoding algorithm. Simulation results demonstrate that the proposed S-PC-CASCL maintains excellent error correction performance while reducing the average list size by up to 16 % under low Signal Noise Ratio (SNR) conditions, thereby lowering computational complexity and decoding latency compared with other widely used polar decoding methods.

## Asymptotically Good CSS-T Codes and a New Construction of Triorthogonal Codes

- **Status**: ❌
- **Reason**: 양자 CSS-T/triorthogonal 코드 구성, magic state distillation — 양자 전용 개념(직교성·triorthogonal) 의존, 고전 바이너리 LDPC로 이식 불가, 원칙 제외
- **ID**: ieee:11047535
- **Type**: journal
- **Published**: 2025
- **Authors**: Elena Berardini, Reza Dastbasteh, Josu Etxezarreta Martinez +2
- **PDF**: https://ieeexplore.ieee.org/document/11047535
...
- **Status**: ❌
- **Reason**: 고밀도 스토리지용 스펙트럼 성형 제약부호(k-constrained) 설계 — SDD 언급하나 ECC 자체는 일반적, 떼어낼 LDPC 디코더/구성 신규 기여 없음. 다만 스토리지 도메인이라 애매; 성형부호 중심이고 LDPC 특정 기법 부재로 out
- **ID**: ieee:10887185
- **Type**: journal
- **Published**: 2025
- **Authors**: Chi Dinh Nguyen
- **PDF**: https://ieeexplore.ieee.org/document/10887185
...
## Design of Enhanced Protograph Codes and Codebooks for IDD-SCMA Systems

- **Status**: ✅
- **Reason**: PEXIT 기반 protograph PLDPC 코드 설계(바이너리 LDPC 구성), 이식 가능(E); SCMA codebook은 부수
- **ID**: ieee:10935343
- **Type**: journal
- **Published**: 2025
- **Authors**: Jiaqin Chen, Huan Ma, Liang Lv +1
- **PDF**: https://ieeexplore.ieee.org/document/10935343
- **Abstract**: This paper investigates the design of protograph low-density parity-check (PLDPC) codes and Gray-labeling codebooks (CBs) for the sparse code multiple access systems with iterative detection and decoding receiver (IDD-SCMA). Specifically, leveraging the protograph extrinsic information transfer (PEXIT) analysis, we first propose two types of PLDPC codes (i.e., an unpunctured Code-W and a punctured Code-V) which achieve the lowest decoding thresholds for the IDD-SCMA systems over AWGN and Rayleigh fading channels. To further enhance system performance, we focus on the critical role of Gray-labeling in the PLDPC-coded-IDD-SCMA systems, which are regarded as specific types of bit-interleaved coded modulation with iterative decoding (BICM-ID) systems. Subsequently, we devise a simple SCMA CB design scheme, referred to as the MPSK-based Gray-labeling CB design. This scheme is composed of the factor graph matrix design, the constellation set design, and Gray-labeling for the constellation set. Furthermore, with the aid of the PEXIT algorithm, the proposed CBs exhibit superior compatibility with the PLDPC-coded-IDD-SCMA systems. Analytical and simulation results demonstrate significant performance gains from the proposed PLDPC codes and CBs compared to existing counterparts. Consequently, the PLDPC-coded-IDD-SCMA systems with the proposed design emerge as a promising solution to satisfy the high-reliability requirements for SCMA applications.

## Short-Block Polar-Coded Reverse and Direct Reconciliation in CV-QKD

- **Status**: ❌
- **Reason**: CV-QKD reconciliation; LDPC는 부수 보호용, 양자 보안 응용·떼어낼 새 LDPC ECC 기법 없음
- **ID**: ieee:11087626
- **Type**: journal
- **Published**: 2025
- **Authors**: Dingzhao Wang, Xin Liu, Chao Xu +2
- **PDF**: https://ieeexplore.ieee.org/document/11087626
...
- **Status**: ✅
- **Reason**: Gradient Flow LDPC 디코더 — 새 연속시간 디코딩 알고리즘, 아날로그/텐서 구현 이식 가능 (C/D)
- **ID**: ieee:11095675
- **Type**: journal
- **Published**: 2025
- **Authors**: Tadashi Wadayama, Lantian Wei
- **PDF**: https://ieeexplore.ieee.org/document/11095675
...
- **Status**: ❌
- **Reason**: 생성형 시맨틱 통신/VQ; LDPC는 검증 베이스라인일 뿐 떼어낼 LDPC ECC 기법 없음 (JSCC/시맨틱 제외)
- **ID**: ieee:11154002
- **Type**: journal
- **Published**: 2025
- **Authors**: Maheshi Lokumarambage, Thushan Sivalingam, Feng Dong +2
- **PDF**: https://ieeexplore.ieee.org/document/11154002
...
- **Status**: ❌
- **Reason**: 암호 보안용 정수 소거정정 부호; 채널코딩 LDPC 아님
- **ID**: ieee:11036792
- **Type**: journal
- **Published**: 2025
- **Authors**: Miodrag J. Mihaljević, Aleksandar Radonjić, Nevena Mijajlović +2
- **PDF**: https://ieeexplore.ieee.org/document/11036792
...
- **Status**: ❌
- **Reason**: NTN 무선 물리계층 보안 서베이 — LDPC 미언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:10824882
- **Type**: journal
- **Published**: 2025
- **Authors**: Asim Ul Haq, Seyed Salar Sefati, Syed Junaid Nawaz +2
- **PDF**: https://ieeexplore.ieee.org/document/10824882
...
- **Status**: ❌
- **Reason**: 토릭 코드(양자 LDPC) 대상 min-sum 분석; 스태빌라이저·축퇴 등 양자 전용 개념에 의존하여 원칙 제외
- **ID**: ieee:11006877
- **Type**: journal
- **Published**: 2025
- **Authors**: Julien Du Crest, Mehdi Mhalla, Valentin Savin
- **PDF**: https://ieeexplore.ieee.org/document/11006877
...
## Physical-Layer Secure Optical Transmission Based on Randomized Quantization Noise

- **Status**: ❌
- **Reason**: 물리계층 보안 광전송(양자노이즈 암호) — 보안·암호 응용, 채널코딩 ECC 기법 아님
- **ID**: ieee:11201271
- **Type**: journal
- **Published**: 2025
- **Authors**: Hanwen Luo, Ziheng Zhang, Longquan Dai +6
- **PDF**: https://ieeexplore.ieee.org/document/11201271
...
- **Status**: ❌
- **Reason**: VLC 실시간 오디오 전송 — 일반적 error correction 언급뿐, 떼어낼 LDPC 기법 없는 응용 특이적
- **ID**: ieee:10870223
- **Type**: journal
- **Published**: 2025
- **Authors**: Kanchana Chathurangi Ahangama, Hemali Pasqual, Chinthaka Premachandra +1
- **PDF**: https://ieeexplore.ieee.org/document/10870223
...
- **Status**: ❌
- **Reason**: Ptychography 위상복원용 BP/VAMP 추론 — 이미징 역문제 메시지패싱, LDPC 부호 디코딩과 무관
- **ID**: ieee:11206532
- **Type**: journal
- **Published**: 2025
- **Authors**: Hajime Ueda, Shun Katakami, Masato Okada
- **PDF**: https://ieeexplore.ieee.org/document/11206532
...
- **Status**: ❌
- **Reason**: 대기난류 기반 비밀키생성 암호시스템 — QKD/PQC 보안, ECC 기법 없음
- **ID**: ieee:11218052
- **Type**: journal
- **Published**: 2025
- **Authors**: Ivan B. Djordjevic
- **PDF**: https://ieeexplore.ieee.org/document/11218052
...
## PosGKG: Lightweight Position-Based Group Key Generation and Management in BC Systems

- **Status**: ❌
- **Reason**: 백스캐터 통신 위치기반 그룹키 생성 — 보안·키관리, ECC와 무관
- **ID**: ieee:11222606
- **Type**: journal
- **Published**: 2025
- **Authors**: Jiajun Li, Zheng Yan, Yishan Yang
- **PDF**: https://ieeexplore.ieee.org/document/11222606
...
## Nonlinear Massive MIMO–RSMA With Multilinear GSVD Precoding: Signal Characterization and Receiver Design

- **Status**: ❌
- **Reason**: Massive MIMO-RSMA GSVD 프리코딩/수신기 설계 — LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:11271423
- **Type**: journal
- **Published**: 2025
- **Authors**: Oussama Ben Haj Belkacem, Rui Dinis
- **PDF**: https://ieeexplore.ieee.org/document/11271423
...
- **Status**: ❌
- **Reason**: DeepJSCC 이미지 전송, LDPC는 베이스라인 비교 대상일 뿐 이식 기법 없음
- **ID**: ieee:11023562
- **Type**: journal
- **Published**: 2025
- **Authors**: Daisuke Hisano, Keigo Matsumoto, Yoshiaki Inoue +7
- **PDF**: https://ieeexplore.ieee.org/document/11023562
- **Abstract**: This paper presents the first outdoor field trials of deep joint source-channel coding (DeepJSCC) for image transmission over a 5G system. DeepJSCC is a deep learning-based end-to-end method that unifies source and channel coding to enable robust and low-latency image transmission, particularly in low signal-to-noise power ratio (SNR) environments. Unlike conventional methods, DeepJSCC inherently avoids the cliff effect and maintains stable image quality under harsh channel conditions. To evaluate its feasibility of practical environments, we modified a commercial 5G base station (gNB) and user equipment (UE) to support DeepJSCC signal transmission and reception. Extensive experiments were conducted under indoor and outdoor settings, including line-of-sight (LoS) and non-line-of-sight (NLoS) conditions. A key contribution of this study is the empirical verification that even a DeepJSCC model trained solely on an additive white Gaussian noise (AWGN) channel can maintain stable reconstruction performance in real 5G environments, demonstrating its generalization capability. Compared to baseline systems using JPEG2000 and LDPC, DeepJSCC achieved higher PSNR stability and was able to restore image content even when conventional schemes completely failed. These findings suggest that DeepJSCC is a promising candidate for next-generation visual communication over 5G infrastructure.

## Enhancing QoS and RF-EMF Radiation Using RSMA and AI in 6G Networks: A Comprehensive Survey

- **Status**: ❌
- **Reason**: 6G RSMA+AI survey; LDPC only incidental mention, no new transplantable technique
- **ID**: ieee:11224747
- **Type**: journal
- **Published**: 2025
- **Authors**: Adedotun T. Ajibare, Balyan Vipin, Oluwaseyi P. Babalola
- **PDF**: https://ieeexplore.ieee.org/document/11224747
- **Abstract**: The sixth generation (6G) wireless networks are envisioned to deliver unprecedented levels of connectivity, ultra-reliable low-latency communication (URLLC), and energy efficiency while addressing public concerns about radiofrequency electromagnetic field (RF-EMF) exposure. Rate-Splitting Multiple Access (RSMA) has emerged as a promising multiaccess technique that flexibly manages interference and supports a broad range of Quality of Service (QoS) requirements. In parallel, the integration of artificial intelligence (AI), including machine learning (ML) and reinforcement learning (RL), has become essential for dynamic resource optimisation, proactive decision making, and real-time adaptation in complex and dense wireless environments. This survey presents a comprehensive overview of RSMA’s operational principles, with a focus on its encoding/decoding architecture using low-density parity-check (LDPC) and polar coding and how it enhances spectral and energy efficiency compared to traditional multiple access schemes. It also presents the mathematical framework for both the RSMA scheme and the RF-EMF evaluation. The survey also explores AI-driven strategies for optimising RSMA, including power control, beamforming, and user scheduling, while minimising RF-EMF exposure. We examine the regulatory thresholds provided by IEEE, FCC, and ICNIRP, focusing on exposure-aware RSMA models that balance RF safety with performance demands in relation to system constraints. Furthermore, we discuss system-level trade-offs between QoS and RF-EMF exposure and system performance metrics such as bit error rate (BER), latency, spectral efficiency, and specific absorption rate (SAR) levels. This survey identifies open challenges, including real-time AI deployment, scalability, and security, and discusses future research directions, such as hybrid multiple access models, privacy-preserving ML, and AI-RSMA-6G integration. Finally, this survey serves both as a reference guide and a basis for future research on the safe, intelligent, and high-performing deployment of RSMA in 6G networks, which optimises both user experience and environment.

## Corrections to “Performance of Spatially Coupled LDPC Codes Over the Underwater Wireless Optical Channel With Strong Turbulence and Pointing Errors”

- **Status**: ❌
- **Reason**: 수중 광채널 SC-LDPC 논문의 정오표(corrections)일 뿐, 기술 기여 없음
- **ID**: ieee:10962181
- **Type**: journal
- **Published**: 2025
- **Authors**: Sravan Kumar Padala, John D’Souza
- **PDF**: https://ieeexplore.ieee.org/document/10962181
- **Abstract**: Presents corrections to the paper, (Corrections to “Performance of Spatially Coupled LDPC Codes Over the Underwater Wireless Optical Channel With Strong Turbulence and Pointing Errors”).

## Editorial Quantum Error Correction and Fault Tolerance

- **Status**: ❌
- **Reason**: 양자 오류정정 사설(editorial), 초록 없음 — 원칙 제외(양자)
- **ID**: ieee:11258615
- **Type**: journal
- **Published**: 2025
- **Authors**: Navin Kashyap, Narayanan Rengaswamy, Bane Vasic +1
- **PDF**: https://ieeexplore.ieee.org/document/11258615
- **Abstract**: N/A

## Deep Learning-based Blind Identification of Channel Coding Schemes

- **Status**: ❌
- **Reason**: DL blind identification of coding schemes (conv/turbo/LDPC); classification task, no LDPC decoder/code-design contribution
- **ID**: ieee:10986577
- **Type**: conference
- **Published**: 2025
- **Authors**: B. Singh, Shalu
- **PDF**: https://ieeexplore.ieee.org/document/10986577
- **Abstract**: The signal identification in blind radio frequency environment is gaining increasing importance in intelligent wireless communication systems. In this paper, we present a deep learning based blind identification of channel coding schemes. These include Convolutional coding, Turbo coding, and Low Density Parity Check coding-promising schemes for wireless communication systems. We have synthesized the dataset through MatLab simulations, where the randomly generated bits are encoded using specified coding schemes and modulated with BPSK and QPSK. The transmission of data has been simulated over a signal to noise ratio range of 0-20 dB in an AWGN channel, facilitating robust model training. Finally, a convolutional gated recurrent unit deep neural network is proposed. Unlike existing deep learning-based coding detection algorithms that handle only one modulation scheme, the proposed model processes information bits modulated with two different schemes. The method demonstrates average prediction accuracy approaching 87% to 90% over low regions of signal to noise ratio of the communication links.

## SyndromeCode: Feedback-Assisted Concatenated Coding based on Transformer

- **Status**: ❌
- **Reason**: 피드백 코딩 Transformer 내부부호로 LDPC 아닌 신경망 코드, 떼어낼 LDPC 디코더 없음
- **ID**: ieee:11443900
- **Type**: conference
- **Published**: 2025
- **Authors**: J. Jang, H. Nam, V. Tripathi +1
- **PDF**: https://ieeexplore.ieee.org/document/11443900
- **Abstract**: Deep learning-based feedback coding has demonstrated superior performance over classical linear counterparts under specific channel conditions by learning robust non-linear mappings. To achieve better reliability, these neural codes are typically deployed as inner codes within a concatenated architecture, wrapped around an outer linear error-correcting codes (ECC). However, existing data-driven architectures typically treat the feedback coding as a black-box optimization, done independently of the selection of the outer ECC. Unfortunately, this means the data-driven architecture is not optimized to exploit the algebraic structure of the outer code, resulting in an inability to consider the underlying outer code structure when they are concatenated. To bridge this gap, we propose SyndromeCode, a novel feedback coding architecture that explicitly incorporates the outer code structure via syndrome inputs. Instead of relying solely on raw received signals, SyndromeCode leverages a soft syndrome vector—a differentiable indicator of parity violations derived from the outer code structure—and feeds it directly into the Transformer-based encoder and decoder. Furthermore, we demonstrate the versatility of this approach in multiple-input multiple-output (MIMO) multi-stream scenarios, as well as different spatial noise correlations. Our extensive results demonstrate that SyndromeCode outperforms the baselines by validating the power of injecting domain knowledge into deep learning-based feedback coding architecture.

## Bivariate Bicycle Code-Enhanced Quantum Consciousness Networks: A qLDPC Framework for Brain–Quantum Interface Computing with 200-Logical-Qubit Scalability

- **Status**: ❌
- **Reason**: qLDPC 기반 양자 두뇌-인터페이스 — 양자 전용(bivariate bicycle, 스태빌라이저) 의존, 원칙 제외
- **ID**: ieee:11308365
- **Type**: conference
- **Published**: 2025
- **Authors**: B. Dinesh, M. Thangamani, S. Tamizharasu +3
- **PDF**: https://ieeexplore.ieee.org/document/11308365
- **Abstract**: This paper introduces a computer science framework for large-scale brain–quantum interface computing by integrating bivariate bicycle code quantum low-density parity-check (qLDPC) codes with a neural spike encoding pipeline. The proposed system achieves 200 logical qubits using sparse circulant constructions, maintaining fault tolerance and constant encoding rate under realistic noise models. We present a mathematical mapping from real-time neural spike streams to logical registers, implement a hardware-aware belief-propagation decoder, and optimize quantum circuit placement for minimal routing overhead. Real-time emulation using live neural surrogate data and calibrated quantum noise confirms a logical error probability below 10−8 per cycle and end-to-end information retention exceeding 99.7%. These results demonstrate the feasibility and scalability of robust, low-latency neural signal processing on quantum hardware, paving the way for dependable quantum brain–computer interfaces.

## Rateless Transmission Based on Short Polar Codes for Free Space Optical Links

- **Status**: ❌
- **Reason**: FSO용 rateless 단축 폴라 코드 — LDPC 아님, 폴라 코드 통신 응용
- **ID**: ieee:11303779
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. S. Rohmah, Iskandar, K. Anwar +1
- **PDF**: https://ieeexplore.ieee.org/document/11303779
- **Abstract**: This paper studies short polar codes as elements to design rateless polar codes based on extended parity (EP). We propose a new rateless polar codes structure, termed as Ladder model with a short block-length N = 4. We perform a series of computer simulations to evaluate bit-error-rate (BER) performance for several coding rates R over additive white Gaussian noise (AWGN), Rayleigh fading, and free space optical (FSO) channels. The simulation results are then analyzed using the extrinsic information transfer (EXIT) chart over an equivalent binary erasure channel (BEC). The results are expected to stimulate further study on the design of rateless capabilities in polar coding schemes.

## Secure Image Transmission: Integrating Image Encryption with Adaptive Modulation and Coding

- **Status**: ❌
- **Reason**: 카오스 영상암호화+적응형 polar code 전송 프레임워크; LDPC 무관, 떼어낼 디코더·코드설계 기법 없음(보안/통신 응용 특이적)
- **ID**: ieee:11186025
- **Type**: conference
- **Published**: 2025
- **Authors**: W. Alexan, E. Mamdouh, Y. Megalli +1
- **PDF**: https://ieeexplore.ieee.org/document/11186025
- **Abstract**: In terms of forward error correcting (FEC) codes, polar codes are among the most effective. These codes are currently the main candidates for upcoming communication systems and have been adopted in the 5G standard for control channels. This paper presents a secure image transmission framework that integrates chaos-based image encryption with an adaptive transmission approach. The proposed scheme enhances both security and efficiency by leveraging hyperchaotic encryption to ensure strong diffusion and confusion properties through $M$ rounds of encryption, while adaptive Hierarchical Quadrature Amplitude Modulation (HQAM) and adaptive rate polar code improve resilience against transmission impairments. Numerical evaluations demonstrate that the scheme achieves high encryption security, with a vast key space of $2^{744}$, Number of Pixel Change Rate (NPCR) exceeding 98.6% and entropy values close to 8, ensuring randomness. Additionally, the adaptive transmission mechanism enables near-perfect image reconstruction at higher $E_{b}/N_{0}$ values, achieving a Peak Signal-to-Noise Ratio (PSNR) of 48.43 dB at only 2.5 dB and flawless recovery at 4.5 dB and beyond. These results confirm the robustness of the proposed method in securing images while maintaining high fidelity, making it suitable for applications requiring reliable and secure visual data transmission.

## Performance Analysis of Frequency Hopping Communication’s Resistance to Partial Band Interference Based on Forward Error Correction Coding

- **Status**: ❌
- **Reason**: 주파수 호핑 RS/Turbo FEC, LDPC 아님
- **ID**: ieee:11406384
- **Type**: conference
- **Published**: 2025
- **Authors**: R. Wang, C. Wu, B. Xiao +1
- **PDF**: https://ieeexplore.ieee.org/document/11406384
- **Abstract**: Partial band interference (PBI) is a “killer” interference in practical communications, which seriously impairs the reliability of frequency hopping (FH) communication systems. Aiming at the limited ability of pure frequency hopping communication systems to resist partial band interference, this paper proposes an anti-interference strategy based on forward error correction (FEC) coding. It combines classic Reed-Solomon (RS) coding and Turbo coding with frequency hopping communication systems respectively, and designs simulation experiments to compare their bit error rates (BER) under different interference factors $\rho$, thereby analyzing the performance of resisting partial band interference. When the interference factor $\rho$ is fixed, the influence of different coding parameters on the system’s resistance to partial band interference is analyzed. In addition, under the premise of keeping the interference factor $\rho$ and coding parameters constant, the frequency hopping parameters are changed to analyze their impact on system performance. Simulation results show that the partial band interference resistance performance of frequency hopping communication based on Turbo coding is superior to that based on RS coding, and both are better than that of pure frequency hopping. To facilitate operators to better select frequency hopping waveforms in different scenarios, guidelines and selection methods are provided to improve the application capability of frequency hopping communication based on forward error correction coding in resisting partial band interference.

## An Efficient Degree Distribution of Short LT-like Codes for Update Distribution over IoT Networks

- **Status**: ❌
- **Reason**: IoT용 LT-like fountain 코드 차수분포 설계, fountain 코드 제외
- **ID**: ieee:11401290
- **Type**: conference
- **Published**: 2025
- **Authors**: N. I. Abdulkhaleq, A. Saad Hussein, S. H. Ali
- **PDF**: https://ieeexplore.ieee.org/document/11401290
- **Abstract**: This paper compares three degree distributions-Robust Soliton Distribution (RSD), Memory-Based RSD (MBRSD), and novel Anti-Stuck Deterministic Degree Distribution (ASDD)for short-message transmission with low latency in Internet of Things (IoT) networks. The foremost contribution is the design of ASDD, which proactively grows and stabilizes the population of degree-1 symbols to prevent decoding stalls ("stuck" states), thus keeping the belief-propagation process under erasure-prone situations. Performance was compared with MATLAB-based simulations of LT-like fountain codes in terms of decoding success rate, overhead efficiency, and erasure robustness. Performance shows ASDD beats RSD and MBRSD under all conditions: achieving a 15% improvement in decoding success rate at high erasure levels, reducing average overhead by 10–12%, and improving decoding reliability for short packets. Such improvements are especially useful for energy-compressing IoT nodes, where retaliation is expensive. Conclusions suggest that ASD provides an effective coding strategy to increase reliability and reduce the delay in short-notification-IoT communication. For future work, this will include the implementation of hardware and assess the real IoT network environment.

## Rethinking Reliability Using Network Coding: a Practical 5G Evaluation

- **Status**: ❌
- **Reason**: 5G RLNC 네트워크코딩 erasure 복구 - 재전송 대체 네트워크코딩, LDPC ECC 기법 없음
- **ID**: ieee:11146298
- **Type**: conference
- **Published**: 2025
- **Authors**: L. Landon, V. A. Vasudevan, J. Sung +1
- **PDF**: https://ieeexplore.ieee.org/document/11146298
...
- **Status**: ❌
- **Reason**: Polar 부호 SCL 디코더 LSTM 개선 — LDPC가 아닌 polar 부호 대상, 이식 대상 LDPC 기법 아님(BP는 baseline 언급)
- **ID**: ieee:11213577
- **Type**: conference
- **Published**: 2025
- **Authors**: F. Alia, B. Akhbari, M. A. Attari
- **PDF**: https://ieeexplore.ieee.org/document/11213577
- **Abstract**: Polar codes have been selected as the channel coding scheme for the Enhanced Mobile Broadband (eMBB) control channel in 5G, which requires short length codes. One of the main challenges in utilizing polar codes is the design of low-complexity decoders with adequate error-correcting performance. The Successive Cancellation (SC) decoder was introduced as the first algorithm enabling polar codes to achieve the channel capacity for long codelengths. However, for shorter codelengths, this decoder does not provide satisfactory error-correction performance. To address this limitation, the Successive Cancellation List (SCL) decoder has been proposed, which performs decoding by maintaining a list of candidate paths and selecting the best one based on a path metric. In this paper, we propose improving the error-correction performance of the SCL decoder using concatenated Cyclic Redundancy Check (CRC) codes and Long Short-Term Memory (LSTM) network. Simulation results demonstrate that the proposed method outperforms the Belief Propagation (BP) decoder in terms of Bit Error Rate (BER) curves. Furthermore, the accuracy of the LSTM model in this study improves from 73 percent in previous research to 93.77 percent.

## Self-Learning and Authentication Algorithm for Automotive Applications

- **Status**: ❌
- **Reason**: MAC+Turbo 결합 자가학습 인증·정정 알고리즘 — Turbo 기반, LDPC 기법 아님, 보안 응용
- **ID**: ieee:11219454
- **Type**: conference
- **Published**: 2025
- **Authors**: N. Živić
- **PDF**: https://ieeexplore.ieee.org/document/11219454
- **Abstract**: This paper presents a two-phase iterative algorithm for the correction (and possibly for authentication) of data related primarily to automotive applications. The algorithm combines Message Authentication Code (MAC), borrowed from cryptography and incorporated in the Soft Input Decryption (SID) procedure for data authentication, with a channel decoding technique based on a Turbo decoder, where certain data blocks, i.e. specific parts of an image (landmarks), are separately decoded in an iterative manner. The algorithm possesses a kind of self-learning property, since in each successful iteration of the landmark decoding, the knowledge about successful authentication of a landmark is passed to the next iteration in the form of “ $L$-values” which are set to the maximally permitted values, so that the decoding performance (for the whole image) is getting better and better in each subsequent iteration. The basic idea is to have cryptographic algorithms for data authentication which are tolerant to minor modifications, such as bit errors below a certain threshold. When these algorithms are combined with forward error correction codes and run in an iterative manner, and with carefully tuned values of some parameters, then both error correction and authentication (based on self-learning) can give better results. This paper describes an iterative (and selflearning) algorithm which can improve error correction and authentication of images protected by security mechanisms.

## Improving Data Transmission Efficiency in UAV Networks Through Adaptive Coding

- **Status**: ❌
- **Reason**: UAV 적응형 RCPC 코딩. LDPC 아니고 무선 응용 특이적, 떼어낼 ECC 기법 없음
- **ID**: ieee:10970889
- **Type**: conference
- **Published**: 2025
- **Authors**: M. M. Safadi, V. B. Amoursky
- **PDF**: https://ieeexplore.ieee.org/document/10970889
- **Abstract**: In recent years, unmanned aerial vehicles (UAV) have become widely used in civil and military applications such as surveillance, data collection, and cargo delivery. With the increasing use of this technology, there is a need for improved communication systems to ensure reliable and efficient data transmission. UAV networks face unique challenges due to dynamic motion, environmental interference, and energy and bandwidth limitations. The objective of this study is to propose an adaptive coding scheme using Rate-Compatible Punctured Coding (RCPC) technology, which assigns different coding rates to different data depending on their importance and channel conditions. The proposed scheme includes a mechanism to dynamically adjust the coding rates based on the change in link quality. This study demonstrates that adaptive coding can improve resource efficiency, reduce latency, and enhance communication reliability.

## Turbo Codes-based Physical Layer Security Method Against Passive Eavesdropping Attacks For MIMO Wireless Communication Systems

- **Status**: ❌
- **Reason**: Turbo 코드 기반 물리계층 보안(도청 방지) — LDPC ECC 기법 아님
- **ID**: ieee:11250554
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Van Linh, H. T. P. Thao, V. Van Yem
- **PDF**: https://ieeexplore.ieee.org/document/11250554
- **Abstract**: This paper proposes a Physical Layer Security (PLS) method based on the Turbo codes to mitigate the passive eavesdropping attacks on the Multiple-Input Multiple-Output (MIMO) wireless communication systems. The proposed method is implemented by using a secret key to manage the working principles of the Turbo codes. The performance of the proposed method is evaluated by comparing the bit error rate (BER) of the legitimate receiver (Bob) with the eavesdropper (Eve) in different MIMO configurations and channels. The obtained results indicate that the proposed method significantly reduces Eve’s decoding ability over the MIMO systems. Therefore, it is effective against passive eavesdropping attacks. Moreover, the proposed method gives a low computational complexity equivalent to normal Turbo codes.

## Error Correction for DNA-Based Image Storage

- **Status**: ❌
- **Reason**: DNA 저장 ECC(RS·convolutional·Raptor) JSCC, LDPC 아님
- **ID**: ieee:11084599
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Lazzarotto, M. Testolina, T. Ebrahimi
- **PDF**: https://ieeexplore.ieee.org/document/11084599
...
## A Design of Convolutional Gaussain Random Codes

- **Status**: ❌
- **Reason**: convolutional Gaussian random code 설계(polar+SVD precoding); AWGN 통신용, LDPC 아니며 NAND 이식 기법 없음
- **ID**: ieee:11195597
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Lin
- **PDF**: https://ieeexplore.ieee.org/document/11195597
- **Abstract**: This paper studies Gaussian random codes based on convolutional structures. Firstly, an error probability upper bound for finite-length Gaussian random codes is derived, expressed as a closed-form solution for the error exponent. It also proposes regular convolutional Gaussian random codes and analyzes the upper bound of error probability of their component codes. To improve the cutoff rate and reduce decoding complexity, polar codes are employed as component codes and SVD precoding is introduced to transform polar codes into approximate Gaussian random codes. Numerical verification shows that the proposed codes have the potential to meet high-performance requirements under achievable complexity conditions.

## Half Spatially Coupled Turbo-Like Codes

- **Status**: ✅
- **Reason**: SC-TC(공간결합 부호) 새 결합 구조 제시 — 공간결합 코드 설계 기법은 SC-LDPC(E)로 이식 검토 가능, 애매하여 살림
- **ID**: ieee:11240476
- **Type**: conference
- **Published**: 2025
- **Authors**: X. Wu, L. Yang, M. Qiu +2
- **PDF**: https://ieeexplore.ieee.org/document/11240476
...
- **Status**: ❌
- **Reason**: 임베디드 메모리용 패리티 기반 ECC, LDPC 아님(버스트 오류 정정 패리티 코드)
- **ID**: ieee:11012346
- **Type**: conference
- **Published**: 2025
- **Authors**: K. Srinidhi, S. V. N. S. V. Chakka, M. Vinodhini
- **PDF**: https://ieeexplore.ieee.org/document/11012346
...
## Security Enhancement for High-Speed Optical Transmission Using Multilevel Coded Modulation and Information Scrambling

- **Status**: ❌
- **Reason**: 광통신 물리계층 보안(coded modulation + scrambling), NAND LDPC ECC로 떼어낼 디코더/코드설계 기법 없음
- **ID**: ieee:11111030
- **Type**: conference
- **Published**: 2025
- **Authors**: X. Yin, Y. Lei, Z. Guo +1
- **PDF**: https://ieeexplore.ieee.org/document/11111030
- **Abstract**: A multilevel coded modulation scheme in combination with information scrambling is proposed to enhance the physical layer security of high-speed optical transmission systems. Its effectiveness is demonstrated by comparing to conventional bit-interleaved coded modulation systems.

## A Comparative Analysis of Advanced Modulation and Coding Schemes for LEO Based Satellite Network

- **Status**: ❌
- **Reason**: LEO 위성 MCS 비교 분석; LDPC 디코더·구성 신규 기여 없음
- **ID**: ieee:11171311
- **Type**: conference
- **Published**: 2025
- **Authors**: D. R. Manjunath
- **PDF**: https://ieeexplore.ieee.org/document/11171311
- **Abstract**: Satellite communication using LEO is gaining popular acceptance, owing to its capabilities of ubiquitous coverage, high speed and minimum latency. The aforementioned advantages offered by LEO links are best utilized when the adverse challenges such as Doppler shifts and varying channel conditions observed in LEO communication are effectively addressed. In order to ensure reliable connectivity amidst these challenges, it is pertinent to employ optimum Modulation and Coding Schemes (MCS). A comparative analysis of the various advanced MCS provides necessary insights into the trade-offs between MCS the implementation latency, spectral efficiency, BER, throughput and the effectiveness with which a reliable communication link can be established under dynamic LEO channel conditions.

## Advances in Convolutional Codes and the Viterbi Algorithm for Error Correction in Digital Communication System

- **Status**: ❌
- **Reason**: convolutional code+Viterbi 서베이, LDPC 무관
- **ID**: ieee:11085274
- **Type**: conference
- **Published**: 2025
- **Authors**: V. Arya, S. Gupta
- **PDF**: https://ieeexplore.ieee.org/document/11085274
- **Abstract**: The application of error correction codes (ECCs) is essential to achieve reliable data transfer over a noisy communications channel. Convolutional codes along with Viterbi decoding algorithm have played a significant role in the area of strong error correction in many communications systems. Herein, a detailed survey on the past, design, and applications of convolutional codes and Viterbi algorithm focusing on the current communication systems like 5G, IoT, and space networks. New-age technologies were especially highlighted because innovations resulted from integrating artificial intelligence and hardware acceleration. The article concludes with a number of observations on the main problems and avenues for future research into the application of these technologies in new-generation communication system. This research also examines the incorporation of novel technol ogies like machine learning and hardware acceleration with traditional error correction systems.

## Bounded-Metric List Decoding of Linearly Expurgated Tail-Biting Convolutional Codes

- **Status**: ❌
- **Reason**: tail-biting 컨볼루션 부호 + ELF 리스트 디코딩; LDPC 부호/디코더 아님, 이식 가능한 LDPC 기법 없음
- **ID**: ieee:11154526
- **Type**: conference
- **Published**: 2025
- **Authors**: Z. Qu, W. Sui, G. Liva +2
- **PDF**: https://ieeexplore.ieee.org/document/11154526
- **Abstract**: In the short blocklength regime, serial list decoding of tail-biting (TB) convolutional codes concatenated with an expurgating linear function (ELF) can approach the random coding union bound on frame error rate (FER) performance. Decoding complexity for a particular received word depends on how deep in the list the decoder must search to find a valid TB-ELF codeword. The average list size is close to one at low-FER operating points such as 10−6, and serial list decoding provides a favorable average complexity compared to other decoders with similar performance for these cases.However, the average list size can be on the order of a hundred or a thousand at higher, but still practically important, FER operating points such as 10−3. It is useful to study the tradeoff between how deep the decoder is willing to search and the proximity to the frame error rate (FER) achieved by an ML decoder. Often, this tradeoff is framed in terms of a maximum list depth. However, this paper frames the tradeoff in terms of a maximum allowable metric between the received word and the trellis paths on the list. We consider metrics of Euclidean distance and angle.This new approach draws on the wealth of existing literature on bounded-metric decoding to provide characterizations of how the choice of maximum allowable metric controls the tradeoffs between FER performance and both decoding complexity and undetected error rate. These characterizations lead to an example of an ELF-TB convolutional code that outperforms recent results for polar codes in terms of the lowest SNR that simultaneously achieves both a total error rate less than $\varepsilon _ \top ^{\ast} = {10^{ - 3}}$ and an undetected error rate below $\varepsilon _{\text{U}}^{\ast} = {10^{ - 5}}$.

## Randomness-Efficient Constructions of Capacity-Achieving List-Decodable Codes

- **Status**: ❌
- **Reason**: 리스트 디코딩 가능 랜덤 선형부호의 randomness-efficient 구성(순수 조합/대수 이론); LDPC·NAND 이식 기법 없는 이론 bound
- **ID**: ieee:11195274
- **Type**: conference
- **Published**: 2025
- **Authors**: J. Mosheiff, N. Resch, K. Shang +1
- **PDF**: https://ieeexplore.ieee.org/document/11195274
...
- **Status**: ❌
- **Reason**: 코히어런트 PON 전송 데모, polar coded probabilistic shaping 기반 — LDPC ECC와 무관, 떼어낼 기법 없음
- **ID**: ieee:11047096
- **Type**: conference
- **Published**: 2025
- **Authors**: X. Jia, J. Li, N. Wang +6
- **PDF**: https://ieeexplore.ieee.org/document/11047096
- **Abstract**: An Alamouti coded $200-\mathrm{Gbps} / \lambda$ coherent PON downstream is achieved with $32-\mathrm{dB}$ and $29-\mathrm{dB}$ power budget under optical-back-to-back and $20-\mathrm{km}$ cases respectively enabled by polar coded truncated probabilistic shaped 64-QAM scheme with $40-\mathrm{GHz}$ signal bandwidth.

## Matmul-Based WAVA Implementation for Tailbiting Convolutional Codes

- **Status**: ❌
- **Reason**: Tailbiting convolutional code(WAVA) 행렬곱 구현, LDPC 무관 컨볼루션 디코더
- **ID**: ieee:11478534
- **Type**: conference
- **Published**: 2025
- **Authors**: T. -Y. Wu
- **PDF**: https://ieeexplore.ieee.org/document/11478534
- **Abstract**: This paper introduces a novel implementation of a tail-biting convolutional code (TBCC) decoder, which addresses the intrinsic decoding challenges associated with the wrap-around nature of TBCC. Traditional decoding methods, particularly sequential approaches like the Viterbi algorithm, struggle to efficiently handle TBCC due to their reliance on sequential processing. This limitation does not align well with the architecture of modern hardware, particularly parallel processing systems, which can exploit massive computational resources more effectively. To overcome these challenges, we transform the decoding process into multiple matrix multiplications by strategically splitting the code into subsequences. By leveraging this transformation, the decoder specifically the wrap-around Viterbi algorithm (WAVA) can fully utilize the power of neural processing units (NPUs) designed for high degrees of parallelism. NPUs at executing optimized linear algebra operations, making them ideally suited for the matrix multiplication approach adopted in this implementation. This method can significantly reduce latency, particularly for high-order TBCCs, which can achieve error performance close to the finite blocklength limit.

## Dynamic Path Activation for Energy-Efficient List Decoding

- **Status**: ❌
- **Reason**: Polar SCL 디코더 전력절감(DPA) — polar 전용 리스트디코딩, LDPC 이식성 없음
- **ID**: ieee:10949113
- **Type**: conference
- **Published**: 2025
- **Authors**: L. Johannsen, C. Kestel, T. Vogt +1
- **PDF**: https://ieeexplore.ieee.org/document/10949113
- **Abstract**: Advancements in semiconductor technologies are largely slowing down, especially with regard to power consumption and energy efficiency. On the other hand, the demands on higher throughput, lower latency and energy efficiency in baseband processing are steadily increasing. In this paper, we focus on the Successive Cancellation List (SCL) decoding algorithm for polar codes, which is known for its near-maximum likelihood error correction but at the expense of high complexity and power consumption. We propose a dynamic path activation (DPA) scheme that significantly reduces power consumption by up to 50 % with negligible impact on the Frame Error Rate (FER). We perform detailed analyses and present decoder implementation results in a 12 nm FinFET technology to quantify the improvements in power and energy efficiency.

## The Genome as a Quantum Error-Correcting Code

- **Status**: ❌
- **Reason**: 게놈을 양자 오류정정(스태빌라이저 코드)으로 모델링 — 양자 EC, 양자 전용 개념 의존, 원칙 제외
- **ID**: ieee:11430948
- **Type**: conference
- **Published**: 2025
- **Authors**: S. Alam, A. Pawar, I. Alam
- **PDF**: https://ieeexplore.ieee.org/document/11430948
- **Abstract**: DNA replication upholds genomic integrity with remarkable precision, rectifying inaccuracies that emerge from quantum-level phenomena. This paper introduces a novel framework that models this biological process using the formalism of quantum error correction .We propose that genetic information encoded in DNA base pairs can be represented as the codespace of a Biological Stabilizer Code , where cellular proofreading and mismatch repair mechanisms function as an active error correction protocol.We provide comprehensive proofs that illustrate the code’s capacity to preferentially rectify the most likely types of mutations, thereby guaranteeing elevated logical fidelity. We establish a biological equivalent of the quantum threshold theorem, demonstrating that high-fidelity replication can be achieved if the inherent mutation rate falls below a critical threshold. The performance of the BSC is corroborated through simulations conducted in Qiskit, which reveal its superior efficacy compared to symmetric codes under biologically plausible noise conditions. This research establishes a quantitative relationship between the principles of fault-tolerant quantum computation and the mechanisms that uphold the stability of life’s genetic code.

## A New Index Modulation Approach for Sparse Superimposed Coding

- **Status**: ❌
- **Reason**: 희소 중첩 코딩(SSC) 인덱스 변조 기법 — LDPC ECC 아님, 떼어낼 디코더 없음
- **ID**: ieee:11427267
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Luo, J. Huang, X. Zhang
- **PDF**: https://ieeexplore.ieee.org/document/11427267
- **Abstract**: Sparse superimposed coding (SSC), as an emerging coding technology, shows great application potential for achieving high reliability and low latency in the field of short-packet communication. This paper proposes a generalized SSC (GSSC) scheme based on base conversion, aiming to eliminate the need for an index table in conventional SSC schemes while ensuring the transmission reliability. The core concept of GSSC is to construct the sparse vector by sharing a half of position resources between adjacent index bit streams, achieving a shortened sparse vector. Meanwhile, the mapping rules of positive direction and reverse direction are established to ensure that the obtained non-zero position indices of adjacent index bit streams exhibit an increasing order. Consequently, the non-zero element mapping process of GSSC can eliminate the dependency on existing baseconversion SSC that necessitates additional labeling. Simulation results show that compared with existing methods, GSSC can effectively reduce the decoding delay while achieving near-optimal transmission performance in single-block encoding mode and surpassing the transmission reliability of conventional SSC schemes in multi-block encoding mode.

## Connecting Polar Codes and 6G Short Range Wireless Quantum Optical Communications

- **Status**: ❌
- **Reason**: Polar 코드·6G 양자광통신; LDPC 무관, 무선 응용 특이적
- **ID**: ieee:11104458
- **Type**: conference
- **Published**: 2025
- **Authors**: K. Dini, P. Jung, H. Almujahed
- **PDF**: https://ieeexplore.ieee.org/document/11104458
- **Abstract**: Recent research has clarified that radio applications above 300 GHz require a laborious analog design that takes into account the frequency-dependent nature of ohmic resistance at these frequencies, bringing optical communication solutions, well suited for short range links in the sixth generation (6G) THz band located between 300 GHz and 10 THz, into focus. In particular, wireless quantum optical communication concepts are attractive, replacing the classical radio frequency based inner physical layer transceivers used in channel coded short range wireless communication systems. In particular, due to low environmental interaction of short range links, the prevailing coherence and interference ability when knowing and maintaining the carrier phase permits a beneficially robust wireless quantum optical transmission. In this manuscript, the viability of connecting the 5G/New Radio polar code and the proposed wireless quantum optical communication concept, which uses the optimum soft output quantum data detector for coherent reception with known carrier phase, is demonstrated by means of performance results.

## Integrated Sensing and Communications for Unsourced Random Access: A Two-Phase Approach With Slotted Transmission

- **Status**: ❌
- **Reason**: Concatenated code for ISAC unsourced random access; multiple-access-specific, no transplantable LDPC ECC technique
- **ID**: ieee:11148951
- **Type**: conference
- **Published**: 2025
- **Authors**: Z. Zhang, J. Dang, Z. Zhang
- **PDF**: https://ieeexplore.ieee.org/document/11148951
- **Abstract**: In this work, we address the problem of concatenated code design for unsourced integrated sensing and communications (UNISAC). Specifically, UNISAC formulates the multiple access design in integrated sensing and communications (ISAC) as a theoretical coding problem, where echo signals for sensing and message information for communication are encoded and mapped onto a common codebook. The receiver then decouples the overlapped signals and decodes the sensing and communication information using this shared codebook. As system activity increases, conventional ISAC multiple access schemes such as TDMA, ALOHA, and TIN either fail to support the system or require intolerably high levels of energy consumption. While theoretical bounds have been established in UNISAC, practical solutions for access codes remain an open challenge. To provide insights into practical UNISAC code design, we introduce a two-phase concatenated code with slotted transmission. The proposed approach significantly outperforms conventional schemes under various parameter setups, generating 15 to 30 dB capacity gains. More importantly, the gap between the proposed scheme and the theoretical achievable bound is very small-less than 2.5 dB before 1000 active users.

## Decoding Optimization of Spatially Coupled Polar Codes Based on Improved State Monitoring

- **Status**: ❌
- **Reason**: 폴라 코드(spatially coupled polar) 디코딩 최적화로 LDPC 아님, 이식할 LDPC 기법 없음
- **ID**: ieee:11438101
- **Type**: conference
- **Published**: 2025
- **Authors**: M. Su, S. Li, Q. Lian +3
- **PDF**: https://ieeexplore.ieee.org/document/11438101
- **Abstract**: Polar codes face challenges of insufficient polarization and limited decoding performance in short code-length applications, and existing decoding algorithms struggle to achieve an ideal balance between performance and complexity. To address this issue, this paper proposes a decoding optimization scheme for spatially coupled polar codes based on an improved state monitoring decoding (ISMD). This scheme adopts a spatially coupled structure to enhance the polarization effect and achieves efficient decoding by combining fixed-iteration soft cancellation (SCAN) decoding. The ISMD mechanism adaptively saves the optimal soft information state by monitoring the variation of the average probability of errors in real time during the decoding process. It then makes a hard decision based on this optimal state, which effectively avoids the performance degradation problem in iterative decoding. The simulation results show that the proposed scheme can effectively improve the decoding performance of spatially coupled polar codes with short code lengths.

## Joint SIC and SCMA for NOMA-Based Uplink Transmission in 5G Systems

- **Status**: ❌
- **Reason**: NOMA/SCMA-SIC 검출 기법, LDPC ECC 기여 아님
- **ID**: ieee:10936702
- **Type**: conference
- **Published**: 2025
- **Authors**: S. -L. Su, N. -H. Huang, C. -L. Chen +1
- **PDF**: https://ieeexplore.ieee.org/document/10936702
- **Abstract**: With higher access capacity, non-orthogonal multiple access (NOMA) is a promising wireless access technology to meet the demands of massive machine-type communications (mMTC) and internet of things (IoT) applications. Focused on NOMA-based uplink multiple access transmission, this paper proposes data detection schemes that integrate sparse code multiple access (SCMA) and successive interference cancellation (SIC) techniques, termed the SCMA-SIC process. Simulation comparisons of various NOMA receiver designs, including hybrid-domain NOMA and iterative detection and decoding (IDD) for coded SCMA, show that the SCMA-SIC process achieves the best system performance. In addition, with power control strategies for uplink access, the SCMA-SIC process still performs the best.

## Modular Neural Wiretap Codes for Fading Channels

- **Status**: ❌
- **Reason**: 딥러닝 기반 유한블록 wiretap 코드(physical-layer security) — 보안 코드 구성, LDPC ECC 이식 기법 없음
- **ID**: ieee:11274860
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Seifert, O. Günlü, R. F. Schaefer
- **PDF**: https://ieeexplore.ieee.org/document/11274860
...
## A Comparative Study of Coded Multi-Carrier Systems over High-Mobility Channels

- **Status**: ❌
- **Reason**: 고이동성 코디드 멀티캐리어 OAMP 반복수신기 비교 - 변조/검출 중심, LDPC 특화 디코더/구성 기여 없음
- **ID**: ieee:11148107
- **Type**: conference
- **Published**: 2025
- **Authors**: T. Chen, T. Yu, B. Bai +1
- **PDF**: https://ieeexplore.ieee.org/document/11148107
- **Abstract**: In high-mobility scenarios, coded multi-carrier modulation (MCM) schemes are resistant to the severe effects of Doppler shifts and have significant implications for reliable communication systems. Since channel coding has received limited attention in prior MCM waveform studies, this paper presents a comparative study of several coded MCM schemes. To this end, we propose an iterative receiver based on the orthogonal approximate message passing (OAMP) framework, which combines the linear minimum mean square error (LMMSE) estimator and the decoder. Simulation results reveal that channel coding enhances overall performance and narrows the gap among different modulation schemes. With the proposed detector, affine frequency division multiplexing (AFDM) outperforms other schemes in the low SNR region while interleaved frequency division multiplexing (IFDM) performs better in the high SNR region. Furthermore, we analyze the effect of symbol interleaving on coded MCM systems. Simulation results also show that, with the proposed receiver, these interleaved coded schemes yield a BER improvement of approximately 0.5 dB over conventional schemes. Among these systems, the interleaved AFDM achieves the best performance.

## The Error Probability of Spatially Coupled Sparse Regression Codes Over Memoryless Channels

- **Status**: ❌
- **Reason**: SC-SPARC의 GAMP 디코더 오류확률 이론 분석; sparse regression code(AMP 기반)로 바이너리 LDPC 아님, 순수 이론 bound
- **ID**: ieee:11195621
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Liu, Y. Xu, T. Hou
- **PDF**: https://ieeexplore.ieee.org/document/11195621
- **Abstract**: Sparse Regression Codes (SPARCs) are capacity-achieving codes introduced for communication over the Additive White Gaussian Noise (AWGN) channels and were later extended to general memoryless channels. In particular it was shown via threshold saturation that Spatially Coupled Sparse Regression Codes (SC-SPARCs) are capacity-achieving over general memoryless channels [1] when using an Approximate Message Passing decoder (AMP). This paper, for the first time rigorously, analyzes the non-asymptotic performance of the Generalized Approximate Message Passing (GAMP) decoder of SC-SPARCs over memoryless channels, and proves exponential decaying error probability with respect to the code length.

## A Smooshed BMOCZ Zero Constellation for CFO Estimation Without Channel Coding

- **Status**: ❌
- **Reason**: BMOCZ zero-constellation 변조 + CFO 추정 — channel coding 없는 변조 기법, LDPC 이식 기법 없음
- **ID**: ieee:11274554
- **Type**: conference
- **Published**: 2025
- **Authors**: A. J. Perre, P. Huggins, A. Şahin
- **PDF**: https://ieeexplore.ieee.org/document/11274554
- **Abstract**: In this study, we propose a new binary modulation on conjugate-reciprocal zeros (BMOCZ) zero constellation, which we call smooshed binary modulation on conjugate-reciprocal zeros (SBMOCZ), to address carrier frequency offset (CFO)induced zero rotation without depending on channel coding. In our approach, we modify the phase mapping of Huffman BMOCZ by shrinking the angle between adjacent zeros, except for the first and last, to introduce a gap in the zero constellation. By discerning the gap location in the received polynomial, the receiver can estimate and correct the phase rotation. We demonstrate the error rate performance of SBMOCZ relative to Huffman BMOCZ, showing that SBMOCZ addresses a CFO-induced rotation at the cost of a modest performance reduction compared to Huffman BMOCZ in the absence of a CFO. Finally, we compare SBMOCZ to Huffman BMOCZ using a cyclically permutable code (CPC), showing a 4 dB bit error rate (BER) improvement in a fading channel, while demonstrating comparable performance across other simulations.

## Integrated Sensing and Communications for Unsourced Random Access: A Spectrum Sharing Compressive Sensing Approach

- **Status**: ❌
- **Reason**: ISAC unsourced random access 다중접속 코드/압축센싱; LDPC ECC 무관, 이식 가능 기법 없음
- **ID**: ieee:11174834
- **Type**: conference
- **Published**: 2025
- **Authors**: Z. Zhang, J. Dang, K. -K. Wong +2
- **PDF**: https://ieeexplore.ieee.org/document/11174834
...
## A New Multi-Stage Receiver for Lattice-Coded Based Multiuser Communication

- **Status**: ❌
- **Reason**: 격자부호 기반 다중접속 수신기(GMI). LDPC 아니고 무선 다중접속 응용, 이식할 LDPC 기법 없음
- **ID**: ieee:10978305
- **Type**: conference
- **Published**: 2025
- **Authors**: J. Wang, T. Yang, R. Liu
- **PDF**: https://ieeexplore.ieee.org/document/10978305
...
- **Status**: ❌
- **Reason**: ROI 인지 JSCC + 조건부 확산모델 이미지 시맨틱 통신 - JSCC/생성모델 기반, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:11147221
- **Type**: conference
- **Published**: 2025
- **Authors**: Z. Chen, X. Wei, H. Tong +2
- **PDF**: https://ieeexplore.ieee.org/document/11147221
...
## Implementation of Lunar Surface Video Transmission System with RaptorQ Codes over the USRP Platform

- **Status**: ❌
- **Reason**: 달 표면 영상전송 RaptorQ fountain 코드, fountain/erasure 제외
- **ID**: ieee:11352176
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Lin, S. Gu, Y. Wu +3
- **PDF**: https://ieeexplore.ieee.org/document/11352176
- **Abstract**: Reliable and efficient video transmission is crucial for lunar surface communications in both manned and unmanned exploration missions. This paper proposes an implementation of Universal Software Radio Peripheral-based video transmission system (USRP-VTS), which is designed to emulate lunar communication attenuation and verify the video reconstruction quality under lunar surface conditions. For accurate lunar channel attenuation emulation, we develop a programmable attenuator (PA) that enables real-time $0-90 \text{dB}$ attenuation control through integration of lunar terrain parameters into the ITU-R P. 526 model, achieving less than 1 dB deviation between theoretical and measured results. To address packet loss problem in video transmission, we design a RaptorQ-UDP protocol combining modified UDP packetization, RaptorQ fountain codes, and CRC16 checksums, which can show 8-10 dB peak signal-to-noise ratio (PSNR) improvement under 70 dB path loss for key frames compared to unprotected transmission, while maintaining 18 Mbps throughput without retransmission.

## Fourier-Domain CFO Estimation Using Jutted Binary Modulation on Conjugate-Reciprocal Zeros

- **Status**: ❌
- **Reason**: J-BMOCZ 변조 + Fourier-domain CFO 추정 — 변조/동기화 기법, LDPC 이식 기법 없음
- **ID**: ieee:11275518
- **Type**: conference
- **Published**: 2025
- **Authors**: P. Huggins, A. J. Perre, A. Şahin
- **PDF**: https://ieeexplore.ieee.org/document/11275518
...
## Coded Semantic-Aware Coordinated Transmission for Cohesive Clustered Satellite Networks

- **Status**: ❌
- **Reason**: 위성망 코디드 시맨틱 협력전송(CSCT) - concatenated coding + 강화학습 스케줄링, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:11152891
- **Type**: conference
- **Published**: 2025
- **Authors**: L. Xu, J. Jiao, J. Huang +3
- **PDF**: https://ieeexplore.ieee.org/document/11152891
- **Abstract**: Semantic-aware cohesive clustered satellite networks are poised to become essential enablers for intelligent satellite Internet of Things applications that require not just data-oriented high-speed transmission but also information-centric coordinated communication. In this paper, we propose a coded semantic-aware coordinated transmission (CSCT) scheme for clustered satellite networks, aiming at maximizing the utility of information (UoI) metric in a distributed and fully cooperative manner. We design a semantic codebook to distinguish semantic information and utilize concatenated coding followed by successive cancellation and then joint decoding (SCJD) to perform multi-satellite transmission. Moreover, we formulate an optimization problem of joint spot beams and semantic messages scheduling to maximize the average sum of UoI within the limited connection time window. To deal with the decision coupling which hinders optimal problem-solving, we propose a Multi-Agent Double and Dueling Deep Q-Learning (MAD3QL) based CSCT approach, enabling satellites to autonomously make decisions based solely on their local individual observations. Simulation results show the superiority of the CSCT scheme over the power-domain multi-satellite transmission scheme in enhancing reliability and scalability. In addition, the findings indicate that the MAD3QL-enabled CSCT policy obtains near-optimal performance and achieves more than twice the average sum of UoI gain compared to the semantic-agnostic transmission policy.

## Efficient CKM Exchange via Semantic Communications

- **Status**: ❌
- **Reason**: 시맨틱 통신 기반 CKM 교환; 채널코딩 ECC 아님, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11174889
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Shen, S. Wang, X. Xu +1
- **PDF**: https://ieeexplore.ieee.org/document/11174889
...
- **Status**: ❌
- **Reason**: Reed-Muller 코드의 고전-양자(CQ) 채널 capacity 이론 분석; 순수 이론 bound, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:11195211
- **Type**: conference
- **Published**: 2025
- **Authors**: A. Mandal, H. D. Pfister
- **PDF**: https://ieeexplore.ieee.org/document/11195211
...
## Enhancing Synchronization and Error-Correction Performances Under Low C/N Condition Based on ISDB-S3 for 12-GHz-band Satellite Broadcasting

- **Status**: ❌
- **Reason**: ISDB-S3 위성방송 동기+FEC 개선; 이식 가능한 구체적 LDPC 디코더/구성 없음 (무선 응용 특이적)
- **ID**: ieee:11165729
- **Type**: conference
- **Published**: 2025
- **Authors**: M. Kojima, R. Akiyama, Y. Koizumi +1
- **PDF**: https://ieeexplore.ieee.org/document/11165729
- **Abstract**: We are developing a new system for 12-GHz-band satellite broadcasting, which enables to use a small receiving antenna instead of conventional dish antennas for the general public. To achieve this, it is desired to enhance the noise resistance of ISDB-S3, the current transmission system for 12-GHz-band satellite broadcasting in Japan. In this study, we propose a transmission method that improves both synchronization and forward error correction (FEC) performances by incorporating known signals while keeping the basic framework of the existing ISDB-S3. Our simulation showed that the synchronization was established when C/N was as low as -10 dB, and its required C/N achieved -6.7 dB after the FEC.

## NN-Based Channel Equalization and Symbol Estimation for SC-FDMA with Channel Coding and Higher-Order Modulation

- **Status**: ❌
- **Reason**: SC-FDMA용 NN 채널등화/심볼추정 — 디코더가 아닌 등화기, LDPC 코드설계/디코더 기여 없음
- **ID**: ieee:10949128
- **Type**: conference
- **Published**: 2025
- **Authors**: O. Karakas, P. Fakharizadeh, M. Breiling +1
- **PDF**: https://ieeexplore.ieee.org/document/10949128
- **Abstract**: We design a fully connected neural network (FNN)-based scheme for joint channel equalization and symbol es-timation tasks in Single-Carrier Frequency Division Multiple Access (SC-FDMA) transmission over a dispersive block-fading channel. It is demonstrated that the proposed scheme is a reliable estimator in terms of soft estimation quality and it can be seamlessly combined with channel decoders that take a posteriori probability (APP) as input. The proposed scheme is evaluated against linear minimum mean-squared error (MMSE) equalization and demonstrates superior performance for BPSK, QAM16, and QAM64 modulations in terms of bit error rate (BER) and block error rate (BLER) for the 5G Clustered Delay Line (CDL) channel model.

## Error Correcting Codes for Segmented Burst-Deletion Channels

- **Status**: ❌
- **Reason**: Burst-deletion synchronization codes; different ECC family, no transplantable LDPC technique
- **ID**: ieee:11240373
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Liu, T. M. Duman
- **PDF**: https://ieeexplore.ieee.org/document/11240373
...
- **Status**: ❌
- **Reason**: 비선형 OFDM ML 검출; LDPC 코드/디코더 기법 아님
- **ID**: ieee:11174425
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Dinis, D. Costa, J. Guerreiro +2
- **PDF**: https://ieeexplore.ieee.org/document/11174425
- **Abstract**: In the last years, it has been shown that nonlinear (NL) orthogonal frequency division multiplexing (OFDM) can outperform linear OFDM because the nonlinear distortion has useful information about the transmitted signals. However, only a maximum likelihood (ML) receiver can exploit this information. Despite its potential, the optimal ML receiver for NL OFDM is highly complex, and its performance is difficult to simulate. Moreover, although some theoretical performance bounds exist for OFDM transmissions involving many subcarriers and high signal-to-noise ratio (SNR), the behavior of NL OFDM under more practical SNR conditions remains insufficiently explored. This paper focuses on optimal detection methods for NL OFDM systems. We present a comprehensive analysis of how the distortion received on different subcarriers contributes to the signal of a specific subcarrier and derive a performance bound for the ML detection of NL OFDM that is applicable across a broad range of SNR values. Furthermore, we propose a practical iterative decision-directed receiver that achieves significant performance improvements over linear OFDM in both uncoded and coded setups.11This work supported by Fundação para a Ciência e Tecnologia and Instituto de Telecomunicações under the project UIDB/50008/2020, DOI:10.54499/UIDB/50008/2020, and Universidade Lusófona.

## Enumerative Sphere Shaping-PAS Architecture for Reliable Transmission in 64QAM-OFDM 400 GHz Photonic THz Communication System

- **Status**: ❌
- **Reason**: ESS 기반 확률적 진폭 성형(PAS) for THz 통신 — 성좌 성형 기법, LDPC 디코더/코드설계 기여 없음
- **ID**: ieee:11406825
- **Type**: conference
- **Published**: 2025
- **Authors**: T. Li, J. Yu, S. Cai +1
- **PDF**: https://ieeexplore.ieee.org/document/11406825
- **Abstract**: We demonstrate a 400 GHz photonic Terahertz (THz) 64QAM-OFDM system utilizing Enumerative Sphere Shaping (ESS) based Probabilistic Amplitude Shaping (PAS). ESS mitigates the finite-blocklength rate loss inherent to Constant Composition Distribution Matching (CCDM) by leveraging the full multidimensional sphere. Experiments show that at an Achievable Information Rate (AIR) of 5.1 bit/2-D, ESS-PAS achieves Signal-to-Noise Ratio (SNR) gains of 0.81 dB and 0.31 dB over uniform signaling and CCDM, respectively. At a Frame Error Rate (FER) of 10-3, ESS improves power efficiency by 0.98 dB over the uniform baseline.

## Parallel Trellis-Stage-Combining BCJR for High-Throughput CUDA Decoder of CCSDS SCPPM

- **Status**: ❌
- **Reason**: CCSDS SCPPM용 BCJR(trellis) CUDA 디코더 — convolutional/accumulator SC code, LDPC 아님, BP/min-sum 무관
- **ID**: ieee:11068743
- **Type**: conference
- **Published**: 2025
- **Authors**: A. Antonini, E. Glukhov, R. Wesel +2
- **PDF**: https://ieeexplore.ieee.org/document/11068743
...
## Development of the Concept and Computer Model of a Prototype of a Wireless Signal Transmission System for Automatic Relay Protection at Substations

- **Status**: ❌
- **Reason**: 변전소 무선전송 시스템(GFSK/SDR) 개발. interference-resistant coding 언급뿐, LDPC/이식 기법 없음
- **ID**: ieee:10970799
- **Type**: conference
- **Published**: 2025
- **Authors**: S. V. Soldatkin, A. Y. Boev, S. A. Chechenya +2
- **PDF**: https://ieeexplore.ieee.org/document/10970799
- **Abstract**: This paper addresses the need for reliable wireless signal transmission with high speed and low latency in automatic relay protection of substations. The proposed wireless communication system provides at least 100 radio channels, supports a range of up to 2 km, ensures latency below 2 ms, and offers bidirectional data exchange with robust fault resilience. The system integrates a proprietary 900 MHz radio module employing Gaussian Frequency-Shift Keying (GFSK) and a software-defined radio (SDR)-based base station. Key features include multi-channel communication, cryptographic encryption, interference-resistant coding, channel quality assessment, and data reception confirmation. MATLAB Simulink modeling verifies that the system achieves high throughput and maintains latency under 2 ms, demonstrating an annual reliability of 100% even in challenging industrial environments. This solution significantly enhances substation reliability and safety by providing uninterrupted operation for modern relay protection tasks, thereby contributing to stable power supply and effective accident prevention measures.

## Asynchronization-Aided Ultra-Reliable Receiver for SCMA in Satellite-Terrestrial Communication

- **Status**: ✅
- **Reason**: SCMA IDD에서 ordered likelihood decoder(OLD) 기반 소프트출력 디코더(S-OLD) 제시 — OSD계열 디코더로 이식 가능성, 애매하여 살림(Phase 3 재검토)
- **ID**: ieee:11432435
- **Type**: conference
- **Published**: 2025
- **Authors**: C. Li, K. Zhang, Y. Wang +3
- **PDF**: https://ieeexplore.ieee.org/document/11432435
- **Abstract**: This paper proposes an asynchronization-aided iterative detection and decoding (AIDD) scheme for sparse code multiple access (SCMA) in satellite-terrestrial communication scenario, where the messages between the detector and decoder are iteratively exchanged with an additional degrees- of-freedom (DoF) in terms of delay. We first propose a parallel expectation propagation algorithm (P-EPA) for asynchronous multiuser detection, where a new initialization method is introduced by efficiently utilizing the prior information to enhance the performance of the detector. Furthermore, a universal soft-output decoder (S-OLD) is proposed based on the ordered likelihood decoder (OLD), which can generate the soft information with high reliability and serve as the input of P-EPA in the proposed AIDD. The iteration between the P-EPA and S-OLD is terminated when the maximum iteration number of the outer loop is achieved or the decoding results of all the users are converged. Simulation results show that the proposed P-EPA has better performance and lower latency compared to its counterparts, and the proposed AIDD also has better performance and fewer iterations than the synchronous IDD and joint detection and decoding (JDD) schemes.

## Physics-Aware Decoding for Communication Channels Governed by Partial Differential Equations

- **Status**: ❌
- **Reason**: Gradient-flow decoding tied to PDE channel modeling; not a binary LDPC decoder technique, application-specific
- **ID**: ieee:11195690
- **Type**: conference
- **Published**: 2025
- **Authors**: T. Wadayama, K. Igarashi, T. Takahashi
- **PDF**: https://ieeexplore.ieee.org/document/11195690
- **Abstract**: Digital communication systems inherently operate through physical media governed by partial differential equations (PDEs). In this paper, we introduce a physics-aware decoding framework that integrates gradient descent-based error correcting algorithms with PDE-based channel modeling using differentiable PDE solvers. At the core of our approach is gradient flow decoding, which harnesses gradient information directly from the PDE solver to guide the decoding process. We validate our method through numerical experiments on both the heat equation and the nonlinear Schrödinger equation (NLSE), demonstrating significant improvements in decoding performance. The implications of this work extend beyond decoding applications, establishing a new paradigm for physicsaware signal processing that shows promise for various signal detection and signal recovery tasks.

## Fixed-Throughput GRAND with FIFO Scheduling

- **Status**: ✅
- **Reason**: GRAND code-agnostic decoder + FIFO HW scheduling for fixed throughput; decoder/HW technique potentially transplantable, keep for Phase 3
- **ID**: ieee:11043562
- **Type**: conference
- **Published**: 2025
- **Authors**: F. Christen, D. Nonaca, C. Studer
- **PDF**: https://ieeexplore.ieee.org/document/11043562
...
## Multi-Carrier MIMO Cognitive BackCom: Adaptive Processing with Temporal Combining Improved Data Stream Decoding

- **Status**: ❌
- **Reason**: 백스캐터 반복코딩+시간결합 — LDPC 아님, 이식 가능 ECC 기법 없음
- **ID**: ieee:11432177
- **Type**: conference
- **Published**: 2025
- **Authors**: R. B. Nti, D. K. P. Asiedu, A. Baghdadi +3
- **PDF**: https://ieeexplore.ieee.org/document/11432177
- **Abstract**: Backscatter communication has evolved, but the research interest has predominantly focused on a single carrier radio frequency source. In this paper, we propose a joint Repetition Coding (RC) and Multi-Source Temporal Combining (TC) framework to enhance the reliability and throughput of backscatter communication. Unlike conventional approaches that rely on a single carrier source or uniform repetition coding, our method dynamically assigns position-aware repetition codes while leveraging multiple ambient RF sources to exploit temporal diversity. We developed an analytical model to evaluate the bit error rate (BER) performance under different coding strategies and source distributions. Furthermore, we derive a closed-form optimization framework for adaptive weight allocation in TC, ensuring that the contribution of each RF source is weighted based on SNR, coherence time, and estimated BER.

## Generalized User-Oriented Image Semantic Coding Empowered by Large Vision-Language Model

- **Status**: ❌
- **Reason**: VLM 기반 사용자지향 이미지 시맨틱 코딩 — ECC 기법 없음
- **ID**: ieee:11432820
- **Type**: conference
- **Published**: 2025
- **Authors**: S. -Y. Huang, V. W. S. Wong
- **PDF**: https://ieeexplore.ieee.org/document/11432820
...
## Research on Key Technologies Based on Wide-Area Distributed Satellite Communication

- **Status**: ❌
- **Reason**: 위성-지상 통신 아키텍처/엣지 압축, LDPC ECC 기법 없음
- **ID**: ieee:11331723
- **Type**: conference
- **Published**: 2025
- **Authors**: L. He, J. Yi, S. Wang
- **PDF**: https://ieeexplore.ieee.org/document/11331723
- **Abstract**: To address the challenges of communication blind spots, high real-time performance requirements, and extreme environment adaptability in wide-area distributed monitoring during the transition of Xinjiang Power Grid towards a “dual-high” pattern (high proportion of new energy and high power electronics), this paper proposes a communication architecture integrating Low Earth Orbit (LEO) satellites with terrestrial Mesh networks. By leveraging satellite-terrestrial collaborative topology optimization, improved adaptive transmission protocols, and edge computing-based data compression technology, full communication coverage in areas without public network access is achieved. Simulation verification demonstrates that the system can accurately capture wide-frequency oscillation signals, effectively supporting the closed-loop “monitoring-decision-suppression” response of the power grid. This provides critical communication guarantees for the safe and stable operation of power grids with a high proportion of new energy.(Abstract)

## Performances of Cost-Effective 50G ONU with Analog FFE and HI-FEC

- **Status**: ❌
- **Reason**: 50G ONU 광통신 analog FFE+Hard-Input-FEC; LDPC 기법 없음
- **ID**: ieee:11046695
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Chevalier, L. A. Neto, G. Simon +9
- **PDF**: https://ieeexplore.ieee.org/document/11046695
- **Abstract**: We propose a cost-effective 50G ONU reception scheme leveraging analog FFE and Hard-Input-FEC, achieving +3.8 dB of coding gain with analog FFE. This implementation reduces costs at ONUs compared to regular SI-FEC+DSP ones.

## Federated Knowledge Distillation for Hybrid Quantum-Classical End-to-End Communications: An Initial Study

- **Status**: ❌
- **Reason**: 하이브리드 양자-고전 E2E 통신용 연합 지식증류 - JSCC/SemCom + 양자신경망, LDPC ECC 무관
- **ID**: ieee:11147223
- **Type**: conference
- **Published**: 2025
- **Authors**: C. Liu, Z. Wei, Y. Chen +1
- **PDF**: https://ieeexplore.ieee.org/document/11147223
- **Abstract**: End-to-end communication systems have advanced significantly with the evolution of machine learning, enabling applications such as joint source-channel coding and semantic communication (SemCom). To bring these capabilities to privacy-sensitive, distributed edge environments, federated learning (FL) provides a promising training framework. However, challenges such as limited data availability, out-of-distribution issues, and model complexity persist—especially in wireless networks with dynamic multi-user interference. To address these, we propose Fed-SKD, a federated knowledge distillation framework that leverages a static teacher model to enhance generalization. Additionally, we explore the integration of hybrid quantum-classical (HQC) networks in the channel encoder-decoder to assess the potential of quantum neural networks. Simulation results demonstrate that Fed-SKD achieves robust performance under unseen interference and limited data conditions.

## MaskDSC: Resilient Digital Semantic Communication with Masked Transformer and Unequal Error Protection

- **Status**: ❌
- **Reason**: Semantic communication with masked Transformer + UEP; no LDPC ECC technique to extract
- **ID**: ieee:10978821
- **Type**: conference
- **Published**: 2025
- **Authors**: J. Wang, K. Tan, S. Wang +3
- **PDF**: https://ieeexplore.ieee.org/document/10978821
...
## Random Matrix Spreading for Unsourced Random Access

- **Status**: ❌
- **Reason**: Unsourced random access용 random matrix spreading; LDPC ECC 아님
- **ID**: ieee:11033976
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Liang, J. Dang, Z. Zhang
- **PDF**: https://ieeexplore.ieee.org/document/11033976
- **Abstract**: Unsourced random access (URA) has broad prospects as a technology that meets the massive access requirements of massive machine type communication scenarios. This paper first establishes a URA system based on random spreading. To overcome the limitation of channel use imposed by the length of spreading codes, a method utilizing random matrices instead of spreading sequences for symbol spreading is designed. Bundling and spreading the adjacent symbols of the data sent by each user, the effective spreading length of each symbol becomes several times of the original spreading code length, while preserving the total number of channel uses. Simulation results demonstrate that using matrix-based spreading can effectively improve the active user detection performance, and enhance the data detection performance to a certain extent.

## Design of a Standard-Compliant Real-Time Neural Receiver for 5G NR

- **Status**: ❌
- **Reason**: 5G NR 뉴럴 리시버(MIMO detection/등화), 채널코딩 LDPC 디코더 기여 없음
- **ID**: ieee:11140048
- **Type**: conference
- **Published**: 2025
- **Authors**: R. Wiesmayr, S. Cammerer, F. A. Aoudia +3
- **PDF**: https://ieeexplore.ieee.org/document/11140048
- **Abstract**: We detail the steps required to deploy a multi-user multiple-input multiple-output (MU-MIMO) neural receiver (NRX) in an actual cellular communication system. This raises several exciting research challenges, including the need for real-time inference and compatibility with the 5G NR standard. As the network configuration in a practical setup can change dynamically within milliseconds, we propose an adaptive NRX architecture capable of supporting dynamic modulation and coding scheme (MCS) configurations without the need for any re-training. This adaptivity comes at no additional inference cost and negligible loss in error-rate performance when compared to the state-of-the-art single-MCS NRX architecture. Furthermore, we optimize the latency of the neural network (NN) architecture to achieve inference times of less than 1 ms on an NVIDIA A100 GPU using the TensorRT inference library. These latency constraints effectively limit the size of the NN and we quantify the resulting signal-to-noise ratio (SNR) degradation as less than 0.7 dB when compared to the preliminary non-real-time NRX architecture. Finally, we explore the potential for site-specific adaptation of the receiver by investigating the required size of the training dataset and the number of fine-tuning iterations to optimize the NRX for specific radio environments using a ray tracing-based channel model. The resulting NRX is ready for deployment in a real-time 5G NR system and the source code including the TensorRT experiments is available online.1

## Demonstration of Low-Complexity Triple-Rate Coherent PON Achieving Up to 200 Gbit/S Symmetric Data Rates

- **Status**: ❌
- **Reason**: 코히어런트 PON 전송 실험 demo — 떼어낼 LDPC 디코더/코드설계 없음
- **ID**: ieee:11263440
- **Type**: conference
- **Published**: 2025
- **Authors**: G. Di Rosa, O. Jovanovic, M. Kuipers +1
- **PDF**: https://ieeexplore.ieee.org/document/11263440
- **Abstract**: We experimentally demonstrate coherent transmission at 100, 150, and $200 \text{Gbit} / \mathrm{s}$ in continuous and burst-mode operation. Subset modulation of DP-QPSK enables power-efficient signal generation while enabling to use the same receiver digital signal processing chain. We achieve link budgets from 35 to 38.6 dB.

## TV 3.0 Geographical Segmentation by Over-the-air Physical Layer

- **Status**: ❌
- **Reason**: TV 3.0 지리적 세그먼테이션 물리계층(LDM/SFN); LDPC ECC 기법 없음
- **ID**: ieee:11165701
- **Type**: conference
- **Published**: 2025
- **Authors**: L. N. Dos Santos Junior, R. S. Rabaça, G. H. M. G. de Oliveira +6
- **PDF**: https://ieeexplore.ieee.org/document/11165701
- **Abstract**: Geographical Segmentation is one of the requirements of TV 3.0. The new generation of Brazilian Digital Terrestrial Television Broadcasting (DTTB) uses a Physical Layer (PL) based on the Advanced Television Systems Committee (ATSC) 3.0 for the Over-The-Air (OTA) with Multiple-Input Multiple-Output (MIMO), Transmitter Identification (TxID) and Layered Division Multiplexing (LDM), also known as ATSC 3.0 - MIMO Extensions (A/322). The main idea of geographical segmentation is to transmit wide-ranging content on a Physical Layer Pipe (PLP) using the Single-Frequency Network (SFN) technique and on another PLP a regionalized content, which allows users in a specific region to have access to a local program. Some techniques, such as LDM, Time-Division Multiplexing (TDM), Frequency-Division Multiplexing (FDM), and their combination, can be used so that each transmitter in the SFN network sends both types of content. This paper presents laboratory test results of Geographic Segmented Localcasting (GSL) in a SFN with LDM. During the tests, the protection ratios were measured considering an SFN network with two transmitters with the same transmission power and, for this reason, delays of 1 and 5 µs were added between the two transmitters to emulate a real system operating condition. This paper presents the first hardware-based GSL reception performance using LDM/MIMO under the A/322 standard. This meaningful technical achievement demonstrates the practical feasibility of GSL reception, moving beyond simulations to real-world validation.

## A Demonstration of a 300-GHz Backhaul Link Using a Lensed Patch Antenna and an OFDM Transceiver

- **Status**: ❌
- **Reason**: 300GHz backhaul OFDM 링크 하드웨어 시연 — 코딩/ECC 무관
- **ID**: ieee:11276297
- **Type**: conference
- **Published**: 2025
- **Authors**: K. Tamesue, S. Nishi, T. Sato +2
- **PDF**: https://ieeexplore.ieee.org/document/11276297
- **Abstract**: This work investigates a 100-meter class backhaul link in a real-time $300-\text{GHz}$ or-thogonal frequency division multiplexing (OFDM) wireless system that employs a heterodyne based transceiver, a $4 \times 4$ element patch antenna integrated with a lens, and an InP-HEMT RF front-end. In the experimental setup, a $40-\text{dBi}$ right-hand circularly polarized (RHCP) patch antenna with a lens was utilized for transmission, supporting beamforming, while a $47-\text{dBi}$ linearly polarized conical horn antenna with a lens was used for reception. Communication was demonstrated using a carrier frequency of 286.2 GHz and a 32-QAM OFDM modulated signal with a $2.0-\text{GHz}$ bandwidth in an indoor line-of-sight (LoS) configuration, achieving an effective data rate of 8.19 Gbps over a transmission distance of 72.4 m.

## On-ground tests of LASIN free space optical communication system dedicated to CO3D constellation

- **Status**: ❌
- **Reason**: 위성 자유공간 광통신 시스템 지상 시험, LDPC 기법 없음
- **ID**: ieee:11443149
- **Type**: conference
- **Published**: 2025
- **Authors**: N. De Guembecker, A. J. P. Gracia, T. Anfray +10
- **PDF**: https://ieeexplore.ieee.org/document/11443149
- **Abstract**: This paper presents an update on LASIN (LASer through the INstrument) free space optical communication system that is embarked on one satellite of the CO3D Earth observation constellation manufactured by Airbus [1].

## First 100G NRZ-OOK PON Demonstration with >31 dB Loss Budget and Coexistence Study over Field-Deployed Fiber

- **Status**: ❌
- **Reason**: 100G PON 라이브 데모, soft-input FEC는 부수 언급, 떼어낼 LDPC 디코더/HW/코드설계 기법 없음 (무선/광통신 응용 특이)
- **ID**: ieee:11046764
- **Type**: conference
- **Published**: 2025
- **Authors**: C. Füllner, D. Van Veen, M. Straub +9
- **PDF**: https://ieeexplore.ieee.org/document/11046764
- **Abstract**: We perform a live demo of 100 G NRZ-OOK PON downstream coexisting with XGS and 25GS PON over field-deployed fiber in Australia. We achieve a loss budget of $\gt 31 \mathrm{~dB}$ using preamplified reception, advanced equalization, and soft-input FEC decoding.

## XPD Degradation Analysis in TV 3.0

- **Status**: ❌
- **Reason**: TV 3.0 MIMO 안테나 XPD 열화 물리 분석; LDPC 관련 떼어낼 기법 전무
- **ID**: ieee:11165681
- **Type**: conference
- **Published**: 2025
- **Authors**: R. S. Rabaça, L. N. Dos Santos Junior, G. L. Montalvão +4
- **PDF**: https://ieeexplore.ieee.org/document/11165681
- **Abstract**: One of the main features of the new Brazilian Digital Terrestrial Television Broadcasting (DTTB) is the use of 2×2 Multiple-Input Multiple-Output (MIMO), to increase the channel capacity. In addition, receiving the TV 3.0 signal is challenging, considering the Very High Frequency (VHF) and Ultra High Frequency (UHF) band and using indoor antennas. TV 3.0 will use the frequency ranges of 174 to 216 MHz, 231 to 237 MHz, 250 to 292 MHz, 345 to 363.5 MHz and 470 to 698 MHz. Despite the gain in transmission capacity, there is an inherent degradation in using a dual polarization antenna, known as the Cross-Polarization Discrimination (XPD) penalty. For TV 3.0, a value of XPD greater than or equal to 20 dB was specified for the receiver antenna. The main objectives of this work are to test the new features of TV 3.0 and conduct laboratory tests with Advanced Television Systems Committee (ATSC) 3.0 with MIMO Extension-compatible equipment. Laboratory measurements were carried out considering Additive White Gaussian Noise (AWGN) environment and indoor reception using Digital Video Broadcasting (DVB)-P1 profile. The results obtained were compared with the theoretical calculations and were consistent with the expected values. The main evaluation of this article is on reception performance considering the indoor reception antenna scenario and the presence of multipath. In this case, considering the XPD value recommended for TV 3.0 of 20 dB and taking into account the single-layer configuration, a Carrier-to-Noise Ratio (C/N) of 12.2 dB (AWGN) and 17.4 dB (DVB-P1) was obtained, while their calculated values were 12.3 dB and 14.4 dB, respectively. For the dual layer configuration, C/N values of 5.3 and 12.2 dB (Core Layer (CL) and Enhanced Layer (EL) with AWGN) and 9.3 and 16.5 dB (CL and EL with DVB-P1) were obtained, while their calculated values were 6.1 and 12 dB (AWGN) and 8.5 and 13.3 dB (DVB-P1).

## Cross-Temperature Effects on NAND Flash in Automotive Systems: A Comprehensive Study and Broad-Scope Mitigation Strategies

- **Status**: ✅
- **Reason**: NAND 플래시 자동차 cross-temperature 신뢰성 직접(A) — Vth 추적·refresh 등 NAND ECC 환경 직접 관련
- **ID**: ieee:11296567
- **Type**: conference
- **Published**: 2025
- **Authors**: V. P, G. Kumar
- **PDF**: https://ieeexplore.ieee.org/document/11296567
- **Abstract**: The advanced electronic features in modern vehicles have driven the widespread adoption of NAND flash memory in automotive systems. NAND flash memory is exposed to wide thermal fluctuations, often ranging from -40°C to +105°C in automotive environments. This often results in cross temperature conditions which significantly impacts reliability and system performance. This paper explores various techniques and a comprehensive review of existing methods that ensure data integrity, reliability, and performance under such conditions. Methods assessed include thermal throttling, Heat watch algorithm, Dynamic Vth (Threshold Voltage) tracking, adaptive data relocation/refresh and ML (Machine Learning) approaches. The study delves into the strengths and limitations of these methods which serve as a reference for engineers and researchers working to enhance data integrity in memory systems, experiencing extreme automotive temperature conditions.

## Probabilistic Shaping for Peak Power Constrained IM-DD Systems: Perspective of Envelope Control

- **Status**: ❌
- **Reason**: IM-DD 광시스템 확률적 셰이핑; LDPC ECC 기법 없음
- **ID**: ieee:11046707
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Zou, W. Wang, M. Yin +5
- **PDF**: https://ieeexplore.ieee.org/document/11046707
- **Abstract**: A novel indirect probabilistic shaping scheme tailed for peak-power constrained IM-DD systems is proposed based on dynamic selective mapping. Collaborating with turbo equalization, about 1 dB receiver sensitivity improvement is observed in a 56GBaud PAM8 system.

## Quasi Coherent PIC Transceiver Technologies for Metro, Access and Front-Haul Networks

- **Status**: ❌
- **Reason**: Si-PIC 준코히어런트 트랜시버 HW, ECC 디코더와 무관
- **ID**: ieee:11125349
- **Type**: conference
- **Published**: 2025
- **Authors**: J. A. Altabas, L. Amati, O. Düzgöl +12
- **PDF**: https://ieeexplore.ieee.org/document/11125349
- **Abstract**: Quasi-coherent transceivers are a key technology for scaling up the capacity of the metro, access and front-haul networks. This paper shows the last progresses on the development of quasi-coherent transceivers based on silicon photonic integrated circuits (Si-PIC) with analog chromatic dispersion compensation (CDC) techniques included on an electronic integrated circuit (EIC).

## Enabling High-Order Modulation Over Fading Channels Using E2E Deep Learning-Based Transceiver Optimization

- **Status**: ❌
- **Reason**: E2E 딥러닝 송수신 최적화(학습 가능 constellation+CNN demapper) — 변조/복조 수준, LDPC 디코더 아님, 떼어낼 ECC 기법 없음
- **ID**: ieee:11059525
- **Type**: conference
- **Published**: 2025
- **Authors**: M. Allani, G. Kaddoum, H. Barka
- **PDF**: https://ieeexplore.ieee.org/document/11059525
- **Abstract**: In modern wireless communication systems, using high-order modulation is often key to achieving high data rates while maintaining a good spectral efficiency. By packing more bits into each transmitted symbol, more data can be sent over a given bandwidth, but that also makes the transmission more vulnerable to fading and noise. Moreover, traditional methods often isolate the design and optimization of transmitters and receivers, leading to poor error rate performances. To tackle these challenges, we propose a novel end-to-end (E2E) optimization strategy that includes a trainable constellation at the transmitter and a convolutional neural network (CNN)based demapper at the receiver. The transmitter and receiver are jointly trained to handle channel fading and detect symbols with minimal errors. Our findings demonstrate that the proposed transceiver architecture exhibits a significantly lower bit-error rate (BER) than traditional modulation methods and earlier dense layer-based models, especially for high-order modulation.

## Feedforward Compensation of Frequency Drift and Phase Noise of Sub-THz Signal in Optical Heterodyne Technique

- **Status**: ❌
- **Reason**: sub-THz 광 헤테로다인 위상잡음 보상, 채널코딩 무관
- **ID**: ieee:11349800
- **Type**: conference
- **Published**: 2025
- **Authors**: K. Woo, H. Kim
- **PDF**: https://ieeexplore.ieee.org/document/11349800
- **Abstract**: Photonics approach to generate sub-THz signals offers a compelling pathway toward future high-speed wireless systems, but its practical use is often hindered by the frequency instability and phase noise of free-running lasers. In this paper, we present a feedforward compensation scheme that significantly enhances frequency and phase performance of sub-THz signals generated by the optical heterodyne technique. By detecting the frequency drift and phase fluctuations of sub-THz signal and applying them to optical modulation, we suppress the frequency drift and phase fluctuations without employing wavelength locking or feedback control of lasers. Experimental results show that this approach achieves substantial improvement in frequency stability and phase noise performance, along with successful wireless transmission of 80-Gb/s 16-QAM signals. These findings highlight the potential of feedforward compensation-based photonic sub-THz transmitters for next-generation wireless applications.

## Multishape Radio: Advanced Electromagnetic Wave Manipulation for Enabling 6G Wireless Communications

- **Status**: ❌
- **Reason**: 6G 전자기파 조작(OAM/Airy/Bessel), 코딩 무관
- **ID**: ieee:11379134
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Lee, H. Sasaki, Y. Yagi +2
- **PDF**: https://ieeexplore.ieee.org/document/11379134
- **Abstract**: The progression toward 6G wireless networks necessitates innovative methodologies to harness electromagnetic wave characteristics that have remained underexploited in traditional communication systems. This work presents "multishape radio," a transformative framework that capitalizes on sophisticated electromagnetic field properties previously overlooked in conventional wireless applications. We establish three groundbreaking approaches: orbital angular momentum (OAM) beams demonstrating exceptional wireless multiplexing capacity, Airy beams facilitating interference-minimized transmission through distinctive sidelobe characteristics, and Bessel beams delivering reception signal power enhancement via non-diffractive wave propagation. Experimental validation in sub-terahertz bands substantiates the transformative potential of multishape radio for advancing bandwidth efficiency, interference suppression, and transmission reliability in future wireless infrastructures. These achievements position multishape radio as a revolutionary methodology for leveraging varied electromagnetic wave behaviors in emerging communication technologies.

## Beyond Bandwidth Doubling: Embrace Bit-Flips and Unlock Processing-in-NAND

- **Status**: ✅
- **Reason**: Processing-in-NAND, bit-flip 에러 내성 직접 다룸(A 카테고리 NAND 직접). 애매하나 NAND 직접이라 살림
- **ID**: ieee:11112955
- **Type**: conference
- **Published**: 2025
- **Authors**: M. Berens, Y. -C. Chen, J. -J. Chen +1
- **PDF**: https://ieeexplore.ieee.org/document/11112955
...
- **Status**: ❌
- **Reason**: ns-3 5G 사이드링크 패킷 오류 모델/링크-시스템 매핑 — ECC 기법 없음
- **ID**: ieee:11416131
- **Type**: conference
- **Published**: 2025
- **Authors**: T. R. Henderson, P. Liu, C. Liu +1
- **PDF**: https://ieeexplore.ieee.org/document/11416131
- **Abstract**: We describe new packet error models for the Network Simulator version 3 (ns-3) New Radio (NR) sidelink simulation models, derived from an extensive simulation campaign using the National Institute of Standards and Technology (NIST) Fifth Generation (5G) NR Sidelink Link-Level Simulator (LLS). The new error models support the system-level simulation of future 5G sidelink-based public safety scenarios. We first describe the scope, methodology, and output of the link-level campaign and its validation. We next describe the options available to map this data into ns-3 error models, and discuss how we handled various integration issues including interpolation, extrapolation, the need for per-retransmission error tables in ns-3, and how to handle retransmissions with varying signal-to-noise ratio (SNR). Finally, we illustrate the sensitivity of the models to changes in coding, frequency band, numerology, retransmission attempts, and transport block size, and describe our future plans.

## Enhanced Channel Estimation and Error Correction in Vertical UWOC Systems with Non-Line-of-Sight Communication

- **Status**: ❌
- **Reason**: UWOC NLOS 시스템, HVD Turbo coding+OAM PPM — Turbo 코드 기반, LDPC ECC 이식 기법 없음
- **ID**: ieee:11070767
- **Type**: conference
- **Published**: 2025
- **Authors**: V. Kushwaha, D. Manasa, V. Dhote +3
- **PDF**: https://ieeexplore.ieee.org/document/11070767
- **Abstract**: The MIMO - OFDM scheme to provide vertical NLOS and UWOC system channels and methods of channel evaluation and error adjustment are discussed in this chapter. Both these systems were intended to be operated vertically. Once the error within the input sequence has been corrected using Horizontal Vertical Diagonal (HVD) Turbo coding model the error free signal is then modulated with M array Over Modal Axis (OAM) Parity Probability Modulation (PPM). It is done in order to make sure that the signal is right. The Vertical NLOS channel is then used to send forward the modulated signal, converted to an optical signal. The signal is transmitted forward until this process is repeated. After receiving the signal, models that are not so dissimilar perform the demodulation and decoding of the signal. The BER function, channel ability, and data rate outcomes guarantee that the newly formed scheme is more effective than any other scheme proposed. We show by comparison of the newly established scheme to other approaches.

## Reliable Industrial Wireless Communication: Multi-Service MCS Approaches

- **Status**: ❌
- **Reason**: 산업용 무선 NOMA+UEP+MCS; LDPC 디코더·코드설계 기법 없음 (무선 응용 특이적)
- **ID**: ieee:11162242
- **Type**: conference
- **Published**: 2025
- **Authors**: N. Bulk, C. Bockelmann, A. Dekorsy
- **PDF**: https://ieeexplore.ieee.org/document/11162242
- **Abstract**: In industrial settings, reliable and efficient data transmission is crucial. However, traditional Orthogonal Multiple Access (OMA) techniques are limited by their inability to manage mixed-criticality systems and varying data importance. We propose a novel transmission scheme that combines Non-Orthogonal Multiple Access (NOMA) with Unequal Error Protection (UEP) and leverages Multi-Service Modulation and Coding Scheme (MCS) (MS-MCS) tables. This approach enables simultaneous transmission of multiple services over a single channel, each with tailored reliability levels, improving spectral efficiency and reliability in dense wireless environments.

## Probabilistic Semantic Communication for Image Transmission Via Scene Graph Compression

- **Status**: ❌
- **Reason**: 시맨틱 통신 이미지 전송, ECC 기법 없음 (제외 대상)
- **ID**: ieee:11352114
- **Type**: conference
- **Published**: 2025
- **Authors**: C. Zhu, Z. Zhao, S. Liang +4
- **PDF**: https://ieeexplore.ieee.org/document/11352114
- **Abstract**: Semantic communication emphasizes the transmission of meaning rather than raw symbols. It offers a promising solution to alleviate network congestion and improve transmission efficiency. In this paper, we propose a wireless image communication framework that employs probabilistic graphs as a shared semantic knowledge base among distributed users. High-level image semantics are represented via scene graphs, and a two-stage compression algorithm is devised to remove predictable components based on learned conditional and co-occurrence probabilities. At the transmitter, the algorithm filters redundant relations and entity pairs, while at the receiver, semantic recovery leverages the same probabilistic graphs to reconstruct omitted information. Simulation results demonstrate that our semantic-aware scheme achieves superior transmission throughput and semantic alignment under constrained bandwidth, validating the efficacy of leveraging high-level semantics for image transmission.

## Resisting Quantization Noise in Semantic Image Communication with Adversarial Learning-enabled HARQ

- **Status**: ❌
- **Reason**: 시맨틱 이미지 통신 양자화노이즈 HARQ — 시맨틱 통신, LDPC ECC 기법 없음
- **ID**: ieee:11310172
- **Type**: conference
- **Published**: 2025
- **Authors**: C. Mao, Z. Zhang, J. Xue +1
- **PDF**: https://ieeexplore.ieee.org/document/11310172
...
## Lightweight Semantic Communication Model Driven UAV for Intelligent Transmission

- **Status**: ❌
- **Reason**: 시맨틱 통신 + JSCC 이미지 전송, ECC LDPC 기법 없음
- **ID**: ieee:11010292
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Liang
- **PDF**: https://ieeexplore.ieee.org/document/11010292
- **Abstract**: Unmanned Aerial Vehicles (UAVs) are crucial tools for remote sensing tasks. However, UAVs face limitations in computational and communication resources. In the context of the exponential growth of remote sensing data, it is necessary that this captured information be transmitted to powerful ground servers for better processing. To accomplish this task efficiently, this paper proposes an intelligent transmission scheme based on semantic communication. An end-to-end encoder-decoder network is trained to understand the semantic features of remote sensing images, ultimately reconstructing high-quality original images, which significantly reduces channel resource overhead. Additionally, to further reduce the computational load on the transmitter to better align with practical constraints, this paper introduces a pruning method based on $l_{1}$-norm regularization, which reduce the overall computational cost of the model while maintaining performance. Simulation results demonstrate that, compared to baseline models, the proposed system features a more lightweight architecture and superior performance, even under low signal-to-noise ratio (SNR) conditions.

## Reliability Analysis of Vehicular VLC Systems Under Diverse Atmospheric and Geometric Conditions

- **Status**: ❌
- **Reason**: 차량 VLC 신뢰성 분석, BER/SNR 환경 평가만 — 떼어낼 LDPC 디코더/HW/코드설계 없음
- **ID**: ieee:11241977
- **Type**: conference
- **Published**: 2025
- **Authors**: A. Sharma, S. Pandey, S. Kaur
- **PDF**: https://ieeexplore.ieee.org/document/11241977
- **Abstract**: Vehicular Visible Light Communication (V-VLC) offers a high-speed and interference-resistant solution for data transmission between smart vehicles. However, its performance and reliability are highly dependent on various environmental factors and geometric configurations. This study presents a detailed performance evaluation of V-VLC systems under varying weather conditions including fog, rain, haze and clear weather in case of single-lane scenario using Light Fidelity (LiFi) enabled light emitting diodes (LED's). Time and distance analyses have been performed on the key parameters such as bit error rate (BER), channel gain, signal-to-noise ratio (SNR), throughput, received power, and responsivity. The Lambertian model is employed to estimate the channel gain, and the realworld attenuation coefficients in dB/km and are used to model air attenuation. Meanwhile, the results show that there is a major performance decline observed under the presence of fog weather with a SNR value reducing to 7 dB and the received power falling to −39 dBm in case of the proposed V-VLC system.

## Faster-than-Nyquist Equalization with Convolutional Neural Networks

- **Status**: ❌
- **Reason**: FTN ISI 등화/복조용 CNN — LDPC는 부수 코딩으로만 언급, 디코더 기여 아님
- **ID**: ieee:11274769
- **Type**: conference
- **Published**: 2025
- **Authors**: B. De Filippo, C. Amatetti, A. Vanelli-Coralli
- **PDF**: https://ieeexplore.ieee.org/document/11274769
...
- **Status**: ❌
- **Reason**: Sparse vector coding(ST-SVC) 단포패킷 전송 기법; LDPC ECC 아님, 떼어낼 기법 없음
- **ID**: ieee:10978477
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Zhang, X. Fan, H. Liang +3
- **PDF**: https://ieeexplore.ieee.org/document/10978477
...
## LoRA-MAEJSCC: Masked Autoencoders for Semantic Communications using Low-Rank Adaptation

- **Status**: ❌
- **Reason**: 시맨틱 통신 JSCC(MAE+LoRA) — 채널 ECC 기법 아님, 제외 대상(시맨틱/JSCC)
- **ID**: ieee:11268696
- **Type**: conference
- **Published**: 2025
- **Authors**: T. A. Nguyen, T. Ngoc Thinh, T. van Nguyen +1
- **PDF**: https://ieeexplore.ieee.org/document/11268696
- **Abstract**: The rapid proliferation of IoT applications has led to spectrum resource constraints, increased power consumption, higher bandwidth usage, and transmission delays. To address these challenges, recent research has focused on semantic communication (SemCom), an emerging 6G network paradigm that prioritizes transmitting only the most important and distinctive information. As part of this effort, we propose MAEJSCC, a SemCom framework based on Vision Transformers, which leverages Masked Autoencoder to achieve robust and efficient transmission in noisy environments. Additionally, we further develop LoRA-MAEJSCC, a lightweight and efficient variant of MAEJSCC by integrating Low-Rank Adaptation (LoRA) into the linear layers. Experimental results show that LoRA-MAEJSCC achieves competitive classification performance while drastically reducing the number of trainable parameters and adaptation costs compared to the proposed MAEJSCC.

## Design Issues for Encodings for Inter-Satellite Optical Communications using Single Photon Avalanche Detectors

- **Status**: ✅
- **Reason**: Belief propagation to prepare asymmetric SPAD photon detections for error/erasure code; BP decoder adaptation to asymmetric channel is portable (C), and NAND has asymmetric LLR concerns
- **ID**: ieee:10993833
- **Type**: conference
- **Published**: 2025
- **Authors**: T. Schwarz
- **PDF**: https://ieeexplore.ieee.org/document/10993833
- **Abstract**: Optical line-of-sight communication in deep space uses lasers for signal creation and Single-Photon Avalanche Diodes (SPAD) for reception. In the ideal case, a single photon or its absence is needed to send one bit. In reality, neither transmission nor reception are perfect. The natural approach uses On-Off encoding where a bit is represented by a burst or its absence. Decoding then uses a simple threshold. In the harsh environment of space, SPAD deteriorate and will develop significant dead-count, where a non-existing photon is captured. On the other hand, not every photon is detected. The error probabilities are not symmetric. We find here that belief propagation is the only way to prepare raw photon detection numbers for submission to an error and erasure correcting code.

## A Design Generator of Parameterizable and Runtime Reconfigurable OFDM Processors

- **Status**: ❌
- **Reason**: OFDM 프로세서 생성기, ECC는 파라미터로 부수 언급 — 떼어낼 LDPC 기법 없음
- **ID**: ieee:11244447
- **Type**: conference
- **Published**: 2025
- **Authors**: S. Zhou, G. Wang, G. Gu +1
- **PDF**: https://ieeexplore.ieee.org/document/11244447
...
- **Status**: ❌
- **Reason**: JSCC 시맨틱 통신 이미지 전송/디블러; 소스-채널 결합으로 떼어낼 ECC 기법 없음
- **ID**: ieee:11174920
- **Type**: conference
- **Published**: 2025
- **Authors**: P. Yang, G. Zhang, Y. Cai +2
- **PDF**: https://ieeexplore.ieee.org/document/11174920
...
## Online vs. Offline Machine Learning Based Forecast for ACM on Q/V-Band Satellite Links

- **Status**: ❌
- **Reason**: 위성 ACM에 ML 기반 SNR 예측 — LDPC/ECC 무관, 떼어낼 디코더·코드설계 기법 없음
- **ID**: ieee:11288962
- **Type**: conference
- **Published**: 2025
- **Authors**: M. Fetescu, J. Ebert, K. Plimon +4
- **PDF**: https://ieeexplore.ieee.org/document/11288962
- **Abstract**: Adaptive Coding and Modulation (ACM) is a common approach in satellite communications to enhance link efficiency. However, traditional ACM systems can suffer from slow adaptation to changing channel conditions, leading to performance degradation. This paper therefore presents a comparative analysis of online and offline machine learning (ML) methods for short-term signal-to-noise ratio (SNR) forecasting to enhance ACM in Q/V-band satellite links. Based on a two-year dataset from Alphasat measurements, both offline eXtreme Gradient Boosting (XGBoost) and Online Random Regression Forest (ORRF) models are evaluated in univariate and multivariate forecasting configurations. The study also conducts a detailed input feature assessment for both ML models employed. Results demonstrate that ORRF offers a substantial improvement in spectral efficiency over classical ACM through continuous online adaptation, while XGBoost achieves even greater gains by leveraging offline training. These findings support the adoption of robust, ML-driven ACM strategies in future high-frequency satellite missions, with benefits for telemetry and command, as well as fast and reliable payload data transmission (PDT).

## A Comparative Study and Evaluation of 64-DP-QAM and 128-DP-QAM Modulated Signals in High-Capacity Long-Haul Optical Transmission

- **Status**: ❌
- **Reason**: 장거리 광통신 QAM 변조 비교, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11365749
- **Type**: conference
- **Published**: 2025
- **Authors**: S. Rani, S. Singh, S. P. Singh
- **PDF**: https://ieeexplore.ieee.org/document/11365749
- **Abstract**: With growing interest in beyond-5G technologies, this study reviews and examines the details of modulation techniques that offer improved power and bandwidth efficiency for next-generation communication systems. A high-order modulation technique performs a very significant function in accommodating the growing traffic demands of modern transmission networks. High-capacity optical transmission has been extensively explored for long-distance communication links. Numerous approaches have been proposed to enhance system performance, among which the development of optimal modulation schemes has remained a core strategy. The efficiency of a communication system is determined by key parameters including bandwidth availability, power usage, and overall cost. The QAM with appropriate channel coding is a better choice for long range and high data rate communication. This work presents a performance analysis and comparison of 64-QAM and 128-QAM modulation formats employing dual polarization in long-haul optical communication systems. An investigation was conducted at a data rate of $70 \text{Gbps}, 84 \text{Gbps}$ and 120 Gbps over a fiber link spanning at 100 k and 150 km by employ the 64-DP-QAM and 1400 km distance achieved by 128-DP-QAM modulation. The samples per bit are used such as 8 and 32. The simulation allows for the observation of the constellation diagram, optical spectrum for representation of the optical signal.

## Performance Analysis and Configuration of 5G NR for V2X Communications

- **Status**: ❌
- **Reason**: 5G NR V2X 성능 분석, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11345431
- **Type**: conference
- **Published**: 2025
- **Authors**: N. C. Hu, L. Méndez-Monsanto, A. G. Armada
- **PDF**: https://ieeexplore.ieee.org/document/11345431
- **Abstract**: Remote driving relies heavily on high-reliability, low-latency, and high-throughput vehicular communication systems. Fifth-Generation (5G) stands out as the promising technology to meet these stringent requirements. This paper presents a comprehensive analysis of the performance of 5G radio access for remote driving scenarios. Specifically, it investigates the interplay between 5G numerologies, Modulation and Coding Scheme (MCS), vehicular velocities, and propagation channel models representative of urban and highway environments. For each configuration, the minimum Signal-to-Noise Ratio (SNR) required to achieve target Block Error Rate (BLER) of 10−1, 10−2 and 10−3 is determined. Additionally, we examine the asymmetric Uplink (UL) and Downlink (DL) throughput demands characteristic of remote driving use cases. The results provide insights into optimal parameter configurations for reliable 5G-based remote vehicle control under various mobility and channel conditions.
...
- **Status**: ❌
- **Reason**: DVB-S2X/5G NR-NTN 물리계층 성능 비교 — LDPC가 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:10946061
- **Type**: conference
- **Published**: 2025
- **Authors**: B. Chamaillard, A. Traoré, N. Borios +1
- **PDF**: https://ieeexplore.ieee.org/document/10946061
...
## Throughput and Capacity Analysis of LiFi-Over-Powerline

- **Status**: ❌
- **Reason**: LiFi-over-powerline 채널 용량·throughput 측정 연구, FEC는 부수 언급, 이식 가능 LDPC 기법 없음
- **ID**: ieee:11197371
- **Type**: conference
- **Published**: 2025
- **Authors**: A. Pouralizadeh, K. L. Bober, V. Jungnickel +1
- **PDF**: https://ieeexplore.ieee.org/document/11197371
- **Abstract**: A combination of optical wireless communication (also denoted as LiFi), and powerline communication offers a promising solution for wireless extension of data networks operating in unlicensed optical bands with no interference from radio. This paper reports on a measurement campaign conducted to characterize a LiFi-over-powerline link. The channel frequency response and the corresponding signal-to-noise ratio were measured up to 100 MHz under four various channel conditions, including liFi-only, powerline-only, cascaded PLCLiFi and cascaded power grid and LiFi links. In addition, the Shannon capacity and throughput, using both uniform and adaptive bit-loading, were evaluated to provide a complete linklevel performance assessment. For a power grid combined with 100 cm LiFi link, the results indicate a net data rate of $492 \text{Mbit} / \mathrm{s}$ after forward error correction decoding with a target bit error rate of $10^{-2}$, while the estimated capacity is $\mathbf{7 8 5 M b i t} /$ s.

## Low-Complex LLR Computation for 5G-NR

- **Status**: ❌
- **Reason**: 5G-NR QAM LLR 계산 — 변조 복조 LLR이지 LDPC 디코더 ECC 아님, 채널 LLR과 무관
- **ID**: ieee:11317690
- **Type**: conference
- **Published**: 2025
- **Authors**: A. M. K, S. Soujanya, P. Singh
- **PDF**: https://ieeexplore.ieee.org/document/11317690
- **Abstract**: This paper presents a novel, low-complex algorithm for log-likelihood ratio (LLR) computation tailored for higher-order quadrature amplitude modulation (QAM) modulation schemes in fifth-generation new radio (5G-NR) systems. Unlike conventional approaches that require distinct, complex calculations for each modulation order, the proposed method uses a recursive framework that models LLR calculation as a scaled and shifted quadrature phase shift keying (QPSK) problem, enabling scalability and uniformity across modulation schemes. The proposed algorithm significantly reduces computational complexity and execution time by utilizing only linear operations and avoiding computationally intensive operations, making it highly suitable for hardware implementation. These reductions are achieved by the proposed scheme with almost no compromise in block error rate (BLER) performance, as demonstrated by simulation results. Its recursive and scalable design makes it a promising solution for efficient LLR computation in higher-order modulation schemes used in 5G-NR systems.

## The Dawn of 6G Standardization: Thinking on Physical Layer Design by Learning From 5G

- **Status**: ❌
- **Reason**: 6G 물리계층 설계 전망/서베이, 떼어낼 LDPC 디코더·코드설계 기법 없음
- **ID**: ieee:11437921
- **Type**: conference
- **Published**: 2025
- **Authors**: N. Li, F. Nan, H. Yin +1
- **PDF**: https://ieeexplore.ieee.org/document/11437921
- **Abstract**: Till now, millions of 5 G base stations have been deployed all over the world. We've witnessed the achievements of 5G, while also gained a clear understanding of its challenges. In Aug. 2025, 3 GPP initiated the study on 6 G standardization, indicating the era of 6 G was coming. During this transitional window from 5 G to 6 G, a thorough assessment of 5 G 's strengths and shortcomings is essential to leverage these insights for the design of 6 G networks. This paper provides a comprehensive analysis of potential 6 G physical layer design based on lessons learned from 5 G together with the latest progress in 3GPP. Furthermore, some key research areas for 6G developments are identified from telecom operator's perspective.

## A Reliable and Computationally Efficient Soft-Output Fixed-Complexity Sphere Decoder for Large-Scale MIMO Systems

- **Status**: ❌
- **Reason**: 대규모 MIMO 구체 디코더(LLR refinement); MIMO 검출이지 LDPC ECC 아님, 이식 기법 없음
- **ID**: ieee:11174531
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. -M. Chen, S. -J. Jhang, Y. -L. Ueng
- **PDF**: https://ieeexplore.ieee.org/document/11174531
- **Abstract**: This paper explores a robust and computationally efficient soft-output fixed-complexity sphere decoder (FSD) designed for large-scale multiple-input multiple-output (MIMO) detection. A partial expansion strategy is designed for the first two layers of the proposed FSD, utilizing enumeration orders for both the real and imaginary components of the signal space. Additionally, a section-wise list candidate selection method, incorporating an innovative grouping strategy, is specifically designed for the leaf layer. These techniques complement each other to significantly reduce computational complexity and minimize processing delays. Furthermore, log-likelihood ratio (LLR) refinement is implemented to counteract overestimation caused by the bit-flipping algorithm, leading to notable improvements in error performance. Simulation results demonstrate that the proposed soft-output FSD achieves superior error performance compared to benchmark schemes and approaches the list sphere decoder, while maintaining significantly lower complexity.

## STAR: Improving Lifetime and Performance of High-Capacity Modern SSDs Using State-Aware Randomizer

- **Status**: ✅
- **Reason**: 3D NAND retention 에러 대응 STAR 랜덤라이저 — NAND/SSD 직접(A)
- **ID**: ieee:11240772
- **Type**: conference
- **Published**: 2025
- **Authors**: O. Kwon, K. Oh, J. Lee +2
- **PDF**: https://ieeexplore.ieee.org/document/11240772
- **Abstract**: Although NAND flash memory has achieved continuous capacity improvements via advanced 3D stacking and multi-level cell technologies, these innovations introduce new reliability challenges, particularly lateral charge spreading (LCS), absent in low-capacity 2D flash memory. Since LCS significantly increases retention errors over time, addressing this problem is essential to ensure the lifetime of modern SSDs employing high-capacity 3D flash memory. In this paper, we propose a novel data randomizer, STate-Aware Randomizer (STAR), which proactively eliminates the majority of weak data patterns responsible for retention errors caused by LCS. Unlike existing techniques that target only specific worst-case patterns, STAR effectively removes a broad spectrum of weak patterns, significantly enhancing reliability against LCS. By employing several optimization schemes, STAR can be efficiently integrated into the existing I/O datapath of an SSD controller with negligible timing overhead. To evaluate the proposed STAR scheme, we developed a STAR-aware SSD emulator based on characterization results from 160 real 3D NAND flash chips. Experimental results demonstrate that STAR improves SSD lifetime by up to 2.3× and reduces read latency by an average of 50% on real-world traces compared to conventional SSDs.

## Secure Semantic Image Transmission over Wiretap Channels

- **Status**: ❌
- **Reason**: 도청채널 시맨틱 이미지 전송/빔포밍 보안 — LDPC ECC 기법 없음
- **ID**: ieee:11431665
- **Type**: conference
- **Published**: 2025
- **Authors**: X. Han, B. Feng, Y. Wu +2
- **PDF**: https://ieeexplore.ieee.org/document/11431665
...
## Integrating Post-Quantum Cryptography with DNA-Based Data Storage for Secure and Robust Data Preservation

- **Status**: ❌
- **Reason**: PQC+DNA 저장 보안 프레임워크, repetition coding 수준 outer code만; 이식할 LDPC ECC 기법 없음
- **ID**: ieee:11324504
- **Type**: conference
- **Published**: 2025
- **Authors**: J. M. Joseph, S. Cs, S. Vinod
- **PDF**: https://ieeexplore.ieee.org/document/11324504
...
- **Status**: ❌
- **Reason**: AI-RAN GPU 플랫폼/테스트베드 소개, LDPC ECC 기법 없음
- **ID**: ieee:11140427
- **Type**: conference
- **Published**: 2025
- **Authors**: S. Cammerer, G. Marcus, T. Zirr +4
- **PDF**: https://ieeexplore.ieee.org/document/11140427
...
- **Status**: ❌
- **Reason**: Ka-band 위성 송신기 HW 개발, 고차 변조(8PSK/16APSK) — 채널코딩 부수 언급, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11068512
- **Type**: conference
- **Published**: 2025
- **Authors**: M. M. Kobayashi, T. Voss, B. Douglas +5
- **PDF**: https://ieeexplore.ieee.org/document/11068512
- **Abstract**: Advancements in spaceborne remote sensing technology have significantly increased the amount of data generated onboard spacecraft, necessitating a robust downlink system capable of much higher rates than previously required. For the NASA/ISRO Synthetic Aperture Radar (NISAR) mission the Jet Propulsion Laboratory (JPL) has developed a Ka-band Modulator (KaM) variant of the Universal Space Transponder (UST) product line to support 2000 Msps downlink from a single radio using Offset QPSK (OQPSK) modulation in the Earth Exploration Satellite Service (EESS) band from 25.5 to 27.0 GHz. The KaM has successfully completed its protoflight development campaign and flight models have been integrated onto the NISAR spacecraft, awaiting its launch. The KaM is a Software-Defined Radio (SDR) that offers the flexibility to change all aspects of the RF modulation to channel coding without altering the underlying hardware. This paper describes aspects of the design/implementation trade space to achieve higher data rates on the KaM while meeting transmission band spectral limitations. We explore the use of higher-order modulation schemes such as 8PSK and 16APSK, which can substantially increase data throughput within the available 1500 MHz bandwidth of the EESS band. Performance simulations and prototype radio-based characterization tests demonstrate that with firmware updates, the KaM can be upgraded to support data rates up to 3000 Msps using 8PSK modulation and 4000 Msps using 16APSK modulation. By employing a dual polarization downlink scheme using 16APSK, the updated radio could enable downlink rates of up to 8000 Msps for future missions with much greater downlink volume requirements. Link analyses are presented for Low Earth Orbit science satellites comparing the data rates against station coverage time to NASA's Near Space Network (NSN) and possible daily downlink volumes. A feasibility study is presented that evaluates high-rate lunar downlinks, pairing KaM technology with proposed Lunar Exploration Ground Sites (LEGS) considering current high-power amplifiers and antenna technology. Additionally, future Mars surface terminal links are analyzed to explore the viability of high-rate relay communications from the Martian surface to future Mars relay orbiters.

## Hardware Implementation of Blind Decoding of Downlink Control Information for 5G

- **Status**: ❌
- **Reason**: 5G DCI 블라인드 디코딩 HW — 제어정보 탐색 구현이며 LDPC 디코더 아님, NAND로 이식할 ECC 기법 없음
- **ID**: ieee:10900633
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Anu rajarajeswari, N. Chandrachoodan, A. B. Vadapalli +1
- **PDF**: https://ieeexplore.ieee.org/document/10900633
- **Abstract**: The user equipment (UE) based on the fifthgeneration new radio wireless communication technology standardized by 3GPP receives downlink control information (DCI) to obtain the time-frequency resources, modulation order, code rate, etc required for decoding the received data. The location of the resources containing the DCI will not be directly known to the UE instead it is received in certain possible locations informed through signaling. The UE must blindly decode multiple DCIs with different lengths from the different possible locations within a very stringent time limit of the order of 0.25 ms. This involves time consuming exhaustive search and imposes significant computation load to identify the locations for decoding multiple DCIs. In this paper, a flexible hardware implementation to perform the blind decoding (BD) within the time limit is proposed. It is found that the decoding is completed within 65% of the time available for BD by utilizing optimal resources. The proposed implementation is tested and validated for its functionality and performance using the in-house 5G testbed implemented using the Zynq Ultrascale + RFSoC ZCU111 board from Xilinx by integrating into an existing UE receive chain.

## Achievability of Covert Quantum Communication

- **Status**: ❌
- **Reason**: 양자 은닉통신(qubit covert) achievability 이론; 양자 EC 원칙 제외, 고전 LDPC 유래 이식 기법 없음
- **ID**: ieee:11195542
- **Type**: conference
- **Published**: 2025
- **Authors**: E. J. D. Anderson, M. S. Bullock, F. Rozpędek +1
- **PDF**: https://ieeexplore.ieee.org/document/11195542
- **Abstract**: We explore covert communication of qubits over an arbitrary quantum channel. Covert communication conceals the transmissions in the channel noise, ensuring that an adversary is unable to detect their presence. We show the achievability of a square root law (SRL) for quantum covert communication similar to that for classical: $M(n) \sqrt{n}$ qubits can be transmitted covertly and reliably over $n$ uses of a general quantum channel. We lower bound $M (n)$ with and without assistance from a two-way covert classical channel. In the former case, we quantify the number of classical covert bits sufficient for our protocol.

## Drones Jittering Enhanced Physical-Layer Key Generation

- **Status**: ❌
- **Reason**: 드론 물리계층 키생성(보안), LDPC ECC 기법 없음
- **ID**: ieee:11138233
- **Type**: conference
- **Published**: 2025
- **Authors**: T. Chen, D. Li, X. Fan +1
- **PDF**: https://ieeexplore.ieee.org/document/11138233
- **Abstract**: Physical-layer key generation (PLKG) has gained critical importance for secure drone communications due to its lightweight implementation and adaptability to resource-constrained drones. However, the dominant line-of-sight path in drone channels limits wireless randomness, thereby degrading the key generation rate (KGR). To solve this problem, we propose a novel endogenous drone jittering enhanced PLKG scheme, which integrates the inherent drone jittering randomness to enhance KGR. By analyzing wireless signals and inertial measurement unit (IMU) data in the time-frequency domain, we find that the frequency of drone jittering falls within the 0-50 Hz range. Then, the discrete wavelet transform is used to extract jittering components. We quantize both the wireless signals and the extracted jittering components, then use XOR operation to combine their randomness. This forms a hybrid key generation scheme that enhances PLKG. We experimentally collect extensive wireless signal data and IMU data, and the experimental results show that, compared with the traditional PLKG scheme, the proposed scheme increases KGR by 18.6%. Furthermore, the National Institute of Standards and Technology randomness test confirms that the generated hybrid key meets sufficient randomness standards.

## Resolution Limits of Non-Adaptive 20 Questions Estimation for Tracking Multiple Moving Targets

- **Status**: ❌
- **Reason**: 20-questions estimation / target tracking with threshold decoding; pure estimation theory, not LDPC
- **ID**: ieee:11240310
- **Type**: conference
- **Published**: 2025
- **Authors**: C. Sun, L. Zhou, J. Wang +3
- **PDF**: https://ieeexplore.ieee.org/document/11240310
...
- **Status**: ❌
- **Reason**: QKD/post-quantum security; error-reconciliation codes for QKD, not channel-coding binary LDPC ECC
- **ID**: ieee:11000199
- **Type**: conference
- **Published**: 2025
- **Authors**: A. Rani, X. Ai, A. Gupta +2
- **PDF**: https://ieeexplore.ieee.org/document/11000199
...
## Hybrid-Domain DNN Demodulator Under Hardware Impairments on SC-FDE Transmission

- **Status**: ❌
- **Reason**: 6G sub-THz용 DNN 복조기로 LLR 추정; 채널 복조 응용 특이적, NAND LDPC로 떼어낼 디코더/코드/HW 기법 없음
- **ID**: ieee:11174540
- **Type**: conference
- **Published**: 2025
- **Authors**: K. Kuriyama, K. Tanaka, H. Hasegawa +4
- **PDF**: https://ieeexplore.ieee.org/document/11174540
- **Abstract**: We propose two deep neural network (DNN)-based demodulators for log likelihood ratio (LLR) estimation to mitigate hardware impairments. At high-frequency bands, such as the sub-terahertz (sub-THz) wave bands expected to be used in the sixth-generation mobile communication system (6G), hardware impairments such as nonlinear distortion of power amplifiers (PA) and in-phase and quadrature (IQ) imbalance of direct IQ modulators are key challenges to be addressed. We describe the signal distortion effect of nonlinear distortion and IQ imbalance in the time-domain (TD) and frequency-domain (FD) signals. We compare the two DNN-based demodulators: 1) TD-DNN, which requires TD signals as the input data, and 2) Hybrid-DNN, which requires TD and FD signals with a conventional demodulator. The numerical results indicate that the proposed DNN-based demodulators improve the coded bit error rate (BER) performance and that the Hybrid-DNN demodulator enables more efficient learning and demodulation processing by taking advantage of the characteristics of each.

## Joint Training of Predistortion, Power Back-Off and Constellation for Satellite Power Amplifiers Using Neural Networks

- **Status**: ❌
- **Reason**: 위성 전력증폭기 전치왜곡+신경망+성상도 공동학습; LDPC ECC 기법 없음
- **ID**: ieee:11174412
- **Type**: conference
- **Published**: 2025
- **Authors**: D. Kopyto, M. Tietze, G. Bauch
- **PDF**: https://ieeexplore.ieee.org/document/11174412
- **Abstract**: The deployment of satellite mega constellations may enable global coverage, even for direct transmission from satellite to handheld device. Such transmissions come with increased demands in power efficiency. The traveling wave-tube amplifier (TWTA) in satellite payloads fundamentally limits the transmit power and causes distortions to the transmit signal when power efficient transmission close to amplifier saturation is desired. This work introduces a novel joint training paradigm of constellation, amplifier power back-off and data predistortion to maximize the throughput of single carrier transmission over transparent satellite links. The joint design is enabled by means of communication autoencoders, where transmitter and receiver components are adapted together to achieve the lowest bit error rate (BER). We show how constrained constellation optimization can improve performance on selected configurations from the broadcasting standard DVB-S2X. Results are presented in terms of coded BER and information rates.

## NOC4SC: A Novel Paradigm of Multi-User Semantic Communication Enabled by Non-Orthogonal Codewords

- **Status**: ❌
- **Reason**: 비직교 코드워드 멀티유저 시맨틱 통신(딥러닝) — LDPC ECC 기법 없음
- **ID**: ieee:11432478
- **Type**: conference
- **Published**: 2025
- **Authors**: Y. Wang, P. He, S. Ma +2
- **PDF**: https://ieeexplore.ieee.org/document/11432478
...
- **Status**: ❌
- **Reason**: 양자 LRC(quantum CSS) 이론·bound 논문 — 양자 전용 개념 의존, 고전 바이너리 LDPC 디코더/구성 이식 기법 없음
- **ID**: ieee:10852272
- **Type**: journal
- **Published**: 2025
- **Authors**: G. Luo, B. Chen, M. Frederic Ezerman +1
- **PDF**: https://ieeexplore.ieee.org/document/10852272
...
- **Status**: ❌
- **Reason**: 양자 CSS 코드 lift(스태빌라이저/CSS 구조 의존), 고전 바이너리 이식 아님 — 원칙 제외
- **ID**: ieee:10931129
- **Type**: journal
- **Published**: 2025
- **Authors**: V. Guemard
- **PDF**: https://ieeexplore.ieee.org/document/10931129
...
- **Status**: ❌
- **Reason**: 메모리 burst-error ECC HW(FUEC+신드롬 디코딩)로 LDPC가 아님; 떼어낼 LDPC 디코더·구성 기법 없음
- **ID**: ieee:11072165
- **Type**: journal
- **Published**: 2025
- **Authors**: H. Liu, L. Xiao, T. Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/11072165
- **Abstract**: This paper addresses the issue of double burst errors occurring in memories and presents the design of corresponding error correction codes (ECC). The proposed ECCs can correct up to two burst errors simultaneously, each up to 4-bit. The errors’ positions are randomly distributed across any bit within the codeword. The proposed coding scheme is designed with FUEC and syndrome-based decoding. Then the scheme is implemented in hardware with Verilog HDL, utilizing parallel decoding techniques to minimize the latency and parity bits’ number. Comparative evaluations on hardware overheads are conducted for ECCs with the correction capabilities of double burst errors. To minimize the hardware overhead associated with codes with high correction requirements, bit interleaving techniques are applied, further reducing codec area, power, and delay. The ECCs are proved to demonstrate excellent performance in correcting double burst errors, with optimized hardware efficiency.

## Correcting Burst Deletion/Insertion and Random Substitution Errors With Stacking Codes in Non-Binary Segmented Burst Deletion/Insertion Channels

- **Status**: ❌
- **Reason**: non-binary 버스트 삭제/삽입 정정 stacking RM/BCH/RS 코드; 비이진이며 LDPC 아님, 즉시 제외
- **ID**: ieee:11185178
- **Type**: journal
- **Published**: 2025
- **Authors**: C. Yi, Y. Li, X. Liu +3
- **PDF**: https://ieeexplore.ieee.org/document/11185178
- **Abstract**: In this paper, we propose stacking codes and decoding algorithms to correct burst deletion/insertion and random substitution errors in a non-binary segment- $L$  maxburst- $D$  deletion and maxburst- $S$  insertion (NB-SBDI( $L,D,S$ )) channel without knowing the codeword boundaries. Specifically, in the NB-SBDI( $L,D,S$ ) channel, at most a single non-binary burst (a block of consecutive bits/symbols) of deletions or insertions of length up to  $D$  or  $S$ , respectively, exists in a block of  $L$  consecutive non-binary symbols. The proposed stacking-codes are constructed by stacking multiple Reed-Muller(RM)/modified BCH/modified binary representation of Reed-Solomon (BRRS) codes, respectively, and no marker codes are involved. We show that, in the NB-SBDI( $L,D,S$ ) channel, the proposed approach can not only correct both burst deletions/insertions and random substitution errors, but also achieve error-free decoding for stacking-RM/modified stacking-BCH/modified stacking-BRRS codes for burst deletions/insertions as long as no substitution errors exist. Also, the modified stacking-BRRS code is more rate efficient than the existing Song code, the stacking-RM/modified stacking-BCH codes are more rate efficient than the Song code if  $\max (D,S)$  and code length are small.

## Learning Linear Block Codes With Gradient Quantization

- **Status**: ✅
- **Reason**: BP 디코더에 최적화된 선형 블록 부호 학습 + 이산 가중치 옵티마이저; 패리티검사행렬/BP 학습 기법은 NAND 바이너리 LDPC 코드설계에 이식 가능(E/C)
- **ID**: ieee:11184612
- **Type**: journal
- **Published**: 2025
- **Authors**: L. -A. Dufrène, Q. Lampin, G. Larue
- **PDF**: https://ieeexplore.ieee.org/document/11184612
...
- **Status**: ❌
- **Reason**: BATS(batched sparse) 네트워크코딩 erasure 부호 — 채널코딩 LDPC ECC 아님
- **ID**: ieee:10606541
- **Type**: journal
- **Published**: 2025
- **Authors**: J. Qing, X. Cai, Y. Fan +2
- **PDF**: https://ieeexplore.ieee.org/document/10606541
...
- **Status**: ❌
- **Reason**: barrier 채널 코딩(Hamming metric 기반 코드구성/디코더); LDPC 아님, NAND LDPC 이식성 없음
- **ID**: ieee:11176956
- **Type**: journal
- **Published**: 2025
- **Authors**: Y. Ben-Hur, Y. Cassuto
- **PDF**: https://ieeexplore.ieee.org/document/11176956
...
- **Status**: ❌
- **Reason**: 순열부호 소프트 디매핑/구면부호 — 표준 LDPC는 베이스라인일 뿐, 디매핑·성형 기법으로 NAND LDPC 디코더/구성에 이식할 신규 기여 없음
- **ID**: ieee:10892363
- **Type**: journal
- **Published**: 2025
- **Authors**: R. R. Borujeny, S. E. Rumsey, S. C. Draper +1
- **PDF**: https://ieeexplore.ieee.org/document/10892363
...
- **Status**: ❌
- **Reason**: 물리계층 비밀키 생성 + 폴라부호 기반 reconciliation. LDPC 아니고 보안 응용, 이식할 ECC 기법 없음
- **ID**: ieee:10970068
- **Type**: journal
- **Published**: 2025
- **Authors**: M. Zhang, Z. Zhuang, S. Kim
- **PDF**: https://ieeexplore.ieee.org/document/10970068
- **Abstract**: For efficient physical layer secret key generation (SKG), a key challenge is to increase the secret key rate while ensuring low inconsistency, low complexity, and low latency. This paper addresses this issue by proposing efficient amplitude and phase quantization (APQ) methods, integrated with a computationally efficient information reconciliation process. Specifically, systematic polar codes are utilized alongside a compact, universally applicable soft-bit extraction method. Furthermore, performance is optimized through the adaptive selection of quantization and information reconciliation parameters, fully leveraging the universal applicability of the proposed soft-bit estimation technique. Simulation results confirm that the proposed methods significantly reduce the initial key disagreement probability (KDP) while achieving substantial complexity reduction. In addition, the proposed methods achieve higher secret key rate with fewer parity bits.

## Generalized Quantum Data-Syndrome Codes and Belief Propagation Decoding for Phenomenological Noise

- **Status**: ❌
- **Reason**: 양자 스태빌라이저 data-syndrome 코드 BP 디코딩 — 스태빌라이저·quaternary 등 양자 전용 개념 의존, 예외 불해당
- **ID**: ieee:10841936
- **Type**: journal
- **Published**: 2025
- **Authors**: K. -Y. Kuo, C. -Y. Lai
- **PDF**: https://ieeexplore.ieee.org/document/10841936
...
- **Status**: ❌
- **Reason**: MISO 채널부호 결합 프리코딩; 채널코딩이 베이스라인일 뿐 이식할 LDPC 디코더·구성 기법 없음
- **ID**: ieee:11017435
- **Type**: journal
- **Published**: 2025
- **Authors**: L. V. Nguyen, J. Choi, B. Ottersten +1
- **PDF**: https://ieeexplore.ieee.org/document/11017435
...
- **Status**: ❌
- **Reason**: AES/Gold 확산수열 기반 위성 CDM 보안 — LDPC ECC와 무관, 떼어낼 디코더/코드설계 없음
- **ID**: ieee:10938677
- **Type**: journal
- **Published**: 2025
- **Authors**: R. Garello, M. Visintin, R. Schiavone +2
- **PDF**: https://ieeexplore.ieee.org/document/10938677
...
- **Status**: ❌
- **Reason**: 시맨틱 통신 reliability interface — JSCC 응용 특이적, 이식 가능한 LDPC ECC 기법 없음
- **ID**: ieee:10857459
- **Type**: journal
- **Published**: 2025
- **Authors**: T. -Y. Tung, H. Esfahanizadeh, J. Du +1
- **PDF**: https://ieeexplore.ieee.org/document/10857459
...
- **Status**: ✅
- **Reason**: ORBGRAND HW 구현(sLWO, LUT) 병렬 노이즈 시퀀스 생성 — 범용 선형블록코드 디코더 HW 기법, NAND LDPC 이식 검토 가치(D)
- **ID**: ieee:10718356
- **Type**: journal
- **Published**: 2025
- **Authors**: C. Ji, X. You, C. Zhang +1
- **PDF**: https://ieeexplore.ieee.org/document/10718356
...
- **Status**: ❌
- **Reason**: 시맨틱 통신·JSCC 프레임워크; 채널코딩 베이스라인, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:11096006
- **Type**: journal
- **Published**: 2025
- **Authors**: H. Gao, M. Sun, X. Xu +6
- **PDF**: https://ieeexplore.ieee.org/document/11096006
- **Abstract**: Compatibility between semantic communication and traditional mobile communication systems remains a significant challenge. Therefore, we propose a cross-layer encrypted semantic communication (CLESC) framework for panoramic video transmission, incorporating feature extraction, encoding, encryption, cyclic redundancy check (CRC), and retransmission processes to achieve compatibility between semantic communication and traditional communication systems. Additionally, we propose an adaptive cross-layer transmission mechanism that dynamically adjusts CRC, channel coding, and retransmission schemes based on the importance of semantic information. This mechanism ensures that important information is prioritized under poor transmission conditions. To verify the aforementioned framework, we design an end-to-end adaptive panoramic video semantic transmission (APVST) network that leverages a deep joint source-channel coding (JSCC) structure and attention mechanism, integrated with a latitude adaptive module that facilitates adaptive semantic feature extraction and variable-length encoding of panoramic videos. Simulation results demonstrate that the proposed CLESC framework effectively achieves compatibility and adaptability between semantic and traditional communication systems, significantly enhancing channel robustness. Compared to traditional and artificial intelligence (AI)-based video source coding transmission schemes, our proposed CLESC achieves superior transmission performance under low signal-to-noise ratio (SNR) conditions.

## Network Coding in BLE Networks

- **Status**: ❌
- **Reason**: BLE 네트워크 코딩 다이버시티 — 통신 응용 특이적, NAND LDPC로 이식할 부호·디코더 기법 없음
- **ID**: ieee:11289481
- **Type**: journal
- **Published**: 2025
- **Authors**: M. E. P. Monteiro, P. C. D. F. Guimarães, J. D. A. Farhat +2
- **PDF**: https://ieeexplore.ieee.org/document/11289481
- **Abstract**: This paper investigates the application of network coding-based diversity techniques in Bluetooth Low Energy (BLE) networks to enhance communication reliability. For the first time, multiple cooperation schemes, decode-and-forward (DAF), binary network coding (BNC), and dynamic network coding (DNC), are experimentally evaluated and compared against a no-cooperation (NoC) approach using real BLE hardware. The study assesses the impact of these schemes on the Packet Delivery Ratio (PDR) across various network layouts, demonstrating that network coding can significantly improve transmission robustness over traditional forwarding techniques. Notably, NC-based schemes achieved up to 8.6% and 22.9% improvements in PDR under comparable total transmit power conditions compared to DAF and NoC, respectively. Furthermore, NC-based schemes maintained high reliability while operating at transmit power levels up to 63 times lower than simpler cooperation methods. These findings underscore the potential of integrating network coding into BLE protocols to enhance both the reliability and energy efficiency of IoT communication systems.

## Polar-Coded Tensor-Based Unsourced Random Access With Soft Decoding

- **Status**: ❌
- **Reason**: Polar 부호 기반 비소스 랜덤액세스(텐서/베이지안 수신기) — LDPC 아니고 NAND 이식 기법 없음
- **ID**: ieee:10938717
- **Type**: journal
- **Published**: 2025
- **Authors**: J. Fang, Y. Liang, G. Sun +4
- **PDF**: https://ieeexplore.ieee.org/document/10938717
...
## Enhanced Digital Radio-Over-Fiber Transmission Using Unequal Bit Protection Based on Coding and Modulation

- **Status**: ❌
- **Reason**: D-RoF 불균등 비트보호 코딩+변조(GCS/BICM) — LDPC 특정 기법 아님, NAND 이식 가능 ECC 기법 없음
- **ID**: ieee:11050968
- **Type**: journal
- **Published**: 2025
- **Authors**: Y. Guo, H. Jiang, Y. Xu +4
- **PDF**: https://ieeexplore.ieee.org/document/11050968
- **Abstract**: In digital radio-over-fiber (D-RoF) transmission for mobile fronthaul (MFH), wireless waveforms are digitized into quantization bits, which vary in importance for signal recovery. More important bits (MIBs) require enhanced protection compared to less important bits (LIBs). This paper proposes an unequal-bit-protection-based coding and modulation (UBP-CM) scheme that integrates forward error correction (FEC) and modulation in a joint design. Geometric constellation shaping (GCS) is employed to further enhance the protection of MIBs. Theoretical analysis of the UBP-CM with GCS aligns well with simulation results under an additive white Gaussian noise (AWGN) channel. In the experiments, a signal-to-noise ratio (SNR) gain of 23.1 dB is achieved over conventional bit-interleaved coded modulation (BICM), enabling the D-RoF system to support 16384-QAM wireless signals. Additionally, the maximum allowed symbol rate increases from 38 Gbaud to 58 Gbaud for the 1024-QAM threshold, representing a 52.6% improvement in the maximum line rate for D-RoF transmission.

## SemAI: Semantic Artificial Intelligence-Enhanced DNA Storage for Internet of Things

- **Status**: ❌
- **Reason**: DNA 스토리지용 시맨틱 AI 인코딩/멀티리드 필터링 — LDPC ECC 아님, 떼어낼 디코더/코드설계 기법 없음
- **ID**: ieee:10738388
- **Type**: journal
- **Published**: 2025
- **Authors**: W. Wu, L. Xiang, Q. Liu +1
- **PDF**: https://ieeexplore.ieee.org/document/10738388
...
- **Status**: ❌
- **Reason**: FL gradient 근사 무선 전송, ECC 회피 전략 — 채널코딩 기법 없음, LDPC 무관
- **ID**: ieee:10738374
- **Type**: journal
- **Published**: 2025
- **Authors**: X. Ma, H. Sun, R. Q. Hu +1
- **PDF**: https://ieeexplore.ieee.org/document/10738374
...
- **Status**: ❌
- **Reason**: 변조무관 시맨틱 통신 uJSCC — 소스-채널 결합, 떼어낼 ECC 기법 없음
- **ID**: ieee:10960697
- **Type**: journal
- **Published**: 2025
- **Authors**: Y. Huh, H. Seo, W. Choi
- **PDF**: https://ieeexplore.ieee.org/document/10960697
...
- **Status**: ✅
- **Reason**: 터보 디코더지만 iteration-unrolled 파이프라인·iteration overlap 인터리버 등 반복디코더 HW 아키텍처가 LDPC HW에 이식 가능성 — Phase3 재검토
- **ID**: ieee:11087226
- **Type**: journal
- **Published**: 2025
- **Authors**: S. Weithoffer, C. A. Nour
- **PDF**: https://ieeexplore.ieee.org/document/11087226
...
## Enhancing Air-Water Optical Communication: Achieved 6.7 Photons/bit Through TCPA

- **Status**: ❌
- **Reason**: 수중 광통신 광자 누적(TCPA) + SCPPM 부호 비교 — LDPC 떼어낼 기법 없음, 응용 특이
- **ID**: ieee:10887247
- **Type**: journal
- **Published**: 2025
- **Authors**: J. Zhang, X. Han, W. Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/10887247
- **Abstract**: Underwater wireless optical communication (UWOC) faces substantial challenges in optical signal detection and processing, particularly when traversing the boundary between air and water. To address this issue, this study introduces and validates a method known as time-correlation photon accumulation (TCPA). In addition, the study also analyzed the relative performance of different error-correcting codes. An experimental system for 256-PPM photon-counting communication (PCC) has been developed, demonstrating that the system can achieve a communication sensitivity of 6.7 photons/bit with an accumulation number of 2 when utilizing SCPPM (5006, 5040) and TCPA technology.
...
- **Status**: ❌
- **Reason**: 태스크 지향 JSCC + 제어 공동설계, LDPC ECC 기법 없음
- **ID**: ieee:11016911
- **Type**: journal
- **Published**: 2025
- **Authors**: Y. Diao, Y. Zhang, D. D. Martini +2
- **PDF**: https://ieeexplore.ieee.org/document/11016911
...
- **Status**: ❌
- **Reason**: URA massive MIMO AMP 검출 — 무선 응용 특이적, LDPC 디코더 기법 없음
- **ID**: ieee:10684454
- **Type**: journal
- **Published**: 2025
- **Authors**: Y. Hu, M. Lou, D. Wang +6
- **PDF**: https://ieeexplore.ieee.org/document/10684454
- **Abstract**: In a massive machine-type communication (mMTC) scenario, there are large number of devices that may establish links to receivers, which causes a great burden to the system for signaling overhead, thereby reducing the communication efficiency. One potential approach involves refraining from assigning signaling overhead to users, with active users opportunistically transmitting data messages within time slots. The receiver only needs to recover these independent data messages without identifying the source of these messages, named unsourced random access (URA). In this paper, suitable URA schemes are proposed for cellular massive multiple-input multiple-output (MIMO) and cell-free massive MIMO systems. In the cellular scenario, the system completes the transmission and estimation of the number of active users and the corresponding channel large-scale fading coefficients (LSFCs) in stage one. Utilizing the channel information obtained in stage one, the receiver in stage two applies the sparse-correction-based bilinear generalized approximate message passing (SCB-BiG-AMP) algorithm proposed in this paper to restore the original data sequences sent by active users. In a cell-free scenario, active users won't transmit LSFC information similar to that in stage one of cellular scenario for the properties of massive distributed antennas. Instead, the central limit theorem (CLT) is used to estimate the average channel LSFC of all active users, which is substituted into the SCB-BiG-AMP algorithm as the equivalent channel variance. Then, the original data sequences sent by active users can be restored. According to the simulation results, the proposed URA communication scheme can achieve good bit error performance. Moreover, as a result of the small uplink user-AP distance, the system performance in the cell-free scenario is much better than that in the cellular scenario.

## O2SC: Realizing Channel-Adaptive Semantic Communication With One-Shot Online-Learning

- **Status**: ❌
- **Reason**: 시맨틱 통신 원샷 온라인 학습/채널추정 — ECC 기법 없음, LDPC 무관
- **ID**: ieee:10718362
- **Type**: journal
- **Published**: 2025
- **Authors**: G. Zhang, K. Kang, Y. Cai +3
- **PDF**: https://ieeexplore.ieee.org/document/10718362
- **Abstract**: Motivated by progress in data-driven supervised learning, semantic communication has witnessed remarkable advancements in improving the efficiency of data transmission under various channel conditions. These advancements typically require a substantial amount of training data for offline training, which is challenging in practical systems. Therefore, in this work, we propose O2SC, a one-shot online-learning framework for semantic communication to achieve adaptive transmission under different channel conditions. Since semantic communication relies on acquired channel state information (CSI), we jointly design the channel estimation and semantic communication processes. Specifically, we introduce a denoising module based on one-shot self-supervised learning, allowing semantic communication systems to adapt to new channel conditions without the need to collect extensive training data. The denoising module is utilized to eliminate noise in the received data samples, using only the data samples themselves. Following this, we further exploit meta-learning to allow the system to quickly adapt to diverse channel conditions, by finding an appropriate initialization for each data sample in a timely way. Simulation results demonstrate that the proposed method achieves performance close to that of supervised learning-based approaches while also providing improved generalizability across different channel conditions.

## Fast Max-Log-MAP Detection of Irregular APSK Signals by Traversal Over Rings of Ordered PSK Constellation Points

- **Status**: ❌
- **Reason**: APSK 신호의 max-log-MAP 검출 복잡도 저감 - 변조 검출 기법이며 LDPC 디코더와 무관
- **ID**: ieee:11145102
- **Type**: journal
- **Published**: 2025
- **Authors**: T. -H. Liu, D. -L. Yang, J. -H. Huang +1
- **PDF**: https://ieeexplore.ieee.org/document/11145102
- **Abstract**: Amplitude phase shift keying (APSK) modulation signals are of low peak average power ratio and are generated to fight against the potentially non-linear high power amplifier in satellite communication. The benchmark maximum log-likelihood maximum a posteriori probability (max-log-MAP) detector requires to compute the distance squared between the received signal and each APSK constellation point for the extrinsic bit log-likelihood ratio (LLR) information. To overcome this major challenge of high detection complexity, we propose in this paper to partition and order all the APSK constellation points into rings of ordered phase shift keying (PSK) constellation points. We also propose to apply and tailor the iterative search strategies, originally used to detect multiple input multiple output (MIMO) quadrature amplitude modulation (QAM) signals, to search over the ordered irregular PSK constellation points. Compared with previously reported APSK detectors, our proposed detector achieves exactly the max-log-MAP detection, requires very low computational complexity, and is able to detect APSK signals modulated from the APSK constellation with arbitrary number of constellation points, arbitrary phase offsets, and arbitrary ring radii.

## Semantic-Oriented Modulation for Wireless Communication

- **Status**: ❌
- **Reason**: Semantic-oriented modulation over JSCC; modulation mapping, no LDPC ECC technique
- **ID**: ieee:10979950
- **Type**: journal
- **Published**: 2025
- **Authors**: Y. Wang, X. Zhang, Y. Sun +2
- **PDF**: https://ieeexplore.ieee.org/document/10979950
- **Abstract**: In semantic communication (SemCom), the gain of deep learning (DL)-based joint source and channel coding (JSCC) has been proved to partly come from the analog transmission of semantic features extracted directly from the source signal. While the current mainstream digital communication system design results in the gains almost vanishing when bit-oriented modulation (e.g., QPSK) is employed. To tackle this problem, we propose a semantic-oriented modulation (SOM) method that enables direct mapping from an analog value of a semantic feature to a sequence of discrete values without bit conversion. SOM employs a hierarchical design to mitigate discretization loss and optimizes resource allocation by exploiting the varying significance of semantic features, reducing the data volume by 29.17%. We provide an analysis that reveals the impact of modulation orders and hierarchical layers, guiding the SOM’s design. Simulations in four tasks show that SOM outperforms JSCC with bit-oriented modulation, and the implementation of the software-defined radio (SDR) platform confirms its compatibility with existing systems and its potential for latency reduction.

## Enhancing the EMI-Resilience of Communication Networks Through Warning Propagation: A Multilayer Approach

- **Status**: ❌
- **Reason**: EMI 내성 다계층 경고전파 프레임워크 — LDPC 디코더/코드설계/HW 기여 없음, 떼어낼 ECC 기법 없음
- **ID**: ieee:11197137
- **Type**: journal
- **Published**: 2025
- **Authors**: M. Kameli, D. Pissoort, T. Claeys
- **PDF**: https://ieeexplore.ieee.org/document/11197137
- **Abstract**: This article presents a multilayer warning propagation framework to enhance electromagnetic interference resilience. This approach comprises multiple distinct error detection and correction techniques, each operating independently yet collaboratively. Unlike traditional concatenated coding approaches, the multilayer method is designed to integrate warnings generated by layers that address errors at different levels. A case study is conducted using simulations over a frequency range (0.1GHz–1 GHz) and varying signal-to-interference ratios. It is shown that while individual layers are found to exhibit vulnerabilities under specific electromagnetic interference conditions, the combination of these layers is observed to achieve near-zero undetected error rates, thereby enhancing system safety. In addition, the combination of layers is used to allow system designers to optimize falsely reported error rates, balancing safety and availability.

## Multimodal-Oriented Interactive Joint Source-Channel Coding for Lightweight Semantic Communication

- **Status**: ❌
- **Reason**: Multimodal JSCC lightweight semantic communication; no LDPC ECC technique to extract
- **ID**: ieee:10995230
- **Type**: journal
- **Published**: 2025
- **Authors**: X. Niu, L. Tan, J. Wu +2
- **PDF**: https://ieeexplore.ieee.org/document/10995230
- **Abstract**: As a pivotal technology for sixth-generation (6G) mobile networks, semantic communication (SC) aims to enable low-energy, high-efficiency intelligent communication through joint source-channel coding (JSCC). However, current multimodal SC systems experience semantic divergence and conflicts due to imbalances in the representation capacity of individual encoders. Furthermore, high computational demands significantly elevate the deployment and operational costs of SC. In this letter, we propose a multimodal-oriented lightweight SC system based on an interactive JSCC scheme, promoting the evolution of 6G towards a multi-source collaboration paradigm. Additionally, a dynamic resource allocation method is introduced, which hierarchically adjusts computational costs to improve efficiency. Simulation results demonstrate that the proposed system reduces computational overhead by 60$\%$ compared to six benchmarks while maintaining high performance and robustness in multiple tasks.

## Reinforcement Learning-Based Underwater Video Transmission Against Jamming

- **Status**: ❌
- **Reason**: 수중 음향 비디오 전송 강화학습 적응변조코딩; 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:11181088
- **Type**: journal
- **Published**: 2025
- **Authors**: S. Li, T. Li, W. Su +3
- **PDF**: https://ieeexplore.ieee.org/document/11181088
- **Abstract**: Existing adaptive modulation and coding schemes suffer from performance degradation under time-varying underwater acoustic (UWA) channels and jamming attacks, resulting in increased video jitter and energy consumption, as well as reduced peak signal-to-noise ratio (PSNR). In this article, we first propose a reinforcement learning (RL)-based underwater video transmission scheme, which jointly optimizes the channel coding methods, subcarrier modulation order, quantization parameter, and transmit power against jamming. The direct sequence spread spectrum (DSSS) mechanism is used to reduce the jamming power in each subcarrier frequency band, which ensures that the transmitter obtains a reliable feedback message. In addition, a multi-frame statistics scheme is designed to support transmission policy selection, which mitigates the impact of channel instability by averaging the observed transmission performance and channel gain. To further enhance communication performance and robustness under large state–action spaces and dynamic channel conditions, we propose a deep RL (DRL)-based anti-jamming video transmission scheme to compress the excessive state–action space, mitigate quantization errors, and improve transmission stability. Two target networks are employed in DRL to ensure learning stability by mitigating fluctuations in  $Q$ -value and  $R$ -value updates caused by the time-varying channel. In addition, the performance bounds of transmission delay and energy consumption related to modulation order and channel coding rate are derived. Simulation and experimental results demonstrate that our schemes improve the video transmission performance by reducing transmission delay, energy consumption, and video jitter while increasing the PSNR and video quality compared with the benchmarks.

## Construction of Quantum Anamorphic Evolving Dynamic-Threshold Secret-Sharing Schemes

- **Status**: ❌
- **Reason**: 양자 비밀분산·암호 스킴, LDPC ECC 무관
- **ID**: ieee:11072822
- **Type**: journal
- **Published**: 2025
- **Authors**: S. S. Chaudhury, S. Ganguly
- **PDF**: https://ieeexplore.ieee.org/document/11072822
- **Abstract**: We propose the concept of Quantum Anamorphic Evolving Secret-Sharing(QAESS), combining two different cryptographic primitives in this paper. In QAESS, we have the anamorphic property, allowing alternate secrets to be embedded within the primary secret-sharing framework, accessible only under specific constraints, and the evolving property of secret-sharing (ESS) where the scheme can dynamically adapt by accommodating potentially an infinite number of new parties without reinitialization. To achieve this, the major hurdles we encounter are 1) the large dimensions of shares and the requirement of huge quantum memory, and 2) the system breakdown by inserting a spy. In our first construction, we present a QAESS scheme, and in the second construction, we use secret redistribution to mitigate the above challenges. Our constructions extensively use quantum trap codes, random permutations, and data structure techniques. We analyze the schemes’ efficiency, scalability, and robustness through theoretical proofs and complexity estimates. This integration of quantum anamorphism and evolving properties finds potential application in several Internet of Things (IoT) and other practical scenarios. We close the paper by discussing several advantages of our constructions and some interesting problems for further study.

## Adaptive FTN Signaling Over Rapidly-Fading Channels

- **Status**: ❌
- **Reason**: FTN signaling/precoding 무선 응용 특이적, LDPC ECC로 떼어낼 기법 없음
- **ID**: ieee:10902515
- **Type**: journal
- **Published**: 2025
- **Authors**: M. Tong, X. Huang, J. Andrew Zhang +1
- **PDF**: https://ieeexplore.ieee.org/document/10902515
...
- **Status**: ❌
- **Reason**: 광액세스망 FEC 소프트웨어화(10G-EPON PCS) — FEC 부수 언급, 새 LDPC 디코더/코드설계 없음
- **ID**: ieee:10955361
- **Type**: journal
- **Published**: 2025
- **Authors**: T. Suzuki, S. -Y. Kim, J. -i. Kani +1
- **PDF**: https://ieeexplore.ieee.org/document/10955361
...
- **Status**: ❌
- **Reason**: 해저 광케이블 중계기 공간분할 — 물리계층/광전송, LDPC ECC 무관
- **ID**: ieee:10869835
- **Type**: journal
- **Published**: 2025
- **Authors**: S. Swain, C. K. Schou, M. P. Yankov +2
- **PDF**: https://ieeexplore.ieee.org/document/10869835
...
- **Status**: ❌
- **Reason**: RVQGAN 기반 디지털 시맨틱 통신(음성) — 채널코딩 ECC 아님, 떼어낼 LDPC 기법 없음
- **ID**: ieee:10886956
- **Type**: journal
- **Published**: 2025
- **Authors**: X. Chen, J. Wang, J. Huang +3
- **PDF**: https://ieeexplore.ieee.org/document/10886956
...
## Investigation on Radiation Effects of White Neutron Source on COTS Solid-State Drives

- **Status**: ❌
- **Reason**: SSD 중성자 방사선 효과 측정 연구 — NAND 오류 현상 분석일 뿐 LDPC ECC 기법 없음
- **ID**: ieee:10855552
- **Type**: journal
- **Published**: 2025
- **Authors**: T. Yu, Y. Ma, X. Xu +4
- **PDF**: https://ieeexplore.ieee.org/document/10855552
...
- **Status**: ✅
- **Reason**: 3D NAND(FG vs CT) 방사선 내성/retention 비교 — A. NAND 직접(retention 특성)
- **ID**: ieee:10841906
- **Type**: journal
- **Published**: 2025
- **Authors**: M. A. Kumar, M. Buddhanoy, B. Ray
- **PDF**: https://ieeexplore.ieee.org/document/10841906
- **Abstract**: In this article, we present a comparative investigation of total-ionizing-dose (TID) effects on 3-D floating-gate (FG) and charge-trap (CT) memory technologies. FG 64-layer 3-D nand technology is found to be more sensitive to TID effects than CT 176-layer and 128-layer 3-D nand chips under identical irradiation conditions. However, irradiated CT memory loses information substantially faster than FG counterparts during room-temperature retention. We explain the observed characteristics based on differences in fundamental cell geometry, discrete charge storage mechanism, and charge diffusion in trap-rich and continuous charge storage layers.

## Toward Wi-Fi 8 Standard: A Survey of State-of-the-Art Technologies

- **Status**: ❌
- **Reason**: Wi-Fi 8 기술 서베이, LDPC 코드워드 길이는 부수 언급 — 떼어낼 새 기법 없음
- **ID**: ieee:11269347
- **Type**: journal
- **Published**: 2025
- **Authors**: S. He, C. Peng, W. Huang +3
- **PDF**: https://ieeexplore.ieee.org/document/11269347
- **Abstract**: With the emergence of new applications such as collaborative mobile robots and immersive communications, the stringent requirements on the reliability and latency are far beyond the capabilities of existing wireless local area networks (WLANs) standards. To meet these demands, IEEE 802.11 standard organization has established a working group to revise the existing WLAN standard with a aim to achieve ultra-high reliability (UHR) and ultra-low latency. This paper provides a comprehensive survey of key technologies on physical layer and medium access control layer discussed in the UHR working group. Specifically, it focuses primarily on the related progress of the technologies, such as double low-density parity-check codeword lengths, a new modulation and coding scheme as well as unequal modulation techniques, distributed resource units, multi-access point coordination techniques, non-primary channel access, and seamless roaming, etc. Meanwhile, this paper further reviews the progress related to the low-high frequency common baseband technologies. Finally, a few potential research directions beyond the state-of-the-art technologies discussed in the working group are discussed for the development of WLAN technologies.

## PBiGAMP-Based Joint Channel Estimation and Data Detection Under Nonuniform Doppler Shifts

- **Status**: ❌
- **Reason**: 수중음향 PBiGAMP 채널추정·검출, LDPC 디코더 기법 없음
- **ID**: ieee:11077606
- **Type**: journal
- **Published**: 2025
- **Authors**: Y. Wang, J. Zhu, M. Zhang +4
- **PDF**: https://ieeexplore.ieee.org/document/11077606
- **Abstract**: Achieving reliable underwater acoustic communication in time-varying channels characterized by nonuniform Doppler shifts across different channel paths due to variations in arrival and departure angles is a challenging task. In such a scenario, a short package is preferred as the channel parameters, e.g., amplitudes, delays and Doppler shifts can be assumed quasi-static within its transmission duration. By modeling the residual Doppler frequency of each channel tap as a continuous parameter, an input-output relationship for the resampled received signal is formulated. Building on the parametric bilinear generalized approximate message passing (PBiGAMP) framework, we develop an iterative receiver that employs Newton's method for gridless Doppler frequency estimation, thereby enabling joint estimation of channel amplitudes, Doppler frequencies, and data symbol decoding. We refer to this approach as PBiGAMP for nonuniform Doppler shifts (PBiGAMP-NDS). The performance of PBiGAMP-NDS is validated via numerical simulations and sea trials. Notably, for simulation channels with nonuniform Doppler shifts—where the standard deviation of relative moving speed related to channel path $\sigma _{v}$ is 0.05 m/s and the minimum time delay between paths with significant Doppler differences normalized by the symbol duration $N_{\tau }$ is 2, when coded bit error rate (BER) is $10^{-3}$, PBiGAMP-NDS provides a 2.5 dB signal-to-noise ratio (SNR) gain over the original PBiGAMP. In sea trials, its coded BER is found to be an order of magnitude lower than that of the original PBiGAMP.

## Post-Deployment Fine-Tunable Semantic Communication

- **Status**: ❌
- **Reason**: 시맨틱 통신/JSCC VQ-VAE 이미지 전송 — 채널코딩 ECC 아님, LDPC 무관
- **ID**: ieee:10636042
- **Type**: journal
- **Published**: 2025
- **Authors**: P. Si, R. Liu, L. Qian +2
- **PDF**: https://ieeexplore.ieee.org/document/10636042
...
- **Status**: ❌
- **Reason**: 위성 NTN의 HARQ/RLC ARQ 재전송 성능 분석. LDPC 디코더/구성 기여 없는 시스템 분석
- **ID**: ieee:10975810
- **Type**: journal
- **Published**: 2025
- **Authors**: R. Tuninato, G. Maiolini Capez, N. Mazzali +1
- **PDF**: https://ieeexplore.ieee.org/document/10975810
...
- **Status**: ❌
- **Reason**: O-RAN 자원할당 온라인 학습(Thompson Sampling) — ECC/LDPC 무관, 네트워크 스케줄링
- **ID**: ieee:11059884
- **Type**: journal
- **Published**: 2025
- **Authors**: A. Tuerxun, A. Nakao
- **PDF**: https://ieeexplore.ieee.org/document/11059884
- **Abstract**: The Open Radio Access Network (O-RAN) architecture, which leverages virtualized base stations deployable on diverse commodity hardware, is poised to enhance the flexibility and cost-effectiveness of next-generation cellular networks. However, its widespread adoption faces challenges due to the complexity of configuration choices, which can significantly affect both network performance and energy efficiency. Achieving the right balance requires intelligent resource allocation—optimizing Modulation and Coding Scheme (MCS) selection and Physical Resource Block (PRB) assignment to maximize spectrum and processing efficiency. In this work, we propose a Thompson Sampling-based online learning framework for energy-efficient resource allocation in virtualized base stations. Our approach is designed to operate with minimal assumptions about the network environment, making it highly adaptable to both stationary and dynamic conditions. By integrating variational inference with Thompson Sampling, the framework efficiently balances exploration and exploitation, allowing dynamic adjustment of MCS and PRB allocations in response to changing network states. The proposed algorithm achieves sub-linear regret, ensuring convergence toward an optimal policy over time while maintaining robust adaptability. We validate our method using open-source platforms—OpenAirInterface and FlexRIC—demonstrating its practical effectiveness. Our results show that the proposed approach achieves energy savings of up to 15 percent and improves resource block utilization efficiency by up to 31 percent compared to the default scheduling policy. These findings underscore the potential of our method to significantly enhance the sustainability and efficiency of O-RAN deployments, paving the way for smarter, more adaptive next-generation cellular networks.

## Iterative Interference Cancellation for Clustered Cell-Free Massive MIMO Networks

- **Status**: ❌
- **Reason**: Cell-free MIMO 간섭제거에서 LDPC는 부수적 베이스라인 — 떼어낼 ECC 기법 없음
- **ID**: ieee:10778257
- **Type**: journal
- **Published**: 2025
- **Authors**: T. Ssettumba, S. Mashdour, L. T. N. Landau +2
- **PDF**: https://ieeexplore.ieee.org/document/10778257
...
## BER Comparison Between Time-Domain and Frequency-Domain Self-Interference Canceller in 5G-Based Full-Duplex Mobile Communications

- **Status**: ❌
- **Reason**: 5G 풀듀플렉스 자기간섭 제거 BER 비교 — LDPC 부수, 떼어낼 ECC 기법 없음
- **ID**: ieee:10992724
- **Type**: conference
- **Published**: 15-17 Jan.
- **Authors**: Takumi Yasaka, Kazuma Matsushima, Satoshi Suyama +1
- **PDF**: https://ieeexplore.ieee.org/document/10992724
- **Abstract**: Full-duplex mobile communications are gaining attention as an access method between base station (BS) and user equipment (UE) that can improve frequency utilization efficiency. The important technology is to cancel or eliminate self-interference that occurs between the transmitter (TX) and its own receiver (RX) at both BS and UE. This paper presents a BER comparison between time-domain and frequency-domain self-interference canceller (SIC) operated at baseband. Specifically, we show the BER performance of OFDM-based QPSK and 16/64/256/1024-QAM signals as parameters of the coding rate when time-domain or frequency-domain SIC is applied. The results indicate that both SIC can drastically improve the BER for QPSK and QAM signals compared without SIC, and the frequency-domain SIC is more effective as the modulation order of QAM increases.

## Bidirectional 100G/150G Amplified Transmission With a QD-SOA for Future Passive Optical Networks

- **Status**: ❌
- **Reason**: PON 광전송 실험, LDPC는 BER 임계 기준으로만 부수 언급 — 떼어낼 디코더/HW/코드설계 기여 없음
- **ID**: ieee:11037425
- **Type**: journal
- **Published**: 15 Sept.15
- **Authors**: Ahmed Galib Reza, Lakshmi Narayanan Venkatasubramani, Vladimir S. Mikhrin +2
- **PDF**: https://ieeexplore.ieee.org/document/11037425
- **Abstract**: This work investigates optically amplified bidirectional transmission with a quantum-dot semiconductor optical amplifier for next-generation 100G passive optical networks. We experimentally demonstrate 100/150 Gbit/s uplink/downlink bidirectional PAM-4 transmissions employing a quantum-dot semiconductor optical amplifier in the remote node of an optical access network. After 20 km optically amplified transmission, we attain the uplink/downlink power budgets of 32.3 dB/29 dB at the HD-LDPC bit error ratio decision threshold of  $10^{\mathrm {-2}}$  with an overhead of 15.5%, satisfying the power budget requirements of a legacy passive optical network with net (gross) achievable uplink/downlink data rates of 84.4/126.7 (100/150) Gbit/s, respectively.

## Terrain-Aware Image Transmission System for Lunar IoT Networks: A Multipriority Robust RaptorQ Coding Approach

- **Status**: ❌
- **Reason**: 달 IoT 이미지 전송, RaptorQ fountain/erasure 코딩 — 채널 ECC LDPC 기법 아님
- **ID**: ieee:11115102
- **Type**: journal
- **Published**: 15 Oct.15,
- **Authors**: Yaonan Wu, Shushi Gu, Yuanjian Lin +2
- **PDF**: https://ieeexplore.ieee.org/document/11115102
- **Abstract**: Reliable image transmission is pivotal for lunar Internet of Things (IoT) networks, providing visual information for scientific exploration and real-time navigation. However, the moon’s harsh environment, i.e., lack of atmosphere, low surface conductivity, and rugged terrain, induces abnormal signal attenuation and packet losses, significantly degrading image transmission quality. This article presents the lunar adaptive image transmission system (LAITS), which integrates the terrain aware field strength prediction (TAFSP) framework with the hierarchical raptorQ redundancy optimization (HRRO) coding algorithm. The TAFSP framework provides field strength predictions for channel packet loss rate estimation, by leveraging high-resolution lunar elevation data to formulate a radio propagation loss model. The HRRO algorithm optimizes coding efficiency and enables low-overhead transmission, by dynamically adjusting RaptorQ’s data segmentation based on the predictions of channel packet loss rate and priorities of image data. Simulations demonstrate that while maintaining image transmission quality above the 25 dB peak signal-to-noise ratio (PSNR) threshold, LAITS achieves a coverage rate of 85% in flat terrain with a 4 km radius at 440, 915, and 2400 MHz, and achieves coverage rates of 85% at 440 MHz, 70% at 915 MHz, and 56% at 2400 MHz in rugged terrain with the same radius.

## Joint Information Reconciliation-Privacy Amplification Scheme for CV-QKD

- **Status**: ❌
- **Reason**: CV-QKD 정보조정·프라이버시 증폭, spinal codes 사용 — 양자 QKD 보안 도메인, LDPC 기법 없음
- **ID**: ieee:11142740
- **Type**: journal
- **Published**: 15 Oct.15,
- **Authors**: Kun Zhang, Jia Hou, Yan Feng +4
- **PDF**: https://ieeexplore.ieee.org/document/11142740
- **Abstract**: In the conventional post-processing phase of Gaussian-modulated coherent state (GMCS) quantum key distribution (QKD) systems, the processes of information reconciliation (IR) and privacy amplification (PA) are typically carried out sequentially and separately. This approach incurs substantial computational complexity and may introduce potential security risks, such as key storage risks. In this paper, we propose a more efficient and secure post-processing scheme that integrates IR and PA into a single process by utilizing well-designed spinal codes. The proposed scheme significantly reduces computational complexity by employing the linear-complexity hash function instead of the superlinear complexity Toeplitz matrices used in conventional PA schemes, and effectively mitigates potential security risks associated with conducting IR and PA as separate processes. Experimental results show that the final secret key throughput of the proposed scheme is at least 250 times higher than that of the conventional PA scheme, with the improvement in throughput becoming even greater as the block lengths increase. More importantly, owing to the rateless property and the capacity-approaching performance of spinal codes, the GMCS QKD systems can achieve reconciliation efficiencies of higher than 97% across a broad range of signal-to-noise ratios from −22.5641 to 0.122 dB.

## Channel-Polarized Multilevel Coding for Low-Complexity Forward Error Correction

- **Status**: ✅
- **Reason**: 채널분극 다단계 코딩(CP-MLC)용 새 바이너리 코드 설계 — SD-FEC 적용 비트채널 분리, 이식 가능 코드설계 가능성으로 살림(Phase3 재검토)
- **ID**: ieee:10878470
- **Type**: journal
- **Published**: 15 May15, 
- **Authors**: Takeshi Kakizaki, Masanori Nakamura, Fukutaro Hamaoka +1
- **PDF**: https://ieeexplore.ieee.org/document/10878470
- **Abstract**: Digital coherent optical fiber communication systems adopt forward error correction (FEC) and multilevel modulation in accordance with transmission distance, data rate, and power consumption requirements. Bit-interleaved coded modulation (BICM) is practical coded modulation because of the simplicity of applying a binary code to converted binary-input memoryless channels (B-MCs) under a random bit-interleaver. The power consumption of soft-decision (SD) FEC has recently become a challenge due to transceiver power constraints. The multilevel coding (MLC) scheme efficiently reduces the decoding complexity, while the code design and complexity reduction depend on the modulation order. In this paper, we propose new binary codes for channel-polarized multilevel coding (CP-MLC) that convert multiple B-MCs to unreliable and reliable bit-channels and apply only SD-FEC to unreliable bit-channel to reduce the decoding complexity without depending on the modulation order. Systematic CP-MLC can also be used in probabilistically-shaped signals by using it in the component code of a probabilistic amplitude shaping scheme.

## Joint Optimization of Digital Fronthaul Based on Delta-Sigma Modulation and Equal Length Level Conversion

- **Status**: ❌
- **Reason**: 광 프론트홀 델타시그마 변조·엔트로피 코딩, FEC는 부수 언급 — 떼어낼 LDPC 기법 없음
- **ID**: ieee:10878115
- **Type**: journal
- **Published**: 15 May15, 
- **Authors**: Zijun Yan, Yixiao Zhu, Gengming Lin +4
- **PDF**: https://ieeexplore.ieee.org/document/10878115
- **Abstract**: In conventional mobile fronthaul (MFH) links, the radio-over-fiber (RoF) interface and optical transmission are separately optimized. In this work, we propose an equal-length level conversion (ELLC) scheme to jointly optimize the delta-sigma modulation (DSM) quantization noise and optical transmission performance. The ELLC scheme converts the high-level quantizer output of the DSM into a low-level signal with equivalent entropy using entropy coding. Forward error correction (FEC) is incorporated to guarantee successful decoding without reducing the data rate. Under the peak-power constraint, both the signal-to-noise ratio (SNR) of the recovered wireless signal and the received optical power (ROP) sensitivity of the optical fronthaul transmission are improved with the proposed ELLC scheme. We experimentally demonstrate the conversion of a 6-level quantized DSM waveform into a 4-level signal (6-to-4 scheme), and the conversion of an 8-level quantized DSM signal into a 6-level signal (8-to-6 scheme) at an over-sampling rate (OSR) of 8 in an optical intensity modulation-direct detection (IM-DD) link. Compared to the 4-level quantized DSM, the 6-to-4 scheme provides an 11-dB SNR improvement for wireless signals and a 3-dB enhancement in ROP sensitivity after 10-km standard single-mode fiber (SSMF) transmission in the O-band. Similarly, the 8-to-6 scheme achieves a 4-dB SNR improvement and a 2.5-dB enhancement in ROP sensitivity compared to the 6-level quantized DSM. Moreover, we demonstrate high-pass (HP) DSM based on the proposed ELLC scheme, revealing its advantage with flexible passband selection. By converting higher-order PAM to lower-order PAM, the ELLC scheme achieves both the high recovered wireless signal SNR associated with high quantization levels and the enhanced noise resilience of lower modulation formats in optical channels. The proposed ELLC approach is anticipated to be a promising candidate for digital MFH in the 5G-Advanced era, especially for cost-sensitive and high-fidelity applications.

## Hardware Sharing Design Method of Rate Matching and Interleaving for Wireless Terminal in Industrial Internet of Things

- **Status**: ✅
- **Reason**: turbo/conv/polar/LDPC 인터리빙·rate matching HW 공유 아키텍처 — LDPC 인터리버 HW 재사용 설계, 이식 가능 HW(D) 가능성
- **ID**: ieee:10742614
- **Type**: journal
- **Published**: 15 March15
- **Authors**: Wei Chen, Kejia Huo, Dake Liu
- **PDF**: https://ieeexplore.ieee.org/document/10742614
...
- **Status**: ❌
- **Reason**: 시맨틱 통신용 디지털 변조 성상 매핑 — ECC LDPC 기법 없음, 시맨틱 통신 제외
- **ID**: ieee:10902381
- **Type**: journal
- **Published**: 15 June15,
- **Authors**: Lei Teng, Wannian An, Chen Dong +1
- **PDF**: https://ieeexplore.ieee.org/document/10902381
- **Abstract**: The current state of semantic communication research is primarily based on analog modulation, whereas digital communication is more prevalent in practical applications. However, traditional digital modulation constellation mapping designs are not suitable for semantic communication, as they are primarily focused on minimizing the bit error rate of the transmitted data rather than the change in the numerical value of the semantic information. To address this issue, a semantic digital modulation constellation mapping (sDMCM) scheme based on pulse amplitude modulation (PAM)/quadrature amplitude modulation (QAM) is proposed, that considers the internal correlation of the semantic information. In addition, this article proposes using the mean-squared error (MSE) of the semantic information between the transmitter and receiver as a performance metric for semantic communication. This article also provides the theoretical MSE performance of the proposed sDMCM through formula derivation. Finally, the simulation results match the theoretical results, demonstrating the rationality of the theoretical derivation. Comparing the proposed sDMCM scheme with traditional mapping schemes, such as Gray, Pseudo-Gray (Pe-Gray), and structural quadrant (SQ) constellations in an image semantic communication system under the additive white Gaussian noise (AWGN) channel, the restored image can tolerate an SNR drop of about 3 dB while maintaining the same multiscale structure similarity (MS-SSIM) performance. In addition, sDMCM is applied in an industrial Internet of Things semantic communication system to validate its role in IoT applications.

## Utilizing State Probabilities to Curb Consecutive Errors in Photonic THz Communications

- **Status**: ✅
- **Reason**: 등화기-디코더 상호작용 활용 state error decoding(SED) 디코딩 알고리즘 제안 — LDPC 디코더 개선 기법(C) 이식 가능성, 애매하여 살림
- **ID**: ieee:10973069
- **Type**: journal
- **Published**: 15 July15,
- **Authors**: Liga Bai, Lu Zhang, Zhidong Lyu +4
- **PDF**: https://ieeexplore.ieee.org/document/10973069
- **Abstract**: The rapid evolution of high-speed communication technologies has brought serious inter-symbol interference (ISI). To cope with this issue, channel equalization techniques, such as feedforward equalization (FFE) and decision feedback equalization (DFE), are typically used to compensate for channel response to facilitate signal recovery, and forward error correction (FEC) code, such as low-density parity check (LDPC) codes, is widely deployed to improve link budget margin. However, the mutual influence between the equalizer and the decoder has yet to be thoroughly explored. In this paper, the state error decoding (SED) algorithm is proposed to enhance the decoding performance by effectively reducing the error probabilities and surpassing the limitations of traditional signal recovery methods. Experimental results in a photonic terahertz wireless communication system achieve error propagation mitigation and additional 0.2 dB link budget improvement by utilizing the proposed SED method, which confirms the effectiveness of the algorithm in reducing error propagation and improving system performance, paving the way for the development of broadband communications.

## Pre-Emphasis Assisted Mixed Modulation PD-NOMA-OFDM System for UOWC

- **Status**: ❌
- **Reason**: 수중 광무선 PD-NOMA-OFDM 전송, FEC는 임계 기준만 언급 — 떼어낼 LDPC 기법 없음
- **ID**: ieee:10980148
- **Type**: journal
- **Published**: 15 July15,
- **Authors**: Gopal Krishna, Sumanta Gupta
- **PDF**: https://ieeexplore.ieee.org/document/10980148
- **Abstract**: This article reports the transmission of mixed modulation formats assisted signals, which use orthogonal frequency division multiplexing (OFDM) combined with power domain nonorthogonal multiple access (PD-NOMA) in a multi-user underwater optical wireless communication (UOWC) system. Experimental investigation of two and three-user PD-NOMA-OFDM-based signal transmission in UOWC systems is carried out using a blue light emitting diode (LED) as the transmitter. To overcome the modulation bandwidth limitation of LED, a technique called differential pre-emphasis (DPE) is introduced that optimally minimizes the rise and fall times of the optical OFDM-NOMA signal. Simulation and experimental results show that the bit error rate (BER) of each user is below the FEC threshold of 10−3 at the optimum DPE factor for both mixed-modulation and identical modulation formats in two- and three-user PD-NOMA schemes. For the two-user scenario with the same modulation (QPSK-QPSK) formats, the maximum per-user data rate achieved is 24.1 Mbps, while with mixed modulation (QPSK-16-QAM), the transmission rate is 24.1 Mbps for the far user (FU) and 48.2 Mbps for the near user (NU). For the three-user PD-NOMA scheme, the maximum per-user data rate is 24.1 Mbps with identical (QPSK) modulation format. With mixed modulation formats in three-user NOMA, the maximum achieved per-user data rates are 12.04 Mbps, 24.1 Mbps, and 48.2 Mbps with BPSK, QPSK, and 16-QAM modulation, respectively. Experimental studies in the turbulent water channel also establish the efficacy of the DPE-enabled mixed-modulation PD-NOMA-OFDM signal transmission in achieving BER below 10−3 in both two-user and three-user schemes.

## MDVSC—Efficient Wireless Model Division Video Semantic Communication

- **Status**: ❌
- **Reason**: 비디오 시맨틱 통신 JSCC 기반 — 소스-채널 결합, 떼어낼 ECC LDPC 기법 없음
- **ID**: ieee:10685066
- **Type**: journal
- **Published**: 15 Jan.15,
- **Authors**: Zhicheng Bao, Haotai Liang, Chen Dong +3
- **PDF**: https://ieeexplore.ieee.org/document/10685066
...
- **Status**: ✅
- **Reason**: DL 기반 Normalized Offset Min-Sum(DL-NOMS) LDPC 디코더 제안 — 신경망/민섬 변형 디코더(C) 이식 가능
- **ID**: ieee:10766433
- **Type**: journal
- **Published**: 15 Feb.15,
- **Authors**: Chuanchuan Yang, Hao Qin, Tianxiang Lan +4
- **PDF**: https://ieeexplore.ieee.org/document/10766433
...
- **Status**: ❌
- **Reason**: WDM 광전송 용량 데모, LDPC/디코더/코드설계 이식 기법 없음
- **ID**: ieee:10712737
- **Type**: journal
- **Published**: 15 Feb.15,
- **Authors**: Fukutaro Hamaoka, Masanori Nakamura, Takayuki Kobayashi +3
- **PDF**: https://ieeexplore.ieee.org/document/10712737
...
- **Status**: ❌
- **Reason**: 코히어런트 DSP, LDPC는 표준 부호율(8/9,5/6) 가정으로만 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:10746600
- **Type**: journal
- **Published**: 15 Feb.15,
- **Authors**: Guoxiu Huang, Yo Nakamura, Hisao Nakashima +1
- **PDF**: https://ieeexplore.ieee.org/document/10746600
...
- **Status**: ❌
- **Reason**: QC-MDPC 부호 기반 익명 인증(암호/보안), 채널 ECC 디코딩 아님
- **ID**: ieee:11216973
- **Type**: journal
- **Published**: 15 Dec.15,
- **Authors**: Xin Lin, Yusun Fu, Zihao Wang +1
- **PDF**: https://ieeexplore.ieee.org/document/11216973
- **Abstract**: Currently, the majority of authentication mechanisms in vehicular ad hoc networks (VANETs) are predominantly based on elliptic curve cryptography (ECC). However, with the rise of quantum computing, traditional cryptographic algorithms such as Rivest–Shamir–Adleman (RSA) and ECC face significant security threats, underscoring the need for exploring alternative cryptographic approaches that can provide robust security guarantees in a postquantum era. The National Institute of Standards and Technology (NIST) is working on the standardization of quantum-resistant public-key cryptographic algorithms, with code-based cryptosystems emerging as a promising alternative. In this article, we introduce a code-based anonymous authentication scheme tailored for VANETs. Our approach leverages code-based group signatures to ensure both anonymity and traceability, facilitating efficient user registration and revocation through fully dynamic group signatures (FDGSs). By utilizing punctured and randomly inserted quasi-cyclic moderate density parity-check (QC-MDPC) codes, we significantly reduce key sizes while enhancing resistance to attacks. Compared to conventional number-theoretic VANET authentication schemes, our method exhibits strong security and quantum resistance. Compared to recent code-based cryptographic solutions, our scheme notably decreases key sizes without increasing signature lengths. Security proofs and analyses validate that our scheme offers high security and meets essential requirements such as anonymity, traceability, nonframeability, and tracing soundness. Efficiency evaluations further demonstrate that our proposal is the first to achieve a code-based anonymous authentication scheme for VANETs with constant signature size.

## Joint Data-Aided Channel Estimation and Expectation Propagation Detection for Superimposed-Pilot-Based MIMO-OTFS Systems

- **Status**: ❌
- **Reason**: MIMO-OTFS 채널추정+EP 검출, LDPC ECC 기법 없음
- **ID**: ieee:11202532
- **Type**: journal
- **Published**: 15 Dec.15,
- **Authors**: Hanxin Zeng, Zhaopeng Xie, Xiangming Cai +3
- **PDF**: https://ieeexplore.ieee.org/document/11202532
- **Abstract**: In this article, we design a novel joint receiver that iteratively performs channel estimation (CE) and symbol detection for channel-coded multiuser multiple-input multiple-output systems with orthogonal time–frequency space (MIMO-OTFS) modulation. In particular, we first propose a two-stage CE method based on a single superimposed pilot (SP) with interuser interference canceling CE (ICCE). The delay-Doppler (DD) domain SP is used to estimate path delays, Doppler shifts, and other channel parameters. Then, the detected user symbols are utilized to update the channel parameters with mitigating interuser and multipath interferences. Second, we construct a joint CE and signal detection (JCESD) scheme based on the expectation propagation (EP)-ICCE algorithm (EP-ICCE). We exploit the relationship between CE and symbol detection, refining the estimated channel matrix with the detected data symbols. Finally, the simulation results show that the proposed EP-ICCE can achieve performance gains up to 2 dB over the conventional methods for the different MIMO and modulations.

## 126-Tb/s C+L-Band 2-Core Fiber Transmission Over 114.6 km × 5 Spans

- **Status**: ❌
- **Reason**: 멀티코어 광섬유 전송 용량, LDPC 무관
- **ID**: ieee:11027411
- **Type**: journal
- **Published**: 15 Aug.15,
- **Authors**: Kosuke Komatsu, Shohei Beppu, Daiki Soma +12
- **PDF**: https://ieeexplore.ieee.org/document/11027411
- **Abstract**: We present an experimental demonstration of full C+L-band 2-core fiber transmission over 114.6 km × 5 spans. The span length of 114.6 km is the longest span reported for weakly-coupled multicore fibers (MCFs), which enables cost-effective MCF systems by reducing amplifier-related costs. To achieve a long-span MCF system, we develop ultra-low-loss fan-in/fan-out devices with a minimum insertion loss of 0.20 dB, and utilize ultra-low-loss 2-core fiber with an average loss of 0.149 dB/km. In the transmission, all the 740 channels with 24-Gbaud 16-quadrature amplitude modulation have sufficient Q$^{2}$-factors $>$6.5 dB, corresponding to a total capacity of 126 Tb/s. Through experimental and theoretical investigations, we clarify that the degradation of the Q$^{2}$-factors due to inter-core crosstalk is less than 0.30 dB, and that amplified spontaneous emission noise added by amplifiers mainly limits the transmission performance.

## Secure Key Generation and Distribution Scheme Based on Signal Hiding and Concatenated Coding in Optical Fiber

- **Status**: ❌
- **Reason**: 광 키 생성·분배 보안, LDPC는 베이스라인 연접부호로만 사용, 이식 기법 없음
- **ID**: ieee:11032158
- **Type**: journal
- **Published**: 15 Aug.15,
- **Authors**: Kongni Zhu, Yuang Li, Shuang Wei +4
- **PDF**: https://ieeexplore.ieee.org/document/11032158
- **Abstract**: A key generation and distribution scheme in coherent optical system is proposed, which is compatible with the current fiber infrastructure. The random key is generated by quantifying system noise which is obtained according to the training sequence. The key signal with the low power is hidden in the 212 × 212 TQAM signal. The legal party can extract the key signal from 16 QAM signals, but the attacker can only extract the key signal from 212 × 212 TQAM signals. Compared with processing 212 × 212 TQAM signals, existing algorithms are more effective at processing 16 QAM signals. It provides the security of key distribution and is verified by experiment. The concatenated coding including LDPC coding and differential coding is employed to get error-free key and expand the security space. Since differential coding leads to cumulative errors, the key error rate is ∼50% when the key error rate is above the LDPC threshold. The proposed scheme achieves an error-free key with KDR of 2.5 Gbps over 80 km SSMF, which does not require the presetting, external random source, and additional device.
...
- **Status**: ❌
- **Reason**: CV-QKD 화해(reconciliation), 보안 도메인·d차원 화해는 바이너리 LDPC 디코더 이식 기법 아님
- **ID**: ieee:10842051
- **Type**: journal
- **Published**: 15 April15
- **Authors**: Kadir Gümüş, João dos Reis Frazão, Vincent van Vliet +8
- **PDF**: https://ieeexplore.ieee.org/document/10842051
...
- **Status**: ❌
- **Reason**: 수중음향 OFDM 임펄스 잡음 CNN, LDPC 무관
- **ID**: ieee:10771828
- **Type**: journal
- **Published**: 15 April15
- **Authors**: Lei Wan, Shuoshuo Xu, Yuewen Diao +3
- **PDF**: https://ieeexplore.ieee.org/document/10771828
- **Abstract**: Underwater acoustic (UWA) communication is until now the only effective means for long distance underwater wireless communication, and hence it is the key foundation for Internet of Underwater Things (IoUT). However, in ocean environment, impulsive noise (IN) generated by natural and human factors usually seriously affects the performance of UWA communication. In this article, utilizing the powerful capability of deep learning, a 1-D convolutional neural network based on multiattention mechanism (1DCNN-MAM) for IN mitigation in UWA orthogonal frequency division multiplexing (OFDM) systems is proposed. To enhance the generalization performance of the network, it utilizes minimization of the energy on null subcarriers as an auxiliary task for network training. Furthermore, to adapt to specific environment quickly and reduce the amount of real data required for training, it adopts a network-based deep transfer learning approach for fine-tuning. To verify the performance of the proposed scheme, a sea trial has been carried out along with simulations, and both demonstrate that the proposed scheme can effectively suppress the IN in UWA OFDM systems.

## Secure and Reliable 6G Communications with BCH-Based GLDPC and Kyber

- **Status**: ❌
- **Reason**: BCH 기반 GLDPC+Kyber 보안 결합, 암호 보안 목적이며 떼어낼 순수 ECC 기법 약함 — 다만 GLDPC 디코딩 변형은 경계적이나 보안 결합 특화로 제외
- **ID**: ieee:10930099
- **Type**: conference
- **Published**: 11-14 Jan.
- **Authors**: Linh Nguyen, Cheol-Hong Min, Hanho Lee +1
- **PDF**: https://ieeexplore.ieee.org/document/10930099
- **Abstract**: Channel coding in sixth-generation (6G) networks must attain exceptionally low bit error rate (BER), typically in the range of 10–6 to 10–9, to ensure the requisite level of reliability. While fifth-generation (5G) New Radio (NR) coding techniques have made substantial progress, the inherent limitations of the low error floor impede the attainment of such stringent BER targets. Compared to the low-density parity check (LDPC) codes employed in 5G communications, generalized low-density parity check (GLDPC) codes offer a more advantageous tradeoff between computational complexity and error correction performance in 6G networks. GLDPC codes enhance traditional LDPC structures by incorporating more complex local decoding units within their check nodes. When coupled with cryptographic techniques, GLDPC codes can establish a robust information security framework. In this paper, we propose a new security-based GLDPC that uses a number of BCH matrices for the GLDPC decoding process combined with the Kyber algorithm (BCH-based KyGLDPC) before transmitting data to increase reli-ability and solve the security problem against quantum computer attacks. The system's performance is assessed using both image data and data encrypted prior to transmission in a white additive Gaussian noise environment. The results indicate that the system provides strong error correction and data security.

## Performance Evaluation of Next Generation DTTB Using Asynchronous Time-Domain LDM

- **Status**: ❌
- **Reason**: 지상파 방송 LDM 다중화 물리계층, LDPC 언급 없는 변조 기법, 이식 ECC 기여 없음
- **ID**: ieee:10930202
- **Type**: conference
- **Published**: 11-14 Jan.
- **Authors**: Atsuo MIKI, Akira NAKAMURA, Makoto ITAMI
- **PDF**: https://ieeexplore.ieee.org/document/10930202
- **Abstract**: For the achievement of 4K and 8K terrestrial Ultra High Definition Television (UHDTV) broadcasting, research in the physical layer is being conducted all over the world to realize technology that achieves high transmission efficiency. Currently, the frequency band allocated to terrestrial broad-casting is strained, and there are no extra bandwidth avail-able to introduce next-generation Digital Terrestrial Television Broadcasting (DTTB, same meaning as Advanced ISDB- T). In Japan, Integrated Services Digital Broadcasting-Terrestrial (ISDB-T) is used for terrestrial broadcasting. To introduce the next-generation DTTB while broadcasting ISDB-T, the Layered Division Multiplexing (LDM) method has been proposed. LDM enables ISDB-T and Advanced ISDB-T to communicate in the same frequency band in Time-Domain or Frequency-Domain. In this study, we propose using Asynchronous Time-Domain LDM with a larger number of FFT size, which the size is only acces-sible in the Time-Domain. The result shows that communication accuracy against noise was improved over Frequency-Domain LDM (FLDM) or previous study of Time-Domain (TLDM). This enables next-generation DTTB using TLDM instead of FLDM to transmit signals with different FFT clocks and higher bit rates for 4K and 8K TV services. The results are simulated in the Additive White Gaussian Noise (AWGN) channel.

## Information Set Optimization of Polar Codes Under BP Decoder Based on Union Bound

- **Status**: ❌
- **Reason**: Polar 부호 BP 디코딩용 정보집합 최적화 — LDPC가 아닌 polar 코드 전용 기법으로 NAND LDPC 이식성 없음
- **ID**: ieee:10976029
- **Type**: conference
- **Published**: 10-13 Jan.
- **Authors**: Tomoya Okamura, Satoshi Suyama, Satoshi Nagata +1
- **PDF**: https://ieeexplore.ieee.org/document/10976029
- **Abstract**: One of the possible methods for obtaining reduced latency is the use of belief propagation (BP) decoding on polar codes. We proposed an iterative approach to get the information set optimal for BP decoding in order to mitigate performance degradation caused by BP decoding. In order to estimate the block error rate (BLER) of the BP decoding, we employ the union bound. Specifically, an all-zero codeword is transmitted through a low-noise channel, and it is decoded by successive cancellation list decoder with a large list size to capture low-weight codewords. By employing the proposed iterative algorithm, the performance were improved compared to the performance employing the information set optimized for the successive cancellation decoding.

## Efficient Bit-Flipping Decoding Algorithm for Structured LDPC Codes

- **Status**: ✅
- **Reason**: 구조화 LDPC용 GDBF 비트플립 개선(가중 파라미터, 플립 횟수 반영) — 이식 가능 디코더 알고리즘(C), HW 친화
- **ID**: ieee:11064383
- **Type**: conference
- **Published**: 10-12 Jan.
- **Authors**: Cheng He, Yuzhu Wang
- **PDF**: https://ieeexplore.ieee.org/document/11064383
- **Abstract**: The Gradient descent bit flipping (GDBF) algorithm is a representative approach for decoding low-density parity-check (LDPC) codes, which offers a good tradeoff between decoding performance and complexity. Unfortunately, the decoding performance of GDBF algorithm degenerates dramatically for structured LDPC codes due to their large column weight. To address the above issue, we propose to improve GDBF algorithm by introducing a weighted parameter in the energy function of each bit. Specifically, this parameter compensates for the computational error of the energy function due to the large column weight of the parity-check matrices of structured LDPC codes. Moreover, the flipping number of each bit in the iterative process is included in the energy function to avoid consecutive bit flips in the decoding. Simulation results on typical structured LDPC codes indicate that the performance of the proposed algorithm is better than the standard GDBF algorithm at the cost of slight increment in the algorithmic complexity. The increase operations can be easily implemented, which indicates the proposed algorithm is suitable for practical purposes.

## Performance Analysis of HF Communication System Based on Speech Modal Semantic Encoding

- **Status**: ❌
- **Reason**: HF 음성 시맨틱 통신 — 소스/시맨틱 코딩, 채널 ECC 기법 없음
- **ID**: ieee:11064611
- **Type**: conference
- **Published**: 10-12 Jan.
- **Authors**: Zhanglin Lu, Jielin Fu
- **PDF**: https://ieeexplore.ieee.org/document/11064611
- **Abstract**: The existing HF communication system has reached a bottleneck in improving communication quality, with limited room for further optimization. There is an urgent need to explore new methods to overcome its limitations. We design an HF communication system based on speech modal semantic encoding by introducing method from semantic communication and compare its communication quality performance with that of the traditional HF speech communication system. Our results show that under similar transmission rates, the designed system can achieve the same communication quality as the traditional HF speech communication system at a lower signal-to-noise ratio (SNR).

## TLoRa: On a Feedback-Driven Segmented Turbo Coding Scheme for LoRa Sensor Network Communication in Agriculture

- **Status**: ❌
- **Reason**: LoRa용 turbo/RSC 코딩·SOPS 디코딩; LDPC 아니며 이식 ECC 기법 없음
- **ID**: ieee:11096012
- **Type**: journal
- **Published**: 1 Sept.1, 
- **Authors**: Penghao He, Guoshuai Liang, Tianzhang Xing +2
- **PDF**: https://ieeexplore.ieee.org/document/11096012
...
- **Status**: ❌
- **Reason**: 연합학습·CNN 차량 채널 추정; LDPC 디코더/코드 기법 없음
- **ID**: ieee:11039006
- **Type**: journal
- **Published**: 1 Sept.1, 
- **Authors**: Cao Ding, Ivan Wang-Hei Ho
- **PDF**: https://ieeexplore.ieee.org/document/11039006
- **Abstract**: Urban vehicular channel estimation (UVCE) has long been a difficult task due to the intercarrier interference (ICI) and path loss caused by high-speed vehicle motion and urban geographical features (e.g., buildings, vehicles, and trees). Conventional estimators based on pilot symbols and channel statistics generally assume static signal propagation models, such as Free-space and Rayleigh fading. These models are inadequate for addressing path losses caused by geographical features, leading to limited performance. In contrast, centralized learning (CL)-based estimators can provide higher estimation performance by collecting channel data from a specific geographical area for training. However, when the UVCE is scaled to city size, CL estimators cannot precisely recognize the channel characteristics of each location in the city, resulting in decreased estimation accuracy. To further improve the scalability and accuracy of UVCE, this article proposes a federated learning (FL) and convolutional neural network (CNN)-based channel estimator, referred to as FL-CNN. FL is used to aggregate multiple local channel models (LCMs), which are clustered by the K-Dimension (KD)-tree technique. For each LCM, we employ the ray-tracing model to calculate the path loss caused by geographical features and use CNN to estimate the channel. Our results show that at the low signal-to-noise-ratio (SNR) regime (e.g., 10 dB), the estimation and data recovery performance of the FL-CNN estimator are, respectively, 61% and 65% higher than those of benchmark estimators on average.

## An Unconditionally Secure Encryption Scheme for IoBT Networks

- **Status**: ❌
- **Reason**: IoBT 무조건적 보안 암호화 스킴; 채널코딩 ECC가 아닌 암호
- **ID**: ieee:11111714
- **Type**: journal
- **Published**: 1 Nov.1, 2
- **Authors**: Mohammad Moltafet, Hamid R. Sadjadpour, Zouheir Rezki
- **PDF**: https://ieeexplore.ieee.org/document/11111714
...
- **Status**: ❌
- **Reason**: 다차원 보로노이 성상+MLC 기하성형, 변조 기법이며 이식 가능한 LDPC ECC 기여 없음
- **ID**: ieee:11029117
- **Type**: journal
- **Published**: 1 July1, 2
- **Authors**: Bin Chen, Can Zhao, Lin Sun +6
- **PDF**: https://ieeexplore.ieee.org/document/11029117
- **Abstract**: Multidimensional (MD) geometric shaping is an effective approach for achieving spectral efficiency gains in optical communication systems. MD formats also support the joint transmission across different cores of multi-core fibers (MCFs), enabling higher performance improvements through joint decoding. As a structured geometric shaping method, MD Voronoi constellations (VCs) allow low-complexity encoding and decoding without the need for look-up tables, offering superior performance over quadrature amplitude modulation (QAM) formats in terms of bit error rate and mutual information. Moreover, MD VCs can be combined with multilevel coding (MLC) schemes to achieve higher shaping gains after soft-decision (SD) decoding. In this paper, the performance of 16-dimensional VCs with MLC is experimentally demonstrated over a 50 km four-core weakly-coupled MCF transmission system. Compared to 16QAM with bit-interleaved coded modulation at the outer HD-FEC BER threshold of $ 4.5\times 10^{-3}$, VCs achieve a 6 dB reduction in the required launch power and extend the operating range by 17 dB.

## Multi-Input UV Communication With Adaptive Gain Adjustment

- **Status**: ❌
- **Reason**: UV 통신 채널 특이적 LLR(PMT 가우시안 근사) — LDPC 부호/디코더 기여 없음, 응용 특이적
- **ID**: ieee:10705689
- **Type**: journal
- **Published**: 1 Feb.1, 2
- **Authors**: Yifan Ding, Chen Gong, Weijie Liu +3
- **PDF**: https://ieeexplore.ieee.org/document/10705689
- **Abstract**: In this paper, an on-off keying based multi-input superimposed transmission for ultraviolet communication is investigated by characterizing the multi-input transmission as a hidden Markov model. A Gaussian approximation for the summation of sampled signal is characterized and the corresponding log-likelihood ratio computation method is proposed for the subsequent message-passing decoder. The profile of the PMT output amplitude under different supply voltage levels is experimentally measured and fitted. Based on the fitted results, we predict the optimal PMT gain and its corresponding supply voltage that minimizes the bit error rate (BER) for the signal detection. In the experiments, the derived supply voltage by the proposed approach is close to the optimal value via exhaustive searching method, and the BER of the proposed approach is close to that of exhaustive search.

## High Data-Rate OESCLU-Band Transmission

- **Status**: ❌
- **Reason**: 초광대역 광전송, FEC는 베이스라인 언급뿐 — ECC 기법 없음
- **ID**: ieee:10891718
- **Type**: journal
- **Published**: 1 Dec.1, 2
- **Authors**: Benjamin J. Puttnam, Ruben S. Luís, Ian Phillips +21
- **PDF**: https://ieeexplore.ieee.org/document/10891718
...
## Performance Analysis of Seamless Rate-Adaptive Non-Line-of-Sight Underwater Optical Wireless Communications With Wavy Surface

- **Status**: ❌
- **Reason**: 수중광통신 RCM이 기여, LDPC는 비교 베이스라인 — 떼어낼 ECC 기법 없음
- **ID**: ieee:11184779
- **Type**: journal
- **Published**: 1 Dec.1, 2
- **Authors**: Jianghao Li, Xinyu Wang, Yang Zou +5
- **PDF**: https://ieeexplore.ieee.org/document/11184779
- **Abstract**: Non-line-of-sight (NLOS) underwater optical wireless communication (UOWC) systems can provide high-speed data transmission in the environment with channel blockages but are severely affected by channel fading caused by sea waves. In this paper, we propose a novel rate compatible modulation (RCM) scheme for NLOS UOWC system with the Pierson wave model to address the issue and further improve the system performance. We verify the proof-of-concept of the proposed scheme for NLOS UOWC system through Monte Carlo (MC) simulation. Our results show that seamless rate adaptations can be achieved regardless the channel conditions with the help of the proposed RCM scheme, which results in significant improvement of the achievable uninterrupted transmission distance and enhanced robustness to the channel fading caused by the sea waves, solar radiation, water absorption and scattering as compared to conventional adaptive modulation and coding (AMC) schemes based on LDPC codes. In addition, the maximum achievable data rate of the NLOS UOWC system employing RCM schemes with weight set of W4 = {±1, ±1} and W5 = {±1} can be achieved when the receiver orientation angle (ROA) is 52.5°. Our work provides huge potential and fundamental frameworks for the implementation and design of practical NLOS UOWC systems and networks.

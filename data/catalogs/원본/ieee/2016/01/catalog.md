...
- **Status**: ❌
- **Reason**: 광통신용 FEC/CM 튜토리얼+서베이; 비이진 LDPC 강조, 표준 QC-LDPC 언급, 떼어낼 신규 바이너리 디코더/구성 없음
- **ID**: ieee:7422653
- **Type**: journal
...
- **Status**: ❌
- **Reason**: DCSK 카오스 변조 무선통신 서베이; LDPC는 부수 언급, NAND 이식 기법 없음
- **ID**: ieee:7442517
- **Type**: journal
- **Published**: thirdquart
...
- **Status**: ❌
- **Reason**: 릴레이 협력용 QC-LDPC를 girth-4 제거+표준 MSA로 설계 — 교과서 수준 사이클제거+표준 min-sum, 무선 응용 특이적
- **ID**: ieee:10855863
- **Type**: journal
...
- **Status**: ❌
- **Reason**: array 기반 비이진(NBLDPC) 부호 구성 — 비이진 LDPC는 제외 대상
- **ID**: ieee:7307109
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: 비이진 LDPC 코드드 변조 결합 검출-디코딩 — 비이진 LDPC는 제외 대상
- **ID**: ieee:7293134
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: 비이진 NB-LDPC 전용 디코더(GF(2^5)), 비이진 LDPC는 제외 대상
- **ID**: ieee:7329979
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: 고전 QC-LDPC로 CSS형 양자 LDPC 구성 — 양자 EC 전용(이중포함성·EA), 제외
- **ID**: ieee:7350103
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: SMR 인접트랙간섭용 연접부호(비-LDPC) — 떼어낼 바이너리 LDPC BP 기법 없음
- **ID**: ieee:7234917
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: spatially coupled repeater-combiner-convolutional 부호 설계, 통신 BP threshold 중심이며 NAND LDPC에 이식할 새 디코더/HW 기법 없음
- **ID**: ieee:7317509
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: LDPC 코드 시스템용 NDA 반송파 추적(FLL/PLL) 동기화 기법, LDPC는 부수 언급이며 떼어낼 ECC 기법 없음
- **ID**: ieee:7329919
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: 테이프 스토리지용 RS+비이진 LDPC 연접 + 비이진 반복디코딩 — 비이진 LDPC라 제외
- **ID**: ieee:7339707
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: 위성 위상잡음 SPA 메시지 Tikhonov 혼합 근사 — 위상추정 특이 기법, 바이너리 LDPC BP 이식 기여 아님
- **ID**: ieee:7349155
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: sparse random linear network coding 복잡도 최적화, 채널 ECC가 아니고 이식할 LDPC 기법 없음
- **ID**: ieee:7335581
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: DFT 기반 주파수 추정기, LDPC/ECC와 무관
- **ID**: ieee:7312438
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: BATS(네트워크코딩) 부호의 BP 트리 분석, 채널 ECC가 아니고 이식할 LDPC 기법 없음
- **ID**: ieee:7322211
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: HARQ 부호율 최적화·에너지 효율 분석 — LDPC ECC 이식 기법 없음, 무선 응용 특이적
- **ID**: ieee:7208849
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: 인지무선 permutation trellis code + MFSK + Viterbi — LDPC 아님, 떼어낼 BP 기법 없음
- **ID**: ieee:7342915
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: V-OFDM 위상잡음 EM 추정 — LDPC 무관, 통신 신호처리
- **ID**: ieee:7008538
- **Type**: journal
- **Published**: Jan. 2016
...
- **Status**: ❌
- **Reason**: 100G 광통신 FEC 3세대 부호 서베이 — 구체적 신규 디코더/구성 기여 없는 정성 비교 리뷰
- **ID**: ieee:6917198
- **Type**: journal
...
- **Status**: ❌
- **Reason**: 터보부호 20년 회고 + 에너지 인지 설계 튜토리얼 — 비-LDPC, 이식 BP 기법 없음
- **ID**: ieee:7131434
- **Type**: journal
- **Published**: Firstquart
...
- **Status**: ❌
- **Reason**: polar용 symbol-decision SCL 디코더/아키텍처 — polar 전용(채널결합·SCL), 바이너리 LDPC BP 이식 아님
- **ID**: ieee:7289453
- **Type**: journal
- **Published**: Feb.1, 201
...
- **Status**: ❌
- **Reason**: 수중음향 센서망 multi-hop 에너지 최적화-네트워크 라우팅, ECC 무관
- **ID**: ieee:7535777
- **Type**: conference
- **Published**: 9-11 Jan. 
...
- **Status**: ❌
- **Reason**: 수중음향 채널 sea wave 영향 분석-채널 모델링, ECC 기법 없음
- **ID**: ieee:7535761
- **Type**: conference
- **Published**: 9-11 Jan. 
...
- **Status**: ❌
- **Reason**: GF(2m) cross parity 코드 - 비이진/비-LDPC 부호, 떼어낼 LDPC BP 기법 없음
- **ID**: ieee:7726963
- **Type**: conference
- **Published**: 7-8 Jan. 2
...
- **Status**: ❌
- **Reason**: convolutional/turbo MAP 디코더(Max-log-MAP), 비-LDPC 부호이며 부호 비의존 BP 이식 기법 아님
- **ID**: ieee:7727013
- **Type**: conference
- **Published**: 7-8 Jan. 2
...
- **Status**: ❌
- **Reason**: low-density MDS array code(RAID/erasure)이나 기존 코드[3]의 FUSE 구현 사례, 신규 코드/디코더 기여 없음
- **ID**: ieee:7562983
- **Type**: conference
- **Published**: 27-30 Jan.
...
- **Status**: ❌
- **Reason**: AES side-channel/fault 내성 보안 연구, LDPC ECC 무관
- **ID**: ieee:7428087
- **Type**: conference
- **Published**: 25-28 Jan.
...
- **Status**: ❌
- **Reason**: stochastic computing 클럭/회로 합성 일반론, LDPC 디코더 기법 아님
- **ID**: ieee:7428060
- **Type**: conference
- **Published**: 25-28 Jan.
...
- **Status**: ❌
- **Reason**: 정보이론/채널코딩 튜토리얼·서베이, 구체적 신규 디코더·구성·HW 기여 없음
- **ID**: ieee:7784815
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 분산 소스코딩(DSC/DJSC)+turbo TTCM; 소스코딩·비LDPC
- **ID**: ieee:7423654
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 부반송파 인덱스 변조(SIM) 성능분석, LDPC 무관
- **ID**: ieee:7469311
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: LTE-A M2M fountain coded 협력통신 릴레이 선택, 무선응용 특이적 ECC 기법 없음
- **ID**: ieee:7551214
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 버퍼 보조 릴레이 프로토콜, LDPC와 무관
- **ID**: ieee:7501454
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: turbo Log-BCJR FPTD 디코더, BCJR 기반이라 LDPC BP에 이식 불가능한 비-LDPC 부호
- **ID**: ieee:7539551
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: TDMR rate-4/5 변조부호 ITI 차감 기법, LDPC 디코더/코드설계 기여 없음(변조부호+반복디코딩 베이스라인)
- **ID**: ieee:7511764
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 무선망 손상패킷 복구 서베이, 구체적 신규 LDPC 디코더/구성/HW 기여 없음
- **ID**: ieee:7517301
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: FSO HEVC 부등오류보호, FEC 율 선택 최적화일 뿐 LDPC 기법 없음
- **ID**: ieee:7556280
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: L1 캐시 결함내성 아키텍처; LDPC/ECC 코드 기법 무관
- **ID**: ieee:8074442
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 압축센싱 기반 인지무선 JSCC; LDPC ECC로 떼어낼 기법 없음
- **ID**: ieee:7794629
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: RB-HARQ 기반 보안통신(wiretap); 물리계층 보안 프로토콜, 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:7917100
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 인지무선망 비디오전송/재밍 — 통신/보안 응용, LDPC ECC 기법 없음
- **ID**: ieee:7860536
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: MIMO PIC-MMSE 검출기 최적화, LDPC 비의존 검출기 기법으로 BP 이식성 없음
- **ID**: ieee:7833615
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: RAID DP 스토리지 구조(RAM/HDD/flash 조합), LDPC ECC 알고리즘 없음
- **ID**: ieee:7560930
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: Hadamard 기반 space-time coding으로 MDL 완화, LDPC ECC 무관
- **ID**: ieee:7537474
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 텔레메트리 패킷 오버헤드 최적화, ECC와 무관
- **ID**: ieee:7500762
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 양자노이즈 스트림암호+CV-QKD 보안 전송, LDPC ECC 무관
- **ID**: ieee:7767755
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: probabilistically shaped QAM 광전송, LDPC 무관
- **ID**: ieee:7767614
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 광통신 carrier phase recovery 변조 기법, LDPC/디코더/코드설계 기여 없음
- **ID**: ieee:7537622
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 광 transceiver SNR 최적화, ECC/LDPC 떼어낼 기법 없음
- **ID**: ieee:7537805
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: OFDM 디코더 개선으로 LDPC ECC 기법 아님
- **ID**: ieee:7881481
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 비코히런트 massive MIMO LLR 계산, 변조/검출 특이적이며 떼어낼 LDPC 기법 없음
- **ID**: ieee:7499102
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 광통신 DWDM 16QAM 전송 + soft FEC; LDPC 부수 언급, 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:7769421
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 광통신 확률성형(probabilistic shaping) coded modulation, LDPC 부수 언급, 떼어낼 디코더·HW·코드설계 기법 없음
- **ID**: ieee:8680233
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 비이진 NB-LDPC absorbing set 최적화, 플래시 응용이나 non-binary라 제외
- **ID**: ieee:7541791
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 다중웨이 릴레이 JCCNC, LDPC는 채널코딩 베이스라인일 뿐 떼어낼 디코더/구성/HW 기법 없음
- **ID**: ieee:7556045
- **Type**: conference
- **Published**: 2016
- **Authors**: W. Liu
...
- **Status**: ❌
- **Reason**: 콘텐츠 인식 side-info+터보 디코딩, LDPC 비특이적이라 떼어낼 기법 없음
- **ID**: ieee:7752591
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 메모리 SEU용 majority logic 디코더+cyclic code — 비-LDPC 부호, 제외
- **ID**: ieee:7807854
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 도청채널 보안용 비-LDPC multiple parity-check 부호; 바이너리 LDPC BP로 이식할 기법 없음, 보안 도메인 제외
- **ID**: ieee:7790441
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: LDPC-Staircase AL-FEC erasure 코드, fountain/erasure 응용으로 떼어낼 채널 ECC 기법 없음
- **ID**: ieee:7765395
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: polar-LDPC 연접 인터리빙으로 polar SC 상관오류 분산이 목적, LDPC BP 기법 아님
- **ID**: ieee:7880865
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: turbo/LDPC/polar/conv 부호 비교 분석으로 신규 LDPC 디코더·구성 기여 없음
- **ID**: ieee:7880930
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 테라헤르츠용 turbo product/RS 부호 FPGA 디코더; LDPC와 비교만 할 뿐 기법은 turbo-product 특화로 바이너리 LDPC BP 이식 불가
- **ID**: ieee:7794685
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 단길이 부호 성능 비교(LDPC/RM/Polar/BCH), 범용 ML/OSD 디코더로 부호 비교 — 신규 LDPC 디코더/구성 기여 없음
- **ID**: ieee:7797660
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: VLC 인덱스변조에 LDPC를 베이스라인으로 사용, 새 LDPC 기법 없음
- **ID**: ieee:7504166
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: monolithic 3D IC 파티셔닝 툴; LDPC는 벤치마크 유닛으로만 언급, 부호/디코더 기법 없음
- **ID**: ieee:7970013
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: FTN ISI 등화기 전용 weighted FG-SS-BP, LDPC는 베이스라인일 뿐 이식할 디코더 기법 아님
- **ID**: ieee:7504329
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: MIMO용 polar code + MMSE-SIC 검출; polar 비-LDPC, 검출기법이 LDPC BP 비의존, 제외
- **ID**: ieee:7905658
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: OFDM/OQAM 간섭제거에 LDPC 디코더 부수 사용 — LDPC가 베이스라인, 신규 디코더/코드/HW 없음
- **ID**: ieee:7584319
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: polar code용 CRC/parity-check SCL 디코딩; 비-LDPC, SCL은 polar 전용으로 LDPC BP 이식 불가
- **ID**: ieee:7917180
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 광전송 응용, SC-LDPC를 베이스라인으로 사용할 뿐 새 디코더/구성 기여 없음
- **ID**: ieee:7765589
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: Generalized Reed-Muller 부호 locality·broadcast erasure, 비-LDPC + erasure, 이식 기법 없음
- **ID**: ieee:7521914
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: OFDM/SOQPSK 적응변조 HW 구현, LDPC는 부수 언급일 뿐 떼어낼 LDPC 디코더·구성 기여 없음
- **ID**: ieee:7465452
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: PNC 선형 네트워크코딩 계수 최적화, LDPC는 베이스라인, 이식할 디코더/코드설계 없음
- **ID**: ieee:7565028
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: Polar coded MBM, LDPC는 비교 베이스라인일 뿐 이식 가능한 BP 기법 없음
- **ID**: ieee:7752485
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 링크적응 전송모드 선택 알고리즘, LDPC는 부수 언급
- **ID**: ieee:7881821
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: turbo/LDPC HW 상호관계 서베이성 논문 — 구체적 신규 디코더·구성·HW 기여 없음
- **ID**: ieee:7593146
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: CubeSat CDMA 통신, CCSDS 표준 LDPC 부수 언급만으로 새 기법 없음
- **ID**: ieee:7500710
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 위성 비선형 왜곡 제거 수신기, LDPC는 베이스라인 FEC만 — 이식 가능 LDPC 기법 없음
- **ID**: ieee:7601465
- **Type**: conference
- **Published**: 2016
- **Authors**: S. Dimitrov
...
- **Status**: ❌
- **Reason**: 고차 변조 반송파 위상 추적 FPGA 설계, LDPC는 부수 언급 — 떼어낼 디코더 기법 없음
- **ID**: ieee:7795508
- **Type**: conference
- **Published**: 2016
- **Authors**: T. D. Kurp
...
- **Status**: ❌
- **Reason**: 협력 MARC 릴레이의 joint network-channel MAP 디코더, LDPC는 베이스라인이고 떼어낼 LDPC BP 기법 없음
- **ID**: ieee:7536879
- **Type**: conference
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 학회 표지(front cover) 토픽 나열, 논문 아님
- **ID**: ieee:7530103
- **Type**: conference
- **Published**: 2016
- **Authors**: 
...
- **Status**: ❌
- **Reason**: 학회지 목차(Table of contents)로 논문 아님
- **ID**: ieee:7779344
- **Type**: conference
- **Published**: 2016
- **Authors**: 
...
- **Status**: ❌
- **Reason**: Copyright notice / issue TOC, LDPC decoder는 부수 언급, 떼어낼 기법 없음
- **ID**: ieee:7754576
- **Type**: conference
- **Published**: 2016
- **Authors**: 
...
- **Status**: ❌
- **Reason**: 입자컴퓨팅 대수 몫공간 모델 논문으로 ECC는 사례 예시일 뿐 — 떼어낼 LDPC 기법 없음
- **ID**: ieee:10851925
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: OFDM cross-layer Chase combining/선택적 재전송; LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:7447779
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 탄성 광네트워크 SDN 파라미터 설정, FEC는 부수 언급뿐 이식 가능 LDPC 기법 없음
- **ID**: ieee:7365418
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 분산비디오코딩에서 modulo 연산으로 채널코드 대체 — LDPC 제거 방향, 떼어낼 ECC 디코더 기법 없음
- **ID**: ieee:10855855
- **Type**: journal
- **Published**: 2016
...
- **Status**: ❌
- **Reason**: 특집호 게스트 에디토리얼(서베이성), 구체적 신규 디코더/구성 기여 없음
- **ID**: ieee:7384575
- **Type**: journal
- **Published**: 2016
...
## Channel coded complex field network coding with OFDM in wireless networks

- **Status**: ❌
- **Reason**: OFDM+복소필드 네트워크코딩 무선 협력통신, 오류제어부호 부수 언급, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7821851
- **Type**: conference
- **Published**: 2016
- **Authors**: R. Khan, I. Altunbas, G. K. Kurt
- **PDF**: https://ieeexplore.ieee.org/document/7821851
- **Abstract**: Orthogonal frequency division multiplexing (OFDM) is the most promising approach to combat the frequency selective fading nature of wide-band wireless channels. On the other hand, complex field network coding (CFNC) scheme offers the advantages of better spectral efficiency and full diversity when utilized in multiuser cooperative communication systems. The efficiency of CFNC scheme in relay based multiuser cooperative networks can be further enhanced with the incorporation of error control codes. These considerations motivate the utilization of OFDM and CFNC in cooperative wireless networks combined with error control codes for a frequency selective fading scenario. In this paper, we make a detailed analysis of such a setup while using different relaying strategies such as amplify and forward (AAF) and decode and forward (DAF) to evaluate the system performance. We also consider relay selection technique with both AAF and DAF schemes. Simulation results show that the channel coded CFNC with OFDM significantly improves the error performance in frequency selective faded cooperative communications environment.

## Technical Review on DTMB-Advanced (DTMB-A) Standard

- **Status**: ❌
- **Reason**: DTMB-A 방송표준 기술 개요(서베이성), 신규 디코더·구성·HW 기여 없음
- **ID**: ieee:7810770
- **Type**: conference
- **Published**: 2016
- **Authors**: J. Song, C. Zhang
- **PDF**: https://ieeexplore.ieee.org/document/7810770
- **Abstract**: Digital terrestrial television multimedia broadcasting - advanced (DTMB-A) is digital terrestrial television broadcasting (DTTB) standard proposed by China, which has been accepted by ITU as the international DTTB standard in July, 2015. By adopting several advanced technologies, such as near-capacity channel coding and modulation as well as improved frame structure, DTMB-A can provide fast system synchronization, high receiving sensitivity, better performance against multipath effect, high spectrum efficiency and the flexibility for the future extension. This paper provides a technical overview of the physical layer specification of DTMB-A standard in detail. Laboratory test and field trial results are also given which indicate that DTMB-A standard can offer excellent overall system performance for both fixed and mobile receptions under complicated transmission conditions.

## Improving GGH cryptosystem using generalized low density lattices

- **Status**: ❌
- **Reason**: GGH 암호시스템 + GLD lattice — 보안/암호, NAND ECC 디코더·구성 이식 기법 없음
- **ID**: ieee:7843914
- **Type**: conference
- **Published**: 2016
- **Authors**: S. Kamel, M. Sarkiss, G. R. -B. Othman
- **PDF**: https://ieeexplore.ieee.org/document/7843914
...
- **Status**: ❌
- **Reason**: Notice of Removal로 초록 내용 없음(Removed)
- **ID**: ieee:7740341
- **Type**: conference
- **Published**: 2016
- **Authors**: S. B. Ismail, F. H. M. Ali, S. A. Aljunid
- **PDF**: https://ieeexplore.ieee.org/document/7740341
- **Abstract**: Removed.

## FPGA design and implementation of the Joint Viterbi Detector Decoder

- **Status**: ❌
- **Reason**: JVDD의 FPGA 구현 — Viterbi 트렐리스 디코더 HW, LDPC 디코더 아키텍처 아님
- **ID**: ieee:7843367
- **Type**: conference
- **Published**: 2016
- **Authors**: B. Hamadicharef, K. S. Chan
...
## Complex field network coding with OFDM in distributed wireless networks

- **Status**: ❌
- **Reason**: OFDM+복소필드 네트워크 코딩 무선 릴레이; LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:7993430
- **Type**: conference
- **Published**: 2016
- **Authors**: R. Khan, G. K. Kurt, İ. Altunbaş
- **PDF**: https://ieeexplore.ieee.org/document/7993430
- **Abstract**: Cooperative diversity method is a major way to significantly increase the capacity of multi-source distributed wireless networks with improved coverage. On the other hand, complex field network coding (CFNC) helps mitigate the spectral efficiency loss incurred by traditional relaying schemes in larger networks. Considering the frequency selective fading nature of wireless channels, it would be a practical approach to combine orthogonal frequency division multiplexing (OFDM) with CFNC in wireless relay networks. Therefore, in this paper, we make a thorough analysis of CFNC in distributed wireless networks, combined with OFDM. Different relaying schemes such as amplify and forward (AAF) and decode and forward (DAF) are used for evaluating the system performance. Moreover, we also consider relay selection technique with both AAF and DAF schemes. Simulation results are presented for uncoded and convolutionally coded relaying schemes for CFNC when OFDM is incorporated in the given setup.
...
- **Status**: ❌
- **Reason**: wavelet-coded OFDM으로 LDPC 무관
- **ID**: ieee:7881967
- **Type**: conference
- **Published**: 2016
- **Authors**: L. Cavalcante, J. J. V. Olmos, R. Dinis +3
- **PDF**: https://ieeexplore.ieee.org/document/7881967
...
- **Status**: ❌
- **Reason**: Joint Viterbi Detector Decoder(트렐리스 검출/복호) — LDPC BP 아님, ISI 채널 검출 기법으로 이식 불가
- **ID**: ieee:7843343
- **Type**: conference
- **Published**: 2016
- **Authors**: V. J. Alappat, M. Motani, C. K. Sann
...
- **Status**: ❌
- **Reason**: polar code LSC 디코더 HW, polar 전용 SC 구조라 바이너리 LDPC BP에 비의존적 이식 불가
- **ID**: ieee:7539091
- **Type**: conference
- **Published**: 2016
- **Authors**: T. Che, J. Xu, G. Choi
- **PDF**: https://ieeexplore.ieee.org/document/7539091
- **Abstract**: This paper presents an efficient hardware design approach for list successive cancellation (LSC) decoding of polar codes. By applying path-overlapping scheme, for LSC with list size l (l > 1), the l instances of successive cancellation (SC) decoder can be cut down to only one. This results in a dramatic reduction of the hardware complexity without any decoding performance loss. We also develop novel approaches to reduce the latency associated with the pipeline scheme. Simulation results show that with proposed design approach the hardware efficiency is increased significantly over the recently proposed LSC decoders.

## 96-GBaud Coded 8-Dimensional 16QAM Transmission over 5,252 km Using Iterative Soft-Output Decoding

- **Status**: ❌
- **Reason**: 8D-16QAM coded modulation 광전송 데모, 부호 비의존 디코더 기여 없음
- **ID**: ieee:7767654
- **Type**: conference
- **Published**: 2016
- **Authors**: M. Nakamura, F. Hamaoka, A. Matsushita +6
- **PDF**: https://ieeexplore.ieee.org/document/7767654
- **Abstract**: We propose novel coded 8-dimensional 16QAM demonstrating 576-Gbps transmission over 5,252km. At the same spectral efficiency, 8D-16QAM using iterative soft output decoding can expand the transmission reach by 1,212km compared to conventional PDM-8QAM.

## Error characterization of underwater acoustic channels based on the simple Fritchman model

- **Status**: ❌
- **Reason**: 수중음향 채널 Fritchman 버스트오류 모델링, 디코더/코드설계 기여 없음
- **ID**: ieee:7753714
- **Type**: conference
- **Published**: 2016
- **Authors**: Xin Zhang, Xiaoji Zhang
- **PDF**: https://ieeexplore.ieee.org/document/7753714
...
- **Status**: ❌
- **Reason**: 우주 광통신 CCSDS FEC 시뮬레이션, 변조 내성 분석뿐 — 떼어낼 LDPC 디코더/HW/코드설계 기법 없음
- **ID**: ieee:7573919
- **Type**: conference
- **Published**: 2016
- **Authors**: A. Burton, Z. Ghassemlooy, P. -D. Arapoglou
- **PDF**: https://ieeexplore.ieee.org/document/7573919
...
- **Status**: ❌
- **Reason**: MIMO용 polar 부호 분극, 비-LDPC이며 polar 전용, 이식할 BP 기법 없음
- **ID**: ieee:7556056
- **Type**: conference
- **Published**: 2016
- **Authors**: M. Diouf, I. Diop, I. Dioum +3
- **PDF**: https://ieeexplore.ieee.org/document/7556056
...
- **Status**: ❌
- **Reason**: polar SCL 디코더 stage-located copy로 polar 전용, 바이너리 LDPC BP에 이식 불가
- **ID**: ieee:7868521
- **Type**: conference
- **Published**: 2016
- **Authors**: Y. Shen, C. Zhang, J. Yang +2
- **PDF**: https://ieeexplore.ieee.org/document/7868521
...
- **Status**: ❌
- **Reason**: Polar CA-SCL 디코더(distributed sorting/folding) — 비-LDPC, 부호 비의존 BP 이식 기법 아님(SCL 전용 정렬·folding)
- **ID**: ieee:7841865
- **Type**: conference
- **Published**: 2016
- **Authors**: X. Liang, J. Yang, C. Zhang +2
- **PDF**: https://ieeexplore.ieee.org/document/7841865
- **Abstract**: For polar codes, cyclic redundancy check (CRC)aided successive cancellation list (CA-SCL) decoder has attracted increasing attention from both academia and industry. In this paper, a hardware efficient and low-latency CA-SCL polar decoder based on distributed sorting is first proposed. For path metric (PM) sorting of each level, a distributed sorting (DS) algorithm is proposed to reduce the comparison complexity from (L2) to (L) (L denotes list size), together with the latency from kL2 to kL (k is a coefficient independent of L). Employing folding technique, the N-bit folding polar decoder can be implemented based on the basic √N-bit polar decoder. In addition, pipelining technique is employed to refine the timing issue resulting from folding. The CRC is performed for 2L candidate paths serially to reduce hardware cost. According to demo of (1024, 512) code on Altera Stratix V FPGA, the proposed CA-SCL decoders with L = 2 and adjustable L = 2, 4 consume 9% and 50% board resources, respectively. Decoding latencies (in terms of clock cycles) are 2, 528 and 4, 064, respectively. For L = 2 and 4, we can achieve the frame error rate (FER) of 10-2 at the signal noise ratio (SNR) of 2.36 dB and 2.06 dB, respectively. Compared with the floating point results, the performance degradation is negligible. Thus, the proposed design is suitable and adjustable for different real-life scenarios.

## Irregular Repeat-Accumulate Lattice Network Codes for Two-Way Relay Channels

- **Status**: ❌
- **Reason**: GF(q) 비이진 IRA lattice 네트워크코드 + PNC 응용 — 비이진 LDPC라 제외
- **ID**: ieee:7841918
- **Type**: conference
- **Published**: 2016
- **Authors**: M. Qiu, L. Yang, J. Yuan
- **PDF**: https://ieeexplore.ieee.org/document/7841918
...
- **Status**: ❌
- **Reason**: compute-and-forward 에너지 이득 이론, LDPC 무관
- **ID**: ieee:7541716
- **Type**: conference
- **Published**: 2016
- **Authors**: Z. Ren, J. Goseling, J. H. Weber +1
- **PDF**: https://ieeexplore.ieee.org/document/7541716
...
- **Status**: ❌
- **Reason**: 탄성 광네트워크 적응·모니터링, ECC/LDPC 무관
- **ID**: ieee:7506990
- **Type**: conference
- **Published**: 2016
- **Authors**: F. Cugini, N. Sambo, F. Paolucci +2
- **PDF**: https://ieeexplore.ieee.org/document/7506990
- **Abstract**: In this paper, we provide a comprehensive view of the most advanced techniques and solutions we contributed to design and validate for adaptation operations in Elastic Optical Networks (EONs). Data, control and monitoring aspects are discussed, identifying potentials and open issues, also in the context of challenging multi-vendor/domain scenarios as the case of elastic alien wavelength.

## Multi-dimension coded PAM4 signaling for 100Gb/s short-reach transceivers

- **Status**: ❌
- **Reason**: 4D 코드 PAM4 변조 단거리 전송, FEC 부수 언급, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7537319
- **Type**: conference
- **Published**: 2016
- **Authors**: R. Rios-Müller, J. Renaudier, M. A. Mestre +5
- **PDF**: https://ieeexplore.ieee.org/document/7537319
- **Abstract**: We report on the use of 4-Dimension coded modulation for short-reach interfaces. With low extra complexity, 4D-coded PAM4 enables a performance improvement when associated with low-latency and low-complexity FEC, as demonstrated by experimental results.

## Segmented CRC-Aided SC List Polar Decoding

- **Status**: ❌
- **Reason**: polar SC-list 디코딩(분할 CRC), 부호·디코더 의존적이라 LDPC BP 이식 불가
- **ID**: ieee:7504469
- **Type**: conference
- **Published**: 2016
- **Authors**: H. Zhou, C. Zhang, W. Song +2
- **PDF**: https://ieeexplore.ieee.org/document/7504469
...
- **Status**: ❌
- **Reason**: super-orthogonal convolutional code MUD(SIC/STD), 비-LDPC·검출기 전용
- **ID**: ieee:7511614
- **Type**: conference
- **Published**: 2016
- **Authors**: Y. Hori, H. Ochiai
- **PDF**: https://ieeexplore.ieee.org/document/7511614
...
- **Status**: ❌
- **Reason**: 400G 해저 전송 트랜스폰더 리뷰, FEC 부수 언급, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7537291
- **Type**: conference
- **Published**: 2016
- **Authors**: R. Rios-Müller, J. Renaudier, L. Schmalen +1
- **PDF**: https://ieeexplore.ieee.org/document/7537291
- **Abstract**: We review single-carrier 400 Gb/s transponder design and experiments. Requirements in terms of opto-electronic devices, modulation formats, error correction codes to push the transmission reach beyond transatlantic distances are described.

## Impact of satellite transponder nonlinearities on the performance of protected tactical waveform (PTW) for the return link (RL)

- **Status**: ❌
- **Reason**: 위성 트랜스폰더 비선형성 영향 분석, DVB-S2 FEC는 베이스라인 — 떼어낼 LDPC 기법 없음
- **ID**: ieee:7795334
- **Type**: conference
- **Published**: 2016
- **Authors**: L. K. Nguyen, R. B. Wells, K. D. Pham
- **PDF**: https://ieeexplore.ieee.org/document/7795334
- **Abstract**: This paper examines the impact of satellite transponder nonlinearities on the performance of protected tactical waveform (PTW) for the return link (RL). The performance impact due to adjacent channels interference (ACI) and a partial band noise jammer (PBNJ) are considered in the paper. In this paper, a Shaleh model is used to model the transponder traveling wave tube amplifier (TWTA). This TWTA is protected by a soft limiter to prevent TWTA operation in the saturation region. Impact of signal clipping due to this soft limiter under a PBNJ is also investigated. Computer simulations are performed using Digital Video Broadcasting - Satellite - Second generation (DVB-S2) forward error correcting (FEC) codes. In addition, a ground hub receiver does not assume knowledge of the channel information. Ground hub is required to estimate signal-to-noise ratio (SNR) and details of SNR estimation are also discussed in the paper.

## Range segmentation to improve latency in parallel stochastic computing

- **Status**: ❌
- **Reason**: Stochastic computing 병렬화 latency 개선(MSC); 범용 SC 산술 회로로 LDPC ECC 디코더 기법 아님
- **ID**: ieee:7451071
- **Type**: conference
- **Published**: 2016
- **Authors**: R. Saraiva, J. C. Ruzicki, A. de Souza +1
- **PDF**: https://ieeexplore.ieee.org/document/7451071
...
- **Status**: ❌
- **Reason**: 근사 DRAM 신뢰성 시뮬레이션, LDPC ECC 기법 없음
- **ID**: ieee:7428043
- **Type**: conference
- **Published**: 2016
- **Authors**: M. Jung, D. M. Mathew, C. Weis +1
- **PDF**: https://ieeexplore.ieee.org/document/7428043
...
## Design an optimized hardware implementation of DVB-T2 modules on an FPGA

- **Status**: ❌
- **Reason**: DVB-T2 모듈 FPGA 구현(셀/주파수 인터리버 등), LDPC 디코더 HW 아님
- **ID**: ieee:7470804
- **Type**: conference
- **Published**: 2016
- **Authors**: H. A. Fahmy, K. A. Shehata, S. Gasser
- **PDF**: https://ieeexplore.ieee.org/document/7470804
- **Abstract**: DVB-T2 (The second generation Digital Video Broadcasting) is a system enhancement for the DVB-T system. The cyclic Q delay, cell interleaver and time interleaver are optional modules employed in the DVB-T2 system to increase the overall performance. The cell mapper module is used to build the T2 frames. The frequency interleaver module increases the ability of data recovery when facing channel noise. In this paper we propose a new algorithm that combines these five modules into a single module. The new module is hardware implemented. The results with respect to the current standard show the hardware reduction and hence cutting down the system cost.

## Comparison of modulation formats based on generalized mutual information

- **Status**: ❌
- **Reason**: GMI 기반 변조포맷 비교, ECC 디코더/코드설계 기여 없음
- **ID**: ieee:7537201
- **Type**: conference
- **Published**: 2016
- **Authors**: S. Zhang, F. Yaman, E. Mateo +1
- **PDF**: https://ieeexplore.ieee.org/document/7537201
- **Abstract**: 16QAM is found to achieve the lowest SNR penalty against the Shannon limit at the GMI of 2~3 bits/channel use compared to the analyzed 2- and 4-dim modulation formats. The FEC OSNR limit of 16QAM is measured to require ~1 dB less than 8QAM at the same GMI of 2.4 bits/channel use.

## Sensor-Cloud and Power Line Communication: Recent Developments and Integration

- **Status**: ❌
- **Reason**: Sensor-Cloud/PLC 서베이로 LDPC 무관
- **ID**: ieee:7588863
- **Type**: conference
- **Published**: 2016
- **Authors**: C. Zhu, Y. Huo, V. C. M. Leung +1
- **PDF**: https://ieeexplore.ieee.org/document/7588863
- **Abstract**: Sensor-Cloud (SC) and power line communication (PLC) are attracting growing attention from both academia and industry, by 1) integrating wireless sensor networks and cloud computing and 2) utilizing the power grid infrastructure to perform data transmission, respectively. Aiming to be an enlightening guidance for research about SC and PLC, this paper first reviews SC and PLC, by presenting the recent developments about SC and PLC. Further, this paper explores SC and PLC, by envisioning the applications and advantages of the integration of SC and PLC. We hope our investigations can inspire more research about SC and PLC to make them develop faster and better.

## A practical wireless reciprocity-aware key establishment protocol

- **Status**: ❌
- **Reason**: 무선 채널 비밀키 생성, BCH 기반 reconciliation — 보안/정보조정+비-LDPC, 제외
- **ID**: ieee:7795478
- **Type**: conference
- **Published**: 2016
- **Authors**: S. Ponnaluri, B. Azimi-Sadjadi, Y. -K. Hue +3
- **PDF**: https://ieeexplore.ieee.org/document/7795478
...
## Experimental system for generating DVB-T2 signal based on FPGA board

- **Status**: ❌
- **Reason**: DVB-T2 신호생성 FPGA 실험, LDPC 디코더/코드 기여 없음(신호생성 시스템)
- **ID**: ieee:7521970
- **Type**: conference
- **Published**: 2016
- **Authors**: S. D. You, M. -H. Shen
- **PDF**: https://ieeexplore.ieee.org/document/7521970
- **Abstract**: This paper reports our implementation of an experimental system to generate DB-T2 signal based on a commercial FPGA (Field Programmable Gate Array) board with additional instruments. The baseband OFDM (Orthogonal Frequency Division Multiplexing) samples are computed offline via a C program. The OFDM samples are stored in an SD card for the FPGA board to read. The FPGA board converts the digital samples to analog baseband signal to be modulated by an I/Q modulator. The generated DVB-T2 signal can be successfully decoded by a commercial DVB-T2 receiver card, and thus the experimental system is validated.

## Adaptive transmission algorithms for a hard-switched FSO/RF link

- **Status**: ❌
- **Reason**: FSO/RF 하이브리드 적응 전송 알고리즘 — ECC 부호 기법 아님
- **ID**: ieee:7795440
- **Type**: conference
- **Published**: 2016
- **Authors**: K. Nock, C. Font, M. Rupar
- **PDF**: https://ieeexplore.ieee.org/document/7795440
...
- **Status**: ❌
- **Reason**: ATSC 3.0 주파수 인터리버 성능평가, LDPC ECC 기법 없음
- **ID**: ieee:7521965
- **Type**: conference
- **Published**: 2016
- **Authors**: B. -m. Lim, S. I. Park, J. -y. Lee +3
- **PDF**: https://ieeexplore.ieee.org/document/7521965
- **Abstract**: Advanced Television Systems Committee (ATSC) 3.0 physical layer standard has adopts frequency interleaving scheme to mitigate burst errors caused by frequency selective fading in OFDM systems. In this paper, we briefly present the frequency interleaver of ATSC 3.0 and evaluate the performance on various wireless fading channel conditions.

## Performance evaluation of multiple-PLP based LDM systems for the next generation terrestrial broadcasting

- **Status**: ❌
- **Reason**: 방송용 LDM 다중PLP 성능평가, LDPC 부수언급도 없고 떼어낼 기법 없음
- **ID**: ieee:7521933
- **Type**: conference
- **Published**: 2016
- **Authors**: J. -y. Lee, S. I. Park, S. Kwon +7
- **PDF**: https://ieeexplore.ieee.org/document/7521933
- **Abstract**: In this paper, we present performance evaluation of multiple physical layer pipe (PLP) based layered division multiplexing (LDM) systems for the next generation terrestrial broadcasting. In addition to a conventional multiple-PLP configuration, which is based on time division multiplexing (TDM), a variety of LDM configurations, which includes combinations of TDM and two-layer LDM, and three-layer LDM, are considered. Given three different broadcasting contents are delivered by three PLPs, performance comparison and analysis are provided when four different multiple-PLP configurations including TDM, two-layer LDM, and three-layer LDM are used.

## Efficient implementation of BCH decoders on GPU for flash memory devices using iBMA

- **Status**: ❌
- **Reason**: 플래시용 BCH GPU 디코더(iBMA·Chien); 비LDPC, LDPC BP에 이식 불가
- **ID**: ieee:7430612
- **Type**: conference
- **Published**: 2016
- **Authors**: A. K. Subbiah, T. Ogunfunmi
- **PDF**: https://ieeexplore.ieee.org/document/7430612
- **Abstract**: Recent development and popularity of Flash Memory requires efficient error correction technique on its eco system like gaming and mobile platforms. In this paper, we have addressed an efficient method to decode and correct errors using the parallel computing technique offered by Graphical Processing Unit (GPU). This decoder employs the inversion-less Berleykamp-Massey algorithm (iBMA), and Chein search algorithm to decode the BCH (Bose-Chaudhuri-Hocquenghem) codes. We have devised an engine, on a GPU, that decodes BCH (n=8192, k=4096, t=4) code, and the results have shown that the latency of the decoder is less than the typical read latency of the flash memory device. Further, a comparative analysis of the same engine for different block size and error bits.

## Joint decoding for multiway multirelay networks with coded random access

- **Status**: ❌
- **Reason**: IoT 코드드랜덤액세스 SIC+반복디매핑 — LDPC 채널코드/디코더 기여 없음, 네트워크 throughput 응용
- **ID**: ieee:7581421
- **Type**: conference
- **Published**: 2016
- **Authors**: M. N. Hasan, K. Anwar
- **PDF**: https://ieeexplore.ieee.org/document/7581421
- **Abstract**: The emergence of Internet-of-Thing (IoT) has driven tremendous growth of number of connected devices such that in the near future everything is connected to the networks forming super-dense networks. To cope with this challenge, this paper investigates networks with multiple relays serving massive number of devices (users), termed as multiway multirelay (MWMR) networks. Coded random access is adopted to simplify the transmission involving massive number of users. Iterative demapping (IDM) algorithm is proposed to be incorporated into successive interference cancellation (SIC) of random access decoding to significantly improve the network throughput. The relays employ modern decode-and-forward (mDF) protocol allowing the relays to keep forwarding (broadcasting) the decoded messages even though error is detected. To take the advantage of messages received from multiple relays, this paper then proposes a joint decoding technique exploiting source correlation of the messages to reduce the required transmit power and improve the network throughput. It is shown that the proposed techniques reduces bit-error-rate (BER) floor to the level below 10-5. Moreover, with Λa (x), more than two times throughput improvement is achieved using the proposed techniques. We also confirm that K = 2 relays is the practical optimal number of relays to serve massively distributed users in MWMR networks.

## An optical receiver for science measurements and data detection

- **Status**: ❌
- **Reason**: 광통신 수신기 PPM 검출, ECC와 무관
- **ID**: ieee:7500711
- **Type**: conference
- **Published**: 2016
- **Authors**: D. Divsalar, S. Asmar, W. Farr +2
- **PDF**: https://ieeexplore.ieee.org/document/7500711
- **Abstract**: In the era of optical communications, the currently available optical system does not provide the required observations to extract the proper measurements for optical science experiments. Science investigations should utilize the optical telecommunication links between spacecraft and Earth to examine changes in the phase, frequency, amplitude, and polarization of radio signals to investigate planetary atmospheres, planetary rings, planetary surfaces, planetary interiors, solar corona and wind, comet mass flux, and fundamental physics. The proposed system in this paper provides an architectural improvement to the present state of the art optical communication systems utilized by NASA. In this paper we develop an optical receiver to provide amplitude, phase, and Doppler frequency for optical Science measurements in addition to detecting Pulse Position Modulation (PPM) signals. Currently available direct detection PPM does not provide these features. First we propose how to construct an optical receiver with mirrors, splitters, and photon counting detectors that produce in-phase and quadrature components. We analyze the performance of proposed optical system for PPM. The paper provides derivations, and analysis of proposed optical receiver. The innovations are methods to extract phase, Doppler frequency from PPM intensity modulated optical signal. We demonstrate how the receiver can detect the PPM data and at the same time provide phase information for science measurements. Numerical results are provided for the proposed optical receiver.

## Sneak-Peek: High speed covert channels in data center networks

- **Status**: ❌
- **Reason**: 데이터센터 covert channel 코딩으로 채널 ECC가 아닌 정보은닉, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7524467
- **Type**: conference
- **Published**: 2016
- **Authors**: R. Tahir, M. T. Khan, X. Gong +6
- **PDF**: https://ieeexplore.ieee.org/document/7524467
...
## Chaotic filter bank based computer cryptograpic system for wireless applications

- **Status**: ❌
- **Reason**: 무선 카오스 암호 시스템; 표준 LDPC를 한 블록으로 사용할 뿐 새 기법 없음, 보안/무선 도메인
- **ID**: ieee:7793543
- **Type**: conference
- **Published**: 2016
- **Authors**: Shuang Li, Nili Tian, Xiao-Zhi Zhang +3
- **PDF**: https://ieeexplore.ieee.org/document/7793543
- **Abstract**: This paper proposes a chaotic filter bank based computer cryptographic system for wireless applications. The signal is first decomposed via an analysis filter bank. Second, a pair of chaotic modulators is employed for performing the encryption on the subband signals. Third, the encrypted signals are upsampled and filtered so as to obtain the oversampled signals. Fourth, the oversampled signals are quantized via a multi-dimensional sigma delta modulator. Fifth, the quantized signals are encoded via a low density parity check code scheme. The encoded signals are transmitted via a wireless channel. At the receiver side, first the encoded signals are decoded via a low density parity check decoder. Then, a multi-dimensional filter is employed for separating the signals and the quantization noises. Next, the filtered signals are downsampled to obtain the same number of samples. After that, a pair of chaotic demodulators is employed for performing the decryption. Finally, a synthesis filter bank is used to reconstruct the original signal. In this paper, the filters in both the filter bank system and the multidimensional sigma delta modulator are designed. Computer numerical simulation results show that the proposed system outperforms the existing computer cryptographic systems.

## Design and Assessment of a CE-OFDM-Based mm-Wave 5G Communication System

- **Status**: ❌
- **Reason**: CE-OFDM mm-Wave 5G 시스템 + trellis-coded modulation — 무선응용, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7848876
- **Type**: conference
- **Published**: 2016
- **Authors**: C. Sacchi, T. F. Rahman, N. Bartolomei +3
- **PDF**: https://ieeexplore.ieee.org/document/7848876
- **Abstract**: In this paper, we propose and assess an mm-Wave communication system that is based on the use of constant-envelope multicarrier modulation format, namely Constant-Envelope OFDM (CE-OFDM): particularly, in order to establish a preliminary assessment of the affordable performance, we propose and design a SIW slotted array with a squared cosecant pattern at 73 GHz; moreover, we consider only single-user very high data-rate transmissions and two scenarios, namely, the small cell downlink and the so called "information shower". Simulation results, related to LOS downlink transmission in 73 GHz channel, will consider link performance in terms of bit-error- rate and packet-error-rate in a LOS channel and prove that CE-OFDM, used with trellis-coded modulations, can offer interesting performance results in terms of robustness and coverage.

## Distributed Low-Density Lattice Codes

- **Status**: ❌
- **Reason**: 분산 LDLC(Low-Density Lattice Codes) - lattice 부호로 바이너리 LDPC 아님, NAND 이식 불가
- **ID**: ieee:7317728
- **Type**: journal
- **Published**: 2016
- **Authors**: B. Chen, D. N. K. Jayakody, M. F. Flanagan
- **PDF**: https://ieeexplore.ieee.org/document/7317728
...
- **Status**: ❌
- **Reason**: Hyperbolic surface code 양자 부호 구성; 양자 전용 개념(스태빌라이저/곡면) 의존, 고전 바이너리 LDPC 이식 불가
- **ID**: ieee:7456305
- **Type**: journal
- **Published**: 2016
- **Authors**: N. P. Breuckmann, B. M. Terhal
- **PDF**: https://ieeexplore.ieee.org/document/7456305
...
- **Status**: ❌
- **Reason**: Turbo product code 서베이, 비-LDPC 부호이며 신규 LDPC 기여 없음
- **ID**: ieee:7505623
- **Type**: journal
- **Published**: 2016
- **Authors**: H. Mukhtar, A. Al-Dweik, A. Shami
- **PDF**: https://ieeexplore.ieee.org/document/7505623
- **Abstract**: Turbo product codes (TPCs) have been integrated in several practical applications, and hence, they have been considered widely in the literature where the main aim is improving the error performance and/or reducing the computational and implementation complexity. This paper presents a comprehensive survey of the research that focuses on TPCs in terms of encoding, decoding, error performance, and complexity. Moreover, this paper also considers the advantages of integrating TPCs in hybrid automatic repeat request systems where power optimization becomes very efficient and the complexity can be reduced using the unique properties of TPCs such as error self-detection capabilities. Based on the surveyed literature, the pivotal open research issues in TPCs are presented and discussed.

## Ultra Low Density Spread Transmission

- **Status**: ❌
- **Reason**: ULDS 다중접속 전송/MUD 기법, 무선 응용 특이적이며 이식할 LDPC ECC 기법 없음
- **ID**: ieee:7466115
- **Type**: journal
- **Published**: 2016
- **Authors**: A. R. Safavi, A. G. Perotti, B. M. Popović
- **PDF**: https://ieeexplore.ieee.org/document/7466115
- **Abstract**: Ultra low density spread (ULDS) transmission scheme, allowing simultaneous and efficient usage of given time-frequency resources by multiple users, is presented and evaluated. The scheme is based on the special sets of LDS signatures that eliminate the need for iterative multi-user detector (MUD) in the receiver and dramatically improves reception performances, both without and with error correction codes. The ULDS transmission is particularly beneficial when the outer loop feedback to MUD is used in the receiver.

## FEC Code Anchored Robust Design of Massive MIMO Receivers

- **Status**: ❌
- **Reason**: Massive MIMO QP 수신기에 FEC 코드 제약 활용 — FEC는 범용 앵커, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7576676
- **Type**: journal
- **Published**: 2016
- **Authors**: K. Wang, Z. Ding
...
- **Status**: ❌
- **Reason**: 광 네트워크 QoS·에너지 스케줄링; LDPC ECC 기법 없음
- **ID**: ieee:7405175
- **Type**: journal
- **Published**: 2016
- **Authors**: H. Khodakarami, B. S. G. Pillai, W. Shieh
- **PDF**: https://ieeexplore.ieee.org/document/7405175
...
- **Status**: ❌
- **Reason**: 네트워크 코딩+협력통신 튜토리얼/서베이, LDPC ECC로 떼어낼 신규 디코더·HW 기법 없음
- **ID**: ieee:7464271
- **Type**: journal
- **Published**: 2016
- **Authors**: S. Tedik Başaran, G. Karabulut Kurt, M. Uysal +1
- **PDF**: https://ieeexplore.ieee.org/document/7464271
...
- **Status**: ❌
- **Reason**: coherent optical transceiver ASIC 튜토리얼, FEC가 부수 언급일 뿐 신규 LDPC 디코더/HW 기여 없음
- **ID**: ieee:7210138
- **Type**: journal
- **Published**: 2016
- **Authors**: D. A. Morero, M. A. Castrillón, A. Aguirre +2
- **PDF**: https://ieeexplore.ieee.org/document/7210138
...
- **Status**: ❌
- **Reason**: 스마트시티 비디오 브로드캐스팅 서베이/응용, FEC 부수언급, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7349100
- **Type**: journal
- **Published**: 2016
- **Authors**: B. -W. Chen, W. Ji, F. Jiang +1
- **PDF**: https://ieeexplore.ieee.org/document/7349100
...
- **Status**: ❌
- **Reason**: NVSRAM 셀 회로설계 기반 SEU/MBU 내성 - LDPC ECC 아님, 부호 기법 없음
- **ID**: ieee:7173038
- **Type**: journal
- **Published**: 2016
- **Authors**: W. Wei, K. Namba, Y. -B. Kim +1
- **PDF**: https://ieeexplore.ieee.org/document/7173038
...
- **Status**: ❌
- **Reason**: 유한블록길이 부호 기반 에너지효율 패킷 스케줄링; 순수 이론/최적화로 디코더·HW·구성 이어지지 않음
- **ID**: ieee:7463506
- **Type**: journal
- **Published**: 2016
- **Authors**: S. Xu, T. -H. Chang, S. -C. Lin +2
- **PDF**: https://ieeexplore.ieee.org/document/7463506
...
- **Status**: ❌
- **Reason**: Reed-Solomon PTA 반복 수신기, 비-LDPC 부호이고 RS 전용 PTA로 이식성 없음
- **ID**: ieee:7762081
- **Type**: journal
- **Published**: 2016
- **Authors**: O. O. Ogundile, D. J. J. Versfeld
- **PDF**: https://ieeexplore.ieee.org/document/7762081
...
- **Status**: ❌
- **Reason**: embedded SG-MONOS 플래시 매크로 회로/공정 설계, ECC·LDPC 무관
- **ID**: ieee:7265102
- **Type**: journal
- **Published**: 2016
- **Authors**: Y. Taito, T. Kono, M. Nakano +5
- **PDF**: https://ieeexplore.ieee.org/document/7265102
...
- **Status**: ❌
- **Reason**: 전력선통신(PLC) 전반 서베이, 구체적 LDPC 디코더·구성·HW 신규 기여 없음
- **ID**: ieee:7467440
- **Type**: journal
- **Published**: 2016
- **Authors**: C. Cano, A. Pittolo, D. Malone +3
- **PDF**: https://ieeexplore.ieee.org/document/7467440
...
- **Status**: ❌
- **Reason**: 2D 자기기록 검출기/헤드어레이가 핵심, 바이너리 LDPC는 표준 길이 확장만 언급(새 기여 없음)
- **ID**: ieee:7368942
- **Type**: journal
- **Published**: 2016
- **Authors**: Y. Wang, B. Yuan, K. K. Parhi
- **PDF**: https://ieeexplore.ieee.org/document/7368942
...
- **Status**: ❌
- **Reason**: ATSC 3.0 LDM 송수신 구조, 무선 멀티플렉싱 응용으로 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7329951
- **Type**: journal
- **Published**: 2016
- **Authors**: S. I. Park, J. -Y. Lee, S. Myoung +9
- **PDF**: https://ieeexplore.ieee.org/document/7329951
...
- **Status**: ❌
- **Reason**: massive MU-MIMO 가우시안 메시지패싱 검출기 수렴분석, MIMO 검출 특이적이며 LDPC BP 디코더로 이식 불가
- **ID**: ieee:7501561
- **Type**: journal
- **Published**: 2016
- **Authors**: L. Liu, C. Yuen, Y. L. Guan +2
- **PDF**: https://ieeexplore.ieee.org/document/7501561
...
- **Status**: ❌
- **Reason**: ATSC 3.0 MIMO 성상 무선 응용, LDPC ECC 기법 없음
- **ID**: ieee:7383279
- **Type**: journal
- **Published**: 2016
- **Authors**: D. Gómez-Barquero, D. Vargas, M. Fuentes +5
- **PDF**: https://ieeexplore.ieee.org/document/7383279
...
- **Status**: ❌
- **Reason**: 광통신 QAM 슈퍼채널 장거리 전송 실험; FEC는 단순 임계 언급, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7463011
- **Type**: journal
- **Published**: 2016
- **Authors**: T. Rahman, D. Rafique, B. Spinnler +17
- **PDF**: https://ieeexplore.ieee.org/document/7463011
...
- **Status**: ❌
- **Reason**: 60GHz 무선통신 서베이 — LDPC 기법 없음
- **ID**: ieee:7613187
- **Type**: journal
- **Published**: 2016
- **Authors**: T. Yilmaz, O. B. Akan
- **PDF**: https://ieeexplore.ieee.org/document/7613187
...
- **Status**: ❌
- **Reason**: 양자화 가우시안 노이즈 생성 FPGA, ECC 디코더/코드설계가 아닌 시뮬레이션용 노이즈 생성기
- **ID**: ieee:7491345
- **Type**: journal
- **Published**: 2016
- **Authors**: J. Choi, J. Jung, I. -C. Park
- **PDF**: https://ieeexplore.ieee.org/document/7491345
...
- **Status**: ❌
- **Reason**: RCM용 비선형 성상 매핑/PAPR 무선 응용, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7353142
- **Type**: journal
- **Published**: 2016
- **Authors**: R. Duan, R. Liu, M. Shirvanimoghaddam +2
- **PDF**: https://ieeexplore.ieee.org/document/7353142
...
- **Status**: ❌
- **Reason**: Vector quantization 압축용 stochastic 회로 설계; 소스코딩/압축이며 LDPC ECC 디코더·구성 기법 없음
- **ID**: ieee:7437471
- **Type**: journal
- **Published**: 2016
- **Authors**: R. Wang, J. Han, B. F. Cockburn +1
- **PDF**: https://ieeexplore.ieee.org/document/7437471
...
- **Status**: ❌
- **Reason**: ATSC 3.0 LDM 방송 성능평가, 떼어낼 LDPC 디코더/코드설계 기법 없음
- **ID**: ieee:7378930
- **Type**: journal
- **Published**: 2016
- **Authors**: C. Regueiro, J. Montalban, J. Barrueco +7
- **PDF**: https://ieeexplore.ieee.org/document/7378930
...
- **Status**: ❌
- **Reason**: 인지무선 재밍·보안 자원할당; LDPC ECC 무관
- **ID**: ieee:7420660
- **Type**: journal
- **Published**: 2016
- **Authors**: M. Soysa, P. C. Cosman, L. B. Milstein
- **PDF**: https://ieeexplore.ieee.org/document/7420660
...
- **Status**: ❌
- **Reason**: SC-LDPC density evolution(RCA+가우스근사) 임계값 분석 — 디코더/HW/구성으로 안 이어지는 이론 분석
- **ID**: ieee:7433602
- **Type**: conference
- **Published**: 20-22 Jan.
...
- **Status**: ❌
- **Reason**: 광 eU-OFDM SIC용 인코딩-디코딩 구조; 무선/광 응용 특이적, 바이너리 LDPC BP 이식 기법 없음
- **ID**: ieee:7433670
- **Type**: conference
- **Published**: 20-22 Jan.
...
- **Status**: ❌
- **Reason**: FSO 저지연 코드성능 bound 분석; LDPC는 예시, 순수 이론 bound, 떼어낼 디코더/구성 없음
- **ID**: ieee:7433601
- **Type**: conference
- **Published**: 20-22 Jan.
...
- **Status**: ❌
- **Reason**: CVQKD reconciliation용 QC-RA 코드; QKD 정보조정+비-LDPC, 떼어낼 디코더/HW 기법 없음
- **ID**: ieee:7433603
- **Type**: conference
- **Published**: 20-22 Jan.
...
- **Status**: ❌
- **Reason**: BICM 신호 shaping/constellation labeling — 변조 기법, LDPC ECC 기법 아님
- **ID**: ieee:7433671
- **Type**: conference
- **Published**: 20-22 Jan.
...
- **Status**: ❌
- **Reason**: VLC용 short NBLDPC 블록 마르코프 중첩전송 — 비이진 LDPC 기반, 제외
- **ID**: ieee:7491294
- **Type**: journal
- **Published**: 15 Sept.15
- **Authors**: Shancheng Zhao, Xiao Ma
...
- **Status**: ❌
- **Reason**: 광 WDM 확률적 16-QAM shaping, LDPC는 부수 적용 — 떼어낼 ECC 기법 없는 통신 응용
- **ID**: ieee:7523228
- **Type**: journal
- **Published**: 15 Sept.15
...
- **Status**: ❌
- **Reason**: 광 무중계 전송·증폭맵 최적화, 떼어낼 ECC 기법 없음
- **ID**: ieee:7514963
- **Type**: journal
- **Published**: 15 Oct.15,
...
- **Status**: ❌
- **Reason**: 60GHz RoF 빔포밍 실험, LDPC/ECC 언급 없음 (무선 응용 특이)
- **ID**: ieee:7448364
- **Type**: journal
- **Published**: 15 Oct.15,
...
- **Status**: ❌
- **Reason**: 확률 성형(constellation shaping)·turbo BICM, 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:7563861
- **Type**: journal
- **Published**: 15 Nov.15,
...
- **Status**: ❌
- **Reason**: 코히어런트 수신기 설계(이퀄라이저/위상추정), ECC 기법 없음
- **ID**: ieee:7384692
- **Type**: journal
...
- **Status**: ❌
- **Reason**: 광 신호 오버랩 전송 기법, LDPC 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:7469317
- **Type**: journal
- **Published**: 15 July15,
...
- **Status**: ❌
- **Reason**: soft-decision FEC limit 패러다임/GMI 예측 이론, 디코더·HW·구성으로 안 이어짐
- **ID**: ieee:7406824
- **Type**: journal
- **Published**: 15 Jan.15,
...
- **Status**: ❌
- **Reason**: TTCM vs BICM LDPC 정보이론적 성능 비교, 신규 디코더·구성·HW 없음
- **ID**: ieee:7742908
- **Type**: journal
- **Published**: 15 Dec.15,
...
- **Status**: ❌
- **Reason**: 표준 LDPC 인코더(하삼각 변형) FPGA 면적 비교, 새 디코더/구성 없는 표준 기법 재사용
- **ID**: ieee:7508190
- **Type**: conference
- **Published**: 14-15 Jan.
...
- **Status**: ❌
- **Reason**: VLC용 convolutional-Miller 연접부호+BCJR; 비-LDPC 부호이며 trellis 기반이라 BP 이식 불가
- **ID**: ieee:7397916
- **Type**: journal
- **Published**: 1 May1, 20
...
- **Status**: ❌
- **Reason**: 광통신 4D 채널분포 achievable rate 실험; 순수 정보율 분석, LDPC ECC 기법 없음
- **ID**: ieee:7404211
- **Type**: journal
- **Published**: 1 May1, 20
...
- **Status**: ❌
- **Reason**: 광전송 증폭/DBP 비선형 보상; LDPC는 AIR 검증에 부수 언급, 떼어낼 디코더/구성 기법 없음
- **ID**: ieee:7389964
- **Type**: journal
- **Published**: 1 May1, 20
...
- **Status**: ❌
- **Reason**: VLC용 soft RLL 디코딩+RS 디코더; 비-LDPC이고 RLL/RS 전용 soft 기법, BP 이식 대상 아님
- **ID**: ieee:7302045
- **Type**: journal
- **Published**: 1 Feb.1, 2
...
- **Status**: ❌
- **Reason**: 광통신 probabilistic shaping 64-QAM 실험; FEC 고정, LDPC 디코더/구성 신규 기여 없음
- **ID**: ieee:7360102
- **Type**: journal
- **Published**: 1 April1, 

...
- **Status**: ❌
- **Reason**: BICM 인터리버(VDMM) 매핑 최적화로 무선/변조 응용 특이적. 떼어낼 NAND LDPC ECC 기법 없음
- **ID**: ieee:6777400
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: Non-binary LDPC 디코더(symbol flipping) — 비이진 LDPC는 제외 대상
- **ID**: ieee:6787156
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: 바이오메트릭/PUF용 code offset method 보안 helper data 스킴. 채널 ECC 아님, 보안 제외
- **ID**: ieee:6798816
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: 채널 부호 블라인드 인식(syndrome posterior probability) — ECC 디코딩이 아니라 코드 식별, 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:6816517
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: 릴레이 네트워크 코딩 1비트 soft forwarding 프로토콜. LDPC는 부수 언급, 무선 응용 특이적
- **ID**: ieee:6783947
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: Polar 코드 디코더 알고리즘/HW(SC 기반)로 LDPC BP에 이식 불가한 비-LDPC 부호 — 원칙 제외
- **ID**: ieee:6804939
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: Polar 코드 soft-output 디코더; polar 전용 구조로 LDPC BP 이식성 없음 — 비-LDPC 부호 제외
- **ID**: ieee:6804940
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: Polar+비이진 RS 연접 부호 및 전용 디코딩 — 비-LDPC·비이진, LDPC BP 이식 기법 없음
- **ID**: ieee:6816518
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: 신경망 클리크 기반 sparse 메시지 저장(연상메모리) — LDPC ECC 아님, 디코더 이식 불가
- **ID**: ieee:6658945
- **Type**: journal
- **Published**: May 2014
...
- **Status**: ❌
- **Reason**: ECG 신호 UEP를 위해 서로 다른 rate LDPC 적용 — LDPC를 베이스라인으로 쓴 응용, 떼어낼 신규 디코더/구성/HW 기법 없음.
- **ID**: ieee:6845613
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Turbo-code lossless source compression; source coding, not channel ECC, no portable LDPC decoder technique
- **ID**: ieee:6842493
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 도시 GNSS 환경 soft-input 디코더 입력(LLR/검출함수) 적응 — 채널검출 일반론, LDPC BP는 부수 언급, NAND 특화 이식 기법 없음
- **ID**: ieee:6851419
- **Type**: conference
...
- **Status**: ❌
- **Reason**: QZSS 신호 인증(스푸핑 방지)에 LDPC를 시그니처 용도로 사용 — 채널 ECC가 아닌 보안/인증 응용, 떼어낼 기법 없음
- **ID**: ieee:6851394
- **Type**: conference
- **Published**: 5-8 May 20
...
- **Status**: ❌
- **Reason**: Polar code FEC — 비-LDPC 부호, 떼어낼 LDPC BP 이식 기법 없음
- **ID**: ieee:6839983
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 비이진 LDPC FFT-SPA FPGA 디코더 — 비이진 LDPC는 제외 대상
- **ID**: ieee:6853936
- **Type**: conference
...
- **Status**: ❌
- **Reason**: CPM 결합 LDPC 점근 설계(EXIT/Gaussian approx) — CPM 변조 특화, 떼어낼 NAND 이식 코드설계 없음
- **ID**: ieee:6854408
- **Type**: conference
- **Published**: 4-9 May 20
...
- **Status**: ❌
- **Reason**: LDPC '인코딩'용 TTA 프로세서 가속기 — 디코더/코드설계 기여 없고 SDR 인코딩 특이적
- **ID**: ieee:6855236
- **Type**: conference
- **Published**: 4-9 May 20
...
- **Status**: ❌
- **Reason**: rank/sparsity 제약 메트릭 학습 — ECC·LDPC 무관, 신호처리 일반
- **ID**: ieee:6853550
- **Type**: conference
- **Published**: 4-9 May 20
...
- **Status**: ❌
- **Reason**: FER 예측 추정기 — 디코더·HW·코드설계 기여 아님, 시스템 레벨 성능 추정
- **ID**: ieee:6853935
- **Type**: conference
- **Published**: 4-9 May 20
...
- **Status**: ❌
- **Reason**: BCC 보안채널용 UEP LDPC 전송설계 — 보안 응용 특이적, 새 디코더/구성 기여 없음
- **ID**: ieee:6845079
- **Type**: conference
...
- **Status**: ❌
- **Reason**: MC-CDMA 이미지 전송 BER 성능평가; LDPC 무관, 통신 응용 특이적
- **ID**: ieee:6866742
- **Type**: conference
- **Published**: 29-31 May 
...
- **Status**: ❌
- **Reason**: 2-bit LLR representation in VN processor of NB-LDPC decoder; non-binary LDPC, excluded
- **ID**: ieee:6991185
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Near-ML non-iterative decoding of short non-binary LDPC codes; non-binary LDPC, excluded
- **ID**: ieee:6991187
- **Type**: conference
- **Published**: 29 April-1
...
- **Status**: ❌
- **Reason**: 비이진(nonbinary GF(q)) LDPC 스킴 — 기준상 비이진 LDPC는 제외
- **ID**: ieee:6849016
- **Type**: conference
- **Published**: 27-30 May 
...
- **Status**: ❌
- **Reason**: 무선 충돌/간섭관리 코딩, 채널 ECC 디코더/구성 기법 없음
- **ID**: ieee:6848202
- **Type**: conference
...
- **Status**: ❌
- **Reason**: rateless 코드 기반 멀티캐스트 스케줄링, LDPC 아님이며 떼어낼 ECC 기법 없음
- **ID**: ieee:6848104
- **Type**: conference
- **Published**: 27 April-2
...
- **Status**: ❌
- **Reason**: 표준 LDPC의 채널별 BER 시뮬레이션 분석만, 신규 디코더/구성/HW 기여 없음
- **ID**: ieee:6859553
- **Type**: conference
- **Published**: 26-30 May 
...
- **Status**: ❌
- **Reason**: DVB-T2 L1용 punctured LDPC 디코더 구현, 표준 부호 단순 구현 보고 — 신규 디코더/HW 기여 없음
- **ID**: ieee:6904098
- **Type**: conference
- **Published**: 26-28 May 
...
- **Status**: ❌
- **Reason**: Polar+RS 연접 부호; BEC 대상이고 LDPC는 비교 베이스라인일 뿐, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:6999836
- **Type**: conference
- **Published**: 20-22 May 
...
- **Status**: ❌
- **Reason**: LDPC-coded MIMO-OFDM의 IQ imbalance/CFO 보정; LDPC는 베이스라인, 떼어낼 ECC 기법 없음(무선 특이)
- **ID**: ieee:6999749
- **Type**: conference
- **Published**: 20-22 May 
...
- **Status**: ❌
- **Reason**: 네트워크코딩 HARQ 통신 응용 특이적, 떼어낼 일반 LDPC BP 기법 없음
- **ID**: ieee:7022961
- **Type**: conference
- **Published**: 18-21 May 
...
- **Status**: ❌
- **Reason**: 비이진 q-ary LDPC + MIMO 검출 결합 설계, 바이너리 LDPC 아님이라 제외
- **ID**: ieee:7022876
- **Type**: conference
- **Published**: 18-21 May 
...
- **Status**: ❌
- **Reason**: BCH 2비트 정정 ECC(비-LDPC), PCM용 — LDPC BP로 이식 불가, 원칙 제외
- **ID**: ieee:6849370
- **Type**: conference
- **Published**: 18-21 May 
...
- **Status**: ❌
- **Reason**: RaptorQ fountain code 보안 공격/방어, FEC 보안 — LDPC ECC 기법 아님, 제외
- **ID**: ieee:6956584
- **Type**: conference
- **Published**: 18-21 May 
...
- **Status**: ❌
- **Reason**: 위상추정 Cramer-Rao bound 순수 이론, 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:7022915
- **Type**: conference
- **Published**: 18-21 May 
...
- **Status**: ❌
- **Reason**: 간섭 변조분류 통신 응용, LDPC ECC와 무관
- **ID**: ieee:7022962
- **Type**: conference
- **Published**: 18-21 May 
...
- **Status**: ❌
- **Reason**: turbo MMSE-PIC 수신기 링크적응 MIMO 응용, LDPC 부호 아니고 떼어낼 BP 기법 없음
- **ID**: ieee:7022972
- **Type**: conference
- **Published**: 18-21 May 
...
- **Status**: ❌
- **Reason**: 물리계층 보안용 인공잡음+스크램블링, 보안 응용이며 떼어낼 ECC 디코더/구성 기법 없음
- **ID**: ieee:6913670
- **Type**: conference
- **Published**: 15-17 May 
...
- **Status**: ❌
- **Reason**: FH 재밍 대응, 표준 PEG 구성+표준 sum-product만 사용, 신규 기여 없음
- **ID**: ieee:6913666
- **Type**: conference
- **Published**: 15-17 May 
...
- **Status**: ❌
- **Reason**: FFH/BFSK 재밍 대응에 LDPC 부수 사용, 표준 PEG/SPA만 사용, 떼어낼 신규 기법 없음
- **ID**: ieee:6913657
- **Type**: conference
- **Published**: 15-17 May 
...
- **Status**: ❌
- **Reason**: 고차 Galois Field 비이진 QC-LDPC, 비이진 LDPC는 제외 대상
- **ID**: ieee:6839791
- **Type**: conference
- **Published**: 14-17 May 
...
- **Status**: ❌
- **Reason**: 비이진(non-binary GF(q)) LDPC 가변율 shortening, 비이진 LDPC는 제외 대상
- **ID**: ieee:6839769
- **Type**: conference
- **Published**: 14-17 May 
...
- **Status**: ❌
- **Reason**: QKD 키 reconciliation으로 채널 ECC가 아님, 단 LDPC bit-flipping syndrome decoding의 FPGA 저복잡도 HW 기법은 경계선이나 정보조정 맥락이라 원칙 제외
- **ID**: ieee:6839886
- **Type**: conference
- **Published**: 14-17 May 
...
- **Status**: ❌
- **Reason**: Reed-Solomon 기반 물리계층 네트워크 코딩(무선 다중릴레이) — 비-LDPC 부호, 떼어낼 BP 디코더 기법 없음
- **ID**: ieee:6843206
- **Type**: conference
- **Published**: 14-16 May 
...
- **Status**: ❌
- **Reason**: 인지무선 안티재밍 하이브리드 FEC(재전송 제거)로 LDPC ECC 기법 아님, 이식 가능 기법 없음
- **ID**: ieee:6838733
- **Type**: conference
- **Published**: 13-16 May 
...
- **Status**: ❌
- **Reason**: 무선 분산저장용 space-time storage code(네트워크/물리계층 cross-layer); LDPC ECC 기법 아님
- **ID**: ieee:6934407
- **Type**: conference
- **Published**: 11-14 May 

...
- **Status**: ✅
- **Reason**: QC-LDPC 블록/convolutional 코드 GPU 디코더 아키텍처, 병렬화·메시지 패킹 최적화 — 이식 가능 HW/병렬화 (D)
- **ID**: ieee:6470607
- **Type**: journal
...
- **Status**: ❌
- **Reason**: 중첩변조용 디코딩, 시스템을 비이진 LDPC로 취급한 joint 디코딩 — 변조 결합/비이진 처리라 바이너리 LDPC BP 이식 기법 아님
- **ID**: ieee:6784553
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ✅
- **Reason**: non-refresh eDRAM 기반 저전력 고처리율 LDPC 디코더 HW — D(이식 가능 HW 아키텍처), 메모리 접근 최적화 기법 NAND ECC HW에 이식 가능
- **ID**: ieee:6736117
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: LDPC-RS 곱부호 + RS 하드결정 결합 'turbo-like' 디코딩 — RS 의존적 결합기법이라 바이너리 LDPC BP에 그대로 이식 불가, 비-LDPC 결합부호
- **ID**: ieee:6678727
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: 사회망 노드 중심성(HIC) 메시지패싱 — ECC와 무관, 그래프 영향력 계산용
- **ID**: ieee:6733262
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: Raptor 코드(비-LDPC fountain) 설계, BIAWGN 레이트 최적화로 떼어낼 바이너리 LDPC BP 기법 없음
- **ID**: ieee:6784554
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: 유한체 확산 MAC + GF(64) 비이진 LDPC — 비이진 LDPC이고 다중접속 응용 특이적
- **ID**: ieee:6725575
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: OFDM 임펄스 노이즈 추정/제거 압축센싱 — 무선 응용 특이적, LDPC ECC 기법 없음
- **ID**: ieee:6742716
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: 소셜 네트워크 노드 중심성(HIC) 메시지패싱; ECC와 무관
- **ID**: ieee:6732931
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: TTCM 기반 분산소스코딩(DSC), 소스압축+터보 — LDPC 아니고 ECC 디코더 기법 없음
- **ID**: ieee:6697844
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: Turbo 디코더용 simplified Log-MAP(max* 근사) — turbo 전용, BP min-sum과 다른 trellis 기반이라 LDPC 이식성 약함; 비-LDPC 제외
- **ID**: ieee:6607183
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: 물리계층 보안 PRNG 공격 — 보안 도메인, 코셋 인코딩 강건성, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:6730892
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: 비이진 뉴런 연상메모리 학습/회상 알고리즘 — 채널 ECC LDPC 디코더가 아니고 떼어낼 바이너리 LDPC 기법 없음
- **ID**: ieee:6634278
- **Type**: journal
- **Published**: March 2014
...
- **Status**: ❌
- **Reason**: 광통신 CO-OFDM용 LLR 메트릭 — 채널 특이적 LLR 유도일 뿐 NAND LDPC에 이식할 디코더/코드 기법 없음, LDPC는 부수 언급
- **ID**: ieee:6887151
- **Type**: conference
...
- **Status**: ✅
- **Reason**: staircase rate-adaptive LDPC로 코딩이득 증대 및 error floor 완화 제안 — rate-adaptive 코드설계/error floor 완화 기법이 NAND ECC에 이식 가능성, 애매하여 살림
- **ID**: ieee:6886576
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 광통신 cycle slip 완화 turbo demodulation, NAND에 이식할 LDPC 디코더/코드 기법 없음(채널 특이적)
- **ID**: ieee:6886573
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 64QAM 광전송 DAC 구현+FEC 오버헤드 언급뿐; LDPC ECC 기법 없음
- **ID**: ieee:6886511
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 24D 확장 Golay 코딩 변조 실험 시연, LDPC는 베이스라인이고 떼어낼 바이너리 LDPC 기법 없음
- **ID**: ieee:6886575
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 4D 코딩 변조 achievable rate 연구, LDPC는 검증용 베이스라인일 뿐 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:6886524
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: spatially coupled LDPC 적용 장거리 광전송 시연이나 표준 SC-LDPC 단순 적용, 신규 구성/디코더/HW 기여 없음
- **ID**: ieee:6886980
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: SD-FEC와 차동인코딩 QPSK 결합(변조 결합), 광통신 송수신기 특이적, 떼어낼 LDPC 기법 없음
- **ID**: ieee:6886577
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: flexgrid 네트워크 PCE 아키텍처, LDPC/ECC와 무관
- **ID**: ieee:6886801
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 광통신 FEC 에너지효율 개요(서베이성), 구체적 신규 디코더/구성/HW 기여 없음
- **ID**: ieee:6886571
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 400G DP-8QAM 광전송 실험, LDPC/ECC 신규 기법 없음(전송 시연)
- **ID**: ieee:6886982
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: SDN flexgrid 필터 최적화, LDPC/ECC와 무관
- **ID**: ieee:6886804
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 광통신 변조/검출(constellation expansion, multi-symbol detection) — LDPC ECC와 무관, 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:6887044
- **Type**: conference
- **Published**: 9-13 March
...
- **Status**: ❌
- **Reason**: 비이진(nonbinary) LDPC 디코더 아키텍처 — NAND는 바이너리 LDPC 표준이므로 제외
- **ID**: ieee:6922245
- **Type**: conference
- **Published**: 6-8 March 
...
- **Status**: ✅
- **Reason**: 802.16e용 다중레이트 LDPC 디코더의 컬럼 레이어드 디코딩+병렬 ASIC 아키텍처 — 도메인은 무선이나 떼어낼 HW 디코더 기법(D) 이식 가능
- **ID**: ieee:6922226
- **Type**: conference
- **Published**: 6-8 March 
...
- **Status**: ✅
- **Reason**: 메모리용 ML(majority-logic) 디코딩 가능 LDPC/DC 코드의 영역·시간 절감 HW 구현 — 스토리지 메모리 ECC HW 기여(B/D)
- **ID**: ieee:6926127
- **Type**: conference
- **Published**: 6-8 March 
- **Authors**: S. Baskar
...
- **Status**: ❌
- **Reason**: 양방향 중계용 LDPC 코드 최적화(density evolution+nesting/shortening); 통신 응용 특이적, NAND ECC에 떼어낼 신규 디코더/HW 기법 없음
- **ID**: ieee:6811264
- **Type**: conference
- **Published**: 28 Feb.-2 
...
- **Status**: ✅
- **Reason**: 이식 가능 코드설계(E): rate-compatible LDPC puncturing 개선, absorbing set 기반 — error floor/유한길이 관련 신규 기여, 바이너리 LDPC
- **ID**: ieee:6811346
- **Type**: conference
- **Published**: 28 Feb.-2 
...
- **Status**: ✅
- **Reason**: 이식 가능 코드설계(E): node-splitting으로 large-girth irregular/protograph LDPC 구성, 동일 girth에서 블록길이 단축 — 바이너리 LDPC 구성 기법
- **ID**: ieee:6811288
- **Type**: conference
- **Published**: 28 Feb.-2 
...
- **Status**: ✅
- **Reason**: 이식 가능 HW(D): edge-coloring 기반 그리디 통신 스케줄링으로 VLSI 반복디코더 throughput 최적화, 바이너리 LDPC 디코더에 적용 가능
- **ID**: ieee:6811240
- **Type**: conference
- **Published**: 28 Feb.-2 
...
- **Status**: ❌
- **Reason**: IWSN FEC 벤치마크 서베이성 평가, LDPC가 후보 중 하나로 부수 언급 — 신규 기법 없음
- **ID**: ieee:6895022
- **Type**: conference
- **Published**: 26 Feb.-1 
...
- **Status**: ❌
- **Reason**: RS 연판정 디코더(information set decoding) HW — 비-LDPC 부호, 디코더가 RS/ISD에 종속되어 바이너리 LDPC BP에 이식 불가
- **ID**: ieee:6800423
- **Type**: conference
...
- **Status**: ❌
- **Reason**: PLC용 S-FSK+표준 LDPC 결합, LDPC는 베이스라인이고 떼어낼 ECC 기법 없음
- **ID**: ieee:6840922
- **Type**: conference
...
- **Status**: ✅
- **Reason**: 새 group-shuffled LDPC 디코딩(VN 그룹화)으로 수렴 가속, 이식 가능 디코더 기법(C)
- **ID**: ieee:6840905
- **Type**: conference
- **Published**: 19-22 Marc
...
- **Status**: ✅
- **Reason**: PEG형 저복잡도 H행렬 구성 기법 — 바이너리 LDPC 코드 설계(E) 이식 가능
- **ID**: ieee:6925956
- **Type**: conference
...
- **Status**: ✅
- **Reason**: stochastic LDPC 디코더 출력 결정 기법, 칩면적/처리율 개선 이식 가능(C/D)
- **ID**: ieee:6814072
- **Type**: conference
- **Published**: 19-21 Marc
...
- **Status**: ✅
- **Reason**: 디스크 어레이용 새 LDPC 구성(rigid graph 기반 low-density MDS), 스토리지 ECC+코드설계(B/E)
- **ID**: ieee:6925897
- **Type**: conference
- **Published**: 19-21 Marc
...
- **Status**: ❌
- **Reason**: RCM+LDGM 하이브리드 rate-adaption, LDPC ECC 아니고 떼어낼 기법 없음
- **ID**: ieee:6814118
- **Type**: conference
- **Published**: 19-21 Marc
...
- **Status**: ❌
- **Reason**: 아날로그 JSCC 매핑(Shannon-Kotelnikov), LDPC 아님
- **ID**: ieee:6814102
- **Type**: conference
- **Published**: 19-21 Marc
...
- **Status**: ✅
- **Reason**: 확장형 SPA LDPC 디코더 FPGA 아키텍처 + 자원 trade-off — 이식 가능 HW(D)
- **ID**: ieee:6836261
- **Type**: conference
- **Published**: 1-8 March 
...
- **Status**: ❌
- **Reason**: AES+Turbo 결합 crypto-coding(위성채널) — 비-LDPC, 보안, 이식 가능 LDPC BP 기법 없음
- **ID**: ieee:6804443
- **Type**: conference
- **Published**: 1-2 March 

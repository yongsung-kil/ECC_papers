...
- **Status**: ❌
- **Reason**: 정수 잉여환(ring) 위 Lee 메트릭 LDPC — 바이너리 LDPC 아닌 비이진 계열, 제외 대상
- **ID**: ieee:10620337
- **Type**: journal
- **Published**: Nov. 2024
- **Authors**: Jessica Bariffi, Hannes Bartz, Gianluigi Liva +1
- **PDF**: https://ieeexplore.ieee.org/document/10620337
...
- **Status**: ❌
- **Reason**: 시맨틱 통신 + 적응형 채널코딩, LDPC가 베이스라인 — 떼어낼 ECC 기법 없음
- **ID**: ieee:10666082
- **Type**: journal
- **Published**: Nov. 2024
- **Authors**: Shiqi Sun, Zhijin Qin, Huiqiang Xie +1
- **PDF**: https://ieeexplore.ieee.org/document/10666082
...
- **Status**: ❌
- **Reason**: GLM 신호추정 + AMP/spatial coupling, state evolution 이론 분석 - 채널코딩 LDPC ECC 아님, 추정 문제. 떼어낼 디코더/HW 없음
- **ID**: ieee:10673895
- **Type**: journal
- **Published**: Nov. 2024
- **Authors**: Pablo Pascual Cobo, Kuan Hsieh, Ramji Venkataramanan
- **PDF**: https://ieeexplore.ieee.org/document/10673895
...
- **Status**: ❌
- **Reason**: LDPC 구조를 빔포밍 안테나/RF 선택에 차용한 응용 특이적 메시지패싱 — NAND ECC로 이식할 코드/디코더 기법 없음
- **ID**: ieee:10538224
- **Type**: journal
- **Published**: Nov. 2024
- **Authors**: Li-Hsiang Shen, Yen-Chun Lo, Kai-Ten Feng +2
- **PDF**: https://ieeexplore.ieee.org/document/10538224
...
- **Status**: ❌
- **Reason**: 손실 소스 코딩(Hamming 기반 압축), 채널 ECC 아님; LDPC 무관
- **ID**: ieee:10845285
- **Type**: conference
- **Published**: 8-11 Nov. 
- **Authors**: Guanchang Li, Ya Lian, Wensheng Lin +4
- **PDF**: https://ieeexplore.ieee.org/document/10845285
...
## Optimization Design and Performance Research of 5G P-IOT Passive Tags Based on LPWAN and Transformer in Long Range Coverage Transmission

- **Status**: ❌
- **Reason**: 5G P-IoT 패시브 태그 Transformer 기반 LPWAN 최적화로 LDPC ECC와 무관
- **ID**: ieee:10871281
- **Type**: conference
- **Published**: 8-10 Nov. 
- **Authors**: Jiaqi Hu, Guoyi Zhang, Canhao Zhou +3
- **PDF**: https://ieeexplore.ieee.org/document/10871281
- **Abstract**: With the expansion of the Internet of Things (Io'T), current passive IoT (P-IoT) systems supporting 5G are facing challenges such as limited communication range, high interference, and low data throughput in complex environments. This paper introduces E-TransLPWAN (LPWAN optimization framework based on enhanced transformers), a novel solution for monitoring ultra-high voltage (UHV) power grids. This framework solves the above problems by optimizing spectrum utilization and power control, while effectively processing large-scale time series data using Transformer's self-attention mechanism. The experimental results show that E-TransLPWAN can significantly improve the performance of existing models, including a 50% reduction in latency, a 6% increase in anomaly detection accuracy (reaching 97%), and a 30% reduction in energy consumption. These improvements have enhanced the reliability and cost-effectiveness of UHV monitoring and ensuring the stability of the power grid.

## A Radiation-Hardened Serial Peripheral Interface with an ECC-Protected SRAM in a 65nm CMOS Technology

- **Status**: ❌
- **Reason**: 방사선 강화 SPI/SRAM ECC 설계로 LDPC가 아닌 SRAM용 ECC, 떼어낼 LDPC 기법 없음
- **ID**: ieee:10808843
- **Type**: conference
- **Published**: 7-9 Nov. 2
- **Authors**: Ming-Hao Chang, Chansyun Yang, Yu-Ju Chuang +1
- **PDF**: https://ieeexplore.ieee.org/document/10808843
- **Abstract**: Benefiting from a reduction in rocket launch costs and an increase in market scale, low earth orbit (LEO) satellites have become a new focus in the field of technology in recent years. Their characteristics of low latency, high bandwidth and low cost provide advantages for mobile communication. Related applications, such as phased array antennas and beamforming ICs, have also been developed accordingly. However, the space environment is filled with a large number of cosmic rays, and these high-energy radiation particles may cause soft errors in ICs. Therefore, mitigating the impact of radiation will be a major challenge. This work proposes a radiation-hardened serial peripheral interface (SPI) and an SRAM with error-correcting code (ECC) protection for application in LEO satellites. By analyzing through a mathematical bit error rate model and relevant information about SRAM, a suitable ECC is selected. Additionally, radiation-hardened cells are incorporated into the SPI.

## A Review of Resource Allocation of OFDMA using LDPC Codes

- **Status**: ❌
- **Reason**: OFDMA 자원할당 최적화 (BP 무오류 디코딩 조건 활용); 표준 LDPC/BP 그대로 사용, 새 디코더·구성 기여 없음 — 무선 응용 특이적
- **ID**: ieee:10800933
- **Type**: conference
- **Published**: 6-8 Nov. 2
- **Authors**: Dr M Selvi, L K Sherya, E V Srinivasan +1
- **PDF**: https://ieeexplore.ieee.org/document/10800933
- **Abstract**: To address the challenge of distributed resources in multi-carrier communications, various approaches have been proposed. These methods typically stem from information-theoretic measurements or other channel activity aspects, which may not accurately represent the coding. This study employs a customized optimization method for Orthogonal Frequency Division Multiplexing (OFDM), implemented with a Low-Density Parity Check (LDPC) codes and employing general stability conditions. The latter involves formulating a crucial requirement to ensure flawless decoding by the Belief Propagation (BP) decoder with no errors in the received vector. This reframes the overall condition to represent better the characteristics of useful multi-carrier systems such as OFDM and establishes a broad framework for resource allocation to maximize transmitted power based on the attributes of LDPC coding. This study describes that the suggested optimization method that is applied in Orthogonal Frequency Division Multiple Access (OFDMA) systems for power distribution to ensure reliable decoding while minimizing power consumption. To validate the proposed approach, it is compared with information-theoretic methods aiming to maximize the mutual information shared by the transmitter and receiver. Both approaches yield practically the same performance for the scenarios addressed in this study.

## Examination of PHY Layer Features in DECT-2020 and LTE-M Networks

- **Status**: ❌
- **Reason**: DECT-2020/LTE-M PHY 비교 분석; LDPC ECC 기법 없음
- **ID**: ieee:10845321
- **Type**: conference
- **Published**: 6-8 Nov. 2
- **Authors**: Refik Caglar Kizilirmak, Satzhan Askarov
- **PDF**: https://ieeexplore.ieee.org/document/10845321
...
- **Status**: ❌
- **Reason**: OFDM+시각암호 영상 전송; LDPC는 표준 사용·부수 언급, PAPR/암호 응용 중심, 이식할 ECC 기법 없음
- **ID**: ieee:10801136
- **Type**: conference
- **Published**: 6-8 Nov. 2
- **Authors**: S Maheswari, S. Agnes Shifani
- **PDF**: https://ieeexplore.ieee.org/document/10801136
...
## The Effect of the Punch Function on Error Correcting Codes

- **Status**: ❌
- **Reason**: puncturing으로 convolutional/turbo code rate 향상. LDPC 아니며 떼어낼 LDPC 기법 없음 — 제외.
- **ID**: ieee:10783386
- **Type**: conference
- **Published**: 3-5 Nov. 2
- **Authors**: Fayssal Menezla, Mohammed Debbal, Mouweffeq Bouregaa +1
- **PDF**: https://ieeexplore.ieee.org/document/10783386
- **Abstract**: This paper explores strategies for improving spectral efficiency and error correction capabilities in digital communication systems. Error correcting codes (ECCs) play a crucial role in ensuring reliable data transmission, particularly in environments prone to noise and interference. By combining efficient ECCs with advanced modulation techniques, such as MDP4 modulation, significant improvements in data transmission reliability and efficiency can be achieved. However, the trade-off between spectral efficiency and complexity poses challenges, especially with high-rate convolutional codes. Drawing upon Claude Shannon's channel capacity theorem, which establishes theoretical limits on error-free transmission, the study investigates practical approaches for maximizing spectral efficiency while mitigating complexity. The puncturing technique emerges as a key strategy, allowing for the derivation of codes with higher rates from a base code with lower efficiency. Through systematic adjustments in puncturing configurations, the transmission chain can be optimized to achieve higher data rates within the available bandwidth. Simulation results validate the efficacy of punctured codes in enhancing error correction performance across different channel conditions. The graphical representations of binary error rate curves against signal-to-noise ratio provide insights into the trade-offs between spectral efficiency, coding rates, and error correction capabilities. Additionally, analysis of turbo-codes under varying modulation schemes and channel conditions demonstrates their robustness and adaptability in mitigating errors.

## Learning Age of Information-Oriented Energy-Efficient Scheduling with Non-Orthogonal Multiple Access

- **Status**: ❌
- **Reason**: NOMA 업링크 AoI DQN 스케줄링; LDPC/ECC 무관, 떼어낼 디코더/코드설계 기법 없음
- **ID**: ieee:10760809
- **Type**: conference
- **Published**: 29 Oct.-1 
- **Authors**: Jinhua Li, Yi Cao, Tse-Tin Chan +1
- **PDF**: https://ieeexplore.ieee.org/document/10760809
- **Abstract**: We propose a deep Q-network (DQN)-based user scheduling scheme aimed at low network-wide age of information (AoI) in a non-orthogonal multiple access (NOMA) uplink status update system. In our system, end users can harvest energy from wireless signals received on the radio-frequency band to extend the lifespan of their batteries. Given the battery replacement cost in many practical scenarios, our objective is to design a scheduling scheme to maintain a low AoI while efficiently utilizing energy harvesting and reducing the number of battery replacements. Considering the instantaneous AoI, remaining energy, and channel condition of end users, we model the user scheduling problem as a Markov decision process (MDP), which is solved by DQN. In particular, the choice of transmission power to save energy while enabling a high NOMA decoding rate is incorporated in the design of DQN. Experiments indicate that our DQN-based scheduling scheme achieves a low average AoI of the system with significantly fewer battery replacements compared to various benchmarking schemes.

## DFT-based Channel Estimation with Multiple Windows for ATSC 3.0 Receiver

- **Status**: ❌
- **Reason**: ATSC 3.0 채널 추정(DFT 보간+유전알고리즘) 논문, LDPC ECC와 무관 — 떼어낼 디코더/코드설계 기법 없음
- **ID**: ieee:10761026
- **Type**: conference
- **Published**: 29 Oct.-1 
- **Authors**: Yu-Sun Liu, Yin-Shan Li, Shingchern D. You
- **PDF**: https://ieeexplore.ieee.org/document/10761026
- **Abstract**: This study introduces a novel method for Discrete Fourie Transform (DFT)-based interpolation for channel estimation through the application of multiple windows in the channel impulse response. Utilizing a genetic algorithm, we determine the optimal positions and lengths of these windows. Our simulation results demonstrate that this approach has lower channel's Mean Squared Error (MSE) than other high-performance estimation approaches.

## Analysis and Methodological Advancements in Software-Defined Error Correction Codes

- **Status**: ❌
- **Reason**: ECC 종합 리뷰+SDECC 소개, LDPC는 사례 언급 수준이고 NAND 이식 가능한 새 디코더/구성 기여 불명확 — 표준 기법 재사용
- **ID**: ieee:10874348
- **Type**: conference
- **Published**: 28-30 Nov.
- **Authors**: Yisen Li
- **PDF**: https://ieeexplore.ieee.org/document/10874348
- **Abstract**: This article provides a detailed exploration of the principles, development, and applications of Error-Correcting Codes (ECC) across various fields. ECC has the capability to detect and correct errors during data transmission and storage, significantly enhancing data accuracy and system reliability. Particularly in areas such as wireless networks, digital communication, and data storage, ECC technology has become an indispensable component. The article primarily discusses Hamming codes, Reed-Solomon codes, Turbo codes, Low-Density Parity-Check codes (LDPC), and Polar codes, focusing on cutting-edge research. Using LDPC as a case study, it analyzes the principles of traditional ECC methods, highlighting their limitations in handling double-bit errors (DUE), and introduces Software-Defined Error-Correcting Codes (SDECC), which integrate software and hardware technologies to provide more flexible and efficient error handling solutions. Furthermore, through experimental validation combining various traditional ECC methods, it demonstrates that SDECC exhibits significant advantages in recovering data errors and addressing system crashes, particularly in big data environments, effectively preventing the propagation of erroneous data and system failures. These research findings offer new perspectives and potential development directions for the future of ECC technology. By conducting an in-depth analysis and discussion of SDECC technology, this paper not only underscores its application value in modern information society but also showcases the potential and challenges for future development. With advancements in communication technology and computational theory, ECC and its derivative technologies will continue to play a crucial role in ensuring the security and reliability of information transmission.
...
## Iterative Spatial Demapper with Repetition Codes for NOMA Network Coding

- **Status**: ❌
- **Reason**: NOMA 네트워크 코딩용 반복부호+짧은 LDPC, LDPC가 네트워크코딩 베이스라인일 뿐 새 ECC 기법 없음
- **ID**: ieee:10792963
- **Type**: conference
- **Published**: 28-30 Nov.
- **Authors**: Muhammad Rafli Al-Hasyimi, Khoirul Anwar, Linda Meylani
- **PDF**: https://ieeexplore.ieee.org/document/10792963
- **Abstract**: This paper proposes Iterative Spatial Demapping (ISM) for non-orthogonal multiple access (NOMA) network coding to support multi-user communication exploiting both channel coding and network coding. This paper uses repetition codes for channel coding and short Low Density Parity Check (LDPC) Codes as network coding. Two ISMs is used to represent the network box-plus operation connecting several users larger than available resources. We perform a series of computer simulations to evaluate the proposed NOMA network coding and evaluate some users having network degree distribution of one and two in terms of diversity order. We found that multiple ISMs work properly and help user detections although their signals are superposed due to less time resources compared to the number of users. We also analyze the performance using Extrinsic Information Transfer (EXIT) Chart to confirm the validity of ISM demapper. The results of this paper are expected to provide contribution to the development NOMA with the help of network coding.

## Research on Models for Real-Time Data Transmission of Polar Navigating Ships using 5G Communication

- **Status**: ❌
- **Reason**: 극지 선박 5G 실시간 데이터 전송 응용 연구, ECC/LDPC 기법 부재
- **ID**: ieee:10823048
- **Type**: conference
- **Published**: 28-30 Nov.
- **Authors**: Xingfei Feng, Haotian Wang, Yonggang Zong
- **PDF**: https://ieeexplore.ieee.org/document/10823048
- **Abstract**: Extreme natural environment, bad weather conditions and sparse infrastructure make polar navigation a challenging task. Real-time data transmission, as one of the core requirements of modern navigation and scientific research activities, is particularly important for polar navigation. The purpose of this article is to discuss the application of 5G communication technology in real-time data transmission of ships sailing in polar regions, and to conduct in-depth research on its performance, energy efficiency and signal coverage. By constructing a 5G communication model adapted to the polar environment and adopting advanced data processing and transmission technology, we can meet the challenges brought by extreme weather conditions and sparse infrastructure. The experimental results show that compared with traditional methods, 5G communication technology has obvious advantages in data recall, energy efficiency ratio and signal coverage, which effectively improves the data transmission performance of polar navigation ships. The introduction of 5G communication technology provides a new solution for real-time data transmission of polar ships, which not only achieves a breakthrough in data transmission performance, but also makes important progress in energy efficiency and signal coverage.
...
- **Status**: ❌
- **Reason**: 5G OFDM 신호 jamming을 강화학습으로 학습하는 보안 연구, LDPC ECC 기법 없음
- **ID**: ieee:10773738
- **Type**: conference
- **Published**: 28 Oct.-1 
- **Authors**: Zachary Schutz, Daniel J. Jakubisin, Charles E. Thornton +1
- **PDF**: https://ieeexplore.ieee.org/document/10773738
...
## Application of the Sionna Software for 5G/6G Physical Layer Simulations

- **Status**: ❌
- **Reason**: Sionna 5G/6G 물리계층 시뮬레이션 소개로 표준 5G LDPC 사용, 새 기법 없음
- **ID**: ieee:10819060
- **Type**: conference
- **Published**: 26-27 Nov.
- **Authors**: Milica Đorđević, Nenad Jevtić, Marija Malnar
- **PDF**: https://ieeexplore.ieee.org/document/10819060
- **Abstract**: The rapid advancement of wireless communication technologies demands sophisticated simulation software capable of accurately modeling and analyzing the physical layer of 5G (Fifth Generation). Advanced applications of the Sionna software provide a comprehensive platform for simulating complex link dynamics and performance metrics. This research focuses on the simulation analyses of 5G NR (New Radio) LDPC (Low-Density Parity-Check) codes and Multi-User MIMO (Multiple Input Multiple Output) OFDM (Orthogonal Frequency Division Multiplexing) techniques, demonstrating significant improvements in system performance and channel efficiency. The integration of ML (Machine Learning) methods is essential for advancing signal processing and decoding efficiency, particularly in next-generation networks. Simulated advanced neural demapping techniques highlight the need for innovative approaches to address the challenges posed by emerging technologies, including anticipated advancements in 6G (Sixth Generation).
...
## Enhancements to the 5G-NR 2-Step RACH: an Unsourced Multiple Access Perspective

- **Status**: ❌
- **Reason**: 5G-NR 2-step RACH/unsourced multiple access 프로토콜 개선. 채널코딩 ECC 기법 아님
- **ID**: ieee:10849721
- **Type**: conference
- **Published**: 25-27 Nov.
- **Authors**: Patrick Agostini, Jean-Francois Chamberland, Federico Clazzer +7
- **PDF**: https://ieeexplore.ieee.org/document/10849721
- **Abstract**: The ever increasing demand for massive connectivity, combined with the specific characteristics of machinegenerated wireless traffic, is pushing the existing solutions for device registration and data transfer beyond their operational limits. In this paper, we target specifically the 3GPP 5G New Radio random access channel, proposing some enhancements inspired by recent research results in the field of unsourced multiple access (UMAC). Aiming to enable massive grant-free connectivity for large machine-type and Internet of things terminals, we focus on modifications of the two-step random access procedures originally introduced in 3GPP Release 16. By means of simulations, we show that remarkable gains in both energy and spectral efficiency can be attained while retaining a strong resemblance to the legacy protocol.

## PHY Preamble Shortening by Training Field Reduction for 802.11 Wireless LANs

- **Status**: ❌
- **Reason**: 802.11 WLAN preamble 단축(채널 추정 축소). ECC/LDPC 무관
- **ID**: ieee:10849741
- **Type**: conference
- **Published**: 25-27 Nov.
- **Authors**: Ephraim Fuchs, Thomas Handte, Daniel Verenzuela +1
- **PDF**: https://ieeexplore.ieee.org/document/10849741
- **Abstract**: In short-packet communications, overhead from the packet preamble can significantly degrade latency and throughput. This paper provides a novel concept to shorten preambles in the context of IEEE 802.11 standards. In low-mobility scenarios with long coherence time, the channel remains stable for several packet transmissions. Thus, it is sufficient to estimate the channel of a subset instead of all spatial streams, reducing the amount of channel estimation sequences required per packet. The proposed method is analyzed with respect to preamble duration and reliability under various scenarios and configurations such as environmental velocity or channel estimation field compression. It turns out that a shorter preamble duration is achieved with similar reliability compared to the preamble design in recent wireless local area network (WLAN) standards, rendering it a promising candidate for low-latency advancements in next-generation WLAN standards.
...
- **Status**: ❌
- **Reason**: 분산 소스 코딩(DSC) 기반 엣지 컴퓨팅 전송 기법, 채널 ECC가 아닌 소스 코딩이라 떼어낼 LDPC 기법 없음
- **ID**: ieee:10806937
- **Type**: conference
- **Published**: 24-28 Nov.
- **Authors**: Rong Hu, Xiaofan He
- **PDF**: https://ieeexplore.ieee.org/document/10806937
- **Abstract**: As the advantages promised by distributed edge computing in large-scale computation applications are often offset by a few straggling edge nodes (ENs), coded edge computing has emerged recently as an effective countermeasure by creating redundant computation using coding theory. However, existing pioneering works on coded edge computing often treat the corresponding information transmission as a traditional multi-user communication problem, in which the messages from the users are often assumed independent. In contrast, in coded edge computing, due to task encoding, the computation results of the ENs are correlated. With this consideration, a novel distributed source coding (DSC) assisted downlink transmission scheme is proposed in this work, to demonstrate that, if properly exploited, such correlation can lead to more efficient transmission of the coded computation results. To the best of our knowledge, this work is among the first to explore the interesting analogy between transmission in coded edge computing and the classic DSC problem. To further support the proposed scheme, an efficient and practical DSC method is also developed, by exploiting the unique features of coded computing. The effectiveness of the proposed scheme is corroborated by simulation results.

## Enhanced Performance of Channel Coded CE-OFDM-IM with Phase Receiver

- **Status**: ❌
- **Reason**: CE-OFDM-IM에 표준 LDPC+소프트결정 적용, 표준 부호 단순 재사용으로 떼어낼 새 기여 없음
- **ID**: ieee:10869098
- **Type**: conference
- **Published**: 22-24 Nov.
- **Authors**: Hanbing Zhang, Quanchao Zhou, Xianle Dai +3
- **PDF**: https://ieeexplore.ieee.org/document/10869098
- **Abstract**: Constant envelope orthogonal frequency division multiplexing (CE-OFDM) greatly reduces the peak-to-average ratio (PAPR) by embedding information into the phases of carriers. However, during the process of wide application, CE-OFDM is faced with a significant obstacle in balancing the bit error rate (BER) performance and bandwidth. To address this challenge, we adopt the approach of combining index modulation (IM) with CE-OFDM to utilize the potential frequency diversity gains, while using low density parity check (LDPC) coding and employing soft desicion to further enhance the BER performance. Simulation results show that the CE-OFDM-IM system with channel coding and soft decision reduces the BER while improving spectral efficiency.

## VLC: A Robust and Highly Secured Data Communication Service Establishment Using Visual Light enabled LiFi Technology

- **Status**: ❌
- **Reason**: LiFi/VLC 보안 통신 시스템에서 LDPC는 부수 언급, 떼어낼 새 디코더·코드설계 기법 없음
- **ID**: ieee:10965028
- **Type**: conference
- **Published**: 22-23 Nov.
- **Authors**: G. Ramkumar, J. Megala, S. Ramesh +3
- **PDF**: https://ieeexplore.ieee.org/document/10965028
- **Abstract**: With the increasing demand for secure, high-speed wireless communication, Light Fidelity (LiFi) technology has emerged as a promising solution. In this paper, we propose a robust and highly secured data communication system based on Visual Light Communication (VLC) enabled by Light Fidelity (LiFi) technology. The proposed system leverages Orthogonal Frequency Division Multiplexing (OFDM) modulation, Advanced Encryption Standard (AES-256) encryption, and Low-Density Parity-Check (LDPC) error correction to enhance data transmission speed, security, and reliability. Our experimental results demonstrate that the proposed model achieves an accuracy of 97.81 %, significantly outperforming nine existing models. The system shows substantial improvements in throughput, bit error rate (BER), and latency, achieving a throughput of 148.7 Mbps, a BER of 0.018%, and a latency of 18.7 ms. The proposed model offers enhanced energy efficiency and packet loss minimization, making it suitable for high-speed and secure communication in modern environments. Our approach ensures data integrity and protection against man-in-the-middle (MITM) attacks through a machine learning-based anomaly detection system. The proposed methodology is evaluated under various conditions, and the results demonstrate that it outperforms existing LiFi models in accuracy, security, and performance

## Intelligent Control and Security Systems Models Synthesis Methodology for Critical Infrastructure Objects

- **Status**: ❌
- **Reason**: 중요인프라 지능형 제어·보안 시스템 방법론, LDPC/ECC와 무관
- **ID**: ieee:11222460
- **Type**: conference
- **Published**: 21-23 Nov.
- **Authors**: Serhii Yevseiev, Ruslan Hryshchuk, Oleksandr Zakovorotnyi +3
- **PDF**: https://ieeexplore.ieee.org/document/11222460
- **Abstract**: The proposed methodology for the intelligent control and security systems models synthesis of critical infrastructure facilities is based on a fundamentally new approach to the construction of such systems. The methodology is based on the principle of synergism. The intellectualization of models and the synergistic effects arising from their synthesis make it possible to obtain new emergent properties of control and security systems of critical infrastructure objects. In particular, on the basis of the obtained models, the effect of building N-contour intelligent control and security systems with predetermined indicators of resistance to threats of a certain (quantum) or predicted (post-quantum) type, depending on the belonging of critical infrastructure objects, has been revealed. The developed methodology is intended to prevent manifestations of unauthorized interference in the regular modes of operation of critical infrastructure objects and is used to forecast and prevent crisis situations at critical infrastructure objects as a result of the use of cyber weapons by states unfriendly to Ukraine or terrorist cyber groups. On the basis of the developed methodology for the intelligent management and security systems models synthesis of critical infrastructure objects, which are fundamentally different in their properties, the continuity of the performance of the main functions by intelligent management systems of critical infrastructure objects is ensured, while at the same time a guaranteed (given) level of security of such systems, which has a critical important for the further development of the field of information security of the state in the interests of increasing the level of national security of Ukraine, ensuring the safety of citizens, and protecting their rights and freedoms.
...
- **Status**: ❌
- **Reason**: 양자 LDPC(QLDPC) — flag/proxy 큐빗·syndrome extraction 등 양자 전용 개념 의존, 고전 이식 불가
- **ID**: ieee:10764437
- **Type**: conference
- **Published**: 2-6 Nov. 2
- **Authors**: Suhas Vittal, Ali Javadi-Abhari, Andrew W. Cross +2
- **PDF**: https://ieeexplore.ieee.org/document/10764437
...
- **Status**: ❌
- **Reason**: 멤리스티브 CIM 데이터레이아웃/wear-leveling, LDPC ECC 무관
- **ID**: ieee:10764631
- **Type**: conference
- **Published**: 2-6 Nov. 2
- **Authors**: Heng Zhou, Bing Wu, Huan Cheng +4
- **PDF**: https://ieeexplore.ieee.org/document/10764631
...
## Performance Evaluation of Error Optimization Algorithms for Soft-Input LDPC Decoder with Adaptive Equalization

- **Status**: ❌
- **Reason**: Coherent-PON adaptive equalization (StateTD/ED); equalization-specific, no detachable LDPC ECC technique
- **ID**: ieee:10809946
- **Type**: conference
- **Published**: 2-5 Nov. 2
- **Authors**: Liga Bai, Qun Zhang, Zhensheng Jia
- **PDF**: https://ieeexplore.ieee.org/document/10809946
- **Abstract**: This study evaluates adaptive equalization's impact on LDPC-based coherent-PONs, focusing on error-propagation mitigation strategies like state-tracking-and-demapping (StateTD) and error-decorrelation (ED) algorithms. Results show FFE-ED improves post-FEC BER by 0.5 dB at BER of 1E-5.
...
## Performance Evaluation of OAM-Based MIMO FSO System Integrated with Hybrid Channel Coding and Space-Time Coding

- **Status**: ❌
- **Reason**: OAM-MIMO FSO with space-time coding; LDPC incidental, no detachable ECC technique
- **ID**: ieee:10809802
- **Type**: conference
- **Published**: 2-5 Nov. 2
- **Authors**: Shidong Xu, Shanyong Cai, Zhiguo Zhang
- **PDF**: https://ieeexplore.ieee.org/document/10809802
- **Abstract**: This paper presents an orbital angular momentum multiplexing MIMO FSO system based on the combination of hybrid channel coding and space-time coding. Simulation results show that compared with only vertical Bell Layered Space-Time(V-BLAST) coding, the coding gain is improved by 1.33dB under strong turbulence.
...
## Improving Hard-Decision FEC Decoding via Four-Level Bit Marking: A Case Study of KR4/KP4 Codes

- **Status**: ❌
- **Reason**: Reed-Solomon(KR4/KP4) bit-marking 디코딩 — LDPC 아닌 RS 대상, NAND LDPC 이식 기여 없음
- **ID**: ieee:10809376
- **Type**: conference
- **Published**: 2-5 Nov. 2
- **Authors**: Yanzhe Yue, Yi Lei, Jinlong Tian +1
- **PDF**: https://ieeexplore.ieee.org/document/10809376
- **Abstract**: An improved decoding algorithm for Reed-Solomon codes is proposed using bit flipping in combination with mis-correction detection with the help of four-level bit-marking, achieving 0.28 dB and 0.19 dB additional gains for KR4 and KP4 codes, respectively.
...
- **Status**: ❌
- **Reason**: Voronoi constellation vs probabilistic shaping comparison; no LDPC decoder/HW/code-design to port
- **ID**: ieee:10809888
- **Type**: conference
- **Published**: 2-5 Nov. 2
- **Authors**: Yajie Sheng, Bin Chen, Yi Lei +5
- **PDF**: https://ieeexplore.ieee.org/document/10809888
...
- **Status**: ❌
- **Reason**: 철도 센서망 비밀키 생성(SKG)·보안 통신, LDPC 부수적이고 떼어낼 ECC 기법 없음
- **ID**: ieee:10985423
- **Type**: conference
- **Published**: 18-22 Nov.
- **Authors**: Yizhuo Wang, Qinghe Du, Jiyu Chen
- **PDF**: https://ieeexplore.ieee.org/document/10985423
...
## Low Complexity Soft Demapper for MIMO Sidelink Communications

- **Status**: ❌
- **Reason**: MIMO 사이드링크 soft demapper — LDPC 무관, 변조/디매핑 기법뿐
- **ID**: ieee:10881052
- **Type**: conference
- **Published**: 17-20 Nov.
- **Authors**: Yang Fu, Jaime Rodrigo Navarro, Faiza Bouchmal +2
- **PDF**: https://ieeexplore.ieee.org/document/10881052
- **Abstract**: The Third Generation Partnership Project (3GPP) has introduced definitions and services for 5G New Radio (NR) V2X since Release 16 to provide promising technology standards for future automotive driving. In this paper, we present an optimized soft demapper that exploits information from multiple layers, instead of a single layer, to improve the performance of the algorithm while maintaining a low implementation complexity. The Block Error Rate (BLER) performance of the proposed soft demapping method is evaluated through link-level simulations of the 5G NR Physical Sidelink Shared Channel (PSSCH). Different modulation schemes and multipath fading channel conditions were simulated to evaluate the performance of the proposed soft demapper. Simulation results show a performance improvement in terms of BLER vs SNR compared to state-of-the-art methods.
...
- **Status**: ❌
- **Reason**: 컨볼루션 부호 비터비 디코딩 Markov metric 개선 — LDPC 아님, NAND ECC로 떼어낼 기법 없음
- **ID**: ieee:10805044
- **Type**: conference
- **Published**: 15-17 Nov.
- **Authors**: Alina M. Veresova, Andrei A. Ovchinnikov
- **PDF**: https://ieeexplore.ieee.org/document/10805044
...
## Time Deinterleaving Reception with SPADs for Higher Throughput Space Communication

- **Status**: ❌
- **Reason**: SPAD 우주통신 시간 디인터리빙 수신, LDPC 기법 없음
- **ID**: ieee:10799618
- **Type**: conference
- **Published**: 10-14 Nov.
- **Authors**: H. Ogawa, H. Motomatsu, H. Hayashi +3
- **PDF**: https://ieeexplore.ieee.org/document/10799618
- **Abstract**: We proposed a time deinterleaving reception to mitigate the effect of the dead time of SPAD. The effectiveness of the proposed method was confirmed in a proof-of-concept experiment and the data rate of 99.6 Mb/s was achieved at -64 dBm with only two SPADs.

## High-Speed PAM-4 Signal Transmission with Multi-Mode Fabry-Pérot Laser for Data Center Networks

- **Status**: ❌
- **Reason**: PAM-4 광전송, HD-LDPC는 BER 한계 기준으로 부수 언급뿐. 떼어낼 디코더/코드 기법 없음.
- **ID**: ieee:10799833
- **Type**: conference
- **Published**: 10-14 Nov.
- **Authors**: Ahmed Galib Reza, Lakshmi Narayanan Venkatasubramani, Liam Barry
- **PDF**: https://ieeexplore.ieee.org/document/10799833
- **Abstract**: We report 800 Gbit/s system capacity by exploiting multiple longitudinal modes of a free-running Fabry-Pérot laser and an EAM. The BER below the HD-LDPC decision limit is obtained with a T-spaced 31-tap FFE after C-band 100 Gbit/s/mode PAM-4 signal transmissions over 1 km.

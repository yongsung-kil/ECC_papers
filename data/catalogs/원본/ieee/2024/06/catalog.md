...
- **Status**: ❌
- **Reason**: 물리계층 비밀키 정보조정(reconciliation) 기법; FEC를 일부 비트에만 적용하는 보안 응용으로 NAND LDPC ECC에 떼어낼 디코더/구성 기여 없음
- **ID**: ieee:10488080
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: 자외선 통신용 적응변조·재전송(AMC/HARQ)에 표준 LDPC 앙상블을 그대로 사용; 새 디코더·구성 기여 없는 응용 특이적
- **ID**: ieee:10506962
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: SCMA HARQ + 네트워크코딩 무선 응용; LDPC는 부수 언급, 떼어낼 디코더 기법 없음
- **ID**: ieee:10295166
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: polar 기반 JSCC(소스-채널 결합); LDPC(DP-LDPC)는 베이스라인 비교군일 뿐, 이식할 LDPC ECC 기법 없음
- **ID**: ieee:10491360
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: 위성-지상 CV-QKD 화해(reconciliation). MET-LDPC를 화해 도구로 사용, 양자 QKD 응용·새 디코더 기여 없음
- **ID**: ieee:10415457
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: GMIMO MAMP 수신기 정보이론 최적성; LDPC는 성능 평가용 베이스라인, 떼어낼 부호/디코더 기법 없음
- **ID**: ieee:10332136
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: 양자 CSS 코드 단샷 디코딩, 스태빌라이저·신드롬 오류 의존 — 양자 전용 개념 의존, 고전 바이너리 이식 불가
- **ID**: ieee:10477410
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: 시맨틱 통신 지식베이스 시스템; LDPC·ECC 무관
- **ID**: ieee:10318078
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: OTFS 변조용 Turbo SIC-MMSE 검출 — LDPC ECC 기법 아님, 무선 검출 응용 특이적
- **ID**: ieee:10411929
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: DNA 스토리지 코딩 10년 서베이; 합성 DNA 특화 코딩으로 바이너리 LDPC ECC 디코더/구성 이식 기여 없음
- **ID**: ieee:10535435
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: V2X 차량군 포스트양자 인증/보안 응용. QC-MDPC를 표준 그대로 사용, 새 디코더/코드 기여 없고 보안 응용 특이적
- **ID**: ieee:10368128
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: FDD 물리계층 비밀키 생성(MUSIC/DoA 기반); LDPC 무관, ECC 기법 없음
- **ID**: ieee:10497579
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: Polar 코드 기반 물리계층 네트워크 코딩(GMAC) — LDPC 아님, 무선 응용 특이적
- **ID**: ieee:10388470
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: IRSA 랜덤액세스 비동기 MAC 프로토콜 점근 분석(density evolution) — 떼어낼 LDPC 디코더/HW/코드 기여 없음, 순수 이론 bound
- **ID**: ieee:10411106
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: 비평형 열역학 기반 모바일 통신 에너지 소산 이론; LDPC·ECC 무관
- **ID**: ieee:10301609
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: MIMO-OTFS 심볼 검출(UAMP/SIC); 무선 검출 알고리즘으로 LDPC ECC 이식 기여 없음
- **ID**: ieee:10500696
- **Type**: journal
- **Published**: June 2024
...
- **Status**: ❌
- **Reason**: Zak-OTFS DD영역 신뢰도 기반 LDPC 비트할당 — OTFS 무선 특이적, 떼어낼 일반 ECC 기법 없음
- **ID**: ieee:10622586
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: 양자 LDPC(QLDPC) CSS 부호용 NBP 디코더. 양자 전용 개념(CSS/hypergraph product/Bacon-Shor)에 의존, 고전 바이너리 이식 불가 - 양자 제외
- **ID**: ieee:10622478
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: 시맨틱 통신 지식베이스 — LDPC ECC 무관
- **ID**: ieee:10622764
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: 6G 시맨틱 통신(MLLM). LDPC/ECC 무관, 시맨틱 통신은 제외 대상
- **ID**: ieee:10615340
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: UAV 시맨틱 통신 객체검출 — LDPC ECC 무관
- **ID**: ieee:10622874
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: 5G vRAN 에너지 모델. LDPC/ECC 전혀 무관
- **ID**: ieee:10615464
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: wiretap 보안코딩(autoencoder+해시) — 보안/물리계층 secrecy, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:10623082
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: OFDM 재밍 강화학습 — ECC/LDPC 무관
- **ID**: ieee:10622747
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: LDGM 손실 소스코딩 BPGD decimation — 소스코딩(압축)이라 채널 ECC 아님, 기준상 제외
- **ID**: ieee:10622968
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: 홀로그램 DL 기반 JSCC. LDPC는 비교 베이스라인(JPEG2000+LDPC)일 뿐, JSCC 제외 대상
- **ID**: ieee:10615727
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC를 사용하고 응용도 수중음향 통신 특이적 — 절차 0번 비이진 즉시 제외
- **ID**: ieee:10623112
- **Type**: conference
- **Published**: 9-13 June 
...
- **Status**: ❌
- **Reason**: OFDM PAPR 저감 응용에 표준 PEG/SPA LDPC를 그대로 사용, 무선 응용 특이적이고 떼어낼 새 ECC 기법 없음
- **ID**: ieee:10575635
- **Type**: conference
- **Published**: 5-7 June 2
...
- **Status**: ❌
- **Reason**: Infrastructure as Code 분산환경 자동화 — ECC/LDPC와 무관
- **ID**: ieee:10575600
- **Type**: conference
- **Published**: 5-7 June 2
...
- **Status**: ❌
- **Reason**: 6G 단블록 채널 수신기 메트릭(BICM detection). LDPC가 베이스라인일 뿐 디코더/구성 새 기여 없음, 무선 응용 특이적 — 제외.
- **ID**: ieee:10597121
- **Type**: conference
...
- **Status**: ❌
- **Reason**: NTN 5G 위성 MIMO 멀티캐리어 프레임워크; LDPC는 STSK-CE-OFDM 수신기와 결합된 APP 부수 요소로 통신 응용 특이적, NAND 이식 가능한 디코더/코드설계 기여 없음
- **ID**: ieee:10591513
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Turbo code 디코딩 알고리즘 서베이로 LDPC가 아니며 떼어낼 새 디코더/HW/구성 기여 없음
- **ID**: ieee:10709190
- **Type**: conference
...
- **Status**: ❌
- **Reason**: CRITIC-AHP 기반 통신 간섭 효과 평가, ECC/LDPC와 전혀 무관
- **ID**: ieee:10696271
- **Type**: conference
- **Published**: 28-30 June
...
- **Status**: ❌
- **Reason**: GNU Radio/SDR로 OFDM 구현 실습 논문, ECC는 부수 언급이고 이식 가능한 LDPC 기법 없음
- **ID**: ieee:10625021
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 무선시스템 코딩 개관, LDPC를 표준적으로 나열만 함, 새 디코더·구성·HW 기여 없음
- **ID**: ieee:10724493
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 블록체인+양자암호 백신 공급망 보안, LDPC ECC와 무관
- **ID**: ieee:10724489
- **Type**: conference
- **Published**: 24-28 June
...
- **Status**: ❌
- **Reason**: 확률 성형(CCDM) coding-shaping concat — 채널 ECC 디코더/코드설계 기여 아님(성형)
- **ID**: ieee:10683085
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: 헬기 위성 채널 점유 검출+복호 결합 기법으로, 채널 특이적이고 NAND 이식 가능한 새 LDPC 디코더/구성 없음
- **ID**: ieee:10683487
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: 아날로그 fountain 부호용 OSD 디코더, LDPC는 내부 연접 베이스라인일 뿐 fountain 코드 응용 특이적이라 이식 기여 약함
- **ID**: ieee:10683654
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: 5G LDPC coded modulation의 하이브리드 셰이핑/인터리버, 변조 셰이핑 기법으로 ECC 디코더/코드설계 기여 아님
- **ID**: ieee:10683676
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: 적응형 coded caching 그래프 컬러링 — 채널 ECC LDPC 아님
- **ID**: ieee:10683348
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: DVB LEO 위성 링크레벨 시뮬레이터, 표준 MCS — 새 LDPC 기법 없음
- **ID**: ieee:10683179
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: NOMA/NCMA 무선 다중접속 정보신선도(AoC) 연구, LDPC ECC와 무관, 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:10683581
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: NN OFDM 수신기 양자화·프루닝 — LDPC 코드/디코더 무관
- **ID**: ieee:10683574
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: LDPC 무관, 재머 RB 스케줄링 안티재밍 기법 — 떼어낼 ECC 기법 없음
- **ID**: ieee:10646325
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: MIMO-OTFS UAMP 검출 기법, 무선 신호검출 응용 특이적, LDPC ECC로 이식할 기법 없음
- **ID**: ieee:10683591
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: NavIC L1 송수신기 구현, 항법신호처리 응용, LDPC ECC 무관
- **ID**: ieee:10683652
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: SC-SCMA 다중사용자 검출 BP, LDPC는 결합복호 베이스라인 — 무선 검출 특이, 떼어낼 LDPC 기법 없음
- **ID**: ieee:10683053
- **Type**: conference
- **Published**: 24-27 June
...
- **Status**: ❌
- **Reason**: 양자 스태빌라이저 회로 시뮬레이션, 이식 가능한 고전 바이너리 LDPC 디코더/코드설계 기법 없음
- **ID**: ieee:11294801
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 위성 DSSS 항재밍에 LLR 수정+표준 BP 디코딩 적용, 응용 특이적이며 떼어낼 새 ECC 기법 없음
- **ID**: ieee:10803411
- **Type**: conference
- **Published**: 21-23 June
...
- **Status**: ❌
- **Reason**: 양자 어닐링 기반 네트워크 취약점(QUBO). LDPC/디코더와 무관
- **ID**: ieee:11062742
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Semantic/JSCC communication; LDPC used as baseline, no portable ECC technique
- **ID**: ieee:10588546
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 5G Broadcast vs ATSC 3.0 BLER 비교 평가, LDPC는 부수 언급일 뿐 떼어낼 새 ECC 기법 없음 — 무선/방송 응용 특이적
- **ID**: ieee:10608271
- **Type**: conference
- **Published**: 19-21 June
...
- **Status**: ❌
- **Reason**: Wi-Fi 협력 방송 채널추정 — LDPC 무관, ECC 기법 없음
- **ID**: ieee:10682925
- **Type**: conference
- **Published**: 19-21 June
...
- **Status**: ❌
- **Reason**: TV 3.0 물리계층 테스트 자동화 — ECC/LDPC 기법 전무
- **ID**: ieee:10608290
- **Type**: conference
- **Published**: 19-21 June
...
- **Status**: ❌
- **Reason**: ATSC3.0 IBFD MIMO 자기간섭제거(SIC); LDPC 무관, ECC 기법 없음
- **ID**: ieee:10608255
- **Type**: conference
- **Published**: 19-21 June
...
- **Status**: ❌
- **Reason**: 4K-QAM 소프트 복조기 NN 전처리로 LLR 생성 — 변조/복조 영역, LDPC 디코더·코드설계 기법 떼어낼 것 없음
- **ID**: ieee:10674131
- **Type**: conference

...
- **Status**: ❌
- **Reason**: Non-binary (NB) QC-LDPC over GF(q); criterion excludes non-binary LDPC
- **ID**: ieee:9737098
- **Type**: journal
- **Published**: May 2022
- **Authors**: Irina E. Bocharova, Boris D. Kudryashov, Evgenii P. Ovsyannikov +2
- **PDF**: https://ieeexplore.ieee.org/document/9737098
...
- **Status**: ❌
- **Reason**: MIMO unsourced random access의 joint DAD-CE-DD, LDPC는 표준 BP 베이스라인 — 떼어낼 새 ECC 기법 없음
- **ID**: ieee:9693931
- **Type**: journal
- **Published**: May 2022
- **Authors**: Tianya Li, Yongpeng Wu, Mengfan Zheng +5
- **PDF**: https://ieeexplore.ieee.org/document/9693931
...
- **Status**: ❌
- **Reason**: IRS 패시브 빔포밍 SER 최소화 — LDPC/디코더 무관, 통신 응용 특이적
- **ID**: ieee:9706177
- **Type**: journal
- **Published**: May 2022
- **Authors**: Yiran Zheng, Tian Lin, Yu Zhu
- **PDF**: https://ieeexplore.ieee.org/document/9706177
...
- **Status**: ❌
- **Reason**: polar code 기반 멀티미디어 근사 통신 시스템 - LDPC 무관, 응용 특이적, 떼어낼 ECC 기법 없음
- **ID**: ieee:9825949
- **Type**: conference
- **Published**: 4-6 May 20
- **Authors**: Aman Shreshtha, Priyanka Singla, Smruti R. Sarangi
- **PDF**: https://ieeexplore.ieee.org/document/9825949
...
- **Status**: ❌
- **Reason**: polar code 성능분석, LDPC 아님
- **ID**: ieee:9824746
- **Type**: conference
- **Published**: 27-29 May 
- **Authors**: Pooja Pathak, Richa Bhatia
- **PDF**: https://ieeexplore.ieee.org/document/9824746
- **Abstract**: 5G referring to the upcoming generation of mobile communications networks, which is the major breakthrough in the field of Wireless communication. 5G technologies produce a lot more improvement in the area of mobile connectivity. In academia and industry, there has recently been a lot of discussion on candidate channel coding techniques for fifth-generation (5G) mobile communication systems. Amongst many codes, Polar codes have attracted the researchers’ attention because of the capacity achieving characteristics. Channel polarization operation is the basic operation behind the polar encoding system, and it is feasible to attain channel capacity using it. In this paper, we describe the encoding and decoding of polar codes and also evaluated the performance of the polar codes for short to moderate information length.
...
- **Status**: ❌
- **Reason**: BPMR용 rate-3/5 제약부호+MLP LLR 추정 — 매체 특이적 제약코드, LDPC ECC 이식 기법 아님
- **ID**: ieee:9795475
- **Type**: conference
- **Published**: 24-27 May 
- **Authors**: Natthakan Rueangnetr, Chanon Warisarn, Santi Koonkamkhai +1
- **PDF**: https://ieeexplore.ieee.org/document/9795475
...
- **Status**: ❌
- **Reason**: 딥 JSCC 이미지 전송, LDPC ECC 기법 없음(소스-채널 결합)
- **ID**: ieee:9746268
- **Type**: conference
- **Published**: 23-27 May 
- **Authors**: Sixian Wang, Ke Yang, Jincheng Dai +1
- **PDF**: https://ieeexplore.ieee.org/document/9746268
...
- **Status**: ❌
- **Reason**: MIMO unsourced multiple access 블라인드 수신기로 채널 추정·검출 기법, 이식 가능한 LDPC ECC 기여 없음
- **ID**: ieee:9838932
- **Type**: conference
- **Published**: 16-20 May 
- **Authors**: Jiaai Liu, Xiaodong Wang
- **PDF**: https://ieeexplore.ieee.org/document/9838932
...
- **Status**: ❌
- **Reason**: 풀듀플렉스 자기간섭제거(SIC) 구현 논문, LDPC/ECC 기법 전무
- **ID**: ieee:9838784
- **Type**: conference
- **Published**: 16-20 May 
- **Authors**: Bin Yu, Chen Qian, Peng Lin +8
- **PDF**: https://ieeexplore.ieee.org/document/9838784
- **Abstract**: Full duplex (FD) communication is an enabling technology with simultaneous uplink and downlink transmission over the same spectrum, which could not only virtually double the spectrum but also shorten the latency of bi-directional communications. One of the key challenges to bring full duplex into reality is how to design a practically implementable self-interference cancellation (SIC). This paper promotes a practical joint-design of SIC capable of >120dB SIC gain to make in-band FD practically viable. It consists of novel integrated SIC antenna, multi-tap tunable RF SIC and non-linear digital SIC. Further, a prototype system implemented using in-band FD with 5G NR commercial level hardware components is presented, which not only verifies in-band FD is practically implementable with the proposed joint SIC, but also achieves highest SIC results, i.e. 122.5dB SIC capability with 32dBm transmit power, to our best knowledge. This result confirms the appealing potential of in-band FD and conclusively, the in-band FD communication with the developed effective SIC turns out to be a promising enabler for future business thriving.

## On the Performance of Integrated Orthogonal Time Frequency Space Framework based on WFRFT

- **Status**: ❌
- **Reason**: WFRFT-OTFS 무선 파형 BER/PAPR 분석 — message passing 개선이 WFRFT 차원에 종속, NAND LDPC 이식 기법 아님
- **ID**: ieee:9814667
- **Type**: conference
- **Published**: 16-20 May 
- **Authors**: Zhenduo Wang, Xingyu Chen, Xiaoyan Ning +1
- **PDF**: https://ieeexplore.ieee.org/document/9814667
- **Abstract**: Orthogonal time frequency space (OTFS) scheme has been proposed to achieve strong robustness against Doppler channels in comparison with orthogonal frequency division multiplexing (OFDM) systems, and then weighted-type fractional Fourier transform (WFRFT) has been put froward to extend current OTFS waveform architecture with two-dimensional variable parameters. In this paper, we deeply investigate BER and peak-to-average power ratio (PAPR) performances of WFRFT-OTFS scheme to demonstrate overall performance advantages. On one hand, an improved message passing algorithm based on WFRFT is proposed, and thus better BER performances can be achieved through flexible selection of WFRFT order over delay-Doppler channels. On the other hand, PAPR performances at different levels are easily acquired through configuring multiple adjustable parameters, and thus a precise performance control is achieved to satisfy diverse requirements. Therefore, the superiorities of BER and PAPR performances are obtained in WFRFT-OTFS framework.

## Achieving Short-Blocklength RCU Bound via CRC List Decoding of TCM with Probabilistic Shaping

- **Status**: ❌
- **Reason**: CRC-TCM-PAS 확률성형 + 리스트 Viterbi 디코딩 — LDPC 아님(convolutional/TCM), 떼어낼 LDPC 기법 없음
- **ID**: ieee:9838498
- **Type**: conference
- **Published**: 16-20 May 
- **Authors**: Linfang Wang, Dan Song, Felipe Areces +1
- **PDF**: https://ieeexplore.ieee.org/document/9838498
...
- **Status**: ❌
- **Reason**: 광섬유 MIMO IM/DD 용량·autoencoder 프리코더로 LDPC ECC와 무관
- **ID**: ieee:9838629
- **Type**: conference
- **Published**: 16-20 May 
- **Authors**: Metodi P. Yankov, Francesco Da Ros, Søren Forchhammer +1
- **PDF**: https://ieeexplore.ieee.org/document/9838629
...
- **Status**: ❌
- **Reason**: all-silicon IQ 변조기 HW, FEC는 임계값 언급뿐 — LDPC 기법 없음
- **ID**: ieee:9890497
- **Type**: conference
- **Published**: 15-20 May 
- **Authors**: Essam Berikaa, Md Samiul Alam, Alireza Samani +3
- **PDF**: https://ieeexplore.ieee.org/document/9890497
- **Abstract**: We demonstrate the transmission of 100 GBaud 64QAM achieving a BER below the 25% OH SD-FEC threshold using a single segment all-silicon IQ modulator; featuring a throughput of 600 (net 480) Gb/s.
...
- **Status**: ❌
- **Reason**: Slepian 4D 변조 포맷에 LDPC 단순 적용 — 떼어낼 LDPC 기법 없음
- **ID**: ieee:9891193
- **Type**: conference
- **Published**: 15-20 May 
- **Authors**: Xiao Han, Ivan B. Djordjevic
- **PDF**: https://ieeexplore.ieee.org/document/9891193
- **Abstract**: We implement a 4-dimentional modulation format using Slepian sequences. We applied LDPC coding and experimentally investigated the BER performance in a 40km fiber link transmission and get the error free region without complicated DSP.

## LDPC Kodlarında Artık Veri Kullanımı Residual Data Usage in LDPC Codes

- **Status**: ❌
- **Reason**: LDPC를 erasure code로 쓰되 핵심은 padding/no-padding 데이터 분배 — ECC 기법 아님
- **ID**: ieee:9864789
- **Type**: conference
- **Published**: 15-18 May 
- **Authors**: Erdi Kaya, Massoud Pourmandi, Elif Haytaoglu +1
- **PDF**: https://ieeexplore.ieee.org/document/9864789

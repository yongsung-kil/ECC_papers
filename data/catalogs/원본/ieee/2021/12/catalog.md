...
- **Status**: ❌
- **Reason**: Polar 코드 인코딩/디코딩 및 RCPC-HARQ 서베이, LDPC 기법 아님
- **ID**: ieee:9733299
- **Type**: journal
...
- **Status**: ❌
- **Reason**: GNSS용 표준 girth-8 QC-LDPC 구성·type-II 가중치행렬 — 교과서 수준 QC-LDPC 구성으로 NAND에 새로 이식할 기법 부족.
- **ID**: ieee:9570287
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: 순환시프트로 LDPC에 추가비트 전송하는 통신 기법; 디코더/HW/코드설계 개선 아님, 떼어낼 ECC 기법 없음
- **ID**: ieee:9564241
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ✅
- **Reason**: semi-LDPC-CC 신규 코드 구성(희소+밀집 부분행렬)과 슬라이딩윈도우 리스트 디코딩 알고리즘 제시 — 이식 가능 디코더/코드설계(C/E), 애매하므로 살림.
- **ID**: ieee:9663105
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ✅
- **Reason**: 5G NR LDPC GPU 디코더 — layered 알고리즘 병렬화 개선(단일 코드워드 병렬성 증대), D(이식 가능 병렬화 디코더 아키텍처)
- **ID**: ieee:9328563
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ✅
- **Reason**: 2D LDPC 신규 코드 구성(girth>4)과 병렬 디코더 HW(이중 barrel shifter 라우팅, FPGA 12.52Gb/s)를 데이터 스토리지용으로 제시 — 이식 가능 HW/코드설계(D/E).
- **ID**: ieee:9568927
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: BP/MAP 디코딩 하 LDPC 안정성·범용성 임계값에 대한 순수 이론 분석. 떼어낼 디코더·HW·코드구성 기여 없음 (순수 이론 bound).
- **ID**: ieee:9567663
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: double protograph LDPC JSCC 소스-채널 결합 코드설계; 기준상 JSCC는 제외 대상
- **ID**: ieee:9537752
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: 무선 coded caching을 오류제어코딩 관점으로 재해석 — 캐싱 설계 문제, 떼어낼 LDPC 디코더/HW/구성 기여 없음.
- **ID**: ieee:9608974
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: 폴라 코드 SCL-Flip 디코더 개선 — LDPC가 아닌 폴라 코드 전용 디코딩 기법.
- **ID**: ieee:9684773
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: Unit memory convolutional codes(UMCC); LDPC가 아니고 NAND 이식 기법 없음
- **ID**: ieee:9534893
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: 무선 이종망용 CNN 분류기+DL 디코더; 일반 부호 식별/복호이며 LDPC 전용 이식 기법 없음, NAND 무관
- **ID**: ieee:9404186
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: 재밍/도청 Bayesian-Stackelberg 게임; 채널코딩/LDPC 무관
- **ID**: ieee:9535143
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: UMA MIMO 블라인드 수신기/희소성 활용; 채널 디코딩은 일반 언급, 이식할 LDPC 기법 없음
- **ID**: ieee:9551997
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: Coded Slotted ALOHA 랜덤액세스 프로토콜의 erasure 코드+밀도진화 최적화 — 무선 접속 응용 특이적, 떼어낼 ECC 디코더 기법 없음.
- **ID**: ieee:9573456
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: SC-LDGM(생성행렬 기반) 코드+EM 클러스터링 블라인드 검출. LDPC ECC가 아닌 LDGM/검출 기법, 떼어낼 바이너리 LDPC 디코더 기여 없음.
- **ID**: ieee:9573301
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: Spinal codes의 인코딩 구조 개선; LDPC가 아니며 NAND ECC 이식 기법 없음
- **ID**: ieee:9468924
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ✅
- **Reason**: MLC NAND 플래시 CNN 기반 LLR 검출+read-voltage 설계; 카테고리 A 직접 해당
- **ID**: ieee:9537753
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: 위성 Q/V 밴드 블라인드 등화(CMA); LDPC 디코더 기법 없음
- **ID**: ieee:9535298
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: LOS massive MIMO 하이브리드 프리코더; LDPC는 부수 언급(NR LDPC), 떼어낼 ECC 기법 없음
- **ID**: ieee:9474948
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ❌
- **Reason**: 광통신 superchannel용 turbo DFE 등화/간섭제거 — LDPC ECC 기법 아님, 무선/통신 응용 특이적.
- **ID**: ieee:9594678
- **Type**: journal
- **Published**: Dec. 2021
...
- **Status**: ✅
- **Reason**: girth-6 보장하는 rate-1/3 QC-LDPC 대수적 구성법(E). 짧은 사이클 회피 새 구성 — 이식 가능.
- **ID**: ieee:9685071
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ✅
- **Reason**: PIC-PS로 LDPC를 사슬결합하는 새 코드설계 기법(E). 기존 LDPC 인코더/디코더 구조 재사용 가능 — 이식 가능.
- **ID**: ieee:9682151
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ✅
- **Reason**: SC-LDPC 슬라이딩윈도우 디코딩 오류전파 모델/완화, 바이너리 디코더·코드설계 이식 가능(C/E)
- **ID**: ieee:9682064
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ✅
- **Reason**: RCQ 비균일 양자화 레이어드 MinSum LDPC 디코더 FPGA 구현(C/D). 메시지 양자화·HW — NAND ECC에 직접 이식 가능.
- **ID**: ieee:9685732
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ✅
- **Reason**: QC-LDPC 레이어드 디코딩용 PCM 분할 알고리즘으로 HW 복잡도/지연 감소(D). NAND 디코더에 직접 이식 가능.
- **ID**: ieee:9682155
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: SIC용 LDPC 밀도진화 임계값 분석(이론). 디코더/HW/구성으로 안 이어지는 다중접속 임계값 분석.
- **ID**: ieee:9685529
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: U-UV(BCH+OSD/SCL) 부호의 SISO 디코딩, LDPC 아니고 NAND 이식성 약함
- **ID**: ieee:9682136
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: 병렬연산 결함내성 스케줄링+네트워크 코딩. LDPC ECC 아님, 코딩매트릭스/스케줄링 이슈.
- **ID**: ieee:9685369
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: 6G용 MLC/BICM 코딩 변조 프레임워크. LDPC 디코더/HW/코드설계 기여 없음, 무선 변조 응용 특이적.
- **ID**: ieee:9682143
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: JSCD 신경 디코더, LDPC는 결합 베이스라인, 떼어낼 순수 ECC 기법 없음
- **ID**: ieee:9682040
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: 연합학습 기반 오디오 시맨틱 통신. LDPC 무관, 오토인코더 소스 코딩 응용.
- **ID**: ieee:9685654
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ✅
- **Reason**: MIMO BP 검출기 deep unfolding + negentropy 손실로 LLR Gaussianity 향상 — 후단 soft-decision 디코더용 LLR 개선 기법, NAND LDPC LLR 처리에 이식 검토 여지(C).
- **ID**: ieee:9685863
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: 6G 코드화 랜덤액세스(MIMO 기지국, ACK 기반 spatial coupling). 떼어낼 LDPC ECC 기법 없는 다중접속 프로토콜.
- **ID**: ieee:9682156
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: 심우주 광링크 포인팅 손실 분석. ECC/LDPC 무관한 링크버짓·안테나 게인 분석.
- **ID**: ieee:9685465
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: 위상잡음 이산시간 채널 모델링(AR 프로세스). LDPC 디코더·코드설계·HW 기법 없음 — 떼어낼 ECC 기여 없음.
- **ID**: ieee:9685737
- **Type**: conference
- **Published**: 7-11 Dec. 
...
- **Status**: ❌
- **Reason**: 4G/5G physical-layer comparison survey; no LDPC technique to extract.
- **ID**: ieee:9702888
- **Type**: conference
- **Published**: 6-9 Dec. 2
...
- **Status**: ❌
- **Reason**: 네트워크 워터마킹에 LDPC를 부수적으로 사용; 떼어낼 디코더·코드설계 기여 없음
- **ID**: ieee:9724843
- **Type**: conference
- **Published**: 6-10 Dec. 
...
- **Status**: ✅
- **Reason**: BP 디코딩을 신경망으로 펼치고 파라미터 정규화 최적화한 정규화 신경망 디코더 — 이식 가능 디코더(C).
- **ID**: ieee:9702213
- **Type**: conference
- **Published**: 3-5 Dec. 2
...
- **Status**: ❌
- **Reason**: CNN-BLSTM 기반 채널코딩 종류 블라인드 인식. 디코더/코드설계가 아닌 인식 분류 문제, 떼어낼 ECC 기법 없음.
- **ID**: ieee:9702153
- **Type**: conference
- **Published**: 3-5 Dec. 2
...
- **Status**: ❌
- **Reason**: OSMLD product code + iterative threshold decoding HARQ. LDPC 아닌 다수결논리/product code, 떼어낼 LDPC ECC 기법 없음.
- **ID**: ieee:9641872
- **Type**: conference
- **Published**: 3-5 Dec. 2
...
- **Status**: ❌
- **Reason**: 네트워크 코딩 기반 멀티패스 erasure correction(CoMPEC). 패킷 손실용 erasure 코딩, 채널 LDPC ECC 아님.
- **ID**: ieee:9653103
- **Type**: conference
- **Published**: 29 Nov.-2 
...
- **Status**: ✅
- **Reason**: 5G LDPC 디코더용 새 check-node HW 아키텍처(고차 CN 분할, 적응적 offset)로 D/C 이식 가능
- **ID**: ieee:9665587
- **Type**: conference
- **Published**: 28 Nov.-1 
...
- **Status**: ❌
- **Reason**: Non-Binary LDPC 디코더 — 비이진(GF) LDPC라 기준상 제외
- **ID**: ieee:9665548
- **Type**: conference
- **Published**: 28 Nov.-1 
...
- **Status**: ✅
- **Reason**: 동적 최대반복(early termination) + layered scaled min-sum 단순화 — 이식 가능 디코더 알고리즘 변형(C). 애매하나 살림
- **ID**: ieee:9742216
- **Type**: conference
- **Published**: 27-29 Dec.
- **Authors**: Liang Yan
...
- **Status**: ✅
- **Reason**: LDPC-CC 구성법(Gallager/Mackay-Neal/QC) 비교 + BF 디코딩 — 바이너리 코드설계(E). 애매하나 살림
- **ID**: ieee:9678497
- **Type**: conference
- **Published**: 27-28 Dec.
...
- **Status**: ❌
- **Reason**: GC-LDPC를 RF/FSO 릴레이에 적용 — 글로벌결합 LDPC를 표준 적용, 떼어낼 신규 디코더·구성 기여 없고 무선 응용 특이적.
- **ID**: ieee:9768382
- **Type**: conference
- **Published**: 20-22 Dec.
...
- **Status**: ❌
- **Reason**: 표준 QC-LDPC + bilayer Tanner graph + 표준 BP를 협력통신에 적용, 새 디코더/구성 기여 없음
- **ID**: ieee:9674081
- **Type**: conference
- **Published**: 17-19 Dec.
...
- **Status**: ❌
- **Reason**: 3GPP turbo/polar/LDPC의 인터리빙·rate matching HW 공유 — LDPC 디코더 아키텍처가 아닌 인터리버 공유, 이식할 디코더 HW 기법 약함
- **ID**: ieee:9674248
- **Type**: conference
- **Published**: 17-19 Dec.
...
- **Status**: ❌
- **Reason**: turbo/LDPC/polar 부호의 HDL 구현 성능 비교 연구 — 표준 부호 단순 비교, 새 디코더/구성 기여 없음
- **ID**: ieee:9678589
- **Type**: conference
- **Published**: 15-17 Dec.
...
- **Status**: ❌
- **Reason**: 가우시안 소스 손실압축(소스코딩)에 P-LDPC 적용, 채널 ECC 아님
- **ID**: ieee:9660280
- **Type**: conference
- **Published**: 13-15 Dec.
...
- **Status**: ❌
- **Reason**: Full-Duplex 자기간섭 보상에 표준 5G QC-LDPC/Polar/Turbo를 베이스라인으로 비교만, 새 디코더·구성 기여 없음
- **ID**: ieee:9660220
- **Type**: conference
- **Published**: 13-15 Dec.
...
- **Status**: ❌
- **Reason**: PUF 기반 하드웨어 보안 모듈(HSM), 보안 영역·ECC 무관
- **ID**: ieee:9647783
- **Type**: conference
- **Published**: 13-15 Dec.
...
- **Status**: ✅
- **Reason**: GenAlg로 QC-LDPC 베이스행렬 위치/시프트 최적화 + 다중길이 호환 구성; 바이너리 QC-LDPC 코드설계 신규 기여(E)
- **ID**: ieee:9674585
- **Type**: conference
- **Published**: 10-13 Dec.
...
- **Status**: ❌
- **Reason**: LDPC 보조 블라인드 프레임 동기화; 채널 ECC 디코더가 아니라 동기화 알고리즘, 떼어낼 부호/디코더 기법 없음
- **ID**: ieee:9674430
- **Type**: conference
- **Published**: 10-13 Dec.
...
- **Status**: ❌
- **Reason**: McEliece 기반 물리계층 보안 부호화; 보안 응용이며 표준 LDPC 사용, NAND ECC로 떼어낼 신규 디코더/구성 없음
- **ID**: ieee:9674295
- **Type**: conference
- **Published**: 10-13 Dec.
...
- **Status**: ❌
- **Reason**: 수중음향용 polar 부호 Monte Carlo 구성; 비-LDPC 부호이며 LDPC는 비교 베이스라인일 뿐
- **ID**: ieee:9674601
- **Type**: conference
- **Published**: 10-13 Dec.
...
- **Status**: ❌
- **Reason**: H.265 영상 LDPC 불균등오류보호(UEP); 응용 특이적 계층화 전송, 떼어낼 ECC 디코더/구성 기법 없음
- **ID**: ieee:9674644
- **Type**: conference
- **Published**: 10-13 Dec.
...
- **Status**: ❌
- **Reason**: OFDM 블라인드 채널추정에 LDPC 하드디시전 피드백 활용; 채널추정 알고리즘이며 떼어낼 디코더/코드 기법 없음
- **ID**: ieee:9674615
- **Type**: conference
- **Published**: 10-13 Dec.
...
- **Status**: ❌
- **Reason**: 무선 IoT 패킷 스케줄링 POMDP; LDPC 무관, ECC 기법 없음
- **ID**: ieee:9674485
- **Type**: conference
- **Published**: 10-13 Dec.
...
- **Status**: ✅
- **Reason**: 플래시 storage refresh로 LDPC 디코딩 지연 완화 — NAND/SSD 직접(A)
- **ID**: ieee:9680340
- **Type**: conference
- **Published**: 10-12 Dec.
...
- **Status**: ✅
- **Reason**: LDPC용 BP-CNN 신경망 디코더, BatchNorm으로 BP 개선 — 이식 가능 디코더(C)
- **ID**: ieee:9689078
- **Type**: conference
- **Published**: 1-2 Dec. 2

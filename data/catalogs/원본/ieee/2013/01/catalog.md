...
- **Status**: ❌
- **Reason**: 멀티미디어 압축·통신 에너지효율 서베이, 이식할 LDPC ECC 기법 없음
- **ID**: ieee:6226793
- **Type**: journal
- **Published**: Third Quar
- **Authors**: Tao Ma, Michael Hempel, Dongming Peng +1
- **PDF**: https://ieeexplore.ieee.org/document/6226793
...
- **Status**: ✅
- **Reason**: LDPC 에러플로어 완화용 신규 직렬 부호결합(SCC) 전략 — E(error floor) 이식 가능
- **ID**: ieee:6601080
- **Type**: journal
- **Published**: Spring 201
- **Authors**: Damian Morero, Mario Hueda
- **PDF**: https://ieeexplore.ieee.org/document/6601080
...
- **Status**: ❌
- **Reason**: Pilot-aided LLR for optical MPSK-OFDM with laser phase noise; channel/modulation-specific LLR derivation, no portable NAND ECC technique
- **ID**: ieee:6472045
- **Type**: journal
- **Published**: March15, 2
- **Authors**: Shengjiao Cao, Pooi-Yuen Kam, Changyuan Yu
- **PDF**: https://ieeexplore.ieee.org/document/6472045
...
- **Status**: ❌
- **Reason**: 비이진 column-scaled LDPC 인코딩/디코딩, non-binary GF(2^p)로 제외 대상
- **ID**: ieee:6336756
- **Type**: journal
- **Published**: January 20
- **Authors**: Shancheng Zhao, Xiao Ma, Xiaoyi Zhang +1
- **PDF**: https://ieeexplore.ieee.org/document/6336756
...
- **Status**: ✅
- **Reason**: multi-edge-type 바이너리 LDPC 코드 설계(E)+다차원 EXIT 최적화로 유한길이 짧은 블록길이 달성, 이식 가능
- **ID**: ieee:6334510
- **Type**: journal
- **Published**: January 20
- **Authors**: Lei M. Zhang, Frank R. Kschischang
- **PDF**: https://ieeexplore.ieee.org/document/6334510
- **Abstract**: A method of designing low-density parity-check codes for bandwidth-efficient high-order modulation is proposed. A multi-edge-type LDPC code ensemble is used to improve the correspondence between modulation bit-channel capacity and bit-level protection in a bit-interleaved coded modulation system. A key innovation is the development of a multi-dimensional extrinsic information transfer (EXIT) vector field technique for the analysis and design of multi-edge-type codes. A condition, sufficient for the decoder to converge, is derived on the multi-dimensional EXIT vector field, and this condition is used as a constraint in code optimization. Code designs indicate that the proposed method produces codes matching the performance of codes designed using best available methods in ensemble threshold, and is capable of achieving identical finite-length error rates with shorter block-lengths. In addition to simplified design complexity, the resulting codes allow for low-complexity implementation and rate-adaptivity, and hence are well-suited for adaptive modulation systems.

## A Simplified Min-Sum Decoding Algorithm for Non-Binary LDPC Codes

- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC min-sum 디코더 — 바이너리 한정 기준에서 제외
- **ID**: ieee:6336760
- **Type**: journal
- **Published**: January 20
- **Authors**: Chung-Li Wang, Xiaoheng Chen, Zongwang Li +1
- **PDF**: https://ieeexplore.ieee.org/document/6336760
...
- **Status**: ✅
- **Reason**: NAND 플래시 임계전압 분포 추정→연판정 ECC 최적화, A 직접 해당
- **ID**: ieee:6320667
- **Type**: journal
- **Published**: Jan.15, 20
- **Authors**: Dong-hwan Lee, Wonyong Sung
- **PDF**: https://ieeexplore.ieee.org/document/6320667
...
- **Status**: ✅
- **Reason**: EG-LDPC 다수결논리 디코딩 조기 에러검출로 메모리 접근시간 단축 — 디코더/HW 기법 이식 가능(C/D)
- **ID**: ieee:6121923
- **Type**: journal
- **Published**: Jan. 2013
- **Authors**: Pedro Reviriego, Juan A. Maestro, Mark F. Flanagan
- **PDF**: https://ieeexplore.ieee.org/document/6121923
...
- **Status**: ❌
- **Reason**: BEC에서 BP의 유한블록길이 보정 상수 α(ε,t) 유도. 순수 분석 이론으로 디코더/HW/구성 신규 기여 없음.
- **ID**: ieee:6303915
- **Type**: journal
- **Published**: Jan. 2013
- **Authors**: Ryuhei Mori, Toshiyuki Tanaka, Kenta Kasai +1
- **PDF**: https://ieeexplore.ieee.org/document/6303915
...
- **Status**: ❌
- **Reason**: 비이진 LDPC LP 디코딩(FFT 기반) — 바이너리 한정 기준에서 제외
- **ID**: ieee:6261547
- **Type**: journal
- **Published**: Jan. 2013
- **Authors**: Dina Goldin, David Burshtein
- **PDF**: https://ieeexplore.ieee.org/document/6261547
...
- **Status**: ❌
- **Reason**: 60GHz CMOS 트랜시버; LDPC 디코더는 부수 언급(전력수치만), 신규 디코더/HW 아키텍처 기여 없음.
- **ID**: ieee:6339016
- **Type**: journal
- **Published**: Jan. 2013
- **Authors**: Kenichi Okada, Keitarou Kondou, Masaya Miyahara +22
- **PDF**: https://ieeexplore.ieee.org/document/6339016
...
- **Status**: ❌
- **Reason**: 네트워크 코딩 이론 서베이. 구체적 신규 디코더/구성/HW 기여 없음.
- **ID**: ieee:6463375
- **Type**: journal
- **Published**: Fourth Qua
- **Authors**: Riccardo Bassoli, Hugo Marques, Jonathan Rodriguez +2
- **PDF**: https://ieeexplore.ieee.org/document/6463375
...
- **Status**: ❌
- **Reason**: 광 OFDM BICM-ID 코딩변조 실험 시연, LDPC 베이스라인 응용, 신규 디코더/구성 없음
- **ID**: ieee:6290330
- **Type**: journal
- **Published**: Feb.15, 20
- **Authors**: T. H. Lotz, X. Liu, S. Chandrasekhar +6
- **PDF**: https://ieeexplore.ieee.org/document/6290330
...
- **Status**: ❌
- **Reason**: FEC 성능 추정 방법론(QC-LDPC는 단순 대상), 떼어낼 디코더·HW·코드설계 기여 없음
- **ID**: ieee:6654252
- **Type**: journal
- **Published**: Dec.15, 20
- **Authors**: Nebojsa Stojanovic, Yu Zhao, Deyuan Chang +2
- **PDF**: https://ieeexplore.ieee.org/document/6654252
...
- **Status**: ❌
- **Reason**: TDS-OFDM 압축센싱 채널추정, LDPC 기법 무관
- **ID**: ieee:6605639
- **Type**: journal
- **Published**: Dec.1, 201
- **Authors**: Linglong Dai, Jintao Wang, Zhaocheng Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/6605639
...
- **Status**: ❌
- **Reason**: GF(q) non-binary LDPC stochastic 디코더 — 비이진 제외 대상
- **ID**: ieee:6519310
- **Type**: journal
- **Published**: Aug.15, 20
- **Authors**: Alexandru Ciobanu, Saied Hemati, Warren J. Gross
- **PDF**: https://ieeexplore.ieee.org/document/6519310
- **Abstract**: We propose a non-binary stochastic decoding algorithm for low-density parity-check (LDPC) codes over ${\rm GF}(q)$ with degree two variable nodes, called Adaptive Multiset Stochastic Algorithm (AMSA). The algorithm uses multisets, an extension of sets that allows multiple occurrences of an element, to represent probability mass functions that simplifies the structure of the variable nodes. The run-time complexity of one decoding cycle using AMSA is  $O(q)$ for conventional memory architectures, and $O(1)$ if a custom memory architecture is used. Two fully-parallel AMSA decoders are implemented on FPGA for two (192,96) (2,4)-regular codes over GF(64) and GF(256), both achieving a maximum clock frequency of 108 MHz. The GF(64) decoder has a coded throughput of 65 Mb/s at $E_{b}/N_{0}={\hbox{2.4 dB}}$ when using conventional memory, while a decoder using the custom memory version can achieve 698 Mb/s at the same  $E_{b}/N_{0}$. At a frame error rate (FER) of $2\times 10^{-6}$  the GF(64) version of the algorithm is only 0.04 dB away from the floating-point SPA performance, and for the GF(256) code the difference is 0.2 dB. To the best of our knowledge, this is the first fully parallel non-binary LDPC decoder over GF(256) reported in the literature.
...
- **Status**: ❌
- **Reason**: irregular non-binary QC-LDPC 광전송 coded modulation — 비이진 LDPC, 응용 특이적
- **ID**: ieee:6552958
- **Type**: journal
- **Published**: Aug.15, 20
- **Authors**: Ivan B. Djordjevic
- **PDF**: https://ieeexplore.ieee.org/document/6552958
...
- **Status**: ✅
- **Reason**: 병렬 LDPC 디코더 충돌없는 on-chip 메모리 매핑 다항시간 알고리즘 — 병렬화 HW 기법 D
- **ID**: ieee:6517513
- **Type**: journal
- **Published**: Aug.15, 20
- **Authors**: Awais Hussain Sani, Philippe Coussy, Cyrille Chavet
- **PDF**: https://ieeexplore.ieee.org/document/6517513
...
- **Status**: ❌
- **Reason**: FD MU-MIMO precoding 스펙트럼/에너지 효율 — LDPC 무관, ECC 기법 없음
- **ID**: ieee:6529189
- **Type**: journal
- **Published**: Aug.15, 20
- **Authors**: Dan Nguyen, Le-Nam Tran, Pekka Pirinen +1
- **PDF**: https://ieeexplore.ieee.org/document/6529189
...
- **Status**: ✅
- **Reason**: EG-LDPC용 Majority Logic Detector/Decoder(MLDD)로 검출시간 단축 - 메모리 ECC 디코더 HW 기법(A/C/D), NAND 인접 적용 가능
- **ID**: ieee:6466152
- **Type**: conference
- **Published**: 4-6 Jan. 2
- **Authors**: M. A. Jayarani, M. Jagadeeswari
- **PDF**: https://ieeexplore.ieee.org/document/6466152
...
- **Status**: ✅
- **Reason**: STT-MRAM용 short LDPC + RB-MS 디코딩 + capacity-max 양자화 설계, 메모리 ECC로 NAND 이식 가능(B/C)
- **ID**: ieee:6504145
- **Type**: conference
- **Published**: 28-31 Jan.
- **Authors**: Kui Cai, Zhiliang Qin, Bingjin Chen
- **PDF**: https://ieeexplore.ieee.org/document/6504145
...
- **Status**: ❌
- **Reason**: polar codes 서베이(데이터 스토리지 적합성 조사). 비-LDPC 부호 + 서베이로 원칙 제외, 떼어낼 신규 LDPC BP 디코더 기법 없음
- **ID**: ieee:6504198
- **Type**: conference
- **Published**: 28-31 Jan.
- **Authors**: Gabi Sarkis, Warren J. Gross
- **PDF**: https://ieeexplore.ieee.org/document/6504198
...
- **Status**: ❌
- **Reason**: Q-ary(비이진 GF(q)) LDPC 디코더 복잡도 감소. 비이진 LDPC는 제외 대상
- **ID**: ieee:6488335
- **Type**: conference
- **Published**: 27-30 Jan.
- **Authors**: X. H. Shen, F. C. M. Lau
- **PDF**: https://ieeexplore.ieee.org/document/6488335
- **Abstract**: Q-ary low-density parity-check (LDPC) codes achieve exceptional error performance at the expense of computation simplicity. Solutions to accelerate the decoding process have become one of the focuses in literature. In this paper, a decoding method is proposed, based on the subcode concept, to speed up the dominant iterative process. The method leads to speed improvement with moderate error-performance penalty.

## A 6.72-Gb/s, 8pJ/bit/iteration WPAN LDPC decoder in 65nm CMOS

- **Status**: ✅
- **Reason**: D. WPAN용 65nm LDPC 디코더이나 modified-PCM 메시지 permutation 전략은 NAND 디코더 HW에 이식 가능
- **ID**: ieee:6509569
- **Type**: conference
- **Published**: 22-25 Jan.
- **Authors**: Zhixiang Chen, Xiao Peng, Xiongxin Zhao +3
- **PDF**: https://ieeexplore.ieee.org/document/6509569
...
- **Status**: ✅
- **Reason**: A. SSD용 error-prediction LDPC 아키텍처+VTH/retention 기반 보정, NAND 직접
- **ID**: ieee:6509567
- **Type**: conference
- **Published**: 22-25 Jan.
- **Authors**: Shuhei Tanakamaru, Yuki Yanagihara, Ken Takeuchi
- **PDF**: https://ieeexplore.ieee.org/document/6509567
...
- **Status**: ❌
- **Reason**: joint source-channel coding용 multi-edge LDPC 최적화; JSCC는 떼어낼 채널 ECC 기법 없음(제외 대상)
- **ID**: ieee:6469353
- **Type**: conference
- **Published**: 21-24 Jan.
- **Authors**: H. V. Beltrao Neto, W. Henkel
- **PDF**: https://ieeexplore.ieee.org/document/6469353
...
## Hierarchical Modulation to Support Low-Density Parity-Check Code Design?

- **Status**: ✅
- **Reason**: 계층 변조에 최적화된 irregular LDPC의 변수노드 차수분포 LP 설계; 바이너리 LDPC 코드설계(E) 기법 이식 가능성으로 살림
- **ID**: ieee:6469347
- **Type**: conference
- **Published**: 21-24 Jan.
- **Authors**: Alexandra Filip, Werner Henkel
- **PDF**: https://ieeexplore.ieee.org/document/6469347
- **Abstract**: We study variable node degree distributions resulting from a linear programming approach for designing a lowdensity parity-check (LDPC) code optimized for an irregular modulation alphabet. We opt for an irregular LDPC code and make use of the irregularities of the channel in the sense of different modulation classes originating especially from different distances in a hierarchical modulation signal set. Our aim is to investigate if differences in equivalent binary channels as given by hierarchical modulation signal sets would in any way support resulting variable node degree distributions.

## Breaking Cycles with Dummy Bits: Improved Rate-Compatible LDPC Codes with Short Block Lengths

- **Status**: ✅
- **Reason**: E. dummy bit 삽입으로 short cycle 제거하는 rate-compatible LDPC 구성 신규 기법
- **ID**: ieee:6468978
- **Type**: conference
- **Published**: 21-24 Jan.
- **Authors**: Moritz Beermann, Peter Vary
- **PDF**: https://ieeexplore.ieee.org/document/6468978
...
- **Status**: ❌
- **Reason**: turbo-like NC-HARQ 반복 디코딩, 비-LDPC product/turbo 기법으로 LDPC BP에 비의존
- **ID**: ieee:6468984
- **Type**: conference
- **Published**: 21-24 Jan.
- **Authors**: Yidong Lang, Dirk Wubben, Armin Dekorsy +2
- **PDF**: https://ieeexplore.ieee.org/document/6468984
...
- **Status**: ❌
- **Reason**: polar-coded modulation 설계; polar 부호 기반이고 LDPC BP 이식 가능한 디코더 기법 없음
- **ID**: ieee:6469346
- **Type**: conference
- **Published**: 21-24 Jan.
- **Authors**: Mathis Seidl, Andreas Schenk, Clemens Stierstorfer +1
- **PDF**: https://ieeexplore.ieee.org/document/6469346
...
- **Status**: ❌
- **Reason**: MIMO 부분 코히어런트 채널의 ST 성좌 설계; LDPC/디코더/HW 기여 없음, 무선 응용 특이적
- **ID**: ieee:6469325
- **Type**: conference
- **Published**: 21-24 Jan.
- **Authors**: Animesh Yadav, Markku Juntti, Jorma Lilleberg
- **PDF**: https://ieeexplore.ieee.org/document/6469325
...
- **Status**: ❌
- **Reason**: 협업필터링 추천용 factor graph BP; ECC 부호와 무관한 추론 응용, 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:6691241
- **Type**: conference
- **Published**: 2013
- **Authors**: J. Zou, A. Einolghozati, E. Ayday +1
- **PDF**: https://ieeexplore.ieee.org/document/6691241
...
- **Status**: ❌
- **Reason**: 클라우드 모바일망 백홀/RAN 공동설계 개관, turbo/네트워크코딩 언급뿐 LDPC ECC 기법 없음
- **ID**: ieee:6633538
- **Type**: conference
- **Published**: 2013
- **Authors**: C. J. Bernardos, A. De Domenico, J. Ortin +2
- **PDF**: https://ieeexplore.ieee.org/document/6633538
...
- **Status**: ❌
- **Reason**: 전자여권 워터마킹 패리티검사; ECC 채널코딩 아님, LDPC 무관
- **ID**: ieee:6846575
- **Type**: conference
- **Published**: 2013
- **Authors**: Z. Wang, L. Yang, Y. Cheng +1
- **PDF**: https://ieeexplore.ieee.org/document/6846575
...
## Systematics teaching in communication theory and system

- **Status**: ❌
- **Reason**: 통신이론 교육과정 설계 논문, 기술 기여 없음
- **ID**: ieee:6553984
- **Type**: conference
- **Published**: 2013
- **Authors**: C. P. Hou, H. Wu, Q. Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/6553984
- **Abstract**: The courses on communication theory, system and technology are very important and indispensable fundamental courses in communication, electronic and information related field. For communication theory and system class teaching, three kinds of coursed design are introduced in this paper, where the fundamental concepts and theories for undergraduate students, the deep understanding and system concept for master of science students, and the practical design and realization for master of engineering students. The course contents for each kind of students are introduced both in Syllabus and in experiment examples. All the course design and division are derived and verified to be effective from our long term teaching practice.

## A memory reduced stack algorithm for MIMO detection

- **Status**: ❌
- **Reason**: MIMO 검출용 stack 알고리즘 메모리 절감, LDPC ECC 비관련
- **ID**: ieee:6664066
- **Type**: conference
- **Published**: 2013
- **Authors**: Z. Yue, G. He, J. Ma +1
- **PDF**: https://ieeexplore.ieee.org/document/6664066
...
- **Status**: ❌
- **Reason**: 광전송 용량 필드 트라이얼 데모, LDPC 신규 기법 없음
- **ID**: ieee:6533224
- **Type**: conference
- **Published**: 2013
- **Authors**: T. J. Xia, G. A. Wellbrock, A. Tanaka +10
- **PDF**: https://ieeexplore.ieee.org/document/6533224
- **Abstract**: 40.5 Tb/s over 1,822 km and 54.2 Tb/s over 634 km field SSMF was realized using 41 Nyquist rate DP-8QAM and DP-16QAM superchannels. They are the highest field capacities for long-haul and regional distances achieved so far.

## A novel peak-to-average power ratio reduction method for amplitude phase shift keying

- **Status**: ❌
- **Reason**: OFDM/APSK PAPR 저감 기법, LDPC/ECC 무관 무선 응용
- **ID**: ieee:6533617
- **Type**: conference
- **Published**: 2013
- **Authors**: J. Wang, Z. Liu, Z. Luo +1
- **PDF**: https://ieeexplore.ieee.org/document/6533617
- **Abstract**: Orthogonal frequency division multiplexing (OFDM) is one of the key technologies adopted in modern communication systems. However, it suffers from high peak-to-average power ratio (PAPR) problem, which limits the efficiency of the power amplifier (PA). This paper presents a novel PAPR reduction method for amplitude phase shift keying (APSK) modulation. The amplitude of the transmit signal in time domain is firstly limited and afterwards the corresponding constellation points in frequency domain are dynamically extended to mitigate the distortion caused by the amplitude clipping. Simulation results show that the proposed scheme alleviates the PAPR problem substantially without sacrificing the error-rate performance.

## Fixed scenario reception of DVB-T2 signal in urban area

- **Status**: ❌
- **Reason**: DVB-T2 도시 수신 현장 측정, ECC 기법 기여 없음
- **ID**: ieee:6658359
- **Type**: conference
- **Published**: 2013
- **Authors**: I. Bacic, E. Dumic, K. Malaric
- **PDF**: https://ieeexplore.ieee.org/document/6658359
- **Abstract**: In this paper, we present the measurement of the signal transmitted in the second generation digital terrestrial television standard in urban area. The transmitter was located at the Sljeme hill in Zagreb, Croatia and measurements were carried out at different locations in the city of Zagreb, Croatia. The channel power, the constellation graph and the bit error rate were recorded at every measurement points as well as the channel impulse and frequency response. Measurements were done via a common log periodic antenna and a professional receiver with signal analyzer. The minimum channel power interval for error free communication was detected.

## Optimized packet size for energy efficient delay-tolerant sensor networks with FEC

- **Status**: ❌
- **Reason**: 센서망 패킷크기 최적화용 FEC 에너지효율 비교, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:6578275
- **Type**: conference
- **Published**: 2013
- **Authors**: K. Lendvai, Á. Milánkovich, S. Imre +1
- **PDF**: https://ieeexplore.ieee.org/document/6578275
- **Abstract**: Optimization of wireless smart metering systems requires an entirely different approach compared to traditional communication networks. For devices operating without external power supply energy efficiency is a key factor, because it will determine the duration of operation time without external intervention. The data packets are less sensitive for delay, hence it is possible to wait for more measurement records and send them aggregated. In this paper we compare different FEC algorithms according to their energy efficiency and the optimal number of measurement records is determined to be aggregated into one packet considering the quality of the wireless channel.
...
- **Status**: ❌
- **Reason**: MIMO BICMB-OFDM 프리코딩 다이버시티; 무선 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:6831639
- **Type**: conference
- **Published**: 2013
- **Authors**: B. Li, E. Ayanoglu
- **PDF**: https://ieeexplore.ieee.org/document/6831639
...
- **Status**: ❌
- **Reason**: 터보부호 LP 디코딩 알고리즘으로 trellis 기반이라 바이너리 LDPC BP에 이식 불가, 비-LDPC 원칙 제외
- **ID**: ieee:6620475
- **Type**: conference
- **Published**: 2013
- **Authors**: M. Helmling, S. Ruzika
- **PDF**: https://ieeexplore.ieee.org/document/6620475
...
## Teaching information theory via a simulation tool for communications systems

- **Status**: ❌
- **Reason**: 정보이론 교육용 시뮬레이션 툴, ECC 기법 없음
- **ID**: ieee:6530098
- **Type**: conference
- **Published**: 2013
- **Authors**: I. Alustiza, M. Hernaez, X. Insausti +1
- **PDF**: https://ieeexplore.ieee.org/document/6530098
- **Abstract**: In this paper, an interactive tool for learning the fundamental concepts of communications systems from an information theory point of view is presented. This tool is composed of two parts: a C++ library and a Graphical User Interface application in Matlab. The C++ library is designed following an object-oriented structure and is fully scalable (it is open for future updates). The Matlab-GUI application is a friendly interface that aids undergraduate students to understand the theory. Some of the tool's capabilities are illustrated through classroom examples. In addition, this tool is designed to improve the students' theoretical knowledge of information theory.

## Stability control of power adaptation in wireless communication system

- **Status**: ❌
- **Reason**: 무선 적응전력 제어 BER 안정화; ECC·LDPC 기법 없음
- **ID**: ieee:6885084
- **Type**: conference
- **Published**: 2013
- **Authors**: Tong Tingting, Song Xiaoqin, Niu YingTao +1
- **PDF**: https://ieeexplore.ieee.org/document/6885084
- **Abstract**: The adaptive power adjustment technology can significantly enhance the adaptive ability for environment and electromagnetic compatibility of wireless communication system, which can save a lot of power. However, the bit error rate (BER) performance of system may be unstable when the environment changes rapidly. To improve the BER stability of wireless communication system with adaptive power adjustment, this paper introduces a state feedback controller with integrator to the power control in the system. Theory and simulation shows that the BER can be quickly stabilized at the target value when the system is subjected to a sudden interference.

## A novel 60 GHz short range Gigabit wireless access system using a large array antenna

- **Status**: ❌
- **Reason**: 60GHz 어레이 안테나 무선접속 시스템; ECC/LDPC 무관 RF 하드웨어 논문
- **ID**: ieee:6717637
- **Type**: conference
- **Published**: 2013
- **Authors**: M. Zhang, J. Hirokawa, M. Ando +3
- **PDF**: https://ieeexplore.ieee.org/document/6717637
...
## Multiple packet reception in asynchronous wireless networks

- **Status**: ❌
- **Reason**: 비동기 무선 MPR/SIC 결합 디코딩, 채널코딩 응용 특이적, 이식 가능 LDPC 기법 없음
- **ID**: ieee:6504242
- **Type**: conference
- **Published**: 2013
- **Authors**: A. Argyriou
- **PDF**: https://ieeexplore.ieee.org/document/6504242
- **Abstract**: In this paper we present a scheme for multiple-packet reception (MPR) that allows the concurrent packet transmission from several asynchronous users and is based on a new algorithm for successive interference cancellation (SIC). Transmitted signals are superimposed at the destination nodes and also at a relay node. The system model allows for the transmitted packets to be superimposed asynchronously with an arbitrary pattern at each node that receives them. For the final version of the proposed scheme we present a joint MPR and channel decoding algorithm.

## Soft-input soft-output linear programming decoding for spread spectrum underwater acoustic communications

- **Status**: ✅
- **Reason**: SISO LP 디코더 제안 - pseudo-codeword 기반 soft정보가 BP보다 우수한 채널추정. 부호 비의존 LP 디코딩 기법으로 바이너리 LDPC 이식 가능(C)
- **ID**: ieee:6810498
- **Type**: conference
- **Published**: 2013
- **Authors**: E. L. Daly
- **PDF**: https://ieeexplore.ieee.org/document/6810498
- **Abstract**: This paper presents the soft-input soft-output (SISO) linear programming (LP) decoder. It is shown that the soft information gleaned from a pseudo-codeword solution to the LP optimization is not only useful, but that it can be used to form a superior channel estimate compared to the output from a SISO belief propagation (BP) decoder in certain situations.

## On the LDPC-coded modulation for ultra-high-speed optical transport in the presence of phase noise

- **Status**: ❌
- **Reason**: 위상잡음 하 coded modulation의 심볼 LLR 계산(Monte Carlo), 채널 특이적 LLR이고 NAND 이식 디코더/구성 기법 없음
- **ID**: ieee:6532737
- **Type**: conference
- **Published**: 2013
- **Authors**: I. B. Djordjevic, Ting Wang
- **PDF**: https://ieeexplore.ieee.org/document/6532737
- **Abstract**: A Monte Carlo integration based method to calculate symbol log-likelihood ratios for soft iterative decoding in the presence of imperfect carrier phase estimation (CPE) is proposed. The proposed method shows good robustness when CPE is imperfect, in particular for optimum modulation schemes.

## Trapping set structure of LDPC codes on finite geometries

- **Status**: ✅
- **Reason**: FG-LDPC trapping set 구조 기하학적 분석, error floor 관련 바이너리 코드설계(E) 이식 가능
- **ID**: ieee:6502922
- **Type**: conference
- **Published**: 2013
- **Authors**: Q. Diao, Y. Y. Tai, S. Lin +1
- **PDF**: https://ieeexplore.ieee.org/document/6502922
- **Abstract**: The trapping set structure of LDPC codes constructed based on finite geometries, called finite geometry (FG) LDPC codes, is analyzed using a geometric approach. In this approach, trapping sets in the Tanner graph of an FG-LDPC code are represented by subgeometries of the geometry based on which the code is constructed. Using this geometrical representation, bounds and configurations of trapping sets of an FG-LDPC code can be derived and analyzed.

## Trapping set structure of LDPC codes on finite geometries

- **Status**: ✅
- **Reason**: FG-LDPC trapping set 구조의 기하학적 분석·bound 도출 → error floor·코드설계(E) 이식 가능, 바이너리 LDPC
- **ID**: ieee:6502951
- **Type**: conference
- **Published**: 2013
- **Authors**: Q. Diao, Y. Y. Tai, S. Lin +1
- **PDF**: https://ieeexplore.ieee.org/document/6502951
- **Abstract**: The trapping set structure of LDPC codes constructed based on finite geometries, called finite geometry (FG) LDPC codes, is analyzed using a geometric approach. In this approach, trapping sets in the Tanner graph of an FG-LDPC code are represented by subgeometries of the geometry based on which the code is constructed. Using this geometrical representation, bounds and configurations of trapping sets of an FG-LDPC code can be derived and analyzed.

## Fault scanning and repairing in processor based system using dynamic reconfiguration

- **Status**: ❌
- **Reason**: FPGA BIST/결함복구 논문, EG-LDPC를 출력 검증용으로 단순 사용할 뿐 새 디코더/구성 기여 없음
- **ID**: ieee:6623013
- **Type**: conference
- **Published**: 2013
- **Authors**: G. Gowtham Raj, B. Kannan, T. Aravind
- **PDF**: https://ieeexplore.ieee.org/document/6623013
- **Abstract**: In this paper, a new method of fault tolerance technique through dynamic reconfiguration is achieved in Processor based System. There involves two parts of technique Fault detection and Fault recover. First, a new reseeding architecture for scan based built - in self-set (BIST), which uses a linear feedback shift register (LFSR) as test pattern generator is proposed. Multiple cells of the LFSR are utilized as sources for feeding the scan chain of the circuit under test in different test phases. The LFSR generates the same state sequence in all phases, keeping that way the implementation cost low. A seed - selection algorithm is furthermore presented that, taking advantage of the multiphase architecture, manages to significantly reduce the number of the required seeds for achieving complete (100%) fault coverage. Then simple LDPC codes based on Euclidean geometries (EG-LDPC) are included to verify whether the TPG output is correctly fed to processor which is the circuit under test (CUT). The main goal of testing and diagnostic process of CUT is achieved by the mechanism of Roving Self-Testing Area (Roving STAR).This process takes place in self-test areas of FPGA without affecting normal system operation. By this way entire chip is tested by roving the STARs across FPGA. In case of occurrence of any fault the ORA gives the fail response to memory unit, then memory unit fed the correct output from LUT for particular clock cycle.

## Performance anaylisis of implementation Dvb-t2 network in ulaanbaatar

- **Status**: ❌
- **Reason**: DVB-T2 방송망 계획; ECC 신규 기법 없음
- **ID**: ieee:6616884
- **Type**: conference
- **Published**: 2013
- **Authors**: C. Naimannaran, E. Badarch
- **PDF**: https://ieeexplore.ieee.org/document/6616884
- **Abstract**: The DVB-T2 network planning procedure is the most important issue in the transition period from analog to digital TV broadcasting system in Mongolia. In this paper, we present the implementation model of DVB-T2 network and performance analysis in Ulaanbaatar. Experimental results shows that our method can solve the problem in the transition period from analog to digital TV broadcasting system in Mongolia.

## Two-layer rateless codes over lattices for Gaussian broadcast channels

- **Status**: ❌
- **Reason**: Gaussian broadcast용 rateless coset/lattice 코드; 무선 전송 스킴, 바이너리 LDPC ECC 기법 아님
- **ID**: ieee:6710317
- **Type**: conference
- **Published**: 2013
- **Authors**: S. Zhao, X. Ma, K. Zhang +1
- **PDF**: https://ieeexplore.ieee.org/document/6710317
- **Abstract**: In this paper, we present a class of rateless coset codes, which consists of two layers. The first layer is protected by a systematic lattice-Kite code, which takes as input a sequence of coset leaders and delivers as output a sequence of coset leaders with redundancy. The second layer is for shaping, which can be implemented by using a (possibly coded) binary sequence to select lattice points from each coset. Based on the presented two-layer lattice-Kite code, we propose a rateless transmission scheme for two-user Gaussian broadcast channels (TU-GBC), where the common information and the private information are carried by the first layer and the second layer, respectively. The proposed scheme allows the user with good channel conditions to collect more private information. Simulation results are given to show the effectiveness of the proposed rateless transmission scheme.

## Improved joint source-channel coding based on SPIHT

- **Status**: ❌
- **Reason**: SPIHT 기반 JSCC + 불균등보호. LDPC는 베이스라인 채널코딩으로만 쓰임, 떼어낼 신규 ECC 기법 없음
- **ID**: ieee:6757951
- **Type**: conference
- **Published**: 2013
- **Authors**: Aili Wang, Meng Wei, Hongyong Gan
- **PDF**: https://ieeexplore.ieee.org/document/6757951
- **Abstract**: This paper presents a joint source-channel coding scheme of improved SPIHT algorithm combined with unequal error protection. Source coding to improve the SPIHT algorithm, the L set materiality judgment, using Z scanning sequence, highlights the low frequency information, important degree, preferred to scan frequency; channel coding by irregular quasi-cyclic, using different code rate and the number of iterations code, the full implementation of unequal error protection of important information, secondary information and other important information, have extremely strong error control. Simulation results show that, the united coding algorithm with quality performance in low SNR, at high SNR, and can realize and performance error protection is basically the same, the SNR curve, the effect is quite prominent.

## A MIMO SFBC OFDM scheme for transmission of watermarked medical images over frequency-selective fading channels

- **Status**: ❌
- **Reason**: MIMO SFBC OFDM 워터마크 의료영상 전송; LDPC 무관 무선 전송 스킴
- **ID**: ieee:6731212
- **Type**: conference
- **Published**: 2013
- **Authors**: P. K. Korrai, M. N. S. Swamy, K. Deergha Rao
- **PDF**: https://ieeexplore.ieee.org/document/6731212
- **Abstract**: Digital watermarking is a technique adapted to embed patient information as watermark with medical images to reduce storage and transmission overheads. A multiple-input multiple-output (MIMO) transmission scheme in which multiple antennas are used in both transmitter and receiver has emerged as one of the most significant technical breakthroughs in modern wireless communications. This paper presents a MIMO SFBC OFDM scheme for transmission of watermarked medical images over frequency-selective fading channels and its performance is analyzed in comparison with SISO-OFDM using MMSE V-BLAST based detection at the receiver. The efficacy of the proposed scheme is illustrated with implementation results on two watermarked medical images.

## And now to something completely different: Spatial coupling as a proof technique

- **Status**: ❌
- **Reason**: spatial coupling을 증명기법으로 쓴 순수 이론(Maxwell conjecture, interpolation), 디코더/HW/구성 신규 기여 없음 제외
- **ID**: ieee:6620665
- **Type**: conference
- **Published**: 2013
- **Authors**: A. Giurgiu, N. Macris, R. Urbanke
- **PDF**: https://ieeexplore.ieee.org/document/6620665
...
## Experimental analysis of single carrier POLQAM (6Pol-QPSK) transmission with soft-decoding

- **Status**: ❌
- **Reason**: POLQAM 전용 soft-decoding/EXIT chart 최적화 LDPC; 광통신 응용 특이적, 떼어낼 NAND ECC 기법 없음
- **ID**: ieee:6647508
- **Type**: conference
- **Published**: 2013
- **Authors**: H. Bülow, X. Lu, L. Schmalen
- **PDF**: https://ieeexplore.ieee.org/document/6647508
- **Abstract**: At 28-Gbaud soft-coded POLQAM exhibits measured coding gain improvements of 1.5dB and 3.1dB for 12.5% and 30% code overhead, respectively, when moving from hard decision to soft decision FEC. Iterative demapping was mandatory to decode the LDPC code which was optimized for POLQAM by EXIT chart technique.

## Transmission of a 1.1 Tb/s super channel in 100 GHz optical bandwidth based on PM-256 QAM and spatially coupled FEC

- **Status**: ❌
- **Reason**: PM-256QAM + 표준 SC-LDPC를 iterative demod에 그대로 사용, 신규 코드 구성 없음
- **ID**: ieee:6647584
- **Type**: conference
- **Published**: 2013
- **Authors**: R. Dischler, L. Schmalen
- **PDF**: https://ieeexplore.ieee.org/document/6647584
- **Abstract**: We demonstrate generation and transmission of PM-256 QAM signals at a symbol rate of 14.1 GBd in a 20-GHz channel grid WDM scheme as a 1.1 Tb/s super channel. Application of spatially coupled LDPC coding with iterative demodulation reduces the required FEC overhead down to 21% compared to non-iterative schemes.

## Implementation of coded modulation and FEC

- **Status**: ✅
- **Reason**: LDPC convolutional(SC-LDPC) 기반 soft-decision FEC의 BICM 구현·복잡도 비교 — SC-LDPC 구성/HW 구현 측면(D/E) 이식 가능성, 애매하여 Phase3 재검토
- **ID**: ieee:6533101
- **Type**: conference
- **Published**: 2013
- **Authors**: D. Chang, Fan Yu, Zhiyu Xiao +5
- **PDF**: https://ieeexplore.ieee.org/document/6533101
- **Abstract**: We discuss implementation aspects of LDPC based soft-decision FEC schemes for high speed optical systems. Several BICM schemes with LDPC convolutional codes are proposed and compared in respects of both performance and implementation complexity.

## Optimization of high-order non-uniform QAM constellations

- **Status**: ❌
- **Reason**: 비균일 QAM constellation shaping 최적화, LDPC는 부수 언급이고 떼어낼 ECC 기법 없음 제외
- **ID**: ieee:6621711
- **Type**: conference
- **Published**: 2013
- **Authors**: J. Zoellner, N. Loghin
- **PDF**: https://ieeexplore.ieee.org/document/6621711
...
- **Status**: ❌
- **Reason**: 위성 주파수복구 알고리즘. LDPC는 부수 언급(BER 측정용)일 뿐 떼어낼 부호/디코더 기법 없음
- **ID**: ieee:6805819
- **Type**: conference
- **Published**: 2013
- **Authors**: J. Webber, M. Yofune, K. Yano +2
- **PDF**: https://ieeexplore.ieee.org/document/6805819
...
- **Status**: ❌
- **Reason**: 분산비디오코딩에서 LDPC/Turbo 채널코드를 단순 엔트로피코딩으로 대체하는 응용 논문, 떼어낼 LDPC 디코더/코드설계 기법 없음
- **ID**: ieee:6622739
- **Type**: conference
- **Published**: 2013
- **Authors**: Gengfeng Qiu, Shaoshuai Gao, Guofang Tu
- **PDF**: https://ieeexplore.ieee.org/document/6622739
...
- **Status**: ❌
- **Reason**: superposition HARQ의 비트-심볼 매핑(Gray) 연구, LDPC는 링크 시뮬 베이스라인일 뿐 떼어낼 부호/디코더 기법 없음
- **ID**: ieee:6554948
- **Type**: conference
- **Published**: 2013
- **Authors**: T. V. K. Chaitanya, E. G. Larsson
- **PDF**: https://ieeexplore.ieee.org/document/6554948
- **Abstract**: We consider the mapping of bits-to-superimposed constellation symbols in terms of the achievable rate on the channel for the HARQ system using superposition coding as proposed in [2]. We show that using a Gray mapping of bits-to-superimposed constellation symbols has better performance than the conventional natural mapping that results from superposition in signal space, for all the values of the superposition ratio. We also show through link-level simulations that the predicted gains in terms of achievable rate can be realized in practice using LDPC codes. Furthermore, we show that the optimal superposition ratio for the Gray mapping case results in conventional higher order constellation symbols after the superposition operation.

## Resource allocation for Type-I HARQ-based wireless networks with finite-length codes

- **Status**: ❌
- **Reason**: 무선 CAHN HARQ 자원할당; LDPC는 부수 언급, 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:6612000
- **Type**: conference
- **Published**: 2013
- **Authors**: S. Marcille, P. Ciblat, C. J. Le Martret
- **PDF**: https://ieeexplore.ieee.org/document/6612000
...
- **Status**: ❌
- **Reason**: sphere-packing bound 근사식 — 순수 이론 bound, LDPC는 부수 언급, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:6691845
- **Type**: conference
- **Published**: 2013
- **Authors**: F. Babich
- **PDF**: https://ieeexplore.ieee.org/document/6691845
- **Abstract**: The sphere-packing bound represents a suitable tool for assessing the limiting performance of a digital communication system. In fact, most of the modern transmission techniques, adopting capacity approaching codes, such as turbo codes, or Low Density Parity Check (LDPC) codes, may offer a performance that is within 1 dB from the bound, both for Additive White Gaussian Noise (AWGN) and for the fading channel. Unfortunately, the sphere-packing exponent may be difficult to compute, and this may prevent its adoption as a performance estimator. This paper presents and discusses the accuracy of an approximate expression of the bound, that may be used for evaluating the achievable performance of a communication system, without resorting to cumbersome simulations.
...
- **Status**: ✅
- **Reason**: 메모리용 EG-LDPC 기반 fault-secure encoder/decoder VLSI; 바이너리 LDPC 코드설계+HW 이식 가능
- **ID**: ieee:6678434
- **Type**: conference
- **Published**: 2013
- **Authors**: M. Chandrasekar, P. Dhinakar
- **PDF**: https://ieeexplore.ieee.org/document/6678434
- **Abstract**: Memory are largely affected by soft errors and do so the the encoder and decoder circuitry around the memory. In this paper we address the issue by going for a newly designed FSD with a new class of error correcting codes named EG-LDPC. The mechanism by which the codes detect faults is clearly demonstrated. Larger codes have been used in nano scale and brings about more reliability and low area overhead.

## Message passing soft decoding of linear block codes over arbitrary finite fields

- **Status**: ❌
- **Reason**: 임의 유한체 비이진 선형블록코드 디코딩(Hadamard 변환), 비이진/GF(q) 영역으로 제외 (바이너리 BP로 변환하나 비이진 코드 대상)
- **ID**: ieee:6642574
- **Type**: conference
- **Published**: 2013
- **Authors**: T. K. Moon, J. H. Gunther
- **PDF**: https://ieeexplore.ieee.org/document/6642574
...
- **Status**: ✅
- **Reason**: 공간결합(SC-LDPC) windowed decoding의 비균일 갱신 스케줄로 복잡도 50% 절감 — 이식 가능 디코더/코드설계 기법(C/E)
- **ID**: ieee:6831345
- **Type**: conference
- **Published**: 2013
- **Authors**: N. ul Hassan, A. E. Pusane, M. Lentmaier +2
- **PDF**: https://ieeexplore.ieee.org/document/6831345
...
- **Status**: ❌
- **Reason**: 계층변조 SFN용 SIC 복호, LDPC는 부수 언급일 뿐 떼어낼 ECC 기법 없음
- **ID**: ieee:6552336
- **Type**: conference
- **Published**: 2013
- **Authors**: Z. Hu, Hongxiang Li, Z. Chen
- **PDF**: https://ieeexplore.ieee.org/document/6552336
...
- **Published**: 2013
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/6617084
- **Abstract**: The following topics are dealt with: adaptive algorithms based-time iterative channel estimation; MC-IDMA system; Bluetooth receiver; extended Kalman filtering; 3GPP LTE; interference analysis; OFDM-IDMA system; fast fading multipath channel; cognitive radio network; concatenated coding scheme; Nakagami fading channel; high-powered long-range ZigBee device; cooperative spectrum sensing; multirelay switching; Internet of Things; DS-UWB radar; MHBCDA; mobility and heterogeneity aware bandwidth efficient cluster based data aggregation; wireless sensor network; digital beamforming quadrature amplitude modulation receiver; SIMO MRC SC-FDMA performance; mobile satellite channel; transport protocol; MOHRA; multiobjective hybrid routing algorithm; LDPC; 3D beamforming and smart antenna arrays.
...
- **Published**: 2013
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/6615494
- **Abstract**: The following topics are dealt with: information management system; UML; data mining; software design; XML; rule based clinical decision support system; spam detection; Website; SOA; fingerprint access control system; aspect oriented program; ontology; requirements engineering; software packaging; Web service; workflow management system; GPU; text mining; collaborative filtering; software reliability; middleware; computational complexity; LDPC code; Turbo code; SVM; fault tolerance; clustering algorithm; information security; satellite communication; cache simulation; image segmentation; recommendation system; image restoration; Internet; wireless sensor network; ZigBee; remote sensing image registration; case based reasoning; cloud computing; MIMO; speech emotion recognition; media streaming; radial line slot antenna; mobile device; computer vision; safety-critical system; GIS; E-commerce heterogeneous sensor network; and OFDM.

## [Copyright notice]

- **Status**: ❌
- **Reason**: 학회 copyright notice/목차 나열, 단일 논문 아님 — 떼어낼 기법 없음
- **ID**: ieee:6566224
- **Type**: conference
- **Published**: 2013
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/6566224
- **Abstract**: The following topics are dealt with: QoS awareness scheduling scheme; CR mobile ad hoc networks; quality of service differentiation measurement; 4G network; MIMO system equalization; flat fading; BAN application; channel allocation strategy; multihop cognitive radio networks; radiography image transmission; protograph double LDPC code; downlink control information design; GFSK phase estimation; extended Kalman filtering; nonGaussian noise; LTE-advanced channel coding generic procedure; privacy-enhanced LTE-AKA Wi-Fi; orthogonal wavefront-multiplexing architecture; VHF narrowband mobile ad-hoc network; wireless sensor node; HTTP traffic; independent component analysis; five-port receiver; RF device; electromagnetic emission; principal component analysis; OFDMA nonlinear distortion recovery; heterogeneous wireless sensor network; wireless cellular system; outage-aware power saving; cooperative routing algorithm; cell edge detection; interference avoidance scheme; closed mode LTE femtocell; network assisted power control; IEEE 802.11n performance evaluation; spatial spreading transceiver; adaptive stochastic-based M-ary modulation extension algorithm; mobile cloud computing selective service system; and blind timing synchronization.

## Table of contents

- **Status**: ❌
- **Reason**: 학술대회 목차(Table of contents); 논문 아님
- **ID**: ieee:6835522
- **Type**: conference
- **Published**: 2013
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/6835522
...
- **Status**: ❌
- **Reason**: 광전송용 다차원 벡터양자화 신호배치 설계, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:6542645
- **Type**: journal
- **Published**: 2013
- **Authors**: I. B. Djordjevic, A. Z. Jovanovic, M. Cvijetic +1
- **PDF**: https://ieeexplore.ieee.org/document/6542645
...
- **Status**: ❌
- **Reason**: Growth/Rateless 코드 점근성능 분석+비디오 응용, fountain/rateless 영역으로 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:6623065
- **Type**: journal
- **Published**: 2013
- **Authors**: N. Thomos, R. Pulikkoonattu, P. Frossard
- **PDF**: https://ieeexplore.ieee.org/document/6623065
...
- **Status**: ❌
- **Reason**: MRAM/NAND/SRAM 등 메모리 스케일링 세션 개요, ECC/LDPC 기법 없음
- **ID**: ieee:6658564
- **Type**: conference
- **Published**: 2013
- **Authors**: K. Niii, T. Kirihata
- **PDF**: https://ieeexplore.ieee.org/document/6658564
- **Abstract**: This session covers scaling challenges, latest advances, and future trends on spin-torque MRAM, NAND, and logic-compatible flash, TCAM, and 6T/8T SRAM in advanced technology nodes.

## Superimposed adaptive network coded cooperation for wireless sensor networks

- **Status**: ❌
- **Reason**: 무선센서망 네트워크코드 협력(XOR/EXIT), LDPC ECC 기법 없음
- **ID**: ieee:6666317
- **Type**: conference
- **Published**: 2013
- **Authors**: N. Takeishi, K. Ishibashi, Y. Yamao
- **PDF**: https://ieeexplore.ieee.org/document/6666317
- **Abstract**: In this paper, we propose a bandwidth efficient distributed network code, termed superimposed adaptive network coded cooperation (SANCC), for a network consisting of M users sending different information packets to a common destination through independent block fading channels. Different from conventional cooperative communications with half-duplex constraint, our proposed approach does not reduce the bandwidth efficiency with the aid of high order modulation while its encoding process is still performed by simple XOR operation similar to the conventional adaptive network coded cooperation (ANCC). In order to exploit the structure of the proposed approach, effective mapping and corresponding decoding are investigated. We further propose a modified encoding for SANCC to improve the inherent error floor behavior and analyze its performance based on extrinsic information transfer (EXIT) chart. Finally, the effectiveness of our proposed approach is confirmed via computer simulations.

## Data storage time sensitive ECC schemes for MLC NAND Flash memories

- **Status**: ✅
- **Reason**: MLC NAND Flash 직접(retention/PI 에러, Gray코딩+ECC HW), 카테고리 A 명확 해당
- **ID**: ieee:6638108
- **Type**: conference
- **Published**: 2013
- **Authors**: C. Yang, D. Muckatira, A. Kulkarni +1
- **PDF**: https://ieeexplore.ieee.org/document/6638108
...
- **Status**: ❌
- **Reason**: Locally recoverable code의 정보이론적 bound(순수 이론), LDPC 디코더/구성/HW 기여 없음
- **ID**: ieee:6502958
- **Type**: conference
- **Published**: 2013
- **Authors**: A. Mazumdar, V. Chandar, G. W. Wornell
- **PDF**: https://ieeexplore.ieee.org/document/6502958
...
- **Status**: ❌
- **Reason**: 모바일센서망 ARQ+릴레이 프로토콜, 블록코드 비유만 있고 떼어낼 LDPC 기법 없음
- **ID**: ieee:6632103
- **Type**: conference
- **Published**: 2013
- **Authors**: N. Alaoui, J. -P. Cances, V. Meghdadi
- **PDF**: https://ieeexplore.ieee.org/document/6632103
- **Abstract**: Mobile Sensor networks have become a hot topic of research in the last decade. There are a lot of new applications which employ this kind of network architecture. For example, Body Area Network (BAN) is a new application where multiple sensors on different body parts simultaneously transmit their data to a monitoring unit. In the case of numerous sensors, the addition of active relays which can act as parity nodes in a bipartite graph enables to obtain redundant information to improve the integrity of the transmission. The network topology is somewhat equivalent to that of a block code. However, in the case of a small number of sensors, this technique becomes less efficient. On the other hand, using Automatic Repeat Request (ARQ) protocol, one can avoid transmission errors. In this paper we propose a protocol to combine the two correction methods mentioned above (relaying and ARQ) for mobile sensor networks for a small number of sensors which operate on quasi-static Rayleigh fading channel. Coding error correction is first applied, and then a detection layer will be added to detect errors that were not corrected by the error correction code. Power saving which is crucial in mobile sensor network is greatly improved by our proposed algorithm.

## Detection and correction of soft errors in memory system

- **Status**: ❌
- **Reason**: 메모리 소프트에러용 Hamming/OS-MLD(DSCC) 디코더; 메모리 도메인이나 비-LDPC 부호·이식 기법 없음
- **ID**: ieee:6938723
- **Type**: conference
- **Published**: 2013
- **Authors**: M. Ramya, S. Preethi
- **PDF**: https://ieeexplore.ieee.org/document/6938723
- **Abstract**: Nowadays, The memory applications are more concerned with single event upsets. They invert the stored logic values in flip flop and memory cells. This issue is more serious when the affected memory cells are part of the configuration memory used for programming the circuit functionality. The occurrence of error can be corrected by reprogramming, which is caused due the alteration of circuit functionality. Here we have compared two decoders of error correction codes for issues in the programming circuits. A Hamming Decoder and a One-Step Majority Logic Decoder (OS-MLD) for the Difference-Set Cyclic Codes (DSCC) are analyzed yielding surprisingly unexpected results for their SEU susceptibility, which are interesting for application designers.

## Performance of trajectory plot for serial concatenation of BCH and Convolutional codes

- **Status**: ❌
- **Reason**: BCH+Convolutional 직렬연접, BCJR/EXIT; 비-LDPC 부호, 부호비의존 이식 BP 기법 없음
- **ID**: ieee:6870854
- **Type**: conference
- **Published**: 2013
- **Authors**: Melinda, Nasaruddin, Syahrial +1
- **PDF**: https://ieeexplore.ieee.org/document/6870854
- **Abstract**: Nowadays, the use of digital communication has been highly demanding. The advanced communication is needed by people to communicate with each other at anywhere, anytime and any place. Therefore, the better performance of communication systems is very important. Extraordinary efforts have been done by many scientists to achieve better performances of digital communication. Over than 50 years, the researchers have been working hard to develop the state of the art of digital communication. Due to this phenomenon, this paper try to acquire well performance of trajectory using serial concatenation of coding. Here, two kinds of channel coding are applied, namely: BCH and Convolutional codes. Furthermore, there are also decoding process using BCJR algorithm which is implemented in the inner and outer decoding scheme for both codes. In addition, several impacts of interleaved in the EXIT chart are going to present using three types of different length of interleaver. As a result, using quite long of interleaver length, is going to produce well-match the trajectory plot and also the EXIT chart. Lastly, outer codes is well-shown by applying a BCH code for decoding process, while Convolutional code is quite good for inner codes.

## Beyond turbo codes: Rate-compatible punctured polar codes

- **Status**: ❌
- **Reason**: rate-compatible punctured polar 코드 + SCL/SCS 디코딩. polar 부호 전용, 부호 비의존적 BP 이식 기법 아님
- **ID**: ieee:6655078
- **Type**: conference
- **Published**: 2013
- **Authors**: K. Niu, K. Chen, J. -R. Lin
- **PDF**: https://ieeexplore.ieee.org/document/6655078
...
- **Status**: ❌
- **Reason**: BICM-ID 컨볼루션 코드+차동변조 릴레이 시스템. 비-LDPC, 무선 응용 특이적, 이식 기법 없음
- **ID**: ieee:6820485
- **Type**: conference
- **Published**: 2013
- **Authors**: Le Yu, Zhanji Wu, Fan Yang
- **PDF**: https://ieeexplore.ieee.org/document/6820485
...
## On incorporating biometric based watermark for HD video using SVD and error correction codes

- **Status**: ❌
- **Reason**: 바이오메트릭 비디오 워터마킹+syndrome decoding 보안 응용, 채널 ECC 아님
- **ID**: ieee:6575988
- **Type**: conference
- **Published**: 2013
- **Authors**: P. Swamy, M. G. Chandra, B. S. Adiga
- **PDF**: https://ieeexplore.ieee.org/document/6575988
- **Abstract**: Watermarking videos have been explored extensively in the recent past. In our work, we are proposing a biometric based watermarking scheme to embed a fingerprint into a HD video for authentication. Using the idea from existing techniques, we arrive at an effective solution capable of handling extreme attacks such as resizing and cropping. In this direction, we propose a method to use binary feature vector corresponding to the fingerprint as a watermark together with Singular Value Decomposition. Further, error correction codes are used to provide robustness and syndrome decoding is adopted to arrive at the authenticity of the Watermark. Our initial study and results presented in the paper suggest that the proposed solution can provide a good starting point towards arriving at a foolproof system in terms of robustness and security.

## 30.58 Tb/s transmission over 7,230 km using PDM half 4D-16QAM coded modulation with 6.1 b/s/Hz spectral efficiency

- **Status**: ❌
- **Reason**: 30.58 Tb/s 광전송 용량 데모, coded modulation 베이스라인, ECC 신규 기법 없음
- **ID**: ieee:6532986
- **Type**: conference
- **Published**: 2013
- **Authors**: H. Zhang, H. G. Batshon, D. G. Foursa +6
- **PDF**: https://ieeexplore.ieee.org/document/6532986
- **Abstract**: We transmit 30.58 Tb/s data (294×104 Gb/s) over 7,230 km in 40 nm bandwidth with 6.1 b/s/Hz spectral efficiency. We use PDM half-4D-16QAM coded modulation to achieve the highest reported capacity-distance product of 221 Pb/s·km.

## Joint channel-physical layer network coding in multi-way wireless relay systems

- **Status**: ❌
- **Reason**: 무선 다중방향 릴레이의 결합 채널-네트워크 코딩 알고리즘; LDPC ECC로 떼어낼 디코더/HW/구성 기법 없음
- **ID**: ieee:6731983
- **Type**: conference
- **Published**: 2013
- **Authors**: N. Balasuriya, C. Wavegedara
- **PDF**: https://ieeexplore.ieee.org/document/6731983
- **Abstract**: Multi-way relaying is a widely considered network configuration, where multiple communication nodes exchange their information via a single relay. In this configuration, a pairwise information exchange and a channel condition based node pair selection for simultaneous information transfer provide the best performance. For such schemes, the relationship between the minimum number of time slots required for complete information exchange among communication nodes and the number of communication nodes is derived. Furthermore, this paper proposes an improved joint channel decoding-network coding algorithm, which is to be employed at the relay node. In the proposed joint decoding algorithm, the soft information of the information bits is exchanged between the channel decoders corresponding to different node pairs transmitting simultaneously. We also propose three different schemes for soft information exchange between the different channel decoders. The proposed algorithm is highly scalable with respect to the number of communication nodes. Simulation results demonstrate that our proposed joint decoding algorithm offers improved error performance over the existing joint decoding algorithms for a three-way relay system under the three different information exchanging schemes. The simulation results verify that the performance of the proposed decoding algorithm increases with the number of overlapping information pairs.

## Joint iterative soft decoding for raptor codes

- **Status**: ❌
- **Reason**: Raptor(fountain) 부호 joint iterative soft decoding — LDPC 아님, fountain 계열은 제외 대상
- **ID**: ieee:6570211
- **Type**: conference
- **Published**: 2013
- **Authors**: M. Zhang, S. Kim, X. Jiang
- **PDF**: https://ieeexplore.ieee.org/document/6570211
- **Abstract**: In this paper, we propose a joint iterative soft decoding algorithm for raptor codes. We present an efficient method to exchange extrinsic soft information between the component codes. Bit error rate (BER) performance shows that the proposed method can enhance the decoding performance compared to the existed ones.

## Practical Coding Scheme for Universal Source Coding with Side Information at the Decoder

- **Status**: ❌
- **Reason**: side-info 보편 무손실 소스코딩, 채널 ECC 아님
- **ID**: ieee:6543076
- **Type**: conference
- **Published**: 2013
- **Authors**: E. Dupraz, A. Roumy, M. Kieffer
- **PDF**: https://ieeexplore.ieee.org/document/6543076
- **Abstract**: This paper considers the problem of universal lossless source coding with side information at the decoder only. The correlation channel between the source and the side information is unknown and belongs to a class parametrized by some unknown parameter vector. A complete coding scheme is proposed that works well for any distribution in the class. At the encoder, the proposed scheme encompasses the determination of the coding rate and the design of the encoding process. Both contributions result from the information-theoretical compression bounds of universal lossless source coding with side information. Then a novel decoder is proposed that takes into account the available information regarding the class. The proposed scheme avoids the use of a feedback channel or the transmission of a learning sequence, which both would result in a rate increase at finite length.

## K-user parallel concatenated code for Gaussian multiple-access channel

- **Status**: ❌
- **Reason**: Gaussian 다중접속채널용 PCC(병렬연접부호)+반복/컨볼루션 부호. 비-LDPC, 무선 응용 특이적, 떼어낼 LDPC 기법 없음
- **ID**: ieee:6655052
- **Type**: conference
- **Published**: 2013
- **Authors**: G. Song, J. Cheng, Y. Watanabe
- **PDF**: https://ieeexplore.ieee.org/document/6655052
- **Abstract**: A k-user parallel concatenated code (PCC) is proposed for a Gaussian multiple-access channel with symbol synchronization and equal power users. In this code, each user employs a PCC with M + 1 component codes, where the first component code is a rate 1/q repetition code and the other M component codes are the same rate-1 convolutional code 1/1+D. The K-user PCC achieves a larger maximum sum rate, at the high rate region, than the conventional scheme of an error correction code serially concatenated with a spreading.

## Linear programming decoding of spatially coupled codes

- **Status**: ✅
- **Reason**: spatially-coupled LDPC의 LP 디코딩 threshold 분석; SC-LDPC LP 디코딩 기법으로 코드설계/디코더(C/E) 이식 가능, 애매하여 보존
- **ID**: ieee:6620474
- **Type**: conference
- **Published**: 2013
- **Authors**: L. Bazzi, B. Ghazi, R. Urbanke
- **PDF**: https://ieeexplore.ieee.org/document/6620474
...
- **Status**: ❌
- **Reason**: 가변길이부호 결합 소스-채널 디코딩(JSCD), 트렐리스 가지치기; LDPC ECC 아님
- **ID**: ieee:6736000
- **Type**: conference
- **Published**: 2013
- **Authors**: G. Tu, J. Dai
- **PDF**: https://ieeexplore.ieee.org/document/6736000
...
- **Status**: ❌
- **Reason**: 링 상 PG 코드+MLG 디코더, 비-LDPC 부호이고 LDPC BP 이식 기법 아님
- **ID**: ieee:6487949
- **Type**: conference
- **Published**: 2013
- **Authors**: B. S. Adiga, S. Thaskani, M. G. Chandra +1
- **PDF**: https://ieeexplore.ieee.org/document/6487949
...
## A novel and blind detection scheme for asymmetric PCMA system

- **Status**: ❌
- **Reason**: 비대칭 PCMA 위성 통신 블라인드 검출. FEC 부수 언급뿐, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:6967240
- **Type**: conference
- **Published**: 2013
- **Authors**: P. -h. Mo, X. -x. Fan, L. You
- **PDF**: https://ieeexplore.ieee.org/document/6967240
...
- **Status**: ❌
- **Reason**: partial response 채널용 polar 코드 + turbo equalization. polar 전용 SISO-SC 디코더로 바이너리 LDPC BP 이식 기법 아님
- **ID**: ieee:6655247
- **Type**: conference
- **Published**: 2013
- **Authors**: U. U. Fayyaz, J. R. Barry
- **PDF**: https://ieeexplore.ieee.org/document/6655247
- **Abstract**: We describe an error-correcting system that combines polar codes with turbo equalization for partial response channels. The successive cancellation decoder, originally proposed by Arikan for polar codes, does not produce the soft outputs needed for turbo processing. The belief propagation decoder, on the other hand, requires many iterations and has high computational complexity. In this paper, we propose a soft-input soft-output variant of the successive cancellation decoder that produces the soft information required for turbo architectures, while keeping the computational complexity low. Numerical results show that the proposed decoder performs better than the hard-output successive cancellation decoder and the belief propagation decoder in the context of turbo equalization. The proposed decoder achieves this performance gain with lower complexity compared to belief propagation and maximum-likelihood decoders. Additionally, we prove that Arikan's successive cancellation decoder is a fast-polarizing instance of our soft-input soft-output successive cancellation decoder.

## Least squares superposition codes with Bernoulli dictionary are still reliable at rates up to capacity

- **Status**: ❌
- **Reason**: sparse superposition code 신뢰성 이론(LS 디코딩); 비-LDPC 순수 이론 bound, 디코더/HW 기여 없음
- **ID**: ieee:6620456
- **Type**: conference
- **Published**: 2013
- **Authors**: Y. Takeishi, M. Kawakita, J. Takeuchi
- **PDF**: https://ieeexplore.ieee.org/document/6620456
...
- **Status**: ❌
- **Reason**: 물리계층 네트워크코딩용 Tomlinson-Harashima 프리코딩, LDPC/디코더 기법 없음
- **ID**: ieee:6533335
- **Type**: conference
- **Published**: 2013
- **Authors**: A. Schmidt, R. Schober, W. Gerstacker
- **PDF**: https://ieeexplore.ieee.org/document/6533335
...
- **Status**: ❌
- **Reason**: m-수열 검출/디코딩 개선 (decimation 속성 활용). 동기화 응용 특이적, LDPC ECC 이식 기법 없음
- **ID**: ieee:6811566
- **Type**: conference
- **Published**: 2013
- **Authors**: M. des Noes, V. Savin, L. Ros +1
- **PDF**: https://ieeexplore.ieee.org/document/6811566
- **Abstract**: M-sequences are widely used in communications and positioning systems for synchronization purposes. In these systems, the receiver does not know which sequence is used by the transmitter, this needs to be detected. This paper establishes first a link between the conventional detection theory and the recently developed detection technique relying on iterative message-passing algorithm. Then, a novel decoding strategy is proposed. It exploits the decimation property of m-sequences to improve significantly the detection performance compared to the existing decoding strategy.

## An improved image compression scheme with an adaptive parameters set in encrypted domain

- **Status**: ❌
- **Reason**: 암호화 도메인 이미지 압축(coset code); 소스 코딩/압축이라 채널 ECC 아님
- **ID**: ieee:6706408
- **Type**: conference
- **Published**: 2013
- **Authors**: G. Zhang, S. Liu, F. Jiang +2
- **PDF**: https://ieeexplore.ieee.org/document/6706408
...
- **Status**: ❌
- **Reason**: 무선 수신기 소프트결정 분석기(SDA) 측정 기법; LDPC ECC 디코더/HW 기여 없음
- **ID**: ieee:6737541
- **Type**: conference
- **Published**: 2013
- **Authors**: C. A. Lansdowne, G. F. Steele, J. P. Zucha +1
- **PDF**: https://ieeexplore.ieee.org/document/6737541
- **Abstract**: We describe the benefit of using closed-loop measurements for a radio receiver paired with a counterpart transmitter. We show that real-time analysis of the soft decision output of a receiver can provide rich and relevant insight far beyond the traditional hard-decision bit error rate (BER) test statistic. We describe a Soft Decision Analyzer (SDA) implementation for closed-loop measurements on single- or dual-(orthogonal) channel serial data communication links. The analyzer has been used to identify, quantify, and prioritize contributors to implementation loss in live-time during the development of software defined radios. This test technique gains importance as modern receivers are providing soft decision symbol synchronization as radio links are challenged to push more data and more protocol overhead through noisier channels, and software-defined radios (SDRs) use error-correction codes that approach Shannon's theoretical limit of performance.

## Multigigabit RS-CC decoder for 60-GHz systems

- **Status**: ❌
- **Reason**: RS-CC(Berlekamp-Massey/Viterbi) FPGA 디코더; 비-LDPC, LDPC로 이식할 HW기법 없음
- **ID**: ieee:6893576
- **Type**: conference
- **Published**: 2013
- **Authors**: P. Jiang, B. Gao, Z. Xiao +2
- **PDF**: https://ieeexplore.ieee.org/document/6893576
- **Abstract**: With ultra-wide unlicensed spectrum, 60-GHz communication system has become a key candidate to achieve multigigabit throughput in short distance. This paper proposes a novel multigigabit Reed-Solomon (RS) convolutional codes (CC) decoder architecture for 60-GHz systems. In the proposed architecture, the RS and the CC codes are used as outer codes and inner codes, respectively. For RS decoder, the circuit for reformulated inversionless Berlekamp-Massey (RIBM) algorithm is proposed via double-clock methods to improve the decoding speed. For CC decoder, we adopt a balanced add-select-register-compare Viterbi decoder architecture, which breaks the decoding-speed bottleneck in traditional Viterbi decoders. The proposed RS-CC decoder has been implemented and demonstrated in a Xilinx Virtex-6 FPGA device.

## A rateless encoder with adaptive symbol removal for AWGN and fading channels

- **Status**: ❌
- **Reason**: Raptor/rateless fountain 부호; erasure/fountain 계열로 떼어낼 LDPC 채널ECC 기법 없음
- **ID**: ieee:6677260
- **Type**: conference
- **Published**: 2013
- **Authors**: Kun Tu, Zhaoyang Zhang, Chuangmu Yao +1
- **PDF**: https://ieeexplore.ieee.org/document/6677260
...
- **Status**: ❌
- **Reason**: 비직교 접속 랜덤 빔포밍+intra-beam SIC MIMO 다운링크, 부호화 이식 기법 없음
- **ID**: ieee:6692307
- **Type**: conference
- **Published**: 2013
- **Authors**: K. Higuchi, Y. Kishiyama
- **PDF**: https://ieeexplore.ieee.org/document/6692307
...
- **Status**: ❌
- **Reason**: ISI 채널 SIC 멀티레이트 등화기, ECC/LDPC 비관련
- **ID**: ieee:6666374
- **Type**: conference
- **Published**: 2013
- **Authors**: M. F. Bayramoglu, M. Juntti
- **PDF**: https://ieeexplore.ieee.org/document/6666374
...
- **Status**: ✅
- **Reason**: MLC NAND threshold voltage 분포 특성화/모델링, read-retry 기반 측정 - A 카테고리 NAND 직접, LLR/ECC 설계 직결
- **ID**: ieee:6513712
- **Type**: conference
- **Published**: 2013
- **Authors**: Y. Cai, E. F. Haratsch, O. Mutlu +1
- **PDF**: https://ieeexplore.ieee.org/document/6513712
...
- **Status**: ❌
- **Reason**: group testing/희소 pooling 행렬(spatially coupled); 채널 ECC가 아닌 측정행렬 복원, NAND LDPC 이식 불가
- **ID**: ieee:6649458
- **Type**: conference
- **Published**: 2013
- **Authors**: Pan Zhang, F. Krzakala, M. Mézard +1
- **PDF**: https://ieeexplore.ieee.org/document/6649458
...
## Polar Codes for Gaussian Degraded Relay Channels

- **Status**: ❌
- **Reason**: 폴라 부호 릴레이 채널 적용; 비-LDPC, LLR식이 채널 특이적이라 바이너리 LDPC BP로 이식 불가
- **ID**: ieee:6412681
- **Type**: journal
- **Published**: 2013
- **Authors**: A. Bravo-Santos
- **PDF**: https://ieeexplore.ieee.org/document/6412681
...
- **Status**: ❌
- **Reason**: polar 코드 modified successive-cancellation 디코더 개선. polar 전용, 바이너리 LDPC BP에 이식되는 부호 비의존 기법 아님
- **ID**: ieee:6656076
- **Type**: journal
- **Published**: 2013
- **Authors**: Z. Huang, C. Diao, J. Dai +3
- **PDF**: https://ieeexplore.ieee.org/document/6656076
- **Abstract**: An improvement is introduced of the modified successive-cancellation (MSC) decoding for polar codes, in which local decoders at rate-other nodes are simplified. This improvement reduces the decoding latency and complexity of the MSC decoding with no sacrifice in error performance. Furthermore, in our method, the decoding latency decreases rapidly with increasing signal-to-noise ratio. Significant latency and complexity reductions are shown by simulation results.

## Bounds on Maximum Likelihood Decoding Performance for Linear Codes at Low Rates

- **Status**: ❌
- **Reason**: ML 디코딩 오류확률 상한·error exponent 순수 이론 bound, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:6478823
- **Type**: journal
- **Published**: 2013
- **Authors**: H. Yagi, H. V. Poor
- **PDF**: https://ieeexplore.ieee.org/document/6478823
...
- **Status**: ❌
- **Reason**: 풍력단지 분산 소스코딩 압축; ECC 채널코딩 아니고 떼어낼 BP 디코더 기여 없음(particle-filtering BP는 소스코딩 상관모델용)
- **ID**: ieee:6304949
- **Type**: journal
- **Published**: 2013
- **Authors**: V. Stankovic, L. Stankovic, S. Wang +1
- **PDF**: https://ieeexplore.ieee.org/document/6304949
...
- **Status**: ❌
- **Reason**: Block Differential Modulation의 constrained capacity 이론, LDPC/디코더 기법 없음
- **ID**: ieee:6522424
- **Type**: journal
- **Published**: 2013
- **Authors**: S. Bellini, A. Tomasoni, M. Ferrari
- **PDF**: https://ieeexplore.ieee.org/document/6522424
...
- **Status**: ❌
- **Reason**: 릴레이 채널 HARQ-IR/CC의 정보이론적 성능 분석, LDPC 부호설계/디코더 기여 없는 순수 통신 응용
- **ID**: ieee:6512535
- **Type**: journal
- **Published**: 2013
- **Authors**: A. Chelli, M. -S. Alouini
- **PDF**: https://ieeexplore.ieee.org/document/6512535
...
- **Status**: ❌
- **Reason**: 디지털 TV 방송 전송기법 서베이, 신규 디코더·구성·HW 기여 없음
- **ID**: ieee:6492307
- **Type**: journal
- **Published**: 2013
- **Authors**: M. El-Hajjar, L. Hanzo
- **PDF**: https://ieeexplore.ieee.org/document/6492307
...
- **Status**: ❌
- **Reason**: STSK 분산행렬/성좌 결합최적화, EXIT 차트 설계; LDPC ECC 떼어낼 기법 없음
- **ID**: ieee:6378497
- **Type**: journal
- **Published**: 2013
- **Authors**: S. Sugiura, L. Hanzo
- **PDF**: https://ieeexplore.ieee.org/document/6378497
...
- **Status**: ❌
- **Reason**: DVB-T2 복조기 DSP 구현(FFT/디인터리버/soft-demapper), LDPC 디코더/코드설계 기여 없음
- **ID**: ieee:6531127
- **Type**: journal
- **Published**: 2013
- **Authors**: H. Yang, N. Basutkar, P. Xue +2
- **PDF**: https://ieeexplore.ieee.org/document/6531127
...
- **Status**: ❌
- **Reason**: MoCA 홈네트워킹 표준 개요 — 부호/디코더 기여 없는 시스템 개요
- **ID**: ieee:6558525
- **Type**: journal
- **Published**: 2013
- **Authors**: A. Monk, R. Lee, Y. Hebron
- **PDF**: https://ieeexplore.ieee.org/document/6558525
...
- **Status**: ❌
- **Reason**: 위성 통신 time-frequency packing 스펙트럼 효율 — 통신 응용 특이적, LDPC 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:6559982
- **Type**: journal
- **Published**: 2013
- **Authors**: A. Piemontese, A. Modenini, G. Colavolpe +1
- **PDF**: https://ieeexplore.ieee.org/document/6559982
...
- **Status**: ❌
- **Reason**: 회전 QAM soft-demapping(1D) DSP 구현, 변조/복조 기법으로 LDPC ECC 디코더 아님
- **ID**: ieee:6515394
- **Type**: journal
- **Published**: 2013
- **Authors**: K. Kim, N. Basutkar, K. Bae +2
- **PDF**: https://ieeexplore.ieee.org/document/6515394
...
- **Status**: ✅
- **Reason**: bit-reversal permutation 병렬화 fast 알고리즘/HW 아키텍처; permutation network HW 기법으로 LDPC 디코더 인터리버에 이식 가능성(D)
- **ID**: ieee:6457479
- **Type**: journal
- **Published**: 2013
- **Authors**: M. M. Mansour
- **PDF**: https://ieeexplore.ieee.org/document/6457479
...
- **Status**: ❌
- **Reason**: 60GHz OFDM 위상잡음 보상, LDPC는 부수 언급·떼어낼 ECC 기법 없음
- **ID**: ieee:6486682
- **Type**: conference
- **Published**: 20-23 Jan.
- **Authors**: Donghoon Shin, Satoshi Suyama, Hiroshi Suzuki +1
- **PDF**: https://ieeexplore.ieee.org/document/6486682
...
- **Status**: ❌
- **Reason**: 수중 RF 통신 안테나/시스템, LDPC 표준 적용·떼어낼 디코더 기법 없음
- **ID**: ieee:6486734
- **Type**: conference
- **Published**: 20-23 Jan.
- **Authors**: Brian Kelley, Krishna Naishadham
- **PDF**: https://ieeexplore.ieee.org/document/6486734
- **Abstract**: Most traditional underwater communication systems rely upon low data-rate acoustic communications, which cannot propagate behind objects and is confined to very narrow-band channels. We propose an alternative method supporting robust broadband radio frequency (RF) communications in low signal-to-noise ratio (SNR) undersea environments. This paper presents an integrated treatment involving broadband RF antennas and digital radio systems, potentially enabling 1 Mbps underwater communications at a medium range of 100 to 1000 meters. We describe the broadband underwater antenna design results coupled with the application of spectrally efficient multi-carrier modulation and iterative message-passing low-density parity check codes. We also present the channel modeling and underwater linklevel simulation results at 5 MHz, 10 MHz, and 15 MHz bandwidths.

## RF multicarrier signaling and antenna systems for low SNR broadband underwater communications

- **Status**: ❌
- **Reason**: 수중 RF 통신(중복본), LDPC 표준 적용·떼어낼 기법 없음
- **ID**: ieee:6613709
- **Type**: conference
- **Published**: 20-23 Jan.
- **Authors**: Brian Kelley, Krishna Naishadham
- **PDF**: https://ieeexplore.ieee.org/document/6613709
- **Abstract**: Most traditional underwater communication systems rely upon low data-rate acoustic communications, which cannot propagate behind objects and is confined to very narrow-band channels. We propose an alternative method supporting robust broadband radio frequency (RF) communications in low signal-to-noise ratio (SNR) undersea environments. This paper presents an integrated treatment involving broadband RF antennas and digital radio systems, potentially enabling 1 Mbps underwater communications at a medium range of 100 to 1000 meters. We describe the broadband underwater antenna design results coupled with the application of spectrally efficient multi-carrier modulation and iterative message-passing low-density parity check codes. We also present the channel modeling and underwater link-level simulation results at 5 MHz, 10 MHz, and 15 MHz bandwidths.
...
- **Published**: 20-23 Jan.
- **Authors**: Brian Kelley, Krishna Naishadham
- **PDF**: https://ieeexplore.ieee.org/document/6488659
- **Abstract**: Most traditional underwater communication systems rely upon low data-rate acoustic communications, which cannot propagate behind objects and is confined to very narrow-band channels. We propose an alternative method supporting robust broadband radio frequency (RF) communications in low signal-to-noise ratio (SNR) undersea environments. This paper presents an integrated treatment involving broadband RF antennas and digital radio systems, potentially enabling 1 Mbps underwater communications at a medium range of 100 to 1000 meters. We describe the broadband underwater antenna design results coupled with the application of spectrally efficient multi-carrier modulation and iterative message-passing low-density parity check codes. We also present the channel modeling and underwater link-level simulation results at 5 MHz, 10 MHz, and 15 MHz bandwidths.

## RF multicarrier signaling and antenna systems for low SNR broadband underwater communications

- **Status**: ❌
- **Reason**: 수중 RF 광대역 통신 응용, 반복 메시지패싱 LDPC는 부수 적용 — 떼어낼 기법 없음
- **ID**: ieee:6490225
- **Type**: conference
- **Published**: 20-20 Jan.
- **Authors**: Brian Kelley, Krishna Naishadham
- **PDF**: https://ieeexplore.ieee.org/document/6490225
- **Abstract**: Most traditional underwater communication systems rely upon low data-rate acoustic communications, which cannot propagate behind objects and is confined to very narrow-band channels. We propose an alternative method supporting robust broadband radio frequency (RF) communications in low signal-to-noise ratio (SNR) undersea environments. This paper presents an integrated treatment involving broadband RF antennas and digital radio systems, potentially enabling 1 Mbps underwater communications at a medium range of 100 to 1000 meters. We describe the broadband underwater antenna design results coupled with the application of spectrally efficient multi-carrier modulation and iterative message-passing low-density parity check codes. We also present the channel modeling and underwater link-level simulation results at 5 MHz, 10 MHz, and 15 MHz bandwidths.

## Enhanced min-sum decoding for DVB-T2 LDPC codes

- **Status**: ✅
- **Reason**: enhanced min-sum (ln cosh 2단계 근사)는 부호 비의존 디코더 개선(C), DVB-T2지만 바이너리 LDPC BP에 이식 가능
- **ID**: ieee:6487024
- **Type**: conference
- **Published**: 11-14 Jan.
- **Authors**: Sung Ik Park, Young Min Choi, Heung Mook Kim +2
- **PDF**: https://ieeexplore.ieee.org/document/6487024
...
- **Status**: ❌
- **Reason**: fake error로 패리티를 메시지로 옮겨 코드 압축(데이터 전송 효율) — 채널 ECC 디코더/구성 기법이 아닌 전송 압축 트릭
- **ID**: ieee:6487009
- **Type**: conference
- **Published**: 11-14 Jan.
- **Authors**: Agi Prasetiadi, Dong-Sung Kim, Soo-Young Shin
- **PDF**: https://ieeexplore.ieee.org/document/6487009
...
- **Status**: ❌
- **Reason**: set-top box용 MIMO 전송 구조, LDPC 언급 없고 떼어낼 ECC 기법 없음
- **ID**: ieee:6486953
- **Type**: conference
- **Published**: 11-14 Jan.
- **Authors**: Jo Bong Gyun, Dong Seog Han
- **PDF**: https://ieeexplore.ieee.org/document/6486953
...
- **Status**: ❌
- **Reason**: GF(q) 비이진 LDPC 디코더(FPGA) — 비이진 LDPC는 제외
- **ID**: ieee:6488484
- **Type**: conference
- **Published**: 11-14 Jan.
- **Authors**: Wojciech Sulek, Marcin Kucharczyk, Grzegorz Dziwoki
- **PDF**: https://ieeexplore.ieee.org/document/6488484
...
## A novel network coded relay-assisted Hybrid-ARQ scheme

- **Status**: ❌
- **Reason**: network-coded relay HARQ + 가상 MIMO/MMSE 수신기; 무선 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:6488483
- **Type**: conference
- **Published**: 11-14 Jan.
- **Authors**: Yue Ma, Lihua Li, Jin Jin +1
- **PDF**: https://ieeexplore.ieee.org/document/6488483
- **Abstract**: In conventional relay-assisted HARQ schemes, source is always in anidle state during the retransmission phase.In this paper, we proposed a relay-assisted HARQ scheme which makes use of the basic idea of network coding. We simply adopt a remapping modulation method to combine new codewords and the ones to be retransmittedas the network coding. Source will transmit the superposition symbols during retransmission phase. Thus a virtual MIMO (Multiple In Multiple Out) system can be created and diversity and multiplexing can be gained. A corresponding MMSE (Minimum Mean Square Error) MIMO receiver and a soft demodulation method are proposed to recover two data streams. The proposed scheme can enhance the reliability and at the same time, throughput can be also improved due to the double-amount retransmission. Simulation results show that proposed scheme can greatly balance the reliability and the efficiency.

## FPGA implementation of wireless communication system

- **Status**: ❌
- **Reason**: LDPC-OFDM 무선통신 FPGA 구현이나 표준 LDPC 인코더/디코더 사용 수준, 떼어낼 신규 디코더/HW 아키텍처 기여 불명확
- **ID**: ieee:6784952
- **Type**: conference
- **Published**: 1-8 Jan. 2
- **Authors**: Zhongxun Wang, Dong Guo, Xingcheng Wang +1
- **PDF**: https://ieeexplore.ieee.org/document/6784952
- **Abstract**: A high data reliability for high-speed transmission of LDPC-OFDM wireless communication system architecture is proposed with the implementation plan by the field programmable gate array(FPGA). Using the orthogonal properties of OFDM sub-channels can be transmitted over a combination of coding and decoding LDPC codes in the high performance, will achieve good results in communication system. The LDPC-OFDM system is implemented by the second generation of Altera corporation with the EP2C35 device Cyclone II. The FPGA implementation results show that the data transmission performance is good and the data throughput is wide and the decoder can achieve a maximum decoding throughput of 10Mb/s at 15 iterations, it can meet the high-speed wireless communication system.

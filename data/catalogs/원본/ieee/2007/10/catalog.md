...
- **Status**: ❌
- **Reason**: 릴레이 DF binning 전용 bilayer LDPC 구성으로 NAND 단일채널 ECC에 이식할 기법 없음, density evolution/LP는 표준
- **ID**: ieee:4305411
- **Type**: journal
- **Published**: Oct. 2007
- **Authors**: Peyman Razaghi, Wei Yu
- **PDF**: https://ieeexplore.ieee.org/document/4305411
...
- **Status**: ❌
- **Reason**: PRISM 비디오 코딩, Wyner-Ziv 분산 소스압축이라 채널 ECC ECC 기법 없음
- **ID**: ieee:4303151
- **Type**: journal
- **Published**: Oct. 2007
- **Authors**: Rohit Puri, Abhik Majumdar, Kannan Ramchandran
- **PDF**: https://ieeexplore.ieee.org/document/4303151
...
- **Status**: ❌
- **Reason**: 비이진(nonbinary GF(q)) QC-LDPC 구성, 비이진 LDPC는 제외 대상 → 제외
- **ID**: ieee:4454753
- **Type**: conference
- **Published**: 29-31 Oct.
- **Authors**: Bo Zhou, Jingyu Kang, Ying Y. Tai +2
- **PDF**: https://ieeexplore.ieee.org/document/4454753
- **Abstract**: This paper presents algebraic methods for constructing efficiently encodable and high performance nonbinary quasi-cyclic LDPC codes based on hyperplanes of Euclidean geometries and masking. Codes constructed from these methods perform very well over the AWGN channel. With iterative decoding using a Fast Fourier Transform based sum-product algorithm, they achieve significantly large coding gains over Reed-Solomon codes of the same lengths and rates decoded with either the algebraic hard-decision Berlekamp-Massey algorithm or the algebraic soft-decision Kötter-Vardy algorithm. Due to their quasi-cyclic structure, these nonbinary LDPC codes on Euclidean geometries can be encoded with simple shift-registers with linear complexity. Structured nonbinary LDPC codes have a great potential to replace Reed-Solomon codes for some applications in either communication systems or storage systems for combating mixed types of noise and interferences.

## Attack Resilient Network Channel Code for the Wireless Multiple Access Relay Network

- **Status**: ❌
- **Reason**: 무선 멀티액세스 릴레이 네트워크 보안(공격탐지) 응용. LDPC/LDGM은 베이스라인, 떼어낼 NAND 이식 디코더/HW 기법 없음
- **ID**: ieee:4454772
- **Type**: conference
- **Published**: 29-31 Oct.
- **Authors**: Cheng-Chun Chang, Heung-No Lee
- **PDF**: https://ieeexplore.ieee.org/document/4454772
...
- **Status**: ❌
- **Reason**: H.264 UEP 전송용 FMO 분류 기법, LDPC는 부수적 응용 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:4415751
- **Type**: conference
- **Published**: 22-25 Oct.
- **Authors**: Jun Wang, Shen Li, Kazunori Shimizu +2
- **PDF**: https://ieeexplore.ieee.org/document/4415751
...
- **Status**: ❌
- **Reason**: 소스 결합형 FSI-LDPC를 위한 tripartite 그래프 설계 — 소스-involved 구조로 NAND 채널ECC와 무관, 떼어낼 바이너리 ECC 기법 없음
- **ID**: ieee:4392186
- **Type**: conference
- **Published**: 17-19 Oct.
- **Authors**: Jun Ning, Jinhong Yuan
- **PDF**: https://ieeexplore.ieee.org/document/4392186
...
- **Status**: ❌
- **Reason**: GF(2^m) 비이진 LDPC 디코더 FPGA 구현 — 비이진 LDPC는 제외
- **ID**: ieee:4387557
- **Type**: conference
- **Published**: 17-19 Oct.
- **Authors**: Christian Spagnol, William Marnane, Emanuel Popovici
- **PDF**: https://ieeexplore.ieee.org/document/4387557
...
- **Status**: ❌
- **Reason**: LDPC+Turbo 직렬연접의 비디오용 JSCC 비트할당; 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:4379636
- **Type**: conference
- **Published**: 16 Sept.-1
- **Authors**: Naeem Ramzan, Shuai Wan, Ebroul Izquierdo
- **PDF**: https://ieeexplore.ieee.org/document/4379636
...
- **Status**: ❌
- **Reason**: distributed video coding Slepian-Wolf용 LDPC - 소스코딩, 채널 ECC 아님
- **ID**: ieee:4379081
- **Type**: conference
- **Published**: 16 Sept.-1
- **Authors**: Ronald P. Westerlaken, Stefan Borchert, Rene Klein Gunnewiek +1
- **PDF**: https://ieeexplore.ieee.org/document/4379081
...
- **PDF**: https://ieeexplore.ieee.org/document/4379232
...
- **Status**: ❌
- **Reason**: 양방향 비디오 네트워크코딩; LDPC 기법 부재
- **ID**: ieee:4379637
- **Type**: conference
- **Published**: 16 Sept.-1
- **Authors**: Vladimir Stankovic, Lina Fagoonee, Abdi Moinian +1
- **PDF**: https://ieeexplore.ieee.org/document/4379637
...
- **Status**: ❌
- **Reason**: multiterminal video coding Slepian-Wolf/Wyner-Ziv용 LDPC - 소스코딩
- **ID**: ieee:4379237
- **Type**: conference
- **Published**: 16 Sept.-1
- **Authors**: Yang Yang, Vladimir Stankovic, Wei Zhao +1
- **PDF**: https://ieeexplore.ieee.org/document/4379237

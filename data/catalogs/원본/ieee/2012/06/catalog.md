...
- **Status**: ✅
- **Reason**: 유한체 기반 바이너리 QC-LDPC convolutional 코드 신규 대수적 구성(E)
- **ID**: ieee:6185512
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ✅
- **Reason**: rate-compatible LDPC convolutional(SC-LDPC) graph extension 구성 — 바이너리 SC-LDPC 코드설계(E)
- **ID**: ieee:6157623
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ✅
- **Reason**: 유한평면 바이너리 LDPC의 최소 absorbing set 분석→error floor 코드설계(E)
- **ID**: ieee:6166933
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ✅
- **Reason**: QC-LDPC 행렬이론적 분석(Fourier/permutation) 및 대수·기하 구성 — 바이너리 QC-LDPC 코드설계(E)에 이식 가능
- **ID**: ieee:6134665
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ✅
- **Reason**: PEG 변형 + Sum-Product 활용 디코더최적화 PEG로 error floor 낮춤 — 바이너리 LDPC 코드설계(E) 신규 기법, 이식 가능
- **ID**: ieee:6189817
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ✅
- **Reason**: absorbing set 탐색 + post-processing 저-error-floor BP 디코더 신규 제안 — 디코더(C)/코드설계(E) 이식 가능
- **ID**: ieee:6192273
- **Type**: journal
- **Published**: June 2012
...
- **Status**: ✅
- **Reason**: layered/serial scheduling LDPC 디코딩 알고리즘(C) — 노드 차수 기반 스케줄링은 바이너리 LDPC 디코더에 이식 가능
- **ID**: ieee:6264324
- **Type**: conference
- **Published**: 27-29 June
...
- **Status**: ✅
- **Reason**: eDRAM 기반 저전력 고처리율 LDPC 디코더 HW 아키텍처, NAND LDPC 디코더 메모리 설계에 이식 가능(D)
- **ID**: ieee:6243816
- **Type**: conference
...
- **Status**: ✅
- **Reason**: LDPC 인코더 파이프라인 HW 아키텍처, NAND ECC 인코더로 이식 가능(D)
- **ID**: ieee:6306129
- **Type**: conference
...
- **Status**: ✅
- **Reason**: bilayer QC-LDPC 신규 구성(stopping set/girth 회피 정리, min-distance 개선), 바이너리 코드설계(E)
- **ID**: ieee:6363723
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: NAND 플래시용 EG-LDPC 코드+양자화 경계/LLR 최적화; A(NAND, LLR 양자화) 직접 해당
- **ID**: ieee:6364973
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: density evolution+differential evolution로 multilevel LDPC 설계, LLR독립화 decorrelator 신규 디코더기법(C/E) 이식 가능
- **ID**: ieee:6363646
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: PN-PBRL protograph LDPC 신규 구성, 낮은 디코딩 threshold — 바이너리 코드설계 기법(E)
- **ID**: ieee:6363996
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: protograph LDPC 신규 구성(불균등 다이버시티)+EXIT 분석; 바이너리 코드설계 기법(E) 이식 검토 여지, 애매하면 in
- **ID**: ieee:6363986
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: 공간결합(SC-LDPC) threshold saturation 분석; SC-LDPC 구성·BP 임계값은 바이너리 LDPC 코드설계(E)로 이식 가능
- **ID**: ieee:6364433
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: 프로토그래프 LDPC 코드 설계(EXIT 임계값 기반 탐색)는 바이너리 LDPC 코드설계(E)로 이식 가능; 단 부분응답 채널 특화는 Phase3 재검토
- **ID**: ieee:6364385
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: LDPC convolutional code 앙상블+expanding-window 메시지패싱 디코더 신규 제안; 디코더(C)·코드설계(E) 이식 가능, BEC 한정은 Phase3 재검토
- **ID**: ieee:6364586
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: NAND 플래시 soft-decision sensing 데이터 전송 지연 감소; A(NAND/LLR 양자화) 직접 해당
- **ID**: ieee:6364887
- **Type**: conference
- **Published**: 10-15 June
...
- **Status**: ✅
- **Reason**: GPU LDPC 디코더 신규 메모리 coalescing 알고리즘 — 이식 가능 병렬 HW/구현 기법(D)
- **ID**: ieee:6363991
- **Type**: conference
- **Published**: 10-15 June

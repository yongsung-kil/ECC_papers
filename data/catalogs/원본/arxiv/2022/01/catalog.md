...
- **Status**: ✅
- **Reason**: 순열행렬 기반 LDPC의 cycle/girth 회피를 수론(Sidon set)으로 새로 구성 — 바이너리 QC-LDPC 코드 설계 기법(E), 이식 가능
- **ID**: arxiv:2201.11112v1
- **Type**: preprint
- **Published**: 2022-01-26
- **Authors**: Julia Lieb, Simran Tinani
- **PDF**: https://arxiv.org/pdf/2201.11112v1

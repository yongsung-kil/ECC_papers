...
- **Status**: ❌
- **Reason**: MIMO 저해상도 프리코딩 검출/디코딩 — LDPC는 베이스라인일 뿐 떼어낼 ECC 기법 없는 무선 응용
- **ID**: arxiv:2009.10036v5
- **Type**: preprint
- **Published**: 2020-09-21
- **Authors**: Erico S. P. Lopes, Lukas T. N. Landau
- **PDF**: https://arxiv.org/pdf/2009.10036v5
...
- **Status**: ❌
- **Reason**: LDPC 개요/서베이(과제 리포트), 신규 디코더·구성·HW 기여 없음
- **ID**: arxiv:2009.08645v1
- **Type**: preprint
- **Published**: 2020-09-18
- **Authors**: Saumya Borwankar, Dhruv Shah
- **PDF**: https://arxiv.org/pdf/2009.08645v1

...
- **Status**: ❌
- **Reason**: 양자 EC용 gate(surface code/qLDPC), 양자 전용 개념 의존 — 고전 바이너리 LDPC 이식 기법 없음
- **ID**: arxiv:1209.2764v1
- **Type**: preprint
- **Published**: 2012-09-13
- **Authors**: Amrit De, Leonid P. Pryadko
- **PDF**: https://arxiv.org/pdf/1209.2764v1

...
- **Status**: ❌
- **Reason**: GF(q) LDPC 기반 데이터 압축(소스코딩)—비이진+소스코딩, 채널 ECC 아님, 제외
- **ID**: arxiv:1108.6239v2
- **Type**: preprint
- **Published**: 2011-08-31
- **Authors**: Alfredo Braunstein, Farbod Kayhan, Riccardo Zecchina
- **PDF**: https://arxiv.org/pdf/1108.6239v2
...
- **Status**: ❌
- **Reason**: rateless/LT(저밀도 생성행렬) coupled 코드 — fountain/rateless, 떼어낼 채널 ECC 기법 없음
- **ID**: arxiv:1108.0535v1
- **Type**: preprint
- **Published**: 2011-08-02
- **Authors**: Vahid Aref, Rüdiger L. Urbanke
- **PDF**: https://arxiv.org/pdf/1108.0535v1

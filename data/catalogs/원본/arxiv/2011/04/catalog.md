...
- **Status**: ✅
- **Reason**: 고율 단블록 LDPC(T/SPC) 신규 코드 설계+저복잡도 디코딩, 자기기록 채널 — 코드설계/디코더 이식 가능(E/C)
- **ID**: arxiv:1104.1457v1
- **Type**: preprint
- **Published**: 2011-04-07
- **Authors**: Damian A. Morero, Graciela Corral-Briones, Carmen Rodriguez +1
- **PDF**: https://arxiv.org/pdf/1104.1457v1

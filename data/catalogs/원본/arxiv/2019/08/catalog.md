...
- **Status**: ❌
- **Reason**: 유한기하 기반 LDPC의 최소거리·생성어 순수 조합론 이론, 새 디코더/HW/실용 구성 기여 없음
...
- **Status**: ❌
- **Reason**: 5G NR PUSCH 송수신기 프로토타입, LDPC는 표준 인코딩/디코딩 부수 언급, 떼어낼 신규 ECC 기법 없음
...
- **Status**: ✅
- **Reason**: 프로토그래프 LDPC 부호 설계(유한길이 최적화)로 이식 가능 코드 설계(E), 채널모델은 무선이나 기법 분리 가능

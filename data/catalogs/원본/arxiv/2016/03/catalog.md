...
- **Status**: ❌
- **Reason**: QC-LDPC lattice 부호+nested lattice shaping — 기여는 격자 구성·shaping, 바이너리 LDPC ECC 아님
- **ID**: arxiv:1603.07010v1
- **Type**: preprint
- **Published**: 2016-03-22
- **Authors**: Hassan Khodaiemehr, Mohammad-Reza Sadeghi, Amin Sakzad
- **PDF**: https://arxiv.org/pdf/1603.07010v1
- **Abstract**: LDPC lattices were the first family of lattices that equipped with iterative decoding algorithms under which they perform very well in high dimensions. In this paper, we introduce quasi cyclic low density parity check (QC-LDPC) lattices as a special case of LDPC lattices with one binary QC-LDPC code as their underlying code. These lattices are obtained from Construction A of lattices providing us to encode them efficiently using shift registers. To benefit from an encoder with linear complexity in dimension of the lattice, we obtain the generator matrix of these lattices in "quasi cyclic" form. We provide a low-complexity decoding algorithm of QC-LDPC lattices based on sum product algorithm. To design lattice codes, QC-LDPC lattices are combined with nested lattice shaping that uses the Voronoi region of a sublattice for code shaping. The shaping gain and shaping loss of our lattice codes with dimensions $40$, $50$ and $60$ using an optimal quantizer, are presented. Consequently, we establish a family of lattice codes that perform practically close to the sphere bound.

## A Generalized LDPC Framework for Robust and Sublinear Compressive Sensing

- **Status**: ❌
- **Reason**: 압축센싱 측정행렬 설계(GLDPC 영감)로, NAND 채널 ECC 디코더/구성이 아닌 신호복원 — 떼어낼 ECC 기법 없음
- **ID**: arxiv:1603.06286v1
- **Type**: preprint
- **Published**: 2016-03-20
- **Authors**: Xu Chen, Dongning Guo
- **PDF**: https://arxiv.org/pdf/1603.06286v1
...
- **Status**: ❌
- **Reason**: SAT 솔버 HW 가속에 BP를 응용한 것으로, LDPC 디코더 HW를 SAT에 가져다 쓴 방향 — NAND LDPC ECC에 새로 이식할 기법 없음
- **ID**: arxiv:1603.05314v1
- **Type**: preprint
- **Published**: 2016-03-16
- **Authors**: Te-Hsuan Chen, Ju-Yi Lu
- **PDF**: https://arxiv.org/pdf/1603.05314v1
...
- **Status**: ❌
- **Reason**: sparse superposition codes의 threshold saturation 순수 이론 증명 — 디코더/HW/구성으로 이어지지 않는 bound 분석
- **ID**: arxiv:1603.01817v1
- **Type**: preprint
- **Published**: 2016-03-06
- **Authors**: Jean Barbier, Mohamad Dia, Nicolas Macris
- **PDF**: https://arxiv.org/pdf/1603.01817v1
...
- **Status**: ❌
- **Reason**: polar(inner)+LDPC(outer) 연접의 인터리빙 기법 — polar SC 디코딩 상관오류 해소용, 바이너리 LDPC BP에 이식할 부호비의존 디코더 기법 아님
- **ID**: arxiv:1603.00644v2
- **Type**: preprint
- **Published**: 2016-03-02
- **Authors**: Ya Meng, Liping Li, Yanjun Hu
- **PDF**: https://arxiv.org/pdf/1603.00644v2

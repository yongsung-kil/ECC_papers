...
- **Status**: ❌
- **Reason**: ARA(accumulate-repeat-accumulate) 부호 구성, BEC capacity 이론 앙상블로 비-LDPC 구조이며 NAND 이식 기법 없음
- **ID**: arxiv:cs/0509044v1
- **Type**: preprint
- **Published**: 2005-09-15
- **Authors**: Henry D. Pfister, Igal Sason
- **PDF**: https://arxiv.org/pdf/cs/0509044v1
...
- **Status**: ❌
- **Reason**: 연속변수 정보조정(reconciliation, QKD)용 LDPC - 채널 ECC가 아닌 정보조정이라 원칙 제외, 떼어낼 디코더/HW 신규 기법 없음
- **ID**: arxiv:cs/0509041v1
- **Type**: preprint
- **Published**: 2005-09-14
- **Authors**: Matthieu Bloch, Andrew Thangaraj, Steven W. McLaughlin
- **PDF**: https://arxiv.org/pdf/cs/0509041v1
...
- **Status**: ✅
- **Reason**: 2D ISI 채널의 MMSE 등화+LDPC 결합 디코딩, joint equalization/decoding 기법은 NAND 채널 디코더(C)에 이식 가능
- **ID**: arxiv:cs/0509010v1
- **Type**: preprint
- **Published**: 2005-09-05
- **Authors**: N. Singla, J. A. O'Sullivan
- **PDF**: https://arxiv.org/pdf/cs/0509010v1

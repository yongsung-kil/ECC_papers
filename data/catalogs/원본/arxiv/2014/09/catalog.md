...
- **Status**: ❌
- **Reason**: 릴레이 네트워크용 anytime SC-LDPC 코드 delay-exponent 분석 — 통신 응용 특이적 이론, 떼어낼 NAND ECC 기법 없음
- **ID**: arxiv:1409.5177v1
- **Type**: preprint
- **Published**: 2014-09-18
- **Authors**: Md. Noor-A-Rahim, Khoa D. Nguyen, Gottfried Lechner
- **PDF**: https://arxiv.org/pdf/1409.5177v1
...
- **Status**: ❌
- **Reason**: 비이진(GF(2^m)) LDPC ADMM LP 디코더 — 비이진 LDPC는 제외
- **ID**: arxiv:1409.5141v2
- **Type**: preprint
- **Published**: 2014-09-17
- **Authors**: Xishuo Liu, Stark C. Draper
- **PDF**: https://arxiv.org/pdf/1409.5141v2
...
- **Status**: ❌
- **Reason**: 비이진 (2,v)-regular LDPC 최적화(ontology 기반) — 비이진 LDPC는 제외
- **ID**: arxiv:1409.2019v1
- **Type**: preprint
- **Published**: 2014-09-06
- **Authors**: Chao Chen
- **PDF**: https://arxiv.org/pdf/1409.2019v1

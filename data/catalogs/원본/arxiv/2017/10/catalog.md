...
- **Status**: ✅
- **Reason**: protograph LDPC 코드 설계, degree-1/DGLDPC 노드 block threshold 조건 도출 - 이식 가능 코드 설계(E)
- **ID**: arxiv:1710.09651v2
- **Type**: preprint
- **Published**: 2017-10-26
- **Authors**: Asit Kumar Pradhan, Andrew Thangaraj
- **PDF**: https://arxiv.org/pdf/1710.09651v2
...
- **Status**: ❌
- **Reason**: Wyner-Ziv 소스 코딩(LDGM 양자화+syndrome), 채널 ECC 아님 - 소스 코딩 제외
- **ID**: arxiv:1710.07985v1
- **Type**: preprint
- **Published**: 2017-10-22
- **Authors**: Mahdi Nangir, Mahmoud Ahmadian-Attari, Reza Asvadi
- **PDF**: https://arxiv.org/pdf/1710.07985v1

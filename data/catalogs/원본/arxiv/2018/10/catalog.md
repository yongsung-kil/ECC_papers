...
- **Status**: ❌
- **Reason**: 비이진(non-binary GF(q)) LDPC 디코딩 — 바이너리 한정 기준에 따라 제외
- **ID**: arxiv:1810.08921v3
- **Type**: preprint
- **Published**: 2018-10-21
- **Authors**: Maximilian Stark, Jan Lewandowsky, Souradip Saha +1
- **PDF**: https://arxiv.org/pdf/1810.08921v3
...
- **Status**: ❌
- **Reason**: 유한체 랜덤행렬 rank로 LDPC rate 공식 검증하는 순수 이론 bound — 디코더/HW/구성으로 안 이어짐
- **ID**: arxiv:1810.07390v1
- **Type**: preprint
- **Published**: 2018-10-17
- **Authors**: Amin Coja-Oghlan, Pu Gao
- **PDF**: https://arxiv.org/pdf/1810.07390v1
...
- **Status**: ✅
- **Reason**: QKD reconciliation이나 irregular LDPC용 syndrome 기반 QBER 추정+punctured/shortened 처리는 디코더에 떼어낼 여지 있어 애매로 in
- **ID**: arxiv:1810.05841v2
- **Type**: preprint
- **Published**: 2018-10-13
- **Authors**: E. O. Kiktenko, A. O. Malyshev, A. A. Bozhedarov +3
- **PDF**: https://arxiv.org/pdf/1810.05841v2

...
- **Status**: ❌
- **Reason**: 블라인드 등화 위상모호성 해결에 LDPC 비대칭성 활용 — 통신 응용 특이적, 떼어낼 ECC 기법 없음
- **ID**: arxiv:1808.07232v2
- **Type**: preprint
- **Published**: 2018-08-22
- **Authors**: Kun Wang
- **PDF**: https://arxiv.org/pdf/1808.07232v2
...
- **Status**: ✅
- **Reason**: QC-LDPC column weight 4 girth 6/8에서 소형 elementary trapping set 제거 신규 edge-coloring 구성법 → 카테고리 E(바이너리 코드 설계)
- **ID**: arxiv:1808.05258v1
- **Type**: preprint
- **Published**: 2018-08-15
- **Authors**: Mohammad-Reza Sadeghi, Farzane Amirzade
- **PDF**: https://arxiv.org/pdf/1808.05258v1
...
- **Status**: ❌
- **Reason**: LDPC-coded MIMO용 SDR 결합 검출-디코딩 수신기(joint detection-decoding) — 무선 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: arxiv:1808.05477v1
- **Type**: preprint
- **Published**: 2018-08-15
- **Authors**: Kun Wang, Zhi Ding
- **PDF**: https://arxiv.org/pdf/1808.05477v1
...
- **Status**: ❌
- **Reason**: QC-LDPC/MDPC 기반 McEliece 암호시스템 reaction attack 분석 — 보안/암호, 채널 ECC 기법 아님
- **ID**: arxiv:1808.01945v1
- **Type**: preprint
- **Published**: 2018-08-06
- **Authors**: Paolo Santini, Marco Baldi, Franco Chiaraluce
- **PDF**: https://arxiv.org/pdf/1808.01945v1
...
- **Status**: ✅
- **Reason**: Tanner 그래프 짧은 사이클(길이<2g) 개수 계산 신규 스펙트럼 공식 — 사이클 분석은 girth/error-floor 코드설계(E)에 이식 가능
- **ID**: arxiv:1808.00352v2
- **Type**: preprint
- **Published**: 2018-08-01
- **Authors**: Mohsen Alinejad, Kazem Khashyarmanesh
- **PDF**: https://arxiv.org/pdf/1808.00352v2
- **Abstract**: Recently, working on the Tanner graph which represents a low density parity check (LDPC) code becomes an interesting research subject. Finding the number of short cycles of Tanner graphs motivated Blake and Lin to investigate the multiplicity of cycles of length girth in bi-regular bipartite graphs, by using the spectrum and degree distribution of the graph. Although there were many algorithms to find the number of cycles, they preferred to investigate in a computational way. Dehghan and Banihashemi counted the number of cycles of length $g+2$ and $g+4,$ where $G$ is a bi-regular bipartite graph and $g$ is the length of the girth $G.$ But they just proposed a descriptive technique to compute the multiplicity of cycles of length less than $2g$ for bi-regular bipartite graphs. In this paper, we find the number of cycles of length less than $2g$ by using spectrum and degree distribution of a bi-regular bipartite graph such that the formula depends only on the partitions of positive integers and the number of closed cycle-free walks from a vertex of the bi-regular bipartite graph.

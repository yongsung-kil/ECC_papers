...
- **Status**: ✅
- **Reason**: 프로토그래프 기반 QC-LDPC 구성+병렬 디코더 구조 — 바이너리 코드설계/HW 기법(D/E), QC 인코더·병렬 디코더 이식 가능
- **ID**: ieee:7117421
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Lingjun Kong, Liwen He, Pingping Chen +2
- **PDF**: https://ieeexplore.ieee.org/document/7117421
...
- **Status**: ✅
- **Reason**: 새 weighted bit-flipping 디코더(FF/FBS/스케줄링) 제안 — 이식 가능 바이너리 LDPC 디코더 알고리즘(C).
- **ID**: ieee:7208838
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Tofar C.-Y. Chang, Yu T. Su
- **PDF**: https://ieeexplore.ieee.org/document/7208838
...
- **Status**: ✅
- **Reason**: ARM 임베디드 프로세서용 고처리량 layered LDPC 디코더 구현 — 이식 가능 HW/디코더 아키텍처(C/D).
- **ID**: ieee:7244167
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Bertrand Le Gal, Christophe Jego
- **PDF**: https://ieeexplore.ieee.org/document/7244167
...
- **Status**: ❌
- **Reason**: Locally recoverable code 최소거리 bound — 순수 이론 bound, 디코더/HW/구성으로 이어지지 않음.
- **ID**: ieee:7247728
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Viveck R. Cadambe, Arya Mazumdar
- **PDF**: https://ieeexplore.ieee.org/document/7247728
...
- **Status**: ❌
- **Reason**: 분자통신용 채널코딩 비교(EG-LDPC/RM/Hamming) — 표준 LDPC 적용 비교일 뿐 새 기법 없음, 응용 특이적.
- **ID**: ieee:7273857
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Yi Lu, Matthew D. Higgins, Mark S. Leeson
- **PDF**: https://ieeexplore.ieee.org/document/7273857
...
- **Status**: ❌
- **Reason**: TDMR 자기기록 채널의 head skew BER 평가 — LDPC는 베이스라인, 떼어낼 새 디코더·구성·HW 기여 없음(2D 신호처리 특이적)
- **ID**: ieee:7123641
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: R. Suzutou, Y. Nakamura, H. Osawa +3
- **PDF**: https://ieeexplore.ieee.org/document/7123641
- **Abstract**: 2-D magnetic recording (TDMR) exploits 2-D signal processing using the waveforms reproduced by array head from the intended and adjacent tracks to mitigate the effects of intertrack interference. However, an array head has the issue on the degradation of bit error rate (BER) performance due to head skew. In this paper, we evaluate the BER performance of TDMR R/W channel with head skew under a specification of 4 Tbit/in2 employing low-density parity check coding and iterative decoding system using a 2-D finite-impulse response filter by computer simulation. The results show that our system can achieve the reliable BER performances by appropriately setting the reader scanning positions at the head skew angle between 0° and 3°.

## Reduction of Complexity for Nonbinary LDPC Decoders With Compressed Messages

- **Status**: ❌
- **Reason**: 비이진 LDPC 디코더 메시지 압축(CNBMP) — 비이진 LDPC 제외
- **ID**: ieee:6996021
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Jesús O. Lacruz, Francisco García-Herrero, Javier Valls
- **PDF**: https://ieeexplore.ieee.org/document/6996021
...
- **Status**: ❌
- **Reason**: MAMR 면밀도 예측(마이크로마그네틱+채널시뮬) — LDPC는 베이스라인 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:7147805
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: K. K. Teo, K. S. Chan, S. J. Greaves +1
- **PDF**: https://ieeexplore.ieee.org/document/7147805
...
- **Status**: ❌
- **Reason**: Polar SCL 리스트 디코더 HW 아키텍처 — 부호 특화(SC/path pruning/CRC), 바이너리 LDPC BP에 이식 불가한 비-LDPC 부호
- **ID**: ieee:7001058
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Jun Lin, Zhiyuan Yan
- **PDF**: https://ieeexplore.ieee.org/document/7001058
...
- **Status**: ❌
- **Reason**: MIMO 검파기 VLSI(MMSE-SQRD/K-Best) — LDPC 디코더 아님, 검파 HW로 이식성 없음.
- **ID**: ieee:7279190
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Zhiting Yan, Guanghui He, Yifan Ren +3
- **PDF**: https://ieeexplore.ieee.org/document/7279190
...
- **Status**: ❌
- **Reason**: 무선 협력통신 릴레이 SIC 프로토콜 — LDPC 아님, 떼어낼 ECC 기법 없음.
- **ID**: ieee:7247706
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Antonios Argyriou
- **PDF**: https://ieeexplore.ieee.org/document/7247706
...
- **Status**: ❌
- **Reason**: RFID 태그 그룹핑/missing protection — LDPC ECC와 무관, 떼어낼 디코더/HW/코드설계 기법 없음.
- **ID**: ieee:7222414
- **Type**: journal
- **Published**: Nov. 2015
- **Authors**: Yi-Sheng Su, Chung-Hsuan Wang
- **PDF**: https://ieeexplore.ieee.org/document/7222414
...
- **Status**: ✅
- **Reason**: D: 576-bit LDPC 디코더 VLSI 구현(charge-recovery, energy/throughput) - 이식 가능 HW 아키텍처
- **ID**: ieee:7387474
- **Type**: conference
- **Published**: 9-11 Nov. 
- **Authors**: Tai-Chuan Ou, Zhengya Zhang, Marios C. Papaefthymiou
- **PDF**: https://ieeexplore.ieee.org/document/7387474
...
- **Status**: ✅
- **Reason**: 60GHz baseband ASIC backend에 LDPC 디코더 포함, 40nm 구현 — HW 아키텍처(D) 이식 여지, 애매하므로 살림
- **ID**: ieee:7387455
- **Type**: conference
- **Published**: 9-11 Nov. 
- **Authors**: Nicholas Preyss, Christian Senning, Andreas Burg +3
- **PDF**: https://ieeexplore.ieee.org/document/7387455
...
- **Status**: ✅
- **Reason**: C/E — stochastic LDPC 디코더의 trapping set 분석, error floor 낮추는 코드구조 설계 가이드, 바이너리 LDPC 직접 관련
- **ID**: ieee:7421418
- **Type**: conference
- **Published**: 8-11 Nov. 
- **Authors**: Kuo-Lun Huang, Vincent C. Gaudet, Masoud Salehi
- **PDF**: https://ieeexplore.ieee.org/document/7421418
- **Abstract**: Stochastic decoding is a hardware and energy-efficient approach to implement iterative Low-Density Parity-Check (LDPC) decoders. However, stochastic decoding often has a performance loss compared to the sum-product algorithm and suffers from additional trapping sets, which limit the performance of LDPC codes in the error floor region. In this paper, we investigate the error characteristics of stochastic LDPC decoding. We also report stochastic-decoding-specific trapping sets for the (1056,528) LDPC code from the WiMAX standard. This observation has a potential to guide code structure designs that lower the error floor in stochastic decoding.

## LDPC-coded OAM based FSO transmission system in the presence of strong atmospheric turbulence

- **Status**: ❌
- **Reason**: FSO/OAM 무선광 응용에 LDPC 부수 적용, 떼어낼 디코더·HW 기법 없음
- **ID**: ieee:7421288
- **Type**: conference
- **Published**: 8-11 Nov. 
- **Authors**: Zhen Qu, Ivan B. Djordjevic
- **PDF**: https://ieeexplore.ieee.org/document/7421288
...
- **Status**: ✅
- **Reason**: 디코더 메모리 비트셀 고장 완화(MSB 보호·self-correction) + SC-LDPC — NAND HW 신뢰성·디코더 기법 이식 가능(C/D/E)
- **ID**: ieee:7421423
- **Type**: conference
- **Published**: 8-11 Nov. 
- **Authors**: Jiandong Mu, Aida Vosoughi, Joao Andrade +6
- **PDF**: https://ieeexplore.ieee.org/document/7421423
...
- **Status**: ✅
- **Reason**: 양자화 LUT 기반 min-sum 변형 디코더, 3비트 저해상도 메시지 — NAND LDPC LLR 양자화/디코더에 직접 이식 가능(C)
- **ID**: ieee:7421419
- **Type**: conference
- **Published**: 8-11 Nov. 
- **Authors**: Michael Meidlinger, Alexios Balatsoukas-Stimming, Andreas Burg +1
- **PDF**: https://ieeexplore.ieee.org/document/7421419
- **Abstract**: We propose a quantized decoding algorithm for low- density parity-check codes where the variable node update rule of the standard min-sum algorithm is replaced with a look-up table (LUT) that is designed using an information-theoretic criterion. We show that even with message resolutions as low as 3 bits, the proposed algorithm can achieve better error rates than a floating-point min-sum decoder. Moreover, we study in detail the effect of different decoder design parameters, like the design SNR and the LUT tree structure on the performance of our decoder, and we propose some complexity reduction techniques, such as LUT re-use and message alphabet downsizing.

## A software LDPC decoder implemented on a many-core array of programmable processors

- **Status**: ✅
- **Reason**: D — many-core 프로세서 어레이상 SW LDPC 디코더 병렬화/메모리 최적화, 이식 가능 HW/아키텍처
- **ID**: ieee:7421111
- **Type**: conference
- **Published**: 8-11 Nov. 
- **Authors**: Brent Bohnenstiehl, Bevan Baas
- **PDF**: https://ieeexplore.ieee.org/document/7421111
...
- **Status**: ✅
- **Reason**: C/D — parity polytope/probability simplex 투영의 HW 적응(FPGA), LP 디코딩 계열 LDPC 디코더 HW에 이식 가능
- **ID**: ieee:7421292
- **Type**: conference
- **Published**: 8-11 Nov. 
- **Authors**: Mitchell Wasson, Stark C. Draper
- **PDF**: https://ieeexplore.ieee.org/document/7421292
...
- **Status**: ✅
- **Reason**: erasure 채널용 Root-LDPC에 패리티 비트 spatial coupling 적용한 신규 구성; B/E 카테고리 이식 가능
- **ID**: ieee:7566624
- **Type**: conference
- **Published**: 4-7 Nov. 2
- **Authors**: F. Jardel, J.J. Boutros, V. Dedeoglu +2
- **PDF**: https://ieeexplore.ieee.org/document/7566624
...
- **Status**: ✅
- **Reason**: QC-LDPC 디코더 HW: reusable CNU, permutation network, TDMP-NMS min-sum 변형 — D/C 이식 가능
- **ID**: ieee:7517004
- **Type**: conference
- **Published**: 3-6 Nov. 2
- **Authors**: Wenchao Zhang, Song Chen, Xuefei Bai +1
- **PDF**: https://ieeexplore.ieee.org/document/7517004
...
- **Status**: ✅
- **Reason**: D — irregular LDPC용 fully parallel FPGA 디코더 아키텍처, NAND LDPC HW로 이식 가능
- **ID**: ieee:7377471
- **Type**: conference
- **Published**: 24-26 Nov.
- **Authors**: Jan Broulím, Pavel Broulím, Jan Moldaschl +2
- **PDF**: https://ieeexplore.ieee.org/document/7377471
...
- **Status**: ❌
- **Reason**: 4D 성상도 설계·바이너리 라벨링 최적화. LDPC ECC 기법 없음, 변조 성상 도메인 특이적
- **ID**: ieee:7374241
- **Type**: conference
- **Published**: 24-24 Nov.
- **Authors**: Farbod Kayhan, Nicolò Mazzali, Shankar M.R. Bhavani
- **PDF**: https://ieeexplore.ieee.org/document/7374241
- **Abstract**: In this paper we address the problem of constellation design in four dimensional space (4D) under average power constraint. We compare the performance of best lattice constellations with those optimized without any constraint on their structure. Even though the lattice based constellations provide the best minimum distance, usually they do not allow for a good binary labelling. Therefore, in more realistic system scenarios, up to a 2 dB gain can be obtained by properly optimizing the constellation and the corresponding binary labelling. We also investigate the performance of 4D constellations obtained by the Cartesian product of two 2D constellations.

## Hybrid construction of LDPC codes of code length within 2,000 with (14, 8) extended Hamming code

- **Status**: ✅
- **Reason**: (14,8) 확장 해밍 기반 신규 바이너리 LDPC 하이브리드 구성 — 코드설계(E)
- **ID**: ieee:7453886
- **Type**: conference
- **Published**: 20-23 Nov.
- **Authors**: Huan Ma, Yangwen Yu, Lijun Zhang
- **PDF**: https://ieeexplore.ieee.org/document/7453886
- **Abstract**: Based on a (14, 8) extended Hamming code constructed via column splitting of the (7, 4) Hamming code, a method for constructing LDPC codes of code length within 2,000 and of column weight 3 is presented. By using the (14, 8) code and hybrid construction, it is effortless to generate an LDPC code with code rate generally higher than 0.9 by mapping the this code to component of the parity-check matrix. Simulation results show that compared with hybrid construction of Gallager codes and (14, 8) code, that of PEG codes and (14, 8) code performs better and the capacity of it is only a difference of 1.5 dB around to the Shannon limit with sum-product algorithm decoding.

## Hamming-GLDPC codes in BEC and AWGN channel

- **Status**: ✅
- **Reason**: Hamming-GLDPC 신규 구성 및 EXIT/AWGN 성능 분석, 바이너리 — 코드설계(E)
- **ID**: ieee:7453885
- **Type**: conference
- **Published**: 20-23 Nov.
- **Authors**: Yangwen Yu, Ya'nan Han, Lijun Zhang
- **PDF**: https://ieeexplore.ieee.org/document/7453885
- **Abstract**: Hamming codes are used as component codes to construct generalized low-density parity-check (GLDPC) codes. In BEC channel, the convergence behavior of the Hamming-GLDPC codes is theoretically analyzed with EXIT chart. The duality property of Hamming codes and simplex codes helps to get the EXIT chart of Hamming code with the bridge of the EXIT of simplex codes. The analysis shows that the advantage of convergence for Hamming-GLDPC codes is obvious over the duplicate standard LDPC codes. In AWGN channel, simulation results of the GLDPC code with Hamming (7, 4) code as component code also indicate the powerful decoding performance of Hamming-GLDPC codes. Up to 1.5 dB coding gain can be obtained for GLDPC code in comparison with the counterpart standard LDPC code at BER of 10-3.

## Area efficient half row pipelined layered LDPC decoder for gigabit wireless communications

- **Status**: ✅
- **Reason**: layered LDPC 디코더의 half-row 파이프라인 병렬 HW 아키텍처 — 무선 응용이나 D(이식 가능 HW) 기법 존재
- **ID**: ieee:7401700
- **Type**: conference
- **Published**: 2-5 Nov. 2
- **Authors**: Sabooh Ajaz, Hanho Lee
- **PDF**: https://ieeexplore.ieee.org/document/7401700
...
- **Status**: ❌
- **Reason**: 충격성 잡음 채널용 LLR demapper와 density evolution 분석 — 채널 특이적 수신기 설계, NAND에 이식할 디코더·구성 기법 아님
- **ID**: ieee:7448605
- **Type**: conference
- **Published**: 2-4 Nov. 2
- **Authors**: Zhen Mei, Martin Johnston, Stephane Le +1
- **PDF**: https://ieeexplore.ieee.org/document/7448605
- **Abstract**: In conventional communication systems, the additive noise at the receiver is usually assumed to be Gaussian distributed. However, this assumption is not always valid and examples of non-Gaussian distributed noise include power line channels, underwater acoustic channels and man-made interference. Therefore it is important to design a receiver to mitigate the effects of impulsive noise. This paper proposes a new low-complexity receiver design that closely approximates the optimal log-likelihood ratio demapper and performs well when the channel varies from slightly impulsive to very impulsive. Furthermore, we present a density evolution analysis and simulation results of (3, 6) LDPC code on additive impulsive noise channels, with symmetric alpha-stable probability density functions, employing different receivers to overcome the impulsive nature of the channels. Each receiver calculates or approximates the log-likelihood ratios of the received symbols, depending on whether they are optimal or sub-optimal respectively. The threshold signal-to-noise ratios of the LDPC code are derived to determine the start of the waterfall region of the bit-error rate performance and simulation results are presented to validate our density evolution analysis.

## Flooding and node-wise RBP sequentially concatenated decoder for LDPC codes

- **Status**: ✅
- **Reason**: flooding과 NW-RBP를 순차 결합한 신규 BP 스케줄링 디코더로 지연 감소 — 바이너리 LDPC BP 개선(C), NAND 이식 가능
- **ID**: ieee:7448671
- **Type**: conference
- **Published**: 2-4 Nov. 2
- **Authors**: Hua Zhou, Peng Li, Jiao Feng +1
- **PDF**: https://ieeexplore.ieee.org/document/7448671
- **Abstract**: A new strategy of belief propagation (BP) decoder for LDPC codes is presented by sequentially concatenating the scheduling algorithms of flooding and node-wise residual belief propagation (NW RBP) without increasing the complexity of hardware implementation. Compared to NW RBP, the concatenated BP decoder significantly decreases the decoding latency caused by computing and sorting the residual of each message in the factor graph of an LDPC code. As the signal-to-noise ratio (SNR) increases, the decoding performance of the concatenated BP decoder outperforms that of purely applying flooding or NW RBP, and the average number of decoding iterations required for the concatenated decoder decreases and tends to be approximately the same as the other two.

## Timing error analysis of flooded LDPC decoders

- **Status**: ✅
- **Reason**: Min-Sum/SCMS/FAID LDPC 디코더의 타이밍오류 내성·오버클럭 분석 — 이식 가능 디코더·HW 견고성 기법(C/D)
- **ID**: ieee:7360460
- **Type**: conference
- **Published**: 2-4 Nov. 2
- **Authors**: Alexandru Amaricai, Valentin Savin, Oana Boncalo +3
- **PDF**: https://ieeexplore.ieee.org/document/7360460
...
## Implementation of trellis shaping on LDPC coded modulation DSL systems

- **Status**: ❌
- **Reason**: DSL QAM에 trellis shaping 적용한 shaping gain 연구 — 변조/셰이핑 기법, LDPC는 베이스라인, 떼어낼 ECC 기법 없음
- **ID**: ieee:7448656
- **Type**: conference
- **Published**: 2-4 Nov. 2
- **Authors**: Jianhua Liu, Ruosi Liu, Bin Zhou
- **PDF**: https://ieeexplore.ieee.org/document/7448656
- **Abstract**: Shaping gain for trellis shaping is presented in LDPC-coded QAM DSL system. A labelling scheme is designed for current constellations to derive regional shaping effects. The performance of BER results are investigated for various QAM orders from 256QAM to 32768QAM. It is found that for even bits QAM the shaping gain is more evident than odd bits QAM, especially when the QAM order is high; and larger order QAMs are in general have better shaping gains than smaller order QAMs. Based on the BER results with regard to normalized SNR, it is concluded that overall shaping gains of 0.51dB (even bits QAM) and 0.45dB (odd bits QAM) can be derived at BER 10-7 from the presented scheme.

## Code-aided channel estimation and decoding over the flat fading channel with no pilot symbol

- **Status**: ❌
- **Reason**: fading 채널 code-aided 채널추정(RA 부호), 비-LDPC·채널추정 특이 기법, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7448610
- **Type**: conference
- **Published**: 2-4 Nov. 2
- **Authors**: Haifeng Yuan, Ming-Wei Wu, Pooi-Yuen Kam
- **PDF**: https://ieeexplore.ieee.org/document/7448610
- **Abstract**: In this paper, we consider transmissions over the flat fading channel with no pilot symbols, and propose code-aided channel estimation, which utilizes the structure of the error-correction codes for channel estimation. Using a repeat-accumulate code as an example, we demonstrate how pilot-free communication can be achieved effectively with higher information throughput and negligible performance loss. The work aims to motivate the study on code and transceiver design specific to fading channels, which are suitable for efficient low-complexity joint channel estimation and decoding.

## Design and implementation of distributed video coding architecture

- **Status**: ❌
- **Reason**: 분산 비디오 코딩(DVC/Wyner-Ziv) 아키텍처 — JSCC/소스코딩, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7449889
- **Type**: conference
- **Published**: 2-3 Nov. 2
- **Authors**: K S Geetha, Subodh Bhaskar Hegde, H P Vishwas
- **PDF**: https://ieeexplore.ieee.org/document/7449889
- **Abstract**: The present day video coding standards such as MPEG and H.264 are mainly used for broadcast applications, where the encoder is more complex than the decoder. However, for applications such as low power surveillance networks and wireless video cameras, where there is a dearth of hardware at the encoder, the encoder needs to be simpler, but the decoder can be complex. Distributed Video Coding (DVC) technique is an emerging coding paradigm for the above kind of applications. The primary objective of this paper is to design and implement Distributed Video Coding technique, with high compression efficiency and resilience to transmission errors. The main concern of the design is to shift the computationally complex part in the encoder, i.e., Motion Estimation (ME), to the decoder, thereby making the encoder less complex. The whole design is tested on MatLab software and Wyner-Ziv (WZ) part of the codec is implemented on Beagle Bone Black hardware. The test results show that the performance of the DVC Codec developed is close to the performance of H.264 conventional codec, which is a splendid result according to Slepian-Wolf and Wyner-Ziv theorems. A PSNR value of more than 35 dB is achieved along with a compression ratio of around 7:1. Also, there is more than 50% reduction in the encoding time when compared with standard codecs like MPEG, H.264, which was the main concern of this paper.

## Triple Failure Tolerant Storage Systems Using Only Exclusive-Or Parity Calculations

- **Status**: ❌
- **Reason**: XOR 패리티 기반 3중 디스크 장애 허용 배열 — 스토리지지만 LDPC 아닌 erasure/XOR RAID 구성, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7371868
- **Type**: conference
- **Published**: 18-20 Nov.
- **Authors**: Thomas Schwarz, Darrell D. E. Long, Jehan-François Pâris
- **PDF**: https://ieeexplore.ieee.org/document/7371868

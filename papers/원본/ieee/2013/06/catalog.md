...
- **Status**: ✅
- **Reason**: 2D ISI 채널 LDPC 결합 검출에 Chase 기반 저복잡도 check node 연산 — BP 디코더 개선(C) 이식 가능
- **ID**: ieee:6522234
- **Type**: journal
- **Published**: June 2013
- **Authors**: Zhiliang Qin, Kui Cai, Kheong Sann Chan
- **PDF**: https://ieeexplore.ieee.org/document/6522234
...
- **Status**: ❌
- **Reason**: entanglement-assisted 양자 LDPC — CSS·stabilizer·ebit 등 양자 전용 개념 의존, 이식 불가
- **ID**: ieee:6461941
- **Type**: journal
- **Published**: June 2013
- **Authors**: Yuichiro Fujiwara, Vladimir D. Tonchev
- **PDF**: https://ieeexplore.ieee.org/document/6461941
...
- **Status**: ✅
- **Reason**: MLC NAND 플래시 셀간간섭 보상+LDPC용 LLR 생성 (카테고리 A 직접)
- **ID**: ieee:6522273
- **Type**: journal
- **Published**: June 2013
- **Authors**: Taehyung Kim, Gyuyeol Kong, Xi Weiya +1
- **PDF**: https://ieeexplore.ieee.org/document/6522273
...
- **Status**: ✅
- **Reason**: automorphism group 활용 nonequivalent 패리티검사 행렬 다중 디코더로 바이너리 cyclic LDPC 반복디코딩 성능 개선 — 이식 가능 디코더/구성 기법(C/E)
- **ID**: ieee:6493982
- **Type**: journal
- **Published**: June 2013
- **Authors**: Chao Chen, Baoming Bai, Xinquan Yang +2
- **PDF**: https://ieeexplore.ieee.org/document/6493982
...
- **Status**: ✅
- **Reason**: Tree-EP는 BP를 일반화한 신규 메시지패싱 디코더로 BP보다 정확한 marginal 추정 제공 — 이식 가능 디코더(C). BEC 한정이나 애매하면 in
- **ID**: ieee:6451276
- **Type**: journal
- **Published**: June 2013
- **Authors**: Pablo M. Olmos, Juan José Murillo-Fuentes, Fernando Pérez-Cruz
- **PDF**: https://ieeexplore.ieee.org/document/6451276
...
- **Status**: ✅
- **Reason**: trapping set 기반 LDPC 저오율 성능 추정(importance sampling) — error floor/TS 평가는 NAND LDPC 코드설계(E)에 이식 가능
- **ID**: ieee:6502175
- **Type**: journal
- **Published**: June 2013
- **Authors**: Seok-Ki Ahn, Kyeongcheol Yang, Dongsoo Har
- **PDF**: https://ieeexplore.ieee.org/document/6502175
...
- **Status**: ❌
- **Reason**: HAMR 자기기록 채널 전용 BiPDNP 검출기/BCJR가 핵심, LDPC는 부수 베이스라인
- **ID**: ieee:6522289
- **Type**: journal
- **Published**: June 2013
- **Authors**: Yibin Ng, Kui Cai, B. V. K. Vijaya Kumar +2
- **PDF**: https://ieeexplore.ieee.org/document/6522289
...
- **Status**: ❌
- **Reason**: erasure를 error에서 분리하는 패리티검사 행렬·separating redundancy는 일반 선형부호 erasure 디코딩 이론으로 NAND 채널 ECC 디코더/HW 기여 없음
- **ID**: ieee:6457505
- **Type**: journal
- **Published**: June 2013
- **Authors**: Khaled A. S. Abdel-Ghaffar, Jos H. Weber
- **PDF**: https://ieeexplore.ieee.org/document/6457505
...
- **Status**: ❌
- **Reason**: RFID 태그 그룹화(SSF) 응용, LDPC는 비교 대상일 뿐 떼어낼 ECC 기법 없음
- **ID**: ieee:6517352
- **Type**: journal
- **Published**: June 2013
- **Authors**: Yi-Sheng Su, Jiun-Ren Lin, Ozan K. Tonguz
- **PDF**: https://ieeexplore.ieee.org/document/6517352
...
- **Status**: ✅
- **Reason**: turbo/LDPC 재구성형 VLSI 디코더 아키텍처 — LDPC 디코딩용 HW 병렬화/NoC 구조가 NAND LDPC HW에 이식 가능(D)
- **ID**: ieee:6365775
- **Type**: journal
- **Published**: June 2013
- **Authors**: Carlo Condo, Maurizio Martina, Guido Masera
- **PDF**: https://ieeexplore.ieee.org/document/6365775
...
- **Status**: ❌
- **Reason**: 무선 분산 비디오 전송(DCast), FEC 없이 전력할당 — LDPC ECC 기법 아님, 떼어낼 디코더/구성 없음
- **ID**: ieee:6470664
- **Type**: journal
- **Published**: June 2013
- **Authors**: Xiaopeng Fan, Feng Wu, Debin Zhao +1
- **PDF**: https://ieeexplore.ieee.org/document/6470664
...
- **Status**: ❌
- **Reason**: OAM 광섬유 crosstalk 완화에 soft-decision LDPC를 적용한 실험; 떼어낼 신규 디코더/구성 기법 없는 무선/통신 응용
- **ID**: ieee:6833161
- **Type**: conference
- **Published**: 9-14 June 
- **Authors**: Yongxiong Ren, Yequn Zhang, Yang Yue +8
- **PDF**: https://ieeexplore.ieee.org/document/6833161
- **Abstract**: The efficient mitigation of crosstalk-induced “error floor” in system performance by using soft-decoding LDPC codes in an OAM-based four modes multiplexed fiber transmission system is experimentally demonstrated. A significant coding gain of >15.5 dB is achieved, depending on the amount of crosstalk from other channels.

## Optimum signal constellation design and mapping rule for few-mode fiber based LDPC-coded CO-OFDM

- **Status**: ❌
- **Reason**: 광통신 CO-OFDM 신호 성좌 설계/매핑 규칙; LDPC는 베이스라인이고 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:6833101
- **Type**: conference
- **Published**: 9-14 June 
- **Authors**: Ding Zou, Tao Liu, Ivan B. Djordjevic +1
- **PDF**: https://ieeexplore.ieee.org/document/6833101
...
- **Status**: ✅
- **Reason**: LDPC-CC 레이어드 디코딩 알고리즘+멀티레이트 ASIC/VLSI 아키텍처; 디코더(C)+HW(D) 이식 가능
- **ID**: ieee:6655475
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Yun Chen, Changsheng Zhou, Yuebin Huang +1
- **PDF**: https://ieeexplore.ieee.org/document/6655475
...
- **Status**: ❌
- **Reason**: 비이진(q-ary) LDPC, erasure channel MAP 디코딩 — non-binary 제외 대상
- **ID**: ieee:6655047
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Giuliano Garrammone, Enrico Paolini, Balázs Matuz +2
- **PDF**: https://ieeexplore.ieee.org/document/6655047
...
- **Status**: ❌
- **Reason**: McEliece 암호용 QC-LDPC 패리티검사 밀도 최적화, 보안/표준코드, 채널 ECC 신규 기여 없음
- **ID**: ieee:6649325
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Marco Baldi, Marco Bianchi, Franco Chiaraluce
- **PDF**: https://ieeexplore.ieee.org/document/6649325
...
- **Status**: ❌
- **Reason**: 3D메시 QIM-LDPC 워터마킹, 데이터은닉용 LDPC, 이식 가능 ECC 기법 없음
- **ID**: ieee:6649324
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Bata Vasic, Bane Vasic
- **PDF**: https://ieeexplore.ieee.org/document/6649324
...
- **Status**: ✅
- **Reason**: Self-Corrected Min-Sum 디코더 error-floor 성능 분석 — min-sum 변형 이식 가능(C)
- **ID**: ieee:6655051
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Joao Andrade, Gabriel Falcao, Vitor Silva +3
- **PDF**: https://ieeexplore.ieee.org/document/6655051
...
- **Status**: ✅
- **Reason**: reweighted message passing/max-product 등 BP 디코더 변형 비교 — 바이너리 LDPC BP에 이식 가능(C)
- **ID**: ieee:6655048
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Henk Wymeersch, Federico Penna, Vladimir Savic +1
- **PDF**: https://ieeexplore.ieee.org/document/6655048
...
- **Status**: ❌
- **Reason**: TDS-OFDM 채널추정 압축센싱, LDPC 무관 무선 응용
- **ID**: ieee:6654997
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Linglong Dai, Jintao Wang, Zhaocheng Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/6654997
...
- **Status**: ❌
- **Reason**: 채널단축 검출기 송신필터 최적화, LDPC 무관
- **ID**: ieee:6655017
- **Type**: conference
- **Published**: 9-13 June 
- **Authors**: Andrea Modenini, Fredrik Rusek, Giulio Colavolpe
- **PDF**: https://ieeexplore.ieee.org/document/6655017
...
- **Status**: ❌
- **Reason**: LDPC-RS product code(비-LDPC 부호 결합), Raptor-like+RS 하이브리드 디코딩, 떼어낼 순수 바이너리 LDPC 기법 아님
- **ID**: ieee:6621783
- **Type**: conference
- **Published**: 5-7 June 2
- **Authors**: Yaqi Li, Bo Liu, Bo Rong +4
- **PDF**: https://ieeexplore.ieee.org/document/6621783
...
- **Status**: ✅
- **Reason**: dual-polarized MIMO 채널응답을 LLR 계산에 반복 활용하는 신규 LDPC 디코딩 알고리즘 - 애매하나 디코더 기법(C)으로 살림(Phase3)
- **ID**: ieee:6621716
- **Type**: conference
- **Published**: 5-7 June 2
- **Authors**: Shingo Asakura, Kenichi Murayama, Takuya Shitomi +1
- **PDF**: https://ieeexplore.ieee.org/document/6621716
...
- **Status**: ❌
- **Reason**: fountain 특성 quarter-rate LDPC, truncated 성능이 전용 코드보다 같거나 나쁨, fountain/erasure 계열로 제외
- **ID**: ieee:6621773
- **Type**: conference
- **Published**: 5-7 June 2
- **Authors**: Sung Ik Park, Yiyan Wu, Heung Mook Kim +4
- **PDF**: https://ieeexplore.ieee.org/document/6621773
...
- **Status**: ❌
- **Reason**: 광통신 mutual information bound와 TCM/regular LDPC 성능 비교 — 순수 비교/이론, 신규 디코더/구성/HW 없음
- **ID**: ieee:6602943
- **Type**: conference
- **Published**: 23-27 June
- **Authors**: Tobias Fehenberger, Norbert Hanik
- **PDF**: https://ieeexplore.ieee.org/document/6602943
...
- **Status**: ❌
- **Reason**: Doubly generalized LDPC(DGLDPC) — generalized constraint(component code) 구조로 표준 바이너리 LDPC ECC와 별개, NAND 표준 QC-LDPC로 떼어낼 신규 기법 모호하나 generalized 구조 의존
- **ID**: ieee:6692727
- **Type**: conference
- **Published**: 2-5 June 2
- **Authors**: Raffaele Soloperto, Giuliano Garrammone, Gianluigi Liva +1
- **PDF**: https://ieeexplore.ieee.org/document/6692727
- **Abstract**: We introduce a class of structured (protograph-based) doubly generalized low-density parity-check (DGLDPC) codes. The proposed class leads to quasi-cyclic codes for which efficient encoder and decoder implementations are possible. In particular, we illustrate that on the additive white Gaussian noise (AWGN) channel, the introduced structured DGLDPC codes do not lose in performance with respect to unstructured DGLDPC codes. Furthermore, a sufficient condition on the code graph is derived, which allows unveiling the quasi-cyclic nature of the designed codes.

## Physical-Layer Network Coding in Coded OFDM Systems with Multiple-Antenna Relay

- **Status**: ❌
- **Reason**: OFDM physical-layer network coding+MIMO relay 검출 연구, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:6692712
- **Type**: conference
- **Published**: 2-5 June 2
- **Authors**: Meng Wu, Dirk Wubben, Armin Dekorsy
- **PDF**: https://ieeexplore.ieee.org/document/6692712
...
- **Status**: ❌
- **Reason**: Polar code SCL 디코더 tree-pruning — polar 전용 SC 트리 구조 의존, 바이너리 LDPC BP로 이식 불가
- **ID**: ieee:6691844
- **Type**: conference
- **Published**: 2-5 June 2
- **Authors**: Kai Chen, Kai Niu, Jiaru Lin
- **PDF**: https://ieeexplore.ieee.org/document/6691844
- **Abstract**: Polar codes are the first constructive and provable capacity-achieving codes. In finite code length cases, successive cancellation list (SCL) decoding algorithm is reported to have performance very close to maximum-likelihood (ML) decoding. In this paper, a reduced-complexity version of SCL decoding algorithm is proposed to boost the finite- length performance of polar codes. By regarding the SCL decoding algorithm as a path searching procedure in a code tree representation, a tree-pruning technique is used to avoid unnecessary path searching operations. With only a negligible loss of performance, the computational complexity of pruned SCL decoder can be very close to that of the successive cancellation (SC) decoder in the moderate and high signal-to- noise ratio (SNR) regime.

## Channel information estimation for error correcting code in road-to-vehicle visible light communication systems

- **Status**: ❌
- **Reason**: VLC 채널정보 추정 기법, LDPC는 부수 언급. 떼어낼 디코더 기법 없는 무선 응용 특이적.
- **ID**: ieee:6698229
- **Type**: conference
- **Published**: 2-3 June 2
- **Authors**: Hiraku Okada, Shinnosuke Misawa, Takaya Yamazato +2
- **PDF**: https://ieeexplore.ieee.org/document/6698229
- **Abstract**: This paper focuses on a road-to-vehicle visible light communication (VLC) system using LED traffic lights and high-speed cameras on cars. So as to improve the transmission reliability, an error correcting code like a low-density parity-check (LDPC) is applied to the road-to-vehicle VLC system. The decoder of the LDPC code needs channel information in order to maximize decoding performance. Usually, it is calculated from a signal-to-noise ratio (SNR) or bit error rate (BER) of a channel, where noise is a dominant factor of the channel characteristic. In the road-to-vehicle VLC system, not noise but interference among LEDs decides the channel characteristic. In this paper, we propose a channel information estimation method for the road-to-vehicle VLC system. The proposed method estimates a signal-to-interference ratio (SIR) from the receiving image, and calculates the channel information using the SIR. The proposed method is evaluated by experiment. As a result, the proposed method can achieve almost the same performance with the optimum case, and then maximize the decoding performance.

## dmin-based precoder applied to non-binary LDPC coded MIMO system

- **Status**: ❌
- **Reason**: 비이진 NB-LDPC over GF(24) + MIMO precoder, 비이진 LDPC라 제외
- **ID**: ieee:6579578
- **Type**: conference
- **Published**: 19-21 June
- **Authors**: Tarek Chehade, Philippe Rostaing, Ludovic Collin +2
- **PDF**: https://ieeexplore.ieee.org/document/6579578
- **Abstract**: In this paper, we present a transmission model for a multiple-input multiple-output (MIMO) channel with perfect channel state information (CSI). We intend to exploit the available CSI through the use of a precoder based on the minimum Euclidean distance (dmin) criterion. We also introduce a low density parity check coding block in order to improve the system performance. We consider a two-stream 4QAM-MIMO transmission scheme (4 bits per transmitted symbol vector) associated to a non-binary LDPC (NB-LDPC) code over GF(24). The addition of the precoder in this system is studied. Simulations are made in order to show the interest of the association of the dmin-based precoder with NB-LDPC codes, which is particularly well suited for LDPC codes with high rates.

## Performance analysis of QC-LDPC construction based on distance graph

- **Status**: ✅
- **Reason**: 거리그래프 기반 QC-LDPC 구성법(girth/길이/율 조절) 제안 - 이식 가능 코드설계(E)
- **ID**: ieee:6566542
- **Type**: conference
- **Published**: 19-21 June
- **Authors**: Lixin Li, Meng Zhu, Fan Yang +1
- **PDF**: https://ieeexplore.ieee.org/document/6566542
- **Abstract**: According to the fact that the random construction method of LDPC(Low Density Parity Check) codes are lack of structure and are difficult to be implemented in hardware, two construction methods of QC-LDPC(Quasi-Cyclic LDPC) codes-sequential and random search method based on distance graph are proposed. The two algorithms can produce flexible QCLDPC codes by setting the parameters such as code length, rates and girth according to requirement. The simulation shows that: the random search method performs better than the sequential search method and the QC-LDPC codes constructed by random search method have equivalent BER performance with PEG construction method. Compared with the existing random construction method, the two methods proposed are faster, and can obtain quasi-cyclic codes which are easy to be implemented in hardware.

## Statistical analysis-based approach for check node processor inputs of NB-LDPC decoder

- **Status**: ❌
- **Reason**: 비이진 NB-LDPC 체크노드 복잡도 감소 기법, 비이진 LDPC라 제외
- **ID**: ieee:6579584
- **Type**: conference
- **Published**: 19-21 June
- **Authors**: Ali Chamas Al Ghouwayel, Abbass Nasser, Ali Alaeddine +1
- **PDF**: https://ieeexplore.ieee.org/document/6579584
- **Abstract**: Non-Binary LDPC codes are nowadays considered as a potential competitor of both binary LDPC and convolutional Turbo Codes, mainly when codes with short and moderate codeword lengths are used. However, the Non-Binary nature of these codes makes their decoding process suffers from high computational complexity. This paper deals with the reduction of this computational complexity at the Check Node level based on the selection of the most reliable messages effectively impacting the CN processing. Two main message truncation schemes are proposed leading to a reduction of the memory size needed to store the extrinsic reliability messages of the order of 12 %. The Monte Carlo simulation results show that these truncation schemes do not degrade the performance of the code where in the worst case a loss of 0.06 dB is obtained.

## A new LDPC-COFDM scheme in cooperative communication system

- **Status**: ❌
- **Reason**: LDPC-COFDM 협력통신 시스템 응용, LDPC는 베이스라인이고 떼어낼 ECC 기법 없음
- **ID**: ieee:6566545
- **Type**: conference
- **Published**: 19-21 June
- **Authors**: Lixin Li, Wen Sun, Nan Qi +2
- **PDF**: https://ieeexplore.ieee.org/document/6566545
- **Abstract**: This paper proposes a cooperation system jointing LDPC codes and OFDM modulation. Its principle is given in detail that the signal is encoded by LDPC and modulated with OFDM, moreover, transmit diversity is created when the relay station assists a sender by retransmitting its information signal to the destination. Furthermore, several simulation results are presented to validate the proposed approach and a comparison with several conventional schemes is provided on Gaussian channel and Rayleigh flat-fading channel. In particular, we show that an excellent BER performance can be reached with the proposed strategies without much high computational complexity. The average symbol error rate simulation results allow us to clearly illustrate the advantage that the proposed system has in overcoming the severe penalty in signal-to-noise ratio caused by channel.

## Iterative decoding and multiuser communication using sparse space codes for MIMO channels

- **Status**: ❌
- **Reason**: sparse space code MIMO 검출, LDPC는 외부부호 베이스라인이고 떼어낼 ECC 기법 없음
- **ID**: ieee:6621614
- **Type**: conference
- **Published**: 18-21 June
- **Authors**: Sagar Dhakal, Thomas A. Sexton, Steve Hranilovic
- **PDF**: https://ieeexplore.ieee.org/document/6621614
- **Abstract**: We propose a new decoding algorithm for sparse space codes (SSC) transmission in an open-loop under-determined MIMO channel. The basis pursuit detector algorithm is combined with the sum-product algorithm to facilitate an iterative decoding using the LDPC based outer codes and the SSC based inner codes. In addition, a novel idea on multiuser detection using SSC codes is presented for an uplink MIMO channel.

## An improved normalized min-sum algorithm for LDPC codes

- **Status**: ✅
- **Reason**: 개선된 normalized min-sum(IN-MS) 디코더 알고리즘, 부호 비의존적 이식 가능 디코더(C)
- **ID**: ieee:6607890
- **Type**: conference
- **Published**: 16-20 June
- **Authors**: Jinlei Chen, Yan Zhang, Ruiyi Sun
- **PDF**: https://ieeexplore.ieee.org/document/6607890
- **Abstract**: An improved normalized min-sum (IN-MS) algorithm is proposed for decoding low-density parity-check (LDPC) codes. In this algorithm, two normalized factors are used in check node computing, one for the minimum data and another for the second minimum data, and this algorithm achieves a better approximation to the BP algorithm. Simulation results show that the decoding performance of IN-MS algorithm is better than that of the normalized min-sum (NMS) algorithm.

## Controlled start-up stochastic decoding of LDPC codes

- **Status**: ✅
- **Reason**: Controlled Start-up Stochastic(CSS) LDPC 디코딩 알고리즘, FPGA 완전병렬 구현하는 신규 디코더 기법(C/D)
- **ID**: ieee:6573662
- **Type**: conference
- **Published**: 16-19 June
- **Authors**: Mountassar Maamoun, Rafik Bradai, Ali Naderi +2
- **PDF**: https://ieeexplore.ieee.org/document/6573662
- **Abstract**: This paper concerns a new and powerful Low-Density Parity-Check (LDPC) stochastic decoding algorithm, called Controlled Start-up Stochastic (CSS) decoding, to implement fully parallel LDPC decoders. The proposed algorithm uses a clever starting point computing method to improve the convergence as well as to reduce the latency of the decoding process, without a significant hardware complexity cost. Using this stochastic method, in low signal-to-noise ratio (SNR) region, a short LDPC code can outperforms the fixed point state-of-the-art (2048, 1723) LDPC code. To validate the performance of the proposed algorithm, a (48, 24) LDPC code are implemented on Xilinx Virtex-6 VLX240T field programmable gate array device, with and without the CSS method. The new algorithm provides a decoding speed seven times faster and a Bit Error Rate (BER) hundred times better at E3/N0=4.5 dB. In addition, the results provide a BER better than the 6 bits offset min-sum algorithm (OMSA) and better than the 6 bits sum-product algorithm (SPA) for the (2048, 1723) LDPC code, below E3/N0=3.9 dB and Eb/N0=4.3 dB respectively. The obtained results show that, the proposed algorithm is the first stochastic algorithm which can outperform the OMSA and SPA algorithms, with less hardware complexity.

## A multi-standard efficient column-layered LDPC decoder for Software Defined Radio on GPUs

- **Status**: ✅
- **Reason**: GPU 기반 column-layered QC-LDPC 디코더 병렬화/메모리 최적화 기법, 디코더 알고리즘·병렬화로 이식 가능(C/D)
- **ID**: ieee:6612145
- **Type**: conference
- **Published**: 16-19 June
- **Authors**: Rongchun Li, Jie Zhou, Yong Dou +3
- **PDF**: https://ieeexplore.ieee.org/document/6612145
...
- **Status**: ❌
- **Reason**: 무선 환경 secret key generation 보안 실험, ECC/LDPC 디코더 기법 아님
- **ID**: ieee:6612134
- **Type**: conference
- **Published**: 16-19 June
- **Authors**: Alexandre J. Pierrot, Rémi A. Chou, Matthieu R. Bloch
- **PDF**: https://ieeexplore.ieee.org/document/6612134
- **Abstract**: This paper proposes a proof-of-principle design of a secret key generation system along with the desirable secrecy analysis to guarantee information-theoretic security. We conduct physical experiments on programmable radios in an indoor environment to analyze the statistical characteristics of the induced source that we employ to generate secret keys. We also provide a generic security analysis of the system, and we give an estimate of the achievable secret key rates for a target information leakage in the finite block-length regime.

## Spherical codes for the Gaussian wiretap channel with continuous input alphabets

- **Status**: ❌
- **Reason**: Gaussian wiretap channel용 spherical code(보안 secrecy 코드), 비-LDPC이고 NAND ECC 이식 기법 없음
- **ID**: ieee:6612133
- **Type**: conference
- **Published**: 16-19 June
- **Authors**: João Almeida, Cristiano Torezzan, João Barros
- **PDF**: https://ieeexplore.ieee.org/document/6612133
- **Abstract**: We address the problem of designing codes for transmission over a Gaussian wiretap channel when the source is continuously-valued. We show that spherical codes based on flat tori can provide a natural constructive method to design codes for secrecy. In particular, their geometrical properties allow to fine tune the code for prescribed levels of reliability and secrecy, while providing a basis for efficient encoding and decoding. We present a suitable parametrization for these codes which enables legitimate users to communicate under a small distortion, while forcing the eavesdropper to operate at large distortions.

## A parallelized layered QC-LDPC decoder for IEEE 802.11ad

- **Status**: ✅
- **Reason**: 802.11ad용 이중 병렬화 layered QC-LDPC 디코더 VLSI 구현, 병렬화 HW 아키텍처 기법(D)
- **ID**: ieee:6573590
- **Type**: conference
- **Published**: 16-19 June
- **Authors**: Alexios Balatsoukas-Stimming, Nicholas Preyss, Alessandro Cevrero +2
- **PDF**: https://ieeexplore.ieee.org/document/6573590
- **Abstract**: We present a doubly parallelized layered quasi-cyclic low-density parity-check decoder for the emerging IEEE 802.11ad multigigabit wireless standard. The decoding algorithm is equivalent to a non-parallelized layered decoder and, thus, retains its favorable convergence characteristics, which are known to be superior to those of flooding schedule based decoders. The proposed architecture was synthesized using a TSMC 40 nm CMOS technology, resulting in a cell area of 0.18 mm2 and a clock frequency of 850 MHz. At this clock frequency, the decoder achieves a coded throughput of 3.12 Gbps, thus meeting the throughput requirements when using both the mandatory BPSK modulation and the optional QPSK modulation.

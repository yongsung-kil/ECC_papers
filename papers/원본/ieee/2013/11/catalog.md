...
- **Status**: ❌
- **Reason**: 선형부호 신드롬 기반 채널 파라미터 추정(ML). 디코더/HW/코드설계가 아닌 추정 이론, NAND ECC 이식 불가
- **ID**: ieee:6600724
- **Type**: journal
- **Published**: November 2
- **Authors**: Gottfried Lechner, Christoph Pacher
- **PDF**: https://ieeexplore.ieee.org/document/6600724
...
- **Status**: ❌
- **Reason**: 슬롯 ALOHA rateless 랜덤액세스 프로토콜, 채널 ECC가 아니라 무선 액세스 기법
- **ID**: ieee:6630481
- **Type**: journal
- **Published**: November 2
- **Authors**: Cedomir Stefanovic, Petar Popovski
- **PDF**: https://ieeexplore.ieee.org/document/6630481
...
- **Status**: ❌
- **Reason**: CRT 기반 RFID 태그 그룹핑 식별 기법, LDPC ECC 비의존·떼어낼 디코더/구성 없음
- **ID**: ieee:6630480
- **Type**: journal
- **Published**: November 2
- **Authors**: Yi-Sheng Su, Ozan K. Tonguz
- **PDF**: https://ieeexplore.ieee.org/document/6630480
...
- **Status**: ❌
- **Reason**: 무선센서망 클록동기 분산추정에 BP 사용, ECC 디코더 아님·떼어낼 LDPC 기법 없음
- **ID**: ieee:6644230
- **Type**: journal
- **Published**: November 2
- **Authors**: Jian Du, Yik-Chung Wu
- **PDF**: https://ieeexplore.ieee.org/document/6644230
...
- **Status**: ❌
- **Reason**: 랜덤액세스 분산 전력제어(SIC). LDPC 무관, ECC 기법 없음
- **ID**: ieee:6518475
- **Type**: journal
- **Published**: November 2
- **Authors**: Chongbin Xu, Li Ping, Peng Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/6518475
...
- **Status**: ❌
- **Reason**: 비이진(NB GF(2^p)) LDPC min-max 디코더, 비이진 LDPC는 제외 대상
- **ID**: ieee:6374266
- **Type**: journal
- **Published**: Nov. 2013
- **Authors**: Fang Cai, Xinmiao Zhang
- **PDF**: https://ieeexplore.ieee.org/document/6374266
...
- **Status**: ❌
- **Reason**: D-GLDPC 가중치 스펙트럼 점근 지수의 순수 이론 분석, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:6515184
- **Type**: journal
- **Published**: Nov. 2013
- **Authors**: Mark F. Flanagan, Enrico Paolini, Marco Chiani +1
- **PDF**: https://ieeexplore.ieee.org/document/6515184
...
- **Status**: ❌
- **Reason**: 3D 메시 워터마킹용 QIM+삭제정정부호 — 채널 ECC 아님, 떼어낼 바이너리 LDPC 기법 없음
- **ID**: ieee:6522818
- **Type**: journal
- **Published**: Nov. 2013
- **Authors**: Bata Vasic, Bane Vasic
- **PDF**: https://ieeexplore.ieee.org/document/6522818
...
- **Status**: ❌
- **Reason**: 공간결합+AMP 압축센싱 복원 — CS reconstruction, 채널 ECC 디코더 아님; spatial coupling 개념은 순수 LDPC 논문서 다룸
- **ID**: ieee:6566160
- **Type**: journal
- **Published**: Nov. 2013
- **Authors**: David L. Donoho, Adel Javanmard, Andrea Montanari
- **PDF**: https://ieeexplore.ieee.org/document/6566160
...
- **Status**: ❌
- **Reason**: LNS 가감산 저전력 VLSI/디지털필터, LDPC ECC와 무관
- **ID**: ieee:6212439
- **Type**: journal
- **Published**: Nov. 2013
- **Authors**: Ioannis Kouretas, Charalambos Basetas, Vassilis Paliouras
- **PDF**: https://ieeexplore.ieee.org/document/6212439
...
- **Status**: ❌
- **Reason**: non-binary GLDPC 부호 — 비이진 LDPC는 제외
- **ID**: ieee:6810673
- **Type**: conference
- **Published**: 3-6 Nov. 2
- **Authors**: Nicholas B. Chang, Marko Kocic
- **PDF**: https://ieeexplore.ieee.org/document/6810673
...
## Linear precoding for MIMO with LDPC coding and reduced receiver complexity

- **Status**: ❌
- **Reason**: MIMO용 선형 프리코더 설계, LDPC는 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:6810670
- **Type**: conference
- **Published**: 3-6 Nov. 2
- **Authors**: T. Ketseoglou, E. Ayanoglu
- **PDF**: https://ieeexplore.ieee.org/document/6810670
...
- **Status**: ❌
- **Reason**: 무선용 non-binary rateless LDPC — 비이진+rateless, 제외
- **ID**: ieee:6810674
- **Type**: conference
- **Published**: 3-6 Nov. 2
- **Authors**: David L. Romero, Nicholas B. Chang, Adam R. Margetts
- **PDF**: https://ieeexplore.ieee.org/document/6810674
...
- **Status**: ❌
- **Reason**: Markov chain 알고리즘 일반론으로 LDPC 디코딩을 예시로만 언급, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:6810242
- **Type**: conference
- **Published**: 3-6 Nov. 2
- **Authors**: Biplab Deka, Alex A. Birklykke, Henry Duwe +2
- **PDF**: https://ieeexplore.ieee.org/document/6810242
...
- **Status**: ❌
- **Reason**: RS 기반 UEP 비디오 전송, LDPC 아님 — 비-LDPC 부호 제외
- **ID**: ieee:6782082
- **Type**: conference
- **Published**: 23-25 Nov.
- **Authors**: Mohd Ayyub Khan, Athar Ali Moinuddin, Ekram Khan
- **PDF**: https://ieeexplore.ieee.org/document/6782082
...
- **Status**: ❌
- **Reason**: CR/MIMO 보안용 spatial LDPC(채널 의존), 무선 간섭제거 응용 특이적; NAND 이식 기법 없음
- **ID**: ieee:6827796
- **Type**: conference
- **Published**: 22-258 Nov
- **Authors**: Yang Xiao, Jinfeng Kou, Dong Wang
- **PDF**: https://ieeexplore.ieee.org/document/6827796
- **Abstract**: The existing cognitive radio (CR) systems lack the ability to deal with the attack of a pretended primary user (PPU), which can palsy cognitive network by sending some random signal at the frequency band of CR network. To solve the problem, in this paper, a secure cognitive radio (CR) system is proposed. We develop a spatial LDPC code, which combines MIMO technique and low density parity check (LDPC) codes to cancel the electronic interference of PPU. In the proposed scheme, the spatial LDPC code depends on the wireless channel between the CR mobile station (MS) and CR base station, so different CR MS has its own spatial LDPC code. The spatial LDPC codes in CR network can very with channels, they can be recovered by the CR receivers from the attacked bits of PPU. The simulation results in Rayleigh flat-fading channel show that CR MIMO system with the proposed spatial LDPC codes can effectively cancel electronic interference from PPU.

## Spread spectrum LDPC for cognitive systems working in TV frequency band

- **Status**: ❌
- **Reason**: 인지무선 TV대역 간섭제거용 spread spectrum LDPC; 무선 응용 특이적, 떼어낼 디코더/구성 기법 없음
- **ID**: ieee:6827798
- **Type**: conference
- **Published**: 22-258 Nov
- **Authors**: Yang Xiao, Kaiyao Wang, Dong Wang +1
- **PDF**: https://ieeexplore.ieee.org/document/6827798
- **Abstract**: In the cable television covered area, the cognitive users (CUs) will face the problem of TV signals interference from TV station, so that CUs cannot effectively utilize the spectrum hole of TV band. To solve this problem, the spread spectrum LDPC (SSLDPC) code for cognitive system has been proposed by us to cancel the TV interference recently. These papers extended and deepen the results of SS-LDPC, developed the algorithms of soften-coding and soft-decoding, removed classical spreading and despreading circuits, simplified the transmitters and receivers of CUs. The cognitive system with SS-LDPC need not withdraw the TV signals, and the CUs can use the TV band to communicate with base-station (BS). The construction, encoding and decoding approaches of SS-LDPC are provided. The information transmission of cognitive system with SS-LDPC can be of the anti-interference ability and error correcting capability. The simulation results in Rayleigh flat-fading channel show that, comparing with cognitive system without SS-LDPC, the proposed approach can effectively cancel TV signals interference.
...
- **Status**: ❌
- **Reason**: jamming 하 기존 코딩방식(LDPC/turbo/BCH) 성능평가만, 신규 디코더·구성 기여 없음
- **ID**: ieee:6735790
- **Type**: conference
- **Published**: 18-20 Nov.
- **Authors**: M. Baldi, M. Bianchi, F. Chiaraluce +4
- **PDF**: https://ieeexplore.ieee.org/document/6735790
...
## An RC-LDPC coded adaptive cooperative communication scheme based on the Mutual Information model

- **Status**: ❌
- **Reason**: RC-LDPC 협력통신 적응 코딩 응용 — 무선통신 특이적, 떼어낼 ECC 기법 없음
- **ID**: ieee:6820448
- **Type**: conference
- **Published**: 17-19 Nov.
- **Authors**: Xiang Chen, Mingxiang Xie, Huanbing Liu
- **PDF**: https://ieeexplore.ieee.org/document/6820448
- **Abstract**: Cooperative communication is a promising technology to obtain diversity gain at user terminals. According to the traditional coded cooperation scheme, it is hard for relay node to know the optimal number of new parity bits to relay. This paper introduces the Adaptive Coded Cooperation (ACC) scheme for accurate prediction based on the Mutual Information model. The reliability requirement is satisfied, and the radio resource is saved for transmitting new information. Furthermore, Rate Compatible (RC) LDPC codes help to improve throughput even more. Simulation results indicate that the ACC scheme improves the spectral efficiency significantly, even outperforms the Adaptive Decode-and-Forward (ADF) scheme.

## An efficient carrier estimation algorithm for two-way relay systems with physical-layer network coding

- **Status**: ❌
- **Reason**: 물리계층 네트워크코딩 캐리어 추정 — LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:6767246
- **Type**: conference
- **Published**: 17-19 Nov.
- **Authors**: Ronghai Guo, Jiping Li, Tuanfeng Wu +1
- **PDF**: https://ieeexplore.ieee.org/document/6767246
...
- **Status**: ❌
- **Reason**: CMMB 표준 LDPC 인코더의 LU 분해 기반 구현으로 표준 부호 단순 구현, 새 HW 기여 없음
- **ID**: ieee:6835475
- **Type**: conference
- **Published**: 15-17 Nov.
- **Authors**: Li Qiao, He Jing, Xu Xin Yu
- **PDF**: https://ieeexplore.ieee.org/document/6835475
- **Abstract**: In this paper, coding principles based on LU decomposition for LDPC in CMMB (China Mobile Multimedia Broadcasting ) are introduced, and the implementation method of the encoder is detailed. The pipeline technology is adopted in the implementation process to improve data throughput. Coding method and implementation introduced in this paper are easy and feasible.
...
- **Status**: ❌
- **Reason**: 비이진 NB-LDPC 디코더(generalized bit-flipping). 비이진 LDPC는 제외 대상
- **ID**: ieee:6704549
- **Type**: conference
- **Published**: 12-15 Nov.
- **Authors**: F. García-Herrero, M. J. Canet, J. Valls
- **PDF**: https://ieeexplore.ieee.org/document/6704549
- **Abstract**: This paper presents a high-speed VLSI decoder for wireless applications, based on the generalized bit-flipping algorithm, suitable for decoding high-rate non-binary low-density parity-check codes. A technique to limit the data growth in the generalized bit-flipping decoding algorithm without penalizing the throughput is proposed. In addition, a broadcasting technique to reduce the routing congestion was applied to the derived message-passing architecture increasing the throughput of the decoder. Using a 90nm CMOS process, for the (837,723) non-binary code, the decoder requires an area of 13.4 mm2, achieving 573 Mbps at 20 iterations.

## Performance of polar code for image transmission

- **Status**: ❌
- **Reason**: polar code 이미지전송 성능평가, LDPC는 비교 베이스라인. 떼어낼 바이너리 LDPC BP 기법 없음 — 제외
- **ID**: ieee:6704592
- **Type**: conference
- **Published**: 12-15 Nov.
- **Authors**: Tanaporn Payommai, Kosin Chamnongthai
- **PDF**: https://ieeexplore.ieee.org/document/6704592
- **Abstract**: We discuss the performance of polar code, the capacity-achieving channel code, on wireless communication channel in the paper. This code is used as forward error correction (FEC) technique to protect transmitted source data over channel. The aim of this paper is to reduce the error floor and the bit rate error of image transmission. We analyze the polar code with the define parameters via Additive White Gaussian Noise (AWGN) channel. The construction of polar code is designed with various at difference code length, same rate by comparing with low density parity check (LDPC) code as same cause. Polar code will be good candidate for image transmissions. The performance of polar code is evaluated by bit error rate (BER) that can improve more than 10% and peak signal-to-noise ratio (PSNR) more than 30 at SNR equals 8 dB.

## Complexity reduction in joint decoding of block coded signals in overloaded MIMO-OFDM system

- **Status**: ❌
- **Reason**: overloaded MIMO-OFDM 블록부호 joint decoding 복잡도 감소, LDPC 무관 무선응용 특이적 — 제외
- **ID**: ieee:6704619
- **Type**: conference
- **Published**: 12-15 Nov.
- **Authors**: Yoshihito Doi, Mamiko Inamori, Yukitoshi Sanada
- **PDF**: https://ieeexplore.ieee.org/document/6704619
...
- **Status**: ❌
- **Reason**: non-binary LDPC 디코딩 알고리즘 - 비이진 LDPC는 기준상 명시적 제외
- **ID**: ieee:6710288
- **Type**: conference
- **Published**: 1-3 Nov. 2
- **Authors**: Nanfan Qiu, Wen Chen, Yang Yu +1
- **PDF**: https://ieeexplore.ieee.org/document/6710288

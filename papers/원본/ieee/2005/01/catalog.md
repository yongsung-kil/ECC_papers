...
- **Status**: ❌
- **Reason**: ISI 채널 turbo equalization용 LDPC 임계값 분석·설계, 무선 채널 equalizer 특이적으로 NAND 이식 기법 약함
- **ID**: ieee:1381445
- **Type**: journal
- **Published**: Jan. 2005
...
- **Status**: ❌
- **Reason**: LDPC-coded modulation의 비트 신뢰도 매핑 전략, 변조-부호 매핑 응용으로 NAND LDPC 디코더/구성에 이식할 기법 없음
- **ID**: ieee:1375222
- **Type**: journal
- **Published**: Jan. 2005
...
- **Status**: ❌
- **Reason**: Slepian-Wolf 분산 소스코딩, 채널 ECC가 아닌 소스코딩 응용
- **ID**: ieee:1375242
- **Type**: journal
- **Published**: Jan. 2005
...
- **Status**: ❌
- **Reason**: 분산 비디오 코딩(Wyner-Ziv) 서베이, 소스코딩/JSCC 응용으로 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:1369699
- **Type**: journal
- **Published**: Jan. 2005
...
- **Status**: ❌
- **Reason**: turbo 디코딩의 확률적 해석 모델, 부호 비의존 LDPC BP 이식 기법 아닌 turbo 전용 동역학 분석
- **ID**: ieee:1377494
- **Type**: journal
- **Published**: Jan. 2005
- **Authors**: M. Fu
...
- **Status**: ❌
- **Reason**: 선형 동적시스템 fault tolerance 코딩, 채널 LDPC ECC 디코더/구성 기법 아님
- **ID**: ieee:1377502
- **Type**: journal
- **Published**: Jan. 2005
...
- **Status**: ❌
- **Reason**: serial concatenated TCM(비-LDPC, 변조/누산부호) ML 분석, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:1391191
- **Type**: journal
- **Published**: Jan. 2005
...
- **Status**: ❌
- **Reason**: 이미지전송 fading 채널 irregular LDPC BICM 응용, 표준 irregular vs regular 비교만, 신규 기법 없음
- **ID**: ieee:1405204
- **Type**: conference
- **Published**: 6-6 Jan. 2
...
- **Status**: ❌
- **Reason**: parity check/Hamming 코드 비교 - 비-LDPC 부호, 교과서 수준, 떼어낼 LDPC 기법 없음
- **ID**: ieee:1408414
- **Type**: conference
- **Published**: 24-27 Jan.
...
- **Status**: ❌
- **Reason**: RAID 스토리지용 array code와 Hamming code 비교, LDPC 아니며 떼어낼 디코더/구성 기법 없음
- **ID**: ieee:1577866
- **Type**: conference
- **Published**: 2005
- **Authors**: E. L. Valles, A. I. V. Casado, M. Blaum +2
- **PDF**: https://ieeexplore.ieee.org/document/1577866
...
- **Status**: ❌
- **Reason**: MC-CDMA product code 성능분석 — 초록 없음, 무선 응용 특이적이며 LDPC 이식 기법 없음
- **ID**: ieee:1580274
- **Type**: conference
- **Published**: 2005
- **Authors**: T. Baba, S. Wada
- **PDF**: https://ieeexplore.ieee.org/document/1580274
- **Abstract**: N/A
...
- **Status**: ❌
- **Reason**: CPM 외부부호용 LDGM 최적화로 통신 응용 특이적, 떼어낼 LDPC ECC 기법 없음 → 제외
- **ID**: ieee:1531899
- **Type**: conference
- **Published**: 2005
- **Authors**: M. Xiao, T. M. Aulin
- **PDF**: https://ieeexplore.ieee.org/document/1531899
...
- **Status**: ❌
- **Reason**: STBC-OFDM에 turbo product code 결합, 비-LDPC이며 이식 가능한 BP 기법 없음
- **ID**: ieee:1567040
- **Type**: conference
- **Published**: 2005
- **Authors**: Yejun He, Guangxi Zhu, Feng Wang
- **PDF**: https://ieeexplore.ieee.org/document/1567040
- **Abstract**: Space-time block codes (STBCs) are designed to obtain the full diversity gain. However, STBCs are not designed to achieve an additional coding gain. Therefore, STBCs need to be concatenated with an outer code which provides a significant coding gain. Turbo product codes (TPCs) are a kind of high-efficient coding scheme with low latency decoding, which do not suffer from an error floor associated with turbo codes. This article considers the concatenation of TPCs with STBCs and sets up coded OFDM system to improve the reliability of the wireless communication systems. Finally, the paper presents simulating environment and results of experiment testing.

## The performance of STBC coded MIMO-OFDM system based on turbo product codes

- **Status**: ❌
- **Reason**: STBC MIMO-OFDM with turbo product codes(비-LDPC), 무선 응용 특이적 → 제외
- **ID**: ieee:1544128
- **Type**: conference
- **Published**: 2005
- **Authors**: Yejun He, Guangxi Zhu, Bijun Zhang +2
- **PDF**: https://ieeexplore.ieee.org/document/1544128
- **Abstract**: Space-time block codes (STBCs) are designed to obtain the full diversity gain. However, STBCs are not designed to achieve an additional coding gain. Therefore, STBCs need to be concatenated with an outer code which provides a significant coding gain. Turbo product codes (TPCs) are a kind of high-efficient coding scheme with low latency decoding, which do not suffer from an error floor associated with turbo codes. This article considers the concatenation of TPCs with STBCs and sets up coded MIMO-OFDM system to improve the reliability of the wireless communication systems. Finally, the paper presents simulating environment of experiment testing.

## Space-time multilevel codes

- **Status**: ❌
- **Reason**: 공간시간 멀티레벨 코드(비-LDPC), MIMO 전용 다단 디코더 → 제외
- **ID**: ieee:1543498
- **Type**: conference
- **Published**: 2005
- **Authors**: P. A. Martin, D. M. Rankin, D. P. Taylor
- **PDF**: https://ieeexplore.ieee.org/document/1543498
- **Abstract**: To date there has been little work done on multilevel codes for the space-time environment. In this paper we develop multi-dimensional space-time multilevel codes (ST-MLCs), which partition the 2N/sub t/-dimensional signalling space that spans all N/sub t/ transmit antennas. The partitioning is designed to reduce the complexity of detection/decoding. We also develop a space-time multistage decoder for the proposed ST-MLC. It allows the detection/decoding complexity to be significantly reduced compared to a single level approach.

## Ensembles of codes over abelian groups

- **Status**: ❌
- **Reason**: Abelian group(Z_m) 코드로 비이진 LDPC 영역 → 제외
- **ID**: ieee:1523653
- **Type**: conference
- **Published**: 2005
- **Authors**: G. Como, F. Fagnani
- **PDF**: https://ieeexplore.ieee.org/document/1523653
- **Abstract**: In this paper we study ensembles of Abelian group codes on symmetric channels. Our main example is the AWGN channel where the inputs are restricted to a GU constellation admitting Zopfm as a generating group. For codes which are Zopfm-free modules, we prove a sort of Shannon theorem which exactly characterizes which are the rates for which reliable transmission is possible. In particular we prove that for the 2r-PSK constellation, group codes over Zopf- do achieve Shannon capacity. Finally, we study the performance of low density Zopf codes and we prove average convergence rate of their word error probability

## Space-time Reed-Muller codes for noncoherent MIMO transmission

- **Status**: ❌
- **Reason**: 공간시간 Reed-Muller(비-LDPC), MIMO 전용 RM 디코더, 양자 stabilizer 의존 → 제외
- **ID**: ieee:1523686
- **Type**: conference
- **Published**: 2005
- **Authors**: A. Ashikhmin, A. R. Calderbank
- **PDF**: https://ieeexplore.ieee.org/document/1523686
...
- **Status**: ❌
- **Reason**: 반복 수신기용 인코딩 파일럿, LDPC 부호설계/디코더 기여 없음, abstract 없음
- **ID**: ieee:1558440
- **Type**: conference
- **Published**: 2005
- **Authors**: H. M. Kwon, K. Hassan, A. Goyal +3
- **PDF**: https://ieeexplore.ieee.org/document/1558440
- **Abstract**: N/A

## Using flexible turbo-like codes for simplified water-filling

- **Status**: ❌
- **Reason**: turbo-like 부호 기반 water-filling 용량 접근 - 비-LDPC, 부호 비의존 이식 디코더 기법 없음
- **ID**: ieee:1506306
- **Type**: conference
- **Published**: 2005
- **Authors**: K. M. Chugg, P. Gray
- **PDF**: https://ieeexplore.ieee.org/document/1506306
- **Abstract**: A method for approaching the water-filling (WF) capacity of parallel Gaussian channels is presented. This method relies on the existence of modern turbo-like codes (TLCs) with a high degree of rate flexibility. The algorithm is a constant power WF algorithm with the active sub-channels and associated modulations selected based on the performance limits of the available TLC and modulation formats. A single TLC block is used over all sub-channels with rate imposed by the modulation assignments and the total capacity limits of the channel. Simulation results demonstrate that this approach can yield performance within approximately 3-5 dB of the ideal WF capacity for Rayleigh channel gains.

## A suboptimal receiver with turbo block coding for ultra-wideband communications

- **Status**: ❌
- **Reason**: UWB용 turbo product code(Hamming 기반)+적응 등화, 비-LDPC이며 이식할 LDPC BP 기법 없음
- **ID**: ieee:1549479
- **Type**: conference
- **Published**: 2005
- **Authors**: R. H. Morelos-Zaragoza, T. Becker, S. Aquino
- **PDF**: https://ieeexplore.ieee.org/document/1549479
...
- **Status**: ❌
- **Reason**: turbo 소스 인코더(무손실 소스코딩), 채널 ECC 아님이며 abstract 없음
- **ID**: ieee:1557967
- **Type**: conference
- **Published**: 2005
- **Authors**: J. Haghighat, M. R. Soleymani, W. Hamouda
- **PDF**: https://ieeexplore.ieee.org/document/1557967
- **Abstract**: N/A
...
- **Status**: ❌
- **Reason**: 심우주 DTN 상위계층 오류제어 적용 논문, LDPC 디코더/HW/코드설계 기여 없음
- **ID**: ieee:1547817
- **Type**: conference
- **Published**: 2005
- **Authors**: T. de Cola, H. Ernst, M. Marchese
- **PDF**: https://ieeexplore.ieee.org/document/1547817
- **Abstract**: Nowadays, the realization and the deployment of network infrastructures able to guarantee connectivity to geographical areas characterized by hazardous access conditions, such as remote sensor networks, disaster areas and interplanetary networks, are assuming great importance. Under this view, the large access latencies along with the high percentage of lost packets makes the applicability of TCP/IP protocol suite almost unfeasible. A promising solution counteracting TCP/IP shortcomings is represented by the delay tolerant network (DTN) architecture, which exploits the principle of the mail delivery service to guarantee the success of the information transfer. This paper applies the DTN concepts to data communications achieved in deep space environments and investigates the adoption of error control schemes implemented at the higher layers, in order to make the transmission more reliable without the need of a feedback link for the acknowledgment transportation

## On phase correct blind deconvolution of flat MIMO channels exploiting channel encoding

- **Status**: ❌
- **Reason**: MIMO 채널 블라인드 디컨볼루션 - 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:1415892
- **Type**: conference
- **Published**: 2005
- **Authors**: A. Scherb, V. Kuhn, K. D. Kammeyer
- **PDF**: https://ieeexplore.ieee.org/document/1415892
...
- **Status**: ❌
- **Reason**: sphere decoding/MCMC MIMO 검출 - LDPC 디코더 아님, ECC 무관
- **ID**: ieee:1505877
- **Type**: conference
- **Published**: 2005
- **Authors**: H. Zhu, B. Farhang-Boroujeny, R. . -R. Chen
- **PDF**: https://ieeexplore.ieee.org/document/1505877
...
- **Status**: ❌
- **Reason**: multiband OFDM에 turbo/RA 부호+비트로딩 적용, 무선 응용 특이적이며 LDPC 기여 없음
- **ID**: ieee:1569955
- **Type**: conference
- **Published**: 2005
- **Authors**: C. Snow, L. Lampe, R. Schober
- **PDF**: https://ieeexplore.ieee.org/document/1569955
...
- **Status**: ❌
- **Reason**: NoC 핫스팟 열관리 런타임 재구성, LDPC/ECC와 무관
- **ID**: ieee:1395643
- **Type**: conference
- **Published**: 2005
- **Authors**: G. M. Link, N. Vijaykrishnan
- **PDF**: https://ieeexplore.ieee.org/document/1395643
...
- **Status**: ❌
- **Reason**: Tomlinson-Harashima precoder 파이프라이닝 - LDPC ECC 무관, 떼어낼 디코더/코드설계 기법 없음
- **ID**: ieee:1464611
- **Type**: conference
- **Published**: 2005
- **Authors**: Yongru Gu, K. K. Parhi
- **PDF**: https://ieeexplore.ieee.org/document/1464611
...
- **Status**: ❌
- **Reason**: 무선 릴레이 전송전략(DAF) - LDPC 부호/디코더/HW 기여 없음, 떼어낼 ECC 기법 없음
- **ID**: ieee:1506253
- **Type**: conference
- **Published**: 2005
- **Authors**: X. Bao, J. Li
- **PDF**: https://ieeexplore.ieee.org/document/1506253
- **Abstract**: A new class of forwarding strategy, termed decode-amplify-forward (DAF), is proposed for relay channels. By exploiting the coding gain on the inter-user channel and maximizing the data fidelity using soft reliability representation, the proposed DAF strategy has cleverly combined the merits of both decode-forward (DF) and amplify-forward (AF). To fully harness the power promised by the DF-extended schemes such as coded cooperation, we further propose a DAF-DF mixed strategy that blends DAF and DF via time sharing. The considerable gains enabled by the proposed DAF and especially the DAF-DF strategies are demonstrated using mutual information and capacity analysis as well as extensive simulations on fast and slow fading channels.

## Complex Linear STBCs with Multiple Rates

- **Status**: ❌
- **Reason**: 복소 선형 STBC 용량/rate 이론, LDPC·디코더 기법 없음 → 제외
- **ID**: ieee:1547734
- **Type**: conference
- **Published**: 2005
- **Authors**: Pansop Kim, K. M. Chugg
- **PDF**: https://ieeexplore.ieee.org/document/1547734
- **Abstract**: Complex linear space-time block codes (STBCs) with multiple rates are investigated. First, the conditions for capacity-lossless STBC existence are derived and we prove that capacity-lossless complex linear STBCs exist if and only if there is one receive antenna. It is also proved that rate-one capacity-lossless complex linear STBCs exist if and only if there are two transmit antennas. We show that even though the Alamouti code and layered-Alamouti code are capacity-lossless for one receive antenna, better STBCs can still be found for two receive antennas by introducing the circular layered-Alamouti code. By analyzing the outage capacity, we also show that additional transmit antennas beyond the number of receive antennas can dramatically improve the performance. This analysis is supported by simulations.

## Fast correlation attacks against stream ciphers and related open problems

- **Status**: ❌
- **Reason**: 스트림암호 고속상관공격 — 보안/암호해독, 선형코드 디코딩이나 ECC 설계 기여 없음
- **ID**: ieee:4638690
- **Type**: conference
- **Published**: 2005
- **Authors**: A. Canteaut
- **PDF**: https://ieeexplore.ieee.org/document/4638690
...
- **Status**: ❌
- **Reason**: Rayleigh 페이딩 채널 큐 기반 모델링, 부호화/디코더 기법 무관, abstract 없음
- **ID**: ieee:1558149
- **Type**: conference
- **Published**: 2005
- **Authors**: Libo Zhong, F. Alajaji, G. Takahara
- **PDF**: https://ieeexplore.ieee.org/document/1558149
- **Abstract**: N/A

## Integrated tracking and focusing systems in a monolithic device for MEMS optical pick-up head

- **Status**: ❌
- **Reason**: MEMS 광 픽업헤드, ECC와 무관 → 제외
- **ID**: ieee:1540062
- **Type**: conference
- **Published**: 2005
- **Authors**: Mingching Wu, Chih-Yu Peng, Sheng-Yi Hsiao +2
- **PDF**: https://ieeexplore.ieee.org/document/1540062
...
- **Status**: ❌
- **Reason**: HDD read-channel equalizer의 CMOS 아날로그 프론트엔드 - ECC/LDPC 무관 회로 설계
- **ID**: ieee:1465054
- **Type**: conference
- **Published**: 2005
- **Authors**: T. Ndjountche, Fa-Long Luo, C. Bobda
- **PDF**: https://ieeexplore.ieee.org/document/1465054
...
- **Status**: ❌
- **Reason**: CDMA 잡음분산 추정 - LDPC ECC 무관, 응용 특이적
- **ID**: ieee:1493386
- **Type**: conference
- **Published**: 2005
- **Authors**: Jingxian Wu, Chengshan Xiao, K. B. Letaief
- **PDF**: https://ieeexplore.ieee.org/document/1493386
- **Abstract**: In this paper, a novel additive noise variance estimation algorithm is proposed for multiuser CDMA systems experiencing time varying and frequency selective fading. The algorithm is developed by exploring the eigenstructure of the receive signal correlation matrix, which is characterized by the statistical properties of both the fading channel and the additive white Gaussian noise. Relying only on the knowledge of the receiver signal samples, the algorithm can accurately estimate the variance of the additive noise present at the receiver of multiuser CDMA systems. The estimated noise variance can be employed along with other receiver algorithms to improve system performance.

## Blind symbol detection for multiple-input multiple-output systems via particle filtering

- **Status**: ❌
- **Reason**: MIMO 블라인드 심볼 검출(particle filter) - LDPC ECC 기법 없음
- **ID**: ieee:1415891
- **Type**: conference
- **Published**: 2005
- **Authors**: Ke Deng, Qinye Yin, Yinkuo Meng
- **PDF**: https://ieeexplore.ieee.org/document/1415891
- **Abstract**: A novel blind symbol detection algorithm is proposed for time-selective fading multiple-input-multiple-output (MIMO) systems, whose every channel is described as a second-order autoregressive (AR) model. This algorithm employs the particle filter as the demodulator stage in turbo receivers because the particle filter has the natural characteristics of soft-input soft-output. Moreover, the particle filter has the advantage of parallel computation. Computer simulation results demonstrate the performance of the proposed algorithm.
...
- **Status**: ❌
- **Reason**: OFDM 위상잡음 제거 추론 - LDPC ECC 기법 없음
- **ID**: ieee:1424471
- **Type**: conference
- **Published**: 2005
- **Authors**: Darryl Dexu Lin, Yi Zhao, Teng Joon Lim
- **PDF**: https://ieeexplore.ieee.org/document/1424471
- **Abstract**: We propose a systematic probabilistic framework to address the phase noise (PHN) problem in OFDM. In addition to deriving the optimal data detection scheme in the presence of PHN, we introduce a series of suboptimal approaches to blindly cancel the effect of PHN without the aid of pilot symbols. Not only do these algorithms provide the means to efficiently eliminate the effect of PHN in OFDM, they also open the door to much wider applications of advanced probabilistic inference algorithms in solving communications problems.
...
- **Status**: ❌
- **Reason**: IEEE 802.16e 시스템 성능 시뮬레이션 — 무선 시스템 평가, ECC 무관
- **ID**: ieee:1651572
- **Type**: conference
- **Published**: 2005
- **Authors**: F. Wang, A. Ghosh, R. Love +5
- **PDF**: https://ieeexplore.ieee.org/document/1651572
...
- **Status**: ❌
- **Reason**: 순차디코딩 버퍼오버플로 확률 bound(컨볼루션부호), 순수 이론이며 LDPC 디코더/HW로 안 이어짐
- **ID**: ieee:1397935
- **Type**: journal
- **Published**: 2005
- **Authors**: T. Hashimoto
- **PDF**: https://ieeexplore.ieee.org/document/1397935

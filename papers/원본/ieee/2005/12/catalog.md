...
- **Status**: ✅
- **Reason**: LCS 기반 LDPC 구성, girth-4 회피 조건 일반화(불규칙·임의차수) - 바이너리 코드설계 기법(E)
- **ID**: ieee:1556819
- **Type**: journal
- **Published**: Dec. 2005
- **Authors**: Jing Sun, O.Y. Takeshita
- **PDF**: https://ieeexplore.ieee.org/document/1556819
...
- **Status**: ❌
- **Reason**: good linear binary code의 weight spectrum 순수 이론 bound - 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:1542430
- **Type**: journal
- **Published**: Dec. 2005
- **Authors**: Ruoheng Liu, P. Spasojevic, E. Soljanin
- **PDF**: https://ieeexplore.ieee.org/document/1542430
...
- **Status**: ✅
- **Reason**: 비대칭 메모리리스 채널용 일반화 density evolution - NAND는 비대칭 채널이라 코드설계/DE 분석에 직접 유용(E)
- **ID**: ieee:1542413
- **Type**: journal
- **Published**: Dec. 2005
- **Authors**: Chih-Chun Wang, S.R. Kulkarni, H.V. Poor
- **PDF**: https://ieeexplore.ieee.org/document/1542413
...
- **Status**: ✅
- **Reason**: PEG 기반 LDPC-CC 구성으로 large girth - SC-LDPC 코드설계 기법(E)
- **ID**: ieee:1576587
- **Type**: journal
- **Published**: Dec. 2005
- **Authors**: Zhengang Chen, S. Bates
- **PDF**: https://ieeexplore.ieee.org/document/1576587
...
- **Status**: ✅
- **Reason**: adaptive BP + reliability-based 디코딩 결합, 부호 비의존적 디코더 기법(C) - 바이너리 LDPC BP에 이식 가능
- **ID**: ieee:1576590
- **Type**: journal
- **Published**: Dec. 2005
- **Authors**: A. Kothiyal, O.Y. Takeshita, W. Jin +1
- **PDF**: https://ieeexplore.ieee.org/document/1576590
...
- **Status**: ✅
- **Reason**: protograph 기반 LDPC 구성, 선형 최소거리+낮은 error floor+고속 디코더 지원 - 바이너리 LDPC 코드설계(E) 이식 가능
- **ID**: ieee:1577834
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: D. Divsalar, C. Jones, S. Dolinar +1
- **PDF**: https://ieeexplore.ieee.org/document/1577834
...
- **Status**: ❌
- **Reason**: MPSK 변조용 u/u+v LDPC 멀티레벨 코드 - 변조결합 응용이고 표준 u/u+v 구성, NAND에 새로 이식할 신규 코드설계 기여 불명확
- **ID**: ieee:1577654
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Jia Hou, Moon Ho Lee
- **PDF**: https://ieeexplore.ieee.org/document/1577654
- **Abstract**: The multilevel code (MLC) has attracted considerable attention as a means to achieve bandwidth and power efficiency. Additionally, the LDPC codes by the u/u+v construction have flexible rate or length. By combing with them, we investigate an efficient way for variable rates data transmission in this paper. The study can enrich the family of LDPC codes and their applications.

## Low-density parity-check convolutional codes applied to packet based communication systems

- **Status**: ✅
- **Reason**: LDPC 컨볼루셔널 부호(LDPC-CC)의 인코더/디코더 설계 및 종료 알고리즘, SC-LDPC 코드설계 기법으로 이식 가능(E)
- **ID**: ieee:1577852
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Zhengang Chen, S. Bates, Xiaodai Dong
- **PDF**: https://ieeexplore.ieee.org/document/1577852
...
- **Status**: ❌
- **Reason**: BEC(이진소거채널) 전용 디코딩 알고리즘으로 NAND 채널(BSC/AWGN)과 무관, 소거채널 그래프 조작 기법은 이식 불가
- **ID**: ieee:1577840
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: B.N. Vellambi, F. Fekri
- **PDF**: https://ieeexplore.ieee.org/document/1577840
...
- **Status**: ✅
- **Reason**: Rate-compatible punctured LDPC mother code 설계·puncturing 기법 — 이식 가능 바이너리 LDPC 코드설계(E)
- **ID**: ieee:1578492
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: D. Klinc, Jeongseok Ha, Jaehong Kim +1
- **PDF**: https://ieeexplore.ieee.org/document/1578492
...
- **Status**: ✅
- **Reason**: QC-LDPC overlapped message passing 부분병렬 HW 스케줄링 최적화(throughput/HUE) — 이식 가능 HW 아키텍처(D)
- **ID**: ieee:1578092
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Yongmei Dai, Zhiyuan Yan
- **PDF**: https://ieeexplore.ieee.org/document/1578092
...
- **Status**: ✅
- **Reason**: 멀티레이트 LDPC 디코더 VLSI/FPGA 구현 + 사이클 제거로 error floor 억제, NAND ECC HW 아키텍처+코드설계에 이식 가능(D/E)
- **ID**: ieee:1577854
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Lei Yang, Hui Liu, C.-J.R. Shi
- **PDF**: https://ieeexplore.ieee.org/document/1577854
...
- **Status**: ✅
- **Reason**: min-sum 2차원 정규화로 BP급 성능+낮은 error floor 달성, NAND LDPC 디코더에 이식 가능한 디코더 알고리즘(C)
- **ID**: ieee:1577841
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Juntan Zhang, M. Fossorier, Daqing Gu +1
- **PDF**: https://ieeexplore.ieee.org/document/1577841
...
- **Status**: ❌
- **Reason**: RA 부호 점근 가중치분포/ML bound - 비-LDPC(RA) 부호의 순수 이론 분석, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:1577833
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Chun-Hao Hsu, A. Anastasopoulos
- **PDF**: https://ieeexplore.ieee.org/document/1577833
...
- **Status**: ❌
- **Reason**: RS/BCH를 구성노드로 쓰는 일반화 LDPC(GLDPC), BEC 성능 열세이며 비-LDPC 컴포넌트 부호 기반으로 바이너리 단순 LDPC ECC와 무관
- **ID**: ieee:1577850
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: N. Miladinovic, M. Fossorier
- **PDF**: https://ieeexplore.ieee.org/document/1577850
...
- **Status**: ✅
- **Reason**: LDPC-coded MIMO 반복수신기 + LDPC degree profile 최적화 알고리즘(전역최적·수렴보장) — 이식 가능 코드설계/EXIT 기법(E/C)
- **ID**: ieee:1578297
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Jun Zheng, B.D. Rao
- **PDF**: https://ieeexplore.ieee.org/document/1578297
...
- **Status**: ❌
- **Reason**: Rateless LT/Raptor UEP codes over BEC (fountain/erasure), non-LDPC ECC 베이스라인; 떼어낼 BP/HW 기법 없음
- **ID**: ieee:1577872
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: N. Rahnavard, F. Fekri
- **PDF**: https://ieeexplore.ieee.org/document/1577872
...
- **Status**: ❌
- **Reason**: 블록페이딩 비동기 검출 MCMC; LDPC 무관 통신 검출 응용
- **ID**: ieee:1578215
- **Type**: conference
- **Published**: 28 Nov.-2 
- **Authors**: Rong-Rong Chen, Ronghui Peng
- **PDF**: https://ieeexplore.ieee.org/document/1578215
...
## LDPC codes performance based on OFDM wireless communication system

- **Status**: ❌
- **Reason**: LDPC-OFDM 무선 BER 평가, 떼어낼 새 디코더/HW/구성 없음
- **ID**: ieee:1595409
- **Type**: conference
- **Published**: 13-16 Dec.
- **Authors**: Y. Kami, C. Han, Y. Miyanaga
- **PDF**: https://ieeexplore.ieee.org/document/1595409
- **Abstract**: In this paper, we present LDPC-coded OFDM system for wireless communication. LDPC code has superior performance in error correcting and can be adopted in various communication systems. We evaluate BER performance for wireless communication system based on IEEE802.11a standard. We demonstrate that LDPC coded system has better performance with smaller number of iterations than conventional Viterbi decoding. Furthermore it shows better performance by using large number of data symbols per packet. We present LDPC coded scheme, which is suitable for packet OFDM system, and show simulation results in multipath fading environment.

## Rate-compatible punctured low-density parity-check codes with bit-interleaved coded modulation

- **Status**: ✅
- **Reason**: rate-compatible punctured LDPC 차수분포+패리티 펑처링 구성(E), NAND 가변레이트에 이식 가능
- **ID**: ieee:1595436
- **Type**: conference
- **Published**: 13-16 Dec.
- **Authors**: Jingbo Gao, Manli Zhou
- **PDF**: https://ieeexplore.ieee.org/document/1595436
- **Abstract**: We design bit-interleaved coded modulation (BICM) schemes based on low-density parity-check (LDPC) codes. On time-varying channels, it is necessary to adapt the code rate according to channel conditions. Rate-compatible punctured-code (RCPC) is such an efficient and flexible scheme that it uses a single code which can be punctured in rate compatible fashion across a range of code rate. Therefore, when the capacity rule is used to determine the rate of component LDPC codes, we construct rate-compatible component LDPC codes by carefully selecting degree distributions, followed by optimal parity puncturing. Simulation results show that our system performs within 1 dB above the capacity at bit error rate 10/sup -6/ across a range of rates.

## Reconfigurable acceleration for Monte Carlo based financial simulation

- **Status**: ❌
- **Reason**: 금융 Monte Carlo FPGA 가속기, LDPC와 무관
- **ID**: ieee:1568549
- **Type**: conference
- **Published**: 11-14 Dec.
- **Authors**: G.L. Zhang, P.H.W. Leong, C.H. Ho +5
- **PDF**: https://ieeexplore.ieee.org/document/1568549

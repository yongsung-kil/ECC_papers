...
- **Status**: ❌
- **Reason**: Turbo/LDPC/Polar 디코더 ASIC 서베이 — 5G/셀룰러 도메인, 신규 디코더·구성·HW 기여 없는 리뷰
- **ID**: ieee:8616900
- **Type**: journal
- **Published**: thirdquart
- **Authors**: Shuai Shao, Peter Hailes, Tsang-Yi Wang +4
- **PDF**: https://ieeexplore.ieee.org/document/8616900
...
- **Status**: ❌
- **Reason**: 물리계층 보안 서베이 — 보안 도메인, 신규 LDPC 디코더·구성 기여 없음
- **ID**: ieee:8509094
- **Type**: journal
- **Published**: Secondquar
- **Authors**: Jehad M. Hamamreh, Haji M. Furqan, Huseyin Arslan
- **PDF**: https://ieeexplore.ieee.org/document/8509094
...
- **Status**: ❌
- **Reason**: 유한알파벳 물리계층 보안 리뷰 — 보안 도메인, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:8527545
- **Type**: journal
- **Published**: Secondquar
- **Authors**: Sina Rezaei Aghdam, Alireza Nooraiepour, Tolga M. Duman
- **PDF**: https://ieeexplore.ieee.org/document/8527545
...
- **Status**: ❌
- **Reason**: 프린트-캡처 채널 모델링/추정 논문, LDPC는 표준 소프트디코딩 적용 예시일 뿐 신규 ECC 기법 없음
- **ID**: ieee:8453836
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Lin Zhang, Changsheng Chen, Wai Ho Mow
- **PDF**: https://ieeexplore.ieee.org/document/8453836
- **Abstract**: With the rapid advancement of sensing capability and computational power in consumer electronic devices, the use of mobile cameras for communications has attracted significant attention from both academia and industry. The design of a reliable communication system over the print-capture channel is a key challenge in some important applications, such as barcoding and document authentication. However, the real-world print-capture channel is spatially non-linear and non-stationary and lacks a standard parametric model. As a consequence, advanced channel coding techniques developed for common channel models are not applicable in the existing systems without costly and device-dependent pre-training. In this paper, an accurate parametric print-capture channel model and an efficient channel estimation scheme requiring low training overhead are proposed. With the estimated parameters, the proposed print-capture channel model can be linearized to the (possibly input-dependent) additive white Gaussian noise channel model. This allows the use of the state-of-the-art channel coding schemes, such as low-density parity-check (LDPC) codes with iterative soft decoding, to improve the reliability of the communication system under challenging conditions, e.g., at a low signal-to-noise ratio. As an example application of the proposed print-capture channel model, a demonstrative multilevel 2D barcode using an LDPC code with iterative soft decoding is designed to enhance the reliability over the conventional QR code, which is based on the Reed–Solomon code with hard decoding. At a printing resolution of 600 dpi, the 8-level 2D barcode achieves data capacity gains of about 10% and 56% over the QR code in the in-focus and blur-limited scenarios, respectively. It is noteworthy that the enhanced data capacity of the multilevel barcode is made possible by the proposed channel estimation scheme, which incurs an additional training overhead of about 3.3% only.

## Displacement Convexity in Spatially Coupled Scalar Recursions

- **Status**: ❌
- **Reason**: 공간결합 스칼라 점화식 displacement convexity 순수 이론 분석, 신규 디코더·구성·HW 기여 없음
- **ID**: ieee:8432398
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Rafah El-Khatib, Nicolas Macris, Tom Richardson +1
- **PDF**: https://ieeexplore.ieee.org/document/8432398
...
- **Status**: ❌
- **Reason**: 유한블록길이 fast HARQ 프로토콜 지연/throughput 분석, LDPC 디코더/코드 기법 없음
- **ID**: ieee:8525430
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Behrooz Makki, Tommy Svensson, Giuseppe Caire +1
- **PDF**: https://ieeexplore.ieee.org/document/8525430
...
- **Status**: ❌
- **Reason**: 디스플레이-카메라 통신 청색채널 임베딩, LDPC는 표준 채널코딩으로 부수 사용, 떼어낼 ECC 기법 없음
- **ID**: ieee:8438485
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Changsheng Chen, Wenjian Huang, Lin Zhang +1
- **PDF**: https://ieeexplore.ieee.org/document/8438485
...
- **Status**: ❌
- **Reason**: 순환시프트 선형 네트워크 코딩(GF(2)), LDPC ECC와 무관, 떼어낼 디코더·구성 기법 없음
- **ID**: ieee:8353910
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Hanqi Tang, Qifu Tyler Sun, Zongpeng Li +2
- **PDF**: https://ieeexplore.ieee.org/document/8353910
...
- **Status**: ❌
- **Reason**: 나노스케일 비-von Neumann 통계 컴퓨팅 프레임워크, LDPC 디코더/HW/코드 기법 없음
- **ID**: ieee:8482253
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Naresh R. Shanbhag, Naveen Verma, Yongjune Kim +2
- **PDF**: https://ieeexplore.ieee.org/document/8482253
...
- **Status**: ❌
- **Reason**: BMST-BCH 부호 + sliding-window 디코더, 비-LDPC(BCH) 부호 전용 디코더로 바이너리 LDPC BP에 이식할 부호 비의존 기법 없음
- **ID**: ieee:8463624
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Suihua Cai, Nina Lin, Xiao Ma
- **PDF**: https://ieeexplore.ieee.org/document/8463624
...
- **Status**: ❌
- **Reason**: 클라우드 디코딩 straggler 완화용 frame 단위 선형부호화 시스템, 바이너리 LDPC ECC 부호·디코더 기법 아님
- **ID**: ieee:8463544
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Malihe Aliasgari, Jörg Kliewer, Osvaldo Simeone
- **PDF**: https://ieeexplore.ieee.org/document/8463544
...
- **Status**: ❌
- **Reason**: 버스트 잡음-소거 채널 용량/피드백 순수 이론, 디코더·HW·구성으로 안 이어짐
- **ID**: ieee:8424211
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Lin Song, Fady Alajaji, Tamás Linder
- **PDF**: https://ieeexplore.ieee.org/document/8424211
...
- **Status**: ❌
- **Reason**: Reed-Muller 네트워크 협력 부호 + joint decoding, 비-LDPC 부호 전용 기법
- **ID**: ieee:8519796
- **Type**: journal
- **Published**: Jan. 2019
- **Authors**: Shoaib Mughal, Fengfan Yang, Rahim Umar
- **PDF**: https://ieeexplore.ieee.org/document/8519796
...
- **Status**: ❌
- **Reason**: 수중음향 OFDM의 임펄스 잡음 완화 아날로그 전처리기, LDPC ECC 기법 무관
- **ID**: ieee:8666616
- **Type**: conference
- **Published**: 7-9 Jan. 2
- **Authors**: Reza Barazideh, Wensheng Sun, Balasubramaniam Natarajan +2
- **PDF**: https://ieeexplore.ieee.org/document/8666616
...
- **Status**: ❌
- **Reason**: Polar 디코더 VLSI로 polar 부호 특화 PE/LLR 표현, 비-LDPC이며 BP가 polar에 종속되어 이식성 낮음
- **ID**: ieee:8710796
- **Type**: conference
- **Published**: 5-9 Jan. 2
- **Authors**: Rahul Shrestha, Pooja Bansal, Srikant Srinivasan
- **PDF**: https://ieeexplore.ieee.org/document/8710796
...
- **Status**: ❌
- **Reason**: Reed-Solomon 인코더 설계(비-LDPC 부호), 디지털 필터링 기법은 LDPC BP에 비이식; 원칙 제외
- **ID**: ieee:8657174
- **Type**: conference
- **Published**: 28-31 Jan.
- **Authors**: Andrey Belyaev, Pavel Poperechny
- **PDF**: https://ieeexplore.ieee.org/document/8657174
- **Abstract**: Nowadays RS-encoding find wide application in many technical fields, such as digital telecommunication standards, memory storage system etc. The RS-codec can be hardware implemented as part of System-on-Chip (SOC) in FPGA or ASIC. In case of ASIC, SOC is used for many technical tasks, for example it can consist of the memory storage system like SSD and the digital communication unit like SDR (software defined radio), so both of these require ECC (error-correcting code) codec like RS, BCH, LDPC etc. Preferably that one codec can offer many standards with different error correcting capability (ECC) just not to use many codecs with large hardware costs.This article proposes a method to change correcting level capability. This approach allows using all digital filtering advantages, such as to split one big order filter to many first-order filters, pipelining to improve performance.

## High-Throughput Covert Channels in Adaptive Rate Wireless Communication Systems

- **Status**: ❌
- **Reason**: FEC 기반 covert channel 정보은닉(보안), 채널 ECC 디코더/구성 기여 없음
- **ID**: ieee:8706484
- **Type**: conference
- **Published**: 22-25 Jan.
- **Authors**: Peter M. B. Harley, Murali Tummala, John C. McEachen
- **PDF**: https://ieeexplore.ieee.org/document/8706484
...
## NSC Data Detection Scheme in NR-based Communications System

- **Status**: ❌
- **Reason**: 5G NR 무선 데이터검출(NSC=IRC+SIC) 응용 특이적, LDPC 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:8706356
- **Type**: conference
- **Published**: 22-25 Jan.
- **Authors**: Sangmi Moon, Soonho Kwon, Hyeonsung Kim +2
- **PDF**: https://ieeexplore.ieee.org/document/8706356
- **Abstract**: The 3rd Generation Partnership Project (3GPP) has recently developed new radio (NR) for the 5G introduction and commercialization. The requirements of the NR service are significantly higher than those of existing 4G. The maximum transmission rate of the downlink is 20Gbps, which is 20 times higher than that of the existing 4G. In addition, communications should be performed with an extremely low error probability within a time delay of several to several tens of ms. In this paper, 256QAM modulation scheme and low density parity check (LDPC) codes are applied to satisfy 5G requirements of high data rate and high reliability. In addition, we propose a new data detection technique called novel suppression and cancellation (NSC) which combines IRC and SIC, a data detection technique. Simulation results show that the proposed scheme improves the data rate and reliability compared to the existing scheme.
...
- **Status**: ❌
- **Reason**: 비이진(32-ary) NB-LDPC 디코더; 비이진 LDPC는 제외 대상
- **ID**: ieee:8629018
- **Type**: journal
- **Published**: 2019
- **Authors**: Mao-Ruei Li, Wei-Xiang Chu, Huang-Chang Lee +1
- **PDF**: https://ieeexplore.ieee.org/document/8629018
...
- **Status**: ❌
- **Reason**: 비이진 NB-LDPC(GF(q)) T-EMS 디코더 — 비이진 LDPC는 제외
- **ID**: ieee:8685081
- **Type**: journal
- **Published**: 2019
- **Authors**: Jing Tian, Suwen Song, Jun Lin +1
- **PDF**: https://ieeexplore.ieee.org/document/8685081
...
- **Status**: ❌
- **Reason**: LDPC가 베이스라인일 뿐 기여는 GMSK CPE 변조·BCJR 복조, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:8725540
- **Type**: journal
- **Published**: 2019
- **Authors**: Hai Zhu, Hengzhou Xu, Bo Zhang +2
- **PDF**: https://ieeexplore.ieee.org/document/8725540
...
- **Status**: ❌
- **Reason**: 바이너리 양자 부호를 QC 코드에서 유도, symplectic self-orthogonal 등 양자 전용 개념 의존 — 고전 바이너리 LDPC 이식 불가
- **ID**: ieee:8741013
- **Type**: journal
- **Published**: 2019
- **Authors**: Jingjie Lv, Ruihu Li, Junli Wang
- **PDF**: https://ieeexplore.ieee.org/document/8741013
...
- **Status**: ❌
- **Reason**: CRC-aided PC polar 부호 오류검출, 부호 비의존적 BP 이식 기법 없음
- **ID**: ieee:8883157
- **Type**: journal
- **Published**: 2019
- **Authors**: Fengyi Cheng, Aijun Liu, Jing Ren +1
- **PDF**: https://ieeexplore.ieee.org/document/8883157
...
- **Status**: ❌
- **Reason**: 비이진(non-binary)? 아님-바이너리 LDPC지만 JDDD는 표준 SPA 대비 joint detection 기법으로 DVB-S2 채널 특이적이며 자원과다로 NAND 이식 실익 없음 (애매하나 떼어낼 신규 BP 기여 불명확)
- **ID**: ieee:8741011
- **Type**: journal
- **Published**: 2019
- **Authors**: Kheong Sann Chan, Ashish James, Susanto Rahardja
- **PDF**: https://ieeexplore.ieee.org/document/8741011
...
- **Status**: ❌
- **Reason**: JSCC double-protograph LDPC; JSCC는 LDPC가 베이스라인이고 떼어낼 채널 ECC 기법 없음 (제외 항목)
- **ID**: ieee:8758624
- **Type**: journal
- **Published**: 2019
- **Authors**: Qiwang Chen, Shaohua Hong, Yifan Chen
- **PDF**: https://ieeexplore.ieee.org/document/8758624
- **Abstract**: A joint source channel coding (JSCC) scheme based on source and channel low density parity check (LDPC) codes, which is named as the D-LDPC system, has attracted a lot of attention recently. However, it suffers from a high error-floor. By introducing a linking matrix connecting variable nodes of source LDPC and check nodes of channel LDPC, the error-floor can be lowered effectively. However, the water-fall performance was lost with the increasing of the size of linking matrix. In this paper, a detailed analysis about the impact of this linking matrix on the water-fall region is conducted. Some design principles for the linking matrix are proposed, by which several linking matrices for different source statistics will be designed to improve the water-fall performance from the perspective of both the source and channel LDPC codes. The extrinsic information transfer (EXIT) analysis and numerical simulations will be compared to verify the superiority of the proposed linking matrices.

## Construction of Rate-Compatible Physical Layer Network Coding in Two-Way Relay Systems

- **Status**: ❌
- **Reason**: Two-way relay PNC용 rate-compatible 채널코딩(JTNC) — 무선 PNC 응용 특이적 puncturing/RC 설계, NAND ECC에 떼어낼 기법 없음
- **ID**: ieee:8644006
- **Type**: journal
- **Published**: 2019
- **Authors**: Ying You, Zhaopeng Xie, Pingping Chen +1
- **PDF**: https://ieeexplore.ieee.org/document/8644006
- **Abstract**: The existing physical-layer network coding (PNC) only considers channel codes of a constant coding rate. In this paper, we propose a rate-compatible (RC) channel coding scheme for PNC in two-way relay systems. Our contributions are as follows. First, we propose a two-edge-type-low-density-paritycheck-aided PNC (JTNC) scheme due to its simple implementation and excellent performance. Second, we design an RC scheme, i.e., choice of locations and symbols, for the proposed JTNC in the relay. The simulation results show that the proposed RC-JTNC has good error correction performance and achieves large gains over the existing puncturing algorithms aided PNC over a wide range of rates.

## The Design of Vertical RS-CRC and LDPC Code for Ship-Based Satellite Communications On-the-Move

- **Status**: ❌
- **Reason**: 위성통신용 RS-CRC+LDPC 연접; 표준 LDPC 사용, 새 바이너리 LDPC 디코더/구성 기여 없음
- **ID**: ieee:8628980
- **Type**: journal
- **Published**: 2019
- **Authors**: Bingrui Wang, Pingping Chen, Yi Fang +1
- **PDF**: https://ieeexplore.ieee.org/document/8628980
...
- **Status**: ❌
- **Reason**: SCMA 다중접속 MPA 검출 — 무선 응용 특이적, NAND 바이너리 LDPC로 떼어낼 ECC 기법 없음
- **ID**: ieee:8865009
- **Type**: journal
- **Published**: 2019
- **Authors**: Zhipeng Pan, Jing Lei, Wei Liu +2
- **PDF**: https://ieeexplore.ieee.org/document/8865009
...
- **Status**: ❌
- **Reason**: Golay 코드 기반 무선 비밀키 reconciliation 비트정합 — 비-LDPC, 정보조정, 이식 기법 없음
- **ID**: ieee:8580449
- **Type**: journal
- **Published**: 2019
- **Authors**: Chen Shen, Hao Li, Gokhan Sahin +2
- **PDF**: https://ieeexplore.ieee.org/document/8580449
...
- **Status**: ❌
- **Reason**: 무선 다운링크 rateless coded multiplexing — LDPC 비의존, 이식 가능한 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:8691426
- **Type**: journal
- **Published**: 2019
- **Authors**: Yen-Ming Chen, Wei-Min Lai, Yeong-Luh Ueng
- **PDF**: https://ieeexplore.ieee.org/document/8691426
- **Abstract**: This paper presents a non-orthogonal multiplexing scheme using the concept of rateless coding for a downlink broadcast scheme with two users. The proposed approach does not require the inclusion of successive interference cancellation (SIC) techniques for signal detection when compared to the power-domain non-orthogonal multiple access (PD-NOMA) schemes. In various user pair scenarios, it is shown that the proposed scheme not only enhances the user transmission rate but also reduces the overhead required for reliable transmissions when compared to PD-NOMA-based schemes. To further enhance the error performance when considering both unconstrained and constrained inputs, a code design algorithm is proposed based on the transmission rate analysis. It is shown that the designed rateless multiplexing schemes achieve error performances that accurately approach the predicted performance limits.

## Toward High-Performance Implementation of 5G SCMA Algorithms

- **Status**: ❌
- **Reason**: 5G SCMA MPA 디코더 구현, 비-LDPC(SCMA factor graph), LDPC는 부수 언급
- **ID**: ieee:8606081
- **Type**: journal
- **Published**: 2019
- **Authors**: Alireza Ghaffari, Mathieu Léonardon, Adrien Cassagne +2
- **PDF**: https://ieeexplore.ieee.org/document/8606081
...
- **Status**: ❌
- **Reason**: Physical-layer security for IoT/MEC; no LDPC ECC decoder/HW/code technique to extract.
- **ID**: ieee:8703710
- **Type**: journal
- **Published**: 2019
- **Authors**: Dong Wang, Bo Bai, Kai Lei +3
- **PDF**: https://ieeexplore.ieee.org/document/8703710
...
- **Status**: ❌
- **Reason**: Polar BP bit-flip 디코더, critical set은 polar 채널 극화 전용 개념으로 LDPC BP에 직접 이식 불가
- **ID**: ieee:8607080
- **Type**: journal
- **Published**: 2019
- **Authors**: Yongrun Yu, Zhiwen Pan, Nan Liu +1
- **PDF**: https://ieeexplore.ieee.org/document/8607080
...
- **Status**: ❌
- **Reason**: QCA 패리티 생성/검사 회로(나노통신 에러검출)로 LDPC ECC와 무관
- **ID**: ieee:8718600
- **Type**: journal
- **Published**: 2019
- **Authors**: Jadav Chandra Das, Debashis De, Sankar Prasad Mondal +3
- **PDF**: https://ieeexplore.ieee.org/document/8718600
...
- **Status**: ❌
- **Reason**: FrodoKEM 격자암호+ECC/Gray, 보안/암호 도메인, 비-LDPC
- **ID**: ieee:8931793
- **Type**: journal
- **Published**: 2019
- **Authors**: Eunsang Lee, Young-Sik Kim, Jong-Seon No +2
- **PDF**: https://ieeexplore.ieee.org/document/8931793
...
- **Status**: ❌
- **Reason**: BCH-Polar 연접+LUT HW; 비-LDPC이고 디코더가 polar/BCH 의존, BP 이식 불가
- **ID**: ieee:8770235
- **Type**: journal
- **Published**: 2019
- **Authors**: Yu Wang, Lirui Chen, Cang Liu +1
- **PDF**: https://ieeexplore.ieee.org/document/8770235
...
- **Status**: ❌
- **Reason**: Polar codes용 CRC-aided Log-SCS 스택 디코딩 — SC 계열 디코더로 polar 전용, 바이너리 LDPC BP에 이식 불가(비-LDPC 원칙 제외)
- **ID**: ieee:8651506
- **Type**: journal
- **Published**: 2019
- **Authors**: Luping Xiang, Zeynep B. Kaykac Egilmez, Robert G. Maunder +1
- **PDF**: https://ieeexplore.ieee.org/document/8651506
...
- **Status**: ❌
- **Reason**: 3D 카오스 어트랙터 기반 통신 설계+트레리스 디코딩, LDPC 무관·비-LDPC, NAND 이식 기법 없음
- **ID**: ieee:8607963
- **Type**: journal
- **Published**: 2019
- **Authors**: Carlos E. C. Souza, Daniel P. B. Chaves, Cecilio Pimentel
- **PDF**: https://ieeexplore.ieee.org/document/8607963
...
## Polar-Coded DCSK-based Multi-access Transmission System

- **Status**: ❌
- **Reason**: Polar 부호 + 카오스 변조 무선 시스템, 부호 비의존적 BP 이식 기법 없음
- **ID**: ieee:8877137
- **Type**: conference
- **Published**: 2019
- **Authors**: J. Ou, Z. Xie, J. Chen +1
- **PDF**: https://ieeexplore.ieee.org/document/8877137
- **Abstract**: This paper explores the application of polar codes for Walsh-code-based multi-access differentially differential chaos shift keying (DDCSK-WC) system. As such, a serial concatenated coding of the channel detector and the polar decoder is formed. In particular, the proposed polar-coded DDCSK-WC system does not require the channel state information, which avoids complex channel estimation and simplifies the receiver implementation as in uncoded-DDCSK-WC scheme. Simulation results verify that the performance improvement of the polar coded DDCSK-WC system over uncoded one in Rayleigh multipath fading channels. Besides, the performance advantage of the polar-coded DDCSK-WC is illustrated over a realistic ultra-wideband (UWB) channel. Therefore, the proposed chaotic-based polar-coded scheme offers a promising alternative for short-length low-cost and low-complexity communication, such as wireless local area network applications.

## Spatially Coupled Repeat-Accumulate Signal Codes

- **Status**: ❌
- **Reason**: Repeat-accumulate signal codes(SC-RASC)는 비-LDPC 신호코드, 떼어낼 바이너리 LDPC BP/HW/구성 기여 없음
- **ID**: ieee:8714357
- **Type**: conference
- **Published**: 2019
- **Authors**: M. Takai, K. Ishibashi
- **PDF**: https://ieeexplore.ieee.org/document/8714357
- **Abstract**: We propose spatially coupled repeat-accumulate codes (SC-RASC) as a new class of repeat-accumulate signal codes (RASC). Monte-Carlo density evolution analysis displays that SC-RASC can achieve about 0.3dB away from the channel capacity of additive white Gaussian noise (AWGN) channels. Furthermore, finite-length simulation results show that the symbol error rate performance of SC-RASC is 0.2dB superior to that of the conventional RASC with an information length of 6500 signals.

## Signal Point Target Code

- **Status**: ❌
- **Reason**: 변조점 회전 기반 rate 1/2 트렐리스 블록부호(비-LDPC), 이식 기법 없음
- **ID**: ieee:8885083
- **Type**: conference
- **Published**: 2019
- **Authors**: J. Sodha, T. Moon
- **PDF**: https://ieeexplore.ieee.org/document/8885083
- **Abstract**: The signal points transmitted from a given modulation scheme are rotated to follow a pre-defined path through the signal constellation diagram to create a novel rate 1/2 systematic block code that allows for trellis based decoding. By setting a predefined target signal point, the input signal points are rotated to overlay the target signal point to create a code trellis of (M - 1) initial and final rotation states. Simulation results are presented for rate 1/2 systematic target codes created using the M-ary QAM signal constellations for M = 4 and 16.

## A Simulation of DVB-S2 System in Fading Channels

- **Status**: ❌
- **Reason**: DVB-S2 BCH+LDPC 종단 시뮬레이션, 신규 디코더/구성/HW 기여 없는 단순 시뮬
- **ID**: ieee:8883449
- **Type**: conference
- **Published**: 2019
- **Authors**: H. N. Manh, M. Richterova, M. Vrsecka
- **PDF**: https://ieeexplore.ieee.org/document/8883449
- **Abstract**: Coded modulation techniques are a very promising technique for satellite broadcasting, as it could corrects error nearing the theoretical Shannon limit. From the viewpoint, Second Generation Digital Video Broadcasting via Satellite channels using forward error correction is the most innovative approach towards the modern research. However, the conventional research focused on simulations of the subsystem or full simulation in the additive white Gaussian noise channel. In the article, based on a description of standard document, the end-to-end simulation with single input stream over fading channel was described and simulated. The whole communication channel is modelled in the simulation, including the Bose-Chaudhuri-Hocquenghem and low-density parity-check coder/decoder, mod/demodulation, physical layer frame blocks and communication channel. In order to have the accuracy simulation in fading channels, built-in Matlab functions and basic algorithms used in the program. The simulation results on the constellation diagram provide an overview of Second Generation Digital Video Broadcasting system in Rayleigh and Rician channels. Furthermore, obtained results were visually quantitated and discussed.

## A Lower Bound on the Error Exponent of Linear Block Codes over the Erasure Channel

- **Status**: ❌
- **Reason**: 소거채널 ML 오류지수 하한 순수이론 bound, 디코더/HW/구성 없음
- **ID**: ieee:8849509
- **Type**: conference
- **Published**: 2019
- **Authors**: E. Paolini, G. Liva
- **PDF**: https://ieeexplore.ieee.org/document/8849509
- **Abstract**: A lower bound on the maximum likelihood (ML) decoding error exponent of linear block code ensembles, on the erasure channel, is developed. The lower bound turns to be positive, over an ensemble-specific interval of erasure probabilities, when the ensemble weight spectral shape function tends to a negative value as the fractional codeword weight tends to zero. For these ensembles we can therefore lower bound the block-wise ML decoding threshold. Two examples are presented, namely, linear random parity-check codes and fixed-rate Raptor codes with linear random precoders. While for the former a full analytical solution is possible, for the latter we can lower bound the ML decoding threshold on the erasure channel by simply solving a 2 × 2 system of nonlinear equations.

## Statistical Learning Aided Decoding of BMST Tail-Biting Convolutional Code

- **Status**: ❌
- **Reason**: BMST-TBCC(tail-biting convolutional) SLVA 디코딩 — 비-LDPC 부호, Viterbi 기반이라 바이너리 LDPC BP 이식 불가
- **ID**: ieee:8849780
- **Type**: conference
- **Published**: 2019
- **Authors**: X. Ma, W. Lin, S. Cai +1
- **PDF**: https://ieeexplore.ieee.org/document/8849780
...
- **Status**: ❌
- **Reason**: 동기화 오류정정 concatenated 마커 코드, 비-LDPC·이식할 BP 기법 없음
- **ID**: ieee:9064318
- **Type**: conference
- **Published**: 2019
- **Authors**: T. Xue, C. M. Francis Lau
- **PDF**: https://ieeexplore.ieee.org/document/9064318
- **Abstract**: A concatenated code with designed markers is proposed to detect and correct both synchronization and substitution errors. The inner decoder is effective in maintaining synchronization at codeword boundaries with the help of designed markers. The outer conventional error correcting code is used to provide adequate error correcting capability. The frame error rate (FER) of the concatenated code is both analyzed theoretically and simulated. The performance and complexity of our code is also compared with Davey Mackay (DM) watermark code over channels with substitution, deletion and insertion errors. The concatenated code we propose can correct multiple substitution and synchronization errors with much lower complexity and simpler decoding algorithm. Simulation and theoretical analysis show that the performance of our code at rate 0.50 can perform much better than that of watermark code at code rate 0.71. Great reduction in decoding complexity has been realized at the expense of code rate loss.

## A Novel Group Retransmission Scheme for Industrial IoT over 5G

- **Status**: ❌
- **Reason**: 5G IoT HARQ 그룹캐스트 재전송, 외부부호 RS/Raptor — 비-LDPC이며 이식 가능한 BP 디코더 기법 없음
- **ID**: ieee:9024444
- **Type**: conference
- **Published**: 2019
- **Authors**: J. Yeo, H. Ji, J. Bang +2
- **PDF**: https://ieeexplore.ieee.org/document/9024444
- **Abstract**: This paper considers a hybrid automatic repeat and request (HARQ) scheme of groupcast data transmission for industrial Internet-of-Things (IoT) in 5G New Radio (NR) system. HARQ has been widely used for unicast transmission to improve reliability and resource efficiency. However, it becomes inefficient in industrial IoT scenarios that have a lot of target receivers in groupcast data transmission since each receiver may have different part failed to correctly decode. In this paper, a novel and efficient groupcast retransmission scheme for industrial IoT services by adopting a concatenated code structure with inner and outer codes is proposed. The amount of retransmitted data is minimized by only transmitting parity code blocks generated by the outer code, e.g., Reed-Solomon (RS) or Raptor code. In addition, the receivers send HARQ feedback information by utilizing the common resources, which can offer the improvement of uplink feedback coverage for IoT devices. Numerical results show that the proposed scheme outperforms the conventional HARQ schemes, reducing more than 50% of retransmissions.

## Performance Analysis of Concatenated Error Correction Code in Secret Key Generation System

- **Status**: ❌
- **Reason**: 비밀키 생성 정보조정용 BCH+RS 연접부호; 비-LDPC 부호이고 떼어낼 LDPC BP 기법 없음
- **ID**: ieee:8947039
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Wang, L. Peng, H. Fu +2
- **PDF**: https://ieeexplore.ieee.org/document/8947039
- **Abstract**: Secret key generation from wireless channel is an emerging technique of physical layer security. At present, most of the secret key generation schemes use information reconciliation to obtain symmetric keys. This paper introduces a non-interactive information reconciliation scheme based on channel coding and stream encryption, and considering the error correction capability, we design a concatenated code of BCH and RS codes as channel coding. The performance of concatenated error correction code has been analyzed in this scheme. Then, we compare the concatenated code with first-level error correction code in different test environments. Extensive numerical simulations and experiments demonstrate that the decoding performance of this second-level concatenated code is better than the first-level error correction code, and it can also effectively eliminate third-party eavesdropping.
...
- **Status**: ❌
- **Reason**: LOCO 제약(line)부호 — LDPC 패리티 인코딩 언급뿐, LDPC ECC 디코더/구성 기여 아님
- **ID**: ieee:8989270
- **Type**: conference
- **Published**: 2019
- **Authors**: A. Hareedy, R. Calderbank
- **PDF**: https://ieeexplore.ieee.org/document/8989270
...
- **Status**: ❌
- **Reason**: blind code detection 계산복잡도(NP-hard) 순수이론, 디코더·HW·구성으로 안 이어짐
- **ID**: ieee:8849467
- **Type**: conference
- **Published**: 2019
- **Authors**: A. Balatsoukas-Stimming, A. Filos-Ratsikas
- **PDF**: https://ieeexplore.ieee.org/document/8849467
...
- **Status**: ❌
- **Reason**: Davey-MacKay 워터마크 동기화 코드 코드북 설계, 비-LDPC·NAND 이식 기법 없음
- **ID**: ieee:9026489
- **Type**: conference
- **Published**: 2019
- **Authors**: T. Xue, F. C. M. Lau
- **PDF**: https://ieeexplore.ieee.org/document/9026489
- **Abstract**: The synchronization-correcting code proposed by Davey and MacKay (DM) consists of an outer code which corrects substitution errors and an inner watermark code which maintains synchronization. The inner watermark code converts each symbol into one of the lowest density sequences which is subsequently added to a predefined randomly-generated watermark sequence. We claim that the inner sparsified codebook can be optimized based on better distance property and lowest-density property, and the improvement can be significant under some specific cases. In order to verify our claim and to reduce the complexity of the inner decoder, a hard-decision decoding based on Hamming distance and a soft-decision decoding based on a new metric are proposed for the symbol-level decoder. Simulation results verify the claim that the system with the improved codebook design offers better performance in terms of symbol error rate, reduces decoding complexity and saves computational time.

## Modified Successive Cancellation Flip Decoder for Polar Codes Based on Gaussian Approximation

- **Status**: ❌
- **Reason**: Polar SC-flip 디코더 개선; polar 특화 SC 디코딩, LDPC BP 이식 불가
- **ID**: ieee:8770559
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Lv, H. Yin, J. Li +2
- **PDF**: https://ieeexplore.ieee.org/document/8770559
- **Abstract**: Compared with the conventional successive cancellation (SC) decoding algorithm, the list decoder effectively improves the block error rate (BLER) performance, but also greatly increases the space complexity. Thus, some scholars have proposed a successive cancellation flip (SCF) decoder that can maintain the similar spatial complexity of the SC decoder while improving the BLER performance of SC decoder. However, the computational complexity of the SCF decoder at low SNR is greater than that of the SC decoder. To overcome the problem and further decrease the complexity, we propose a new decoder called modified successive cancellation flip (MSCF) decoder, which reasonably avoids the unnecessary flip operation of conventional SCF decoder by utilizing a threshold based on Gaussian approximation. Simulation results have shown that the new decoder can significantly reduce the complexity of SCF algorithm with not obvious BLER performance decrease.

## Employing a Pseudo-Random Sequence to Secure a Lattice Coding Scheme

- **Status**: ❌
- **Reason**: Lattice 코딩 보안 의사난수 기법; LDPC 무관, 보안 도메인
- **ID**: ieee:8786590
- **Type**: conference
- **Published**: 2019
- **Authors**: N. Sanandaji, A. Falahati
- **PDF**: https://ieeexplore.ieee.org/document/8786590
- **Abstract**: A pseudo-random antipodal sequence that is accessible to transmitter and legitimate receiver is employed over a lattice coding scheme to provide the required security. Traditionally, pseudo-random sequences are employed in spread spectrum techniques to maintain the security of a wireless communication system. However, spread spectrum techniques require a huge amount of bandwidth that is a major constraint for wireless systems. Nonetheless, in the proposed scheme, the pseudorandom sequence is employed over channel coding level, so the bandwidth limitation of the spread spectrum is eased significantly. Mathematically, it is proved that the eavesdropper suffers from a degraded channel compared with legitimate receiver, and at high signal to noise ratio regimes, the proposed scheme can considerably deliver the required secrecy.
...
- **Status**: ❌
- **Reason**: polar 부호 정보·에너지 동시전송 — 비-LDPC, 이식 기법 없음
- **ID**: ieee:8815547
- **Type**: conference
- **Published**: 2019
- **Authors**: S. Basu, L. R. Varshney
- **PDF**: https://ieeexplore.ieee.org/document/8815547
...
- **Status**: ❌
- **Reason**: 분산학습 straggler 완화용 LDGM gradient coding — 채널 ECC가 아니고 NAND LDPC로 떼어낼 디코더/HW/구성 기법 없음
- **ID**: ieee:8849580
- **Type**: conference
- **Published**: 2019
- **Authors**: S. Horii, T. Yoshida, M. Kobayashi +1
- **PDF**: https://ieeexplore.ieee.org/document/8849580
...
- **Status**: ❌
- **Reason**: rank-metric 기반 code-based KEM 보안(암호) — ECC 디코더·LDPC와 무관, 보안 제외
- **ID**: ieee:8849302
- **Type**: conference
- **Published**: 2019
- **Authors**: L. -P. Wang
- **PDF**: https://ieeexplore.ieee.org/document/8849302
- **Abstract**: Based on hardness of the rank support learning problem which is as hard as the rank syndrome problem, we introduce a new IND-CPA-secure public-key encryption scheme— Loong.CPAPKE. By applying a variant of the Fujisaki-Okamoto transform to Loong.CPAPKE, a new IND-CCA-secure key encapsulation mechanism (KEM for short) can be constructed. We also make comparison on parameter sets between our scheme and some NIST submissions.

## Low-Precision Neural Network Decoding of Polar Codes

- **Status**: ❌
- **Reason**: polar NSC용 저정밀 NN 디코더 — polar SC 구조 의존, LDPC BP 이식 불가
- **ID**: ieee:8815542
- **Type**: conference
- **Published**: 2019
- **Authors**: I. Wodiany, A. Pop
- **PDF**: https://ieeexplore.ieee.org/document/8815542
...
- **Status**: ❌
- **Reason**: 폴라코드 경로메트릭 비트플립 디코딩 — SC 기반 폴라 전용, LDPC BP 비이식
- **ID**: ieee:8885419
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Wang, L. Chen, Q. Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/8885419
...
- **Status**: ❌
- **Reason**: Polar SC 디코더용 PE HW — SC 전용 f/g 함수라 바이너리 LDPC BP에 비이식, 양자화/precompute도 폴라 특이적
- **ID**: ieee:8882149
- **Type**: conference
- **Published**: 2019
- **Authors**: F. G. Krasser, M. C. Liberatori, L. Coppolillo +2
- **PDF**: https://ieeexplore.ieee.org/document/8882149
...
## High Speed Polar Encoder Architecture For next Generation 5G Applications Using Radix-k Processing Engine

- **Status**: ❌
- **Reason**: polar 인코더 radix-k VLSI — polar 전용 HW, LDPC 이식 불가
- **ID**: ieee:8821961
- **Type**: conference
- **Published**: 2019
- **Authors**: R. Kavipriya, M. Maheswari
- **PDF**: https://ieeexplore.ieee.org/document/8821961
- **Abstract**: Among the various encoding techniques which is effective, polar encoding is found to be the best because of its unique characteristics of channel achieving property. The coding scheme chosen by Third Generation Partnership Project (3GPP) is polar code since it has attracted the attention towards the 5th generation wireless system. The emerging research is going on the polar codes in the application of MIMO system. Polar encoder is mainly designed because of its high processing speed as compared with other techniques. The VLSI implementation process can be extended to a large extent by using radix-k based design.

## Outage Probability and Performance of Moderate-Length Codes under Partial-Band Noise Jamming (PBNJ)

- **Status**: ❌
- **Reason**: Outage-probability theory bound for moderate-length DVB-S2 FEC under jamming — pure theory, no decoder/HW/construction.
- **ID**: ieee:9021002
- **Type**: conference
- **Published**: 2019
- **Authors**: L. K. Nguyen, R. B. Wells, D. H. N. Nguyen +1
- **PDF**: https://ieeexplore.ieee.org/document/9021002
...
- **Status**: ❌
- **Reason**: 저용량 채널코딩 비점근 한계 — 순수 이론 bound, 디코더/HW/구성 없음
- **ID**: ieee:8989142
- **Type**: conference
- **Published**: 2019
- **Authors**: M. Fereydounian, M. V. Jamali, H. Hassani +1
- **PDF**: https://ieeexplore.ieee.org/document/8989142
...
- **Status**: ❌
- **Reason**: DVB-T2용 FBMC vs OFDM 변조 비교; ECC/LDPC 기법 없는 멀티캐리어 변조 논문
- **ID**: ieee:8969550
- **Type**: conference
- **Published**: 2019
- **Authors**: A. -C. Honfoga, T. T. Nguyen, M. Dossou +1
- **PDF**: https://ieeexplore.ieee.org/document/8969550
...
## Error Rate Performance of Communication Systems with SCMA

- **Status**: ❌
- **Reason**: SCMA(sparse code multiple access) 무선 5G 코드북 설계, NAND LDPC ECC와 무관하고 떼어낼 디코더/HW 기법 없음
- **ID**: ieee:8823323
- **Type**: conference
- **Published**: 2019
- **Authors**: D. A. Pokamestov, Y. V. Kryukov, E. V. Rogozhnikov
- **PDF**: https://ieeexplore.ieee.org/document/8823323
- **Abstract**: The article deals with the analysis and improvement of error rate performance of communication systems with multiple access based on sparse codes. This channel formation method is a promising technology that will be probably used in the fifth-generation wireless networks. The principles of communication system operation with multiple access on the basis of sparse codes with books which dimensions coincide with the number of subcarriers are considered. Such codebooks formation algorithm is described. The signal transmission simulation results in channels with additive white Gaussian noise and in channels with multipath propagation are provided. It is shown that it is possible to increase the transmission error rate performance by the formation of "large" codebooks. This is achieved through the formation of multidimensional signal constellations and the analysis of complex amplitudes vector of all subcarriers used for transmission.

## On the Design of Analog Fountain Codes for Short Packet Communications in 5G URLLC

- **Status**: ❌
- **Reason**: 아날로그 fountain code+BCH 프리코더 설계로 비-LDPC fountain/erasure, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:8891550
- **Type**: conference
- **Published**: 2019
- **Authors**: W. J. Lim, M. Shirvanimoghaddam, R. Abbas +2
- **PDF**: https://ieeexplore.ieee.org/document/8891550
- **Abstract**: Analog fountain code (AFC) is a seamless rate adaptation strategy and was recently shown to closely approach the channel capacity without the channel state information at the transmitter side. The code was mainly designed for large block lengths and therefore the design for short packet communications which is one of the communication scenarios in 5G ultra-reliable and low latency communications (URLLC), is still not clear. We tackle this problem in this work and particularly focus on the design of the precoder which is shown to significantly affects the overall performance of the AFC in the short block length regime. We consider BCH codes as the precoder, and determine the rate of the code in order to maximize the realized rate under a given block error rate constraint. Simulation is performed to investigate the effect of choices for BCH precoder on the overall performance of BCH-AFC in terms of reliability and latency. We show that by selecting the appropriate BCH code as the AFC precoder, AFC performs closely to the normal approximation benchmark. We further proposed a threshold-based decoder to reduce the decoding complexity which is of significant importance in URLLC scenarios.

## Link Adaptation Algorithms for Free-Space Optical Communication Systems

- **Status**: ❌
- **Reason**: turbo-coded FSO 적응형 변조/코딩 — turbo 부호, FSO 응용 특이적, 이식 가능 LDPC 기법 없음
- **ID**: ieee:9118109
- **Type**: conference
- **Published**: 2019
- **Authors**: S. H. Hariq, N. Odabasioglu
- **PDF**: https://ieeexplore.ieee.org/document/9118109
- **Abstract**: In this paper, a turbo-coded FSO system with Mary pulse position modulation is considered over log-normal turbulence channels and an adaptive coding and modulation scheme is proposed under peak power constraints. In the proposed system, a link adaptation technique is designed to maximize the bandwidth efficiency of the turbo-coded FSO system by adaptively varying the code rate of turbo code and modulation size according to the channel state information. The simulation results demonstrate significant performance improvements of the proposed adaptive coding and modulation scheme over coded/uncoded adaptive modulation and non-adaptive counterparts.

## Low Complexity PIC-MMSE Detector for LDS Systems

- **Status**: ❌
- **Reason**: LDS 다중사용자 검출용 PIC-MMSE(MPA 대체) — 채널 LDPC 부호 BP가 아닌 다중접속 검출기
- **ID**: ieee:8861818
- **Type**: conference
- **Published**: 2019
- **Authors**: M. Fantuz, C. D’Amours
- **PDF**: https://ieeexplore.ieee.org/document/8861818
- **Abstract**: Non-orthogonal multiple access (NOMA) is a promising multiple access scheme for Fifth Generation (5G) cellular networks as it provides a high spectral efficiency to meet the demands of new wireless applications, such as Internet-of-Things (IoT). Low density spreading (LDS) is a code-domain NOMA technique that spreads users' symbols with spreading sequences that contain a low number of nonzero chips. This low-density structure allows for detection using the belief propagation-based message passing algorithm (MPA). MPA is a suboptimum detector that converges to the optimum maximum a posteriori (MAP) detector with reduced complexity, but the algorithm complexity is exponentially proportional to the number of interfering users, which can be prohibitive when the system is operating near peak load. We propose an alternative detector based on the minimum mean square error (MMSE) and parallel interference cancellation (PIC) detectors which offer complexity that is quadratic to the number of users. Simulations show with a system load of 150%, the number of multiplications, additions and exponentials are reduced by 81.8%, 67.8% and 97.9% respectively with a penalty of about 0.25 dB at an error rate of 10-3.

## On Performance Analysis and Code Design for Visible Light Communication

- **Status**: ❌
- **Reason**: VLC RLL+컨볼루셔널 FEC, 비-LDPC, 이식할 LDPC 디코더 기법 없음
- **ID**: ieee:8919764
- **Type**: conference
- **Published**: 2019
- **Authors**: N. Jain, A. Banerjee
- **PDF**: https://ieeexplore.ieee.org/document/8919764
...
## Huffman coded sphere shaping with short length and reduced complexity

- **Status**: ❌
- **Reason**: Huffman 기반 probabilistic shaping(소스 측 분포정형) — 채널 ECC LDPC 디코더·구성 기여 아님
- **ID**: ieee:9125512
- **Type**: conference
- **Published**: 2019
- **Authors**: D. S. Millar, T. Fehenberger, T. Yoshida +4
- **PDF**: https://ieeexplore.ieee.org/document/9125512
...
- **Status**: ❌
- **Reason**: VLC flicker-free FEC를 polar 코드로 구성, 비-LDPC이며 LDPC 이식 기법 없음
- **ID**: ieee:9013196
- **Type**: conference
- **Published**: 2019
- **Authors**: E. Ngomseu Mambou, T. Tonnellier, S. A. Hashemi +1
- **PDF**: https://ieeexplore.ieee.org/document/9013196
...
- **Status**: ❌
- **Reason**: 폴라부호 병렬채널 전력할당 설계 — LDPC 비관련, 이식 디코더 기법 없음
- **ID**: ieee:8849335
- **Type**: conference
- **Published**: 2019
- **Authors**: T. Wiegart, T. Prinz, F. Steiner +1
- **PDF**: https://ieeexplore.ieee.org/document/8849335
...
## Performance of Polar Codes under Successive Cancellation Decoding Employing Approximation Algorithm

- **Status**: ❌
- **Reason**: polar SC 디코딩에 표준 min-sum 근사 적용 평가뿐, LDPC BP에 이식할 신규 기법 없음
- **ID**: ieee:9008707
- **Type**: conference
- **Published**: 2019
- **Authors**: N. Miki, S. Suyama, S. Nagata
- **PDF**: https://ieeexplore.ieee.org/document/9008707
- **Abstract**: This paper evaluates the performance degradation incurred by an approximation algorithm (min-sum algorithm) when polar codes under successive cancellation decoding (SCD) are employed. To understand the behavior of the algorithm under the SCD, the error performances of the synthetic channels were evaluated, since different synthetic channels show different levels of degradation, because the numbers of the approximation algorithm applied to the channels and the operating signal-to-noise power ratios (SNRs) of the channels, which also affect the levels of degradation, are different. After evaluation of the synthetic channels, the block error rate performances under the SCD for different coding rates were obtained. The results show that the performance degradation was not significant, even when a coded bit length of 214=16384 was used.

## Mutual-Information-Based Successive Cancellation List Decoding of Polar Codes

- **Status**: ❌
- **Reason**: polar 부호 전용 MI-SCL 디코딩, 부호 비의존적 이식성 없음
- **ID**: ieee:8746488
- **Type**: conference
- **Published**: 2019
- **Authors**: S. K. Jha, K. Deka, S. Rao
- **PDF**: https://ieeexplore.ieee.org/document/8746488
...
- **Status**: ❌
- **Reason**: 확률적 구형 셰이핑 — 채널 ECC 디코더/구성 아님
- **ID**: ieee:8818086
- **Type**: conference
- **Published**: 2019
- **Authors**: S. Goossens, S. Van der Heide, M. Van den Hout +8
- **PDF**: https://ieeexplore.ieee.org/document/8818086
...
## Rate Analysis of Ad Hoc Networks under Rapid On-Off-Division Duplex

- **Status**: ❌
- **Reason**: 애드혹 네트워크 RODD 처리율 분석; 오류제어부호는 부수 언급, 떼어낼 LDPC 기법 없음
- **ID**: ieee:8960854
- **Type**: conference
- **Published**: 2019
- **Authors**: M. Yu, W. Zhang
- **PDF**: https://ieeexplore.ieee.org/document/8960854
- **Abstract**: We examine the deployment of rapid on-off-division duplex (RODD) scheme, a paradigm to enable bidirectional communication with half-duplex radios, in a partially-connected ad hoc network. Different from symmetric interlinked ad hoc network, not all the received signals can be decoded by receivers in partially connected networks, thus the effect of multiuser interference should be considered and the throughput of such network is evaluated with Gaussian code-books and random on-off masks. Numerical experiments show that the throughput of RODD is higher than that of the random access protocol in 802.11b. However, the throughput is shown to be limited as the number of users and the probability of transmission increase. Based on error-control codes and compressive sensing, a general paradigm for on-off mask generation and channel coding is discussed.

## A Compact Soft MMSE detection Scheme for Uplink Coded Massive MIMO Systems

- **Status**: ❌
- **Reason**: Massive MIMO용 MMSE-PIC 소프트 검출 복잡도 감소 기법; LDPC ECC 디코더/코드 기법 없음, 무선 검출 특이적
- **ID**: ieee:8939871
- **Type**: conference
- **Published**: 2019
- **Authors**: Z. Zhang, M. Zhang, S. Kim
- **PDF**: https://ieeexplore.ieee.org/document/8939871
...
- **Status**: ❌
- **Reason**: HARQ 조기 재전송/다단 판정 기법으로 채널 디코더 무관, LDPC ECC 이식 기법 없음
- **ID**: ieee:8891408
- **Type**: conference
- **Published**: 2019
- **Authors**: K. Taniyama, Y. Kishiyama, K. Higuchi
- **PDF**: https://ieeexplore.ieee.org/document/8891408
...
- **Status**: ❌
- **Reason**: Fountain/LT 코드 degree distribution을 DRL로 최적화, fountain/erasure는 제외 대상이며 LDPC BP 디코더 기여 없음
- **ID**: ieee:8845185
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Savchenko, Y. Liu
- **PDF**: https://ieeexplore.ieee.org/document/8845185
- **Abstract**: Fountain codes are a modern class of error-correcting codes with a reasonably low encoding/decoding complexity and an ability that constitutes their rateless property to generate encoded symbols on demand. Fountain codes have found various applications, most notably in the areas of network communications, data storage systems, delay sensitive transmissions and continuous data delivery. Furthermore, fountain codes form the core part of alternative communications protocols, also known as a digital fountain communication protocol and its modifications, for future networks. Luby Transform (LT) codes are the first practical realization of fountain codes for binary and packet erasure channels. LT codes and the fountain codes that originate from LT codes (LT-based codes), such as Raptor or Zigzag Decodable fountain codes, utilize monomial distributions for degree selection, also known as degree distributions. Degree distributions have a significant impact on the overall efficiency of the fountain codes; therefore, we propose a novel technique that uses deep reinforcement learning to approximate/learn an optimal degree distribution (ODD). We obtain an approximation of an ODD, which we call a learned degree distribution (LDD), and evaluate the fountain codes with the LDD and other previously proposed degree distributions and observe improvements in their performance whenever the codes use the LDD.

## Multipath and Impulsive Noise Interference Testing Performance Comparison Between Broadcast Systems: ISDB-TB and ATSC 3.0

- **Status**: ❌
- **Reason**: ISDB-T/ATSC 3.0 멀티패스·임펄스 노이즈 실험실 테스트 — ECC 기여 없음, 무선 방송 응용 특이적
- **ID**: ieee:8971887
- **Type**: conference
- **Published**: 2019
- **Authors**: G. H. M. G. d. Oliveira, R. S. Rabaça, N. S. Santiago +14
- **PDF**: https://ieeexplore.ieee.org/document/8971887
- **Abstract**: This paper presents laboratory test results from multipath and impulsive noise interference in the brazilian Digital TV system, ISDB-$\mathrm{T}_{B}$, and in the broadcast system ATSC 3.0, adopted by USA and South Korea. These tests were made in a Faraday–s Cage, environment immune to external electromagnetic waves.

## A Polar-Coded MIMO-OFDM Scheme for VLC System

- **Status**: ❌
- **Reason**: Polar-coded MIMO-OFDM VLC, 떼어낼 LDPC 기법 없음
- **ID**: ieee:8989605
- **Type**: conference
- **Published**: 2019
- **Authors**: X. Yan, J. He, Y. Liu +4
- **PDF**: https://ieeexplore.ieee.org/document/8989605
- **Abstract**: Polar code combined with MIMO-OFDM scheme is proposed for VLC system. At the same spectrum efficiency, it can obtain 2.6dB SNR improvement for user1 and 2.5dB for user2 using 64-QAM at BER of 1 × 10−4.

## The Evaluation of Faster-Than-Nyquist System with THP Precoding Technology

- **Status**: ❌
- **Reason**: Faster-than-Nyquist THP 프리코딩, ECC/LDPC 기법 없음
- **ID**: ieee:8989025
- **Type**: conference
- **Published**: 2019
- **Authors**: G. Huang, Y. Koganei, H. Nakashima
- **PDF**: https://ieeexplore.ieee.org/document/8989025
- **Abstract**: In this paper, we evaluated an analog bandwidth limited system with faster-than-Nyquist technologies. The THP-precoding technology was applied and the simulation results show obvious improvement for digital coherent system of 800G with 64QAM modulation format.

## 1.04 Tbps/Carrier Probabilistically Shaped PDM-64QAM WDM Transmission Over 240 km Based on Electrical Spectrum Synthesis

- **Status**: ❌
- **Reason**: 광 WDM 전송 데모 — ECC/LDPC 기법 없음
- **ID**: ieee:8696302
- **Type**: conference
- **Published**: 2019
- **Authors**: M. Nakamura, F. Hamaoka, M. Nagatani +7
- **PDF**: https://ieeexplore.ieee.org/document/8696302
- **Abstract**: We demonstrate 1.04-Tbps/carrier net-rate 125-GHz-spaced 9-WDM (9.3-Tbps) transmission over 240-km using 120-GBd probabilistically shaped PDM-64QAM generated by electrical spectrum synthesis technique with in-house ultra-broadband bandwidth doublers with the spectral efficiency of 8.3 bps/Hz.

## MC-CDMA and SCMA Performance Evaluation in 100% and 200% Load Factor Scenarios

- **Status**: ❌
- **Reason**: Wireless 5G MC-CDMA vs SCMA multiple-access comparison with MPA/sphere detector; no portable LDPC ECC decoder/HW/code-design technique.
- **ID**: ieee:9014898
- **Type**: conference
- **Published**: 2019
- **Authors**: C. I. Frison, H. C. Mora, C. de Almeida
- **PDF**: https://ieeexplore.ieee.org/document/9014898
...
## Research on the application of wide bandwidth transmission for DTT 8K-UHDTV services

- **Status**: ❌
- **Reason**: DTT 8K-UHDTV 광대역 전송 응용; ECC/LDPC 기법 없는 방송 시스템 논문
- **ID**: ieee:8940037
- **Type**: conference
- **Published**: 2019
- **Authors**: J. Bae, J. Seo, Y. Kim +5
- **PDF**: https://ieeexplore.ieee.org/document/8940037
- **Abstract**: In this paper, we discussed the application of wide bandwidth transmission in Korean DTT(digital terrestrial television) environment for the preparation of 8K-UHDTV service. Even though 4K-UHDTV service had started several years ago, the technologies and equipment for 8K-UHDTV are ready in media markets. The global manufactures such as LG, Samsung, Sharp, Sony are releasing various 8K-UHDTV commercial products already. When VVC(versatile video coding), which has twice higher video compression efficiency than HEVC(high efficiency video coding) used in 4K-UHDTV, is standardized in 2020, 8KUHDTV services are expected to be promoted actively through internet OTT(over the top), IPTV, cable TV etc. In this situation, it is worthwhile to consider 8K-UHDTV services thorough terrestrial television. In this paper, we discussed and analyzed the application of wide bandwidth transmission to investigate 8KUHDTV service with terrestrial TV. More over the wide bandwidth transmission has advantages in reducing network installation cost and operation cost. Through the computer simulation, it is shown that the wide bandwidth transmission has almost the same performances with legacy narrow bandwidth transmission.

## Coded Slotted Aloha over the On-Off Fading Channel: Performance Bounds

- **Status**: ❌
- **Reason**: Coded Slotted Aloha 성능 bound, 순수 이론·이식할 디코더/HW 없음
- **ID**: ieee:9049025
- **Type**: conference
- **Published**: 2019
- **Authors**: G. Liva, E. Paolini, Č. Stefanović +1
- **PDF**: https://ieeexplore.ieee.org/document/9049025
- **Abstract**: The on-off fading channel is used as a proxy to gain insights on the performance of coded slotted Aloha (CSA) access protocols on the block flat fading channel. Bounds on the performance of CSA are developed, which include both the on-off fading effect and multi-packet reception capabilities at the receiver. The bounds apply to the case where a non-vanishing packet loss probability can be tolerated. A comparison of simulation results for actual CSA schemes with the developed bounds is provided.
...
- **Status**: ❌
- **Reason**: 악의적 적대자 환경 인증용 구조화 부호 — 보안/인증 도메인, LDPC ECC 이식 기법 없음
- **ID**: ieee:8849581
- **Type**: conference
- **Published**: 2019
- **Authors**: A. Beemer, O. Kosut, J. Kliewer +2
- **PDF**: https://ieeexplore.ieee.org/document/8849581
...
## Gain Division Multiple Access for Transmissions Over Independent Fading Channels

- **Status**: ❌
- **Reason**: 채널 이득 기반 다중접속(GDMA) 기법으로 LDPC ECC와 무관
- **ID**: ieee:8851630
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. -T. Hsu, B. -H. Chang, C. -F. Chang +5
- **PDF**: https://ieeexplore.ieee.org/document/8851630
- **Abstract**: For a multiple access system, the receiver needs to separate the desired signal from the superposition of signals generated by multiple users with user-specific feature. We propose to employ the unique channel gain between each user and the receiver to recover the desired signal, and the proposed technique allows multiple users to share the same feature in multiple access systems.

## P4-Based Hybrid Error Control Booster Providing New Design Tradeoffs in Wireless Networks

- **Status**: ❌
- **Reason**: P4-based network-layer hybrid ARQ/parity booster — no LDPC code/decoder technique.
- **ID**: ieee:9020724
- **Type**: conference
- **Published**: 2019
- **Authors**: A. McAuley, Y. M. Gottlieb, L. Kant +2
- **PDF**: https://ieeexplore.ieee.org/document/9020724
- **Abstract**: Modern, general purpose error control solutions at the link and transport layers provide strong error control, suitable for most applications in most environments. There are, however, known limitations when applied to wireless, mobile and hostile environments, resulting in high latency or low throughput. This paper describes an implementation of a Hybrid Error Control (HEC) Booster that can be dynamically deployed anywhere in the network to support robust communication and provide broad design tradeoffs selectivity per application. It uses the emerging P4 standard to provide very-low latency processing of data packets that require control headers. With long burst losses, testbed results show how a pair of HEC Boosters can support either: a) high reliability and low latency using proactive parity packets, or b) high reliability and high throughput using parsimonious ACKs and incremental parities.
...
- **Status**: ❌
- **Reason**: 레이더+통신 이중용도 파형 알파벳 설계, LDPC 떼어낼 기법 없는 무선 응용 특이적
- **ID**: ieee:8835778
- **Type**: conference
- **Published**: 2019
- **Authors**: I. Weiner
- **PDF**: https://ieeexplore.ieee.org/document/8835778
- **Abstract**: We propose a flexible methodology for the design of dual-use waveform alphabets which are suitable for simultaneous use in radar and wireless communications. Suitability for radar is enforced by one or more freely-specifiable waveform constraints. The resulting alphabets are shown to have a structure amenable to use with existing capacity-approaching coding techniques, enabling a high-throughput communications channel encoded in a waveform-diverse radar pulse train. At moderately high SNRs (5 to 16 dB) we demonstrate simulated throughputs double the closest competitor technique, using waveforms whose average radar pulse compression sidelobes are comparable to an LFM, and radar pulse-compression filter loss of -1 dB.

## Deep Learning Assisted Rate Adaptation in Spatial Modulation Links

- **Status**: ❌
- **Reason**: 공간변조 코딩레이트 선택용 DNN, LDPC 디코더/구성 기여 없음
- **ID**: ieee:8877161
- **Type**: conference
- **Published**: 2019
- **Authors**: A. Tato, C. Mosquera
- **PDF**: https://ieeexplore.ieee.org/document/8877161
- **Abstract**: The adaptation of Spatial Modulation based links to the channel conditions is challenged by the complicated dependence between performance (either error rate metrics or theoretically achievable rates) and the multiple antenna channel description. In this paper a coding rate selection mechanism is presented based on a carefully selected set of channel features and the proper training of a deep neural network, which all together can satisfy a given error rate bound.

## Achievable Rate Region for Iterative Multi-User Detection via Low-cost Gaussian Approximation

- **Status**: ❌
- **Reason**: IDMA 다중사용자 검출 EXIT 차트 이론 — 무선 MUD 특이적, 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:8849621
- **Type**: conference
- **Published**: 2019
- **Authors**: X. Wang, C. Liang, L. Ping +1
- **PDF**: https://ieeexplore.ieee.org/document/8849621
...
- **Status**: ❌
- **Reason**: 차세대 ISDB-T 전송 시스템 개요 — 시스템 설계, 떼어낼 LDPC 기법 없음
- **ID**: ieee:8971915
- **Type**: conference
- **Published**: 2019
- **Authors**: M. Nakamura, A. Sato, H. Miyasaka +8
- **PDF**: https://ieeexplore.ieee.org/document/8971915
- **Abstract**: Japan Broadcasting Corporation (NHK) has been conducting research and development on large-capacity transmission technologies for next-generation digital terrestrial television broadcasting (DTTB) system. In this work, a transmission system inherited Integrated Services Digital Broadcasting-Terrestrial (ISDB-T) has been developed, which can provide both fixed reception service and mobile reception service. The transmission system was developed with the aim of providing 4K/8K UHDTV broadcasting for fixed reception and HDTV broadcasting for mobile reception in one channel (6 MHz bandwidth). This report describes an overview of the transmission system for a next-generation DTTB called the advanced ISDB-T and its basic transmission performance.

## Evaluation of Rotated Constellation in DVB-T2 Based on Measurement Data

- **Status**: ❌
- **Reason**: DVB-T2 회전 성좌 측정 결과, LDPC 디코더/HW/코드설계 기법 없음
- **ID**: ieee:8802572
- **Type**: conference
- **Published**: 2019
- **Authors**: N. Suwansukho, S. Promwong
- **PDF**: https://ieeexplore.ieee.org/document/8802572
- **Abstract**: This paper describes the result of using Rotated Constellation Feature that include Digital Terrestrial Television second generation network in Thailand. The measured results were carried out from 20 measured location, located in Bangkok, Thailand.

## A Coherent Demodulation Method for Short Burst Communication

- **Status**: ❌
- **Reason**: DSSS 코히어런트 복조(SCBFFT); 채널코딩 아닌 물리계층 복조
- **ID**: ieee:8785516
- **Type**: conference
- **Published**: 2019
- **Authors**: C. Wang, F. Gao
- **PDF**: https://ieeexplore.ieee.org/document/8785516
- **Abstract**: Information is an important feature of modern warfare. In the information warfare network, unmanned aerial vehicle (UAV) relay communication has caused research interest in many countries due to its high mobility and low construction cost. In order to meet the requirements of high relative speed, anti-interference and anti-reconnaissance, short burst direct sequence spread spectrum (DSSS) has become a commonly used communication means. The traditional coherent demodulation method needs to feedback the carrier estimation result, and the synchronization time is too long. The successive compensation based fast Fourier transform (SCBFFT) coherent demodulation method proposed in this paper has an open-loop structure. It uses twice FFT operations to estimate and compensate the carrier frequency offset and phase successively, and has the advantage of short carrier synchronization time. The coherent demodulation performance of the method is simulated and tested at low signal to noise ratio (SNR). The results show that the SCBFFT method can achieve coherent demodulation performance close to the theoretical bit error rate (BER) at low SNR.

## Optical Strategies for Economical Next Generation 50 and 100G PON

- **Status**: ❌
- **Reason**: 차세대 PON 광 전략 개요 — LDPC 무관
- **ID**: ieee:8696761
- **Type**: conference
- **Published**: 2019
- **Authors**: V. Houtsma, D. van Veen
- **PDF**: https://ieeexplore.ieee.org/document/8696761
- **Abstract**: An overview of optical strategies for economical next-generation 50 and 100G PON is given.

## 0.715 Pb/s Transmission Over 2,009.6 km in 19-Core Cladding Pumped EDFA Amplified MCF Link

- **Status**: ❌
- **Reason**: 멀티코어 광섬유 전송 데모 — ECC/LDPC 기법 없음
- **ID**: ieee:8696418
- **Type**: conference
- **Published**: 2019
- **Authors**: B. J. Puttnam, G. Rademacher, R. S. Luís +7
- **PDF**: https://ieeexplore.ieee.org/document/8696418
- **Abstract**: We demonstrate 0.715 Pb/s recirculating transmission through 19 cores of 31.4 km MCF amplified with C+L-band, cladding-pumped, multi-core EDFAs; transmitting 345×24.5 GBd PDM-16QAM signals over 2009.6 km for 1.44 Exb/s×km throughput-distance product.

## A Stochastic Wireline Communication System

- **Status**: ❌
- **Reason**: 잡음 통계량 인코딩 stochastic 송수신기 — LDPC ECC와 무관
- **ID**: ieee:8884914
- **Type**: conference
- **Published**: 2019
- **Authors**: T. Anand
- **PDF**: https://ieeexplore.ieee.org/document/8884914
- **Abstract**: This paper proposes a stochastic wireline communication system. In the proposed stochastic system, the information is encoded in the statistical parameter of noise such as standard deviation, and the noise signal is transmitted on the channel. The receiver estimates the standard deviation of the received noise signal and recovers the information. A stochastic receiver architecture, which can differentiate between the noise signals with two different standard deviations is presented. Using mathematical modeling, this paper demonstrates that the proposed stochastic transceiver has a potential to improve the SNR by more than 3dB over a conventional uncoded deterministic transceiver.

## A Study on the TTI Service Delivery via Digital Terrestrial UHD Broadcasting Network

- **Status**: ❌
- **Reason**: UHD 방송 TTI 서비스, LDPC 무관
- **ID**: ieee:8939735
- **Type**: conference
- **Published**: 2019
- **Authors**: K. Yang, B. Lee, S. -I. Park +1
- **PDF**: https://ieeexplore.ieee.org/document/8939735
- **Abstract**: As technology develops, vehicles evolve to support connected car, autonomous driving, etc. In the era of connected car and autonomous driving, traffic and travel information is essential to drivers or cars. To send this information efficiently, it needs to make good use of the merits of the broadcasting. This paper introduces mechanisms to transmit traffic and travel information efficiently using terrestrial UHD broadcasting.

## Enabling Technologies for 5G-Oriented Optical Networks

- **Status**: ❌
- **Reason**: 5G 광 네트워크 기술 리뷰 — LDPC 무관
- **ID**: ieee:8696394
- **Type**: conference
- **Published**: 2019
- **Authors**: X. Liu, N. Deng, M. Zhou +8
- **PDF**: https://ieeexplore.ieee.org/document/8696394
- **Abstract**: We review enabling technologies in optical transport and access networks, such as mobile-optimized-OTN and eCPRI-PON, to better support the upcoming 5G wireless networks with high bandwidth efficiency, low latency, accurate synchronization, and flexible network slicing.

## Coordinate Descent Method for Signal Detection in IDMA

- **Status**: ❌
- **Reason**: IDMA 신호검출용 좌표하강 검출기, LDPC 디코더 아님
- **ID**: ieee:8746371
- **Type**: conference
- **Published**: 2019
- **Authors**: R. He, J. Kang, Y. Xiao +1
- **PDF**: https://ieeexplore.ieee.org/document/8746371
- **Abstract**: In this paper, an efficient coordinate descent method (CDM)-based turbo-type iterative detection algorithm is proposed for uplink interleave division multiple access (IDMA) systems. The simulation results and analysis reveal that the proposed CDM-based detector provides improved bit error rate (BER) performance compared to the conventional elementary signal estimator (ESE) conceived for IDMA systems. Meanwhile, by taking into account both the convergence performance and the computational complexity, we show that the proposed CDM-based detector is also superior to conventional ESE.

## Adaptive Feedback of the Channel Information for Beamforming in IEEE 802.11ax WLANs

- **Status**: ❌
- **Reason**: 802.11ax WLAN 빔포밍 피드백 — LDPC 무관
- **ID**: ieee:8891127
- **Type**: conference
- **Published**: 2019
- **Authors**: E. Jeon, W. B. Lee, M. Ahn +2
- **PDF**: https://ieeexplore.ieee.org/document/8891127
- **Abstract**: In this paper, we propose an adaptive beamforming matrix feedback scheme, which guarantees the best packet error rate (PER) by selecting the beamforming matrix between singular value decomposition (SVD) and geometric mean decomposition (GMD) based beamforming matrices. The physical layer (PHY)-abstraction is utilized for joint PER prediction and modulation and coding scheme (MCS) level selection. In addition, a low complexity GMD is proposed where the iterative GMD process is converted to 2×2 block-wise GMD without iteration. Each 2×2 GMD is further simplified to remove the square-root and division operators for easy hardware implementation. The simulation is performed extensively via a 802.11ax link-level simulator. The results show that the proposed adaptive feedback scheme provides a significant performance gain in comparison to the conventional SVD- or GMD-based beamforming matrix feedback scheme. Also, the proposed GMD has an advantage in both complexity and PER performance when the number receive antenna is more than two.

## Experimental demonstration of eight-dimensional modulation formats for long-haul optical transmission

- **Status**: ❌
- **Reason**: 8차원 변조포맷 광전송 실험 — 변조/도달거리, LDPC ECC 기법 없음
- **ID**: ieee:9125652
- **Type**: conference
- **Published**: 2019
- **Authors**: S. van der Heide, B. Chen, M. van den Hout +4
- **PDF**: https://ieeexplore.ieee.org/document/9125652
- **Abstract**: Two novel 5.5 bit/4D modulation formats are experimentally demonstrated to transmit over 9680 km of SSMF. A reach increase of 29.4% over the 6 bit/4D PM-8QAM is shown. Furthermore, increased nonlinear tolerance with respect to PM-8QAM is shown.

## Mobile Performance of Next Generation Japanese Terrestrial Broadcasting

- **Status**: ❌
- **Reason**: 차세대 일본 지상파 방송 모바일 성능 시뮬레이션 — FDM/FFT 수신, LDPC ECC 기여 없음
- **ID**: ieee:8971910
- **Type**: conference
- **Published**: 2019
- **Authors**: L. Michael, M. Itami
- **PDF**: https://ieeexplore.ieee.org/document/8971910
...
- **Status**: ❌
- **Reason**: Dual-mode OFDM/SC-FDE mmWave radar/5G PHY; no LDPC ECC technique.
- **ID**: ieee:8711709
- **Type**: conference
- **Published**: 2019
- **Authors**: R. Gomes, K. Sobaihi, A. Hammoudeh +1
- **PDF**: https://ieeexplore.ieee.org/document/8711709
- **Abstract**: In this paper we introduce a dual-mode OFDM/SC-FDE 60 GHz millimeter wave (mmWave) Physical (PHY) layer to provide both radar and transmission data rates over 10 Gbps, as known as radar type sensors and wireless communications (Rad-Com). Such feature goes towards one of the vertical requirements for future wireless communications, such as 5G. The system is evaluated and assessed through metrics of BER and required Eb/N0 for a target BER of 10-5, under both residential LOS and NLOS scenarios. In the simulation results, it is demonstrated that SC-FDE is more robust against RF impairments, and does not requires channel coding contrary to OFDM. In addition to this, the fact that it has lower peak-to-average power ratio (PAPR), makes such transmission scheme a very promising alternative to OFDM. For example, employing 256 QAM modulation, it has 6 dB of Eb/N0 gain in comparison with OFDM, under the same conditions.

## Polar Coding for Physical-Layer Security without Knowledge of the Eavesdropper's Channel

- **Status**: ❌
- **Reason**: polar 부호 기반 물리계층 보안, 비-LDPC·보안 원칙 제외
- **ID**: ieee:8746472
- **Type**: conference
- **Published**: 2019
- **Authors**: T. Pinto, M. Gomes, J. P. Vilela +1
- **PDF**: https://ieeexplore.ieee.org/document/8746472
...
- **Status**: ❌
- **Reason**: 5G 링크/시스템 시뮬레이터 검증 도구 소개. LDPC/디코더/HW 이식 기법 없음.
- **ID**: ieee:8651694
- **Type**: conference
- **Published**: 2019
- **Authors**: S. Pratschner, M. K. Müller, F. Ademaj +4
- **PDF**: https://ieeexplore.ieee.org/document/8651694
...
- **Status**: ❌
- **Reason**: 위상잡음용 나선형 성상도 설계 — 변조/성상도, LDPC/디코더 무관
- **ID**: ieee:8885476
- **Type**: conference
- **Published**: 2019
- **Authors**: A. Ugolini, A. Piemontese, T. Eriksson +1
- **PDF**: https://ieeexplore.ieee.org/document/8885476
...
- **Status**: ❌
- **Reason**: 물리계층 보안용 불규칙 QAM/coset 코드, 보안 응용이며 LDPC 디코더 기법 없음
- **ID**: ieee:9013808
- **Type**: conference
- **Published**: 2019
- **Authors**: H. Searle, M. A. C. Gomes, J. P. Vilela +1
- **PDF**: https://ieeexplore.ieee.org/document/9013808
...
## Design of Two-Dimensional Non-uniform Constellations with Better Performance

- **Status**: ❌
- **Reason**: 2D 비균일 성상도(NUC) 설계 — 변조 최적화일 뿐 LDPC ECC 기법 없음
- **ID**: ieee:8971901
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Cai, G. Zhang, Y. Xu +3
- **PDF**: https://ieeexplore.ieee.org/document/8971901
...
- **Status**: ❌
- **Reason**: ATSC 3.0 L1 시그널링 additional parity 성능평가 — 부호 비의존 시스템 레벨, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:8971907
- **Type**: conference
- **Published**: 2019
- **Authors**: S. -K. Ahn, S. -I. Park, J. -y. Lee +3
- **PDF**: https://ieeexplore.ieee.org/document/8971907
...
## Multilevel Redundancy/Replication Schemes for Adaptive Reliability Enhancement of File Systems

- **Status**: ❌
- **Reason**: 파일시스템 replication/redundancy 하이브리드 — 블록 단위 ECC 관리 정책, LDPC 부호·디코더·HW 기여 없음
- **ID**: ieee:9117278
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. -H. Chen, Y. -T. Hsiao, P. -C. Huang
- **PDF**: https://ieeexplore.ieee.org/document/9117278
- **Abstract**: Replication and redundancy are the two most popular approaches to defend against the worsening reliability problems found in modern storage systems. With the replication approach, one or more copies (“replicas”) of each block are created to guarantee that at least one correct copy is available when failures of single blocks occur. On the other hand, with the redundancy approach, various error correction code (ECC) are employed to compute the redundancy information of data, which can later be used to recover the correct data on potential errors. In practice, on most existing designs of block-based file systems, to alleviate the management burdens of variable-size redundancy information in fixed-size blocks, multiple data blocks are often grouped together for redundancy computation, with their redundancy information stored in the same blocks. While the replication approach incurs higher space wastes, the redundancy approach might degrade the performance of random data accesses, because the associated blocks with redundancy information need to be read along with the blocks with user data. Based on this observation, existing proposals intend to classify files according to whether they are more likely to be sequentially or randomly accessed. However, in certain types of files with hybrid contents, e.g., virtual machine images, it is often difficult to clearly identify whether replication or redundancy approach should be applied to the file. In this work, we propose a hybrid approach between replication and redundancy, where different parts of a file can select different approaches, and even the same parts of a file can use both approaches to reduce management overheads. The proposed approach is then verified through a series of evaluation studies, where the results are quite encouraging.

## Efficient LDLC Decoder Design from the Lattice Viewpoint

- **Status**: ❌
- **Reason**: LDLC(저밀도 격자부호) 가우시안 혼합 메시지패싱 디코더, 격자부호 전용이며 바이너리 LDPC BP에 이식 불가
- **ID**: ieee:9013874
- **Type**: conference
- **Published**: 2019
- **Authors**: X. Wang, W. H. Mow
- **PDF**: https://ieeexplore.ieee.org/document/9013874
- **Abstract**: Low density lattice codes (LDLCs) have been shown to approach the AWGN channel capacity and can be decoded by a message passing decoder. The messages passed between check nodes and variable nodes are probability density functions, which are approximated by Gaussian mixtures in existing LDLC decoders. However, in the best-known M-Gaussian decoder, the Gaussian mixtures for approximating variable node messages still contain unnecessary Gaussian components, resulting in exponential decoding complexity in the LDLC degree d. In this paper, an efficient LDLC decoder is proposed from the lattice viewpoint, which only finds out important Gaussian components for approximating the variable node messages. The decoding complexity for the proposed decoder is linear in d. Numerical results show that the proposed decoder can achieve significant complexity saving without degrading the performance compared with the M-Gaussian decoder. In particular, the runtime saving is 75.3% when the code length is 10000 and d is 7.

## A Possibility: Beyond the Channel Capacity in the Low SNR Regime

- **Status**: ❌
- **Reason**: 저SNR 채널용량 초과 병렬전송 이론; LDPC ECC 디코더/코드 기법 없음
- **ID**: ieee:8958036
- **Type**: conference
- **Published**: 2019
- **Authors**: B. Jiao, D. Zheng, M. Yin +1
- **PDF**: https://ieeexplore.ieee.org/document/8958036
- **Abstract**: The paper proposed a method that organizes a parallel transmission of two signals to be separated from each other at receiver through Hamming-to Euclidean space, where the conventional problem of achievable bit rate (ABR) is converted to that of the ABR’s summation with respect to the two separated signals. Actually, the mutual information is separated accordingly into two. Since the mutual information is non-linear function of signal power in general, the separation brings a chance for achieving higher ABR. The proposed work proceeds along the above thinking and achieves higher bit-error-rate (BER) performance in comparison with BPSK as shown in the simulations. Moreover, one can find theoretically beyond of channel capacity of BPSK input.
...
- **Status**: ❌
- **Reason**: VLC용 RLL 코드의 딥러닝 디코딩, LDPC ECC 비의존·이식할 기법 없음
- **ID**: ieee:9026486
- **Type**: conference
- **Published**: 2019
- **Authors**: D. -D. Le, D. -P. Nguyen, T. -H. Tran +1
- **PDF**: https://ieeexplore.ieee.org/document/9026486
- **Abstract**: In visible light communication (VLC) system, flicker mitigation is considered as an essential requirement that can be met by the use of run-length limited (RLL) code. Among researches about RLL code, soft input soft output (SISO) RLL decoding scheme is proved significantly improving the error correction performance of the entire VLC system. However, it suffers from high computational complexity. To overcome this limitation, this paper proposed a deep learning framework that effectively performs the RLL decoding at a VLC receiver. The proposed framework makes use of a one-layer long short term memory (LSTM) followed by a fully-connected layer to learn the input-output relation of RLL decoder. Additionally, we present numerical results to validate the excellent performance of the proposed RLL decoder. The results exhibit that the combination between FEC and DL-based RLL approach is capable of achieving the bit error rate (BER) performance of concatenated FEC and SISO RLL decoder; while substantially reducing computational complexity.

## Performance Analysis of Relay based Molecular Communication with Depleted Molecule Shift Keying

- **Status**: ❌
- **Reason**: 분자통신 D-MoSK 코딩/릴레이 BER 분석, LDPC 무관 — 떼어낼 ECC 기법 없음
- **ID**: ieee:8904359
- **Type**: conference
- **Published**: 2019
- **Authors**: J. Wang, M. Peng, Y. Liu
- **PDF**: https://ieeexplore.ieee.org/document/8904359
- **Abstract**: Molecular communication (MC) is a new communication engineering paradigm where molecules are employed as information carriers. MC via diffusion is the most promising approach for the communication between nanomachines. Intersymbol interference (ISI) caused by the Brownian motion of diffusion molecules will seriously affected the reliability of communication. Meanwhile, with the increase of communication distance, the signal attenuation is serious, which leads to the decline of communication quality. In this paper, a decode-and-forward (DF) relay in diffusion-based molecular communication systems is proposed to improve communication quality, in which the depleted molecule shift keying (D-MoSK) coding is used to reduce ISI. The channel performance including the BER and capacity is analyzed. Meanwhile, the relationship among BER, capacity, and the key parameters, including the number of the released molecules, receiving radius, and relay position, is investigated. The simulation experiments show that the proposal D-MoSK coding can improve the communication reliability significantly, in which the performance gain can be maximized through optimizing the position of relay and the receiving radius.

## Spatial Modulation Link Adaptation: a Deep Learning Approach

- **Status**: ❌
- **Reason**: Spatial Modulation MCS 선택 딥러닝, LDPC 디코더/구성 이식 기법 없음
- **ID**: ieee:9048866
- **Type**: conference
- **Published**: 2019
- **Authors**: A. Tato, C. Mosquera
- **PDF**: https://ieeexplore.ieee.org/document/9048866
- **Abstract**: Spatial Modulation (SM) offers a good balance between energy and spectral efficiency of interest for next generation networks. This, together with the need for only one Radio Frequency (RF) chain, makes SM a good proposal for Internet of Things (IoT) devices. In this work, we present a method based on Deep Learning to select the optimum Modulation and Coding Scheme (MCS) in an adaptive SM system. The deep neural network is trained with supervised learning to perform a mapping between the channel conditions and the MCS from a given set. We provide simulations results for a 4 × 4 SM link which uses several coding rates and three different constellations: QPSK, 8PSK and 16QAM. Results show how the adaptive system has a throughput close to its maximum value and how the outage probability can be reduced easily by applying a back-off margin to the neural network output.

## Hybrid BP-EP Based Iterative Receiver for Faster-Than-Nyquist with Index Modulation

- **Status**: ❌
- **Reason**: FTN-IM용 BP-EP 하이브리드 수신기로 AR 잡음·EP 가우시안 근사가 FTN 응용에 특이적, 바이너리 LDPC BP로 떼어낼 기법 불분명
- **ID**: ieee:8891399
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Ma, N. Wu, W. Yuan +1
- **PDF**: https://ieeexplore.ieee.org/document/8891399
...
- **Status**: ❌
- **Reason**: IDMA NOMA 시스템레벨 성능평가, 떼어낼 ECC 기법 없음
- **ID**: ieee:8756860
- **Type**: conference
- **Published**: 2019
- **Authors**: L. Canonne-Velasquez, A. Haghighat, P. Herath
- **PDF**: https://ieeexplore.ieee.org/document/8756860
...
- **Status**: ❌
- **Reason**: Product/staircase code decoder (non-LDPC); soft-assist is code-specific, no portable binary-LDPC BP technique.
- **ID**: ieee:8696816
- **Type**: conference
- **Published**: 2019
- **Authors**: C. Fougstedt, A. Sheikh, A. G. i Amat +2
- **PDF**: https://ieeexplore.ieee.org/document/8696816
- **Abstract**: We implement a 1-Tb/s 0.63-pJ/bit soft-assisted product decoder in a 28-nm technology. The decoder uses one bit of soft information to improve its net coding gain by 0.2 dB, reaching 10.3-10.4 dB, which is similar to that of more complex hard-decision staircase decoders.

## Generation of Efficient Self-adaptive Hardware Polar Decoders Using High-Level Synthesis

- **Status**: ❌
- **Reason**: HLS-generated polar SC decoder HW — non-LDPC, methodology is polar-specific, no portable LDPC architecture contribution.
- **ID**: ieee:9020441
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Delomier, B. L. Gal, J. Crenne +1
- **PDF**: https://ieeexplore.ieee.org/document/9020441
...
- **Status**: ❌
- **Reason**: mmWave 디지털 베이스밴드 트랜시버 칩, LDPC 디코더/구성 이식 기법 없음
- **ID**: ieee:9056920
- **Type**: conference
- **Published**: 2019
- **Authors**: K. -L. Chiu, H. -W. Chan, W. -C. Lee +12
- **PDF**: https://ieeexplore.ieee.org/document/9056920
...
- **Status**: ❌
- **Reason**: MIMO 지상파 TV 방송 필드 시험; 떼어낼 ECC/디코더 기법 없음
- **ID**: ieee:8802035
- **Type**: conference
- **Published**: 2019
- **Authors**: T. Shitomi, A. Sato, N. Shirai +9
- **PDF**: https://ieeexplore.ieee.org/document/8802035
- **Abstract**: The transmission performance of open-loop spatial multiplexing cross-polarized MIMO is being studied to determine how to increase the capacity of terrestrial broadcasting and make it more robust. The authors evaluated the performance by largescale field experiments in central Tokyo in two scenarios. Results showed that when the transmission capacity is increased by MIMO using transmission parameters with the same robustness as SISO, although the degradation in the required received power from the laboratory tests is increased by about 0.5 dB, the transmission capacity can be doubled. We confirmed that the required received power can be improved by 9.1 dB when MIMO is introduced to enhance transmission robustness, i.e., maintaining the same transmission capacity as SISO. The field trials were performed using a transmission system for nextgeneration terrestrial broadcasting being studied in Japan, but it also shows promise for wireless communication systems that introduce MIMO into the HPHT network using the UHF band in urban areas.

## MSK Carrier Synchronization Scheme Based on Demodulation Soft Information Aided

- **Status**: ❌
- **Reason**: MSK 반송파 동기화 기법 — 채널코딩 ECC 아님, LDPC 무관
- **ID**: ieee:8982587
- **Type**: conference
- **Published**: 2019
- **Authors**: Y. Qiu, X. He
- **PDF**: https://ieeexplore.ieee.org/document/8982587
- **Abstract**: The existing carrier synchronization algorithms for MSK signals suffer from the disadvantages of low estimation accuracy and difficult implementation under the condition of low signal-to-noise ratio (SNR). To address the problems, the paper proposes a novel carrier synchronization scheme based on demodulation soft information aided. The joint iteration of the synchronizer and demodulator aims to maximize the objective function, the mean square value of demodulation soft information. In the two-dimensional search of carrier frequency and phase offset, the scheme realizes carrier synchronization of near maximum likelihood estimation. It is shown, via analyses and simulations, that its bit error rate (BER) performance approaches the theoretical bound. This scheme is an effective solution for MSK short-time burst transmission systems at the expense of low complexity.
...
## An Effective Data Hiding Mechanism Based on Encrypted Images

- **Status**: ❌
- **Reason**: 암호화 이미지 데이터 은닉(보안/스테가노그래피) — 채널 ECC 무관, 제외
- **ID**: ieee:9170232
- **Type**: conference
- **Published**: 2019
- **Authors**: A. K. Shahade, P. V. Deshmukh, A. S. Kapse +1
- **PDF**: https://ieeexplore.ieee.org/document/9170232
- **Abstract**: Now a day’s to stay up secrecy associated confidentiality of an data can be a vibrant field with two completely different approaches being followed, the first being encrypting the images through cryptography algorithms victimization keys, the other approach involves concealing information victimization information concealing algorithmic rule to stay up the images secrecy. A content owner use cryptography key to perform the cryptography of original footage, and using a data concealing key an information hider can plant any data into the encrypted image though he does not acknowledge the primary content, as a result of the encrypted image contains some any data, with the help of cryptography key a receiver first decipher it then extract the embedded data and recover the primary image in line with the data-hiding key.

## The Use of Mini Computer in Hybrid FSO/RF System

- **Status**: ❌
- **Reason**: 하이브리드 FSO/RF 모니터링 장비·날씨예측 — 부호화 무관
- **ID**: ieee:9119270
- **Type**: conference
- **Published**: 2019
- **Authors**: R. Haluška, L. Ovseník, P. Šul’aj
- **PDF**: https://ieeexplore.ieee.org/document/9119270
- **Abstract**: This article discusses the problem of optical communication with Free Space Optics (FSO), its use, and the conditions that affect it. This document deals with the practical design and construction of the monitoring equipment. Such a device is designed to collect and process data characterizing the nature of the conditions along the transmission path. Because of the vulnerability of the FSO transmission channel to weather conditions, it is necessary to predict the weather and so switch to a backup line using machine learning method called decision tree.

## Record-Sensitivity Receiver at 1 Photon/Bit for Free-Space Applications

- **Status**: ❌
- **Reason**: 광수신기 감도(phase-sensitive 증폭/펌프복원) — 부호화·디코더·HW 기여 없음, NAND LDPC에 떼어낼 기법 없음
- **ID**: ieee:8989435
- **Type**: conference
- **Published**: 2019
- **Authors**: J. Schrder, R. Kakarla, P. A. Andrekson
- **PDF**: https://ieeexplore.ieee.org/document/8989435
- **Abstract**: We demonstrate 1 photon-per-bit receiver sensitivity at 10.52 Gb/s enabled by a low-noise phase-sensitive pre-amplifier in combination with injection-locking-based pump recovery operating at sub nano-Watt powers

## Channel Decoding with Quantum Approximate Optimization Algorithm

- **Status**: ❌
- **Reason**: QAOA 양자 알고리즘으로 quasi-ML 디코딩 — Hamming 부호 대상, 양자 디바이스 의존이라 고전 바이너리 LDPC 디코더로 이식 불가
- **ID**: ieee:8849710
- **Type**: conference
- **Published**: 2019
- **Authors**: T. Matsumine, T. Koike-Akino, Y. Wang
- **PDF**: https://ieeexplore.ieee.org/document/8849710
...
- **Status**: ❌
- **Reason**: 소스코드+제약난수생성기로 채널코드 구성 — 순수 이론적 코딩, 떼어낼 LDPC 디코더/HW/구성 기법 없음
- **ID**: ieee:8510848
- **Type**: journal
- **Published**: 2019
- **Authors**: J. Muramatsu, S. Miyake
- **PDF**: https://ieeexplore.ieee.org/document/8510848
...
- **Status**: ❌
- **Reason**: Polar+chaotic 물리계층 암호화/PAPR 저감, 부호 비의존 LDPC 이식 기법 없음
- **ID**: ieee:8723465
- **Type**: journal
- **Published**: 2019
- **Authors**: X. Lu, Y. Shi, W. Li +2
- **PDF**: https://ieeexplore.ieee.org/document/8723465
...
- **Status**: ❌
- **Reason**: HbbTV/DVB 파일전달 erasure 코딩 전략 분석; LDPC 디코더/HW 기법 없음
- **ID**: ieee:8615993
- **Type**: journal
- **Published**: 2019
- **Authors**: F. Mattoussi, M. Crussière, J. -F. Hélard +1
- **PDF**: https://ieeexplore.ieee.org/document/8615993
...
- **Status**: ❌
- **Reason**: Locally recoverable codes(LRC) bounds/constructions via rank-metric/expander — 비-LDPC 부호 이론, NAND LDPC BP에 이식할 디코더/HW/코드설계 기법 없음
- **ID**: ieee:8635485
- **Type**: journal
- **Published**: 2019
- **Authors**: S. Kruglik, K. Nazirkhanova, A. Frolov
- **PDF**: https://ieeexplore.ieee.org/document/8635485
...
- **Status**: ❌
- **Reason**: Polar 코드 cell search용 다중블록 결합 디코딩, LDPC BP로 이식되는 부호 비의존 기법 아님
- **ID**: ieee:8723486
- **Type**: journal
- **Published**: 2019
- **Authors**: X. Wang, C. Cao, C. Sun +2
- **PDF**: https://ieeexplore.ieee.org/document/8723486
...
- **Status**: ❌
- **Reason**: Polar BP 디코더 복잡도 감소(CRC+GA 임계값) — polar 전용, 바이너리 LDPC BP 이식성 불명확하나 polar 비-LDPC라 제외
- **ID**: ieee:8688403
- **Type**: journal
- **Published**: 2019
- **Authors**: C. Sun, Z. Fei, C. Cao +2
- **PDF**: https://ieeexplore.ieee.org/document/8688403
...
- **Status**: ❌
- **Reason**: Low Density Lattice Codes 디코더 — 격자부호용 가우시안 BP, 바이너리 LDPC가 아니며 이진 BP로 직접 이식 불가
- **ID**: ieee:8692424
- **Type**: journal
- **Published**: 2019
- **Authors**: S. Liu, Y. Hong, E. Viterbo +2
- **PDF**: https://ieeexplore.ieee.org/document/8692424
...
- **Status**: ❌
- **Reason**: 무선 파노라마 비디오 UEP/FEC 응용, LDPC 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:8733786
- **Type**: journal
- **Published**: 2019
- **Authors**: Y. Huo, X. Wang, P. Zhang +2
- **PDF**: https://ieeexplore.ieee.org/document/8733786
...
- **Status**: ❌
- **Reason**: 무선 PNC QAM 매핑 선택 알고리즘 — LDPC ECC와 무관, 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:8481462
- **Type**: journal
- **Published**: 2019
- **Authors**: T. Peng, Y. Wang, A. Burr +1
- **PDF**: https://ieeexplore.ieee.org/document/8481462
...
- **Status**: ❌
- **Reason**: polar 부호 전용 SC-Fano 순차 디코딩, 부호 비의존적 BP 이식성 없음
- **ID**: ieee:8742591
- **Type**: journal
- **Published**: 2019
- **Authors**: M. -O. Jeong, S. -N. Hong
- **PDF**: https://ieeexplore.ieee.org/document/8742591
...
- **Status**: ❌
- **Reason**: 확률적 성형(enumerative sphere shaping) 광통신 기법으로 채널 LDPC ECC 아님
- **ID**: ieee:8850066
- **Type**: journal
- **Published**: 2019
- **Authors**: A. Amari, S. Goossens, Y. C. Gültekin +6
- **PDF**: https://ieeexplore.ieee.org/document/8850066
...
- **Status**: ❌
- **Reason**: MIMO-SCMA 검출용 Gaussian-approximated MPA — 무선 SCMA 응용 특이적 factor graph 검출기, 바이너리 LDPC BP 이식 기법 아님
- **ID**: ieee:8637828
- **Type**: journal
- **Published**: 2019
- **Authors**: J. Dai, K. Niu, J. Lin
- **PDF**: https://ieeexplore.ieee.org/document/8637828
...
- **Status**: ❌
- **Reason**: Massive MIMO MMSE 소프트 검출/디코딩, 무선 응용 특이적이며 LDPC 비의존, NAND 이식 기법 없음
- **ID**: ieee:8588981
- **Type**: journal
- **Published**: 2019
- **Authors**: M. Zhang, S. Kim
- **PDF**: https://ieeexplore.ieee.org/document/8588981
...
- **Status**: ❌
- **Reason**: ATSC 3.0 LDM 멀티플렉싱 구현/메모리 — 방송 시스템 응용, 떼어낼 LDPC 디코더/HW 기법 없음
- **ID**: ieee:8651484
- **Type**: journal
- **Published**: 2019
- **Authors**: J. -Y. Lee, S. -I. Park, S. Kwon +5
- **PDF**: https://ieeexplore.ieee.org/document/8651484
...
- **Status**: ❌
- **Reason**: NOMA 확률적 셰이핑 + MAP/SIC 검출 — LDPC 무관, 이식 가능 ECC 기법 없음
- **ID**: ieee:8864104
- **Type**: journal
- **Published**: 2019
- **Authors**: K. Xiao, B. Xia, L. Ma +1
- **PDF**: https://ieeexplore.ieee.org/document/8864104
...
- **Status**: ❌
- **Reason**: Massive MIMO 채널추정(압축센싱 기반 LMMSE). ECC/LDPC 무관, 떼어낼 디코더 기법 없음.
- **ID**: ieee:8653372
- **Type**: journal
- **Published**: 2019
- **Authors**: L. Ge, Y. Zhang, G. Chen +1
- **PDF**: https://ieeexplore.ieee.org/document/8653372
...
- **Status**: ❌
- **Reason**: coded slotted ALOHA+zigzag SIC 디코더 — 다중접속/충돌해소, LDPC 채널 ECC 기법 아님
- **ID**: ieee:8906098
- **Type**: journal
- **Published**: 2019
- **Authors**: M. Oinaga, S. Ogata, K. Ishibashi
- **PDF**: https://ieeexplore.ieee.org/document/8906098
...
- **Status**: ❌
- **Reason**: 2D-NUC demapper, LDPC와 무관한 변조/디매핑 기법 — 무선 응용 특이적
- **ID**: ieee:8314552
- **Type**: journal
- **Published**: 2019
- **Authors**: J. Barrueco, J. Montalban, P. Angueira +2
- **PDF**: https://ieeexplore.ieee.org/document/8314552
...
- **Status**: ❌
- **Reason**: 테라헤르츠 무선 RS코드 데이터링크 프로세서, LDPC를 면적 비교 대상으로만 언급, 이식 ECC 기법 없음
- **ID**: ieee:8685101
- **Type**: journal
- **Published**: 2019
- **Authors**: L. Lopacinski, M. Marinkovic, G. Panic +4
- **PDF**: https://ieeexplore.ieee.org/document/8685101
...
- **Status**: ❌
- **Reason**: 시간영역 컴퓨팅 이미지인식 프로세서 — ECC/LDPC 무관
- **ID**: ieee:8581434
- **Type**: journal
- **Published**: 2019
- **Authors**: Z. Chen, J. Gu
- **PDF**: https://ieeexplore.ieee.org/document/8581434
...
- **Status**: ❌
- **Reason**: 인덱스 변조 신호검출용 AMP 검출기 — 채널 부호 디코더가 아닌 MIMO/OFDM 신호검출, LDPC BP로 이식할 ECC 기법 없음
- **ID**: ieee:8526314
- **Type**: journal
- **Published**: 2019
- **Authors**: L. Wei, J. Zheng, Q. Liu
- **PDF**: https://ieeexplore.ieee.org/document/8526314
- **Abstract**: In this correspondence paper, we study the application of approximate message passing (AMP) algorithm in the signal detection of index modulation (IM) with multiple active resources (antennas or subcarriers). First, for uplink generalized spatial modulation (GSM), AMP detectors in both spatially uncorrelated and correlated channels are proposed. Specifically, an effective method to utilize the activation pattern constraint of GSM signal vector per user in the posterior probability computation of scalar symbol node is derived. Furthermore, a simple while effective damping strategy is introduced in AMP detector to guarantee convergence in correlated channels. Second, for orthogonal frequency division multiplexing with IM in rapidly time-varying channels, the damped AMP detector is further studied. In addition, the convergence of proposed detectors is analyzed by state evolution. Finally, the effectiveness of proposed AMP detectors is verified by simulations.

## Numerical Investigation of Long-Haul Coherent Optical Generalized Frequency Division Multiplexing Signal

- **Status**: ❌
- **Reason**: GFDM 광통신 신호 성능 분석(Volterra 등화), LDPC ECC와 무관
- **ID**: ieee:8728039
- **Type**: journal
- **Published**: 2019
- **Authors**: O. Gharbi, S. Mhatli, K. Aissaoui +2
- **PDF**: https://ieeexplore.ieee.org/document/8728039
...
- **Status**: ❌
- **Reason**: 400G 광전송 변조포맷·DSP, LDPC 무관
- **ID**: ieee:8784236
- **Type**: journal
- **Published**: 15 Oct.15,
- **Authors**: Miao Kong, Xinying Li, Jiao Zhang +4
- **PDF**: https://ieeexplore.ieee.org/document/8784236
...
- **Status**: ❌
- **Reason**: 광통신 확률적 성형(PCS)·FEC 정보율 분석 — LDPC는 베이스라인, 떼어낼 ECC 디코더/구성 기법 없음
- **ID**: ieee:8640810
- **Type**: journal
- **Published**: 15 March15
- **Authors**: Junho Cho, Peter J. Winzer
- **PDF**: https://ieeexplore.ieee.org/document/8640810
...
- **Status**: ❌
- **Reason**: PAM-4 버스트모드 TIA(아날로그 수신기), LDPC는 FEC threshold 부수 언급뿐
- **ID**: ieee:8704297
- **Type**: journal
- **Published**: 15 June15,
- **Authors**: Gertjan Coudyzer, Peter Ossieur, Laurens Breyne +3
- **PDF**: https://ieeexplore.ieee.org/document/8704297
- **Abstract**: This letter presents a linear burst-mode transimpedance amplifier (LBMTIA) capable of receiving 50 Gbit/s 4-level pulse amplitude modulation (PAM-4), targeting upstream transmission in high-rate time division multiplexed passive optical networks (TDM-PONs). Using a digitally controlled high-speed datapath, where offset- and gain are corrected using a fast lookup from on-chip stored settings, the receiver achieves a settling time of 48 ns and has an input dynamic range of at least 17.7 dB for 25 Gbit/s non-return-to-zero (NRZ) and 10.9 dB for 50 Gbit/s PAM-4 at the low-density-parity-check (LDPC) forward-error-control (FEC) threshold of $1\times 10^{-2}$ (as now standardized for 25 and 50G TDM-PONs). The LBMTIA is fabricated in the 0.25 um SiGe:C BiCMOS-technology from NXP and consumes 375 mW.
...
- **Status**: ❌
- **Reason**: 광통신 4D 변조포맷 설계, LDPC는 성능확인용 부수 언급
- **ID**: ieee:8718568
- **Type**: journal
- **Published**: 15 July15,
- **Authors**: Bin Chen, Chigo Okonkwo, Hartmut Hafermann +1
- **PDF**: https://ieeexplore.ieee.org/document/8718568
...
- **Status**: ❌
- **Reason**: PS-FEC 튜토리얼, 신규 LDPC 디코더·코드·HW 기여 없음
- **ID**: ieee:8627924
- **Type**: journal
- **Published**: 15 Jan.15,
- **Authors**: Georg Böcherer, Patrick Schulte, Fabian Steiner
- **PDF**: https://ieeexplore.ieee.org/document/8627924
...
- **Status**: ❌
- **Reason**: few-mode fiber 고용량 전송 실험, LDPC 무관
- **ID**: ieee:8465979
- **Type**: journal
- **Published**: 15 Jan.15,
- **Authors**: Georg Rademacher, Ruben S. Luís, Benjamin J. Puttnam +8
- **PDF**: https://ieeexplore.ieee.org/document/8465979
...
- **Status**: ❌
- **Reason**: 광 코히어런트/직접검출 필드복원 DSP, LDPC ECC 무관
- **ID**: ieee:8520786
- **Type**: journal
- **Published**: 15 Jan.15,
- **Authors**: Di Che, Chuanbowen Sun, William Shieh
- **PDF**: https://ieeexplore.ieee.org/document/8520786
...
- **Status**: ❌
- **Reason**: distribution matching/shaping 기법, 이식할 LDPC 디코더·구성 없음
- **ID**: ieee:8579183
- **Type**: journal
- **Published**: 15 Jan.15,
- **Authors**: David S. Millar, Tobias Fehenberger, Toshiaki Koike-Akino +2
- **PDF**: https://ieeexplore.ieee.org/document/8579183
- **Abstract**: In this paper, we review the concept of multiset-partition-based distribution matching. We then characterize performance over short block lengths of 20, 40, and 80 symbols, and with 16QAM, 64QAM, and 256QAM modulation formats. We note that a 40 symbol distribution matcher length can obtain better than uniform performance, while an 80 symbol distribution matcher can utilize most of the available gain over a wide range of signal-to-noise ratios.

## Visible Laser Light Communication Based on LDPC-Coded Multi-Band CAP and Adaptive Modulation

- **Status**: ❌
- **Reason**: VLLC 응용에서 LDPC는 베이스라인, 떼어낼 ECC 기법 없음
- **ID**: ieee:8590760
- **Type**: journal
- **Published**: 15 Feb.15,
- **Authors**: Jing He, Zhiqi Li, Jing He +1
- **PDF**: https://ieeexplore.ieee.org/document/8590760
- **Abstract**: In this paper, a multi-band carrierless amplitude and phase (CAP) modulation format based on a low-density parity-check (LDPC) code and an adaptive modulation is experimentally demonstrated in visible laser light communication (VLLC) for the first time. To achieve high spectral efficiency (SE) of the VLLC system, the effects of the LDPC code and adaptive modulation for the VLLC system are investigated. In addition, the relationship between SE and subcarrier m, where m = {1, 2, 4} with a total bandwidth of 862.5 MHz, is analyzed. The experimental results show that the optimal tradeoff between SE and bit error ratio (BER) performance is 64/64/64/16-quadrature amplitude modulation for 4-CAP system, with SE (net bit rate) of 3.56 b/s/Hz (3.08 Gb/s) under the BER of 10−3.

## System Design for High-Capacity Unrepeatered Optical Transmission

- **Status**: ❌
- **Reason**: 무중계 광전송 시스템 설계, LDPC 기법 없음
- **ID**: ieee:8603807
- **Type**: journal
- **Published**: 15 Feb.15,
- **Authors**: João Carlos Soriano Sampaio Januário, Andrea Chiuchiarelli, Sandro M. Rossi +5
- **PDF**: https://ieeexplore.ieee.org/document/8603807
...
- **Status**: ❌
- **Reason**: mmWave few-bit ADC 결합 채널추정/디코딩 bilinear AMP, LDPC ECC 기법 아님
- **ID**: ieee:8586889
- **Type**: journal
- **Published**: 15 Feb.15,
- **Authors**: Peng Sun, Zhongyong Wang, Robert W. Heather +1
- **PDF**: https://ieeexplore.ieee.org/document/8586889
...
- **Status**: ❌
- **Reason**: PS-OFDM precoding IM-DD, LDPC는 채널코딩 베이스라인일 뿐
- **ID**: ieee:8862901
- **Type**: journal
- **Published**: 15 Dec.15,
- **Authors**: Jie Ma, Ming Chen, Kaiquan Wu +1
- **PDF**: https://ieeexplore.ieee.org/document/8862901
...
## A Study on LDM-BST-OFDM Using Extended Parity in Enhanced Layer of LDM for Fixed Reception

- **Status**: ❌
- **Reason**: LDM-BST-OFDM 확장 패리티 — DTTB 방송 응용 특이적, LDPC는 베이스라인, 떼어낼 디코더/구성 기법 없음
- **ID**: ieee:8662109
- **Type**: conference
- **Published**: 11-13 Jan.
- **Authors**: Hiroto YAMAMOTO, Akira NAKAMURA, Makoto ITAMI
- **PDF**: https://ieeexplore.ieee.org/document/8662109
...
- **Status**: ❌
- **Reason**: 광통신 NLIN 완화 위한 turbo equalization+Kalman smoother; 채널 등화 기법, 바이너리 LDPC BP 이식성 없음
- **ID**: ieee:8624343
- **Type**: journal
- **Published**: 1 May1, 20
- **Authors**: Ori Golani, Meir Feder, Mark Shtaif
- **PDF**: https://ieeexplore.ieee.org/document/8624343
...
- **Status**: ❌
- **Reason**: 광섬유 144QAM 전송 응용, 떼어낼 LDPC 디코더/코드설계 기법 없음
- **ID**: ieee:8430517
- **Type**: journal
- **Published**: 1 Jan.1, 2
- **Authors**: Ezra Ip, Yue-Kai Huang, Shaoliang Zhang +7
- **PDF**: https://ieeexplore.ieee.org/document/8430517
...
- **Status**: ❌
- **Reason**: 유연 광 트랜시버 변조기법 튜토리얼/서베이, LDPC 부수 언급
- **ID**: ieee:8572766
- **Type**: journal
- **Published**: 1 Jan.1, 2
- **Authors**: Gabriella Bosco
- **PDF**: https://ieeexplore.ieee.org/document/8572766
...
## Corrections to “Low-Complexity Concatenated LDPC-Staircase Codes” [Jun 18 2443-2449]

- **Status**: ❌
- **Reason**: 기존 논문 정오표(minor error correction), 기술 기여 없음
- **ID**: ieee:8528352
- **Type**: journal
- **Published**: 1 Feb.1, 2
- **Authors**: Masoud Barakatain, Frank R. Kschischang
- **PDF**: https://ieeexplore.ieee.org/document/8528352
- **Abstract**: We correct a minor error in the original paper.

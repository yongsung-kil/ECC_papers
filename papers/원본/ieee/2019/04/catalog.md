...
- **Status**: ❌
- **Reason**: LDPC-OFDM 전력/자원할당 무선 응용 — LDPC는 부수, 떼어낼 ECC 기법 없음
- **ID**: ieee:8587191
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 비이진(NB) LDPC 코드 최적화(WCM/GAST) — non-binary LDPC는 제외 대상(바이너리만 포함)
- **ID**: ieee:8466851
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: SCMA 코드북 UEP 설계(LDPC 인지) — 무선 다중접속 응용, 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:8637721
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: signal codes(RASC) + EMS는 비이진 신호코드용 디코더, BCJR 기반 — 바이너리 LDPC BP 비의존 이식 기법 아님
- **ID**: ieee:8584892
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 광통신 GFDM에 LDPC를 베이스라인으로 적용, 떼어낼 신규 디코더·구성 없음(무선/통신 부수 언급)
- **ID**: ieee:8657778
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 분포정합(distribution matching)/shell mapping 확률성형 — 소스/성형 기법, 채널 ECC 디코더 아님
- **ID**: ieee:8599055
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: Massive MIMO 신호검출 Newton 반복 행렬역변환 가속, LDPC와 무관하고 떼어낼 ECC 기법 없음
- **ID**: ieee:8638827
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: IDMA 다중접속 + 전달함수 정합(SCM/전력제어) — 무선 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:8494711
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 항공통신 하이브리드 듀플렉스 outage·diversity 분석, LDPC 무관
- **ID**: ieee:8663632
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 순환시프트 선형 네트워크코딩 — LDPC ECC 아님, 이식 기법 없음
- **ID**: ieee:8594637
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: erasure 채널 HARQ 증분잉여 블록크기 최적화 — 떼어낼 LDPC 디코더/HW/구성 기법 없음
- **ID**: ieee:8586906
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 결합 정보전송 변조 + 윈도우 디코딩 간섭제거(다중접속) — 통신 변조/IC 기법, 떼어낼 LDPC ECC 디코더 없음
- **ID**: ieee:8525313
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: LT(fountain) 코드용 가우스소거 기반 디코더 — fountain/erasure 베이스라인, LDPC BP 이식 기법 아님
- **ID**: ieee:8520872
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 비이진(NB-LDPC) GF(q) 패리티검사 계수 최적화 — 바이너리 LDPC 아님, 기준상 제외
- **ID**: ieee:8536465
- **Type**: journal
- **Published**: April 2019
...
- **Status**: ❌
- **Reason**: 5G uplink SCMA/NOMA 응용 특이적, LDPC는 부수 채널코딩이고 2-level 파이프라인 외 떼어낼 일반 LDPC 디코더 기법 없음
- **ID**: ieee:8798862
- **Type**: conference
- **Published**: 8-10 April
...
- **Status**: ❌
- **Reason**: 표준 BF/log/prob domain SPA 비교만, 신규 디코더 기여 없음(교과서 수준)
- **ID**: ieee:9019379
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 위성-지상 RF/FSO 무선 응용 BER 분석, LDPC는 베이스라인 부수 언급, 떼어낼 디코더/구성 기법 없음
- **ID**: ieee:8770187
- **Type**: conference
...
- **Status**: ❌
- **Reason**: DVB-S2X 위성 시스템 Matlab/Simulink 비교설계(RO factor, APSK 변조)만, LDPC 떼어낼 기법 없음
- **ID**: ieee:8727700
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 인지무선 광대역 스펙트럼 센싱 서베이, LDPC는 부수 언급(신뢰 전송용)일 뿐 떼어낼 기법 없음
- **ID**: ieee:8741455
- **Type**: conference
- **Published**: 25-26 Apri
...
- **Status**: ❌
- **Reason**: IWSN 코딩기법 비교+에러율 기반 HARQ, LDPC는 후보 비교 수준이고 떼어낼 신규 디코더/구성 기법 없음
- **ID**: ieee:8734232
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Eisenstein 격자 multilevel coding(MIMO 변조), LDPC는 시뮬레이션 부수 언급일 뿐 떼어낼 디코더/구성 기법 없음
- **ID**: ieee:8727219
- **Type**: conference
- **Published**: 24-26 Apri
...
- **Status**: ❌
- **Reason**: 비-LDPC AMP 기반 joint activity detection/decoding(CDMA 다중사용자 검출), 바이너리 LDPC BP에 떼어낼 ECC 기법 없음
- **ID**: ieee:8727194
- **Type**: conference
- **Published**: 24-26 Apri
...
- **Status**: ❌
- **Reason**: D2D 협력 릴레이 간섭회피 기법, LDPC 부호화 ECC 기법 없음
- **ID**: ieee:8734671
- **Type**: conference
- **Published**: 16-18 Apri
...
- **Status**: ❌
- **Reason**: IRSA 랜덤액세스, density evolution 표준 사용뿐 이식할 디코더 없음
- **ID**: ieee:8885472
- **Type**: conference
- **Published**: 15-18 Apri
...
- **Status**: ❌
- **Reason**: polar 기반 product code, 비-LDPC이고 polar 전용 디코딩
- **ID**: ieee:8886100
- **Type**: conference
- **Published**: 15-18 Apri
...
- **Status**: ❌
- **Reason**: RLNC 네트워크 코딩, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:8885446
- **Type**: conference
- **Published**: 15-18 Apri

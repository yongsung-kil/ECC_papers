...
- **Status**: ✅
- **Reason**: 3D TLC NAND 플래시 LDPC 경판정 디코딩 read latency 감소 기법(AWLD/OWLLD/OPLLD) — NAND 직접(A)
- **ID**: ieee:10681227
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: MIMO FSO-RF 응용 특이적 인터리버·rate-compatible PLDPC 설계로 UEP·FSO/RF 링크 특성에 의존, NAND 이식성 낮음
- **ID**: ieee:10538442
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ✅
- **Reason**: LDPC-CC 디코더의 이종 데이터포맷 PE·재구성 가능 아키텍처로 저장공간 축소·datapath 커스터마이즈 — 이식 가능 디코더 HW 기법(D)
- **ID**: ieee:10633815
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: GAMP/GVAMP 수신기 정보이론 분석이 핵심이고 LDPC는 양자화/클리핑 GLS용 코드 설계 예시로 부수 언급, NAND에 이식할 새 디코더·구성 기법 없음
- **ID**: ieee:10511067
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: 상관 잡음 억제용 FCDAE 디노이저가 핵심, LDPC와는 결합만 함, 떼어낼 디코더·코드설계 기법 없음
- **ID**: ieee:10533442
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: DeepJSCC 소스-채널 결합 이미지 전송, LDPC ECC 기법 없음(분리방식 베이스라인 비교만)
- **ID**: ieee:10597355
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: 삽입/삭제 채널 마커코드 딥러닝 검출 — LDPC 아니고 동기오류 채널 전용, NAND LDPC 이식성 없음
- **ID**: ieee:10509546
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: 계층적 QAM 기반 다운링크 다중접속 변조/수신기 설계, LDPC 무관
- **ID**: ieee:10517911
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: IBFD 자기간섭 제거/채널추정 SIC 기법, LDPC ECC와 무관 — 떼어낼 디코더/코드설계 없음
- **ID**: ieee:10748583
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: 심볼레벨 프리코딩 MISO용 비가우시안 소프트 복조기 LLR 계산, 변조·채널 특이적이며 LDPC 디코더 자체 기법 아님
- **ID**: ieee:10584439
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: 멀티홉 네트워크용 streaming code(패킷 erasure, delay deadline) — channel ECC LDPC 기법 아니며 떼어낼 NAND 이식 기법 없음
- **ID**: ieee:10516574
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: 추측비용 bound·Rényi 엔트로피 분산저장 이론 — 디코더/HW/구성으로 안 이어지는 순수 이론 bound
- **ID**: ieee:10341332
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ✅
- **Reason**: 256개 벡터에서 최소 6개 값·위치를 찾는 minima finder HW(min-sum 디코더 핵심 연산) — 광통신 대상이나 LDPC min-sum 디코더 HW로 이식 가능(D)
- **ID**: ieee:10531794
- **Type**: journal
- **Published**: Oct. 2024
...
- **Status**: ❌
- **Reason**: 위성 SC-FDMA에서 NR/WLAN/DVB-S2 표준 LDPC BER 비교 — 표준 부호 단순 비교, 새 기여 없음
- **ID**: ieee:10757587
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: 5G NR 표준 LDPC의 BLER-SNR 곡선/양자화 영향 측정 — 표준 부호 그대로 사용, 새 디코더/구성/HW 기여 없음
- **ID**: ieee:10757540
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: Polar 부호 HARQ NOMA 재전송 비트 결정 — LDPC 아님, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:10757571
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: sub-THz 5G NR sidelink 성능 평가 — LDPC 무관, 무선 응용 특이적
- **ID**: ieee:10757570
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ✅
- **Reason**: 병렬화·짧은 코드워드·pseudo-soft info 활용 디코딩 복잡도 절감 — 병렬 디코더 아키텍처/소프트근사 기법(C/D)으로 NAND LDPC 디코더 이식 여지. 애매하므로 살림
- **ID**: ieee:10757607
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: 위성 HARQ + soft-clipping/PAPR + GAMP 수신기; LDPC 언급 없고 ECC 디코더로 이식할 채널코딩 기법 없음 (무선 응용 특이적)
- **ID**: ieee:10757736
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: 수중음향 OTFS + Turbo DFE 등화기/디코더; LDPC 무관, 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:10757871
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: Turbo 디코딩용 sparse RNN — 신경망 디코더이나 turbo 코드 대상, LDPC로 이식할 구조적 기여 불명확하고 turbo 특화
- **ID**: ieee:10757574
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: ISDB-T 지상파 방송 모바일 수신 필드 실험 — LDPC 언급 없고 떼어낼 ECC 기법 없는 응용 논문
- **ID**: ieee:10757514
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ❌
- **Reason**: Non-binary LDPC(NB-LDPC) 기반 concatenation — 비이진 LDPC는 즉시 제외
- **ID**: ieee:10748489
- **Type**: conference
- **Published**: 4-5 Oct. 2
...
- **Status**: ❌
- **Reason**: Polar+QC-LDPC concatenation 기반 McEliece 암호 — 보안/암호 도메인, 떼어낼 ECC 디코더·구성 기법 없음
- **ID**: ieee:10735591
- **Type**: conference
- **Published**: 30 Sept.-3
...
- **Status**: ✅
- **Reason**: QC-LDPC burst 검출·정정 확장, parity-check 구조 기반 majority decoding — 바이너리 QC-LDPC 디코딩 기법(C/E)으로 이식 가능
- **ID**: ieee:10758475
- **Type**: conference
- **Published**: 30 Sept.-2
...
- **Status**: ✅
- **Reason**: GLDPC 코드 density evolution 분석 — 바이너리 GLDPC 구성/임계값 분석은 코드 설계(E)에 이식 가능, 애매하므로 살림
- **ID**: ieee:10758497
- **Type**: conference
- **Published**: 30 Sept.-2
...
- **Status**: ❌
- **Reason**: Low-density lattice codes(LDLC) — 격자 코드이지 바이너리 LDPC ECC가 아님, AWGN 전용
- **ID**: ieee:10758537
- **Type**: conference
- **Published**: 30 Sept.-2
...
- **Status**: ✅
- **Reason**: Neural min-sum 디코더 + neural quantizer joint 학습 — 이식 가능한 디코더 알고리즘(C), 메시지 양자화는 NAND LLR 양자화와 직접 연관
- **ID**: ieee:10758454
- **Type**: conference
- **Published**: 30 Sept.-2
...
- **Status**: ❌
- **Reason**: Polar+superposition concatenation 무선통신용 — LDPC 무관, NAND ECC로 이식할 기법 없음
- **ID**: ieee:10758448
- **Type**: conference
- **Published**: 30 Sept.-2
...
- **Status**: ❌
- **Reason**: Polar subcode weight spectrum 개선 — Polar 코드 전용 구성, LDPC ECC 기법 아님
- **ID**: ieee:10758477
- **Type**: conference
- **Published**: 30 Sept.-2
...
- **Status**: ❌
- **Reason**: 양자 오류 억제/완화/정정 종합 리뷰 — 양자 EC 원칙 제외, 고전 바이너리 LDPC 이식 기법 없음
- **ID**: ieee:10835735
- **Type**: conference
- **Published**: 28-31 Oct.
...
- **Status**: ✅
- **Reason**: SC-LDPC용 재구성 가능 고처리율 디코더 HW 아키텍처(단순화 라우팅 네트워크) — D(HW)로 이식 가능
- **ID**: ieee:10942947
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ✅
- **Reason**: few-iteration 디코더용 puncturing 패턴 최적화(SPAT) 새 기법, rate-matching 설계로 이식 가능(E)
- **ID**: ieee:10942813
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ✅
- **Reason**: 단일 base matrix LDPC 새 부호 설계+automorphism ensemble decoding 제시(C/E), 바이너리 LDPC
- **ID**: ieee:10942769
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ✅
- **Reason**: 고처리율 LDPC 디코더의 Tanner graph 데이터 전송 구조별 에너지 분석, HW 구현 제약 관점 이식 가능(D)
- **ID**: ieee:10942759
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ❌
- **Reason**: 양자 qLDPC 디코딩으로 원칙 제외 — adversarial error 디코딩으로 syndrome 복원이며 양자 코드 구조에 종속
- **ID**: ieee:10756177
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ✅
- **Reason**: RM 코드 layered/broadcast CPA 디코더지만 LDPC layered decoding+BP 기법을 차용·역이식 가능한 복잡도 절감 기여(C)
- **ID**: ieee:10942623
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ❌
- **Reason**: convolutional/turbo code의 BCJR/SOVA·trellis 압축 기법 — LDPC ECC가 아닌 컨볼루션 코딩, 이식 대상 아님
- **ID**: ieee:10942983
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ❌
- **Reason**: AWGN/adversary 채널 용량 + thresholded LLR 디코더지만 LDPC는 시뮬레이션 베이스라인일 뿐, 떼어낼 새 디코더·코드 기여가 없는 이론/통신 응용
- **ID**: ieee:10942906
- **Type**: conference
- **Published**: 27-30 Oct.
...
- **Status**: ✅
- **Reason**: CNN으로 OMS(offset min-sum)의 초기 LLR을 보정하는 디코더 기법 — 이식 가능한 min-sum 변형/신경망 보조 LLR 보정(C). 무선 응용이나 디코더 기법은 분리 가능
- **ID**: ieee:11117122
- **Type**: conference
- **Published**: 25-27 Oct.
...
- **Status**: ✅
- **Reason**: QC-LDPC 행렬 분할(matrix splitting) 기반 부분병렬 FPGA 디코더, 고처리량/저지연 — 이식 가능 HW 아키텍처(D)
- **ID**: ieee:10827659
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ❌
- **Reason**: non-binary LDPC용 pruning path Min-Sum 디코더, 비이진 LDPC라 즉시 제외(절차 0)
- **ID**: ieee:10827053
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ✅
- **Reason**: QC-LDPC 신규 구성법(simulated annealing+8-cycle/trapping set 상관)으로 girth-8 코드 설계, 바이너리, 이식 가능한 코드설계 기여(E)
- **ID**: ieee:10826749
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ✅
- **Reason**: SC-LDPC 신규 구성법(GCD FLRM)으로 girth-8 QC-SC-LDPC 설계, 바이너리, 이식 가능한 코드설계 기여(E)
- **ID**: ieee:10827040
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ❌
- **Reason**: McEliece 공개키 암호(cyclic codes 기반) — 보안/암호 영역이고 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:10827328
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ❌
- **Reason**: 강화학습 기반 적응변조부호화(AMC), 링크적응 응용, LDPC ECC 기법 없음
- **ID**: ieee:10826945
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ❌
- **Reason**: DeepJSCC 시맨틱 통신 확산모델, 소스-채널 결합·시맨틱 통신으로 ECC 기법 없음
- **ID**: ieee:10826825
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ❌
- **Reason**: 다중사용자 간섭 억제용 일반화 최근접이웃 복조(GNND) — LDPC 디코더는 기존 것을 연결만 함, 무선 응용 특이적이고 떼어낼 ECC 기법 없음
- **ID**: ieee:10827590
- **Type**: conference
- **Published**: 24-26 Oct.
...
- **Status**: ❌
- **Reason**: 5G 실내 레이트레이싱 채널 모델링, LDPC 무관
- **ID**: ieee:10758988
- **Type**: conference
- **Published**: 22-25 Oct.
...
- **Status**: ❌
- **Reason**: NavIC L1C SDR 신호 수신/추적, ECC/LDPC 무관
- **ID**: ieee:11201184
- **Type**: conference
- **Published**: 22-25 Oct.
...
- **Status**: ❌
- **Reason**: 5G/6G 네트워크 코딩+HARQ 서비스시간 최적화; LDPC ECC 기법 없음
- **ID**: ieee:10765762
- **Type**: conference
- **Published**: 21-24 Oct.
...
- **Status**: ❌
- **Reason**: LDPC+RS 코드 변조 스펙트럼 효율 향상, 표준 LDPC를 부호화 모듈로 사용. 새 디코더·코드설계 기여 없음.
- **ID**: ieee:10772771
- **Type**: conference
- **Published**: 21-23 Oct.
...
- **Status**: ❌
- **Reason**: 6G 물리계층 데이터 로깅 테스트베드 인프라. LDPC·ECC 무관.
- **ID**: ieee:10942742
- **Type**: conference
- **Published**: 21-23 Oct.
...
- **Status**: ❌
- **Reason**: 일반화 인덱스 변조 시스템·BER 분석; LDPC-BPSK는 응용예시 베이스라인, 떼어낼 ECC 기법 없음
- **ID**: ieee:10753254
- **Type**: conference
- **Published**: 19-21 Oct.
...
- **Status**: ✅
- **Reason**: D: forward-substitution 기반 부분병렬 QC-LDPC 인코더 HW 아키텍처, NAND 이식 가능
- **ID**: ieee:10946634
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ✅
- **Reason**: E: 4/6-cycle 제거 새 명시적 QC-LDPC 구성법(컴퓨터 탐색 불필요), NAND 코드설계 이식 가능
- **ID**: ieee:10946320
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ❌
- **Reason**: 기하성형 콘스텔레이션 오토인코더 설계(MLC/BICM), LDPC ECC 기법 아님
- **ID**: ieee:10946339
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ❌
- **Reason**: MIMO SGD 기반 등화 검출, LDPC와 무관
- **ID**: ieee:10946447
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ❌
- **Reason**: OFDM 간섭완화·채널추정·검출 결합 수신기, 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:10946374
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) polar code 논문 — LDPC도 아니고 non-binary라 즉시 제외
- **ID**: ieee:10750708
- **Type**: conference
- **Published**: 18-19 Oct.
...
- **Status**: ❌
- **Reason**: DL 시맨틱 통신+JSCC 보안 — 소스-채널 결합/시맨틱, 떼어낼 ECC 기법 없음
- **ID**: ieee:10908341
- **Type**: conference
- **Published**: 17-19 Oct.
...
- **Status**: ❌
- **Reason**: PNC+massive MIMO 저해상도 ADC LLR 계산 — 네트워크코딩 응용, LDPC 디코더 기여 없음
- **ID**: ieee:10908167
- **Type**: conference
- **Published**: 17-19 Oct.
...
- **Status**: ❌
- **Reason**: wiretap full-duplex 블라인드 채널추정·보안코딩 — 무선 보안 응용 특이적, 이식 ECC 기법 없음
- **ID**: ieee:10908139
- **Type**: conference
- **Published**: 17-19 Oct.
...
- **Status**: ❌
- **Reason**: 5G Broadcast/DVB-I TV 서비스 통합. LDPC/ECC 무관
- **ID**: ieee:10755843
- **Type**: conference
- **Published**: 17-18 Oct.
...
- **Status**: ❌
- **Reason**: SEFDM 실험적 수신 평가. NR LDPC 표준 부호 + message-passing을 그대로 사용, 신규 디코더/구성 기여 없음
- **ID**: ieee:10755725
- **Type**: conference
- **Published**: 17-18 Oct.
...
- **Status**: ❌
- **Reason**: Rayleigh 페이딩 LDPC 인터리빙 FER 실험 — 응용 특이적, 이식 가능 신규 기법 없음
- **ID**: ieee:10827339
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: 패리티체크 폴라코드 설계 — LDPC가 아닌 폴라코드
- **ID**: ieee:10827520
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: 벤더 SDFEC(Xilinx) 코어 이용 고속 LDPC 디코더 — 기성 IP 활용, 새 아키텍처 없음
- **ID**: ieee:10827578
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: 위성 전송에서 표준 sum-product 반복횟수 튜닝만 — 새 디코더/HW/코드 기여 없음
- **ID**: ieee:10827185
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ✅
- **Reason**: ECC Transformer/neural BP 디코더의 HW복잡도·양자화 경량화 분석 — 이식 가능 신경망 디코더(C)
- **ID**: ieee:10826987
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: CV-QKD 정보조정용 폴라코드 — LDPC 아니고 양자 QKD, 떼어낼 LDPC 기법 없음
- **ID**: ieee:10827110
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: 물리계층 보안 perfect secrecy + cascaded code. 무선 보안 응용 특이적, 떼어낼 ECC 디코더/구성 기법 없음
- **ID**: ieee:10736451
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: 5G 네트워크 재밍 탐지+Random Forest 연구. LDPC/ECC 기법 없음.
- **ID**: ieee:10814794
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: massive MIMO Gauss-Seidel MMSE-PIC + LDPC 결합 EXIT 설계. MIMO 검출기 결합 특이적이고 LDPC는 표준 부호 사용, 떼어낼 신규 디코더/구성 기법 없음
- **ID**: ieee:10826779
- **Type**: conference
- **Published**: 16-18 Oct.
...
- **Status**: ❌
- **Reason**: PAM4-PON 광통신 실험 성능분석 — LDPC/ECC 기법 언급 없음
- **ID**: ieee:10746115
- **Type**: conference
- **Published**: 15-18 Oct.
...
- **Status**: ✅
- **Reason**: CV-QKD 도메인이나 강화학습 기반 LDPC 코드율 적응 선택 — 레이트 적응 디코딩 기법 이식 검토 여지(애매, Phase3)
- **ID**: ieee:11028745
- **Type**: conference
- **Published**: 15-17 Oct.
...
- **Status**: ❌
- **Reason**: 5G 표준 LDPC/Polar를 양자채널에서 단순 BER 평가 — 표준 부호 재사용, 새 디코더/구성 없음
- **ID**: ieee:11028815
- **Type**: conference
- **Published**: 15-17 Oct.
...
- **Status**: ❌
- **Reason**: UAV 군집 전송 최적화·랜덤 선형 네트워크 코딩+강화학습, LDPC ECC와 무관
- **ID**: ieee:10763871
- **Type**: conference
- **Published**: 10-14 Oct.
...
- **Status**: ❌
- **Reason**: Reed-Solomon 코드 무선 전송 응용 — LDPC 아님, 이식할 기법 없음
- **ID**: ieee:10851530
- **Type**: conference
- **Published**: 10-12 Oct.
...
- **Status**: ❌
- **Reason**: 광통신용 LDPC를 표준 Bit-Flipping으로 디코딩한 MATLAB/OptiSystem 성능 비교만, 새 디코더/코드 기여 없음
- **ID**: ieee:10828774
- **Type**: conference
- **Published**: 1-3 Oct. 2

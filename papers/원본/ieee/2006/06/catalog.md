...
- **Status**: ❌
- **Reason**: MIMO Rayleigh 채널 QAM 트렐리스 inner code 설계, LDPC는 outer로 부수 언급, 떼어낼 LDPC 기법 없음
- **ID**: ieee:1638653
- **Type**: journal
- **Published**: June 2006
- **Authors**: J. Bellorado, S. Ghassemzadeh, A. Kavcic
- **PDF**: https://ieeexplore.ieee.org/document/1638653
...
- **Status**: ❌
- **Reason**: Raptor/LT fountain 부호 — 비-LDPC erasure 부호, 제외 대상
- **ID**: ieee:1638543
- **Type**: journal
- **Published**: June 2006
- **Authors**: A. Shokrollahi
- **PDF**: https://ieeexplore.ieee.org/document/1638543
...
- **Status**: ❌
- **Reason**: 분산 네트워크 스토리지용 erasure 코드(네트워크 코딩 기반), LDPC ECC 아님이고 떼어낼 디코더/HW 기법 없음
- **ID**: ieee:1638564
- **Type**: journal
- **Published**: June 2006
- **Authors**: A.G. Dimakis, V. Prabhakaran, K. Ramchandran
- **PDF**: https://ieeexplore.ieee.org/document/1638564
...
- **Status**: ❌
- **Reason**: Box-Muller 가우시안 노이즈 발생기 FPGA — 시뮬레이션 보조 HW일 뿐 LDPC 디코더 아키텍처 아님
- **ID**: ieee:1628955
- **Type**: journal
- **Published**: June 2006
- **Authors**: D.-U. Lee, J.D. Villasenor, W. Luk +1
- **PDF**: https://ieeexplore.ieee.org/document/1628955
...
- **Status**: ❌
- **Reason**: 분산소스코딩-네트워크코딩 분리 문제, 채널 ECC 아님
- **ID**: ieee:1638561
- **Type**: journal
- **Published**: June 2006
- **Authors**: A. Ramamoorthy, K. Jain, P.A. Chou +1
- **PDF**: https://ieeexplore.ieee.org/document/1638561
...
- **Status**: ❌
- **Reason**: 패킷 무선망 브로드캐스트 스케줄링에 factor graph/sum-product 응용, ECC 부호 설계 아니고 떼어낼 LDPC 기법 없음
- **ID**: ieee:1638642
- **Type**: journal
- **Published**: June 2006
- **Authors**: Jung-Chieh Chen, Yeong-Cheng Wang, Jiunn-Tsair Chen
- **PDF**: https://ieeexplore.ieee.org/document/1638642
...
## Distributed Source Coding Using Symbol-Based Turbo Codes

- **Status**: ❌
- **Reason**: 심볼기반 turbo로 분산 소스코딩(압축) — 소스코딩+비-LDPC, 제외
- **ID**: ieee:1644593
- **Type**: conference
- **Published**: 30 May-1 J
- **Authors**: M. Zamani, F. Lahouti
- **PDF**: https://ieeexplore.ieee.org/document/1644593
- **Abstract**: A simple but powerful scheme for distributed source coding based on the concept of binning and symbol-based turbo codes is proposed. The previous works on the compression with side information (SI) using turbo codes and the binning technique are focused on binary turbo codes. The source is considered to be binary or is converted to a binary stream. This conversion, however, reduces the redundancy that could be exploited by the compression algorithm. To achieve higher compression efficiency, we propose using a scheme based on a turbo decoder that decides over symbols rather than bits. The results demonstrate improved performance

## Improving the Performance of 4-State Turbo Codes with the Correction Impulse Method and Data Puncturing

- **Status**: ❌
- **Reason**: 4-state turbo error floor 저감(correction impulse+puncturing) — turbo 전용 기법, 바이너리 LDPC BP에 이식 안 됨
- **ID**: ieee:1644614
- **Type**: conference
- **Published**: 30 May-1 J
- **Authors**: K. Gracie, S. Crozier
- **PDF**: https://ieeexplore.ieee.org/document/1644614
- **Abstract**: Turbo codes offer excellent error-rate performance and have been included in a wide variety of systems and standards. However, these gains are limited as the signal-to-noise ratio (SNR) increases by "flares" in their error-rate curves. These flares may disqualify turbo codes from applications that require very low error rates. Recently, an effective method for reducing these error flares that is applicable to any turbo or turbo-like code has been proposed. This paper shows that this technique is of tremendous value even when applied to relatively weak 4-state, single-binary turbo codes, particularly when used in conjunction with data puncturing and well-designed interleavers

## Performance of a 4-State Turbo Code with Data Puncturing and a BCH Outer Code

- **Status**: ❌
- **Reason**: turbo+BCH concatenated 성능 — 비-LDPC, 떼어낼 LDPC 기법 없음
- **ID**: ieee:1644615
- **Type**: conference
- **Published**: 30 May-1 J
- **Authors**: R. Kerr, K. Gracie, S. Crozier
- **PDF**: https://ieeexplore.ieee.org/document/1644615
- **Abstract**: The performance of a concatenated turbo code with an outer BCH code is examined. The turbo code was based on simple 4-state constituent codes with a constrained high spread random (HSR) inter-leaver. Data puncturing, as opposed to puncturing only the parity bits, was used with the Turbo code to improve the convergence performance in the waterfall region. It is shown that this simple approach achieves performance better than the rate frac12 DVB-S2 concatenated LDPC-BCH code

## Adaptive Demodulation Performance over a Rayleigh Fading Channel

- **Status**: ❌
- **Reason**: Rayleigh 페이딩 적응복조(ADM) 스펙트럼효율 — 무선 변조 응용, LDPC 무관
- **ID**: ieee:1644568
- **Type**: conference
- **Published**: 30 May-1 J
- **Authors**: J.D. Brown, K.N. Plataniotis, S. Pasupathy
- **PDF**: https://ieeexplore.ieee.org/document/1644568
- **Abstract**: Adaptive demodulation (ADM) is a newly proposed rate adaptive system which operates without requiring channel state information at the transmitter (unlike adaptive modulation). We consider the performance of ADM (using 16-QAM and using 16-PSK) over a Rayleigh fading channel. A methodology is presented for the receiver to effectively choose its operating region based on the observed SNR at the receiver. New results are obtained for the spectral efficiency of the ADM system for both uncoded and coded bits
...
- **Status**: ❌
- **Reason**: 초록 null, 'Cryptography and Coding' 제목만으로 보안/암호 도메인 추정; 떼어낼 LDPC ECC 기법 식별 불가
- **ID**: ieee:4123942
- **Type**: conference
- **Published**: 28-30 June
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/4123942
- **Abstract**: N/A
...
## Performance Improvement of DVB-H System with LDPC Code in MPE-FEC Frame

- **Status**: ❌
- **Reason**: DVB-H에서 RS를 LDPC로 교체하는 성능 분석, 신규 디코더/구성/HW 기여 없음
- **ID**: ieee:1691072
- **Type**: conference
- **Published**: 26-29 June
- **Authors**: Hyung Taek Lim, Sang Hoon Lee, Jong Soo Lim +2
- **PDF**: https://ieeexplore.ieee.org/document/1691072
- **Abstract**: RS (Reed - Solomon) code is used in DVB-H (digital video broadcasting - handheld) system as an addtional error correcting code to improve the performance during mobile reception. LDPC (low density parity check) code which is rediscovered recently shows the astonishing performance. Therefore LDPC code can be used to replace RS code in order to improve the performance further since both of them are block codes. So the performance of LDPC code in MPE-FEC (multi protocol encapsulation - forward error correction) frame of DVB-H system is analyzed in this paper.

## On the Performance of Incremental Redundancy Hybrid ARQ Schemes with Rate Compatible LDPC Codes

- **Status**: ❌
- **Reason**: Rate-compatible LDPC for IR-HARQ throughput; uses existing RC-LDPC, no new decoder/construction/HW for ECC
- **ID**: ieee:4063999
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Hong Wen, Liang Zhou, Chusheng Fu
- **PDF**: https://ieeexplore.ieee.org/document/4063999
- **Abstract**: Rate compatible LDPC codes with only one parity check matrix can be applicable to rate matching. An incremental redundancy hybrid ARQ scheme based on rate compatible LDPC codes is introduced. We studied the throughput of the new HARQ scheme. Furthermore, the throughput of the new HARQ scheme is simulated. It shows that for arbitrary block fading channel, comprising AWGN channel, the performance of IR_HARQ schemes based on RC-LDPC is same as those based on random LDPC. But the encoding and decoding of RC_LDPC is simpler, and the wider range changing of code rates of RC_LDPC can be obtained than those of random LDPC

## The Application of High-Rate LDPC Codes in Image Transmission over Wireless Channel

- **Status**: ❌
- **Reason**: High-rate LDPC for wireless image transmission; LDPC used as-is over fading channel, no new decoder/construction/HW
- **ID**: ieee:4063830
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Huo Yongqing, Peng Qicong, Shao Huaizong
- **PDF**: https://ieeexplore.ieee.org/document/4063830
...
## Threshold Determination of LDPC Codes for Turbo Equalization Based on EXIT Chart

- **Status**: ❌
- **Reason**: EXIT-chart threshold determination of LDPC for turbo equalization over ISI channel; analysis tool, no new decoder/construction/HW
- **ID**: ieee:4063992
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Xu Hua, Xu Cheng-qi, Kang Su-cheng
- **PDF**: https://ieeexplore.ieee.org/document/4063992
- **Abstract**: Optimization of LDPC codes based on (EXIT) chart for MIMO channel was recently proposed by Brink. We extended Brink's idea to the performance analysis and threshold determination of LDPC codes for MMSE turbo equalization. The receiver was partitioned into two blocks. A new scheme to obtain EXIT curve of block I was given. Furthermore a new algorithm was proposed based on the EXIT curve fitting, which can obtain the ensemble threshold automatically. Decoding trajectory of (3,6) regular LDPC codes for MMSE turbo equalization was also analyzed in this paper. Threshold of (3,6) regular LDPC codes obtained by proposed algorithm is only 0.03 dB away to Narayanan's result over the same ISI channel
...
- **Status**: ❌
- **Reason**: 비이진(nonbinary) QC-LDPC 구성 — 바이너리 한정 기준에 따라 제외
- **ID**: ieee:4064124
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Shu Lin, Shumei Song, Ying Y. Tai +2
- **PDF**: https://ieeexplore.ieee.org/document/4064124
...
## A LDPC-Based Joint Source Channel Decoding Using HMM for Image Transmission System

- **Status**: ❌
- **Reason**: LDPC-based JSCD with HMM for image transmission; joint source-channel decoding using source redundancy, no transferable channel ECC technique
- **ID**: ieee:4063835
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Jie Gao, Rongke Liu, Xinmei Sun +1
- **PDF**: https://ieeexplore.ieee.org/document/4063835
- **Abstract**: A modified joint source channel decoding (JSCD) algorithm based on low-density parity-check (LDPC) coding and hidden Markov estimation is proposed to employ the self-checking mechanism of LDPC codes in adjusting the error probability p of the hidden Markov model (HMM) and the JSCD scheme utilizes the source residual redundancy while no priori information of the source parameters is available. We also extend and apply the algorithm over image transmission system. Simulation results show that the modified JSCD algorithm leads to the joint decoder converge at least 10% faster than the unmodified method without any degradation in the decoding performance. The method also obtains substantial improved performance in image quality of 3.0 dB-8.0 dB (PSNR) at 0.6 dB in Eb/N0 when it is employed in still image transmission systems

## A Type-II Hybrid ARQ Scheme Based on Rate-compatible LDPC Code

- **Status**: ❌
- **Reason**: Rate-compatible LDPC + Type-II HARQ; RC-LDPC 확장 기법은 ARQ 시스템 특이적, NAND ECC로 이식할 새 디코더/구성 없음
- **ID**: ieee:4064033
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Fei Zesong, Zhu Miao, Kuang Jingming
- **PDF**: https://ieeexplore.ieee.org/document/4064033
...
- **Status**: ❌
- **Reason**: LDPC coded adaptive OFDM 무선 응용, 표준 LDPC를 부수 사용. 떼어낼 디코더/HW/코드설계 신규 기여 없음
- **ID**: ieee:4064029
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Zhou Mingyu, Li Lihua, Wen Na +1
- **PDF**: https://ieeexplore.ieee.org/document/4064029
- **Abstract**: In this paper, LDPC code is combined with adaptive OFDM. Code rate of LDPC is fixed and modulation mode of sub-carriers can vary according to CQI. Throughput analysis of the scheme under frequency-selective fading channel and theory of sub-band based LDPC coded AOFDM is given. Computer simulation under 12-tap TU fading channel was carried out. Results show that the LDPC coded AOFDM scheme exhibits BER performance quite close to that with fixed QPSK modulation due to existence of LDPC, meanwhile brings much higher throughput than non-adaptive schemes because of adaptation. The sub-band based adaptation has a little degradation in throughput, but reduces signaling cost greatly. LDPC coded AOFDM guarantees system reliability and improves throughput a lot

## A Novel Turbo Equalization for MIMO Frequency Selective Fading Channels

- **Status**: ❌
- **Reason**: MIMO turbo equalization, CRC-aided 반복 정지 기법; LDPC는 부수 사용, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:4064072
- **Type**: conference
- **Published**: 25-28 June
- **Authors**: Zhanli Liu, Jing Wang, Chunming Zhao +2
- **PDF**: https://ieeexplore.ieee.org/document/4064072
...
- **Status**: ❌
- **Reason**: information-nulling type II HARQ 재전송 프로토콜, 무선 HARQ 응용으로 NAND ECC에 떼어낼 디코더/구성 기법 없음.
- **ID**: ieee:4068656
- **Type**: conference
- **Published**: 21-23 June
- **Authors**: Fei Zesong, Zhu Miao, Kuang Jingming
- **PDF**: https://ieeexplore.ieee.org/document/4068656
...
- **Status**: ❌
- **Reason**: 멀티캐리어 무선 영상전송에 고율 LDPC 적용한 응용 논문, 떼어낼 신규 디코더/구성/HW 기법 없음.
- **ID**: ieee:4068638
- **Type**: conference
- **Published**: 21-23 June
- **Authors**: Huo Yongqing, Peng Qicong, Shao Huaizong
- **PDF**: https://ieeexplore.ieee.org/document/4068638
- **Abstract**: Low-density parity-check (LDPC) codes have near Shannon performance and easy to implement, multicarrier modulation can achieve high spectral efficiency and resist the inter-symbol interference (ISI). In this paper, we explored three high rate LDPC codes in image transmission with multicarrier modulation. The simulation results show that the combination of multicarrier modulation and high rate LDPC codes can obtain high information speed and high bandwidth efficiency with high reliability and excellent performance in image communication over wireless channels. This can solve the problems about transmission speed and efficiency caused by large quantity of image data. We also found that the performance is more sensitive to code rate than to code length

## Rate-Compatible LDPC Codes for Cross-Layer Design Combining of AMC with HARQ

- **Status**: ❌
- **Reason**: RC-LDPC를 AMC+HARQ 크로스레이어 무선 설계에 적용한 응용, 펑처링 패턴 외 NAND 이식 신규 ECC 기법 없음.
- **ID**: ieee:4068648
- **Type**: conference
- **Published**: 21-23 June
- **Authors**: Yuling Zhang, Dongfeng Yuan
- **PDF**: https://ieeexplore.ieee.org/document/4068648
- **Abstract**: This paper proposes a cross-layer design combining of adaptive modulation and coding (AMC) with hybrid automatic repeat request (HARQ) based on rate-compatible low-density parity-check codes (RC-LDPC). First we investigate the puncturing pattern of RC-LDPC codes and prove that our puncturing pattern is as good as random puncturing. Then we apply RC-LDPC codes to cross-layer design combing AMC with ARQ over Nakagami-m fading channel and investigate the throughput of the system. Computer simulations show that the joint design of AMC and ARQ base on RC-LDPC codes can achieve considerable spectral efficiency gain
...
- **Status**: ❌
- **Reason**: RSC+LDPC 연접 부호로 표준 LDPC를 베이스라인으로 사용, 떼어낼 신규 LDPC 디코더·구성 기법 없음(연접 구조 자체가 기여).
- **ID**: ieee:4024302
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Satoshi Gounai, Tomoaki Ohtsuki, Toshinobu Kaneko
- **PDF**: https://ieeexplore.ieee.org/document/4024302
...
- **Status**: ❌
- **Reason**: LDPC/Turbo+space-time 연접 ML union bound 성능분석; 순수 이론 bound, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:4024820
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Jingqiao Zhang, Heung-no Lee
- **PDF**: https://ieeexplore.ieee.org/document/4024820
- **Abstract**: A performance evaluation framework based on the maximum-likelihood (ML) union bound is proposed for the concatenated coding scheme where the outer linear block code, low-density parity-check (LDPC) or Turbo code, drives a sequence of inner space-time codes. The outer code can be partitioned in a combinatorial manner such that all codewords in one subset/subcode are associated with an identical pairwise error probability. The union bound is therefore the summation of all distinct pairwise error probabilities, each of which is weighted by the cardinality of the corresponding subset. The cardinality is computable by making use of the statistical property of an ensemble of codes, and an approach of polynomial expansion is proposed for efficient evaluation of the closed-form union bound. Numerical results are presented for different channel scenarios and modulation schemes, which indicate that the ML union bounds are useful to benchmark the performance of practical iterative detection and decoding algorithms.
...
- **Status**: ❌
- **Reason**: 릴레이 채널용 bilayer LDPC+bilayer density evolution; 릴레이 전용 구성(relay-generated parity), NAND 이식성 없는 응용 특이 코드설계
- **ID**: ieee:4024376
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Peyman Razaghi, Wei Yu
- **PDF**: https://ieeexplore.ieee.org/document/4024376
...
- **Status**: ❌
- **Reason**: MTR 내부코드+LDPC 연접 자기기록 시스템 소프트출력 디코딩; 떼어낼 NAND LDPC 신규 기법 없음, LDPC는 부수
- **ID**: ieee:4024312
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Nikola Duric, Miroslav Despotovic
- **PDF**: https://ieeexplore.ieee.org/document/4024312
- **Abstract**: We present an approach for the soft-output decoding in multiple-head maximum-transition-run (MTR) encoded digital magnetic recording systems. The log-likelihood ratio (LLR) algebra implementation in Boolean logic mappings has been used to propagate the soft-output information through the MTR decoder. MTR code is employed as inner code in concatenation with low-density parity-check (LDPC) in two-track two-head E2PR4 partial response (PR) magnetic recording channel. The overall decoding complexity reduction is offered by proposed simulation scheme, while nearly 1.9dB coding gain is obtained with soft-output decoding on AWGN channel.
...
- **Status**: ❌
- **Reason**: eIRA(IRA계열) 코드를 coded modulation/BICM용으로 설계, 변조 매핑 의존 설계로 NAND 바이너리 LDPC에 떼어낼 기법 약함
- **ID**: ieee:4024290
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Giuseppe Durisi, Libero Dinoi, Sergio Benedetto
- **PDF**: https://ieeexplore.ieee.org/document/4024290
- **Abstract**: In this paper we discuss the design of linear time encodable extended irregular repeat-accumulate (eIRA) codes for bit-interleaved coded modulation (BICM) systems. We interpret eIRA codes as a particular instance of the recently introduced multi-edge type (MET) low-density parity-check (LDPC) codes. This allows us to take into account during the design step both the systematic nature of these codes and the different level of protection given to each bit by the choice of input alphabet and mapping function. Furthermore, we extend to the eIRA-BICM case the method used by Roumy et al., IEEE Trans. Inf. Theory, 2004, to optimize LDPC codes for the binary input AWGN (bi-AWGN) channel. This method is based on EXIT functions and leads to a linear program. Using this method we design capacity-approaching eIRA codes for 4PAM and 8PSK. For both short and long block lengths these codes have performance approximately 0.1 dB worse than LDPC codes optimized with density evolution and with similar decoding complexity.
...
- **Status**: ❌
- **Reason**: 센서망 협력코딩, rateless+LDGM 코드; LDPC ECC 아님, fountain/erasure류 제외
- **ID**: ieee:4024370
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Andrew W. Eckford, Josephine P. K. Chu, Raviraj S. Adve
- **PDF**: https://ieeexplore.ieee.org/document/4024370
...
- **Status**: ❌
- **Reason**: MIMO 랜덤코딩 union bound 순수 이론, 디코더/HW로 안 이어짐
- **ID**: ieee:4025150
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Jingqiao Zhang, Heung-no Lee
- **PDF**: https://ieeexplore.ieee.org/document/4025150
- **Abstract**: An assumption of random block codes is made for the closed-form derivation of union upper bounds. The random code works as the outer code for concatenation with the inner space-time modulation over the multi-input multi-output (MIMO) fading channels. From the union bound expression, we further obtain the closed-form expressions of error exponent and cut-off rate for MIMO channels. The error exponent is compared with Gallager's classical error exponent which is generally evaluated in the Monte Carlo method. The obtained bounds can be useful to serve as space-time code design tools or as performance prediction measures for the MIMO systems which employ turbo-like block codes as the outer code to drive the inner space-time code.
...
- **Status**: ❌
- **Reason**: Turbo FDE 등화 비교, LDPC는 부호 선택지일 뿐 이식할 디코더/코드설계 기여 없음
- **ID**: ieee:4024925
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Maryam Sabbaghian, David Falconer
- **PDF**: https://ieeexplore.ieee.org/document/4024925
- **Abstract**: This paper1 presents a Turbo Equalization system using soft interference cancellation in the frequency domain, in which the filter is updated during the iterations with respect to the soft information it receives from the decoder. Simulation results confirm that this method outperforms the suggested one in [4,ll] while it does not add much complexity to the system. We also investigate the effect of two coding schemes, LDPC code and convolutional code, on the performance of Turbo Frequency Domain Equalization (TFDE). TFDE with these codes are compared in terms of performance and computational complexity. Finally we suggest using an LDPC based frequency domain turbo equalizer due to its good performance/complexity tradeoff.

## Approaching Capacity on Noncoherent Block Fading Channels with Successive Decoding

- **Status**: ❌
- **Reason**: 비코히런트 블록페이딩 채널 successive decoding+채널추정; LDPC는 베이스라인, 무선응용 특이적, 이식 기법 없음
- **ID**: ieee:4024339
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Teng Li, Xiaowei Jin, Oliver M. Collins +1
- **PDF**: https://ieeexplore.ieee.org/document/4024339
- **Abstract**: A receiver structure that uses decision feedback and successive decoding is proposed for a noncoherent channel with independent block fading. The transceiver employs a block interleaver to decompose the channel into a set of independent fading sub-channels. LDPC codes are used on each sub-channel, and the decoded data are fed back to help in channel estimation. Simulation results indicate that the performance of the proposed system is within 0.7 dB of the Shannon capacity of the binary-input block fading channel.

## Low Rate Concatenated Zigzag-Hadamard Codes

- **Status**: ❌
- **Reason**: concatenated zigzag-Hadamard 부호로 LDPC가 아니며 SISO 디코딩도 Hadamard 전용, 떼어낼 LDPC 기법 없음.
- **ID**: ieee:4024301
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Guosen Yue, W. K. Leung, Li Ping +1
- **PDF**: https://ieeexplore.ieee.org/document/4024301
...
- **Status**: ❌
- **Reason**: Raptor(fountain/erasure 계열) 코드 구성으로 채널 ECC 떼어낼 LDPC 기법 없음, fountain 제외 대상
- **ID**: ieee:4024292
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Hossein Pishro-Nik, Faramarz Fekri
- **PDF**: https://ieeexplore.ieee.org/document/4024292
- **Abstract**: We introduce a construction of raptor codes to be used over symmetric channels. An important property of the proposed scheme is that unlike the previous construction of raptor codes, it allows to design codes that are approaching the capacity of the underlying channel in a rate-compatible way. We also show that for finite-length codes, the proposed construction outperforms the previous constructions of raptor codes.

## CRC-Assisted Error Correction in a Convolutionally Coded System

- **Status**: ❌
- **Reason**: CRC+컨볼루션 코드 기반 반복/신드롬 디코딩, 비-LDPC 부호 전용이고 바이너리 LDPC BP에 이식 불가
- **ID**: ieee:4024098
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Renqiu Wang, Wanlun Zhao, Georgios B. Giannakis
- **PDF**: https://ieeexplore.ieee.org/document/4024098
...
- **Status**: ❌
- **Reason**: 적응변조 코딩, LDPC는 시뮬 베이스라인일 뿐 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:4024848
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Hari Sankar, Krishna R. Narayanan
- **PDF**: https://ieeexplore.ieee.org/document/4024848
...
- **Status**: ❌
- **Reason**: 양방향 릴레이 채널 turbo 네트워크코드 결합 디코딩; turbo 기반, 부호 비의존 이식 LDPC BP 기법 없음
- **ID**: ieee:4024375
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Christoph Hausl, Joachim Hagenauer
- **PDF**: https://ieeexplore.ieee.org/document/4024375
...
- **Status**: ❌
- **Reason**: 터보 디코더용 prunable interleaver 설계로 LDPC 비의존적이며 떼어낼 BP 이식 기법 없음.
- **ID**: ieee:4024294
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Libero Dinoi, Alberto Tarable, Sergio Benedetto
- **PDF**: https://ieeexplore.ieee.org/document/4024294
...
- **Status**: ❌
- **Reason**: 광통신 다중레벨 코딩 응용으로 표준 block-circulant LDPC를 component code로 단순 사용, 신규 LDPC 기여 없음.
- **ID**: ieee:4024307
- **Type**: conference
- **Published**: 11-15 June
- **Authors**: Ivan B. Djordjevic, Bane Vasic
- **PDF**: https://ieeexplore.ieee.org/document/4024307
- **Abstract**: Transmitter and receiver configurations suitable for M-ary DPSK/differential QAM noncoherent optical transmission are proposed. It is shown that multilevel coding based on lowdensity parity-check codes as component codes is an efficient approach to achieve high-spectrally efficient noncoherent optical transmission. The multilevel coding scheme with 2 bits/s/Hz spectral efficiency based on block-circulant component codes provides the coding gain of 12.3 dB compared to uncoded 8-DPSK, and 8.3 dB compared to uncoded QDPSK.

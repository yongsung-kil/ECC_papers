...
- **Status**: ❌
- **Reason**: LDPC 최소거리 대비 rate 상한 이론 bound — 디코더/HW/구성으로 안 이어지는 순수 이론
- **ID**: ieee:1624642
- **Type**: journal
- **Published**: May 2006
- **Authors**: Y. Ben-Haim, S. Litsyn
- **PDF**: https://ieeexplore.ieee.org/document/1624642
...
- **Status**: ❌
- **Reason**: LP 디코딩 하 pseudo-codeword 최소무게 이론 — 디코더/HW/구성 신규 기여 없는 순수 이론
- **ID**: ieee:1633324
- **Type**: journal
- **Published**: May 2006
- **Authors**: Shu-Tao Xia, Fang-Wei Fu
- **PDF**: https://ieeexplore.ieee.org/document/1633324
...
- **Status**: ✅
- **Reason**: E: 낮은 error floor·저복잡 인코딩 위한 triangular+dual-diagonal 패리티검사 구성 — 바이너리 LDPC 코드설계 이식 가능
- **ID**: ieee:1633327
- **Type**: journal
- **Published**: May 2006
- **Authors**: Z. He, P. Fortier, S. Roy
- **PDF**: https://ieeexplore.ieee.org/document/1633327
...
- **Status**: ✅
- **Reason**: D: 메모리 기반 부분병렬 LDPC 디코더 HW 아키텍처, 레지스터/인터커넥트 절감 — NAND 디코더 HW 이식 가능
- **ID**: ieee:1629243
- **Type**: journal
- **Published**: May 2006
- **Authors**: Se-Hyeon Kang, In-Cheol Park
- **PDF**: https://ieeexplore.ieee.org/document/1629243
...
- **Status**: ❌
- **Reason**: FG-LDPC stopping distance 하한 이론 분석 — 신규 디코더/HW/구성 없는 순수 이론
- **ID**: ieee:1633330
- **Type**: journal
- **Published**: May 2006
- **Authors**: Shu-Tao Xia, Fang-Wei Fu
- **PDF**: https://ieeexplore.ieee.org/document/1633330
...
- **Status**: ❌
- **Reason**: cycle GF(2^p) 비이진 코드 선형시간 인코딩 — 비이진 LDPC 제외
- **ID**: ieee:1633326
- **Type**: journal
- **Published**: May 2006
- **Authors**: Jie Huang, Jinkang Zhu
- **PDF**: https://ieeexplore.ieee.org/document/1633326
- **Abstract**: In this letter, we present a linear-complexity encoding algorithm for any cycle GF(2/sup P/) code C/sub E/(G,H). We just need to investigate the case where G is a nontrivial connected graph. If G is a tree, the only codeword is the all-zero word. If G is not a tree, first, we show that through graph analysis H can be transformed into an equivalent block-diagonal upper-triangular form simply by permuting the rows and columns of H; then, we show that whether H is full row-rank or not, the code can be encoded in linear time.

## Improved decoding of LDPC coded modulations

- **Status**: ✅
- **Reason**: C: 다중레벨 변조용 CMBP 디코더, 심볼 내 비트 의존성 반영한 BP 개선 — NAND multilevel(TLC/QLC) LLR에 이식 가능
- **ID**: ieee:1633328
- **Type**: journal
- **Published**: May 2006
- **Authors**: Y. Nana, E. Sharon, S. Litsyn
- **PDF**: https://ieeexplore.ieee.org/document/1633328
- **Abstract**: A coded modulation belief propagation (CMBP) decoder is proposed for decoding LDPC codes with multilevel modulations. The decoder takes into account statistical dependencies among bits originating in the same symbol, providing better performance than the marginal BP (MBP) decoder. Asymptotically it converges to MAP decoding. The CMBP decoder is based on a single-level coding (SLC) scheme and does not suffer from practical disadvantages of multi-level coding (MLC) schemes. Furthermore, the CMBP decoder can close the capacity gap of the bit interleaved coded modulation (BICM) SLC scheme. The BICM capacity gap increases when the modulation size increases and in scenarios where gray mapping is not possible.

## Raptor codes on binary memoryless symmetric channels

- **Status**: ❌
- **Reason**: Raptor/fountain 부호 BIMSC 성능·안정성 조건 — fountain/erasure 부호 이론, LDPC ECC 이식 기법 없음
- **ID**: ieee:1624639
- **Type**: journal
- **Published**: May 2006
- **Authors**: O. Etesami, A. Shokrollahi
- **PDF**: https://ieeexplore.ieee.org/document/1624639
...
- **Status**: ❌
- **Reason**: 공장자동화 무선네트워크 — LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:1632023
- **Type**: journal
- **Published**: May 2006
- **Authors**: F. De Pellegrini, D. Miorandi, S. Vitturi +1
- **PDF**: https://ieeexplore.ieee.org/document/1632023
...
- **Status**: ❌
- **Reason**: dirty-paper 채널용 superposition coding — side-information 채널 코딩, 채널 ECC 아닌 Gel'fand-Pinsker 구성, 떼어낼 LDPC 기법 없음
- **ID**: ieee:1624629
- **Type**: journal
- **Published**: May 2006
- **Authors**: A. Bennatan, D. Burshtein, G. Caire +1
- **PDF**: https://ieeexplore.ieee.org/document/1624629
...
- **Status**: ✅
- **Reason**: RIA-LDPC 신규 구성으로 array/eIRA의 4-cycle 문제·error floor 개선. 바이너리 LDPC 코드설계(E)
- **ID**: ieee:4261730
- **Type**: conference
- **Published**: 8-12 May 2
- **Authors**: T. Kanaoka, T. Morita
- **PDF**: https://ieeexplore.ieee.org/document/4261730
- **Abstract**: Structured low-density parity-check (LDPC) codes have been studied as practical LDPC codes for magnetic recording channels. These codes, such as array codes and eIRA codes, enable to construct matrices logically. Their performances, however, are not sufficient for inter-symbol-interference (ISI) channels, especially when the block length becomes short and the code rate becomes high. This is due to the structure of the array codes, which are constructed by single cyclic shift matrices. When multiple-bit errors occur in the channel, they are easily connected through the parity check matrix having many single cyclic shifts, and cause performance degradation as if the matrix had four cycles. In this paper, we propose a system using a random interleaved array LDPC (RIA-LDPC) code combined with a reversed maximum-transition-run (MTR) code/error-correction codes (ECC). The system provides significant improvement in the error-rate floor and water-fall performance in short-block-length and high-rate codes.

## Concatenating a Structured LDPC Code and An RLL Code to Preserve Soft-Decoding, Structure, and Burst Correction

- **Status**: ✅
- **Reason**: 구조화 LDPC+RLL 연접, H행렬 수정으로 soft-decoding/구조/burst correction 동시 유지. 스토리지 ECC 코드설계 기법(B/E)
- **ID**: ieee:4261729
- **Type**: conference
- **Published**: 8-12 May 2
- **Authors**: Y. Han, W. E. Ryan
- **PDF**: https://ieeexplore.ieee.org/document/4261729
- **Abstract**: Error-control codes and runlength limited codes each provide critical roles in maintain data integrity on storage devices,with ECCs doing directly by inserting redundancy via some encoding algo-rithm,and RLL codes doing indirectly by facilitating timing recovery.In this paper,we add another two requirements to the RLL-LDPC concatenation.First,we require the LDPC code possess structure to facilitate encoder and decoder. Second,the nominal H matrix of the LDPC code must be modified to accommodate both the RLL constraint and the ability to correct long bursts[6].

## Coding gain by Integrated Interleaving ECC

- **Status**: ❌
- **Reason**: Integrated Interleaving ECC(부호 연접/인터리빙) 기법; SP 디코딩 적용 언급뿐, LDPC 자체 디코더·구성 신규 기여 없음
- **ID**: ieee:4262223
- **Type**: conference
- **Published**: 8-12 May 2
- **Authors**: H. Kamabe, H. Katou
- **PDF**: https://ieeexplore.ieee.org/document/4262223
...
- **Status**: ✅
- **Reason**: LDPC turbo equalization을 postprocessor로 사용, 복잡도 저감. 이식 가능 디코더 기법(C)
- **ID**: ieee:4261736
- **Type**: conference
- **Published**: 8-12 May 2
- **Authors**: B. M. Kurkoski, K. Yamaguchi
- **PDF**: https://ieeexplore.ieee.org/document/4261736
- **Abstract**: Post-Viterbi processors are used for detection of partial-response channels coded with weak parity codes, whereas turbo equalization is usually used for detection and decoding of strong low-density parity check (LDPC) codes. This digest discusses the use of turbo equalization for joint detection and decoding of parity codes that would be used in postprocessing systems. The proposed system has complexity significantly lower than conventional LDPC-turbo equalization systems, and has excellent performance vis-a-vis postprocessing systems. The flexibility of the proposed system is demonstrated by considering an unequal error protection (UEP) code which preferentially places Viterbi algorithm error events within Reed-Solomon symbol boundaries to decrease the sector error rate.

## Run-length Limited Codes with Free Distance Properties: Construction and Soft-Decision Decoding

- **Status**: ❌
- **Reason**: RLL 부호 구성+2-state BCJR 연판정 디코딩; LDPC는 외부 연접 부호로만 언급, 떼어낼 LDPC ECC 기법 없음(비-LDPC)
- **ID**: ieee:4262222
- **Type**: conference
- **Published**: 8-12 May 2
- **Authors**: H. Tiwari, A. Thangaraj
- **PDF**: https://ieeexplore.ieee.org/document/4262222
...
- **Status**: ✅
- **Reason**: 자기기록 채널용 LDPC FPGA 평가 시스템(BER 10^-11까지)-스토리지 ECC HW 평가, 이식 가능 HW/평가 기법(D)
- **ID**: ieee:4262225
- **Type**: conference
- **Published**: 8-12 May 2
- **Authors**: X. Hu, B. Vijaya Kumar, L. Sun +1
- **PDF**: https://ieeexplore.ieee.org/document/4262225
...
## Random Coding Union Bounds for LDPC Coded MIMO Systems

- **Status**: ❌
- **Reason**: MIMO LDPC의 랜덤코딩 union bound 순수 이론; 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:1683289
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: Jingqiao Zhang, Heung-No Lee
- **PDF**: https://ieeexplore.ieee.org/document/1683289
- **Abstract**: Under the assumption of random coding, we derive a closed-form union bound on the error performance of MIMO systems. The distance spectrum of random block codes, instead of that of LDPC or turbo codes, is used in this paper for the purpose of closed-form derivation. As compared with the simulation results, the bound is useful as a performance benchmark for a concatenated coding scheme over MIMO systems in which the LDPC or turbo code serves as the outer code to drive an inner space-time modulation block. In addition, the derived closed-form error exponent and cutoff rate are consistent with Gallager's random coding exponent and the information-theoretic channel capacity in a variety of modulation and channel scenarios

## On the Performance of LDPC Codes with Differential Detection over Rayleigh Fading Channels

- **Status**: ✅
- **Reason**: LDPC 디코더의 SNR 미스매치 민감도 분석·LLR 메트릭 유도—LLR 양자화/추정 robust화는 NAND LDPC에 이식 가능(C)
- **ID**: ieee:1683285
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: H. Tatsunami, K. Ishibashi, H. Ochiai
- **PDF**: https://ieeexplore.ieee.org/document/1683285
...
- **Status**: ❌
- **Reason**: RA 부호용 결정론적 인터리버 설계 — 비-LDPC(RA) 부호 특화, LDPC BP에 이식할 디코더 기법 없음
- **ID**: ieee:1683056
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: S.J. Johnson, S.R. Weller
- **PDF**: https://ieeexplore.ieee.org/document/1683056
...
- **Status**: ❌
- **Reason**: MIMO-OFDM-BICM 실내채널 성능평가 — LDPC를 부수적 코딩옵션으로 비교만, 떼어낼 신규 기법 없음
- **ID**: ieee:1683221
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: H. Suzuki, M. Hedley, G. Daniels +1
- **PDF**: https://ieeexplore.ieee.org/document/1683221
...
## Code Design of Type-II Hybrid ARQ with Iterative Receivers over ISI Channels

- **Status**: ❌
- **Reason**: ISI 채널 type-II HARQ 부호설계 — convolutional/turbo/SCSPC 대상, LDPC BP 이식 기법 없음
- **ID**: ieee:1683206
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: A. Chuang, I.B. Collings
- **PDF**: https://ieeexplore.ieee.org/document/1683206
- **Abstract**: This paper examines type-II ARQ (incremental redundancy) systems over equalized inter-symbol interference (ISI) channels. We study the error rate and throughput performance of hybrid ARQ using convolutional codes, turbo codes and serially concatenated single parity check (SCSPC) codes. SCSPC codes are shown to provide an excellent performance complexity trade-off. Results demonstrate that both convolutional and SCSPC codes can outperform turbo codes in the ARQ framework. This is in direct contrast to previous work on AWGN channels. Finally, we propose a design rule to find good packet lengths for systems based on SCSPC

## Turbo Equalization of Coded OFDM Symbols in Poor HF Channels

- **Status**: ❌
- **Reason**: OFDM HF채널 turbo equalization 무선 수신기; LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:4054673
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: Oktay Ureten, Nur Serinken
- **PDF**: https://ieeexplore.ieee.org/document/4054673
- **Abstract**: In this paper, an iterative receiver that utilizes soft outputs of a FEC decoder to improve channel estimates iteratively is proposed. At each iteration, reliable symbols are selected and included in the extended training set. The channel is re-estimated using the extended set at successive iterations. The performance of the proposed technique is tested in simulated poor HF channels and shown to improve the performance by about 2 dB at a BER of 10-4 over the non-iterative case

## Rate-Compatible Shortened Turbo Product Codes

- **Status**: ❌
- **Reason**: Turbo product code 부호 설계·Gallager bound로 비-LDPC, 떼어낼 바이너리 LDPC BP 기법 없음
- **ID**: ieee:1683305
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: Dongning Feng, Jinhong Yuan, K. Amis
- **PDF**: https://ieeexplore.ieee.org/document/1683305
- **Abstract**: In this paper, we propose a set of design criteria of constructing shortened turbo product codes. Based on the criteria, we design two families of rate-compatible turbo product codes. The performance of rate-compatible turbo product codes is evaluated on the Gaussian channels using Monte Carlo simulations. We also propose a modified Gallager bounding technique to the rate-compatible turbo product codes. We show that the performance bound has a good match with the simulation results.

## On the Diversity and Multiplexing Tradeoff for MIMO Links with Imperfect CSIT

- **Status**: ❌
- **Reason**: MIMO diversity-multiplexing tradeoff 순수 이론 — LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:1683127
- **Type**: conference
- **Published**: 7-10 May 2
- **Authors**: A.W.C. Lim, V.K.N. Lau
- **PDF**: https://ieeexplore.ieee.org/document/1683127
...
## LDPC coded orthogonal frequency division multiplexing over the atmospheric turbulence channel

- **Status**: ❌
- **Reason**: 대기난류 채널 LDPC-OFDM 응용. LDPC 부수 언급, 떼어낼 디코더·코드설계 기법 없음
- **ID**: ieee:4627713
- **Type**: conference
- **Published**: 21-26 May 
- **Authors**: Ivan B. Djordjevic, Bane Vasic, Mark A. Neifeld
- **PDF**: https://ieeexplore.ieee.org/document/4627713
- **Abstract**: LDPC coded optical orthogonal frequency division multiplexing is shown to significantly outperform LDPC coded on-off keying over the atmospheric turbulence channel in terms of both coding gain and spectral efficiency.

## A bit-serial approximate min-sum LDPC decoder and FPGA implementation

- **Status**: ✅
- **Reason**: bit-serial min-sum 근사 check-update 신규 + FPGA 디코더 구현(D/C). NAND LDPC HW에 이식 가능
- **ID**: ieee:1692544
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: A. Darabiha, A.C. Carusone, F.R. Kschischang
- **PDF**: https://ieeexplore.ieee.org/document/1692544
...
- **Status**: ✅
- **Reason**: 고율 QC-LDPC error floor 제거 설계규칙+고처리율 디코더 아키텍처 — 코드설계(E)+HW(D), error floor는 NAND 핵심
- **ID**: ieee:1693392
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: Hao Zhong, Tong Zhang, E.F. Haratsch
- **PDF**: https://ieeexplore.ieee.org/document/1693392
- **Abstract**: By implementing an FPGA-based simulator, we investigate the performance of high-rate quasi-cyclic (QC) LDPC codes for the magnetic recording channel at very low sector error rates. Results show that error-floor-free performance can be realized by randomly constructed high-rate regular QC-LDPC codes with column weight 4 for sector error rates as low as 10/sup -9/. We also conjecture several rules for designing randomly constructed high-rate regular QC-LDPC codes with low error floor. We also present a decoder architecture that is well suited to achieving high decoding throughput for these high-rate QC-LDPC codes with low error floor.

## Decoders for low-density parity-check convolutional codes with large memory

- **Status**: ❌
- **Reason**: LDPC convolutional code 대용량 메모리 디코더 아키텍처 — SC-LDPC 변형이나 컨볼루셔널 특이적, NAND 블록 LDPC 이식성 낮음
- **ID**: ieee:1693780
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: S. Bates, L. Gunthorpe, A. Emre Pusane +3
- **PDF**: https://ieeexplore.ieee.org/document/1693780
...
- **Status**: ❌
- **Reason**: LDPC convolutional code 인코더 병렬화 — SC-LDPC 변형이나 인코더 한정이고 NAND 블록 LDPC 이식성 낮음(애매하나 컨볼루셔널 인코더 특이적)
- **ID**: ieee:1693711
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: S. Bates, Ramkrishna Swamy
- **PDF**: https://ieeexplore.ieee.org/document/1693711
...
- **Status**: ✅
- **Reason**: QC-LDPC 부분병렬 디코더 FPGA+비균일 양자화로 소프트메시지 메모리 축소 — LLR 양자화/HW(C/D), NAND 직접 관련
- **ID**: ieee:1693778
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: Zhiqiang Cui, Zhongfeng Wang
- **PDF**: https://ieeexplore.ieee.org/document/1693778
...
- **Status**: ✅
- **Reason**: 고율 QC-LDPC용 부분병렬 디코더 HW 아키텍처(modified min-sum, 데이터 스케줄링, 메모리 30%절감)로 D 이식 가능
- **ID**: ieee:1693781
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: Zhiqiang Cui, Zhongfeng Wang
- **PDF**: https://ieeexplore.ieee.org/document/1693781
...
- **Status**: ✅
- **Reason**: LDPC 디코더 message-passing 스케줄 개선(행/열 연산 파이프라인 동시화) 병렬 LSI — 이식 가능 디코더/HW(C/D)
- **ID**: ieee:1693779
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: K. Shimizu, T. Ishikawa, N. Togawa +2
- **PDF**: https://ieeexplore.ieee.org/document/1693779
...
- **Status**: ✅
- **Reason**: LDPC 디코더 BLER 개선 feedback 기법(C). 부호 비의존적 디코더 개선, NAND LDPC에 이식 가능성 있어 살림
- **ID**: ieee:1693071
- **Type**: conference
- **Published**: 21-24 May 
- **Authors**: X. Zheng, F.C.M. Lau, C.K. Tse +1
- **PDF**: https://ieeexplore.ieee.org/document/1693071

...
- **Status**: ❌
- **Reason**: 터보부호 설계 서베이(interleaver), 비-LDPC이고 LDPC로 떼어낼 신규 기법 없음
- **ID**: ieee:4282133
- **Type**: journal
- **Published**: June 2007
- **Authors**: Branka Vucetic, Yonghui Li, Lance C. Perez +1
- **PDF**: https://ieeexplore.ieee.org/document/4282133
...
- **Status**: ❌
- **Reason**: ARA codes for BEC, capacity-achieving ensemble — erasure 채널 점근 앙상블 이론, 떼어낼 NAND용 디코더/HW/구성 기법 없음
- **ID**: ieee:4215147
- **Type**: journal
- **Published**: June 2007
- **Authors**: Henry D. Pfister, Igal Sason
- **PDF**: https://ieeexplore.ieee.org/document/4215147
...
- **Status**: ❌
- **Reason**: rate-compatible IRA 코드 설계(puncturing/extending, HARQ용) — IRA 무선 ARQ 응용, 표준 density evolution 기반 구성, NAND용 새 이식 기법 약함
- **ID**: ieee:4237479
- **Type**: journal
- **Published**: June 2007
- **Authors**: Guosen Yue, Xiaodong Wang, Mohammad Madihian
- **PDF**: https://ieeexplore.ieee.org/document/4237479
...
- **Status**: ❌
- **Reason**: 채널코딩 역사 서베이(Hamming→capacity codes) — 리뷰, 구체적 신규 디코더/구성/HW 기여 없음
- **ID**: ieee:4282117
- **Type**: journal
- **Published**: June 2007
- **Authors**: Daniel J. Costello, G. David Forney
- **PDF**: https://ieeexplore.ieee.org/document/4282117
...
- **Status**: ❌
- **Reason**: 터보부호 서베이/응용 개관(통신 표준), 비-LDPC이고 떼어낼 신규 디코더/HW 없음
- **ID**: ieee:4282124
- **Type**: journal
- **Published**: June 2007
- **Authors**: Ken Gracie, Marie-HÉlÈne Hamon
- **PDF**: https://ieeexplore.ieee.org/document/4282124
- **Abstract**: For decades, the de facto standard for forward error correction was a convolutional code decoded with the Viterbi algorithm, often concatenated with another code (e.g., a Reed-Solomon code). But since the introduction of turbo codes in 1993, much more powerful codes referred to collectively as turbo and turbo-like codes have eclipsed classical methods. These powerful error-correcting techniques achieve excellent error-rate performance that can closely approach Shannon's channel capacity limit. The lure of these large coding gains has resulted in their incorporation into a widening array of telecommunications standards and systems. This paper will briefly characterize turbo and turbo-like codes, examine their implications for physical layer system design, and discuss standards and systems where they are being used. The emphasis will be on telecommunications applications, particularly wireless, though others are mentioned. Some thoughts on the use of turbo and turbo-like codes in the future will also be given.

## Novel RLL-ECC Concatenation Scheme for High-Density Magnetic Recording

- **Status**: ❌
- **Reason**: RLL-ECC 연접 스킴 — LDPC는 부수 언급, 인터리빙/연접 구조가 핵심, 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:4202832
- **Type**: journal
- **Published**: June 2007
- **Authors**: Jin Lu, Keith G. Boyer
- **PDF**: https://ieeexplore.ieee.org/document/4202832
- **Abstract**: We propose a new run-length-limited (RLL)/error correction coding (ECC) concatenation scheme based on uniform interleaving. The new scheme reverses the positions of the ECC encoder and the RLL encoder in the classical RLL-ECC structure. Further, a uniform interleaver on the sender side and a uniform deinterleaver on the receiver side are added to the new scheme. We prove that uniform interleaving can impose the required RLL constraint to the ECC encoded data. Our scheme solves the error propagation problem. It also adopts the use of soft decoding ECC such as low-density parity-check (LDPC) codes. Simulation results demonstrate that the new scheme can have a 7 dB gain over the traditional one
...
- **Status**: ❌
- **Reason**: 터보 디코더 최적성/쌍대성 순수 이론 tutorial - 디코더/HW/구성으로 안 이어지는 이론 분석
- **ID**: ieee:4282130
- **Type**: journal
- **Published**: June 2007
- **Authors**: Phillip A. Regalia, John MacLaren Walsh
- **PDF**: https://ieeexplore.ieee.org/document/4282130
...
- **Status**: ❌
- **Reason**: 터보 동기화(synchronization) 기법, ECC 디코더가 아니라 동기화 서브시스템 - 떼어낼 LDPC BP 기법 없음
- **ID**: ieee:4282126
- **Type**: journal
- **Published**: June 2007
- **Authors**: CÉdric Herzet, Nele Noels, Vincenzo Lottici +4
- **PDF**: https://ieeexplore.ieee.org/document/4282126
...
## Distributed Source Coding using non-binary LDPC codes for sensor network applications

- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC 기반 분산소스코딩(DSC) - 비이진+소스코딩 모두 제외 대상
- **ID**: ieee:4259766
- **Type**: conference
- **Published**: 6-8 June 2
- **Authors**: Madhurima Potluri, Suma Chilumuru, Sumakanth Kambhampati +1
- **PDF**: https://ieeexplore.ieee.org/document/4259766
...
- **Status**: ❌
- **Reason**: GLDPC/D-GLDPC stability condition on BEC - generalized 부호 임계값 이론, 떼어낼 디코더/HW/구성 없음
- **ID**: ieee:4557440
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Enrico Paolini, Marc Fossorier, Marco Chiani
- **PDF**: https://ieeexplore.ieee.org/document/4557440
...
- **Status**: ❌
- **Reason**: Slepian-Wolf 소스코딩(분산 소스 압축)용 rate adaptive LDPC - 채널 ECC 아님, 제외
- **ID**: ieee:4557405
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Jing Jiang, Dake He, Ashish Jagmohan
- **PDF**: https://ieeexplore.ieee.org/document/4557405
- **Abstract**: A rateless Slepian-Wolf coding (SWC) scheme based on rate adaptive low-density-parity-check (LDPC) codes is presented. We first motivate the application of punctured LDPC codes in SWC. A general rate adaptive LDPC framework is then described. The main idea is to adjust the puncturing ratio in the specified variable nodes for rate adaptivity while keeping the bipartite graph structure intact. As a complement, a repetition scheme is proposed for high rate SWC. The asymptotic performance of the proposed scheme is analyzed by density evolution (DE) with universal coding bounds and finite code length performance is verified by computer simulations.
...
- **Status**: ❌
- **Reason**: LDPC를 constellation shaping(에너지 최소화/소스 분포 성형)에 사용 — 채널 ECC가 아닌 소스/성형 코딩이라 떼어낼 ECC 기법 없음
- **ID**: ieee:4557573
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Sunil Kaimalettu, Andrew Thangaraj, Matthieu Bloch +1
- **PDF**: https://ieeexplore.ieee.org/document/4557573
...
- **Status**: ❌
- **Reason**: McEliece cryptosystem based on QC-LDPC; security/crypto domain, no portable channel-ECC decoder/HW technique.
- **ID**: ieee:4557609
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Marco Baldi, Franco Chiaraluce
- **PDF**: https://ieeexplore.ieee.org/document/4557609
...
- **Status**: ❌
- **Reason**: 양자 stabilizer 부호(qLDPC, quantum convolutional) 구성으로 CSS/non-CSS 양자 전용 개념 의존, 고전 LDPC 기법은 표준 QC-LDPC 재사용 수준
- **ID**: ieee:4557531
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Peiyu Tan, Jing Li
- **PDF**: https://ieeexplore.ieee.org/document/4557531
...
- **Status**: ❌
- **Reason**: Distributed estimation/Slepian-Wolf syndrome decoding (source coding context), not channel ECC; no portable technique.
- **ID**: ieee:4557603
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Amin Zia, James P. Reilly, Shahram Shirani
- **PDF**: https://ieeexplore.ieee.org/document/4557603
...
- **Status**: ❌
- **Reason**: maximally recoverable multi-protection group 부호 — erasure 구성/복구 이론, LDPC 아닌 일반 erasure 부호이며 떼어낼 BP/HW 기법 없음
- **ID**: ieee:4557272
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Minghua Chen, Cheng Huang, Jin Li
- **PDF**: https://ieeexplore.ieee.org/document/4557272
...
## Analysis of PCO Raptor codes and Turbo-Fountain Codes on Noiseless Channels

- **Status**: ❌
- **Reason**: Raptor/turbo fountain 부호의 noiseless 채널 효율 분석 — fountain/erasure 부호 이론, 떼어낼 LDPC ECC 디코더 기법 없음
- **ID**: ieee:4557261
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Alberto Tarable, Sergio Benedetto
- **PDF**: https://ieeexplore.ieee.org/document/4557261
...
- **Status**: ❌
- **Reason**: 삽입/삭제 정정용 moment balancing 템플릿 — 비-LDPC 범용 동기오류 정정, 떼어낼 LDPC BP 기법 없음
- **ID**: ieee:4557143
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Hendrik C. Ferreira, Khaled A. S. Abdel-Ghaffar, Ling Cheng +1
- **PDF**: https://ieeexplore.ieee.org/document/4557143
...
- **Status**: ❌
- **Reason**: LDPC 패리티검사 행렬을 패턴/측정 압축에 사용하는 패턴인식 시스템 설계 — 소스 압축 응용, 채널 ECC 디코더/HW/구성 기여 없음
- **ID**: ieee:4557243
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Po-Hsiang Lai, Joseph A. O'Sullivan
- **PDF**: https://ieeexplore.ieee.org/document/4557243
- **Abstract**: Pattern recognition systems based on compressed patterns and compressed sensor measurements can be designed using low-density matrices. We examine truncation encoding where a subset of the patterns and measurements are stored perfrectly while the rest is discarded. We also examine the use of LDPC parity check matrices for compressing measurements and patterns. We show how more general ensembles of good linear codes can be used as the basis for pattern recognition system design, yielding system design strategies for more general noise models.
...
- **Status**: ❌
- **Reason**: LDGM(저밀도 생성행렬) 협력 다이버시티 무선 응용 — 비-LDPC 부호이며 떼어낼 NAND ECC 기법 없음
- **ID**: ieee:4557103
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Lei Xiao, Thomas E. Fuja, Jorg Kliewer +1
- **PDF**: https://ieeexplore.ieee.org/document/4557103
...
- **Status**: ❌
- **Reason**: Gaussian relay 라우팅 문제 — LDPC는 시뮬레이션 베이스라인일 뿐, 떼어낼 ECC 기법 없음
- **ID**: ieee:4557364
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Lawrence Ong, Mehul Motani
- **PDF**: https://ieeexplore.ieee.org/document/4557364
...
- **Status**: ❌
- **Reason**: Rayleigh 페이딩 ARMA/Kalman 채널추정 — LDPC 무관, 떼어낼 기법 없음
- **ID**: ieee:4557388
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Alan Barbieri, Amina Piemontese, Giulio Colavolpe
- **PDF**: https://ieeexplore.ieee.org/document/4557388
...
- **Status**: ❌
- **Reason**: Hadamard/RZH 부호용 EXIT 함수 — 비-LDPC, 바이너리 LDPC BP에 떼어낼 기법 없음
- **ID**: ieee:4557335
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Kai Li, Xiaodong Wang, Alexei Ashikhmin
- **PDF**: https://ieeexplore.ieee.org/document/4557335
- **Abstract**: We investigate the extrinsic information transfer (EXIT) functions of Hadamard codes in the context of repeat- zigzag Hadamard (RZH) codes with parallel decoding. The derived EXIT functions can serve as an effective tool for designing low-rate IRZH codes with parallel decoding in BIAWGN channels.
...
- **Status**: ❌
- **Reason**: CDMA 멀티유저 검출(soft-PIC, BP 검출기) 동역학 분석 — 무선 검출 응용, NAND LDPC ECC로 떼어낼 디코더 기법 없음
- **ID**: ieee:4557159
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: K. Mimura, M. Okada
- **PDF**: https://ieeexplore.ieee.org/document/4557159
- **Abstract**: We investigate detection dynamics of a soft parallel interference canceller (soft-PIC), which includes a hard PIC as a special case, for CDMA multiuser detection, applied to a randomly spread, fully synchronous base-band uncoded CDMA channel model with additive white Gaussian noise (AWGN) under perfect power control in the large-system limit. We analyze the detection dynamics of the soft-PIC and the belief-propagation-based detector by the generating functional analysis (GFA). The GFA allows us to study the dynamics of infinitely large disordered system in an exact way.

## Multilevel Coding for Fading Channels

- **Status**: ❌
- **Reason**: 페이딩 채널 다단계 코딩·채널추정 — 무선 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:4557385
- **Type**: conference
- **Published**: 24-29 June
- **Authors**: Mei Chen, Oliver M. Collins
- **PDF**: https://ieeexplore.ieee.org/document/4557385
- **Abstract**: This paper proposes a multilevel coding system with linear mapping for fading channels. The receiver performs multi-stage decoding. Each stage employs the decision-aided successive estimation and decoding method that decouples the channel estimation and decoding without loss of information. As a result, existing codes designed for memoryless channels can be applied directly. The overall system can achieve the constrained capacity of the fading channel with a given input distribution, provided that the memoryless channel codes are capacity achieving and the channel estimator is lossless. This paper uses the block fading channel as example, and derives a low complexity channel estimator. For i.i.d. Gaussian inputs, the estimator is lossless and so the multilevel coding system achieves the mutual information of the channel. For QAM inputs, the same estimator is shown numerically to have good performance.
...
- **Status**: ❌
- **Reason**: McEliece 암호시스템용 QC-LDPC — 보안 응용, 원칙 제외
- **ID**: ieee:4288832
- **Type**: conference
- **Published**: 24-28 June
- **Authors**: M. Baldi, F. Chiaraluce, R. Garello +1
- **PDF**: https://ieeexplore.ieee.org/document/4288832
...
- **Status**: ❌
- **Reason**: 고차변조 UEP-LDPC 코드 설계 — 변조/Gray매핑 의존 무선 응용 특이, 떼어낼 NAND 이식 기법 없음
- **ID**: ieee:4288828
- **Type**: conference
- **Published**: 24-28 June
- **Authors**: N. von Deetzen, S. Sandberg
- **PDF**: https://ieeexplore.ieee.org/document/4288828
...
- **Status**: ❌
- **Reason**: MIMO MMSE-SIC용 비트 매핑 방식 평가 — 무선 SIC 특이적, LDPC는 외부부호 베이스라인, 떼어낼 디코더 기법 없음
- **ID**: ieee:4289477
- **Type**: conference
- **Published**: 24-28 June
- **Authors**: S. Gounai, T. Ohtsuki
- **PDF**: https://ieeexplore.ieee.org/document/4289477
...
- **Status**: ❌
- **Reason**: 협력 다이버시티용 반복부호+SPC product code — 비-LDPC 부호, 떼어낼 BP 기법 없음
- **ID**: ieee:4289649
- **Type**: conference
- **Published**: 24-28 June
- **Authors**: P. Loskot, N. C. Beaulieu
- **PDF**: https://ieeexplore.ieee.org/document/4289649
...
- **Status**: ❌
- **Reason**: 분산 소스코딩(Slepian-Wolf 압축)용 irregular turbo code 최적화 — 소스코딩+비-LDPC 부호, 떼어낼 BP 이식 기법 없음
- **ID**: ieee:4288834
- **Type**: conference
- **Published**: 24-28 June
- **Authors**: D. Van Renterghem, X. Jaspar, B. Macq +1
- **PDF**: https://ieeexplore.ieee.org/document/4288834
...
- **Status**: ❌
- **Reason**: WSN 멀티홉에 LDPC 디코딩 반복 배분 알고리즘, 네트워크 응용 특이적이라 이식 가능 디코더/HW 없음
- **ID**: ieee:4292846
- **Type**: conference
- **Published**: 18-21 June
- **Authors**: Saad Bin Qaisar, Hayder Radha
- **PDF**: https://ieeexplore.ieee.org/document/4292846
...
## Channel equalization in widwband single-carrier transmission using a filter bank transform and a block interleaved DFE

- **Status**: ❌
- **Reason**: 광대역 단일반송파 DFE 등화/복호, LDPC 코드드 베이스라인일 뿐 이식 가능 ECC 기법 없음
- **ID**: ieee:4401412
- **Type**: conference
- **Published**: 17-20 June
- **Authors**: Yuan Yang, Markku Renfors
- **PDF**: https://ieeexplore.ieee.org/document/4401412
- **Abstract**: This paper explores a low-complexity decision feedback equalization/decoding scheme, which uses filter bank frequency-domain equalizer and noise prediction in feedforward and feedback filter, respectively. Its performance is evaluated with extended Vehicular A channel model of ITU-R in LDPC coded single-carrier modulation. Simulation results show that the equalization/decoding scheme with symbol-wise block interleaver can achieve a considerable performance improvement over linear equalizer. Moreover, its performance comparison to widely-used turbo equalizer approach is also included, showing minor performance degradation with considerably reduced complexity.

## A new transmitter concept for iteratively-decoded source-channel coding schemes

- **Status**: ❌
- **Reason**: 반복 소스-채널 결합부호화(ISCD/JSCC), 단일패리티+VLC 매핑이라 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:4401369
- **Type**: conference
- **Published**: 17-20 June
- **Authors**: Ragnar Thobaben
- **PDF**: https://ieeexplore.ieee.org/document/4401369
...
- **Status**: ❌
- **Reason**: 가우시안 프로세스 채널 등화기 soft출력, LDPC 디코더가 아니라 등화기라 이식 기법 없음
- **ID**: ieee:4401349
- **Type**: conference
- **Published**: 17-20 June
- **Authors**: Fernando Perez-Cruz, Pablo Martinez-Olmos, Juan Jose Murillo-Fuentes
- **PDF**: https://ieeexplore.ieee.org/document/4401349

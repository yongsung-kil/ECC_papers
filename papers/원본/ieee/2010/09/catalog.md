...
- **Status**: ✅
- **Reason**: BF 디코딩 적응형 임계값 기법 — NAND LDPC에 이식 가능한 저복잡도 디코더 개선(C)
- **ID**: ieee:5534605
- **Type**: journal
- **Published**: September 
- **Authors**: Junho Cho, Wonyong Sung
- **PDF**: https://ieeexplore.ieee.org/document/5534605
...
- **Status**: ✅
- **Reason**: 효율적 인코딩 가능한 비정규 QC-LDPC 신규 구성(MDS self-reciprocal 다항식) — 바이너리 코드설계(E)
- **ID**: ieee:5557641
- **Type**: journal
- **Published**: September 
- **Authors**: Norifumi Kamiya
- **PDF**: https://ieeexplore.ieee.org/document/5557641
- **Abstract**: This letter presents a class of quasi-cyclic (QC) low-density parity-check (LDPC) codes which are efficiently encodable and have better memory efficiency than other randomly constructed QC-LDPC codes. The parity-check matrix of the codes is obtained from a block circulant matrix that is generated from a self-reciprocal generator polynomial of a maximum distance separable (MDS) code by replacing some of its block entries by all zero matrices. We show by simulations that the codes can achieve excellent error performance.
...
- **Status**: ✅
- **Reason**: protograph 기반 구조화 LDPC 신규 구성(MLS), HW친화·저복잡도 인코딩 — 바이너리 코드설계 기법(E) 이식 가능
- **ID**: ieee:5466219
- **Type**: journal
- **Published**: Sept. 2010
- **Authors**: Nicholas Bonello, Sheng Chen, Lajos Hanzo
- **PDF**: https://ieeexplore.ieee.org/document/5466219
...
- **Status**: ✅
- **Reason**: PEG 변형(LPEG 수정)으로 빠른 인코딩 LDPC 구성 - girth 제약 코드설계 기법(E), 바이너리 LDPC에 이식 가능
- **ID**: ieee:5594175
- **Type**: conference
- **Published**: 6-9 Sept. 
- **Authors**: Xueqin Jiang, Mi Sung Lee, Moon Ho Lee
- **PDF**: https://ieeexplore.ieee.org/document/5594175
- **Abstract**: Progressive edge-growth (PEG) algorithm is known to construct low-density parity-check (LDPC) codes at finite code lengths with large girths. A simple variation of the PEG algorithm, linear-encoding PEG (LPEG) algorithm, can be applied to generate linear encodable LDPC codes. This paper presents a modified LPEG algorithm to construct fast encodable LDPC codes with a certain girth constraint. The presented fast encodable LDPC codes facilitate the parallel encoding processes for parity bit generations. Therefore, their encoding time is much shorter than that of LPEG codes.
...
- **Status**: ✅
- **Reason**: QC-LDPC puncturing 패턴 ILP 최적화(블록크기 독립) — 바이너리 QC-LDPC 코드 설계 신규 기여(E)
- **ID**: ieee:5613847
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: Anton Blad, Oscar Gustafsson, Meng Zheng +1
- **PDF**: https://ieeexplore.ieee.org/document/5613847
...
- **Status**: ✅
- **Reason**: dominant trapping set 탐색 알고리즘으로 error floor 추정/저-error-floor 설계 지원(E)
- **ID**: ieee:5613902
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: Mehdi Karimi Dehkordi, Amir H. Banihashemi
- **PDF**: https://ieeexplore.ieee.org/document/5613902
...
- **Status**: ✅
- **Reason**: LDPC 유한길이 저-BER 성능 빠른 시뮬(importance sampling) 기법, error floor 평가에 이식 가능(E 보조)
- **ID**: ieee:5613994
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: Takakazu Sakai, Koji Shibata
- **PDF**: https://ieeexplore.ieee.org/document/5613994
...
- **Status**: ✅
- **Reason**: LDPC convolutional code 앙상블 설계/임계값 분석 - SC-LDPC 구성 기법(E)으로 바이너리 LDPC 이식 가능
- **ID**: ieee:5613891
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: Michael Lentmaier, David G.M. Mitchell, Gerhard Fettweis +1
- **PDF**: https://ieeexplore.ieee.org/document/5613891
...
- **Status**: ✅
- **Reason**: 멀티표준 turbo/LDPC 디코더 ASIC VLSI 아키텍처 - 바이너리 LDPC 디코더 HW(D) 이식 가능
- **ID**: ieee:5613886
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: Giuseppe Gentile, Massimo Rovini, Luca Fanucci
- **PDF**: https://ieeexplore.ieee.org/document/5613886
...
- **Status**: ✅
- **Reason**: absorbing set 제거로 error floor 개선하는 신규 코드설계 기법(E), 기존 HW 호환 강조
- **ID**: ieee:5613896
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: Lara Dolecek, Jiadong Wang, Zhengya Zhang
- **PDF**: https://ieeexplore.ieee.org/document/5613896
...
- **Status**: ✅
- **Reason**: fading+Gaussian 양채널용 universal LDPC 코드앙상블 신규 구성(E) - 애매하나 살림
- **ID**: ieee:5613805
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: Dieter Duyck, Marc Moeneclaey, Marwan H. Azmi +2
- **PDF**: https://ieeexplore.ieee.org/document/5613805
...
- **Status**: ✅
- **Reason**: Finite Alphabet Iterative Decoding(FAID) — 유한알파벳 양자화 디코더로 trapping set 극복, min-sum/BP 개선 이식 가능 디코더(C)
- **ID**: ieee:5613861
- **Type**: conference
- **Published**: 6-10 Sept.
- **Authors**: David Declercq, Ludovic Danjean, Erbao Li +2
- **PDF**: https://ieeexplore.ieee.org/document/5613861
...
- **Status**: ✅
- **Reason**: check node merging으로 LP 디코딩 개선 + LDPC 최소거리 하한 — LDPC 디코더 개선(C)/구성 분석(E) 이식 가능
- **ID**: ieee:5592887
- **Type**: conference
- **Published**: 30 Aug.-3 
- **Authors**: David Burshtein, Idan Goldenberg
- **PDF**: https://ieeexplore.ieee.org/document/5592887
...
- **Status**: ✅
- **Reason**: permutation matrix 기반 구조적 바이너리 LDPC, small trapping set 제거 구성 — 코드설계(E)/HW permutation 이식 가능
- **ID**: ieee:5592767
- **Type**: conference
- **Published**: 30 Aug.-3 
- **Authors**: Dung Viet Nguyen, Bane Vasić, Michael Marcellin +1
- **PDF**: https://ieeexplore.ieee.org/document/5592767
...
- **Status**: ✅
- **Reason**: 이식 가능 코드 설계(E): QC-LDPC 구성, protograph 선택과 circulant array로 minimum distance 상한 개선 - 바이너리 QC-LDPC 설계 기법
- **ID**: ieee:5592641
- **Type**: conference
- **Published**: 30 Aug.-3 
- **Authors**: David G. M. Mitchell, Roxana Smarandache, Michael Lentmaier +1
- **PDF**: https://ieeexplore.ieee.org/document/5592641
...
- **Status**: ✅
- **Reason**: IRA계 LDPC형 부호의 error floor 개선 코드설계+density evolution — 사이클/floor 저감 코드설계(E) 이식 가능
- **ID**: ieee:5592734
- **Type**: conference
- **Published**: 30 Aug.-3 
- **Authors**: David F. Hayes, Sarah J. Johnson, Steven R. Weller
- **PDF**: https://ieeexplore.ieee.org/document/5592734
...
- **Status**: ✅
- **Reason**: polar용 sparse factor graph 위 LP/BP 디코딩 — 비-LDPC지만 sparse 그래프 BP 디코더 기법이 부호 비의존적으로 바이너리 LDPC BP에 이식 가능(C, 애매→살림)
- **ID**: ieee:5592698
- **Type**: conference
- **Published**: 30 Aug.-3 
- **Authors**: Naveen Goela, Satish Babu Korada, Michael Gastpar
- **PDF**: https://ieeexplore.ieee.org/document/5592698
...
- **Status**: ✅
- **Reason**: spatial coupling(컨볼루셔널 LDPC)의 BP threshold 향상 일반화 — SC-LDPC 코드설계(E) 원리 이식 가능
- **ID**: ieee:5592881
- **Type**: conference
- **Published**: 30 Aug.-3 
- **Authors**: S. Hamed Hassani, Nicolas Macris, Ruediger Urbanke
- **PDF**: https://ieeexplore.ieee.org/document/5592881
...
- **Status**: ✅
- **Reason**: 고처리율 LDPC 디코더의 면적/타이밍/에너지 HW 비용 모델 도출, NAND LDPC 디코더 HW 설계에 이식 가능(D)
- **ID**: ieee:5625546
- **Type**: conference
- **Published**: 29-30 Sept
- **Authors**: Matthias Korb, Tobias G. Noll
- **PDF**: https://ieeexplore.ieee.org/document/5625546
...
## Encoding of certain LDPC codes with decoding resources

- **Status**: ✅
- **Reason**: 디코딩 자원 재사용으로 LDPC 인코딩 — 인코더/디코더 HW 자원 공유 아키텍처는 NAND 컨트롤러 구현에 이식 가능(D)
- **ID**: ieee:5671798
- **Type**: conference
- **Published**: 26-30 Sept
- **Authors**: Z. H. Cai, P. S. Chin, J. Hao +2
- **PDF**: https://ieeexplore.ieee.org/document/5671798
- **Abstract**: This paper addresses the issue of encoding of LDPC codes for certain transmission standards that employ LDPC as coding scheme. It is shown that for these LDPC codes, the encoding can be done simply by reusing decoding resources with negligible overhead. Compared to conventional encoding designs, our approach requires much less resources specified for encoder.

## Low latency low power bit flipping algorithms for LDPC decoding

- **Status**: ✅
- **Reason**: 저지연·저전력 bit-flipping 알고리즘 신규 2종 + 조기정지 — NAND LDPC 디코더 HW에 직접 이식 가능(C/D)
- **ID**: ieee:5671820
- **Type**: conference
- **Published**: 26-30 Sept
- **Authors**: Mohamed Ismail, Imran Ahmed, Justin Coon +3
- **PDF**: https://ieeexplore.ieee.org/document/5671820
...
- **Status**: ✅
- **Reason**: 비정규 LDPC degree profile 설계(GA/factor graph), 이식 가능 코드설계(E)일 수 있어 애매하므로 살림
- **ID**: ieee:5702969
- **Type**: conference
- **Published**: 26-29 Sept
- **Authors**: Jingxi Zhang, Zhisong Bie, Weiling Wu
- **PDF**: https://ieeexplore.ieee.org/document/5702969
- **Abstract**: A method to enhance the performance of IDMA system by means of irregular LDPC codes was studied. Interleavers were used as signature character for user identification and iterative turbo detection and decoding approach was employed with reduced complexity. Gaussian approximation was applied to approximate the message probability density function on factor graph with multiple users. Iterative message update formulas on factor graph were derived. Degree profiles were obtained by using the iterative formula. Simulation result shows that the performance of irregular LDPC-Coded LDMA system is better than that of (3,6) regular LDPC-Coded IDMA system in terms of BER and performance gain about 0.6 dB is achieved at BER 10s with 8 users for AWGN multiple access channel.
...
## Performance optimization of LDPC codes using selective coding approach and beacon parity check matrix

- **Status**: ✅
- **Reason**: selective coding+beacon 패리티검사행렬 신규 구성 제안(바이너리 코드설계 E), 애매하나 살림
- **ID**: ieee:5657851
- **Type**: conference
- **Published**: 24-26 Sept
- **Authors**: Tariq Aziz, Muhammad Iqbal, Muhammad Adnan +2
- **PDF**: https://ieeexplore.ieee.org/document/5657851
- **Abstract**: In this paper we have presented a novel idea to optimize the performance of Low Density Parity Check (LDPC) Codes by using selective encoding and decoding approach. We have also proposed a new simplified form of parity check matrix, h named as beacon matrix which is useful for the efficient implementation of the proposed scheme. The proposed scheme is more suitable for real time applications like voice and video where bandwidth and delay are important considerations. The simulation results validate that bit error rate (BER) performance of LDPC codes is improved significantly by using the proposed scheme.
...
- **Status**: ✅
- **Reason**: M-SC-MPC 구조화 바이너리 LDPC에 수정 PEG로 short cycle 제거하는 신규 코드설계 — 이식 가능(E)
- **ID**: ieee:5623671
- **Type**: conference
- **Published**: 23-25 Sept
- **Authors**: Marco Baldi, Giovanni Cancellieri, Franco Chiaraluce +1
- **PDF**: https://ieeexplore.ieee.org/document/5623671
...
- **Status**: ✅
- **Reason**: Group shuffled BP(GSBP) 빠른 수렴 디코더의 Gaussian approximation 분석 — 부호 비의존적 BP 스케줄링 개선이라 바이너리 LDPC에 이식 가능(C)
- **ID**: ieee:5600988
- **Type**: conference
- **Published**: 23-25 Sept
- **Authors**: Zhenzhen Song, Runbo Yu, Piming Ma
- **PDF**: https://ieeexplore.ieee.org/document/5600988
- **Abstract**: Group shuffled belief propagation (GSBP) algorithm is a modified algorithm to decode LDPC codes. Compared with belief propagation decoding, this algorithm converges faster. In this paper, we analyze the performance of GSBP decoding by means of Gaussian approximation. Under the assumption of Gaussian density, the updating message means during GSBP decoding are derived. The results show that the proposed algorithm can verify the fast convergence property of GSBP decoding effectively.
...
- **Status**: ✅
- **Reason**: joint LDPC 디코딩+동기화 FPGA 구현, 심우주통신. HW 아키텍처 기법(D) 이식 여지 있어 애매하면 in
- **ID**: ieee:5600957
- **Type**: conference
- **Published**: 23-25 Sept
- **Authors**: Zengran Wan, Yafeng Zhan, Jianqiang Wu +1
- **PDF**: https://ieeexplore.ieee.org/document/5600957
- **Abstract**: A receiver structure based on a joint LDPC decoding and synchronization algorithm and realized on an FPGA platform is introduced. The realization system achieves the BER of 1e-5 at the channel SNR of -4.6 dB with moderate hardware complexity, and the performance degradation is less than 1.3 dB from the ideal situation. So it is suitable for deep space communications and other wireless communicatio...
...
- **Status**: ✅
- **Reason**: LDPC VLSI 디코더 on-the-fly syndrome check HW 최적화(D), NAND 디코더에 이식 가능
- **ID**: ieee:5629283
- **Type**: conference
- **Published**: 20-25 Sept
- **Authors**: Erick Amador, Raymond Knopp, Renaud Pacalet +1
- **PDF**: https://ieeexplore.ieee.org/document/5629283
...
- **Status**: ✅
- **Reason**: protograph 기반 바이너리 LDPC 코드 설계·density evolution 분석(E), NAND 코드설계 이식 가능(애매시 살림)
- **ID**: ieee:5616834
- **Type**: conference
- **Published**: 20-23 Sept
- **Authors**: Patrick Grosa, Andre Fonseca dos Santos, Michael Lentmaier +2
- **PDF**: https://ieeexplore.ieee.org/document/5616834
...
- **Status**: ✅
- **Reason**: DVB-S2 LDPC 디코더 HW 구현, 메시지 양자화 trade-off와 check-node 보정 알고리즘(FOMS) 비교 — 이식 가능 디코더/HW 기법(C/D)
- **ID**: ieee:5615527
- **Type**: conference
- **Published**: 1-3 Sept. 
- **Authors**: Florent Berthelot, Francois Charot, Charles Wagner +1
- **PDF**: https://ieeexplore.ieee.org/document/5615527
- **Abstract**: The new Digital Video Broadcasting Satellite (DVB-S2) standard is able to provide capacity gains of about 30% over the previous standard by using a powerfull Forward Error Correction (FEC) scheme based on very large LDPC code words and BCH codes. The implementation of the DVBS2FEC decoder is a big challenge. The designer must deal with the overall design complexity and the decoding throughput in order to obtain a high decoding performance in terms of bit error rate (BER). We present in detail a complete design flow allowing a better understanding of the algorithm in terms of complexity, performance and its hardware implementation. We focus on complexity-performance trade-offs due to message quantizations and we compare its effects on several algorithm corrections used to check nodes for DVB-S2 decoding. The simulation results show that the best compromise between complexity and performance is obtained for the FOMS algorithm approximation.

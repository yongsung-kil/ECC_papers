...
- **Status**: ✅
- **Reason**: RC 바이너리 QC-LDPC 인코더 HW 아키텍처(dual-diagonal, q-parallel, circular shifter+XOR FPGA) - 이식 가능 HW(D)
- **ID**: ieee:10855823
- **Type**: journal
- **Published**: September 
...
- **Status**: ✅
- **Reason**: 스토리지용 바이너리 EG 기반 SC-LDPC 구성 및 weighted bit-flipping 디코딩 — 이식 가능 코드설계/디코더(범주 E/C)
- **ID**: ieee:7553579
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ✅
- **Reason**: 스토캐스틱 바이너리 LDPC 디코더 디코딩사이클 감소 전략+HW 구현 - 이식 가능 디코더/HW(C/D)
- **ID**: ieee:7419905
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: 비이진 NB-LDPC GF(64) EMS 디코더 - 비이진 LDPC 제외
- **ID**: ieee:7419880
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: 비이진(NB-LDPC) 코드 최적화 프레임워크 — 비이진 LDPC는 제외 대상
- **ID**: ieee:7553518
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ✅
- **Reason**: NAND용 LDPC 메시지패싱 디코딩 맵을 mutual-information 최대화 양자화로 생성하는 이식 가능 디코더 기법(범주 C)
- **ID**: ieee:7553561
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: 비이진 GF(q) QC-LDPC 구성(cycle code 기반) - non-binary LDPC는 제외 대상
- **ID**: ieee:7497526
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ✅
- **Reason**: 임의 Tanner 그래프의 elementary trapping set 완전 열거(B&B/ILP) - error floor 분석/코드설계(E) 이식 가능
- **ID**: ieee:7506265
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: GF(q) 비이진 SC-LDPC 윈도우 디코딩 설계; 비이진 LDPC 제외
- **ID**: ieee:7469375
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ✅
- **Reason**: 노이지 게이트 신뢰성 저하 메모리에서 LDPC 반복디코딩+decoder rewinding으로 trapping set 탈출 - 스토리지 ECC/디코더 기법(C) 이식 가능
- **ID**: ieee:7509624
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: 수중 음향 WSN용 spatial coding+LDPC-OFDM 협력 - LDPC 부수 사용, 떼어낼 디코더/코드 기법 없음
- **ID**: ieee:7518674
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: multi-class source-channel coding - JSCC, LDPC 베이스라인이며 떼어낼 ECC 기법 없음
- **ID**: ieee:7506294
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: generalized concatenated(BCH+RS) 코드의 soft-input stack 디코딩 - 비-LDPC 부호, BP 비의존 trellis 기반이라 LDPC 이식성 없음
- **ID**: ieee:7509654
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: 암호화 이미지 데이터 은닉/보안; LDPC ECC 무관
- **ID**: ieee:7107988
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: BER 기반 물리계층 보안(strong converse+SPN error amplification) - 보안 도메인, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7513393
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: MAMR HDD 자기기록 read-write 성능; ECC/LDPC 무관
- **ID**: ieee:7471502
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: BMST-RUN 코드(repetition/uncoded의 spatial coupling) - 비-LDPC 부호 구성, 바이너리 LDPC BP 이식 기법 아님
- **ID**: ieee:7539706
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: MIMO SC-FDMA 신호검출(block circulant); 채널 ECC/LDPC 아님
- **ID**: ieee:7286855
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ✅
- **Reason**: MLC NAND 플래시 CCI 완화 검출기(neighbor-a-priori) - NAND 직접(A)
- **ID**: ieee:7407390
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: 2D 자기기록 turbo equalization+IRA 디코더 — 비-LDPC 부호이고 LLR 매핑이 2D-ISI 채널 의존, 떼어낼 바이너리 LDPC BP 기법 없음
- **ID**: ieee:7556284
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ✅
- **Reason**: MLC NAND 채널 용량·conditional statistics 기반 read-back(hard/soft) 및 ECC 아키텍처 설계(범주 A)
- **ID**: ieee:7553496
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: UEP 비디오 방송 multilevel coded modulation/rate allocation - LDPC 부수 언급, JSCC성 응용으로 떼어낼 디코더 기법 없음
- **ID**: ieee:7491279
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: BPMR용 turbo equalization 소프트정보 라우팅 개선 - 디텍터/이퀄라이저 결합 기법으로 LDPC 디코더 자체 기여 없음, 떼어낼 ECC 기법 없음
- **ID**: ieee:7480408
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: MLC 메모리 cell programming/coding 스킴(쓰기지연 단축, redundancy 없는 인코딩)으로 LDPC ECC 디코더/구성 기법 아님
- **ID**: ieee:7553436
- **Type**: journal
- **Published**: Sept. 2016
...
- **Status**: ❌
- **Reason**: QC-LDPC lattice 기반 비밀키 암호 시스템, 보안 응용으로 원칙 제외(채널 ECC 신규기법 아님)
- **ID**: ieee:7736446
- **Type**: conference
- **Published**: 7-8 Sept. 
...
- **Status**: ✅
- **Reason**: 신규 CPEG 구성 알고리즘으로 girth·ACE·stopping set 개선, 이진 단블록 코드설계(E)
- **ID**: ieee:7593102
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: large girth QC-LDPC용 개선 PEG 구성(사이클 제거), 바이너리 코드설계 기법 이식 가능(E)
- **ID**: ieee:7593094
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 비이진(non-binary GF(q)) LDPC 구조 분석 - 비이진 LDPC 제외
- **ID**: ieee:7593070
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 이진 LDPC min-sum의 고SNR 선형모델·trapping set 기반 error floor 예측, 디코더/코드설계 분석(C/E)
- **ID**: ieee:7593100
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: ME-LDPC+Trellis Shaping의 OFDM PAR 저감, 무선 응용 특이적·LDPC 베이스라인
- **ID**: ieee:7593114
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: NB-LDPC(GF(64)) 비이진 체크노드, 바이너리 LDPC만 포함 원칙 위배
- **ID**: ieee:7593104
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: multi-weight circulant 기반 고율 QC-LDPC 신규 구성 + EMPEG 일반화, 바이너리 코드설계(E)
- **ID**: ieee:7593069
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: (3,L) 바이너리 QC-LDPC, 비동형 코드 분류·사이클 카운팅·girth 최적화 신규 구성 알고리즘 — 코드설계 E
- **ID**: ieee:7593119
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: ADMM 기반 LDPC 디코딩 스케줄링 비교, layered 스케줄 등 이식 가능 디코더 기법(C)
- **ID**: ieee:7593075
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 바이너리 QC-LDPC의 저복잡도 near-ML wrap-around 슬라이딩윈도우 디코더 - 이식 가능 디코더(C)
- **ID**: ieee:7593068
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 이진 SC-LDPC BP의 stopping set·error floor 분석, NAND LDPC 코드설계(E)에 이식 가능
- **ID**: ieee:7593098
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 비이진 NB-LDPC를 coded modulation에 최적화 — 비이진 LDPC 제외
- **ID**: ieee:7593124
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 심볼-튜플 오류채널용 LDPC 메시지패싱 디코더 유도 — 바이너리 LDPC 디코더 기법 C
- **ID**: ieee:7593120
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 유한길이 quasi-synchronous LDPC 디코더, 에너지·타이밍·게이트레벨 분석 — 이식 가능 HW 아키텍처 D
- **ID**: ieee:7593130
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 프로토그래프 기반 rate-compatible LDPC 앙상블 설계(E), 바이너리 LDPC 구성 기법 이식 가능
- **ID**: ieee:7593085
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 확률적 셰이핑(PAS) 기반 rate-adaptive용 프로토그래프 LDPC 설계 - 무선 변조 응용 특이적, 떼어낼 ECC 기법 약함
- **ID**: ieee:7593076
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: SC-LDPC 비정규 종단 최적화로 rate-loss 개선하는 신규 코드설계(E), 바이너리 BEC
- **ID**: ieee:7593071
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: robust computing 서베이/방향제시, 구체적 신규 디코더/구성 기여 없음
- **ID**: ieee:7593087
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: Trellis-Constrained Codes(turbo 일반화), 효율적 디코더 없음·ML 바운드 이론 — 비-LDPC, 이식 가능 BP 기법 없음
- **ID**: ieee:7593118
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: rate-compatible LDPC HARQ 프로토콜, 무선 응용 특이적이고 떼어낼 NAND ECC 기법 없음
- **ID**: ieee:7593109
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: GF(q) 비이진 LDPC (q-ary measurement channel) — 바이너리 LDPC만 포함 대상이므로 제외
- **ID**: ieee:7593117
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: Balanced locally repairable codes — LRC 스토리지지만 LDPC 아님, 떼어낼 BP/디코더 기법 없음
- **ID**: ieee:7593121
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: Two-Way Relay용 Noisy Network Coding 응용, LDPC는 베이스라인이고 NAND에 이식할 ECC 기법 없음
- **ID**: ieee:7593083
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: LDPC syndrome entropy 상한 바운드(density evolution) — 순수 이론 bound, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:7593128
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: EXIT chart 기울기 튜닝 가능한 바이너리 LDPC 앙상블 설계 알고리즘(E)
- **ID**: ieee:7593090
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: tail-biting SC-LDPC의 wave-like 디코딩으로 rate-loss 완화(E), 바이너리 SC-LDPC 구성 기법 이식 가능
- **ID**: ieee:7593089
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: spatial coupling+compressed sensing 기반 신규 FEC 스킴, 짧은 블록 — SC-LDPC 코드설계 가능성, 애매하나 살림(E)
- **ID**: ieee:7593147
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: LDPC LP 디코딩의 ADMM/simplex 복잡도 비교, HW 구현 지향 디코더 기법(C/D) 이식 가능
- **ID**: ieee:7593107
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 불규칙 LDPC용 적응형 Min-Sum 스케일링(상호정보 기반)으로 이식 가능한 디코더 알고리즘(C)
- **ID**: ieee:7593079
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: convolutional lattice/turbo signal codes (비-LDPC), 이식 가능 BP 기법 없음
- **ID**: ieee:7593088
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ✅
- **Reason**: 수정 augmented BP 디코더, near-ML·저복잡도 신규 디코더 기법(C) 이식 가능
- **ID**: ieee:7593103
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 실수 부호+LP 디코딩 기반 병렬 선형필터 fault-tolerance, 이진 LDPC ECC 기법 아님
- **ID**: ieee:7593105
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 일반화 product code(비-LDPC)의 DE·coded modulation bit mapper, 이식할 LDPC ECC 기법 없음
- **ID**: ieee:7593112
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 상관소스 비직교 MARC 전송 outage 분석(JSCC/물리계층 네트워크코딩) - LDPC 부수, 떼어낼 ECC 기법 없음
- **ID**: ieee:7593078
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 비이진(소수체 GF) 선형부호 LP 디코딩, 비이진 LDPC 제외 원칙
- **ID**: ieee:7593086
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: coded slotted ALOHA 접속 프로토콜 분석, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:7593081
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: q-ary Reed-Muller 부호의 지역정정 기반 소거정정 - 비-LDPC 부호, 이식 가능 BP 기법 없음
- **ID**: ieee:7593072
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 비이진 코드 기반 Construction-A 격자, 수체·코셋 — 바이너리 LDPC 아님
- **ID**: ieee:7593126
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 위상잡음 보상용 반복 동기화 수신기, 부호비의존 디코더 기법 없음(무선 응용 특이적)
- **ID**: ieee:7593065
- **Type**: conference
- **Published**: 5-9 Sept. 
...
- **Status**: ❌
- **Reason**: 비-LDPC(turbo) 부호 설계, LDPC는 비교 베이스라인이며 이식 가능 BP 기법 없음
- **ID**: ieee:7601543
- **Type**: conference
- **Published**: 5-7 Sept. 
...
- **Status**: ❌
- **Reason**: DVB-S2X MEO 위성 용량 평가, LDPC 디코더/구성 기여 없음
- **ID**: ieee:7601471
- **Type**: conference
- **Published**: 5-7 Sept. 
...
- **Status**: ❌
- **Reason**: 성좌 설계(QAM→APSK)로 LDPC 기법 없음
- **ID**: ieee:7601550
- **Type**: conference
- **Published**: 5-7 Sept. 
...
- **Status**: ❌
- **Reason**: 위성 신호처리(4D 성좌·MIMO·full-duplex)로 LDPC 기법 없음
- **ID**: ieee:7601468
- **Type**: conference
- **Published**: 5-7 Sept. 
...
- **Status**: ❌
- **Reason**: DOCSIS3.1 SDR 수신기, 'high-performance LDPC 디코더' 언급뿐 신규 디코더/HW 기법 미제시
- **ID**: ieee:7684733
- **Type**: conference
- **Published**: 5-7 Sept. 
...
- **Status**: ✅
- **Reason**: rate-compatible punctured LDPC 설계, density evolution 기반 puncturing 패턴 설계 기준(카테고리 E) 이식 가능.
- **ID**: ieee:7794684
- **Type**: conference
- **Published**: 4-8 Sept. 
...
- **Status**: ❌
- **Reason**: SCDT 결합 복조-디코딩 joint sparse graph 스케줄링, 다중접속 응용 특이적이라 떼어낼 순수 LDPC 기법 없음.
- **ID**: ieee:7794756
- **Type**: conference
- **Published**: 4-8 Sept. 
...
- **Status**: ❌
- **Reason**: 물리계층 네트워크코딩용 protograph 설계, CPNC 가상소거 응용 특이적이라 NAND 이식 기법 없음.
- **ID**: ieee:7794683
- **Type**: conference
- **Published**: 4-8 Sept. 
...
- **Status**: ❌
- **Reason**: 물리계층 Raptor(fountain) coded modulation, 비-LDPC fountain 부호로 원칙 제외.
- **ID**: ieee:7794682
- **Type**: conference
- **Published**: 4-8 Sept. 
...
- **Status**: ✅
- **Reason**: C/D: QC-LDPC 부분병렬 디코더 multi-domain 양자화 기법, 메모리 대역폭·HW 이식 가능
- **ID**: ieee:7723560
- **Type**: conference
- **Published**: 31 Aug.-2 
...
- **Status**: ✅
- **Reason**: D: 레이어드 QC-LDPC 디코더 아키텍처, 신규 VNU/CNU 처리유닛·65nm 구현으로 이식 가능
- **ID**: ieee:7723558
- **Type**: conference
- **Published**: 31 Aug.-2 
...
- **Status**: ❌
- **Reason**: NoC 링크용 2D parity check 코딩, LDPC 아님이며 NAND LDPC에 이식할 기법 없음
- **ID**: ieee:7579328
- **Type**: conference
- **Published**: 31 Aug.-2 
...
- **Status**: ❌
- **Reason**: 양자 LDPC 채널 mismatch 디코딩 전략; 양자 depolarizing 채널 전용 개념에 의존(고전 바이너리 이식 명확치 않음)
- **ID**: ieee:7760297
- **Type**: conference
- **Published**: 29 Aug.-2 
...
- **Status**: ❌
- **Reason**: 다중 기술 벡터 양자화 설계(소스 코딩/압축); 채널 ECC 아님
- **ID**: ieee:7760219
- **Type**: conference
- **Published**: 29 Aug.-2 
- **Authors**: Akinori Ito
...
- **Status**: ❌
- **Reason**: BCH/RS 멀티패스 활용; 비-LDPC, LDPC 이식 디코더 기법 없음
- **ID**: ieee:7835880
- **Type**: conference
...
- **Status**: ✅
- **Reason**: 근사컴퓨팅 응용이나 제약조건을 만족하는 semi-regular LDPC 코드 신규 구성을 제시(E, 바이너리), 애매하여 in 살림
- **ID**: ieee:7852336
- **Type**: conference
...
- **Status**: ✅
- **Reason**: Tanner graph 엣지 가중 딥러닝 BP 디코더(neural decoder) — 바이너리 LDPC BP에 직접 이식 가능(C)
- **ID**: ieee:7852251
- **Type**: conference
- **Published**: 27-30 Sept
...
- **Status**: ❌
- **Reason**: compressed sensing interval-passing 알고리즘 failing set(termatiko) 분석; LDPC 채널 ECC 디코더 아님(CS 복원)
- **ID**: ieee:7852245
- **Type**: conference
- **Published**: 27-30 Sept
...
- **Status**: ❌
- **Reason**: 압축센싱(compressed sensing) 신호복원용 sparse-graph code, 채널 ECC가 아니며 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:7852309
- **Type**: conference
- **Published**: 27-30 Sept
...
- **Status**: ✅
- **Reason**: D: partial-parallel SP LDPC 디코더 FPGA 구현, modified TPMP 스케줄링으로 clock/리소스/전력 절감 — 이식 가능 HW 기여
- **ID**: ieee:7881803
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 무선 NOMA MAC용 LDPC joint decoding 내·외부 반복 최적화 시뮬레이션, 응용 특이적이며 떼어낼 신규 ECC 기법 없음
- **ID**: ieee:7779328
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 선형부호의 데이터 양자화(소스코딩) 이론, 채널 ECC 아님이며 디코더/HW/구성 기여 없음
- **ID**: ieee:7779342
- **Type**: conference
- **Published**: 26-29 Sept
...
- **Status**: ❌
- **Reason**: polar code(RS kernel) directed search 디코딩, 부호 의존적 polar 전용 기법으로 바이너리 LDPC BP 이식 불가
- **ID**: ieee:7779336
- **Type**: conference
- **Published**: 26-29 Sept
...
- **Status**: ❌
- **Reason**: JSCC용 더블 protograph LDPC 이미지 전처리, JSCC 베이스라인이며 떼어낼 채널 ECC 기법 없음
- **ID**: ieee:7751602
- **Type**: conference
...
- **Status**: ✅
- **Reason**: E: BPMR 매체노이즈 채널용 LDPC 코드 최적화·threshold 계산, 바이너리 LDPC 코드설계 기법 이식 가능
- **ID**: ieee:7751601
- **Type**: conference
- **Published**: 26-28 Sept
...
- **Status**: ❌
- **Reason**: IoT 압축센싱 이상검출에 LDPC 패리티행렬·MP를 부수 활용, 채널 ECC 아니고 떼어낼 디코더 기법 없음
- **ID**: ieee:7751684
- **Type**: conference
- **Published**: 26-28 Sept
...
- **Status**: ❌
- **Reason**: 위성 레이저 통신 multi-LDPC-PPM 변조 결합, 떼어낼 신규 디코더/구성 없음(표준 LDPC 적용)
- **ID**: ieee:7875711
- **Type**: conference
...
- **Status**: ✅
- **Reason**: syndrome-weight 기반 신규 two-bit bit-flipping 디코더, 저복잡도 BF로 NAND LDPC 이식 가능(C)
- **ID**: ieee:7875795
- **Type**: conference
- **Published**: 24-27 Sept
...
- **Status**: ❌
- **Reason**: fountain code 협력 비디오 코딩, LDPC 비교 대상일 뿐 떼어낼 LDPC 기법 없음
- **ID**: ieee:7974592
- **Type**: conference
...
- **Status**: ✅
- **Reason**: PEG 변형으로 short-medium LDPC error floor 저감(girth 제어, OED edge density)=이식 가능 코드설계(E)
- **ID**: ieee:7772157
- **Type**: conference
...
- **Status**: ✅
- **Reason**: 심볼릭 하이퍼그래프 기반 SC-LDPC(컨볼루셔널) 코드 설계, syndrome former memory/short cycle 제거=이식 가능 코드설계(E)
- **ID**: ieee:7772132
- **Type**: conference
- **Published**: 22-24 Sept
...
- **Status**: ❌
- **Reason**: Golay (23,12) 인코더 HW 설계, 비-LDPC 부호
- **ID**: ieee:7732059
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 이미지 전송용 product code UEP 선형치환 모듈이 핵심, 떼어낼 일반 바이너리 LDPC 구성/디코더 기여 없음
- **ID**: ieee:7813407
- **Type**: conference
...
- **Status**: ❌
- **Reason**: AL-FEC(애플리케이션계층 FEC) erasure/피드백 기반, 채널 LDPC ECC 기법 아님
- **ID**: ieee:7813360
- **Type**: conference
- **Published**: 21-23 Sept
...
- **Status**: ❌
- **Reason**: 5G 다이버시티 결합용 LDPC 응용, LDPC 부수 활용이며 떼어낼 디코더·구성 기법 없음
- **ID**: ieee:7600909
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 수중음향 단일반송파 IB-DFE 등화기와 LDPC 결합(turbo equalization). LDPC는 베이스라인이고 떼어낼 신규 디코더/구성/HW 기여 없음, 응용 특이적
- **ID**: ieee:7761116
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LDPC를 압축센싱(CS) 센싱행렬로 사용하는 PEG 변형. 채널 ECC가 아닌 센싱행렬 구성이라 NAND ECC 디코더/코드설계로 이식 불가
- **ID**: ieee:7745704
- **Type**: conference
...
- **Status**: ✅
- **Reason**: HLS로 LDPC HARQ FPGA 디코더 구현(자원사용/처리량 측정). 이식 가능 HW 아키텍처(D)로 살림
- **ID**: ieee:7846753
- **Type**: conference
...
- **Status**: ❌
- **Reason**: DCT 도메인 비디오 스테가노그래피 with Hamming/BCH 부호. 비-LDPC 부호이고 떼어낼 BP 이식 기법 없음
- **ID**: ieee:7846757
- **Type**: conference
- **Published**: 19-21 Sept
...
- **Status**: ❌
- **Reason**: GF(32) 비이진 LDPC 변조 — 비이진 LDPC는 제외 대상
- **ID**: ieee:7769398
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 비이진(nonbinary) LDPC convolutional codes 광통신 실험 - 비이진 LDPC는 제외 대상
- **ID**: ieee:7767647
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ✅
- **Reason**: unit-memory SC-LDPC 코드 설계 가이드라인·수렴영역 분석 — 바이너리 SC-LDPC 구성 기법 이식 가능(E)
- **ID**: ieee:7767824
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ✅
- **Reason**: LDPC-CC 윈도우드 디코딩의 layered scheduling 최적화로 복잡도 70%·1dB 개선 — 부호 비의존적 디코더 스케줄링 기법 이식 가능(C/D)
- **ID**: ieee:7767648
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ❌
- **Reason**: 광네트워크용 scalable SD-FEC 개념 제시뿐, 떼어낼 구체적 LDPC 디코더·코드설계 기법 없음
- **ID**: ieee:7767649
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ❌
- **Reason**: PDM 256-QAM 확률적 셰이핑 광전송 실험 - 무선/광통신 응용 특이적, LDPC 부수, 떼어낼 ECC 기법 없음
- **ID**: ieee:7765586
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ❌
- **Reason**: AlGaAs 나노도파관 파장변환 광소자 — ECC/LDPC와 무관
- **ID**: ieee:7767680
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ❌
- **Reason**: LFSR 기반 광물리계층 보안(스크램블링) — ECC 아님, 보안 도메인
- **ID**: ieee:7767751
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ❌
- **Reason**: FTN 광전송용 soft demapping/THP precoding — LDPC 디코더 기법 아님, 떼어낼 ECC 기법 없음
- **ID**: ieee:7767726
- **Type**: conference
- **Published**: 18-22 Sept
...
- **Status**: ✅
- **Reason**: LDPC 디코더의 fault-tolerant/layered pipelined HW 아키텍처, V2C RAM 흡수로 메모리 절감 — 이식 가능 HW 기법(D)
- **ID**: ieee:7880909
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 협력 무선망용 soft angular modulation/SIF 릴레이 기법, LDPC는 부수 사용 — 떼어낼 디코더·코드설계 기여 없음
- **ID**: ieee:7881067
- **Type**: conference
- **Published**: 18-21 Sept
...
- **Status**: ❌
- **Reason**: 무선 릴레이/lossy forwarding 응용에 SC-LDPC 적용, 떼어낼 신규 디코더·코드설계 기법 없음
- **ID**: ieee:7881231
- **Type**: conference
- **Published**: 18-21 Sept
...
- **Status**: ❌
- **Reason**: Polar+STBC 구성 — 비-LDPC 부호, 부호 의존적이라 BP 이식 불가
- **ID**: ieee:7880938
- **Type**: conference
- **Published**: 18-21 Sept
...
- **Status**: ❌
- **Reason**: OFDM 파형 설계 논문, LDPC ECC 무관
- **ID**: ieee:7881580
- **Type**: conference
- **Published**: 18-21 Sept
...
- **Status**: ❌
- **Reason**: LT 코드(fountain/erasure) 저지연 인코딩, 비-LDPC 데이터 손실 복구로 ECC 기법 이식 불가
- **ID**: ieee:7802838
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 우주 업링크 단거리 LDPC 수신기 체인/동기화, 떼어낼 디코더/구성 기법 없는 응용 특이적
- **ID**: ieee:7802826
- **Type**: conference
- **Published**: 13-16 Sept
...
- **Status**: ❌
- **Reason**: 태양 산란 환경 우주 텔레메트리 부호 선택 논의, 떼어낼 신규 LDPC 디코더/구성 없음
- **ID**: ieee:7802831
- **Type**: conference
- **Published**: 13-16 Sept
...
- **Status**: ❌
- **Reason**: 우주 텔레커맨드용 아날로그 LDPC 수신기 ASIC, 128비트 아날로그 디코더로 NAND 디지털 LDPC에 이식 불가
- **ID**: ieee:7802824
- **Type**: conference
- **Published**: 13-16 Sept
...
- **Status**: ❌
- **Reason**: 무선 초밀집망 코드화 랜덤액세스 유한길이 분석, LDPC 유사 그래프이나 떼어낼 NAND ECC 기법 없음
- **ID**: ieee:7811441
- **Type**: conference
...
- **Status**: ❌
- **Reason**: polar BP용 보조 LDPC 설계(scattered EXIT) — polar 특화, LDPC BP에 직접 이식 기법 아님
- **ID**: ieee:7606802
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 결합 시스템의 파동 전파속도 공식 유도(순수 이론, density evolution 분석)로 떼어낼 디코더·HW·구성 기법 없음
- **ID**: ieee:7606833
- **Type**: conference
- **Published**: 11-14 Sept
...
- **Status**: ✅
- **Reason**: SC-LDPC protograph 구성과 sliding window 디코더 설계(블록크기·coupling width 최적화)는 바이너리 LDPC 코드설계(E)로 이식 가능
- **ID**: ieee:7606831
- **Type**: conference
- **Published**: 11-14 Sept
...
- **Status**: ❌
- **Reason**: 분산 가설검정 Körner-Marton 소스코딩 — 채널 ECC 아님
- **ID**: ieee:7606813
- **Type**: conference
- **Published**: 11-14 Sept
...
- **Status**: ❌
- **Reason**: fading 채널 capacity 달성 algebraic lattice 구성, LDPC 무관한 number-field lattice 이론
- **ID**: ieee:7606876
- **Type**: conference
- **Published**: 11-14 Sept

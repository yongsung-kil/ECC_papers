...
- **Status**: ❌
- **Reason**: F_q(비이진 GF(q)) SC-LDPC 임계 포화 분석, 비이진 LDPC로 즉시 제외
- **ID**: arxiv:2512.24232v1
- **Type**: preprint
- **Published**: 2025-12-30
- **Authors**: Jiaxin Lyu, Guanghui He
- **PDF**: https://arxiv.org/pdf/2512.24232v1
...
- **Status**: ❌
- **Reason**: Reed-Solomon 변형(GHRS) MDS 코드, RS 기반이며 LDPC 서브패밀리 언급뿐 이식 ECC 기법 없음
- **ID**: arxiv:2512.22948v1
- **Type**: preprint
- **Published**: 2025-12-28
- **Authors**: Mahir Bilen Can, Benjamin Horowitz
- **PDF**: https://arxiv.org/pdf/2512.22948v1
...
- **Status**: ❌
- **Reason**: RIS 다중안테나 채널추정에 LDPC를 보조 도구로 사용; 떼어낼 디코더/HW/코드설계 신규 기여 없는 무선 응용 특이적
- **ID**: arxiv:2512.22731v1
- **Type**: preprint
- **Published**: 2025-12-28
- **Authors**: Roberto C. G. Porto, Rodrigo C. de Lamare
- **PDF**: https://arxiv.org/pdf/2512.22731v1
...
- **Status**: ❌
- **Reason**: 양자 오류정정부호(qLDPC, HGP 구성) — 순수 양자 EC, 제외
- **ID**: arxiv:2512.22116v1
- **Type**: preprint
- **Published**: 2025-12-26
- **Authors**: Yue Wu, Meng-Yuan Li, Chengshu Li +1
...
- **Status**: ❌
- **Reason**: 양자 LDPC sheaf 부호의 Poincaré duality·논리게이트 — 양자 EC 이론, 제외
- **ID**: arxiv:2512.21922v2
- **Type**: preprint
- **Published**: 2025-12-26
- **Authors**: Yiming Li, Zimu Li, Zi-Wen Liu +1
- **PDF**: https://arxiv.org/pdf/2512.21922v2
...
- **Status**: ❌
- **Reason**: 양자 Tanner 부호(qLDPC) 구성 — 양자 EC, 제외
...
- **Status**: ❌
- **Reason**: 양자 계측학 QFI 스케일링과 양자오류정정 관계 분석; NAND ECC 이식 기법 없음
- **ID**: arxiv:2512.20426v1
- **Type**: preprint
- **Published**: 2025-12-23
- **Authors**: Junjie Chen, Rui Luo, Yuxuan Yan +2
...
- **Status**: ❌
- **Reason**: CV-QKD 시스템에서 LDPC를 정보 reconciliation에 사용 — QKD/reconciliation, 채널 ECC 기법 아님, 제외
- **ID**: arxiv:2512.19834v1
- **Type**: preprint
- **Published**: 2025-12-22
- **Authors**: Davi Juvêncio Gomes de Sousa, Nelson Alves Ferreira Neto, Christiano M. S. Nascimento +7
...
- **Status**: ❌
- **Reason**: quantum LDPC 전용 디코더(BB 코드, circuit-level noise, logical error rate) — 양자 EC 제외
- **ID**: arxiv:2512.07057v2
- **Type**: preprint
- **Published**: 2025-12-08
- **Authors**: Min Ye, Dave Wecker, Nicolas Delfosse
- **PDF**: https://arxiv.org/pdf/2512.07057v2
...
- **Status**: ❌
- **Reason**: 무선 5G shaping+LDPC, LDPC는 베이스라인이고 떼어낼 ECC 기법 없음 — 무선 응용 제외
- **ID**: arxiv:2512.06494v3
- **Type**: preprint
- **Published**: 2025-12-06
- **Authors**: Sandesh Rao Mattu, Nishant Mehrotra, Robert Calderbank
- **PDF**: https://arxiv.org/pdf/2512.06494v3
...
- **Status**: ❌
- **Reason**: LDPC를 Pauli stabiliser Hamiltonian/양자 위상으로 다루는 물리 이론 — 바이너리 고전 ECC 아님

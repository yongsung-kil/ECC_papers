...
- **Status**: ❌
- **Reason**: 스핀시스템 패리티 인코딩 하이브리드 디코딩 — 양자 어닐링/최적화 도메인, 표준 BP/bit-flip 단순 사용
- **ID**: arxiv:2510.26189v4
- **Type**: preprint
- **Published**: 2025-10-30
- **Authors**: Yoshihiro Nambu
- **PDF**: https://arxiv.org/pdf/2510.26189v4
...
- **Status**: ❌
- **Reason**: 비이진(finite-field) 확장 + 양자 CSS 부호 — 판단절차 0(비이진) 및 양자 EC로 즉시 제외
- **ID**: arxiv:2510.25583v1
- **Type**: preprint
- **Published**: 2025-10-29
- **Authors**: Kenta Kasai
- **PDF**: https://arxiv.org/pdf/2510.25583v1
...
- **Status**: ✅
- **Reason**: 양자 BB qLDPC 대상이나 reduced-precision FPGA BP 디코더(24ns) HW 기법이 분리 이식 가능 — Phase3 재검토
- **ID**: arxiv:2510.21600v1
- **Type**: preprint
- **Published**: 2025-10-24
- **Authors**: Thilo Maurer, Markus Bühler, Michael Kröner +4
- **PDF**: https://arxiv.org/pdf/2510.21600v1
...
- **Status**: ❌
- **Reason**: 양자 Shor/스태빌라이저 부호 구성 — 양자 EC, 떼어낼 바이너리 디코더/HW 기법 없음
- **ID**: arxiv:2510.21030v2
- **Type**: preprint
- **Published**: 2025-10-23
- **Authors**: En-Jui Chang
- **PDF**: https://arxiv.org/pdf/2510.21030v2
...
- **Status**: ❌
- **Reason**: 양자 코드 서저리·논리 측정 — 순수 양자 FT 컴퓨팅, NAND ECC 무관
- **ID**: arxiv:2510.14895v1
- **Type**: preprint
- **Published**: 2025-10-16
- **Authors**: Alexander Cowtan, Zhiyang He, Dominic J. Williamson +1
- **PDF**: https://arxiv.org/pdf/2510.14895v1
...
- **Status**: ❌
- **Reason**: 양자 LDPC(qLDPC) 리뷰 논문 — 양자 EC, 바이너리 NAND ECC 새 기법 없음
- **ID**: arxiv:2510.14090v1
- **Type**: preprint
- **Published**: 2025-10-15
- **Authors**: Bane Vasic, Valentin Savin, Michele Pacenti +2
- **PDF**: https://arxiv.org/pdf/2510.14090v1
...
- **Status**: ✅
- **Reason**: 양자 BB 부호 대상이나 normalized min-sum + 하이브리드 serial-layered 스케줄·앙상블·FPGA HW 기법 이식 가능 — Phase3 재검토
- **ID**: arxiv:2510.14060v2
- **Type**: preprint
- **Published**: 2025-10-15
- **Authors**: Arshpreet Singh Maan, Francisco-Garcia Herrero, Alexandru Paler +1
- **PDF**: https://arxiv.org/pdf/2510.14060v2
...
- **Status**: ❌
- **Reason**: LLM 멀웨어 임베딩 공격 — LDPC는 페이로드 운반 부수 요소, ECC 기법 아님
- **ID**: arxiv:2510.10486v2
- **Type**: preprint
- **Published**: 2025-10-12
- **Authors**: Ming Tan, Wei Li, Hu Tao +4
- **PDF**: https://arxiv.org/pdf/2510.10486v2
...
- **Status**: ❌
- **Reason**: qLDPC BP 후처리 'degeneracy cutting' — 스태빌라이저 축퇴는 양자 전용 개념, 바이너리 고전 LDPC로 이식 불가
- **ID**: arxiv:2510.08695v1
- **Type**: preprint
- **Published**: 2025-10-09
- **Authors**: Kento Tsubouchi, Hayata Yamasaki, Shiro Tamiya
- **PDF**: https://arxiv.org/pdf/2510.08695v1
...
- **Status**: ❌
- **Reason**: 양자 LDPC code-switching 기반 fault-tolerant 보편 양자계산 — 순수 양자 EC, 바이너리 고전 NAND LDPC에 이식할 디코더/HW 없음
- **ID**: arxiv:2510.08552v1
- **Type**: preprint
- **Published**: 2025-10-09
- **Authors**: Shi Jie Samuel Tan, Yifan Hong, Ting-Chun Lin +2
- **PDF**: https://arxiv.org/pdf/2510.08552v1
...
- **Status**: ❌
- **Reason**: 양자 Gibbs sampling 알고리즘(HDQI)에서 LDPC를 디코딩 서브루틴으로 사용 — 양자 알고리즘 전용, 떼어낼 고전 ECC 기법 없음
- **ID**: arxiv:2510.07913v1
- **Type**: preprint
- **Published**: 2025-10-09
- **Authors**: Alexander Schmidhuber, Jonathan Z. Lu, Noah Shutty +3
- **PDF**: https://arxiv.org/pdf/2510.07913v1
...
- **Status**: ✅
- **Reason**: SWAP 네트워크 기반 새 고전 LDPC Tanner 그래프 구성(expander·locality tradeoff) — 양자 응용이나 바이너리 코드 설계(E) 이식 가능성, Phase 3 재검토
- **ID**: arxiv:2510.07179v2
- **Type**: preprint
- **Published**: 2025-10-08
- **Authors**: Adithya Sriram, Vedika Khemani, Benedikt Placke
- **PDF**: https://arxiv.org/pdf/2510.07179v2
...
- **Status**: ❌
- **Reason**: qLDPC addressable/parallel 논리게이트·code switching — 순수 양자 fault-tolerance, 고전 NAND ECC 무관
- **ID**: arxiv:2510.06760v1
- **Type**: preprint
- **Published**: 2025-10-08
- **Authors**: Louis Golowich, Kathleen Chang, Guanyu Zhu
- **PDF**: https://arxiv.org/pdf/2510.06760v1
...
- **Status**: ❌
- **Reason**: Qudit(비이진 GF(q)) LDPC 코드 — 판단절차 0에 따라 비이진이므로 즉시 제외
- **ID**: arxiv:2510.06495v2
- **Type**: preprint
- **Published**: 2025-10-07
- **Authors**: Daniel J. Spencer, Andrew Tanggara, Tobias Haug +2
...
- **Status**: ❌
- **Reason**: qLDPC batched 논리연산·code surgery — 양자 fault-tolerant 프로토콜, 고전 바이너리 ECC 이식 기법 없음
- **ID**: arxiv:2510.06159v1
- **Type**: preprint
- **Published**: 2025-10-07
- **Authors**: Qian Xu, Hengyun Zhou, Dolev Bluvstein +5
- **PDF**: https://arxiv.org/pdf/2510.06159v1
...
- **Status**: ❌
- **Reason**: QLDPC post-selection(logical gap/cluster 신뢰도) — 양자 EC 전용, NAND LDPC 디코더로 이어지지 않음
- **ID**: arxiv:2510.05795v4
- **Type**: preprint
- **Published**: 2025-10-07
- **Authors**: Seok-Hyung Lee, Lucas H. English, Stephen D. Bartlett
- **PDF**: https://arxiv.org/pdf/2510.05795v4
...
- **Status**: ❌
- **Reason**: qLDPC fast surgery(체인 복합체 기반 논리연산) — 순수 양자 LDPC, 고전 ECC 기법 없음
- **ID**: arxiv:2510.04521v1
- **Type**: preprint
- **Published**: 2025-10-06
- **Authors**: Nouédyn Baspin, Lucas Berent, Lawrence Z. Cohen
- **PDF**: https://arxiv.org/pdf/2510.04521v1
...
- **Status**: ✅
- **Reason**: Bayesian GNN 신경망 디코더(QuBA, BP 대비 1~2자릿수 개선) — 양자 BB 코드 대상이나 신경망 디코더 아키텍처(C) 이식 가능성, Phase 3 재검토
- **ID**: arxiv:2510.06257v1
- **Type**: preprint
- **Published**: 2025-10-05
- **Authors**: Xiangjun Mi, Frank Mueller
- **PDF**: https://arxiv.org/pdf/2510.06257v1
...
- **Status**: ✅
- **Reason**: Layered NMS + syndrome-guided bit flipping 새 디코더(바이너리, LLR 활용) — min-sum 변형(C), NAND LDPC에 직접 이식 가능
- **ID**: arxiv:2510.01019v1
- **Type**: preprint
- **Published**: 2025-10-01
- **Authors**: Niloufar Hosseinzadeh, Mohsen Moradi, Hessam Mahdavifar
- **PDF**: https://arxiv.org/pdf/2510.01019v1

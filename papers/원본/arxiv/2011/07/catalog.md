...
- **Status**: ❌
- **Reason**: GF(2) 선형방정식 해공간 기하 순수 이론, pseudo-codeword 언급뿐 디코더/구성 미이어짐
- **ID**: arxiv:1107.5550v2
- **Type**: preprint
- **Published**: 2011-07-27
- **Authors**: Dimitris Achlioptas, Michael Molloy
- **PDF**: https://arxiv.org/pdf/1107.5550v2
...
- **Status**: ✅
- **Reason**: spatially-coupled LDPC threshold saturation, ISI 채널 SC-LDPC 구성/분석(E) 이식 가능
- **ID**: arxiv:1107.3253v2
- **Type**: preprint
- **Published**: 2011-07-16
- **Authors**: Phong S. Nguyen, Arvind Yedla, Henry D. Pfister +1
- **PDF**: https://arxiv.org/pdf/1107.3253v2
...
- **Status**: ✅
- **Reason**: trapping set 대응 2단계 LLR-BP 디코더로 error floor 개선(C) — 바이너리 LDPC 디코더 이식
- **ID**: arxiv:1107.2867v1
- **Type**: preprint
- **Published**: 2011-07-14
- **Authors**: A. Dinesh Kumar, Ambedkar Dukkipati
- **PDF**: https://arxiv.org/pdf/1107.2867v1
...
- **Status**: ❌
- **Reason**: fuzzy syndrome hashing 보안/바이오인증 — 채널 ECC 아님, 보안 도메인 제외
- **ID**: arxiv:1107.1600v2
- **Type**: preprint
- **Published**: 2011-07-08
- **Authors**: Marco Baldi, Marco Bianchi, Franco Chiaraluce +2
- **PDF**: https://arxiv.org/pdf/1107.1600v2

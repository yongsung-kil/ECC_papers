...
- **Status**: ✅
- **Reason**: SC-LDPC 다중 체인 연결로 유한길이 성능 개선 신규 구성; BEC 기반이나 바이너리 코드 설계 기법 이식 가능(E)
- **ID**: arxiv:1402.7170v1
- **Type**: preprint
- **Published**: 2014-02-28
- **Authors**: Pablo M. Olmos, David G. M. Mitchell, Dmitri Truhachev +1
- **PDF**: https://arxiv.org/pdf/1402.7170v1
...
- **Status**: ❌
- **Reason**: 블록페이딩 채널용 Root-Check IRAA LDPC, 무선 페이딩 응용 특이적 구성으로 NAND로 떼어낼 일반 기법 약함; 애매하나 페이딩 전용 구조
- **ID**: arxiv:1402.5692v1
- **Type**: preprint
- **Published**: 2014-02-24
- **Authors**: A. G. D. Uchoa, C. T. Healy, R. C. de Lamare
- **PDF**: https://arxiv.org/pdf/1402.5692v1

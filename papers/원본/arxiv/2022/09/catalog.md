...
- **Status**: ❌
- **Reason**: 모듈러 아키텍처용 양자 LDPC 코드(하이퍼그래프 곱), 양자 전용 구성, 제외
...
- **Status**: ✅
- **Reason**: MLC NAND 플래시 직접 — LDPC 기반 동적 write-voltage 설계 및 entropy 기반 read-voltage 최적화(A)
...
- **Status**: ❌
- **Reason**: 양자 LDPC(QLDPC) 디코더 소프트웨어 툴, 양자 전용 휴리스틱 디코더, 고전 바이너리 이식 없음

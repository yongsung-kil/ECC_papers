...
- **Status**: ❌
- **Reason**: 표면코드(토폴로지 양자코드) 전용 BP 재초기화 — surface code 구조에 특화, 양자 전용 임계값 문제 해결로 고전 바이너리 LDPC 이식성 낮음
- **ID**: arxiv:2212.03214v2
- **Type**: preprint
- **Published**: 2022-12-06
- **Authors**: Josias Old, Manuel Rispler
- **PDF**: https://arxiv.org/pdf/2212.03214v2

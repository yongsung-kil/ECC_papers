...
- **Status**: ❌
- **Reason**: 통신시스템 시뮬레이터 SW 프레임워크 발표일 뿐 신규 디코더·구성·HW 기여 없음
- **ID**: arxiv:1802.08522v1
- **Type**: preprint
- **Published**: 2018-02-23
- **Authors**: Johann A. Briffa, Stephan Wesemeyer
- **PDF**: https://arxiv.org/pdf/1802.08522v1

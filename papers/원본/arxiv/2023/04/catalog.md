...
- **Status**: ❌
- **Reason**: Clifford 회로 fault correction의 spacetime stabilizer code 구성 — 양자 전용 개념 의존, 고전 바이너리 LDPC 새 기여 없음
...
- **Status**: ❌
- **Reason**: CF-mMIMO 검출·AP 선택이 핵심; LDPC는 표준 IDD 메시지패싱 베이스라인으로 부수 언급, 떼어낼 새 ECC 기법 없음

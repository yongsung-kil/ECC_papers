...
- **Status**: ❌
- **Reason**: 광통신 coded modulation 정보이론적 비교(TTCM vs BICM-LDPC), LDPC는 베이스라인이고 떼어낼 디코더·HW·코드설계 신규 기법 없음
- **ID**: arxiv:1611.00263v1
- **Type**: preprint
- **Published**: 2016-11-01
- **Authors**: Eric Sillekens, Alex Alvarado, Chigo Okonkwo +1
- **PDF**: https://arxiv.org/pdf/1611.00263v1

...
- **Status**: ❌
- **Reason**: 비-LDPC(비원시 BCH·cyclotomic coset) 기반 LDPC 구성이나 표준 girth-6/4-cycle-free 대수적 구성 수준, 새 기여 없고 양자부호 유도용
- **ID**: arxiv:0802.4079v1
- **Type**: preprint
- **Published**: 2008-02-27
- **Authors**: Salah A. Aly
- **PDF**: https://arxiv.org/pdf/0802.4079v1
...
- **Status**: ❌
- **Reason**: 분산 소스-채널 결합코딩(Slepian-Wolf), LDPC가 베이스라인이며 채널 ECC로 떼어낼 기법 없음
- **ID**: arxiv:0802.2666v1
- **Type**: preprint
- **Published**: 2008-02-19
- **Authors**: Vaneet Aggarwal
- **PDF**: https://arxiv.org/pdf/0802.2666v1

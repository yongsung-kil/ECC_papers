...
- **Status**: ✅
- **Reason**: 바이너리 LDPC의 LP 디코딩 instanton 탐색 알고리즘(BSC pseudo-codeword/error-floor 분석) — error floor 분석/코드설계에 이식 가능(C/E)
- **ID**: arxiv:0808.2515v2
- **Type**: preprint
- **Published**: 2008-08-19
- **Authors**: Shashi Kiran Chilappagari, Michael Chertkov, Bane Vasic
- **PDF**: https://arxiv.org/pdf/0808.2515v2

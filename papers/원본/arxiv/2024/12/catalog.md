...
- **Status**: ❌
- **Reason**: 양자 LDPC(qLDPC) 부호로 hashing bound 근접 — 양자 전용, 고전 바이너리 이식 기법 명시 없음, 원칙 제외
...
- **Status**: ❌
- **Reason**: 양자 EC 임계값(coherent information) 이론, qLDPC/토릭 부호 대상 — 양자 전용, 디코더/HW로 이어지지 않음
...
- **Status**: ❌
- **Reason**: 큐빅 텐서/터보 프로덕트 코드 구성으로 LDPC는 비교 대상일 뿐, 떼어낼 LDPC 디코더/구성 기법 없음
...
- **Status**: ❌
- **Reason**: 양자 qLDPC 스핀글라스 위상 order 이론 — 양자 전용 개념 의존, 고전 바이너리로 이식 불가
...
- **Status**: ❌
- **Reason**: Cell-free MIMO 간섭제거 응용, LDPC는 표준 IDD 베이스라인 — 떼어낼 새 ECC 기법 없음
...
- **Status**: ❌
- **Reason**: RIS 보조 멀티유저 IDD 무선 응용, LDPC는 부수 — 떼어낼 새 디코더 기법 없음
...
- **Status**: ❌
- **Reason**: 양자 bivariate bicycle qLDPC 코드 가지치기/fold-transversal gate — 양자 전용, 고전 이식 불가
...
- **Status**: ❌
- **Reason**: qLDPC 디코더로 양자 축퇴(degeneracy) 완화가 핵심 — 양자 전용 개념 의존, 고전 바이너리 비해당

...
- **Status**: ❌
- **Reason**: QC-LDPC 기반 McEliece 암호시스템 공격/방어 — 보안 응용, 떼어낼 신규 디코더/코드설계 기법 없음
- **ID**: arxiv:0710.0142v2
- **Type**: preprint
- **Published**: 2007-09-30
- **Authors**: Marco Baldi
- **PDF**: https://arxiv.org/pdf/0710.0142v2

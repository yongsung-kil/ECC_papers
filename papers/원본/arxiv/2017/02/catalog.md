...
- **Status**: ❌
- **Reason**: 비이진(NB) LDPC 기반 멀티레벨 코딩으로 바이너리 LDPC 한정 기준에서 제외
- **ID**: arxiv:1702.02372v1
- **Type**: preprint
- **Published**: 2017-02-08
- **Authors**: Valeriya Potapova, Alexey Frolov
- **PDF**: https://arxiv.org/pdf/1702.02372v1

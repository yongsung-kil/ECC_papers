...
- **Status**: ❌
- **Reason**: QKD reconciliation용 rate-compatible RCEV LDPC, 채널 ECC 아닌 정보조정이며 떼어낼 신규 디코더/HW 양자화 기법 불명확
- **ID**: arxiv:1305.6244v1
- **Type**: preprint
- **Published**: 2013-05-27
- **Authors**: Zhengchao Wei, Zhi Ma
- **PDF**: https://arxiv.org/pdf/1305.6244v1

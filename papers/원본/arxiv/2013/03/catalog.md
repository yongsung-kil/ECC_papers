...
- **Status**: ❌
- **Reason**: 양자키확장(EAQECC) 프로토콜, finite-geometry LDPC는 표준이고 신규 기여가 양자 전용 프로토콜에 묶여 이식성 없음
...
- **Status**: ❌
- **Reason**: SC-LDPC threshold saturation over BICM 수치/이론분석, 무선 변조 응용이며 떼어낼 신규 디코더/HW/구성 없음

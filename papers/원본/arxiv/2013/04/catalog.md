...
- **Status**: ❌
- **Reason**: Nakagami 페이딩 채널 protograph LDPC 임계값/BER 이론분석, 무선응용 특이적이며 떼어낼 신규 기법 없음
- **ID**: arxiv:1304.6614v1
- **Type**: preprint
- **Published**: 2013-04-24
- **Authors**: Yi Fang, Kai-Kit Wong, Lin Wang +1
- **PDF**: https://arxiv.org/pdf/1304.6614v1
...
- **Status**: ✅
- **Reason**: C: 짧은 사이클 지식과 reweighting factor 활용 신규 BP 디코딩 알고리즘, 부호 비의존적이라 바이너리 LDPC BP로 이식 가능
- **ID**: arxiv:1304.6152v1
- **Type**: preprint
- **Published**: 2013-04-23
- **Authors**: Jingjing Liu, Peng Li, Rodrigo C. de Lamare
- **PDF**: https://arxiv.org/pdf/1304.6152v1

...
- **Status**: ✅
- **Reason**: SC-LDPC 병렬 BEC 비트매핑 최적화(E, 코드설계/임계값 개선)이나 BEC·BICM 응용성 강함 — 애매하여 in
- **ID**: arxiv:1309.7583v1
- **Type**: preprint
- **Published**: 2013-09-29
- **Authors**: Christian Häger, Alexandre Graell i Amat, Alex Alvarado +2
- **PDF**: https://arxiv.org/pdf/1309.7583v1
...
- **Status**: ✅
- **Reason**: LDPC 반복 디코딩 적응적 반복수 임계(AID)로 디코딩 에너지 절감 — 이식 가능 디코더 기법(C)
- **ID**: arxiv:1309.4374v1
- **Type**: preprint
- **Published**: 2013-09-17
- **Authors**: O. Rehman, N. Javaid, A. Haider +5
- **PDF**: https://arxiv.org/pdf/1309.4374v1
...
- **Status**: ❌
- **Reason**: LDPC coded modulation UEP 부분중첩전송, 변조/전송 응용 특이적이고 NAND 이식 ECC 기법 없음
- **ID**: arxiv:1309.3864v1
- **Type**: preprint
- **Published**: 2013-09-16
- **Authors**: Kechao Huang, Chulong Liang, Xiao Ma +1
- **PDF**: https://arxiv.org/pdf/1309.3864v1
...
- **Status**: ✅
- **Reason**: 1309.4374와 동일 AID 적응적 반복 디코딩 에너지 절감 — 이식 가능 디코더 기법(C)
- **ID**: arxiv:1309.0752v1
- **Type**: preprint
- **Published**: 2013-09-03
- **Authors**: N. Javaid, O. Rehman, N. Alrajeh +3
- **PDF**: https://arxiv.org/pdf/1309.0752v1

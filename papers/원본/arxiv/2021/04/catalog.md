...
- **Status**: ❌
- **Reason**: CV-QKD reconciliation용 Raptor-like MET-LDPC, 양자/보안 응용에 율호환 매트릭스 설계로 NAND 바이너리 ECC에 이식할 새 고전 기법 없음
...
- **Status**: ❌
- **Reason**: 비이진(q-ary) LDPC의 리스트 메시지패싱 디코딩 — 비이진 LDPC는 즉시 제외
...
- **Status**: ❌
- **Reason**: 양자 스태빌라이저 LDPC의 BP 디코딩으로 symplectic 내적·자기직교성 등 양자 전용 개념에 의존, 비이진 GF(2^l) 대상이라 제외

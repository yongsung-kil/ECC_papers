...
- **Status**: ❌
- **Reason**: 양자 LDPC 결함허용 컴퓨팅, 논리 큐비트·Pauli 측정 등 양자 전용 — 고전 바이너리 LDPC 이식 기법 없음
...
- **Status**: ❌
- **Reason**: group testing에 기존 LDPC BP 변형을 차용 적용 — 새 디코더/코드 기여 없음, ECC 채널코딩 아님
...
- **Status**: ❌
- **Reason**: mcMTC용 polar 코드 제안, LDPC는 표준 BP 비교 베이스라인일 뿐 — 새 LDPC 기법 없음

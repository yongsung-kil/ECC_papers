...
- **Status**: ❌
- **Reason**: 양자 코드 weight reduction(coning, 스태빌라이저) — 양자 전용 개념 의존, 고전 바이너리 LDPC 이식성 없음
...
- **Status**: ❌
- **Reason**: AMP 용량최적성 순수 이론, LRMS 신호검출 — LDPC는 부수 언급, 떼어낼 디코더/HW/구성 기여 없음
...
- **Status**: ❌
- **Reason**: Construction D' 격자 인코딩/디코딩, QC-LDPC를 격자 구성에 표준 사용 — LDPC 새 기여 없고 power-constrained shaping 응용 특이적

...
- **Status**: ✅
- **Reason**: 유한온도 survey propagation 디코딩이 BP 대비 임계잡음 개선 - 메시지패싱 디코더 변형(C)으로 이식 검토 가치
- **ID**: arxiv:cond-mat/0508586v1
- **Type**: preprint
- **Published**: 2005-08-24
- **Authors**: B Wemmenhove, H J Kappen
- **PDF**: https://arxiv.org/pdf/cond-mat/0508586v1

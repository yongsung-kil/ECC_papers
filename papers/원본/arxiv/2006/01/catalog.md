...
- **Status**: ❌
- **Reason**: 대수기하 코드용 곡면 Picard수 p-adic 코호몰로지 계산, 순수 수학 이론이며 디코더/HW/LDPC 구성 기여 없음
...
- **Status**: ✅
- **Reason**: 분산 파일 스토리지에 small LDPC erasure 코드 적용·프로토타입 측정, 스토리지 ECC 일반(B)
...
- **Status**: ✅
- **Reason**: LDPC error-floor 영역 정량 분석(instanton method), 바이너리 LDPC error floor 분석으로 코드설계(E)에 활용 가능

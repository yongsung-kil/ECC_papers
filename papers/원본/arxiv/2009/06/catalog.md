...
- **Status**: ✅
- **Reason**: QC-LDPC 고girth 구성 조건 제시(E), 알지브라 코드설계 기여 — 바이너리 LDPC 코드설계로 이식 가능
- **ID**: arxiv:0906.3410v1
- **Type**: preprint
- **Published**: 2009-06-18
- **Authors**: Christian Spagnol, Marta Rossi, Massimiliano Sala
- **PDF**: https://arxiv.org/pdf/0906.3410v1
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC 최소거리 분석 — 비이진 LDPC는 제외 대상
- **ID**: arxiv:0906.2061v1
- **Type**: preprint
- **Published**: 2009-06-11
- **Authors**: Rethnakaran Pulikkoonattu
- **PDF**: https://arxiv.org/pdf/0906.2061v1

...
- **Status**: ✅
- **Reason**: 조합설계(super-simple directed design)로 LDPC 패리티검사행렬 구성 — 바이너리 코드 설계 기법(E)으로 이식 가능성 있어 살림.
- **ID**: arxiv:2007.13743v2
- **Type**: preprint
- **Published**: 2020-07-27
- **Authors**: M. Mohammadnezhad, S. Golalizadeh, M. Boostan +1
- **PDF**: https://arxiv.org/pdf/2007.13743v2

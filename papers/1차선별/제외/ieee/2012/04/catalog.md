...
- **Status**: ❌
- **Reason**: QKD 시스템(키 distillation HW), 정보조정/보안 도메인이고 떼어낼 바이너리 LDPC 디코더 양자화 기법 명시 없음
- **ID**: ieee:6150994
- **Type**: journal
- **Published**: April 2012
- **Authors**: Akihiro Tanaka, Mikio Fujiwara, Ken-ichiro Yoshino +8
- **PDF**: https://ieeexplore.ieee.org/document/6150994
...
- **Status**: ❌
- **Reason**: 릴레이 네트워크 코딩 BER/throughput 분석, LDPC는 부수 채널코딩 언급일 뿐 신규 기법 없음
- **ID**: ieee:6268539
- **Type**: conference
- **Published**: 24-26 Apri
- **Authors**: Tariq Aziz, Ishtiaq Ahmad, Nasir Saleem +2
- **PDF**: https://ieeexplore.ieee.org/document/6268539
- **Abstract**: In this paper, we have evaluated the performance of multicast 2-hop decode-and-forward (DF) based relay network when X-OR network coding is applied at the relay node while Low density Parity Check (LDPC) Coding scheme is applied at the channel. Multicast Relay transmission scheme is a type of transmission scheme in which two fixed relay nodes contribute in the second hop of end-to-end transmission between source and the destination which are BTS and a pair of Mobile stations, in our case. Assuming no direct link between BTS and mobile stations due to shadowing or some obstacle in between, we have further considered one-way and two-way multicast scenarios. We have carried out bit error rate (BER) and throughput analysis for our system model and explained our empirical findings.

## The Bit Interleaved Coded Modulation module for DVB-NGH: Enhanced features for mobile reception

- **Status**: ❌
- **Reason**: DVB-NGH BICM 모듈 기술 설명, LDPC는 부수적이고 떼어낼 디코더/구성/HW 기여 없음
- **ID**: ieee:6221327
- **Type**: conference
- **Published**: 23-25 Apri
- **Authors**: Catherine Douillard, Charbel Abdel Nour
- **PDF**: https://ieeexplore.ieee.org/document/6221327
...
- **Status**: ❌
- **Reason**: BICM/TCM 협력 다이버시티(set-partition 라벨링·트렐리스 가지치기). LDPC 아니고 무선 협력통신 특이적.
- **ID**: ieee:6213939
- **Type**: conference
- **Published**: 1-4 April 
- **Authors**: Lai Wei, Shashank V. Maiya, Thomas E. Fuja
- **PDF**: https://ieeexplore.ieee.org/document/6213939

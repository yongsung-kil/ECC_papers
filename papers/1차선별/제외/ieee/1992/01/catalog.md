...
- **Status**: ❌
- **Reason**: 다단계 멀티레벨 부호 반복디코딩 — 비-LDPC 부호화변조 전용 다단디코딩, BP 이식 기여 없음
- **ID**: ieee:276690
- **Type**: conference
- **Published**: 1992
- **Authors**: T. Woerz, J. Hagenauer
- **PDF**: https://ieeexplore.ieee.org/document/276690
...
- **Status**: ❌
- **Reason**: Rayleigh 페이딩용 블록 부호화 변조 — 비-LDPC 무선응용, 이식 기법 없음
- **ID**: ieee:240757
- **Type**: conference
- **Published**: 1992
- **Authors**: N. Seshadri, C. . -E. W. Sundberg
- **PDF**: https://ieeexplore.ieee.org/document/240757

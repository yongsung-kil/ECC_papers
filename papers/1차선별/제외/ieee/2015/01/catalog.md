...
- **Status**: ❌
- **Reason**: 계층화 비디오용 inter-layer FEC 튜토리얼/리뷰. 응용 특이적이고 NAND 이식 가능한 신규 LDPC 기법 없음
- **ID**: ieee:7010875
- **Type**: journal
- **Published**: Secondquar
- **Authors**: Yongkai Huo, Cornelius Hellge, Thomas Wiegand +1
- **PDF**: https://ieeexplore.ieee.org/document/7010875
...
- **Status**: ❌
- **Reason**: 수중음향 OFDM 협력통신 응용 특이적이며 사용 부호가 non-binary LDPC — 비이진 + 떼어낼 ECC 기법 없음
- **ID**: ieee:6826587
- **Type**: journal
- **Published**: Jan. 2015
- **Authors**: Yougan Chen, Zhaohui Wang, Lei Wan +3
- **PDF**: https://ieeexplore.ieee.org/document/6826587
...
- **Status**: ❌
- **Reason**: polar code 순수 이론(분극 속도, capacity gap), 부호 비의존 디코더 기여 없음 — 비-LDPC 제외
- **ID**: ieee:6960872
- **Type**: journal
- **Published**: Jan. 2015
- **Authors**: Venkatesan Guruswami, Patrick Xia
- **PDF**: https://ieeexplore.ieee.org/document/6960872
...
- **Status**: ❌
- **Reason**: protograph LDPC 서베이, 구체적 신규 디코더/구성/HW 기여 없이 인코딩 설계 개관 — 서베이 제외
- **ID**: ieee:7112076
- **Type**: journal
- **Published**: Fourthquar
- **Authors**: Yi Fang, Guoan Bi, Yong Liang Guan +1
- **PDF**: https://ieeexplore.ieee.org/document/7112076
...
- **Status**: ❌
- **Reason**: 유한기하 LDPC 패리티검사를 압축센싱 측정행렬로 쓰는 결정적 구성 — 채널 ECC 부호설계가 아닌 CS 측정행렬, 떼어낼 LDPC ECC 기여 없음
- **ID**: ieee:6998863
- **Type**: journal
- **Published**: Feb.15, 20
- **Authors**: Shu-Tao Xia, Xin-Ji Liu, Yong Jiang +1
- **PDF**: https://ieeexplore.ieee.org/document/6998863
...
- **Status**: ❌
- **Reason**: 압축센싱 노이즈 희소복원용 nonparametric BP, LDPC유사 측정행렬은 채널 ECC가 아닌 sparse recovery — 떼어낼 NAND LDPC BP 기법 없음
- **ID**: ieee:6996047
- **Type**: journal
- **Published**: Feb.15, 20
- **Authors**: Jaewook Kang, Heung-No Lee, Kiseon Kim
- **PDF**: https://ieeexplore.ieee.org/document/6996047
...
- **Status**: ❌
- **Reason**: HT-coset(RM/polar) 코드의 BMST 전송 기법, 비-LDPC 부호이며 LDPC BP 이식 기법 없음
- **ID**: ieee:7114334
- **Type**: journal
- **Published**: Aug.15, 20
- **Authors**: Chulong Liang, Jingnan Hu, Xiao Ma +1
- **PDF**: https://ieeexplore.ieee.org/document/7114334
...
- **Status**: ❌
- **Reason**: LDGM 기반 AL-FEC(erasure/영상 스트리밍) — fountain/erasure 응용, NAND용 떼어낼 채널 ECC 기법 없음
- **ID**: ieee:7066444
- **Type**: conference
- **Published**: 9-12 Jan. 
- **Authors**: Laith Al-Jobouri, Filippo Casu, Martin Fleury +1
- **PDF**: https://ieeexplore.ieee.org/document/7066444
...
- **Status**: ❌
- **Reason**: D2D 멀티캐스트용 Raptor(fountain) 코딩 전략 — LDPC 아님, erasure 응용
- **ID**: ieee:7157977
- **Type**: conference
- **Published**: 9-12 Jan. 
- **Authors**: Boulos Wadih Khoueiry, M. Reza Soleymani
- **PDF**: https://ieeexplore.ieee.org/document/7157977
...
- **Status**: ❌
- **Reason**: 데이터 은닉/암호화 영상, LDPC ECC와 무관
- **ID**: ieee:7282279
- **Type**: conference
- **Published**: 9-10 Jan. 
- **Authors**: Priyanka V Deshmukh, Aniket K Shahade, Gajendra Y Patil
- **PDF**: https://ieeexplore.ieee.org/document/7282279
...
## BCH and LDPC coded wide-band modem for 21-GHz band satellite broadcasting system

- **Status**: ❌
- **Reason**: 위성방송용 BCH+LDPC 표준 연접부호 모뎀 구현 — 표준 부호 단순 적용, 새 디코더/구성 기여 없음
- **ID**: ieee:7129777
- **Type**: conference
- **Published**: 25-28 Jan.
- **Authors**: Yoichi Suzuki, Yoshifumi Matsusaki, Masashi Kamei +4
- **PDF**: https://ieeexplore.ieee.org/document/7129777
- **Abstract**: The 21-GHz band has been allocated for Ka-band BSS and has a wide bandwidth from 21.4 to 22.0GHz. The 600MHz spectrum allocation is suitable for UHDTV satellite broadcasting. As a countermeasure for rain attenuation due to Ka-band characteristics, a strong forward error correction scheme must be implemented for stable signal reception. We have implemented the concatenated code of BCH and LDPC in the Q/8PSK wide-band modem, whose maximum symbol rate is 250Mbaud. Through measurements, we confirmed clear coding gain against QPSK and 8PSK with no FEC under AWGN.

## Fifteen Years of Quantum LDPC Coding and Improved Decoding Strategies

- **Status**: ❌
- **Reason**: Quantum LDPC survey with non-binary CSS-specific decoder; quantum+non-binary, excluded
- **ID**: ieee:7336474
- **Type**: journal
- **Published**: 2015
- **Authors**: Zunaira Babar, Panagiotis Botsinis, Dimitrios Alanis +2
- **PDF**: https://ieeexplore.ieee.org/document/7336474
...
- **Status**: ❌
- **Reason**: EXIT-aided concatenated quantum convolutional codes (QECC); quantum EC + convolutional, non-LDPC
- **ID**: ieee:7052310
- **Type**: journal
- **Published**: 2015
- **Authors**: Zunaira Babar, Panagiotis Botsinis, Dimitrios Alanis +2
- **PDF**: https://ieeexplore.ieee.org/document/7052310
...
- **Status**: ❌
- **Reason**: 언어처리/자연어처리 키노트 — ECC·LDPC와 무관
- **ID**: ieee:7300260
- **Type**: conference
- **Published**: 2015
- **Authors**: J. Mizera-Pietraszko
- **PDF**: https://ieeexplore.ieee.org/document/7300260
...
- **Status**: ❌
- **Reason**: WSN 충돌 검출 통계 기법, 디코딩 회피용; LDPC 디코더/구성 기여 없음
- **ID**: ieee:7129392
- **Type**: conference
- **Published**: 2015
- **Authors**: F. Alassery, W. K. M. Ahmed, M. Sarraf +1
- **PDF**: https://ieeexplore.ieee.org/document/7129392
...
## Bandwidth-satisfied relay-selection scheme for wireless multicast networks with cooperative communications

- **Status**: ❌
- **Reason**: 무선 멀티캐스트 릴레이 선택, LDPC ECC 무관
- **ID**: ieee:7446853
- **Type**: conference
- **Published**: 2015
- **Authors**: Yi Chen, Ge Gao, Shengbin Liao +1
- **PDF**: https://ieeexplore.ieee.org/document/7446853
- **Abstract**: Cooperative communication is an efficient technology to achieve high bandwidth demands and wide error-prone client coverage. However, the previous cooperative multicast protocols suffer from bandwidth-violation problem while selecting relay nodes, namely, the cooperative hidden route problem (CHRP) by distributed protocols in wireless multicast networks. In this paper, a novel relay selection algorithm that can avoid the CHRP is proposed, and a bandwidth-satisfied multicast cooperative relay selection scheme is constructed. Moreover, to optimize the cooperative performance, we provide theory analysis for selecting a relay. Simulations results show that the proposed algorithm can efficiently mitigate multicast transmission errors and improve network throughput in a distributed wireless environment by more than 10%.

## Investigation of reception zone in a 60 GHz-band compact-range wireless access system using a large array antenna

- **Status**: ❌
- **Reason**: 60GHz 무선 안테나/전파환경 측정 논문. BER 측정만, LDPC/ECC 기법 전무.
- **ID**: ieee:7365066
- **Type**: conference
- **Published**: 2015
- **Authors**: K. Toyosaki, M. Zhang, J. Hirokawa +2
- **PDF**: https://ieeexplore.ieee.org/document/7365066
- **Abstract**: A 60GHz-band compact-range wireless access system using a large array antenna can provide an uniform signal reception zone (less than 14 m distance from the antenna) and an almost multipath-free propagation environment. To evaluate the system performance, a wireless communication system for demonstration is constructed and the bit error rate (BER) and the signal-to-interference-plus-noise ratio (SINR) are measured. A wide and long communication zone with low BER is realized by adopting large array antennas in the access point. However, BER degrades especially for the distance less than 1 m. The characteristics of the coefficient S21 between the transmitting and receiving antennas in both frequency and time domains are measured. The time delay and the delay spread are analyzed, and the SINR is also compared with the signal-to-interference ratio.

## 18.7 A 2.4mm2 130mW MMSE-nonbinary-LDPC iterative detector-decoder for 4×4 256-QAM MIMO in 65nm CMOS

- **Status**: ❌
- **Reason**: 비이진(NBLDPC) GF 처리 디코더/HW — 비이진 LDPC는 명시적 제외, 바이너리만 포함
- **ID**: ieee:7063064
- **Type**: conference
- **Published**: 2015
- **Authors**: C. -H. Chen, W. Tang, Z. Zhang
- **PDF**: https://ieeexplore.ieee.org/document/7063064
...
- **Status**: ❌
- **Reason**: SCMA iterative detection+decoding using standard MPA and baseline LDPC, no new decoder
- **ID**: ieee:7341325
- **Type**: conference
- **Published**: 2015
- **Authors**: B. Xiao, K. Xiao, S. Zhang +3
- **PDF**: https://ieeexplore.ieee.org/document/7341325
...
## A design of cooperative slotted ALOHA system with HARQ

- **Status**: ❌
- **Reason**: Cooperative slotted ALOHA + HARQ MAC; LDPC only as baseline PHY, no extractable ECC technique.
- **ID**: ieee:7354616
- **Type**: conference
- **Published**: 2015
- **Authors**: H. -C. Yen, Y. -C. Liu, S. -K. Lee +1
- **PDF**: https://ieeexplore.ieee.org/document/7354616
...
- **Status**: ❌
- **Reason**: FPGA encoder/decoder for polar codes (SC/list/BP); non-LDPC, HW specific to polar, no code-agnostic LDPC BP technique
- **ID**: ieee:7050456
- **Type**: conference
- **Published**: 2015
- **Authors**: M. S. Oommen, S. Ravishankar
- **PDF**: https://ieeexplore.ieee.org/document/7050456
...
- **Status**: ❌
- **Reason**: SC-MN 코드의 BEC 메모리채널 BP 점근분석(potential function); 떼어낼 신규 디코더/구성 없는 순수 이론 결과
- **ID**: ieee:7282585
- **Type**: conference
- **Published**: 2015
- **Authors**: M. Fukushima, T. Okazaki, K. Kasai
- **PDF**: https://ieeexplore.ieee.org/document/7282585
...
- **Status**: ❌
- **Reason**: ATSC 3.0 물리계층 개요 — OFDM+LDPC FEC 표준 소개/시그널링 overview, 구체적 신규 디코더·구성·HW 기여 없음
- **ID**: ieee:7177257
- **Type**: conference
- **Published**: 2015
- **Authors**: L. Fay
- **PDF**: https://ieeexplore.ieee.org/document/7177257
- **Abstract**: The ATSC 3.0 physical layer team has actively been identifying technology elements for adoption in the new ATSC 3.0 physical layer standard which significantly improves performance and robustness beyond current ATSC 1.0 levels. OFDM based waveforms, LDPC forward error correction are two such technologies which enable very robust broadcasts with low overhead for both stationary and mobile receivers. Flexible signaling is another requirement from broadcasters that has been addressed in the new standard. This paper provides an overview of the current state of the ATSC 3.0 physical layer and outlines the technologies, performance, signaling aspects and discusses how the standard is expected to evolve over the coming years.

## Advanced schemes for all-optical computing, optical error correction, and optical signal processing

- **Status**: ❌
- **Reason**: 전광(all-optical) 컴퓨팅·GF 연산 기반 비이진 LDPC 대상으로 바이너리 LDPC 이식 기법 없음 — 비이진 제외
- **ID**: ieee:7193635
- **Type**: conference
- **Published**: 2015
- **Authors**: I. B. Djordjevic, M. Cvijetic
- **PDF**: https://ieeexplore.ieee.org/document/7193635
- **Abstract**: The recent progress in optical communications and signal processing outlines the fact that the parallel computing falls well behind the optical transmission systems' capabilities. Even though that photonic networks-on-chips (NOCs) can be employed to enable future computing and signal processing functions, there is a number of limitations (such as frequent O-E-O conversions, temperature sensitivity, and reliability issues) to be overcome before such schemes become widely adopted. All this strengthens the need for novel optical computing paradigms to be introduced. In this paper, we discuss novel optical processing schemes to overcome the computing limitations of photonic NOCs. We describe both continuous-time (CT) and discrete-time (DT) implementations of photonic integrated circuits (PIC)-based basic building blocks for all-optical computing. In addition, we need to use all-optical error correction schemes to deal with the accumulated errors due to the impact of noise. To perform all-optical linear block encoding and decoding we discuss and propose the use of SOA based XOR gates, while for CT implementation, the employment of Mach-Zehnder interferometer-based multiplier to perform probabilities multiplication, is considered. Also, the use of Y-junctions and phase modulators for all-optical FFT is discussed. Finally, we will describe and propose our approach of how to perform all-optical multiplication and addition in Galois field (GF), which represent the basic operations required in nonbinary LDPC coding and byte-based computing functions.

## DVB-T2-Lite profile using diversity technique under different channel conditions

- **Status**: ❌
- **Reason**: DVB-T2-Lite 다이버시티 성능 평가 — 무선방송 응용, LDPC는 부수 언급이고 떼어낼 기법 없음
- **ID**: ieee:7177196
- **Type**: conference
- **Published**: 2015
- **Authors**: L. Polak, O. Kaller, T. Kratochvil
- **PDF**: https://ieeexplore.ieee.org/document/7177196
- **Abstract**: The DVB-T2 standard is a very flexible system with a wide range of adjustable parameters. Moreover, within its main profile, another specification is defined, marked as DVB-T2-Lite. It is based on the same digital TV (DTV) system as the DVB-T2, but is more oriented on the mobile and portable TV scenarios. This paper deals with exploration of the DVB-T2-Lite profile using spatial diversity technique. A mobile scenario is considered, represented by Bad Urban and Rural Area fading channel models with 6 independent echo paths. Possible impact of the rotated constellation technique on the DVB-T2-Lite multimedia system performance is explored as well. The overall performance of the T2-Lite profile is evaluated on its physical layer level, based on the dependences of bit error rate before LDPC decoding, modulation error rate on the carrier-to-noise ratio (C/N). Results quantify the extent to which transmit diversity improves reception performance in terms of C/N required for Quasi Error-Free operation in DVB-T2-Lite.

## Block-based distributed video coding without channel codes

- **Status**: ❌
- **Reason**: 분산 비디오 코딩에서 LDPC/Turbo 채널코드를 오히려 소스코딩으로 대체 — 떼어낼 LDPC 기법 없음
- **ID**: ieee:7233154
- **Type**: conference
- **Published**: 2015
- **Authors**: B. Manel
- **PDF**: https://ieeexplore.ieee.org/document/7233154
...
## Yaliny's protocol for low earth orbit satellites

- **Status**: ❌
- **Reason**: LEO 위성 CCSDS/DVB-S2 변형 codec. 표준 LDPC codec을 그대로 FPGA 구현, 신규 디코더·구성 기여 없음 — 응용 특이적.
- **ID**: ieee:7493173
- **Type**: conference
- **Published**: 2015
- **Authors**: I. Dvoryaninov
- **PDF**: https://ieeexplore.ieee.org/document/7493173
- **Abstract**: This paper presents a modification of CCSDS 131.2-R-2/DVB-S2 standard developed by Yaliny Engineering. The modification has special features — Doppler offset compensation with prior information, low latency synchronization scheme, which allows for its use on LEO satellites and patent-free LDPC codec. The paper tells about results reached and used hardware platform — FPGA Xilinx Kintex 7.

## A comprehensive study of Monolithic 3D cell on cell design using commercial 2D tool

- **Status**: ❌
- **Reason**: 모놀리식 3D 물리구현/PnR 방법론, LDPC는 벤치마크 IP로 부수 언급일 뿐 LDPC 디코더/코드/HW 기여 없음
- **ID**: ieee:7092568
- **Type**: conference
- **Published**: 2015
- **Authors**: O. Billoint, H. Sarhan, I. Rayane +13
- **PDF**: https://ieeexplore.ieee.org/document/7092568
...
- **Status**: ❌
- **Reason**: CubeSat CDMA 통신시스템, space-standard LDPC를 그대로 사용. 새 디코더/구성 기여 없음
- **ID**: ieee:7119041
- **Type**: conference
- **Published**: 2015
- **Authors**: A. Babuscia, D. Divsalar, K. -M. Cheung
- **PDF**: https://ieeexplore.ieee.org/document/7119041
...
- **Status**: ❌
- **Reason**: NGB-W 방송 채널 기술 개요 — 시스템 소개/서베이, OFDM+LDPC 표준 채택 언급뿐 신규 기여 없음
- **ID**: ieee:7177199
- **Type**: conference
- **Published**: 2015
- **Authors**: W. Zhang, D. He, Y. Guan +3
- **PDF**: https://ieeexplore.ieee.org/document/7177199
...
- **Status**: ❌
- **Reason**: cognitive radio FEC+network coding pollution attack 방어, LDPC는 비교 베이스라인으로 부수 언급. 떼어낼 LDPC 기법 없음, 보안 응용
- **ID**: ieee:7122564
- **Type**: conference
- **Published**: 2015
- **Authors**: I. Demirdogen, L. Li, C. Chigan
- **PDF**: https://ieeexplore.ieee.org/document/7122564
...
- **Status**: ❌
- **Reason**: mmWave 위상잡음 하 MMSE 등화기 LLR 근사 — 등화기 출력 LLR 계산 기법, LDPC는 베이스라인 FEC 언급뿐. NAND LDPC 디코더에 이식할 부호/HW 기여 없음.
- **ID**: ieee:7391755
- **Type**: conference
- **Published**: 2015
- **Authors**: M. Nishikori, S. Ibi, S. Sampei
- **PDF**: https://ieeexplore.ieee.org/document/7391755
- **Abstract**: This paper proposes an approximated log likelihood ratio (LLR) for millimeter-wave (mmW) systems in presence of phase noise. In mmW systems, phase noise of carrier wave signal causes severe performance degradation while operating in much higher frequency. In order to mitigate the impairments of phase noise, space-time block code (STBC) and forward error correction (FEC), such as LDPC, techniques are effective tools. However, if the probabilistic model does not capture exact behavior of a random process on received signal, the capability of FEC is severely deteriorated, especially in higher order modulation or higher coding rate cases. To address this issue, we define the probabilistic model of minimum mean square error (MMSE) equalizer output including phase noise components. Then, a method for approximately computing the LLR is proposed by applying Gaussian approximation. We have demonstrated that the approximated LLR computation from the defined probabilistic model is capable of improving bit error rate (BER) performances in the presence of phase noise.

## Improving coding scheme of LDACS in the reverse link

- **Status**: ❌
- **Reason**: LDACS 코딩(터보/NB-LDPC) 개선 — NB-LDPC는 비이진이며 표준 LTE 터보 채택, 바이너리 LDPC 신규 기여 없음
- **ID**: ieee:7311536
- **Type**: conference
- **Published**: 2015
- **Authors**: M. Mostafa
- **PDF**: https://ieeexplore.ieee.org/document/7311536
- **Abstract**: • Replacing the current LDACS coding scheme (CRSCC) in the reverse link by a turbo code improves the coding gain by - 1.2 dB in the presence of strong impulsive noise - 0.8 dB in the absence of impulsive noise • For the shortest data block and smallest modulation and code rate - tail-biting outperforms zero-termination by 0.2 dB - Tail-biting computationally more complex - For longer data blocks, the advantage shrinks • NB-LDPC outperforms turbo codes for AWGN channel • NB-LDPC has been excluded in favor of a standardized solution, 3GPP LTE turbo code

## [Copyright notice]

- **Status**: ❌
- **Reason**: 저작권 고지/목차 나열 — 논문 아님
- **ID**: ieee:7412450
- **Type**: conference
- **Published**: 2015
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/7412450
- **Abstract**: The following topics are dealt with: cloud computing; PID position control; data protection; encryption; LDPC codes; FPGA; cognitive radio wireless networks; UHF RFID readers; neural network; posture recognition; LTE networks; water quality; light emitting diode.

## Table of contents

- **Status**: ❌
- **Reason**: Conference 'Table of contents' listing (mentions LDPC as a topic) — not an actual paper with a contribution
- **ID**: ieee:7060231
- **Type**: conference
- **Published**: 2015
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/7060231
- **Abstract**: The following topics are dealt with: brain-computer interface; frequency selective surface; spectrum sharing network; imperfect channel state information; wireless sensor network; business intelligence; intrusion detection system; PV system; software product development; image compression; thermal power system; cellular automata; LDPC codes; power quality assessment; interference cancellation; LTE network; induction generator; wind-based microgeneration; power system transient stability; fuzzy based adaptive control; computational complexity analysis; DC-DC switch mode step-up power supply; multipath fading channel; AWGN noise; video conferencing technique; supercapacitor; load balanced multicast routing protocol; wireless mobile ad hoc network; grayscale image representation; color image representation; partially occluded object detection; compact suspended planar patch antenna; solar cell; sensorless control methodology; brushless DC motor; pixel classification; scalable context-aware recommendation system; image segmentation; rectangular microstrip antenna; Rayleigh fading channel; secure hash function based authentication scheme; and OFDM systems.

## Table of contents

- **Status**: ❌
- **Reason**: Table of contents (proceedings listing), not a technical paper.
- **ID**: ieee:7360720
- **Type**: conference
- **Published**: 2015
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/7360720
- **Abstract**: The following topics are dealt with: distributed storage coding; index coding; information theory and statistics; interactive communication; network coding; network information theory; channel capacity; spatially coupled codes; broadcast & multiaccess channels; LDPC and polar codes; ranking and clustering; MIMO communication; secrecy systems; wiretap channels; source coding; network privacy; and lossy compression.

## [Copyright notice]

- **Status**: ❌
- **Reason**: 저작권/목차 공지, 논문 아님
- **ID**: ieee:7353342
- **Type**: conference
- **Published**: 2015
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/7353342
- **Abstract**: The following topics are dealt with: high-mobility wireless communications; wireless fading channel; RUN codes; relay channels; SIMO-OFDM high speed train systems; WiFi network; MU-MIMO systems; LTE networks; spectrum-efficient index modulation; and LDPC-coded modulation systems.

## Table of contents

- **Status**: ❌
- **Reason**: 학회 목차(Table of contents)로 실제 논문 아님
- **ID**: ieee:7509882
- **Type**: conference
- **Published**: 2015
- **Authors**: 
- **PDF**: https://ieeexplore.ieee.org/document/7509882
- **Abstract**: The following topics are dealt with: FPGA; image fusion; steganography; noniterative LDPC decoding; MANET; wireless sensor network; adder circuit design; frequency selective surfaces; ground penetrating radar; coaxial metal disc loaded waveguiding structure; circularly polarized microstrip antenna; universal filter design; MEMS cantilever; second harmonic gyroklystron amplifier; unipolar organic ring oscillator; gas sensing; DRAM; tri-band printed MIMO antenna; noninvasive concealed weapon detection; land cover classification; compact half-wave folded waveguide resonator; ECG signal decomposition; fully polarimetric RADARSAT-2 data; and software fault prediction.

## Coded Random Access with Distributed Power Control and Multiple-Packet Reception

- **Status**: ❌
- **Reason**: SC-LDPC coded ALOHA + 분산 전력제어 random access — LDPC 베이스라인, 떼어낼 부호/디코더 기법 없는 통신 응용
- **ID**: ieee:6987538
- **Type**: journal
- **Published**: 2015
- **Authors**: Z. Zhang, C. Xu, L. Ping
- **PDF**: https://ieeexplore.ieee.org/document/6987538
- **Abstract**: In this letter, a spatially-coupled low-density parity- check (SC-LDPC) coded ALOHA system with multiuser detection (MUD)-based multiple packet reception (MPR) is studied. A distributed power control scheme based on multiple power levels is proposed for medium and high rate applications. Numerical results show that the proposed scheme can provide noticeable throughput improvement. This improvement is more significant in the cases of fading channels.

## A SRM Applied in Wind Generation at Smart Grids Employing Wireless Power Control

- **Status**: ❌
- **Reason**: 풍력 SRM 무선전력제어에 표준 LDPC를 베이스라인으로 적용, 새 디코더·구성·HW 기여 없음
- **ID**: ieee:7273757
- **Type**: journal
- **Published**: 2015
- **Authors**: I. Casella, A. Sguarezi, C. Capovilla +2
- **PDF**: https://ieeexplore.ieee.org/document/7273757
...
- **Status**: ❌
- **Reason**: QC-MDPC McEliece 암호 구현 — code-based 암호(보안) 원칙 제외, 표준 LDPC 디코더 재사용 수준이라 NAND LDPC에 이식할 신규 기여 없음
- **ID**: ieee:7164228
- **Type**: journal
- **Published**: 2015
- **Authors**: H. Oliveira Martins, A. C. Alves Nascimento
- **PDF**: https://ieeexplore.ieee.org/document/7164228
...
- **Status**: ❌
- **Reason**: rateless 무선 링크적응 비교 논문 — fountain/rateless 베이스라인, 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:7230505
- **Type**: conference
- **Published**: 2015
- **Authors**: F. Mehran, K. Nikitopoulos, P. Xiao +1
- **PDF**: https://ieeexplore.ieee.org/document/7230505
- **Abstract**: State-of-the-art channel coding schemes promise data rates close to the wireless channel capacity. However, efficient link adaptation techniques are required in order to deliver such throughputs in practice. Traditional rate adaptation schemes, which are reactive and try to “predict” the transmission mode that maximizes throughput based on “transmission quality indicators”, can be highly inefficient in an evolving wireless ecosystem where transmission can become increasingly dynamic and unpredictable. In such scenarios, “rateless” link adaptation can be highly beneficial. Here, we compare popular rateless approaches in terms of gains and practicality in both traditional and more challenging operating scenarios. We also discuss challenges that need to be addressed to make such systems practical for future wireless communication systems.

## Turbo equalization for waveforms encoded by Reed Solomon codes

- **Status**: ❌
- **Reason**: Turbo equalization for Reed-Solomon codes with ABP; non-LDPC code, ABP tied to RS not binary LDPC BP.
- **ID**: ieee:7357543
- **Type**: conference
- **Published**: 2015
- **Authors**: W. Wang, Y. L. Guan, P. Yang +1
- **PDF**: https://ieeexplore.ieee.org/document/7357543
- **Abstract**: Turbo equalization is an iterative approach to perform joint equalization and decoding of data, which is protected by error correction code and transmitted over intersymbol interference (ISI) channels. Turbo equalization for Reed Solomon (RS) code, which is a popular error-correction code in wireless communication and recording systems, is seldom discussed in the literature. In this paper, we investigate the computational complexity and performance of turbo equalization which exploits three different kinds of equalization algorithms, i.e., BCJR, M-BCJR and linear minimum mean square error (LMMSE) algorithms. An adaptive belief propagation (ABP) algorithm is used for the decoding of RS code. Simulation results show that, the complexities of the LMMSE and M-BCJR based equalizers are much lower than that of the BCJR based equalizer, and at the same time the performance loss is still acceptable.

## Repeat-Accumulate Codes for Broadcast Channels with Side Information

- **Status**: ❌
- **Reason**: Repeat-accumulate codes with density evolution for Slepian-Wolf/broadcast; RA not LDPC, analysis code-specific, no portable LDPC decoder/construction
- **ID**: ieee:7052118
- **Type**: conference
- **Published**: 2015
- **Authors**: O. Iscan, I. Land, G. Lechner
- **PDF**: https://ieeexplore.ieee.org/document/7052118
- **Abstract**: This paper investigates the performance of practical codes for the problem of Slepian-Wolf coding over broadcast channels, where a message is transmitted to multiple users with different amounts of side information available at each receiver. Density evolution analysis for repeat-accumulate codes on erasure channels is extended to this setup, where the side information is modeled as the output of a virtual correlation channel. Analytic expressions to describe the convergence region for erasure channels are obtained and it is shown by numerical tools that similar results also apply for AWGN channels.

## On optimal family of codes for archival DNA storage

- **Status**: ❌
- **Reason**: DNA 아카이브 저장용 ternary(비이진) Golay 부호 인코딩. 비-LDPC·비이진, 채널 디코더 이식 기법 없음.
- **ID**: ieee:7458386
- **Type**: conference
- **Published**: 2015
- **Authors**: D. Limbachiya, V. Dhameliya, M. Khakhar +1
- **PDF**: https://ieeexplore.ieee.org/document/7458386
- **Abstract**: DNA based storage systems received attention by many researchers in the last few years. This includes archival and re-writable (random access) DNA based storage systems. In this work, we have developed an efficient technique to encode the data into the DNA sequences using non-linear family of ternary codes. In particular, we propose an algorithm to encode data into DNA with high information storage density for archival storage using the sub-code of the Golay code. Theoretically, 115 exabytes (EB) data can be stored in one gram of DNA using our method.

## Hybrid analog-digital coding for nonuniform memoryless sources

- **Status**: ❌
- **Reason**: 비균일 소스 하이브리드 아날로그-디지털 전송(RCM+LDGM) — JSCC/LDGM, 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:7086861
- **Type**: conference
- **Published**: 2015
- **Authors**: L. Li, J. Garcia-Frias
- **PDF**: https://ieeexplore.ieee.org/document/7086861
- **Abstract**: In this paper, we propose a hybrid analog-digital scheme for the transmission of non-uniform memoryless sources over Additive White Gaussian Noise (AWGN) channels. The hybrid scheme is constructed by generating most of the output symbols from standard linear combinations of the input bits, as in Rate Compatible Modulation (RCM), and a few of them using a Low Density Generator Matrix (LDGM) code. The basic idea is that the RCM scheme corrects most of errors, leaving residual errors to be corrected by the LDGM code. Source non-uniformity is exploited at the decoder and the encoder is optimized depending on the source non-uniformity to further improve the system performance.

## Exploring connections between Sparse Fourier Transform computation and decoding of product codes

- **Status**: ❌
- **Reason**: FFAST 희소푸리에=product code 경판정 디코딩 등가성·임계값 이론. product code(비-LDPC) 대상이고 떼어낼 BP 이식 기법 없음 — 순수 이론.
- **ID**: ieee:7447167
- **Type**: conference
- **Published**: 2015
- **Authors**: N. T. Janakiraman, S. Emmadi, K. Narayanan +1
- **PDF**: https://ieeexplore.ieee.org/document/7447167
...
- **Status**: ❌
- **Reason**: 비이진 LDGM(non-binary) + lattice 네트워크 코딩, 바이너리 LDPC ECC 이식 기법 없음
- **ID**: ieee:7343278
- **Type**: conference
- **Published**: 2015
- **Authors**: Y. Ma, Z. Lin, J. Li +2
- **PDF**: https://ieeexplore.ieee.org/document/7343278
...
- **Status**: ❌
- **Reason**: Physical-layer network coding with Gaussian waveforms and linear equalizer; no LDPC technique to port
- **ID**: ieee:7052103
- **Type**: conference
- **Published**: 2015
- **Authors**: M. Woltering, D. Wuebben, A. Dekorsy +2
- **PDF**: https://ieeexplore.ieee.org/document/7052103
...
- **Status**: ❌
- **Reason**: DVB-T2 IRD 수신기 사양 시뮬레이션. FEC 부수 언급뿐, 신규 디코더·구성 기여 없음 — 응용 특이적.
- **ID**: ieee:7482224
- **Type**: conference
- **Published**: 2015
- **Authors**: J. Abdullah, A. A. W. Abobaker, O. Elijah
- **PDF**: https://ieeexplore.ieee.org/document/7482224
- **Abstract**: DVB-T2 (digital video broadcasting - second generation terrestrial) is considered as the most advanced digital terrestrial television system. It supports either or any combination of SD (standard definition), HD (high definition) UHD (ultra-high definition), and mobile TV. One of the challenges of the DVB-T2 is the many options it provides in system mode and parameters which needs to be accurately selected to suit different applications. In view of this, requirement for the IRD (integrated receiver decoder) for use with the DVB-T2 for ASEAN countries has been defined. This paper deals with the transmission performance for the AGWN (additive white Gaussian noise), fixed and portable TV channels. Simulation results of the BER (bit error ratio) after the FEC (Forward Error Correction) decoding were evaluated and compared for the three types of channels. The effect of constellation rotation is being explored for a particular IRD scenario. Appropriate simulations for this study were carried using common simulation platform (CSP) and MATLAB. Finally, the achieved results are evaluated and clearly discussed.

## Performance comparison of mixed modulation codewords and shortened codewords in DOCSIS 3.1 cable modem system

- **Status**: ❌
- **Reason**: DOCSIS 3.1 코드워드 모듈레이션 성능 비교 — 떼어낼 신규 LDPC 디코더/구성 없음
- **ID**: ieee:7066563
- **Type**: conference
- **Published**: 2015
- **Authors**: Joon-Young Jung, Dong-Joon Choi, Namho Hur
- **PDF**: https://ieeexplore.ieee.org/document/7066563
- **Abstract**: This paper provides a performance comparison of mixed modulation codewords and shortened codewords defined in DOCSIS 3.1 specifications. In mixed modulation codewords, the same modulation constellation is not used for all sub-carriers of the OFDM symbol. The performance comparison is needed to decide efficient transmission parameters at the view of signal-to-noise ratio and spectral efficiency. In this paper, we present the more efficient codeword scheme from the comparison.

## Design and performance analysis of network code division multiplexing for wireless sensor networks

- **Status**: ❌
- **Reason**: WSN 네트워크 코드분할다중화 BER 분석; 생성행렬 설계 기준은 응용 특이적, 이식할 LDPC ECC 기법 없음
- **ID**: ieee:7282778
- **Type**: conference
- **Published**: 2015
- **Authors**: J. Yue, Z. Lin, G. Mao +1
- **PDF**: https://ieeexplore.ieee.org/document/7282778
- **Abstract**: In this paper, we investigate the performance of a wireless sensor network, in which multiple groups of source nodes communicate with their respective destination nodes with the help of a common relay network. A network code division multiplexing (NCDM) scheme is proposed to remove the inter-session interference among multiple transmission sessions at each destination. We focus on analyzing the soft processing algorithm of the NCDM scheme. Based on the analysis results, a new code design criteria for the construction of the generator matrix is proposed. Simulation results show that by following the proposed code design criteria, the bit error ratio (BER) performance gap between the scheme we studied and the serial session scheme can be managed effectively. In serial session scheme, source nodes in a number of groups communicate with their respective destinations in a time division manner.

## A novel channel estimation scheme for terrestrial cloud transmission systems

- **Status**: ❌
- **Reason**: 지상파 클라우드 전송 채널추정(FFT 보간/필터) — LDPC 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:7066505
- **Type**: conference
- **Published**: 2015
- **Authors**: S. I. Park, H. M. Kim, J. Kim
- **PDF**: https://ieeexplore.ieee.org/document/7066505
- **Abstract**: In this paper, we propose a novel channel estimation scheme for the terrestrial cloud transmission system under time-varying and multipath fading channels. The proposed scheme utilizes FFT-based interpolation with windowing and moving average filters.

## Real-time rate-adaptable coding for fading channels

- **Status**: ❌
- **Reason**: fading 채널용 적응형 convolutional 부호 + Viterbi 디코딩 — 비-LDPC 부호, 부호 비의존적 BP 이식 기법 없음.
- **ID**: ieee:7369544
- **Type**: conference
- **Published**: 2015
- **Authors**: S. Schmidt, W. K. Harrison
- **PDF**: https://ieeexplore.ieee.org/document/7369544
...
- **Status**: ❌
- **Reason**: Multidimensional signal constellation design for nonlinear phase noise; modulation/coded-modulation, no LDPC technique.
- **ID**: ieee:7357754
- **Type**: conference
- **Published**: 2015
- **Authors**: T. Liu, I. B. Djordjevic, Mo Li
- **PDF**: https://ieeexplore.ieee.org/document/7357754
...
- **Status**: ❌
- **Reason**: OFDM cognitive radio tunes existing LDPC/interleaver params for latency; application-specific, no novel decoder/code.
- **ID**: ieee:7357732
- **Type**: conference
- **Published**: 2015
- **Authors**: N. J. Vukmirović, M. T. Janjić, P. N. Ivaniš
- **PDF**: https://ieeexplore.ieee.org/document/7357732
...
- **Status**: ❌
- **Reason**: SCMA 다중사용자 반복 수신기; SCMA 종속 MPA, 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:7248770
- **Type**: conference
- **Published**: 2015
- **Authors**: Y. Wu, S. Zhang, Y. Chen
- **PDF**: https://ieeexplore.ieee.org/document/7248770
...
## Rateless spinal code for decode-and-forward relay channel

- **Status**: ❌
- **Reason**: rateless spinal code 릴레이 — 비-LDPC 부호, 이식 가능 BP 기법 없음
- **ID**: ieee:7354338
- **Type**: conference
- **Published**: 2015
- **Authors**: X. Yu, Ying Li, Weiqiang Yang
- **PDF**: https://ieeexplore.ieee.org/document/7354338
- **Abstract**: A practical rateless coding framework for the half-duplex decode-and-forward (DF) relay channel is proposed in this paper. Rateless spinal codes are employed as the basic coding strategy in our coding framework and a cooperative decoder for the destination is proposed. Moreover, by introducing the concepts of equivalent code and equivalent channel, we prove that the proposed coding framework is capable of achieving the maximum transmission rate of the half-duplex DF relay channel. We also verify our analysis with simulations. And simulation results indicate that the proposed coding framework is robust and efficient when the channel condition varies.

## Low complexity distributed approach to Hyperspectral image compression

- **Status**: ❌
- **Reason**: 하이퍼스펙트럴 이미지 압축(Slepian-Wolf 분산 소스코딩) — 소스 코딩이지 채널 ECC 아님.
- **ID**: ieee:7373020
- **Type**: conference
- **Published**: 2015
- **Authors**: A. S. Mamatha, V. Kusuma, V. Singh +1
- **PDF**: https://ieeexplore.ieee.org/document/7373020
...
- **Status**: ❌
- **Reason**: BLE 패킷손실 완화(안테나/다중수신기/앱계층 코딩) 무선 응용 특이적 — 떼어낼 LDPC ECC 기법 없음.
- **ID**: ieee:7389068
- **Type**: conference
- **Published**: 2015
- **Authors**: E. Tsimbalo, X. Fafoutis, E. Mellios +5
- **PDF**: https://ieeexplore.ieee.org/document/7389068
...
- **Status**: ❌
- **Reason**: BLE CRC 부호에 반복 디코딩 적용 — 비-LDPC(CRC) 부호 특이적, 바이너리 LDPC BP에 이식할 일반 기법 아님.
- **ID**: ieee:7389067
- **Type**: conference
- **Published**: 2015
- **Authors**: E. Tsimbalo, X. Fafoutis, R. Piechocki
- **PDF**: https://ieeexplore.ieee.org/document/7389067
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) GLD 격자/부호, 비이진 LDPC는 제외 대상
- **ID**: ieee:7133127
- **Type**: conference
- **Published**: 2015
- **Authors**: N. di Pietro, N. Basha, J. J. Boutros
- **PDF**: https://ieeexplore.ieee.org/document/7133127
...
- **Status**: ❌
- **Reason**: CiDRA DRAM resilience via cache + generic in-DRAM ECC; memory ECC architecture but not binary LDPC technique
- **ID**: ieee:7056058
- **Type**: conference
- **Published**: 2015
- **Authors**: Y. H. Son, S. Lee, O. Seongil +3
- **PDF**: https://ieeexplore.ieee.org/document/7056058
...
- **Status**: ❌
- **Reason**: OFDM CSI 기반 soft reliability + KV-RS(Reed-Solomon) 디코딩. LDPC 무관, 비-LDPC 부호
- **ID**: ieee:7117241
- **Type**: conference
- **Published**: 2015
- **Authors**: O. O. Ogundile, D. J. J. Versfeld
- **PDF**: https://ieeexplore.ieee.org/document/7117241
...
## Overlapped fountain coding for delay-constrained priority-based broadcast applications

- **Status**: ❌
- **Reason**: fountain/rateless(LT) 코드 설계로 채널 ECC 아닌 erasure 코딩, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:7255157
- **Type**: conference
- **Published**: 2015
- **Authors**: K. F. Hayajneh, S. Yousefi
- **PDF**: https://ieeexplore.ieee.org/document/7255157
...
## Transmission of 8×128.8Gbaud single-carrier PDM-QPSK signal over 2800-km EDFA-only SMF-28 link

- **Status**: ❌
- **Reason**: Optical single-carrier transmission demo, no LDPC technique
- **ID**: ieee:7341779
- **Type**: conference
- **Published**: 2015
- **Authors**: J. Yu, J. Zhang, Z. Jia +6
- **PDF**: https://ieeexplore.ieee.org/document/7341779
- **Abstract**: We successfully transmitted 100-GHz-grid, 8 channels single-carrier 515.2-Gb/s super-Nyquist signal over 2800-km SMF-28 with EDFA-only amplification. Record all-ETDM-based 136-Gbaud PDM-QPSK is also generated and coherently detected.

## Code-adaptive transmission accounting for filtering effects in EON

- **Status**: ❌
- **Reason**: 탄성광망(EON) 코드적응 전송 실험, LDPC 부호 비의존 ECC 이식 기법 없음
- **ID**: ieee:7127302
- **Type**: conference
- **Published**: 2015
- **Authors**: G. Meloni, L. Potı, N. Sambo +2
- **PDF**: https://ieeexplore.ieee.org/document/7127302
- **Abstract**: Terabit/s Time-Frequency-Packing (TFP) superchannel transmission based on code-adaptation is demonstrated for elastic optical networks. Code is set to achieve error free transmission accounting for physical layer impairments including filtering effects. High spectral-efficient transmission (e.g., 6.6 b/s/Hz with low-order format polarization multiplexing quadrature phase shift keying —PM-QPSK) is achieved in an elastic optical network (EON) experimental testbed including fiber transmission and filters. Monitoring of the super-channel is also enabled to reveal possible signal degradations. In case, hitless code adaption is performed to re-act to the degradation without the need of any re-routing.

## The truncated transmission of spinal codes with imperfect feedback in block-fading channel

- **Status**: ❌
- **Reason**: Spinal codes rate allocation, non-LDPC, no transferable ECC technique
- **ID**: ieee:7341305
- **Type**: conference
- **Published**: 2015
- **Authors**: Z. Li, R. Liu, R. Duan +1
- **PDF**: https://ieeexplore.ieee.org/document/7341305
- **Abstract**: In this paper, a rate allocation policy is proposed for truncated transmission of spinal codes based on imperfect feedback over block fading channels. By constructing and solving the throughput optimization problem, the optimized rate allocation policy is obtained under the constraint of limited transmission attempts and frame error probability. Both analysis and simulations show that the rate-allocated transmission of spinal codes achieves higher throughput in block-fading channel with noisy feedback compared to the fixed rate transmission.

## Simplifying soft demapper design for software DVB-T2 channel decoder

- **Status**: ❌
- **Reason**: DVB-T2 soft demapper 단순화 — LDPC 디코더/코드/HW 기법 없음, 무선 수신기 특화
- **ID**: ieee:7398570
- **Type**: conference
- **Published**: 2015
- **Authors**: S. D. You
- **PDF**: https://ieeexplore.ieee.org/document/7398570
...
- **Status**: ❌
- **Reason**: DVB-S2 전송스트림 프레임 구조 FPGA 구현으로 표준 부호 사용, 신규 LDPC 디코더/HW 기여 없음
- **ID**: ieee:7208128
- **Type**: conference
- **Published**: 2015
- **Authors**: R. Varsha, R. Arora, T. V. S. Ram +1
- **PDF**: https://ieeexplore.ieee.org/document/7208128
...
## YANG modeling of network elements for the management and monitoring of Elastic Optical Networks

- **Status**: ❌
- **Reason**: 탄성광망 YANG 데이터모델링, LDPC·ECC 무관
- **ID**: ieee:7427931
- **Type**: conference
- **Published**: 2015
- **Authors**: J. Akhtar
- **PDF**: https://ieeexplore.ieee.org/document/7427931
...
- **Status**: ❌
- **Reason**: EON carrier spacing self-adaptation, no ECC/LDPC
- **ID**: ieee:7341669
- **Type**: conference
- **Published**: 2015
- **Authors**: F. Cugini, F. Fresi, F. Paolucci +5
- **PDF**: https://ieeexplore.ieee.org/document/7341669
...
## Performance of joint iterative detection and decoding in coherent optical channels

- **Status**: ❌
- **Reason**: coherent optical 위상잡음 보상 joint detection/decoding, LDPC 무관, 광통신 응용 특이적
- **ID**: ieee:7121628
- **Type**: conference
- **Published**: 2015
- **Authors**: M. A. Castrillón, D. A. Morero, O. E. Agazzi +1
- **PDF**: https://ieeexplore.ieee.org/document/7121628
- **Abstract**: We show that a joint iterative detection and decoding algorithm compensates phase noise and laser frequency fluctuations in a 100 Gb/s coherent optical receiver with non-differential 16-QAM modulation, achieving 1 dB gain over existing solutions.

## A study on common phase rotation compensation for coaxial transmission systems in the HFC network

- **Status**: ❌
- **Reason**: HFC coaxial phase rotation compensation (DSP/FPGA, DVB-C2); no LDPC decoder/code/HW technique to transplant.
- **ID**: ieee:7354517
- **Type**: conference
- **Published**: 2015
- **Authors**: J. Bae, J. Song, S. -J. Ra +2
- **PDF**: https://ieeexplore.ieee.org/document/7354517
- **Abstract**: We present a study result for common phase rotation compensation based on DSP and FPGA for coaxial transmission system in the HFC network. Recently, most of internet networks have HFC configuration. For 10Gbps speed in the HFC network, coaxial networks should support 10Gbps. For this, DVB-C2, DOCSIS 3.1, EPoC are developed. Especially, DVB-C2 attracts attentions for 8K-UHDTV services. Considering DVB-C2 in 10Gbps transmission, the common phase rotation should be compensated efficiently. The presented study result is focused on the computation and the processing of common phase rotation.

## DOCSIS 3.1® technology and hybrid fiber coax for multi-Gbps broadband

- **Status**: ❌
- **Reason**: DOCSIS 3.1 HFC 광대역 기술 트렌드 개요, ECC 기법 없음
- **ID**: ieee:7121746
- **Type**: conference
- **Published**: 2015
- **Authors**: D. J. Rice
- **PDF**: https://ieeexplore.ieee.org/document/7121746
- **Abstract**: DOCSIS® 3.1 technologies over HFC networks will continue to support the best-in-market speeds delivered to the broadest population of consumers with the best customer experience. This paper describes the trends of broadband demand and how cable technology could evolve leveraging fiber deep technologies.

## Post-FEC performance evaluation of coherent QPSK system with an enhanced pilot-aided CPE scheme

- **Status**: ❌
- **Reason**: 코히어런트 QPSK 위상잡음 추정(pilot-aided CPE)으로 FEC 성능평가만, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:7203733
- **Type**: conference
- **Published**: 2015
- **Authors**: Huizhong Chen, Haiquan Cheng, Yan Li +2
- **PDF**: https://ieeexplore.ieee.org/document/7203733
- **Abstract**: An simple and robust pilot-aided CPE scheme with a modified phase unwrapping is proposed. A 2.2 gain and post-FEC error-free performance are achieved with only 0.78 % pilot overhead in the presence of phase noise.

## Dithered multi-pulsing and non-parametric statistical inference algorithm for time-of-flight mass spectrometry

- **Status**: ❌
- **Reason**: 비행시간 질량분석용 BP-영감 통계 추론, LDPC ECC 아니고 바이너리 LDPC로 이식할 디코더 기법 없음
- **ID**: ieee:7421185
- **Type**: conference
- **Published**: 2015
- **Authors**: G. S. Moore, M. Manlove, A. Hidalgo
- **PDF**: https://ieeexplore.ieee.org/document/7421185
...
## Study of development of transmission systems for terrestrial 4K UHD & HD convergence broadcasting

- **Status**: ❌
- **Reason**: 4K UHD 지상파 방송 전송 파라미터 연구 — LDPC ECC 신규 기법 없음
- **ID**: ieee:7066525
- **Type**: conference
- **Published**: 2015
- **Authors**: Jong Gyu Oh, Yong Ju Won, Jin Sub Lee +1
- **PDF**: https://ieeexplore.ieee.org/document/7066525
- **Abstract**: In this paper, the service scenario & requirements for providing 4K UHD & HD convergence broadcasting services through terrestrial single channel are analyzed by employing the latest transmission and A/V codec technologies. Optimized transmission parameters for 6 MHz & 8 MHz terrestrial bandwidths are drawn, and receiving performances are measured under Additive White Gaussian Noise (AWGN) and time-varying multipath channels.

## Study on Effect of Cyclic Prefix Extension and Windowing in Cable Modem System

- **Status**: ❌
- **Reason**: 케이블모뎀 CP확장·윈도잉(OFDM), 떼어낼 LDPC 기법 없음
- **ID**: ieee:7434188
- **Type**: conference
- **Published**: 2015
- **Authors**: J. H. Song, S. -J. La, J. H. Bae +2
- **PDF**: https://ieeexplore.ieee.org/document/7434188
- **Abstract**: This paper provides the effect of cyclic prefix (CP) extension and windowing defined in DOCSIS 3.1. When using windowing, a larger roll-off period (RP) leads to sharper spectrum edge in frequency domain. However, from the perspective of synchronization or multipath fading immunity, the selection of low RP can offer better performance. Therefore, the optimum length of value for RP is needed to take into account the given channel, bandwidth and QAM modulation. In this paper, we present the frequency spectrum characteristics and compare the synchronization performance of orthogonal frequency division multiplexing (OFDM) symbol according to the different length of RP.

## Towards DSP technology interoperability for next generation metro/regional optical networks

- **Status**: ❌
- **Reason**: DSP interoperability for optical networks, no LDPC/ECC content
- **ID**: ieee:7329012
- **Type**: conference
- **Published**: 2015
- **Authors**: A. Napoli, T. Rahman, G. Meloni +7
- **PDF**: https://ieeexplore.ieee.org/document/7329012
...
- **Status**: ❌
- **Reason**: LDM 기반 방송용 프레이밍/PLP 구조 — 프레임 다중화 구조, LDPC 디코더·코드설계 기법과 무관
- **ID**: ieee:7177240
- **Type**: conference
- **Published**: 2015
- **Authors**: J. -y. Lee, S. I. Park, S. Kwon +6
- **PDF**: https://ieeexplore.ieee.org/document/7177240
...
- **Status**: ❌
- **Reason**: DVB-T2 회전 QAM demapper LLR HW — LDPC 디코더 자체가 아닌 demapper 전용, 떼어낼 LDPC 기법 없음
- **ID**: ieee:7344998
- **Type**: conference
- **Published**: 2015
- **Authors**: J. Yang, M. Li, M. Li +3
- **PDF**: https://ieeexplore.ieee.org/document/7344998
...
- **Status**: ❌
- **Reason**: 위성 기반 사이버보안 복구 시스템 운용개념 — ECC/LDPC와 무관
- **ID**: ieee:7225325
- **Type**: conference
- **Published**: 2015
- **Authors**: H. C. Shaw, B. McLaughlin, F. Stocklin +7
- **PDF**: https://ieeexplore.ieee.org/document/7225325
...
- **Status**: ❌
- **Reason**: MDS array code(erasure) 단일소거 복구 — LDPC가 아닌 MDS array 부호, I/O 최적화이며 LDPC ECC 기법 없음
- **ID**: ieee:7177078
- **Type**: journal
- **Published**: 2015
- **Authors**: Z. Huang, H. Jiang, K. Zhou +2
- **PDF**: https://ieeexplore.ieee.org/document/7177078
...
- **Status**: ❌
- **Reason**: 양자 스태빌라이저 부호 디코딩의 계산복잡도(#P-complete) 이론, 양자 전용·고전 바이너리 LDPC로 이식할 디코더/구성 기법 없음
- **ID**: ieee:7097029
- **Type**: journal
- **Published**: 2015
- **Authors**: P. Iyer, D. Poulin
- **PDF**: https://ieeexplore.ieee.org/document/7097029
...
- **Status**: ❌
- **Reason**: constant weight/dimension 부호의 기하 구성, 패킷손실복구용; LDPC 아니고 이식할 디코더/구성 기법 없음
- **ID**: ieee:6990580
- **Type**: journal
- **Published**: 2015
- **Authors**: C. Chen, X. Wang, B. Bai +1
- **PDF**: https://ieeexplore.ieee.org/document/6990580
...
- **Status**: ❌
- **Reason**: Hamming 부호 GPU 디코더(비-LDPC), SDR용 구현이며 바이너리 LDPC BP로 이식할 부호 비의존 기법 없음
- **ID**: ieee:7104848
- **Type**: journal
- **Published**: 2015
- **Authors**: M. S. Islam, C. -H. Kim, J. -M. Kim
- **PDF**: https://ieeexplore.ieee.org/document/7104848
...
- **Status**: ❌
- **Reason**: 비이진 RS 코드 병렬 디코더 — 비-LDPC 비이진 부호, BP 이식성 없음
- **ID**: ieee:6979260
- **Type**: journal
- **Published**: 2015
- **Authors**: K. Namba, F. Lombardi
- **PDF**: https://ieeexplore.ieee.org/document/6979260
...
- **Status**: ❌
- **Reason**: 클라우드 분산 이미지 코딩(소스/신드롬 코딩) — 채널 ECC 아님, 소스코딩 제외
- **ID**: ieee:7067354
- **Type**: journal
- **Published**: 2015
- **Authors**: X. Song, X. Peng, J. Xu +2
- **PDF**: https://ieeexplore.ieee.org/document/7067354
...
- **Status**: ❌
- **Reason**: 폴라 부호 IR-HARQ 펑처링/확장; 비-LDPC, LDPC BP로 이식 안 됨
- **ID**: ieee:7244219
- **Type**: journal
- **Published**: 2015
- **Authors**: H. Saber, I. Marsland
- **PDF**: https://ieeexplore.ieee.org/document/7244219
...
- **Status**: ❌
- **Reason**: XOR 기반 Non-MDS RAID-6 erasure 코드 설계; LDPC가 아니며 떼어낼 LDPC 기법 없음
- **ID**: ieee:8213024
- **Type**: journal
- **Published**: 2015
- **Authors**: P. Xie, J. Huang, Q. Cao +2
- **PDF**: https://ieeexplore.ieee.org/document/8213024
...
- **Status**: ❌
- **Reason**: 비동기 DB 대상 PIR(프라이버시 검색) 기법, ECC 아님이며 떼어낼 LDPC 디코더/HW 기법 없음
- **ID**: ieee:7105864
- **Type**: journal
- **Published**: 2015
- **Authors**: G. Fanti, K. Ramchandran
- **PDF**: https://ieeexplore.ieee.org/document/7105864
...
- **Status**: ❌
- **Reason**: 정보이론 보안(universal hashing, 시크릿키/wiretap)으로 LDPC ECC 기법 없음
- **ID**: ieee:7270413
- **Type**: journal
- **Published**: 2015
- **Authors**: H. Tyagi, A. Vardy
- **PDF**: https://ieeexplore.ieee.org/document/7270413
...
- **Status**: ❌
- **Reason**: Turbo TCM + 계층변조 협력통신 — 비-LDPC, 이식 가능한 BP 디코더 기법 없음
- **ID**: ieee:6942255
- **Type**: journal
- **Published**: 2015
- **Authors**: H. Sun, S. X. Ng, L. Hanzo
- **PDF**: https://ieeexplore.ieee.org/document/6942255
...
- **Status**: ❌
- **Reason**: 2D ISI turbo 등화기(1D 등화기 결합), 등화 기법이며 LDPC BP 디코더로 이식할 부호 비의존 메시지패싱 기여 없음
- **ID**: ieee:7105911
- **Type**: journal
- **Published**: 2015
- **Authors**: J. No, J. Moon
- **PDF**: https://ieeexplore.ieee.org/document/7105911
- **Abstract**: A 2-D soft-in, soft-out equalizer consisting of multiple low-complexity constituent equalizers is proposed for the turbo equalization of 2-D intersymbol interference. The constituent equalizers are simple 1-D linear equalizers running in different directions over a 2-D array of storage cells. Simulation results as well as an extrinsic information transfer chart analysis indicate that the proposed concatenation provides performance comparable with finite-window trellis-based equalizers while requiring a much lower complexity level.

## Redundancy on Demand—Extending the Coverage Area of Terrestrial Broadcast via Broadband Networks

- **Status**: ❌
- **Reason**: 지상파 방송 redundancy-on-demand 네트워크 시스템, 채널 ECC LDPC 기법 무관 — 응용 특이적 제외
- **ID**: ieee:6811186
- **Type**: journal
- **Published**: 2015
- **Authors**: J. Qi, J. Zöllner, J. Robert +2
- **PDF**: https://ieeexplore.ieee.org/document/6811186
...
- **Status**: ❌
- **Reason**: 무선 네트워크 link-layer 패킷 복구/노드 라우팅 프레임워크 — 부호 비특정, 떼어낼 LDPC 디코더/HW/구성 기법 없음
- **ID**: ieee:6862930
- **Type**: journal
- **Published**: 2015
- **Authors**: C. Qiu, H. Shen, S. Soltani +3
- **PDF**: https://ieeexplore.ieee.org/document/6862930
...
- **Status**: ❌
- **Reason**: 의료 BAN용 광무선통신(OWC) 응용 분석, LDPC/ECC 무관
- **ID**: ieee:7106550
- **Type**: journal
- **Published**: 2015
- **Authors**: L. Chevalier, S. Sahuguede, A. Julien-Vergonjanne
- **PDF**: https://ieeexplore.ieee.org/document/7106550
...
- **Status**: ❌
- **Reason**: slotted Aloha 협력 디코딩+degree distribution 최적화, 채널 ECC가 아닌 다중접속/SIC 응용
- **ID**: ieee:7042307
- **Type**: journal
- **Published**: 2015
- **Authors**: D. Jakovetić, D. Bajović, D. Vukobratović +1
- **PDF**: https://ieeexplore.ieee.org/document/7042307
...
- **Status**: ❌
- **Reason**: CO-OFDM용 pilot-aided LLR 메트릭; 광통신 위상오차 보정 특이적 LLR이라 NAND LLR 양자화로 이식 곤란
- **ID**: ieee:7014221
- **Type**: journal
- **Published**: 15 May15, 
- **Authors**: Shengjiao Cao, Pooi-Yuen Kam, Changyuan Yu +1
- **PDF**: https://ieeexplore.ieee.org/document/7014221
...
- **Status**: ❌
- **Reason**: 광통신 4D 코드변조/bit-wise decoder, LDPC는 검증용 베이스라인; 떼어낼 NAND LDPC ECC 기법 없음
- **ID**: ieee:7029599
- **Type**: journal
- **Published**: 15 May15, 
- **Authors**: Alex Alvarado, Erik Agrell
- **PDF**: https://ieeexplore.ieee.org/document/7029599
...
- **Status**: ❌
- **Reason**: VLC 디밍 제어용 표준 QC-LDPC를 extension/puncturing으로 rate 조정 — 응용 특이적, NAND에 떼어낼 신규 디코더/구성/HW 없음
- **ID**: ieee:6937164
- **Type**: journal
- **Published**: 1 May1, 20
- **Authors**: Sunghwan Kim
- **PDF**: https://ieeexplore.ieee.org/document/6937164
...
- **Status**: ❌
- **Reason**: 다차원 coded modulation/매핑 리뷰 — 이식할 LDPC ECC 기법 없음
- **ID**: ieee:7079387
- **Type**: journal
- **Published**: 1 July1, 2
- **Authors**: Hongbin Zhang, Hussam G. Batshon, Carl R. Davidson +2
- **PDF**: https://ieeexplore.ieee.org/document/7079387

...
- **Status**: ❌
- **Reason**: RA-type LDPC splitting rate-control은 RA 특이적 rate 호환 구성, NAND용 신규 디코더/구성 아님
- **ID**: ieee:5351642
- **Type**: journal
- **Published**: December 2
- **Authors**: H.-J. Joo, S.-N. Hong, D.-J. Shin
- **PDF**: https://ieeexplore.ieee.org/document/5351642
- **Abstract**: In this letter, a new rate-control scheme, called splitting, is proposed to construct low-rate codes from highrate codes, which splits rows of parity-check matrices of repeat accumulate-type (RA-Type) LDPC codes by adding new parity bits. When a high-degree check node is split into two low-degree check nodes, by making the check node degree distribution in a concentrated form, the performance of low-rate codes can be improved. We also explicitly construct rate-compatible repeat RA-Type LDPC (RC RA-Type LDPC) codes using splitting for code rates from 1/3 to 4/5 and compare this with other RC RA-Type LDPC codes.

## Minimum distance and convergence analysis of hamming-accumulate-accumulate codes

- **Status**: ❌
- **Reason**: Hamming-accumulate-accumulate 부호 최소거리/수렴 분석, 비-LDPC 직렬연접 — 떼어낼 BP 기법 없음
- **ID**: ieee:5351641
- **Type**: journal
- **Published**: December 2
- **Authors**: Alexandre Graell i Amat I Amat, Raphael Le Bidan
- **PDF**: https://ieeexplore.ieee.org/document/5351641
...
- **Status**: ❌
- **Reason**: Raptor(fountain) 부호 FSO/RF 하이브리드, 비-LDPC fountain — 제외
- **ID**: ieee:5342329
- **Type**: journal
- **Published**: December 2
- **Authors**: Wenzhe Zhang, Steve Hranilovic, Ce Shi
- **PDF**: https://ieeexplore.ieee.org/document/5342329
...
- **Status**: ❌
- **Reason**: FSO 비균일 신호 입력분포/multi-level coding, ECC 디코더·구성 신규 기여 없음
- **ID**: ieee:5342315
- **Type**: journal
- **Published**: December 2
- **Authors**: Ahmed A. Farid, Steve Hranilovic
- **PDF**: https://ieeexplore.ieee.org/document/5342315
...
- **Status**: ❌
- **Reason**: 무선 채널추정·간섭완화·디코딩 결합 메시지패싱으로 무선 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:5351719
- **Type**: journal
- **Published**: December 2
- **Authors**: Yan Zhu, Dongning Guo, Michael L. Honig
- **PDF**: https://ieeexplore.ieee.org/document/5351719
...
- **Status**: ❌
- **Reason**: convolutional code 출력 균일성에 관한 순수 이론, 비-LDPC이며 디코더/구성 기여 없음
- **ID**: ieee:5353271
- **Type**: journal
- **Published**: December 2
- **Authors**: Patrick Mitran
- **PDF**: https://ieeexplore.ieee.org/document/5353271
...
- **Status**: ❌
- **Reason**: 센서 네트워크 분산소스코딩 rate/power 할당 문제로 LDPC ECC 기법 없음
- **ID**: ieee:5351673
- **Type**: journal
- **Published**: December 2
- **Authors**: Shizheng Li, Aditya Ramamoorthy
- **PDF**: https://ieeexplore.ieee.org/document/5351673
...
- **Status**: ❌
- **Reason**: wiretap channel 보안/물리계층 비밀성 응용; LDPC는 부수적, 보안 도메인이라 원칙 제외
- **ID**: ieee:6388407
- **Type**: journal
- **Published**: Dec. 2009
- **Authors**: Hong Wen, Guang Gong, Pin-Han Ho
- **PDF**: https://ieeexplore.ieee.org/document/6388407
...
- **Status**: ❌
- **Reason**: GF(2^m) 비이진 LDPC 디코더 HW 구현으로 비이진 LDPC 제외 대상
- **ID**: ieee:4798180
- **Type**: journal
- **Published**: Dec. 2009
- **Authors**: Christian Spagnol, Emanuel Mihai Popovici, William Peter Marnane
- **PDF**: https://ieeexplore.ieee.org/document/4798180
...
- **Status**: ❌
- **Reason**: 분산산술부호(DAC) 코드워드 분포 분석으로 소스코딩, 채널 LDPC ECC 아님
- **ID**: ieee:5204158
- **Type**: journal
- **Published**: Dec. 2009
- **Authors**: Yong Fang
- **PDF**: https://ieeexplore.ieee.org/document/5204158
...
- **Status**: ❌
- **Reason**: 상관 소스 결합 디코딩(BICM-ID, Slepian-Wolf JSCC)으로 LDPC가 베이스라인, 떼어낼 채널 ECC 기법 없음
- **ID**: ieee:5397615
- **Type**: conference
- **Published**: 8-10 Dec. 
- **Authors**: Takashi Shimizu, Tad Matsumoto, Hidekazu Murata +2
- **PDF**: https://ieeexplore.ieee.org/document/5397615
...
- **Status**: ❌
- **Reason**: Projective Geometry LDPC를 무선 응용에 적용+shortening/Chase Combining, 표준 PG코드·다수결 디코딩 단순 사용으로 신규 기여 미흡
- **ID**: ieee:5397612
- **Type**: conference
- **Published**: 8-10 Dec. 
- **Authors**: Balaji Janakiram, M. Girish Chandra, S.G. Harihara +2
- **PDF**: https://ieeexplore.ieee.org/document/5397612
- **Abstract**: The Projective Geometry (PG) based Low Density Parity Check (LDPC) codes are gaining popularity due to their ease of encoding and decoding by the simple majority logic technique. These codes have a flurry of other useful properties, making them ideal candidates/codes for error correction for future wireless applications. This paper brings out a detailed study on the performance of PG codes for different decoding algorithms, bearing in mind the implementation issues. The work is extended by providing results for the shortening (rate reduction) and Chase Combining, which aids in bringing out their usefulness for wireless applications.

## Splitting and merging based rate adaptive LDPC for distributed video coding

- **Status**: ❌
- **Reason**: 분산비디오코딩용 rate-adaptive LDPC(소스코딩 응용), NAND ECC로 떼어낼 기법 없음
- **ID**: ieee:5521954
- **Type**: conference
- **Published**: 7-9 Dec. 2
- **Authors**: Chun-Ling Yang, Hong-Tao Xia, Duan-Wu Cao
- **PDF**: https://ieeexplore.ieee.org/document/5521954
...
## Design of efficient low rate QCARA GLDPC codes

- **Status**: ❌
- **Reason**: GLDPC(generalized, Hamming 노드 super코드)+CCSDS turbo 비교, 표준 NAND 바이너리 LDPC 범위 밖 일반화 구성
- **ID**: ieee:5522038
- **Type**: conference
- **Published**: 7-9 Dec. 2
- **Authors**: Jianrong Bao, Yafeng Zhan, Jianqiang Wu +1
- **PDF**: https://ieeexplore.ieee.org/document/5522038
- **Abstract**: A new method of designing efficient low rate low-density parity-check (LDPC) code is proposed. It is firstly constructed by a basic protograph based accumulate-repeat-accumulate (ARA) code and then extended to a generalized LDPC (GLDPC) code where a parity check node is replaced by a more powerful hamming node. It is implemented in the form of quasi-cyclic (QC) which saves memory resources and greatly reduces the complexity of both encoding and decoding. So the code is called as QCARA GLDPC code since it has features of QC, ARA and GLDPC. Simulation results show that the code designed by the proposed method can achieve lower decoding complexity and less decoding latency at the cost of just 0.3 dB performance loss when compared to the Turbo code of the consultative committee for space data systems (CCSDS) with the same code rate at bit-error-rate (BER) of 10−5.

## Hybrid blind synchronization for LDPC coded system

- **Status**: ❌
- **Reason**: LDPC 블라인드 프레임 동기화, 채널 ECC 디코더/구성/HW 기법 아님
- **ID**: ieee:5521952
- **Type**: conference
- **Published**: 7-9 Dec. 2
- **Authors**: Ying-hao Qi, Pei-wei Huang, Meng-tian Rong
- **PDF**: https://ieeexplore.ieee.org/document/5521952
- **Abstract**: In this paper, we analyze the performance of the blind synchronizer based on syndrome checks using hard decisions for low density parity check (LDPC) code and give a method to compute frame synchronization error (FSE) bound. Only some kinds of LDPC codes are suitable to attain perfect synchronization. We present a two-step hybrid blind synchronizer using both hard and soft decision. Simulation results show that the complexity and performance of the hybrid synchronizer is just between the two previous synchronizers.

## Ultra Wideband (UWB): Technology, design and applications

- **Status**: ❌
- **Reason**: UWB 채널 모델링 프레젠테이션, QC-LDPC 부수 언급뿐 떼어낼 신규 ECC 기법 없음
- **ID**: ieee:5521893
- **Type**: conference
- **Published**: 7-9 Dec. 2
- **Authors**: Bahram Honary, Behshad Memari
- **PDF**: https://ieeexplore.ieee.org/document/5521893
- **Abstract**: In this presentation, Ultra Wideband (UWB) systems operating in 3.1–4.5GHz band are shown to have interesting properties within dense multipath channels and metallic structures. First the IEEE standard UWB channel model is presented and discussed, then our combined deterministic-statistical channel modeling method is shown to have more applicability and better accuracy in real-world scenarios and complex environments. The UWB channel modeling method we proposed based on a combination of ray-tracing and statistical dithering, enables interactive channel simulation and dynamic coverage estimation for system design and development. Advanced Error Control Coding (ECC) techniques using adaptable and low complexity codes (such as the Quasi-Cyclic LDPC codes), could then be employed to sacrifice a percentage of the data rate to further improve link stability and range or to decrease transmission power. Measurement results for DS-UWB and MB-OFDM operating in some non-conventional environments such as metallic bulkheads are reviewed at the end of the session.

## BCH encoder and decoder design for the digital television terrestrial broadcasting system standard of China

- **Status**: ❌
- **Reason**: BCH 인코더/디코더 설계(비-LDPC), 부호 비의존 BP 이식 기법 없음
- **ID**: ieee:5521909
- **Type**: conference
- **Published**: 7-9 Dec. 2
- **Authors**: Wen Fupeng, Zhou Liang, Ai Yu
- **PDF**: https://ieeexplore.ieee.org/document/5521909
- **Abstract**: This paper introduces BCH encoder and decoder construction based on efficient channel coding techniques for the digital television terrestrial broadcasting system specified by China. According to BCH code and concatenation structure, an optimized parallel encoding and decoding method is proposed, and the design uses look-up table to simplify the FPGA decoder structure.

## Design and Analysis of Non-Binary LDPC and IRA Modulation Codes

- **Status**: ❌
- **Reason**: non-binary GF(q) LDPC/IRA 변조코드 설계 — 비이진 LDPC는 제외 대상
- **ID**: ieee:5425994
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Mao-Ching Chiu
- **PDF**: https://ieeexplore.ieee.org/document/5425994
...
- **Status**: ❌
- **Reason**: WiMax LDPC 기반 분산 네트워크-채널 결합코딩 무선 협력통신 응용, 떼어낼 신규 ECC 기법 없음
- **ID**: ieee:5425675
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Lena Chebli, Christoph Hausl, Georg Zeitler +1
- **PDF**: https://ieeexplore.ieee.org/document/5425675
...
- **Status**: ❌
- **Reason**: QC 부호 pseudo-weight 고유값 bound 순수 이론, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:5425400
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Roxana Smarandache, Mark F. Flanagan
- **PDF**: https://ieeexplore.ieee.org/document/5425400
...
- **Status**: ❌
- **Reason**: Gaussian wiretap 물리계층 보안용 LDPC(puncturing) — 보안 응용, 표준 LDPC 최적화로 떼어낼 NAND ECC 기여 없음
- **ID**: ieee:5426065
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Demijan Klinc, Jeongseok Ha, Steven W. McLaughlin +2
- **PDF**: https://ieeexplore.ieee.org/document/5426065
...
- **Status**: ❌
- **Reason**: Doubly-generalized LDPC weight distribution growth rate 평가 — 순수 이론 bound/앙상블 분석, 떼어낼 디코더/HW/구성 기법 없음
- **ID**: ieee:5426116
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Mark F. Flanagan, Enrico Paolini, Marco Chiani +1
- **PDF**: https://ieeexplore.ieee.org/document/5426116
...
- **Status**: ❌
- **Reason**: Erasure-channel FEC (LDPC-Band) with hybrid iterative-ML for erasure correction; erasure-channel/ML decoding not transferable to NAND channel ECC
- **ID**: ieee:5426098
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Alexandre Soro, Mathieu Cunche, Jerome Lacan +1
- **PDF**: https://ieeexplore.ieee.org/document/5426098
...
- **Status**: ❌
- **Reason**: convolutional encoder 블라인드 식별(코그니티브 라디오), LDPC 언급뿐 ECC 디코더 기법 없음
- **ID**: ieee:5360726
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: M. Marazin, R. Gautier, G. Burel
- **PDF**: https://ieeexplore.ieee.org/document/5360726
...
- **Status**: ❌
- **Reason**: 멀티홉 HARQ 스킴 — LDPC를 베이스라인으로 쓰는 무선 ARQ 응용, 떼어낼 ECC 디코더/구성 기법 없음
- **ID**: ieee:5426147
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Takayuki Hashimoto, Tetsuya Wakiyama, Koji Ishibashi +1
- **PDF**: https://ieeexplore.ieee.org/document/5426147
...
- **Status**: ❌
- **Reason**: 광/RF 하이브리드 링크 outage 분석, LDPC 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:5425720
- **Type**: conference
- **Published**: 30 Nov.-4 
- **Authors**: Ricardo Luna, Deva K. Borah, Hrishikesh Tapse
- **PDF**: https://ieeexplore.ieee.org/document/5425720
- **Abstract**: This paper investigates the behavior of optical and hybrid optical/RF links over varying link distances. We first describe inclusion of various factors affecting the optical link, such as the atmospheric absorption, beam divergence and atmospheric turbulence. A technique to analyze outage probability of the hybrid link for low density parity check (LDPC) codes is presented. Our results show that the hybrid link can improve outage probability by orders of magnitude over an optical only link. In haze conditions, the hybrid link can extend the coverage distance of an optical only link by hundreds of meters by diverting a small fraction of the data through the RF link.

## Simulation Research of Nonbinary LDPC Code Based on Finite Fields

- **Status**: ❌
- **Reason**: 비이진(GF) LDPC 부호/디코딩으로 비이진 LDPC 제외 대상
- **ID**: ieee:5447302
- **Type**: conference
- **Published**: 26-28 Dec.
- **Authors**: Yuxiang Li, Guolong Liang, Guangpu Zhang
- **PDF**: https://ieeexplore.ieee.org/document/5447302
- **Abstract**: The encoding and decoding of binary LDPC codes are expanded using characteristics of the Finite Fields concept, a nonbinary LDPC code encoding and decoding method based on the Finite Fields are investigated and the computational complexity of this algorithm is estimated, providing a foundation for the practical applications of this method. Then this algorithm is compared with the binary algorithm. The results show that its performance is superior to the binary BP iterative algorithm. Finally, the effects of the relevant factors such as the number of iterations selected, the structure of the check matrix etc on the algorithm performance were analyzed.

## The Application of RS code in CCK Modulation Technology

- **Status**: ❌
- **Reason**: RS 부호의 CCK 변조 적용으로 비-LDPC, 이식 가능 디코더 기법 없음
- **ID**: ieee:5455388
- **Type**: conference
- **Published**: 26-28 Dec.
- **Authors**: Xi Su, Ying Guo
- **PDF**: https://ieeexplore.ieee.org/document/5455388
- **Abstract**: RS code is a kind of linear block code. Due to its characteristics such as high capability in error correction, easy realization and so on, RS code has been widely applied in wireless communication systems. In this paper, the algorithms of RS encoding and decoding are introduced firstly, then they are applied to CCK(Complementary Code Keying) modulation system which based on 802.11b standard. The simulation results demonstrate that the applications of RS code can effectively reduce the error probability of CCK system over Gaussian white noise channel.

## LDPC Application Based on CI/OFDM Underwater Acoustic Communication System

- **Status**: ❌
- **Reason**: 수중음향 CI/OFDM에 LDPC 적용으로 표준 LDPC 사용, 떼어낼 신규 디코더/구성 없음
- **ID**: ieee:5454883
- **Type**: conference
- **Published**: 26-28 Dec.
- **Authors**: Li-yang Bai, Fang Xu, Ru Xu +1
- **PDF**: https://ieeexplore.ieee.org/document/5454883
- **Abstract**: In this paper, we introduce carrier interferometry OFDM (CI/OFDM) into the underwater acoustic transmission field, and put the emphasis on how to deal with BER during communication with LDPC approach. We also analyze the error distribution of the received CI/OFDM signal, and propose a kind of CI-OFDM-LDPC joint algorithm to solve this problem. The result shows that even if the BER reaches a level of 10-2, it can be corrected completely in this way.

## Combining of Antenna Selection with Adaptive Modulation and Coding in STBC System

- **Status**: ❌
- **Reason**: 안테나선택+적응변조에 LDPC를 ECC로 채택만, 떼어낼 신규 LDPC 기법 없음
- **ID**: ieee:5455556
- **Type**: conference
- **Published**: 26-28 Dec.
- **Authors**: Yuling Zhang, Wenwei He, Yunbo Cheng
- **PDF**: https://ieeexplore.ieee.org/document/5455556
- **Abstract**: In this paper, we investigate a communication strategy combining of transmit antenna selection with adaptive modulation and coding for space-time block coded system. The antenna selection is based on the criterion of maximizing the average spectral efficiency (ASE) of the whole system for a given bit error rate (BER) constraint. In order to enhance system performance, low density parity check codes (LDPC) is employed as the error correcting codes. We assume that the channel state information (CSI) is known at the receiver and the adaptive control signaling can be perfectly fed back to the transmitter. Simulation results show that our proposed scheme provides a well behaved trade-off between the ASE and BER under MIMO environment.

## LDPC for Wi-Fi and WiMAX technologies

- **Status**: ❌
- **Reason**: Wi-Fi/WiMAX용 표준 LDPC 소개·서베이 수준, 새 디코더·구성·HW 기여 없음
- **ID**: ieee:5441120
- **Type**: conference
- **Published**: 22-24 Dec.
- **Authors**: Sindhu Hak Gupta, Bindya Virmani
- **PDF**: https://ieeexplore.ieee.org/document/5441120
- **Abstract**: With increasing demand of low complexity, higher performance systems ITU adopted Wi-Fi and Wi-Max as one of the IMT 2000 Technologies. Wi-Fi and Wi-Max technologies are major global cellular wireless standards. IEEE 802.16e standards use LDPC (Low Density Parity Check) based SFN (Single Frequency Network) networks. These codes were introduced in 1962 by Gallager. LDPC codes for Wi-max and Wi-Fi is based on the set of one or more fundamental LDPC codes, each of which is systematic linear block codes. These codes can accommodate various code rates and packet sizes. LDPC with the help of high frequency powerful processors is error correcting codes which allows transmission at rates in close proximity to Shannon's limit for large block length. With this paper authors are describing various LDPC codes with low complexity and high performance used for Wi-Fi and Wi-max technologies.

## Joint generator and parity-check matrices parallel encoding of LDPC codes

- **Status**: ❌
- **Reason**: LDPC 인코딩(생성/패리티 행렬 병렬 인코딩) 기법, 디코더/HW/코드설계 신규 기여 아니고 인코더 효율화에 국한
- **ID**: ieee:5406967
- **Type**: conference
- **Published**: 19-20 Dec.
- **Authors**: Peng Zhang, Changyin Liu, Jinlun Chen +1
- **PDF**: https://ieeexplore.ieee.org/document/5406967
- **Abstract**: Concerning the high encoding complexity of low-density parity-check (LDPC) codes, a joint generator and parity-check matrices parallel encoding method is proposed, which is able to take full advantage of the characteristics of the sparse parity-check matrix, such as cyclicity and equality of row weight. Experimental results show that, the proposed method runs fast and requires less memory due to low computational complexity.

## A novel method for H.264 video transmission using LDPC codes over high BER wireless network

- **Status**: ❌
- **Reason**: H.264 비디오 전송 UEP 무선 응용, LDPC는 부수적이고 떼어낼 ECC 기법 없음
- **ID**: ieee:5406968
- **Type**: conference
- **Published**: 19-20 Dec.
- **Authors**: Heng Li, YanChun Zhong
- **PDF**: https://ieeexplore.ieee.org/document/5406968
- **Abstract**: H.264 is well known for its excellent compression efficiency and the maximum temporal and spatial prediction. Thus, one packet loss even one bit error may cause destructive visible distortions due to error propagation effect. Besides, bit rates will always be scarce in wireless transmission environments. This paper focuses on the video transmission over high BER wireless network. We first use the concept of PSRN drop ratio to prove that the I-frame is key bottleneck of the quality of the whole video. Then we propose a novel UEP scheme which is applied to high BER wireless network. Simulation results shows that our scheme has similar or litter smaller PSNR value but less redundancy than scheme in other paper in high BER wireless network. Moreover, our scheme achieves 7 dB PSNR higher at low BER and 8 dB PSNR higher at high BER respectively than that without UEP scheme.

## A study on quick simulation for estimation of low FER of LDPC codes

- **Status**: ❌
- **Reason**: trapping set 기반 importance sampling으로 저FER 빠른 추정 - 시뮬레이션 평가 기법이지 떼어낼 디코더/HW/코드설계 기여 아님(순수 평가방법론)
- **ID**: ieee:5431553
- **Type**: conference
- **Published**: 15-17 Dec.
- **Authors**: Takakazu Sakai, Koji Shibata
- **PDF**: https://ieeexplore.ieee.org/document/5431553
- **Abstract**: This study shows a new design method of a simulation probability density function (PDF) for a fast frame error rate (FER) evaluation of low-density parity-check (LDPC) codes. It is difficult to evaluate a very low FER of LDPC codes by Monte Carlo simulation methods since it has excellent performance under iterative decoding. Cole et al. proposed a three-step estimation method of the low FER of LDPC codes of moderate block length. By applying the importance sampling method, which is one of the fast simulation methods, the simulation time of the error performance of LDPC codes can be reduced. Another simulation PDF, which can treat more dominant trapping sets (TS) than Cole et al.'s method, is proposed. The selection of the dominant TS as proportional to its probability reduces the number of simulation runs without deteriorating the accuracy of the estimator. Unbiased estimator is given as well as that that of the Cole et al.'s method. Some numerical examples are shown to demonstrate the effectiveness of the proposed method. The simulation time for an LDPC code of length 504 is reduced to 1/10 when we evaluate FER of around 10-14.

...
- **Status**: ❌
- **Reason**: GLDPC-Hadamard: 체크노드를 Hadamard 부호로 대체한 일반화 LDPC, FHT 기반 SISO 디코더는 Hadamard 제약 의존이라 표준 바이너리 LDPC BP에 이식 불가
- **ID**: ieee:4106145
- **Type**: journal
...
- **Status**: ❌
- **Reason**: MIMO 페이딩에서 LDPC-coded space-time 성능 union bound, 순수 성능해석 bound로 디코더/구성 기여 없음
- **ID**: ieee:4133907
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: 다중트랙 저장 검출기(M-algorithm) + MPC/RS 비반복 디코딩 - LDPC는 비교 베이스라인일 뿐, 떼어낼 LDPC 기법 없음
- **ID**: ieee:4100814
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: 반송파 위상 동기화 분석 - LDPC는 부수 언급, 떼어낼 디코더/코드 기법 없음
- **ID**: ieee:4099566
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: MIMO 트리탐색 신호검출기 VLSI — LDPC 무관, 떼어낼 ECC 디코더/구성 기법 없음
- **ID**: ieee:4154776
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: 양자 컨볼루션/tail-biting 부호(CSS, stabilizer) - 양자 EC, F4-선형/자기직교 의존, 양자 전용 개념 의존으로 제외
- **ID**: ieee:4106119
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: 중국 DTTB 표준 소개 논문, 디코더/구성 신규 기여 없음
- **ID**: ieee:4114828
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: RTP 하이브리드 오류정정+Reed-Solomon, 무선 응용 특이적이고 LDPC 아님
- **ID**: ieee:4114823
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: 멀티홉 계층적 성상도 적응 릴레이, LDPC 무관 무선 응용
- **ID**: ieee:4133904
- **Type**: journal
- **Published**: March 2007
- **Authors**: Ki-ho Lee, Dong-ho Cho
- **PDF**: https://ieeexplore.ieee.org/document/4133904
- **Abstract**: In order to improve cell capacity in multihop networks, we propose a novel adaptive relay scheme based on hierarchical constellations in which a symbol consists of multiple bits with varying degrees of robustness against channel errors. These bits are transferred to multiple users, such as relays and destinations, adaptively according to the users channel conditions and this adaptive transfer enables the capacity of multi-hop networks to be unproved

## Evaluation of Cross-Layer Reliability Mechanisms for Satellite Digital Multimedia Broadcast

- **Status**: ❌
- **Reason**: 위성 멀티미디어 방송 cross-layer 신뢰성+erasure code, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:4114778
- **Type**: journal
- **Published**: March 2007
- **Authors**: Amine Bouabdallah, Michel Kieffer, Jrme Lacan +4
- **PDF**: https://ieeexplore.ieee.org/document/4114778
- **Abstract**: This paper presents a study of some reliability mechanisms which may be put at work in the context of Satellite Digital Multimedia Broadcasting (SDMB) to mobile devices such as handheld phones. These mechanisms include error correcting codes, interleaving at the physical layer, erasure codes at intermediate layers and error concealment on the video decoder. The evaluation is made on a realistic satellite channel and takes into account practical constraints such as the maximum zapping time and the user mobility at several speeds. The evaluation is done by simulating different scenarios with complete protocol stacks. The simulations indicate that, under the assumptions taken here, the scenario using highly compressed video protected by erasure codes at intermediate layers seems to be the best solution on this kind of channel.

## Iterative Joint-Over-Antenna Detection and WNRA Decoding in Single-Carrier Multiuser MIMO Systems

- **Status**: ❌
- **Reason**: 단일캐리어 MIMO에서 비이진 ST-WNRA 부호+터보 등화, 비이진(non-binary)이고 LDPC 아님
- **ID**: ieee:4138056
- **Type**: journal
- **Published**: March 2007
...
- **Status**: ❌
- **Reason**: 대칭 용량 근사 공식(순수 이론 bound), 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:4138135
- **Type**: conference
- **Published**: 4-9 March 
- **Authors**: Weidong Li, Hongwen Yang, Dacheng Yang
- **PDF**: https://ieeexplore.ieee.org/document/4138135
- **Abstract**: In this paper, a very simple formula is presented to approximate the symmetric capacity of the commonly used constellations under additive white Gaussian noise channel. Based on this simple formula, we have derived the ergodic capacity for general fading channels. The capacity of fading channel is determined by the distribution of the fading through the generator moment function (GMF). The formulas provide here is an efficient way to evaluate the channel capacity. Moreover, with this simple closed form formula, many theoretical analysis problems can be greatly simplified or become analytically tractable.

## Decoding Turbo Codes Based on Their Parity-Check Matrices

- **Status**: ❌
- **Reason**: turbo 부호를 패리티검사행렬로 변환해 표준 sum-product/LP 디코딩 - LDPC BP 자체 개선 기여 없음(표준 SPA 재사용)
- **ID**: ieee:4160838
- **Type**: conference
- **Published**: 4-6 March 
...
- **Status**: ❌
- **Reason**: 암호화 비디오의 분산 소스 압축, 채널코딩 ECC 아니고 이식 가능 LDPC 기법 없음
- **ID**: ieee:4148756
- **Type**: conference
- **Published**: 27-29 Marc
...
- **Status**: ❌
- **Reason**: PLC 채널에서 정칙 LDPC vs RS/convolutional 성능비교. 표준 LDPC 단순 적용, 새 기여 없음
- **ID**: ieee:4231714
- **Type**: conference
...
- **Status**: ❌
- **Reason**: PLC DMT 비트로딩+LDPC 코딩 성능분석. LDPC가 부수 적용, 떼어낼 새 디코더·구성 없음
- **ID**: ieee:4231703
- **Type**: conference
- **Published**: 26-28 Marc
...
- **Status**: ❌
- **Reason**: NoC 인터커넥트 결함내성 분석. LDPC와 무관, 떼어낼 ECC 기법 없음
- **ID**: ieee:4149143
- **Type**: conference
- **Published**: 26-28 Marc
...
- **Status**: ❌
- **Reason**: 임펄스 노이즈 채널 soft-output 검출 메트릭. 채널 검출기 메트릭이라 NAND LDPC ECC에 떼어낼 기법 없음
- **ID**: ieee:4231683
- **Type**: conference
- **Published**: 26-28 Marc
...
- **Status**: ❌
- **Reason**: PLC용 clustered-COFDM 변조 성능분석. LDPC/ECC 기법 없음
- **ID**: ieee:4231700
- **Type**: conference
- **Published**: 26-28 Marc
...
- **Status**: ❌
- **Reason**: PMD 채널 turbo equalization용 irregular LDPC 설계, 채널 특화 EXIT 피팅으로 NAND 이식 기법 없음
- **ID**: ieee:4348434
- **Type**: conference
...
- **Status**: ❌
- **Reason**: DPSK용 LLR 유도 중심, 광통신 채널 특화로 NAND 이식 기법 없음
- **ID**: ieee:4348867
- **Type**: conference
- **Published**: 25-29 Marc
...
- **Status**: ❌
- **Reason**: FSO 무선광통신 응용 LDPC-coded modulation, 떼어낼 신규 디코더/HW/코드설계 기법 없음
- **ID**: ieee:4348339
- **Type**: conference
- **Published**: 25-29 Marc
...
- **Status**: ❌
- **Reason**: 광통신 100Gb/s bit-interleaved LDPC-coded modulation, 표준 block-circulant 사용 응용 논문
- **ID**: ieee:4348866
- **Type**: conference
- **Published**: 25-29 Marc
...
- **Status**: ❌
- **Reason**: OCDM-PON에서 LDPC가 부수적 오류정정으로 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:4348607
- **Type**: conference
- **Published**: 25-29 Marc
...
- **Status**: ❌
- **Reason**: non-systematic split-LDPC + BWT 기반 universal source 디코딩(소스 압축/문맥 추정), 채널 ECC 기법 아님
- **ID**: ieee:4298351
- **Type**: conference
...
- **Status**: ❌
- **Reason**: WSN에서 표준 irregular LDPC BP를 그대로 쓰고 디코딩 반복 스케줄 최적화(망 응용 특이적), 떼어낼 ECC 기법 없음
- **ID**: ieee:4298305
- **Type**: conference
- **Published**: 14-16 Marc
...
- **Status**: ❌
- **Reason**: XOR 기반 erasure code, LDPC보다 나음을 주장하는 비-LDPC MDS 근사 코드, 떼어낼 LDPC 기법 없음
- **ID**: ieee:4298277
- **Type**: conference
- **Published**: 14-16 Marc
...
- **Status**: ❌
- **Reason**: Slepian-Wolf 분산 소스 코딩(syndrome/parity), 채널 ECC가 아닌 소스 코딩
- **ID**: ieee:4298397
- **Type**: conference
- **Published**: 14-16 Marc
...
- **Status**: ❌
- **Reason**: FSO/RF 하이브리드에 rate-compatible LDPC를 응용 적용, 표준 LDPC 사용으로 떼어낼 신규 기법 없음
- **ID**: ieee:4298393
- **Type**: conference
- **Published**: 14-16 Marc
...
- **Status**: ❌
- **Reason**: 센서망 consensus estimation을 위한 BP, 채널 ECC가 아닌 분산추정 응용
- **ID**: ieee:4298313
- **Type**: conference
- **Published**: 14-16 Marc
...
- **Status**: ❌
- **Reason**: factor graph/BP로 노이즈 센서데이터 함수 추정, JSCC/추정 응용이며 떼어낼 ECC 기법 없음
- **ID**: ieee:4298413
- **Type**: conference
- **Published**: 14-16 Marc
...
- **Status**: ❌
- **Reason**: binary turbo 부호+IDAC 반복복호 - 비-LDPC, turbo 전용 부호 구조 의존, 부호 비의존 BP 이식 근거 약함
- **ID**: ieee:4224265
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: 무선 라우트의 coding/interleaving/ARQ 처리량 최적화; LDPC는 부수 언급, 떼어낼 디코더·HW·코드설계 기법 없음
- **ID**: ieee:4224322
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: fading 채널 MPSK signal-space diversity 회전각 최적화; 변조 응용 특이적, 떼어낼 LDPC 기법 없음
- **ID**: ieee:4224375
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: 네트워크 코딩+채널 디코딩 결합 — 무선 응용 특이적, 이식할 LDPC 디코더 기법 없음
- **ID**: ieee:4224394
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: DVB-S2 프레임 동기화/주파수 오프셋 — ECC 무관, 동기화 기법
- **ID**: ieee:4224469
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: FFH-MFSK 멀티유저 반복디코딩+간섭제거 — 컨볼루션 부호, 무선 응용 특이적, 떼어낼 ECC 기법 없음
- **ID**: ieee:4224384
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: DMB-T/WLAN 하이브리드 네트워크 아키텍처 — ECC 무관, 시스템 설계
- **ID**: ieee:4225028
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: 다차원 바이너리 반복부호(repetition) 구성 — LDPC 아님, 떼어낼 BP/디코더 기법 없음
- **ID**: ieee:4224378
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: turbo 디코더 주파수 오프셋 보상 - 비-LDPC, turbo/채널 추정 특화, LDPC BP 이식 기법 없음
- **ID**: ieee:4224269
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: 3G 수신 다이버시티+터보부호 — 무선 응용, LDPC 무관
- **ID**: ieee:4224604
- **Type**: conference
- **Published**: 11-15 Marc
...
- **Status**: ❌
- **Reason**: 유니터리 space-time 변조용 유한길이 LDPC의 BEP union bound(순수 이론), OSD/SP는 표준; 디코더·HW·구성 신규 기여 없음
- **ID**: ieee:4224353
- **Type**: conference
- **Published**: 11-15 Marc

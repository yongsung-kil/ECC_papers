...
- **Status**: ❌
- **Reason**: 시스톨릭 정렬 어레이 동시 오류검출/정정, LDPC 아닌 HW 결함허용
- **ID**: ieee:89398
- **Type**: conference
- **Published**: 1990
...
- **Status**: ❌
- **Reason**: RLL(runlength-limited) 변조/검출 부호, LDPC ECC 아님
- **ID**: ieee:114355
- **Type**: conference
- **Published**: 1990
...
- **Status**: ❌
- **Reason**: 위성 음성 전송용 패리티/검출 보호전략, 응용 특이적 비-LDPC
- **ID**: ieee:116795
- **Type**: conference
- **Published**: 1990
...
- **Status**: ❌
- **Reason**: BICM 신호 셰이핑(초록은 학회 TOC로 손상), 비-LDPC 변조 기법
- **ID**: ieee:128695
- **Type**: conference
- **Published**: 1990
- **Authors**: 
...
- **Status**: ❌
- **Reason**: 관상동맥 음향 모델링, ECC/LDPC와 무관한 생체신호 논문
- **ID**: ieee:61034
- **Type**: journal
- **Published**: 1990
...
- **Status**: ❌
- **Reason**: (12,8) 단일오류정정 대수 패리티검사 부호, 비-LDPC·이식 기법 없음
- **ID**: ieee:61052
- **Type**: journal
- **Published**: 1990
...
- **Status**: ❌
- **Reason**: 마이크로웨이브 무선용 블록 부호화 변조(BCM), 비-LDPC
- **ID**: ieee:54987
- **Type**: journal
- **Published**: 1990

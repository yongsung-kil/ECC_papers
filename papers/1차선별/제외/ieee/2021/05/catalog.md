...
- **Status**: ❌
- **Reason**: 양자 LDPC(CSS type) 구성으로 양자 전용 개념에 의존, 원칙 제외
- **ID**: ieee:9328225
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: 소스 코딩(압축) 기법으로 채널코딩 ECC가 아님
- **ID**: ieee:9319718
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: 채널코드 파라미터 블라인드 인식(분류)일 뿐 디코더/코드설계 기여 없음
- **ID**: ieee:9344644
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: AoI용 stream-based 코딩, LDPC 블록코드는 비교 베이스라인일 뿐 새 디코더/구성 기여 없음
- **ID**: ieee:9374436
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: Slotted ALOHA+NOMA 무선 다중접속 프로토콜, SC-LDPC는 부수 비유 언급만, 떼어낼 ECC 기법 없음
- **ID**: ieee:9354838
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: 수중음향 간섭검출/등화 기법으로 LDPC ECC와 무관
- **ID**: ieee:9343880
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: 디코더 soft info 활용 변조분류 알고리즘으로 이식 가능한 LDPC 기법 없음
- **ID**: ieee:9344668
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: 무선전력전송(SWIPT)용 unary 코딩으로 LDPC ECC와 무관, 떼어낼 기법 없음
- **ID**: ieee:9303399
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: mmW 위상잡음 보상·rCFO/rSCO 트래킹 모듈, LDPC와 무관
- **ID**: ieee:9374567
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: LPWAN 파일럿/프레임 동기화 최적화로 LDPC ECC와 무관
- **ID**: ieee:9347473
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: 랜덤액세스 패킷 SIC 결합검출 문제로 LDPC 디코더/코드설계 없음
- **ID**: ieee:9330800
- **Type**: journal
- **Published**: May 2021
...
- **Status**: ❌
- **Reason**: DWDM 광통신 PM-16QAM probabilistic-geometric shaping 응용; LDPC 베이스라인, 이식 가능 ECC 기법 없음
- **ID**: ieee:9571396
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 양자 통신(squeezed-displaced states) LDPC-coded QPSK — 양자 EC 원칙 제외, 고전 LDPC 디코더 신규 기여 없음
- **ID**: ieee:9571143
- **Type**: conference
- **Published**: 9-14 May 2
...
- **Status**: ❌
- **Reason**: 2µm 대역 코히어런트 WDM 전송, on-chip spectral translation; LDPC 무관, 이식할 ECC 기법 없음
- **ID**: ieee:9571617
- **Type**: conference
- **Published**: 9-14 May 2
...
- **Status**: ❌
- **Reason**: G3-PLC Turbo 부호 설계, LDPC는 비교 대상일 뿐 이식 기법 없음
- **ID**: ieee:9441595
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 딥러닝 LDPC 부호 블라인드 인식(분류) 문제, ECC 디코더/구성 기법 아님
- **ID**: ieee:9441497
- **Type**: conference
- **Published**: 7-9 May 20
...
- **Status**: ❌
- **Reason**: CNN 기반 LDPC 부호 블라인드 인식 — 디코딩/코드설계/HW 기여 아님, NAND ECC에 이식할 기법 없음.
- **ID**: ieee:9450940
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Polar 코드 rate-matching(다운사이징 타입선택) 기법으로 LDPC와 무관
- **ID**: ieee:9486401
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LDS-CDMA용 삼진 UD 코드 설계; LDPC는 부수 언급 베이스라인일 뿐 이식 기법 없음
- **ID**: ieee:9527898
- **Type**: conference
- **Published**: 24-28 May 
...
- **Status**: ❌
- **Reason**: MU-MIMO 한정피드백 프리코딩; LDPC ECC와 무관, 떼어낼 디코더/코드설계 기법 없음
- **ID**: ieee:9527824
- **Type**: conference
- **Published**: 24-28 May 
...
- **Status**: ❌
- **Reason**: 비이진(NB-LDPC) 디코더 — 비이진 LDPC 제외 원칙
- **ID**: ieee:9401072
- **Type**: conference
- **Published**: 22-28 May 
...
- **Status**: ❌
- **Reason**: 다중 Galois field 네트워크 코딩 — 채널 ECC 아님, 비이진 GF
- **ID**: ieee:9401700
- **Type**: conference
- **Published**: 22-28 May 
...
- **Status**: ❌
- **Reason**: 폴라 코드 SCAN-flip 디코더 — polar 전용(soft cancellation), 떼어낼 LDPC 기법 없음
- **ID**: ieee:9401398
- **Type**: conference
- **Published**: 22-28 May 
...
- **Status**: ❌
- **Reason**: 자기기록(MR/BPMR) 시스템에서 SC-LDPC 섹터 연관(associated sectors) 기법 — 스토리지 응용 특이적 섹터 간 정보공유 구조로, NAND LDPC ECC에 떼어낼 일반 디코더/구성 기법 없음
- **ID**: ieee:9454834
- **Type**: conference
- **Published**: 19-22 May 
...
- **Status**: ❌
- **Reason**: 5G 망에서 LDPC 부호율/반복수/변조 결합 효율 평가 — 표준 LDPC 적용 분석, 새 디코더/구성/HW 기여 없음
- **ID**: ieee:9501120
- **Type**: conference
- **Published**: 19-21 May 
...
- **Status**: ❌
- **Reason**: BEQ(Binary Erasure Quantization) 압축에 EP 알고리즘 적용 — 소스코딩(압축)이며 채널 ECC가 아님, 제외
- **ID**: ieee:9519624
- **Type**: conference
- **Published**: 19-20 May 
...
- **Status**: ❌
- **Reason**: 광통신 물리계층 보안용 스크램블링+다단부호화 — LDPC는 베이스라인 채널코드, 보안 게이트 목적으로 떼어낼 ECC 기법 없음
- **ID**: ieee:9472213
- **Type**: conference
- **Published**: 19-20 May 
...
- **Status**: ❌
- **Reason**: 조합회로 CED(동시오류검출) 합성 자동화 도구, LDPC ECC 무관
- **ID**: ieee:9438900
- **Type**: conference
- **Published**: 13-15 May 

...
- **Status**: ❌
- **Reason**: 몬테카를로 기반 Polar 코드 밀도 발전(DE) 구현 논문으로 LDPC와 무관, NAND ECC 이식 가능 기법 없음
- **ID**: ieee:10964027
- **Type**: journal
- **Published**: June 2025
...
- **Status**: ❌
- **Reason**: 5G HARQ RV 선택에 DNN을 적용한 무선 통신 논문으로, LDPC는 부수 언급 수준이며 NAND ECC에 이식 가능한 디코더·HW·코드설계 기법 없음
- **ID**: ieee:10856411
- **Type**: journal
- **Published**: June 2025
...
- **Status**: ❌
- **Reason**: 멀티홉 무선 네트워크 AoI 최소화를 위한 SIC 기반 패킷 릴레이 스킴으로, LDPC 코드·디코더 기법이 전혀 없음.
- **ID**: ieee:10839590
- **Type**: journal
- **Published**: June 2025
...
- **Status**: ❌
- **Reason**: Sparse Vector Coding(압축센싱 기반) URLLC 코드북 최적화 논문으로 LDPC ECC와 무관, 이식 가능 기법 없음
- **ID**: ieee:10963750
- **Type**: journal
- **Published**: June 2025
...
- **Status**: ❌
- **Reason**: Reed-Muller/BCH 코드의 재귀적 Plotkin 구성 소프트 디코더 논문이며 LDPC와 무관, 이식 가능한 LDPC 기법 없음
- **ID**: ieee:10947200
- **Type**: journal
- **Published**: June 2025
...
- **Status**: ❌
- **Reason**: 강화학습 기반 BP 스케줄링을 Polar 코드에 적용한 논문으로 LDPC와 무관, NAND ECC 이식 가능 기법 없음
- **ID**: ieee:10960358
- **Type**: journal
- **Published**: June 2025
...
- **Status**: ❌
- **Reason**: 분산 행렬-벡터 연산의 아날로그 코딩 기반 straggler 완화 기법으로, LDPC ECC와 무관하며 NAND 스토리지 적용 가능한 기법 없음.
- **ID**: ieee:10852406
- **Type**: journal
- **Published**: June 2025
- **Authors**: Jinho Choi
...
- **Status**: ❌
- **Reason**: DNA 저장용 coupon collector 채널 코딩 스킴으로, LDPC ECC 디코더·코드설계 기법이 없으며 NAND ECC와 무관함.
- **ID**: ieee:10769527
- **Type**: journal
- **Published**: June 2025
...
- **Status**: ❌
- **Reason**: 폴라 코드 CA-SCL 디코더의 양자화 분석으로 LDPC와 무관하며 이식 가능한 LDPC 기법 없음
- **ID**: ieee:11114217
- **Type**: conference
- **Published**: 9-12 June 
...
- **Status**: ❌
- **Reason**: MIMO-OTFS 수신기 설계 논문으로 LDPC는 성능 검증 도구로만 사용, 고이동성 채널 특이적이며 독립 이식 가능한 코드설계 기법 없음.
- **ID**: ieee:11161769
- **Type**: conference
- **Published**: 8-12 June 
...
- **Status**: ❌
- **Reason**: 포인트 클라우드 시맨틱-채널 결합 코딩(JSCC) 논문으로 LDPC는 관련 없으며 제외 카테고리(JSCC·시맨틱 통신)에 해당.
- **ID**: ieee:11161502
- **Type**: conference
- **Published**: 8-12 June 
...
- **Status**: ❌
- **Reason**: IRSA 랜덤 접속 최적화 논문으로 LDPC 관련 없고 5G CIoT 특이적이며 떼어낼 ECC 기법 없음.
- **ID**: ieee:11161616
- **Type**: conference
- **Published**: 8-12 June 
...
- **Status**: ❌
- **Reason**: FBMC-SS/SMT-SS 기반 UWB 통신 파형 논문으로 LDPC 및 ECC와 무관, 떼어낼 기법 없음.
- **ID**: ieee:11162147
- **Type**: conference
- **Published**: 8-12 June 
...
- **Status**: ❌
- **Reason**: V2X 통신용 LMM 기반 벡터 양자화 피처 압축 논문으로, LDPC/ECC 관련 내용 없음 — 소스 코딩·시맨틱 통신 영역
- **ID**: ieee:11162198
- **Type**: conference
- **Published**: 8-12 June 
...
- **Status**: ❌
- **Reason**: 5G용 LDPC vs Polar 코드 BER 시뮬레이션 비교 논문으로, 새로운 LDPC 기법 제안 없이 기존 코드 성능 분석에 그침
- **ID**: ieee:11136522
- **Type**: conference
...
- **Status**: ❌
- **Reason**: p-bit 기반 simulated annealing용 Hamiltonian 생성 도구 — LDPC/ECC와 무관, 떼어낼 디코더·HW·코드설계 기법 없음
- **ID**: ieee:11038009
- **Type**: conference
...
- **Status**: ❌
- **Reason**: LDPC vs 무부호 QPSK의 BER 비교 개론 논문, 떼어낼 디코더/HW/코드설계 신규 기법 없는 무선 응용 비교
- **ID**: ieee:11138832
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 딥러닝 기반 채널코딩 종류 인식(blind recognition) — ECC 디코딩/HW/코드설계가 아니라 코드 식별, 떼어낼 기법 없음
- **ID**: ieee:11151128
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 분자통신 LDPC 다이버시티 — 응용 특이적, LDPC는 베이스라인이고 떼어낼 ECC 기법 없음
- **ID**: ieee:11111940
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 무선 OFDM 자기직교부호 MTD 디코딩 연구, LDPC는 비교 베이스라인일 뿐 떼어낼 LDPC 기법 없음
- **ID**: ieee:11254355
- **Type**: conference
...
- **Status**: ❌
- **Reason**: IoT 디바이스 인증 PUF용 LDPC 사용에 불과, 이식할 디코더/HW/코드설계 기법 없음(보안 응용 부수 언급)
- **ID**: ieee:11252598
- **Type**: conference
- **Published**: 25-27 June
...
- **Status**: ❌
- **Reason**: 양자-고전 하이브리드 시스템 결함 분류 taxonomy — ECC/LDPC 무관, 이식 기법 없음
- **ID**: ieee:11071596
- **Type**: conference
...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] 양자EC지만 비이진 LDPC의 사이클 구조 분류·error floor 저감 디코딩 기법이 고전 비이진 LDPC로 떼어낼 수 있음(C/E), 애매하므로 살림
- **ID**: ieee:11195217
- **Type**: conference
...
- **Status**: ❌
- **Reason**: BMS wiretap 채널 비밀성(보안) 정보누설 bound 개선 — 순수 이론, 떼어낼 디코더/HW/코드설계 없음(보안+이론 제외)
- **ID**: ieee:11195323
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: 양자 LDPC(HGP) 코드 — 양자 EC 전용, 기준상 제외
- **ID**: ieee:11195678
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: Hypergraph product 양자 LDPC 부호를 양자 erasure 채널서 RL/SA로 최적화 — 양자 EC 전용, 기반 고전부호 설계는 독립적으로 떼어내지지 않음
- **ID**: ieee:11195424
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: 양자 expander code peeling 디코더 — qLDPC/양자 EC 제외 대상
- **ID**: ieee:11195550
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: PAC(polar+convolutional) 부호 순차디코딩 복잡도/rate-profile 설계 — LDPC는 비교 baseline일 뿐, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11195375
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: 랜덤 변조+AMP 검출기, LDPC는 비교 베이스라인일 뿐 — 무선 검출기로 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:11195253
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: BMST 기반 Q-ary 소스 near-lossless 압축 — 소스코딩이며 채널 ECC 아님(제외)
- **ID**: ieee:11195246
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: ReRAM sneak path rate 확률분포 분석 — 메모리 신뢰성 통계, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11195609
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: 양자 LDPC(CSS qLDPC) min-sum 디코딩 — qLDPC 제외 대상
- **ID**: ieee:11195509
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: surface code(양자) BP 디코딩 — qLDPC 제외 대상
- **ID**: ieee:11195585
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: 순수 양자 정보 이론(EPR/GHZ 분배 용량) — 떼어낼 LDPC 디코더/HW/코드설계 기법 없음
- **ID**: ieee:11195480
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: job cloning/straggler BIBD 분산컴퓨팅 — LDPC ECC 기법 아님
- **ID**: ieee:11195588
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: 압축센싱 sparse 신호 복원용 interval passing 순차스케줄 — 채널코딩 ECC가 아닌 CS(소스측), 떼어낼 ECC 기법 없음. 단 LDPC 순차스케줄링 착안은 경계적
- **ID**: ieee:11195431
- **Type**: conference
- **Published**: 22-27 June
...
- **Status**: ❌
- **Reason**: 클라우드 FPGA covert timing channel 보안 공격 — LDPC ECC 무관
- **ID**: ieee:11133099
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Reed-Solomon 디코딩 교육법 논문, LDPC와 무관하며 ECC 이식 기법 없음
- **ID**: ieee:11083501
- **Type**: conference
...
- **Status**: ❌
- **Reason**: ECC 종합 리뷰 논문, 떼어낼 새 기법·구성 없음; 순수 서베이
- **ID**: ieee:11085375
- **Type**: conference
...
- **Status**: ❌
- **Reason**: UAV/HAPS W/D 대역 피더링크 HW/안테나/대역폭 설계. LDPC 언급조차 없고 떼어낼 ECC 기법 없음
- **ID**: ieee:11114548
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 어텐션 기반 시맨틱 통신. LDPC는 JPEG+LDPC 비교 베이스라인일 뿐, 떼어낼 ECC 기법 없음
- **ID**: ieee:11174402
- **Type**: conference
...
- **Status**: ❌
- **Reason**: GSVD 기반 MIMO-RSMA 프리코딩. ECC/LDPC 무관
- **ID**: ieee:11174910
- **Type**: conference
- **Published**: 17-20 June
...
- **Status**: ❌
- **Reason**: M-JSCC 비대칭 시맨틱 통신 아키텍처. LDPC 무관, JSCC 계열로 제외
- **ID**: ieee:11174786
- **Type**: conference
- **Published**: 17-20 June
...
- **Status**: ❌
- **Reason**: DNN 기반 QAMA 컨스텔레이션 설계. LDPC 무관, ECC 기법 없음
- **ID**: ieee:11174455
- **Type**: conference
- **Published**: 17-20 June
...
- **Status**: ❌
- **Reason**: In-memory computing 기반 채널코딩 일반론 - 구체적 LDPC 디코더/코드설계 기여 불명확, 떼어낼 기법 없음(애매하나 LDPC 특정성 없음)
- **ID**: ieee:11058664
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Polar-OTFS 수중통신 - polar code/SCL 디코더이며 LDPC 아님, 무선 응용 특이적
- **ID**: ieee:11104571
- **Type**: conference
- **Published**: 16-19 June
...
- **Status**: ❌
- **Reason**: 단신호 ECC 비교연구(polar/PAC/BCH/LDPC), 평가 위주로 LDPC에 새 기여 없음
- **ID**: ieee:11165540
- **Type**: conference
...
- **Status**: ❌
- **Reason**: ATSC 3.0 채널 본딩 실증 검증 - 방송 RF 응용 특이적, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:11165621
- **Type**: conference
- **Published**: 11-13 June
...
- **Status**: ❌
- **Reason**: Modbus 프로토콜에 선형 블록 코드 적용 가능성 - LDPC 디코더/코드설계 기여 없음
- **ID**: ieee:11049181
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 웨이블릿 기반 코드 vs BCH 비교 - LDPC 무관, 선형 순환 코드
- **ID**: ieee:11049119
- **Type**: conference
- **Published**: 10-14 June

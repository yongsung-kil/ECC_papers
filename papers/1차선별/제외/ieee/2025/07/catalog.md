...
- **Status**: ❌
- **Reason**: OFDM 채널 추정이 주제이고 LDPC는 부수 언급, 무선 특이적이며 떼어낼 ECC 기법 없음
- **ID**: ieee:10975859
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: LLM 스킬 창발을 LDPC 반복 디코딩으로 모델링한 수학 이론: LDPC는 순수 비유/이론 도구, ECC 기법 이식 불가
- **ID**: ieee:10960361
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: [기준개정:비이진제외] NB-LDPC BP 복호 복잡도 감소(JSPO) 및 LLR 인터페이스 설계 — 비이진 LDPC 디코더 알고리즘(C/E) 이식 가능
- **ID**: ieee:11007208
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: UAV 다중안테나 비밀·은닉 통신 보안 최적화: LDPC 없음, NAND ECC와 무관
- **ID**: ieee:10938035
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: DNA 스토리지 주소 시퀀스 설계 (k-WMU 코드): LDPC 없음, NAND ECC에 이식 가능한 기법 없음
- **ID**: ieee:10843767
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: 시맨틱 통신 기반 객체 탐지 프레임워크: LDPC 없음, 시맨틱 통신 응용
- **ID**: ieee:10944429
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: 시맨틱 통신(HDA-DeepSC) 프레임워크로 LDPC 언급 없음, 떼어낼 ECC 기법 없음
- **ID**: ieee:10960639
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: DeepJSCC 하이브리드 소스-채널 결합 코딩: JSCC/시맨틱 통신, LDPC 없음, 떼어낼 ECC 기법 없음
- **ID**: ieee:10960356
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: OCFDM 다중반송파 변조 기법 논문으로 채널 코딩/ECC와 무관, NAND LDPC에 이식 가능한 기법 없음
- **ID**: ieee:10778593
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: 5G-NR PDCCH FPGA 구현: LDPC 내용 없음, 무선 특이적 채널 처리 체인
- **ID**: ieee:10835153
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: HQC 후양자 암호 KEM FPGA 가속기: 코드 기반 암호(보안 목적), NAND LDPC ECC에 이식 가능한 디코더/코드설계 기법 없음
- **ID**: ieee:10949843
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: 3D NAND 기반 PUF 생성 방법으로 NAND 직접 관련이나 ECC/LDPC 기법이 없는 보안 인증 논문
- **ID**: ieee:11004633
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: DNA 저장 삽입/삭제 오류용 마커 코드, NAND LDPC ECC와 무관한 동기화 코드
- **ID**: ieee:11004160
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: 인덱스 코딩용 Lattice 코드 설계, LDPC 무관한 방송 통신 최적화 문제
- **ID**: ieee:11014228
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: 초록 없는 Guest Editorial, 판단 불가 — 내용 없음
- **ID**: ieee:11039751
- **Type**: journal
- **Published**: July 2025
...
- **Status**: ❌
- **Reason**: IFDMA 고이동성 채널 논문. 5G NR LDPC는 비교 결과에만 언급되며 이식 가능한 LDPC 기법 없음.
- **ID**: ieee:11143338
- **Type**: conference
- **Published**: 7-10 July 
...
- **Status**: ❌
- **Reason**: JSCC 벤치마크(무선 이미지 전송). 소스-채널 결합 코딩으로 제외 카테고리에 해당. LDPC는 비교 기준선으로만 언급.
- **ID**: ieee:11143290
- **Type**: conference
- **Published**: 7-10 July 
...
- **Status**: ❌
- **Reason**: 수중 음향 통신용 Polar 코드 OFDM 논문. LDPC 기법 없음.
- **ID**: ieee:11104453
- **Type**: conference
- **Published**: 7-10 July 
...
- **Status**: ❌
- **Reason**: 1비트 양자화 MIMO 검출용 sum-product IDD 수신기 논문으로, LDPC 디코더 자체를 다루지 않으며 NAND LDPC에 이식할 기법 없음
- **ID**: ieee:11143531
- **Type**: conference
- **Published**: 7-10 July 
...
- **Status**: ❌
- **Reason**: 단블록 비이진 Polar 코드 최적화 논문. LDPC 관련 기법 없음.
- **ID**: ieee:11104477
- **Type**: conference
- **Published**: 7-10 July 
...
- **Status**: ❌
- **Reason**: 삽입/삭제 채널 무선 통신용 RNN 검출기의 FPGA HW 최적화 논문으로, LDPC는 후단 표준 디코더로만 사용되며 이식 가능한 LDPC 디코더/HW 기법 없음
- **ID**: ieee:11130325
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 6G 물리계층 보안(PLS) 논문; 신경망 코딩은 신뢰성-보안 트레이드오프 전용이며 NAND LDPC ECC에 이식 가능한 기법 없음.
- **ID**: ieee:11125294
- **Type**: conference
- **Published**: 6-10 July 
...
- **Status**: ❌
- **Reason**: AI(RL·GA) 기반 ECC 파라미터 최적화 — Wi-Fi 응용 특이적, LDPC 디코더·코드설계 이식 기법 불명확
- **ID**: ieee:11158779
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 5G NR LDPC를 PAM4 광전송에 적용한 응용 실험; LDPC는 기성 부호 차용일 뿐 떼어낼 디코더/HW/코드설계 기법 없음
- **ID**: ieee:11110465
- **Type**: conference
- **Published**: 29 June-3 
...
- **Status**: ❌
- **Reason**: 테라헤르츠-오버-파이버 등화기 오류전파 완화용 state error decoding; LDPC ECC 이식 기법 아님
- **ID**: ieee:11111107
- **Type**: conference
- **Published**: 29 June-3 
...
- **Status**: ❌
- **Reason**: 역산란변환 b-modulation에 NN 복조+SD-FEC 적용 응용; 떼어낼 LDPC 디코더/코드설계 없음
- **ID**: ieee:11110989
- **Type**: conference
- **Published**: 29 June-3 
...
- **Status**: ❌
- **Reason**: oversampling 상관 활용 redundant-bit-free 오류정정 — LDPC/ECC 코드설계 아니고 무선광 응용 특이적
- **ID**: ieee:11109964
- **Type**: conference
- **Published**: 29 June-3 
...
- **Status**: ❌
- **Reason**: 물리계층 키 생성·분배(보안) — ECC 채널코딩 아님, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11109185
- **Type**: conference
- **Published**: 29 June-3 
...
- **Status**: ❌
- **Reason**: 광인터커넥션 등화기(FEC-assist DDE) 응용; LDPC 자체 ECC 기법 없음
- **ID**: ieee:11110789
- **Type**: conference
- **Published**: 29 June-3 
...
- **Status**: ❌
- **Reason**: PLSKGD 키 생성·reconciliation·privacy amplification(보안) — ECC 채널코딩 아님, 떼어낼 LDPC 기법 없음
- **ID**: ieee:11110298
- **Type**: conference
- **Published**: 29 June-3 
- **Authors**: Yanwen Zhu, Yuang Li, Xu Zhang +4
...
- **Status**: ❌
- **Reason**: 에어갭 PQC 광통신 플랫폼에 LDPC FEC를 한 구성요소로 사용; 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:11186611
- **Type**: conference
...
- **Status**: ❌
- **Reason**: QKD 기반 전력망 보안 프레임워크 — LDPC는 부수 언급, 떼어낼 ECC 기법 없음(양자보안 응용)
- **ID**: ieee:11096656
- **Type**: conference
- **Published**: 27 June-1 
...
- **Status**: ❌
- **Reason**: 분산망 고장데이터 압축·전송(소스코딩/딥러닝), LDPC ECC 기법 없음
- **ID**: ieee:11212177
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 분산배열안테나/도플러보상 위성통신 기법, LDPC·ECC 무관
- **ID**: ieee:11274380
- **Type**: conference
...
- **Status**: ❌
- **Reason**: VLC-RF MIMO OFDMA 시스템에서 LDPC는 비교 baseline으로 부수 언급, 무선 응용 특이적 — 떼어낼 ECC 기법 없음
- **ID**: ieee:11135982
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 시맨틱 통신 센서 융합 프레임워크, LDPC 무관 ECC 기법 없음
- **ID**: ieee:11183785
- **Type**: conference
...
- **Status**: ❌
- **Reason**: Polar-coded IDMA 수중음향 다중사용자 검출 — polar 코드·SIC 중심, LDPC 무관
- **ID**: ieee:11194645
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 무선 키생성 양자화+LDPC 조합 평가, LDPC는 표준 부수 사용, 떼어낼 새 ECC 기법 없음
- **ID**: ieee:11171534
- **Type**: conference
...
- **Status**: ❌
- **Reason**: 5G 적응형 변조코딩 DRL 결정 전략 - 링크 적응 응용, LDPC 디코더/코드설계 기여 없음
- **ID**: ieee:11136977
- **Type**: conference

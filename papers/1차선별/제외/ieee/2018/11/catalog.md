...
- **Status**: ❌
- **Reason**: Non-binary LDPC(GF(64)) 디코딩 메모리 저감 - 비이진 LDPC 제외
- **ID**: ieee:8063902
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 위성 SDR FPGA 구현, Euclidean geometry LDPC를 표준 채널코드로 그대로 채택; 새 디코더·구성·HW LDPC 기여 없음
- **ID**: ieee:8412572
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: Non-binary LDPC(FRC 조건, 짧은 사이클 카운트/설계) - 비이진 LDPC 제외
- **ID**: ieee:8388219
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 비이진(non-binary) LDPC 대상이며 bit-metric 디코더가 NB 부호+변조 결합에 특화 - 바이너리 한정 위배
- **ID**: ieee:8466621
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: STT-MRAM용 polar 코드 설계/최적화 - 비-LDPC 부호, 이식 기법 없음 제외
- **ID**: ieee:8399859
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 위성 UEP+CCSDS convolutional code 기반 소스/채널 결합 보호. LDPC 아니고 떼어낼 바이너리 LDPC ECC 기법 없음
- **ID**: ieee:8444044
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 비트패턴 매체 island 패턴별 BER 비교, ECC/디코더 신규 기여 없음 - 제외
- **ID**: ieee:8383702
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 2-user NOMA 전력·변조 최적화 ML검출; LDPC 무관
- **ID**: ieee:8449119
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: DP-FTN 무선 백홀 간섭제거·위상추적 기법; LDPC/디코더·코드설계 기여 없음, 떼어낼 ECC 기법 없음
- **ID**: ieee:8408541
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 캐시 네트워크 user association·BS muting 최적화, 네트워크코딩 멀티캐스트; LDPC ECC 무관
- **ID**: ieee:8421237
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: Counter Braid 측정 아키텍처 spatial coupling 점근해석; 채널 ECC 아닌 압축/measurement, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:8434352
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: q-ary polar code 유한길이 스케일링 순수이론; 비-LDPC·비이진, 이식할 BP 디코더 기법 없음
- **ID**: ieee:8438502
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 비트패턴드 자기기록 채널모델·멀티아일랜드 기록; LDPC는 부수 사용, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:8418778
- **Type**: journal
- **Published**: Nov. 2018
...
- **Status**: ❌
- **Reason**: 인지무선 협력센싱 응용에 표준 LDPC를 통신 보호용으로 적용, 떼어낼 ECC 기법 없음
- **ID**: ieee:8796752
- **Type**: conference
- **Published**: 8-10 Nov. 
...
- **Status**: ❌
- **Reason**: 수중 AUV 네트워킹 인프라; ECC/LDPC 내용 전무
- **ID**: ieee:8729790
- **Type**: conference
- **Published**: 6-9 Nov. 2
...
- **Status**: ❌
- **Reason**: 특수 구성 LDPC의 에러지수 하한 이론·점근 분석으로, 떼어낼 구체적 디코더/HW/구성 기법 없는 순수 이론 bound
- **ID**: ieee:8631262
- **Type**: conference
- **Published**: 5-9 Nov. 2
...
- **Status**: ❌
- **Reason**: NB-LDPC(비이진) 소프트 디코더 VLSI 아키텍처(vertical shuffle). 비이진 LDPC는 제외 대상
- **ID**: ieee:8672710
- **Type**: conference
- **Published**: 28-30 Nov.
...
- **Status**: ❌
- **Reason**: 랜덤다중접속 충돌해소 알고리즘(SIC, weight polynomial) — LDPC ECC 아님, 떼어낼 기법 없음
- **ID**: ieee:8604399
- **Type**: conference
- **Published**: 26-30 Nov.
...
- **Status**: ❌
- **Reason**: 신경망 lattice 디코더(Voronoi/parallelotope), LDPC BP 비의존 lattice 전용
- **ID**: ieee:8646560
- **Type**: conference
- **Published**: 26-29 Nov.
...
- **Status**: ❌
- **Reason**: LDGM(생성행렬) 코드 list decoding 용량달성 이론, 표준 BP만 사용·신규 이식 기법 없음
- **ID**: ieee:8613510
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: SC-LDPC pseudodistance 성장률 순수 이론 bound, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:8613507
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: non-binary low-density code(Z/8Z) 기반 constellation shaping — 비이진 LDPC라 제외
- **ID**: ieee:8613506
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: polar code 큰 커널 스케일링 이론, 디코더가 LDPC BP에 이식되지 않음 — 비-LDPC 원칙 제외
- **ID**: ieee:8613428
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: 물리계층 네트워크코딩+convolutional code 조인트 디코딩, LDPC 무관·떼어낼 ECC 기법 없음
- **ID**: ieee:8613512
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: 보안 물리계층 네트워크 코딩, LDPC ECC 기법 없음(보안 제외)
- **ID**: ieee:8613305
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: 순환시프트 선형 네트워크 코딩 이론, NAND LDPC ECC와 무관 (네트워크 코딩, 떼어낼 디코더/HW 없음)
- **ID**: ieee:8613312
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: sparse 측정행렬 압축센싱(interval passing) 복원용 SC 구성, 채널 ECC가 아닌 신호복원이라 제외
- **ID**: ieee:8613339
- **Type**: conference
- **Published**: 25-29 Nov.
...
- **Status**: ❌
- **Reason**: 5G NR 표준 QC-LDPC의 EXIT 차트 성능 분석만, 신규 디코더·구성 기여 없음
- **ID**: ieee:8713114
- **Type**: conference
- **Published**: 25-28 Nov.
...
- **Status**: ❌
- **Reason**: 5G OFDM LDPC vs Turbo BER 비교 분석, 표준 코드 단순 적용·떼어낼 신규 기법 없음
- **ID**: ieee:8713083
- **Type**: conference
- **Published**: 25-28 Nov.
...
- **Status**: ❌
- **Reason**: DVB-S2 무선/위성에 표준 LDPC+표준 bit-flipping을 그대로 쓴 변조 비교 연구로, 떼어낼 신규 디코더/구성/HW 기여 없음
- **ID**: ieee:8820274
- **Type**: conference
- **Published**: 24-26 Nov.
...
- **Status**: ❌
- **Reason**: Polar code 설계(비-LDPC), 떼어낼 부호비의존 LDPC BP 기법 없음 - 원칙 제외
- **ID**: ieee:8601037
- **Type**: conference
- **Published**: 15-17 Nov.
...
- **Status**: ❌
- **Reason**: 무선 광통신 적응변조, LDPC/ECC 무관 - 제외
- **ID**: ieee:8587883
- **Type**: conference
- **Published**: 15-16 Nov.
...
- **Status**: ❌
- **Reason**: 통신용 statistical decoder+convolutional code, LDPC 아니고 부호비의존 BP 기법 없음 - 제외
- **ID**: ieee:8757497
- **Type**: conference
- **Published**: 15-16 Nov.
...
- **Status**: ❌
- **Reason**: SIFT 기반 워터마킹 기법으로 LDPC/ECC와 무관
- **ID**: ieee:8659458
- **Type**: conference
- **Published**: 12-15 Nov.
...
- **Status**: ❌
- **Reason**: SOVA/PSP 차동검출 채널추정 기법; LDPC ECC 무관, 떼어낼 디코더/구성 없음
- **ID**: ieee:8659608
- **Type**: conference
- **Published**: 12-15 Nov.
...
- **Status**: ❌
- **Reason**: 비이진(NB-LDPC) 디코딩 알고리즘, 바이너리 한정 기준에 따라 제외
- **ID**: ieee:8599296
- **Type**: conference
- **Published**: 10-12 Nov.
...
- **Status**: ❌
- **Reason**: Hamming/RS-FEC 기반 HPC 저지연 네트워크 설계, 비-LDPC이고 이식 가능한 BP 디코더 기법 없음
- **ID**: ieee:8548063
- **Type**: conference
- **Published**: 1-3 Nov. 2

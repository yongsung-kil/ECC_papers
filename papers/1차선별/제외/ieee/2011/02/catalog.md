...
- **Status**: ❌
- **Reason**: Slepian-Wolf 분산 소스코딩 BSC 파라미터 추정; 채널 ECC가 아닌 소스코딩이라 떼어낼 LDPC 디코더 기법 없음
- **ID**: ieee:5677629
- **Type**: journal
- **Published**: February 2
- **Authors**: Velotiaray Toto-Zarasoa, Aline Roumy, Christine Guillemot
- **PDF**: https://ieeexplore.ieee.org/document/5677629
...
- **Status**: ❌
- **Reason**: CRDSA/IRSA ALOHA 충돌해소 - erasure 그래프 유추 기반 MAC 처리량, 채널 ECC 디코더 아님
- **ID**: ieee:5668922
- **Type**: journal
- **Published**: February 2
- **Authors**: Gianluigi Liva
- **PDF**: https://ieeexplore.ieee.org/document/5668922
...
- **Status**: ❌
- **Reason**: 멀티홉 ad hoc 협력 노드 선택 정책 - LDPC 무관 네트워크 프로토콜
- **ID**: ieee:5669240
- **Type**: journal
- **Published**: February 2
- **Authors**: Michele Rossi, Cristiano Tapparello, Stefano Tomasin
- **PDF**: https://ieeexplore.ieee.org/document/5669240
...
- **Status**: ❌
- **Reason**: 무선 협력 연접부호 프레임워크로 LDPC 비의존, 떼어낼 ECC 기법 없음
- **ID**: ieee:5713796
- **Type**: journal
- **Published**: February 2
- **Authors**: Ernest S. Lo, K. B. Letaief
- **PDF**: https://ieeexplore.ieee.org/document/5713796
- **Abstract**: A generalized multiuser cooperative concatenated coding framework is theoretically developed for not only cooperative diversity but also enhanced distance spectra. Novel schemes are proposed featuring flexible cooperation group, variable-size messages, and other practical concerns. In particular, users failing to detect their partners messages are allowed to cooperate without incurring error propagation.

## Design of Optimized Convolutional and Serially Concatenated Convolutional Codes in the Presence of A-priori Information

- **Status**: ❌
- **Reason**: convolutional/SCCC 부호 설계 (turbo 계열) - 비-LDPC, 떼어낼 LDPC BP 이식 기법 없음
- **ID**: ieee:5659864
- **Type**: journal
- **Published**: February 2
- **Authors**: Andrea Abrardo, Gianluigi Ferrari
- **PDF**: https://ieeexplore.ieee.org/document/5659864
...
- **Status**: ❌
- **Reason**: 2D ISI 자기기록용 MCMC 검출기, LDPC는 turbo 연접 베이스라인일 뿐 떼어낼 LDPC 기법 없음
- **ID**: ieee:5654591
- **Type**: journal
- **Published**: Feb. 2011
- **Authors**: Mahdi Shaghaghi, Kui Cai, Yong Liang Guan +1
- **PDF**: https://ieeexplore.ieee.org/document/5654591
...
- **Status**: ❌
- **Reason**: Turbo equalization 서베이/리뷰, 신규 디코더·구성 기여 없음
- **ID**: ieee:5695128
- **Type**: journal
- **Published**: Feb. 2011
- **Authors**: Michael Tüchler, Andrew C. Singer
- **PDF**: https://ieeexplore.ieee.org/document/5695128
...
- **Status**: ❌
- **Reason**: Fountain code 기반 delay-tolerant network 라우팅, ECC 디코더/구성 기여 없음
- **ID**: ieee:5668515
- **Type**: journal
- **Published**: Feb. 2011
- **Authors**: Eitan Altman, Francesco De Pellegrini
- **PDF**: https://ieeexplore.ieee.org/document/5668515
...
- **Status**: ❌
- **Reason**: 비이진(nonbinary GF(q)) repeat-multiple-accumulate 부호, 거리 특성 이론 — 비이진+비-LDPC, 제외
- **ID**: ieee:5743575
- **Type**: conference
- **Published**: 6-11 Feb. 
- **Authors**: Alexandre Graell i Amat, Eirik Rosnes
- **PDF**: https://ieeexplore.ieee.org/document/5743575
...
- **Status**: ❌
- **Reason**: Bethe/Kikuchi 분배함수의 조합적 특성화 — 순수 이론, 디코더/HW/구성으로 안 이어짐
- **ID**: ieee:5743617
- **Type**: conference
- **Published**: 6-11 Feb. 
- **Authors**: Pascal O. Vontobel
- **PDF**: https://ieeexplore.ieee.org/document/5743617
...
- **Status**: ❌
- **Reason**: 릴레이 시스템 BER 기반 전력할당, LDPC 부수 언급 — 이식할 디코더/코드 기법 없음
- **ID**: ieee:5741925
- **Type**: conference
- **Published**: 24-25 Feb.
- **Authors**: Meng Wu, Dirk Wübben, Armin Dekorsy
- **PDF**: https://ieeexplore.ieee.org/document/5741925
...
- **Status**: ❌
- **Reason**: 무선 릴레이 AF/DF 적응 포워딩, LDPC는 부수 성능평가만 — 떼어낼 ECC 기법 없음
- **ID**: ieee:5738555
- **Type**: conference
- **Published**: 24-25 Feb.
- **Authors**: Chanchal Kumar De, Sumit Kundu
- **PDF**: https://ieeexplore.ieee.org/document/5738555
- **Abstract**: In this paper, an adaptive forwarding strategy for wireless networks using relays in multi hop and cooperative network is discussed. Here two schemes, amplify-and-forward (AF) and decode-and-forward (DF) are chosen depending on channel condition. Further it allows switching between the two schemes according to channel condition. The bit error probability performance (BEP) for the proposed hybrid strategy is evaluated in presence of Rayleigh fading. Further BEP performance is assessed using LDPC code.

## Comparison of 65nm LP bulk and LP PD-SOI with adaptive power gate body bias for an LDPC codec

- **Status**: ❌
- **Reason**: 65nm SOI vs bulk 공정 전력 비교가 핵심, LDPC 코덱은 벤치마크 회로일 뿐 이식할 디코더 아키텍처 기여 없음
- **ID**: ieee:5746343
- **Type**: conference
- **Published**: 20-24 Feb.
- **Authors**: Julien Le Coz, Philippe Flatresse, Sylvain Engels +5
- **PDF**: https://ieeexplore.ieee.org/document/5746343

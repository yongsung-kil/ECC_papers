...
- **Status**: ❌
- **Reason**: Information Bottleneck으로 FFT 양자화 LUT 최적화 — LDPC LUT 영감만 받은 FFT 응용, ECC 디코더 기여 아님
- **ID**: ieee:9913001
- **Type**: conference
- **Published**: 30 June-3 
- **Authors**: Clemens- Konrad Mueller, Steffen Steiner, Volker Kuehn
- **PDF**: https://ieeexplore.ieee.org/document/9913001
- **Abstract**: The trend towards larger bandwidths in mobile communications requires coarse quantization to obtain energy efficient analog-to-digital converters. The question is whether quantization and subsequent processing can be optimized with respect to relevant mutual information. Current standards rely on orthogonal frequency division multiplexing (OFD M) as air interface and require the implementation of an fast Fourier transform (FFT). Inspired by the efficient implementation of low density parity check (LDPC) decoders via lookup-tables optimized by the information bottleneck (IB) method, we suggest to approximate the computation of intermediate quantities inside the FFT with IB-optimized lookup-tables being designed offline. Consequently, the FFT only relies on the mapping quantization indices for which the flow of relevant information is optimized.

## Performance Evaluation of Multilevel Coded FEC with Register-Transfer-Level Emulation

- **Status**: ❌
- **Reason**: multilevel coded FEC HW 에뮬레이션 BER 측정만, 떼어낼 LDPC 디코더/구성 기법 없음
- **ID**: ieee:9849856
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Toshihiro Konno, Kazumasa Mikami, Junichi Sugiyama +1
- **PDF**: https://ieeexplore.ieee.org/document/9849856
- **Abstract**: We demonstrated hardware emulations to evaluate the error-correction performance for a FEC scheme with multilevel coding. It has enabled the measurement of BER to reach the order of 10−14 for the decoded signal.

## Interplay of Probabilistically Shaped Multilevel Coded Modulation and Fiber Nonlinearity Compensation

- **Status**: ❌
- **Reason**: probabilistic shaping coded modulation 전력소비 분석, 이식 LDPC 기법 없음
- **ID**: ieee:9850154
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Tsuyoshi Yoshida, Takashi Inoue, Masashi Binkai +4
- **PDF**: https://ieeexplore.ieee.org/document/9850154
- **Abstract**: Transmission performance and decoding power consumption are investigated in coded modulation (CM) schemes. Probabilistically-shaped multilevel CM shows 21 or 9 times lower power consumption than uniform bit-interleaved CM with or without fiber nonlinearity compensation, respectively.

## Probabilistic Amplitude Shaping with BICM-ID for all possible labels on 64-QAM

- **Status**: ❌
- **Reason**: PAS+BICM-ID 64-QAM 비트할당/인터리버, 채널코딩 LDPC ECC 기법 아님
- **ID**: ieee:9850181
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Mamoru Komatsu, Akira Naka
- **PDF**: https://ieeexplore.ieee.org/document/9850181
- **Abstract**: We numerically evaluated BER performance of PAS with BICM-ID for all possible labels on 64-QAM and confirmed the effectiveness of proposed interleaver to adjust bit allocation between encoder and modulator using EXIT chart analysis.

## Soft-decision FEc Designed for Optically Preamplified PAM4 Direct Detection

- **Status**: ❌
- **Reason**: PAM4 direct detection용 soft-decision FEC, LDPC 디코더/구성 기여 없음 통신 응용 특이적
- **ID**: ieee:9849940
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Koji Igarashi, Takumi Takahashi, Seiichi Sampei +1
- **PDF**: https://ieeexplore.ieee.org/document/9849940
- **Abstract**: We present a soft-decision FEC designed for preamplified PAM4 direct detection. In the designed FEC, a gamma distribution is fitted to beat noise PDFs, achieving a post-FEC BER threshold comparable to that in coherent systems.

## 50 Gbps Passive Optical Network (50G-PON) for Broadband Access and Beyond

- **Status**: ❌
- **Reason**: 50G-PON 표준/수요 리뷰, ECC 기법 무관
- **ID**: ieee:9849908
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Dezhi Zhang, Derek Nesset, Dekun Liu
- **PDF**: https://ieeexplore.ieee.org/document/9849908
- **Abstract**: A complete suite of 50G-PON standards was finalized by the ITU-T in 2021. The demand drivers for increasing broadband access capacity are reviewed along with the status of ITU-T standardization and prototype technology demonstrations.

## High-Fidelity and High-Capacity Analog Radio-over-Fiber Transmission

- **Status**: ❌
- **Reason**: analog radio-over-fiber 전송 리뷰, ECC 무관
- **ID**: ieee:9850068
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Shota Ishimura, Hidenori Takahashi, Takehiro Tsuritani +1
- **PDF**: https://ieeexplore.ieee.org/document/9850068
- **Abstract**: In this invited paper, we review our recent progress on analog radio-over-fiber (RoF) technology for mobile fronthaul systems from two perspectives. The results show the feasibility of high-capacity and high-fidelity analog mobile fronthaul.

## Coding techniques for beyond 1Tbps optical transmission

- **Status**: ❌
- **Reason**: 광통신 FEC 트렌드 리뷰 + multilevel coding/probabilistic shaping, 이식 가능 LDPC 기법 없음
- **ID**: ieee:9849905
- **Type**: conference
- **Published**: 3-6 July 2
- **Authors**: Yohei Koganei
- **PDF**: https://ieeexplore.ieee.org/document/9849905
- **Abstract**: We firstly review FEC technologies for optical communication with illustrating the trends in each era of the technology. We then show a possible direction for coding techniques that utilizes multilevel coding and probabilistic shaping.

## Analysis of Error-Correction Codes Properties for Underwater Optical Communication Systems with OCDM Modulation

- **Status**: ❌
- **Reason**: 수중광통신 OCDM에 LDPC/polar/turbo 표준 부호 BER 비교 평가 — 새 LDPC 기법 없음, 응용 특이적
- **ID**: ieee:9840984
- **Type**: conference
- **Published**: 29 June-1 
- **Authors**: N. E. Miroshnikova, A. I. Sattarova
- **PDF**: https://ieeexplore.ieee.org/document/9840984
- **Abstract**: Underwater optical channel has strong and variable propagation, absorption and fading conditions which requires careful study. In this article we analyzed error-correcting codes performance in various conditions of underwater optical channel and orthogonal chirp division multiplexing for increasing optical communication systems service area. As coding algorithm candidates were applied main types of modern efficient error-correcting codes such as: product and convolutional turbo codes, LDPC and polar code. Analysis was performed for underwater optical channel model with fading coefficient distributions for various stretch of water conditions. We found the most compatible type of error-correcting coding scheme with OCDM modulation and the underwater optical channel using minimum of BER criteria.

## Large-Scale MIMO Communications With Low-Resolution ADCs Using 16-ary QAM and Protograph LDPC Codes

- **Status**: ❌
- **Reason**: 기존 설계된 protograph LDPC와 표준 더블레이어 Tanner graph를 그대로 사용; 기여는 변조/성좌 설계로 떼어낼 LDPC 디코더·코드·HW 신규 기법 없음
- **ID**: ieee:9852075
- **Type**: conference
- **Published**: 27-29 July
- **Authors**: Hieu T. Nguyen, Duc A. Hoang, Hoai T. Bui +2
- **PDF**: https://ieeexplore.ieee.org/document/9852075
- **Abstract**: In this paper, a new coded modulation model of the large-scale multiple-input multiple-output (LS-MIMO) system with low-resolution ADCs in conjunction with the superposed 16-ary QAM modulation is proposed to achieve high bandwidth efficiency. We derive the formulas to convert the channel model of the 16-ary QAM communication systems into an equivalent channel model of the binary phase-shift keying (BPSK) communication system so that the standard double-layer Tanner graph, whose complexity level is the second order of the number transmit only, can be employed to jointly detect and decode the information bit. Furthermore, we perform extensive computer simulation works to discover that the equal-weight superposition constellation is the best choice in the coded system as the system can enjoy the power gain of the constellation and exploit the error-correcting power of the protograph low-density parity-check codes (LDPC) previously designed for LS-MIMO channels. This constellation offers approximately about 1 dB coding gain over the conventional equal-distance constellation in all considered few-bit ADCs.

## Accelerator-Resource Sharing with Offload-Mediated Proxy for vRAN

- **Status**: ❌
- **Reason**: vRAN 가속기 공유 아키텍처, LDPC/ECC 내용 전무
- **ID**: ieee:9844114
- **Type**: conference
- **Published**: 27 June-1 
- **Authors**: Ikuo Otani, Kei Fujimoto, Akinori Shiraga
- **PDF**: https://ieeexplore.ieee.org/document/9844114
- **Abstract**: In a virtual radio access network (vRAN), accelerators are often used in general purpose servers. They can achieve very high performance in signal processing but at the same time consume high power. If accelerators can be shared by multiple vRAN applications, power consumption can be saved.In this paper, we proposed a method to satisfy five requirements in sharing vRAN accelerators by multiple applications: (a) accelerator sharing without application modification, (b) dynamic accelerator resource increasing and decreasing, (c) no need to consume accelerator resources to enable accelerator sharing, (d) minimum increase in power to enable accelerator sharing, and (e) minimum decrease in performance to enable accelerator sharing. Through pre-evaluation, it became clear that proxy architecture can achieve requirements (a)–(c), but it also causes power to increase. To reduce overheads, we proposed a proxy method in which the proxy itself and vRAN application can sleep as much as possible. We showed that this architecture can reduce power as low as a raw accelerator system without significantly degrading performance, which means accelerator sharing is feasible.

## Minimum distance and other properties of quasi-dyadic parity check codes

- **Status**: ❌
- **Reason**: QD-LDPC/MDPC 코드 속성(최소거리) 분석이며 code-based cryptography 키사이즈 목적, NAND 바이너리 LDPC에 이식할 새 디코더/구성 기여 없음
- **ID**: ieee:9834770
- **Type**: conference
- **Published**: 26 June-1 
- **Authors**: Meraiah Martinez, Christine A. Kelley
- **PDF**: https://ieeexplore.ieee.org/document/9834770
- **Abstract**: A quasi-dyadic (QD) parity check code is a code whose parity check matrix representation is block structured with dyadic matrices as blocks. Depending on the number of nonzero positions in the leading row of each block, these codes may be either low density or moderate density. Moreover, each block is reproducible, giving QD codes advantages similar to quasi-cyclic (QC) codes. In this paper we examine basic code properties of QD-LDPC and QD-MDPC codes. These codes have potential to be of use in standard error correction applications as well as code-based cryptography due to their smaller key size.

## Efficient ADMM Decoder for Non-binary LDPC Codes based on Bit Embedding Technique

- **Status**: ❌
- **Reason**: non-binary LDPC(GF(2^q)) ADMM 디코더 — 비이진 LDPC는 기준상 즉시 제외
- **ID**: ieee:9834885
- **Type**: conference
- **Published**: 26 June-1 
- **Authors**: Xiaomeng Guo, Yongchao Wang
- **PDF**: https://ieeexplore.ieee.org/document/9834885
- **Abstract**: In this paper, we devise a new alternating direction method of multipliers (ADMM) decoder for non-binary low-density parity-check (LDPC) codes in Galois fields of characteristic two $\left( {{\mathbb{F}_{{2^q}}}} \right)$. Its main content are threefold: first, the procedure of formulating the maximum likelihood (ML) decoding problem in ${\mathbb{F}_{{2^q}}}$ to a linear integer problem in real space is presented; Second, after relaxing the integer problem to a continuous one, an efficient ADMM algorithm is customized to solve the latter, where all the entries of the variable vectors can be obtained in parallel; Third, we show that the proposed ADMM decoder satisfies the favorable codeword-independent property under some mild conditions and its computation complexity in each ADMM iteration is roughly $\mathcal{O}\left( {nq} \right)$, where n is code length of the considered non-binary LDPC code. Simulation results demonstrate that its performance, such as error-correction and decoding efficiency, is very competitive in comparison with state-of-the-art non-binary LDPC decoders.

## Analysis of Non-Binary High-Rate Repetition-Parity-Parity Codes Over the BEC

- **Status**: ❌
- **Reason**: 비이진(non-binary) repetition-parity-parity 코드 BEC 분석 — 비이진 LDPC라 제외
- **ID**: ieee:9834620
- **Type**: conference
- **Published**: 26 June-1 
- **Authors**: Iryna Andriyanova, Charly Poulliat
- **PDF**: https://ieeexplore.ieee.org/document/9834620
- **Abstract**: A new class of doubly-generalized LDPC codes over extended code alphabets has been recently proposed in [1]. These codes have been shown to have good asymptotic and minimum distance properties in the range of high code rates, and their structure is solely based on non-binary repetition and parity-check component codes. In this work we go further in the investigation of the new code class, called Repetition-parity-Parity (RPP) in the rest of the paper, by extending the definition of [1] to irregular degree distributions. One performs the asymptotic decoding analysis of the RPP ensemble over the binary erasure channel and formulates a degree distribution optimization problem by means of an approximated EXIT analysis. Some insights on the stability, minimum distance properties and low complexity encoding and decoding of RPP codes have been also developed.

## Analysis of Symbol Message Passing LDPC Decoder for the Poisson PPM Channel

- **Status**: ❌
- **Reason**: q-ary(비이진) LDPC + Poisson PPM 채널 심볼 메시지 패싱 — 비이진 LDPC라 즉시 제외
- **ID**: ieee:9834496
- **Type**: conference
- **Published**: 26 June-1 
- **Authors**: Emna Ben Yacoub, Balázs Matuz
- **PDF**: https://ieeexplore.ieee.org/document/9834496
...
- **Status**: ❌
- **Reason**: BPQM 양자 메시지 belief propagation 디코딩 — 양자 전용(클래시컬-양자 채널·근사 클로닝)에 의존, 고전 바이너리 LDPC로 이식 불가, 양자 원칙 제외
- **ID**: ieee:9834749
- **Type**: conference
- **Published**: 26 June-1 
- **Authors**: Christophe Piveteau, Joseph M. Renes
- **PDF**: https://ieeexplore.ieee.org/document/9834749
...
- **Status**: ❌
- **Reason**: 폴라코드 기반 Merkle Tree로 블록체인 DA 공격 탐지 — LDPC는 베이스라인 언급뿐, 폴라코드 기여이며 NAND ECC 기법 없음
- **ID**: ieee:9834538
- **Type**: conference
- **Published**: 26 June-1 
- **Authors**: Debarnab Mitra, Lev Tauz, Lara Dolecek
- **PDF**: https://ieeexplore.ieee.org/document/9834538
...
## Multidimensional LDPC-coded signal transmission over TWDP fading channel

- **Status**: ❌
- **Reason**: OAM/TWDP 페이딩 LDPC-coded 다차원 변조 성능 분석. 표준 LDPC 베이스라인, 떼어낼 기법 없음
- **ID**: ieee:9907966
- **Type**: conference
- **Published**: 20-22 July
- **Authors**: Goran T. Djordjevic, Ivan B. Djordjevic
- **PDF**: https://ieeexplore.ieee.org/document/9907966
- **Abstract**: In this paper, we analyze orbital angular momentum (OAM)-based signal transmission over front-haul/back-haul links in beyond 5G networks where bit-interleaved low-density parity-check (LDPC) coded modulation is used. The back-haul/front-haul links are modeled by recently proposed two waves with diffuse power (TWDP) fading model. We evaluate bit error rate performance in detecting multidimensional LDPC-coded signals transmitted over a TWDP channel. By applying Monte Carlo simulations, we investigate the effects of constellation dimensionality, number of points in constellation and number of iterations in decoder on bit-error rate (BER) performance of an LDPC code for different channel conditions. For given channel conditions and a fixed number of points in the constellation diagram, the simulation results aim to illustrate performance improvement by increasing the order of constellation dimensions from 2 to 4.

## Demonstration of 20 Mbps LED Ultraviolet-C Communication over Medium Distance with Photon Receiver

- **Status**: ❌
- **Reason**: UV-C LED 광통신 데모. LDPC·ECC 기법 없음
- **ID**: ieee:9908036
- **Type**: conference
- **Published**: 20-22 July
- **Authors**: Yifan Ding, Huabin Yu, Muhammad Hunain Memon +3
- **PDF**: https://ieeexplore.ieee.org/document/9908036
- **Abstract**: Motivated by optical covert communication that can support both line-of-sight (LOS) and non-line-of-sight (NLOS) scenario, we demonstrate the possiblilty of the high data rate communication using deep ultraviolet (UV) light emitting-diode (LED). Both the LOS and NLOS UV communication links over realistic distances have been built. In LOS communication, we transmit data at rate from 2.5 Mbps to 20 Mbps in distances of 10 meters, 20 meters, and 30 meters. While in NLOS communication experiment, we test the channel over 6 meters at the reflection angle of 90 degree, which is reflected by different solid materials. The transmitter adopts On-Off Keying (OOK) modulation, and the receiver part consists of a photomultiplier tube (PMT) and an oscilloscope. We process data on a computer in an offline manner, where supporting vector machine-based approach for signal detection is adopted. The experimental results show that in the LOS condition, the UV LED can provide stable communication at symbol rate 20 Mbps with bit-error rate (BER) below 2%in distance of 20 meters. Furthermore, we demonstrate that the UV photons can be reflected by smooth solid material at 90 degree where symbol rate 10 Mbps with BER below 2%can be achieved.

## Implementation of CUDA and Hadoop based System for Intelligent Guiding Evaluation Algorithm based on Data Center Data Mining

- **Status**: ❌
- **Reason**: CUDA/Hadoop 교육평가 데이터마이닝 시스템. LDPC와 무관
- **ID**: ieee:9850439
- **Type**: conference
- **Published**: 20-22 July
- **Authors**: Yan Li
- **PDF**: https://ieeexplore.ieee.org/document/9850439
- **Abstract**: Implementation of CUDA and Hadoop based system for intelligent guiding evaluation algorithm based on data center data mining is studied in the paper. Based on Jinling Institute of Science and Technology, this paper designs and implements a smart teaching evaluation system for emerging application-oriented undergraduate colleges that integrates relevant teaching and educational affairs data based on the data center and provides standard service interfaces through the center, so as to establish a scientific and fair teaching system. Evaluation index system, improve various drawbacks of the existing teaching evaluation mode, strengthen the analysis, diagnosis and feedback of teaching evaluation - continuous improvement function. For the CUDA and Hadoop, the process of histogram equalization algorithm based on CUDA architecture. The host first obtains the parameters of the input image and initializes the GPU device, including the selection and setting of the device. Then, the host applies for the information storage space required for image data, image equalization data, probability statistics of each gray level of the image and mapping of each gray level of the image, and copies the image data from the host side memory to the global memory of the device side. The system is then implemented with the data mining aspects. The simulation has proven the effectiveness.

## Optimization of Power Allocation for LDPC Coded Modulation on Fading Channels

- **Status**: ❌
- **Reason**: 페이딩 채널 전력 할당 최적화 — 무선 응용 특이적, 떼어낼 디코더/HW/코드 기법 없음
- **ID**: ieee:9851803
- **Type**: conference
- **Published**: 19-22 July
- **Authors**: Xinwei Xu, Zhixing Hu, Dengsheng Lin +1
- **PDF**: https://ieeexplore.ieee.org/document/9851803
- **Abstract**: This contribution studies adaptive power allocation of low-density parity check-code (LDPC) coded modulation on fading channels, where in this case, the symbols within a codeword suffer from different signal-to-noise ratios (SNRs). We consider adjusting the transmission power for each symbol within the codeword so as to improve the transmission performance, through an optimization based on Gaussian approximation. Specially, we first give the expression of the optimization problem, and further propose the solution based on Lagrangian method. Numerical results demonstrate the performance gain brought by the proposed power allocation method.

## Reduced-Complexity T-EMS Algorithm with Elitist Selection for Non-Binary LDPC Codes

- **Status**: ❌
- **Reason**: Non-binary (NB-LDPC, GF(q)) T-EMS 알고리즘 — 비이진 LDPC는 원칙 제외
- **ID**: ieee:9851801
- **Type**: conference
- **Published**: 19-22 July
- **Authors**: Zhong Tang, Ming Zhan, Chenchang Gao +1
- **PDF**: https://ieeexplore.ieee.org/document/9851801
- **Abstract**: In this paper, we proposed a modified Trellis extended min-sum (T-EMS) algorithm with L truncations for non-binary low density parity check (NB-LDPC) codes. The proposed algorithm achieves to reduce complexity of T-EMS algorithm, especially on large order Galois fields GF(q). In order to improve the error-correcting performance of the algorithm, an elitist selection (ES) strategy is presented, which enlarges the belief value of the selected symbols. As a proof, the simulation results and complexity analysis show that with the increase of q, the complexity decreases obviously. However, in the case of a suitable L value, the LT-EMS algorithm with ES strategy is not inferior to the T-EMS algorithm in performance. In addition, the ES strategy can accelerate the convergence rate and reduce the number of iterations of the decoding process, which will enhance the decoding throughput.

## Research on Multipath Reception and Soft Decision Algorithms for Frequency Shift Chirp Modulation

- **Status**: ❌
- **Reason**: FSCM 다중경로 수신/연판정 복조(LoRa) 중심, LDPC는 부수 언급, 떼어낼 ECC 기법 없음
- **ID**: ieee:9851747
- **Type**: conference
- **Published**: 19-22 July
- **Authors**: Qichong Chen, Lei Zhao, Yueyan Chu +1
- **PDF**: https://ieeexplore.ieee.org/document/9851747
- **Abstract**: Frequency Shift Chirp Modulation (FSCM) is the physical layer modulation technique adopted by LoRaWAN-one of the Low Power Wide Area Network (LPWAN) technology. The frequency sweeping feature of the chirp signal in FSCM provides better anti-fading performance than FSK, but when suffering severe multipath interference, the performance of the LoRa system deteriorates greatly. This paper focuses on the reception of FSCM under the multipath channel, compares the performance of two multipath receiving methods: frequency domain equalization and preamble symbol estimation, and proposes FSCM soft-decision demodulation algorithms. Simulation and comparison are performed in the FSCM system combined with coding and interleaving. The results indicate that the FSCM system with soft-decision demodulation has better performance than hard-decision, and the soft-decision algorithms provide bit likelihood information for applying advanced codes (e.g., LDPC codes) to get better performance.

## Performance evaluation of coding schemes for 5G Communication under different channel setting

- **Status**: ❌
- **Reason**: 5G massive MIMO 코딩 스킴 BER 성능평가; LDPC 부수, 새 기법 없음
- **ID**: ieee:9914100
- **Type**: conference
- **Published**: 15-16 July
- **Authors**: Lipsa Dash, Anand Sreekantan Thampy
- **PDF**: https://ieeexplore.ieee.org/document/9914100
- **Abstract**: Future communication systems aim to provide very high data rate seamless service to users. Massive Multiple Input Multiple Output (MIMO) is emerging as a technology to address this goal in 5G standard. The inherent ability of handling huge data makes it perfect candidate for high-rate applications. The term Massive comes from the fact that the Base Station (BS) is designed with a greater number of antennas for supporting numerous users over the same time-frequency resources. The increasing demand for minimum latency and high reliability communication necessitates efficient data transfer via the most unreliable wireless channel. The unpredictable nature of wireless channel due to multipath fading phenomena poses threat on data transmission inducing errors. Suitable channel coding techniques can combat the errors to a great extent. This paper simulates uncoded and coded massive MIMO system with perfect and imperfect channel state information. It is observed that coded transmission outperforms uncoded once in terms of bit error rate. The BER performance is analysed and compared in different channel scenarios i.e., Rayleigh, Rician and Gaussian.

## Successive Cancellation Polar Decoder Implementation using Processing Elements

- **Status**: ❌
- **Reason**: Polar code SC 디코더 VLSI 구현; LDPC는 비교 언급뿐, 떼어낼 LDPC ECC 기법 없음
- **ID**: ieee:9864529
- **Type**: conference
- **Published**: 1-3 July 2
- **Authors**: Swapnil P. Badar, Kamalesh Khanchandani
- **PDF**: https://ieeexplore.ieee.org/document/9864529
- **Abstract**: Channel coding is key factor of error free communication. Polar code is selected as channel control code for 5G wireless system in third generation partnership project New Radio – 3GPP NR. Polar code has ability to use all channel capacity as contrast with low density parity check (LDPC) and turbo code. Successive cancellation (SC) decoder is basic polar code decoder which works sequentially. Due to sequential in nature of SC decoder, latency is high. SC polar decoder using processing element like f-function node, g-function node and partial sum function node is designed in this paper. The connections of these processing elements are followed to polar code decoding circuit graph. SC polar decoder is designed by two ways, the first is without component code and other is with component code (structural way). Processing elements and SC polar decoder VLSI architectures generated by Xilinx platform are shown in this paper.

...
- **Status**: ❌
- **Reason**: 코드기반 암호의 syndrome decoding을 Grassmannian으로 일반화한 이론; ECC 디코더/HW 기여 아님
...
- **Status**: ❌
- **Reason**: 비이진(NB-LDPC) + FTN 시그널링; non-binary 제외 대상
...
- **Status**: ❌
- **Reason**: 양자 LDPC 코드의 거리/차원 bound 이론; 양자 전용 개념 의존, 고전 바이너리 이식 기법 없음

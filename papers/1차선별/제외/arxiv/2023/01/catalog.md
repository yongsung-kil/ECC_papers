...
- **Status**: ❌
- **Reason**: 양자 CSS/qLDPC code surgery — 스태빌라이저·체인복합체 등 양자 전용 개념 의존, 고전 바이너리 LDPC 이식 불가
- **ID**: arxiv:2301.13738v6
- **Type**: preprint
- **Published**: 2023-01-31
- **Authors**: Alexander Cowtan, Simon Burton
- **PDF**: https://arxiv.org/pdf/2301.13738v6
...
- **Status**: ❌
- **Reason**: 블록체인 DA 공격용 Polar Coded Merkle Tree — LDPC는 비교 베이스라인일 뿐 기여는 polar code, 떼어낼 LDPC 기법 없음
- **ID**: arxiv:2301.08295v1
- **Type**: preprint
- **Published**: 2023-01-19
- **Authors**: Debarnab Mitra, Lev Tauz, Lara Dolecek
- **PDF**: https://arxiv.org/pdf/2301.08295v1

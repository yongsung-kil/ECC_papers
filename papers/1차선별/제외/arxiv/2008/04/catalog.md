...
- **Status**: ❌
- **Reason**: protograph LDPC convolutional code의 free distance bound — 순수 이론 bound, 디코더/HW로 안 이어짐
- **ID**: arxiv:0804.4466v1
- **Type**: preprint
- **Published**: 2008-04-28
- **Authors**: David G. M. Mitchell, Ali E. Pusane, Norbert Goertz +1
- **PDF**: https://arxiv.org/pdf/0804.4466v1
...
- **Status**: ❌
- **Reason**: LDGM 손실 소스코딩 rate-distortion 하한 — 채널 ECC 아닌 소스코딩
- **ID**: arxiv:0804.1697v1
- **Type**: preprint
- **Published**: 2008-04-10
- **Authors**: Shrinivas Kudekar, Ruediger Urbanke
- **PDF**: https://arxiv.org/pdf/0804.1697v1
...
- **Status**: ❌
- **Reason**: QC-LDPC McEliece 암호 cryptanalysis — 보안/암호분석, ECC 디코더·구성 기법 아님
- **ID**: arxiv:0804.0409v3
- **Type**: preprint
- **Published**: 2008-04-02
- **Authors**: Ayoub Otmani, Jean-Pierre Tillich, Leonard Dallot
- **PDF**: https://arxiv.org/pdf/0804.0409v3

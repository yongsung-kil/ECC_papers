...
- **Status**: ❌
- **Reason**: Distributed Transmit Beamforming용 적응형 짧은 LDPC 구성 — 무선 응용 특이적, 새 코드설계 기여 불명확
- **ID**: arxiv:1807.03526v2
- **Type**: preprint
- **Published**: 2018-07-10
- **Authors**: Ismail Shakeel, Ishtiaq Ahmad, Hajime Suzuki
- **PDF**: https://arxiv.org/pdf/1807.03526v2
...
- **Status**: ❌
- **Reason**: Compute-and-Forward 중계채널용 SC-LDPC density evolution 점근분석 — 순수 이론 분석+무선 응용, 떼어낼 디코더/HW/구성 신규 기여 없음
- **ID**: arxiv:1807.01599v1
- **Type**: preprint
- **Published**: 2018-07-03
- **Authors**: Satoshi Takabe, Tadashi Wadayama, Masahito Hayashi
- **PDF**: https://arxiv.org/pdf/1807.01599v1

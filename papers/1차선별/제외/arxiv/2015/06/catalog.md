...
- **Status**: ❌
- **Reason**: polar code 구성 알고리즘의 비실용성 이론 결과 — 비-LDPC, density evolution 언급은 부수적이고 이식할 디코더/구성 기법 없음
- **ID**: arxiv:1506.08370v1
- **Type**: preprint
- **Published**: 2015-06-28
- **Authors**: Ido Tal
- **PDF**: https://arxiv.org/pdf/1506.08370v1
...
- **Status**: ❌
- **Reason**: superlinear hyperedge 랜덤 하이퍼그래프 peeling 임계값 순수이론 bound — BEC LDPC 디코딩 threshold 응용이나 디코더/HW/구성으로 이어지는 신규 기법 없음
- **ID**: arxiv:1506.00718v1
- **Type**: preprint
- **Published**: 2015-06-02
- **Authors**: Ryuhei Mori, Osamu Watanabe
- **PDF**: https://arxiv.org/pdf/1506.00718v1

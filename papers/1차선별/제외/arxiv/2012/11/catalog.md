...
- **Status**: ❌
- **Reason**: BEC용 불규칙 LDPC degree distribution 최적화(SDP) — 순수 ensemble 이론, 디코더/HW/구성 신규 이식 기법 없음
- **ID**: arxiv:1211.6279v1
- **Type**: preprint
- **Published**: 2012-11-27
- **Authors**: H. Tavakoli, M. Ahmadian, M. Reza Peyghami
- **PDF**: https://arxiv.org/pdf/1211.6279v1
...
- **Status**: ❌
- **Reason**: 비이진(NBLDPC) 부호+MIMO 검출; 기준상 non-binary LDPC 제외, 검출기는 MIMO 전용
- **ID**: arxiv:1211.5067v1
- **Type**: preprint
- **Published**: 2012-11-21
- **Authors**: Puripong Suthisopapan, Kenta Kasai, Anupap Meesomboon +1
- **PDF**: https://arxiv.org/pdf/1211.5067v1

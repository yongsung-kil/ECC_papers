...
- **Status**: ❌
- **Reason**: SC-LDPC는 표준 protograph 사용, coupling은 BICM 수신기(채널추정·검출)용이라 NAND 이식할 신규 LDPC 디코더/코드 기법 아님
- **ID**: arxiv:1412.6223v1
- **Type**: preprint
- **Published**: 2014-12-19
- **Authors**: Keigo Takeuchi
- **PDF**: https://arxiv.org/pdf/1412.6223v1
...
- **Status**: ❌
- **Reason**: 양자 LDPC(degenerate quantum codes)의 fault-tolerant threshold 순수 이론 bound — 디코더/HW/구성 이식 기여 없고 양자 전용 개념 의존, 제외
- **ID**: arxiv:1412.6172v1
- **Type**: preprint
- **Published**: 2014-12-18
- **Authors**: Ilya Dumer, Alexey A. Kovalev, Leonid P. Pryadko
- **PDF**: https://arxiv.org/pdf/1412.6172v1
...
- **Status**: ❌
- **Reason**: unit scheme 기반 convolutional code 대수적 구성/복호 — LDPC-CC 언급은 부수적이고 dual-containing은 양자코드용, 바이너리 NAND LDPC 이식 신규 기여 불명확
- **ID**: arxiv:1412.1695v4
- **Type**: preprint
- **Published**: 2014-12-04
- **Authors**: Ted Hurley
- **PDF**: https://arxiv.org/pdf/1412.1695v4

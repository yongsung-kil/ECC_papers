...
- **Status**: ❌
- **Reason**: GF(q) 비이진 LDPC 성능을 통계역학으로 분석 — 비이진 LDPC 제외, 떼어낼 바이너리 디코더/HW 없음
- **ID**: arxiv:cond-mat/0010073v1
- **Type**: preprint
- **Published**: 2000-10-05
- **Authors**: Kazutaka Nakamura, Yoshiyuki Kabashima, David Saad
- **PDF**: https://arxiv.org/pdf/cond-mat/0010073v1

# IEEE Xplore — 2025-08 (1차선별 통과)


## Reduced Complexity Dynamic Schedule for Layered Decoding of LDPC Codes

- **Status**: ✅
- **Reason**: LDPC 계층 복호(layered decoding)의 동적 스케줄 복잡도 저감 기법 제안 — 잔차 기반 레이어 선택 알고리즘(C: 이식 가능 디코더 알고리즘)으로 NAND LDPC 디코더에 직접 적용 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10925880
- **Type**: journal
- **Published**: Aug. 2025
...
- **Status**: ✅
- **Reason**: 40nm CMOS 구현 5G NR LDPC/Polar 통합 HW 디코더; configurable permutation network·unified processing node 등 NAND LDPC 디코더 HW 아키텍처(D)로 이식 가능.
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:11039498
- **Type**: journal
- **Published**: Aug. 2025
...
- **Status**: ✅
- **Reason**: NAND 플래시 TLC LDPC를 직접 대상으로 한 absorbing set 인식 LLR 수정 알고리즘(AsLDPC); FER 58% 감소 — 직접 적용(A/C).
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11079633
- **Type**: journal
- **Published**: Aug. 2025
...
- **Status**: ✅
- **Reason**: 짧은 BCH 코드용 enhanced normalized min-sum 디코더(cycle-4 최소화·automorphism ensemble·hybrid OSD); min-sum 변형 및 OSD 기법이 NAND LDPC 디코더(C)에 이식 가능.
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11048551
- **Type**: journal
- **Published**: Aug. 2025
...
- **Status**: ✅
- **Reason**: 양자 LDPC용 Two-Bit BF(TBF) 디코더 제안 — 고전 비트플리핑 변형 알고리즘으로 C 카테고리 이식 가능성 검토 필요(Phase 3 재검토)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10857350
- **Type**: journal
- **Published**: Aug. 2025
...
- **Status**: ✅
- **Reason**: Box-Plus 근사 기반 ABP 디코딩 알고리즘 — NMS/OMS 대비 0.4 dB 성능 향상·38.9% 복잡도 감소, 이식 가능한 디코더 기법(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11430448
- **Type**: conference
- **Published**: 8-11 Aug. 
...
- **Status**: ✅
- **Reason**: 신경망 기반 LDPC 디코더 병렬 HW 구조 — 이식 가능 디코더/HW(C/D), 차량 스토리지 언급도 있음
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11459897
- **Type**: conference
- **Published**: 23-24 Aug.
...
- **Status**: ✅
- **Reason**: min-sum/MPA용 quasi-uniform 양자화로 동적범위 개선+HW 비용 절감 — 메시지 양자화 기법 NAND LDPC 디코더에 이식 가능(C/D), 애매하나 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11291843
- **Type**: conference
- **Published**: 22-24 Aug.
...
- **Status**: ✅
- **Reason**: 새 bit-flipping 디코더: refined checksum weighting + flip count 통합으로 루프 억제, BP 근접 — 이식 가능 새 디코더(C). NAND BF 디코딩과 직결.
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11151954
- **Type**: conference
- **Published**: 20-22 Aug.
...
- **Status**: ✅
- **Reason**: NAND 플래시 저장장치용 초저전력 bit-flipping LDPC 디코더(ULPBF) — NAND 직접(A) + 새 디코더(C/D).
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11449331
- **Type**: conference
- **Published**: 20-22 Aug.
...
- **Status**: ✅
- **Reason**: QC SC-LDPC 고girth·소형 lifting 계층적 구성 알고리즘 — 새 바이너리 코드 설계(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154552
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: Reed-Solomon에서 유도한 바이너리 QC-LDPC 부호의 새 대수적 구성·파라미터/최소거리 bound 제시 — 이식 가능 코드 설계(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154644
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: 층화 BP 디코딩 스케줄러 최적화로 throughput·error-rate 개선 — LDPC 디코더 알고리즘 새 기여, NAND 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154636
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: deep unfolding·학습형 damping 파라미터로 BP 개선한 LDPC 디코더 — 이식 가능 디코더(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154547
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: LDPC용 ADMM 디코딩을 mixed-integer 최적화로 확장한 새 디코더 — 바이너리 LDPC 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154578
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: QLDPC지만 고전 Margulis 유래·표준 min-sum 디코딩, girth 6/8 제어 2BGA 구성법이 바이너리 LDPC에 이식 가능(E) — 애매하여 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154487
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: 패리티검사행렬 중복으로 stopping set 제거하는 신드롬 디코딩 — 고전 바이너리 LDPC에서 유래한 redundancy 기법, 이식 가능(C/E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154620
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: 비트플리핑 디코더에 강화학습 action-list 적용, 코드 무관 일반 기법 — 바이너리 LDPC 비트플립 디코더로 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154588
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: 단척 LDPC 다중라운드 BP에서 VN 선택을 학습하는 신경망 디코더 — 이식 가능 디코더(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154498
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: ScED(부호집합 앙상블 디코딩)는 LDPC 발 기법; 본 논문은 polar 확장이나 ScED 자체가 바이너리 LDPC 디코더 기법으로 애매하므로 살림(Phase3 재검토)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154484
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: 프로토그래프 SC-LDPC의 fractional doping으로 DEP 완화 — 새 바이너리 코드 설계 기법(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11154543
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: LDPC 디코더 신뢰도를 융합한 결합 위상추정·반복복호(WNSSP) 제안 — BP 개선형 디코더 변형, 이식 가능성(C) 여지로 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11296777
- **Type**: conference
- **Published**: 18-22 Aug.
...
- **Status**: ✅
- **Reason**: 5G LDPC 디코더 soft-decision 입력용 멀티비트 적응 양자화 기법 — NAND LLR 양자화(A)에 이식 가능성, 애매하므로 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11199443
- **Type**: conference
- **Published**: 15-17 Aug.
...
- **Status**: ✅
- **Reason**: 낮은 인코딩 복잡도의 girth-8 QC-LDPC 새 구성(구조적 shaping, 대칭/역구조) — E 이식 가능 바이너리 코드 설계
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11148129
- **Type**: conference
- **Published**: 10-13 Aug.
...
- **Status**: ✅
- **Reason**: girth-8 QC-LDPC 새 구성 알고리즘(product-like exponent matrix, RA 기법)으로 error floor 개선 — E 이식 가능 코드 설계
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11148120
- **Type**: conference
- **Published**: 10-13 Aug.
...
- **Status**: ✅
- **Reason**: 층화 LDPC 복호 + 연합전이학습으로 error floor 완화하는 2단계 디코딩 — 이식 가능 디코더 기법(C), error floor 개선
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11244494
- **Type**: conference
- **Published**: 10-13 Aug.
...
- **Status**: ✅
- **Reason**: BP-ORBOSD: BP+OSD 변형 디코더로 재인코딩 오버헤드 감소, 정규화 인자 적용 — 이식 가능 디코더 알고리즘(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11148135
- **Type**: conference
- **Published**: 10-13 Aug.
...
- **Status**: ✅
- **Reason**: QC-SC-LDPC girth-8 구성, GCD 프레임워크로 6-cycle 제거하는 새 구성법 — 이식 가능 바이너리 코드 설계(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11148217
- **Type**: conference
- **Published**: 10-13 Aug.
...
- **Status**: ✅
- **Reason**: 플래시 메모리 채널 대상 적응형 정규화 Min-Sum 디코딩(동적 정규화 인자) — 이식 가능 디코더 알고리즘(C), NAND 직접 언급
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11149292
- **Type**: conference
- **Published**: 10-13 Aug.
...
- **Status**: ✅
- **Reason**: LDPC 그래프 단주기 카운팅 고속 메시지패싱 알고리즘(FMPA) — 사이클 제거/코드 설계 도구로 E 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:11148122
- **Type**: conference
- **Published**: 10-13 Aug.
...
- **Status**: ✅
- **Reason**: Margin-Propagation 아날로그 LDPC 디코더 회로 자동합성/HW 구현 — 이식 가능 HW 아키텍처(D), 애매하나 살림
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:11244472
- **Type**: conference
- **Published**: 10-13 Aug.

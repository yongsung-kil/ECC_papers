...
- **Status**: ✅
- **Reason**: BP guided decimation 디코더 — 바이너리/사진 BP 모두 적용 가능하다고 명시, 스태빌라이저 비의존 신뢰도 기반 decimation은 고전 바이너리 LDPC 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619083
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Hanwen Yao, Waleed Abu Laban, Christian Häger +2
- **PDF**: https://ieeexplore.ieee.org/document/10619083
...
- **Status**: ✅
- **Reason**: 새 girth-8 QC-LDPC 구성(vertical symmetry) 제시 — 카테고리 E 이식 가능 코드설계, 바이너리
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619229
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Guohua Zhang, Aijing Sun, Ling Liu +1
- **PDF**: https://ieeexplore.ieee.org/document/10619229
...
- **Status**: ✅
- **Reason**: QC-LDPC의 section-wise cyclic 구조 활용한 revolving NBP 디코더 — 5G LDPC에서 min-sum 능가하는 새 신경망 디코더 아키텍처(C/D), 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619193
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Qinshan Zhang, Bin Chen, Tianqu Zhuang +2
- **PDF**: https://ieeexplore.ieee.org/document/10619193
...
- **Status**: ✅
- **Reason**: BP+GNN 미분가능 반복 디코더 — 양자 LDPC 대상이나 고전 바이너리 BP에서 유래, 양자 전용 개념 비의존으로 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619589
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Anqi Gong, Sebastian Cammerer, Joseph M. Renes
- **PDF**: https://ieeexplore.ieee.org/document/10619589
...
- **Status**: ✅
- **Reason**: Gradient Flow 디코딩 일반화(텐서 연산·deep unfolding), 바이너리 LDPC 대상 새 디코더 알고리즘(C) — NAND 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619099
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Tadashi Wadayama, Lantian Wei
- **PDF**: https://ieeexplore.ieee.org/document/10619099
...
- **Status**: ✅
- **Reason**: Flash read 채널 write voltage/read threshold 최적화로 LDPC 디코딩 성능 향상 — NAND 플래시 직접(A)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619406
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Ava Asmani, Semira Galijasevic, Richard D. Wesel
- **PDF**: https://ieeexplore.ieee.org/document/10619406
...
- **Status**: ✅
- **Reason**: 다차원 spatially-coupled LDPC 코드 설계, GD 기반 short cycle 최소화 — 데이터 스토리지용 바이너리 SC-LDPC 코드 구성 기법(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619442
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Canberk İrimağzı, Ata Tanrıkulu, Ahmed Hareedy
- **PDF**: https://ieeexplore.ieee.org/document/10619442
...
- **Status**: ✅
- **Reason**: staircase 생성행렬 코드 + LC-ROSD(병렬 GE) 디코더 — OSD 변형 신규 디코더(C), 바이너리 BIOS 대상
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619485
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Qianfan Wang, Yixin Wang, Yiwen Wang +2
- **PDF**: https://ieeexplore.ieee.org/document/10619485
...
- **Status**: ✅
- **Reason**: Generalized QC-LDPC 코드 설계 및 효율적 인코딩(다항식 생성행렬 구성) — 바이너리 QC-LDPC 코드 설계/인코딩 기법 이식 가능(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619445
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Roxana Smarandache, Anthony Gómez Fonseca, David G. M. Mitchell
- **PDF**: https://ieeexplore.ieee.org/document/10619445
...
- **Status**: ✅
- **Reason**: GNN 기반 결합 등화·디코딩, Tanner 그래프 기반 신경망 디코더 + parallel flooding schedule = 이식 가능한 새 디코더 알고리즘(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619122
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Jannis Clausius, Marvin Geiselhart, Daniel Tandler +1
- **PDF**: https://ieeexplore.ieee.org/document/10619122
...
- **Status**: ✅
- **Reason**: (v,w)-regular 코드의 2-iteration bit-flipping 디코더 DFR 추정 기법 — 새 해석/디코더 분석으로 LDPC 디코더 설계(C/E)에 이식 가능. post-quantum 암호 응용이나 기법 자체는 고전 바이너리 LDPC bit-flipping 유래
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619629
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Alessandro Annechini, Alessandro Barenghi, Gerardo Pelosi
- **PDF**: https://ieeexplore.ieee.org/document/10619629
...
- **Status**: ✅
- **Reason**: bit-flipping 알고리즘의 디코딩 실패율을 위한 pseudoredundancy 분석 — BF 디코더는 LDPC 경연판정 디코더로 NAND ECC 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10619249
- **Type**: conference
- **Published**: 7-12 July 
- **Authors**: Jens Zumbrägel
- **PDF**: https://ieeexplore.ieee.org/document/10619249
...
- **Status**: ✅
- **Reason**: 5G NR 단부호 기반 SC-LDPC 신규 구성 + 저복잡도 슬라이딩윈도우 디코딩, 바이너리 ECC 코드설계 기여(E/C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10657015
- **Type**: conference
- **Published**: 23-25 July
- **Authors**: Abdoul-Hadi Konfé, Pasteur Poda, Raphaël Le Bidan
- **PDF**: https://ieeexplore.ieee.org/document/10657015
...
## Code-Aware Anti-Jamming Method for FHSS Systems: Leveraging Diversity Combination

- **Status**: ✅
- **Reason**: FFH용 저복잡도 LDPC code-aware diversity combining + triple-LLR threshold 검출 — 새 LLR 결합/검출 디코더 기법이 바이너리 LDPC에 이식 가능(C), 애매하나 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10636420
- **Type**: conference
- **Published**: 17-19 July
- **Authors**: Yuchen Xu, Yunzhu Xian, Jiaxuan Li +2
- **PDF**: https://ieeexplore.ieee.org/document/10636420
- **Abstract**: Frequency hopping spread spectrum (FHSS) systems exhibit exceptional resilience against jamming through the utilization of time-frequency diversities, which, when coupled with near-Shannon limit channel codes, yield favorable performance outcomes. The coherently combined and decoded signals at the receiver effectively eliminate the impact of partial-band jamming. This letter proposes a novel low complexity low-density parity-check (LDPC) code-aware diversity combining anti-jamming (LCA-DCAJ) method for fast frequency hopping (FFH) systems. Our approach seamlessly integrates multidimensional (time-frequency) diversities, FFH strategies, and LDPC coding techniques, resulting in outstanding suppression of interference within the time-frequency domain. Addressing concerns over complexity, we propose a triple log-likelihood ratio (LLR) threshold detection algorithm to further streamline implementation procedures. Bit error rate (BER) and average processing delay (APD) analyses underscore the superiority of the proposed anti-jamming method, validating its effectiveness in practical scenarios.

## Design of Concatenated Product Codes with Spatially-Coupled LDPC Codes

- **Status**: ✅
- **Reason**: SC-LDPC와 product code 연접 신규 부호(PC-SC-LDPC), error-floor 10^-15 설계+인터리빙 — 이식 가능 코드설계 기여(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10639086
- **Type**: conference
- **Published**: 14-17 July
- **Authors**: Yuqing Ren, Yifei Shen, Emmanuel Boutillon +2
- **PDF**: https://ieeexplore.ieee.org/document/10639086
- **Abstract**: In this paper, we introduce a novel coding scheme that concatenates product codes with spatially-coupled low-density parity-check (SC-LDPC) codes, termed PC-SC-LDPC codes, for next-generation wireless (and wireline) communications. These codes exhibit significant performance improvement in both waterfall and error-floor regions, compared to conventional schemes. We further correct residual errors through tailored interleaving strategies. Numerical results demonstrate that our approach can achieve a 1.2 dB gain at a bit error rate (BER) target of 10−8. Moreover, we offer a semi-analytical approach to estimate that the error floor of our designed PC-SC-LDPC codes falls below 10−15.

## On the Design of LDPC-Based Error-Reducing Codes

- **Status**: ✅
- **Reason**: LDPC 기반 superposition 부호의 양자화 DE 절차+프로토그래프 최적화+error-floor 분석 — 이식 가능 코드설계 기여(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10639052
- **Type**: conference
- **Published**: 14-17 July
- **Authors**: Dawit Simegn, Kirill Andreev, Pavel Rybin +1
- **PDF**: https://ieeexplore.ieee.org/document/10639052
- **Abstract**: In this paper, we continue our investigation into the error-reducing properties of superposition codes started in Andreev, et al. (2023), where the focus was on Sparse Regression Codes (SPARCs) with Gaussian signals. However, despite their high performance, SPARCs are known to have noticeable limitations in their application due to their high decoding complexity. This prompted us to propose a Low-Density Parity Check (LDPC)-based superposition scheme with low-complexity Soft Successive Interference Cancellation (SIC) decoding. In this paper, we focus on such a scheme and perform a detailed analysis of it. We have developed a low-complexity quantized density evolution (DE) procedure for the proposed scheme under the SIC decoder to estimate the output bit error rate. It is shown that the obtained DE procedure quite accurately predicts the behavior of the considered LDPC-based superposition scheme. The procedure predicts not only the waterfall region, but also the error-floor region, which we assume to be caused by interference of component LDPC codes. This helps us to obtain highly optimized constructions of proto-graphs of LDPC code components and significantly improve the bit error rate performance of the whole construction. In addition, for the proposed scheme we have analyzed the output error count distribution, which is crucial for concatenated code constructions, where usually error-reducing codes are used as inner code. All numerical results and analysis are presented at the end of the paper.

## Weighted Residual Layered Belief Propagation for LDPC Decoding

- **Status**: ✅
- **Reason**: WR-LBP: 잔차 기반 동적 스케줄링 레이어드 BP 디코더 변형, 반복 수 감소 — NAND LDPC에 이식 가능한 새 디코더 기법(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10639097
- **Type**: conference
- **Published**: 14-17 July
- **Authors**: Hassan Touati, Rodrigo C. de Lamare
- **PDF**: https://ieeexplore.ieee.org/document/10639097
...
- **Status**: ✅
- **Reason**: GAED 전처리를 Tanner 그래프에 병합하는 개선된 BP 디코딩, 바이너리 LDPC 디코더 기법 — 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10639098
- **Type**: conference
- **Published**: 14-17 July
- **Authors**: Jonathan Mandelbaum, Sisi Miao, Nils Albert Schwendemann +2
- **PDF**: https://ieeexplore.ieee.org/document/10639098
...
- **Status**: ✅
- **Reason**: SSD 수명연장 위해 임계전압 낮춰 RBER 증가 대응, NAND 플래시 RBER/컨트롤러 직접 관련(A)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:10682645
- **Type**: conference
- **Published**: 1-3 July 2
- **Authors**: Zhaokang Ke, Dingyi Kang, Bo Yuan +2
- **PDF**: https://ieeexplore.ieee.org/document/10682645

# IEEE Xplore — 2019-09 (1차선별 통과)


## Optimal Search for Girth-8 Quasi Cyclic and Spatially Coupled Multiple-Edge LDPC Codes

- **Status**: ✅
- **Reason**: Girth-8 QC/SC-LDPC multiple-edge protograph 구성, lifting degree 하한 — 바이너리 코드설계 기법(E), NAND LDPC 구성에 이식 가능.
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8745471
- **Type**: journal
- **Published**: Sept. 2019
...
- **Status**: ✅
- **Reason**: 바이너리 LDPC 다단계 bit-flipping(SD+HD) 디코더, 적응적 stage-switching — 부호 비의존 디코더 알고리즘(C), NAND 하드결정에 이식 가능.
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8742682
- **Type**: journal
- **Published**: Sept. 2019
...
- **Status**: ✅
- **Reason**: Girth-8 QC-LDPC GCD 프레임워크 자동검증 + CPM 크기 신규 하한 — 바이너리 사이클/girth 코드설계 기법(E), NAND QC-LDPC에 이식 가능.
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8750852
- **Type**: journal
- **Published**: Sept. 2019
...
- **Status**: ✅
- **Reason**: LDPC ADMM 디코딩의 check polytope projection 고속 근사 알고리즘 — 디코더 알고리즘 기여(C), 바이너리 LDPC 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8752435
- **Type**: journal
- **Published**: Sept. 2019
...
- **Status**: ✅
- **Reason**: 고처리량 LDPC 디코더 HW(40nm, 메모리 스케줄링/HW 공유로 57% 절감) 포함 — SCMA 응용이나 LDPC 디코더 HW 기법 이식 가능(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8766141
- **Type**: journal
- **Published**: Sept. 2019
...
- **Status**: ✅
- **Reason**: EC-WOM 코드 — q-level 메모리 ECC, 고정밀 readout 없이 soft reliability 추출/soft-decision — NAND LLR 양자화에 이식 가능(B/C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8717691
- **Type**: journal
- **Published**: Sept. 2019
...
- **Status**: ✅
- **Reason**: SC-LDPC 그래프 체인 연결 신규 구성 — 디코딩 threshold·최소거리·유한길이 개선, 바이너리 코드 설계 이식 가능(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8718022
- **Type**: journal
- **Published**: Sept. 2019
...
- **Status**: ✅
- **Reason**: E/D: QC-LDPC 레이어드 디코딩에서 critical path를 쪼개는 새 셔플링 기법+Latin square QC-LDPC 구성, HW throughput 개선으로 NAND LDPC 디코더 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8904435
- **Type**: conference
- **Published**: 8-11 Sept.
...
- **Status**: ✅
- **Reason**: 5G LDPC용 DM-QBP 양자화 BP 디코더(LUT 기반 CN 업데이트+분해로 메모리 절감), 부호 비의존 디코더+HW 기법(C/D) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8905133
- **Type**: conference
...
- **Status**: ✅
- **Reason**: B/E: DNA 스토리지에 large block-length 바이너리 LDPC 단일 부호로 error+erasure 통합, insertion/deletion 처리 — 스토리지 LDPC 코드 설계 이식 가능성
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8919890
- **Type**: conference
...
- **Status**: ✅
- **Reason**: C/D: GPU 다중코어 BP 메시지 스케줄링(RnBP) 신규 기법 — ECC BP에 적용, 병렬 디코더 스케줄링으로 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8916366
- **Type**: conference
...
- **Status**: ✅
- **Reason**: FPGA로 LDPC convolutional 코드의 code length·girth·buffer 효과 분석 + HW 검증 — 이식 가능 HW/코드설계 기법(D/E). BCH는 외부 concatenation
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:9125510
- **Type**: conference
...
- **Status**: ✅
- **Reason**: 바이너리 raptor-like LDPC 반복디코딩에서 체크노드 연산 선택적 스킵 — 부호 비의존 복잡도저감 디코더 기법(C) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8891425
- **Type**: conference
...
- **Status**: ✅
- **Reason**: Tanner 그래프 상 gradient descent로 offset min-sum offset 최적화(딥러닝 BP) — 바이너리 LDPC BP에 직접 이식 가능 디코더 기법(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8891434
- **Type**: conference
- **Published**: 22-25 Sept
...
- **Status**: ✅
- **Reason**: 딥러닝 기반 LLR 손실 압축·양자화를 rate-1/2 LDPC에 적용, 양자화 손실 0.15dB 미만 — LLR 양자화(A)/이식 가능 디코더 전처리(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8902805
- **Type**: conference
- **Published**: 2-6 Sept. 
...
- **Status**: ✅
- **Reason**: 불규칙 LDPC 차수분포-최소거리 성장률 분석, 유한길이 코드설계 분석(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8903633
- **Type**: conference
...
- **Status**: ✅
- **Reason**: C. 디코더 초기화(LLR) 개선 — SP 디코더 채널 기반 LLR 초기화 기법, NAND 채널 LLR 추정에 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8882153
- **Type**: conference
...
- **Status**: ✅
- **Reason**: E. QC-LDPC 구조적 생성행렬·최소거리 상한 분석 — 바이너리 QC-LDPC 코드 설계 기법 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8893395
- **Type**: conference
- **Published**: 18-20 Sept
...
- **Status**: ✅
- **Reason**: C. OSD 복잡도 저감 — 신뢰기저 단순화·반복 SISO-OSD, 부호 비의존적 디코더 기법으로 이식 검토
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8893385
- **Type**: conference
- **Published**: 18-20 Sept
...
- **Status**: ✅
- **Reason**: C. 신규 디코더 — 채널정보 불필요한 GA 기반 병렬 LDPC 디코더, 부호 비의존적 BP 대안으로 이식 검토
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8882169
- **Type**: conference
- **Published**: 18-20 Sept
...
- **Status**: ✅
- **Reason**: E: cyclic group decomposition 기반 length/rate adaptive MET QC-LDPC 신규 구성, 바이너리 코드설계 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8884427
- **Type**: conference
...
- **Status**: ✅
- **Reason**: E: protograph sieving로 MET QC-LDPC 코드거리·사이클 개선하는 신규 바이너리 코드설계 기법, NAND 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8884381
- **Type**: conference
- **Published**: 13-16 Sept

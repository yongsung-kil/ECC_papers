# IEEE Xplore — 2018-10 (1차선별 통과)


## A Multi-Gb/s Frame-Interleaved LDPC Decoder With Path-Unrolled Message Passing in 28-nm CMOS

- **Status**: ✅
- **Reason**: 28nm CMOS LDPC 디코더 칩; Min-Sum, path-unrolled 메시지패싱, QC 구조 활용 HW 아키텍처 D 이식 가능
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8385174
- **Type**: journal
- **Published**: Oct. 2018
...
- **Status**: ✅
- **Reason**: 고율 QC-LDPC error-floor 저감 redecoding 기법(VN attenuation)으로 NAND LDPC에 직접 이식 가능한 코드설계/디코더(C/E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8434230
- **Type**: journal
- **Published**: Oct. 2018
...
- **Status**: ✅
- **Reason**: RLL 제약 LDPC 기록시스템에서 density/differential evolution으로 UEP LDPC 분포 최적화 - 바이너리 LDPC 코드 설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8425687
- **Type**: journal
- **Published**: Oct. 2018
...
- **Status**: ✅
- **Reason**: PBRL 프로토그래프 LDPC 코드설계(PEXIT 최적화, PEG 구성); 바이너리 LDPC 코드설계 E 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8336882
- **Type**: journal
- **Published**: Oct. 2018
...
- **Status**: ✅
- **Reason**: biregular bipartite Tanner 그래프 girth·short cycle 계수 계산법, error floor 관련 → 코드설계 E 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8225637
- **Type**: journal
- **Published**: Oct. 2018
...
- **Status**: ✅
- **Reason**: layered LDPC 디코딩 FBA 기반 dual-mode 디코더 HW(하드웨어 공유 a posteriori calculator) - 이식 가능 HW 아키텍처(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8574777
- **Type**: conference
- **Published**: 9-12 Oct. 
...
- **Status**: ✅
- **Reason**: P-LDPC anti-burst PEG lifting 알고리즘, 바이너리 코드설계 기법 이식 가능(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8599984
- **Type**: conference
- **Published**: 8-11 Oct. 
...
- **Status**: ✅
- **Reason**: 유한체 기반 QC-LDPC 신규 대수적 구성, 바이너리 코드설계 이식 가능(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8600012
- **Type**: conference
- **Published**: 8-11 Oct. 
...
- **Status**: ✅
- **Reason**: QC-LDPC 부분병렬 HW 인코더 아키텍처, NAND 이식 가능(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8599970
- **Type**: conference
- **Published**: 8-11 Oct. 
...
- **Status**: ✅
- **Reason**: NAND 플래시용 바이너리 LDPC VNBP-MP 디코더 직접 제안(A/C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8600003
- **Type**: conference
- **Published**: 8-11 Oct. 
...
- **Status**: ✅
- **Reason**: A. NAND 플래시 LDPC read latency 개선 위한 선택적 압축 스킴, RBER 저감 컨트롤러 기법
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8615667
- **Type**: conference
- **Published**: 7-10 Oct. 
...
- **Status**: ✅
- **Reason**: 불규칙 바이너리 LDPC의 Gallager A 디코딩 실패를 유발하는 새 Tanner 서브그래프(2-cycle) 구조 분석 — 코드설계 E(사이클 제거) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8664386
- **Type**: conference
- **Published**: 28-31 Oct.
...
- **Status**: ✅
- **Reason**: SC-irregular 바이너리 LDPC error floor 추정 — error floor/SC-LDPC 구성(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8664369
- **Type**: conference
- **Published**: 28-31 Oct.
...
- **Status**: ✅
- **Reason**: protograph LDPC와 marker의 구조적 결합·protograph 최적화로 insertion/deletion 채널 성능 개선; 바이너리 LDPC 코드설계 기법(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8664206
- **Type**: conference
- **Published**: 28-31 Oct.
...
- **Status**: ✅
- **Reason**: protograph block-error threshold 분석·자본근접 protograph 설계, 바이너리 채널 LDPC 코드설계/유한길이 기여(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8664240
- **Type**: conference
- **Published**: 28-31 Oct.
...
- **Status**: ✅
- **Reason**: syndrome loss 신경망 디코더 손실함수, 부호 비의존이며 short block code(LDPC 포함)에 이식 가능한 디코더 학습 기법(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8645388
- **Type**: conference
- **Published**: 28-31 Oct.
...
- **Status**: ✅
- **Reason**: Polar BP를 Tanner 그래프로 변환해 min-sum 신경망 디코더 학습—부호 비의존 BP/min-sum 가중치 기법이 바이너리 LDPC BP에 이식 가능(예외 C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8645372
- **Type**: conference
- **Published**: 28-31 Oct.
...
- **Status**: ✅
- **Reason**: C/D: 5G LDPC 디코더의 통합 재구성 가능 데이터패스(CN/VN 업데이트 분리·구성)와 FPGA 구현 — NAND LDPC HW에 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8605615
- **Type**: conference
- **Published**: 26-30 Oct.
...
- **Status**: ✅
- **Reason**: C/D: MCMC 기반 신규 LDPC 디코딩 알고리즘(BP 대비 1dB 개선)과 VLSI 아키텍처 — 바이너리 LDPC 디코더로 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8605692
- **Type**: conference
- **Published**: 26-30 Oct.
...
- **Status**: ✅
- **Reason**: 저복잡도 LDPC 디코더 FPGA 아키텍처(shift module 축소), 이식 가능 HW D
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8597812
- **Type**: conference
- **Published**: 26-30 Oct.
...
- **Status**: ✅
- **Reason**: E: superposition 구성 불규칙 QC-LDPC의 girth·단주기 최적화 마스킹 알고리즘 — 바이너리 코드 설계 기법으로 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8595774
- **Type**: conference
- **Published**: 26-29 Oct.
...
- **Status**: ✅
- **Reason**: LDPC loop-removing(사이클 제거) 알고리즘 제시 → 코드설계 E 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8596302
- **Type**: conference
- **Published**: 26-29 Oct.
...
- **Status**: ✅
- **Reason**: ARM상 LDPC 디코더 ILP·압축저장·프리페치 최적화; 이식 가능 HW/구현 기법(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8598307
- **Type**: conference
- **Published**: 21-24 Oct.
...
- **Status**: ✅
- **Reason**: 딥러닝 기반 OMS/SOMS min-sum 디코더; polar 대상이나 BP 기반 min-sum 변형으로 바이너리 LDPC BP에 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8598384
- **Type**: conference
- **Published**: 21-24 Oct.
...
- **Status**: ✅
- **Reason**: MD-SC LDPC 사이클 최적화 코드설계, 3D Flash 명시 — 바이너리 SC-LDPC 구성 이식 가능(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8635827
- **Type**: conference
- **Published**: 2-5 Oct. 2
...
- **Status**: ✅
- **Reason**: posterior 샘플링 기반 랜덤화 디코더(Gibbs/Metropolis), 부호 비의존 디코더 기법으로 바이너리 LDPC BP에 이식 검토 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8636049
- **Type**: conference
- **Published**: 2-5 Oct. 2
...
- **Status**: ✅
- **Reason**: Polar용 LUT-SMS 디코더지만 LDPC/Turbo LUT 기법 차용·min-sum 변형이며 부호 비의존 디코더 기법 이식 가능(C, 애매시 in)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8589421
- **Type**: conference
- **Published**: 19-21 Oct.
...
- **Status**: ✅
- **Reason**: degree별 NMS/선형근사 혼합 + 채널분산 추정 제거 곱셈인자 초기화; 이식 가능 LDPC 디코더 변형(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8555597
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ✅
- **Reason**: 심층강화학습+MCTS로 LDPC edge growth 코드 구성; 이식 가능 코드 설계(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8555714
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ✅
- **Reason**: deep learning 기반 통합 polar-LDPC 디코더; LDPC BP 신경망 디코더 부분 이식 가능(C), 애매하여 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8555891
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ✅
- **Reason**: QC-LDPC용 분산 CRC 조기종료 기법; 디코더 HW/throughput 개선 이식 가능(C/D)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8555687
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ✅
- **Reason**: QC/LDPC 디코더의 BPU(check/variable node) 로직복잡도 절감 아키텍처 - 이식 가능 HW(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8587568
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ✅
- **Reason**: NAND 플래시 LDPC 동적 기준전압 검출+LLR 갱신; A 카테고리 직접 해당
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8555666
- **Type**: conference
- **Published**: 18-20 Oct.
...
- **Status**: ✅
- **Reason**: RS 기반 + protograph QC-LDPC 구성으로 girth>=8 및 최소거리 상향 — 바이너리 코드설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:8539649
- **Type**: conference
- **Published**: 17-19 Oct.
...
- **Status**: ✅
- **Reason**: QC-LDPC 신규 인코더 HW(고속 vector-dense-matrix 곱셈, 회로공유)-D 이식 가능
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:8577709
- **Type**: conference
- **Published**: 12-14 Oct.

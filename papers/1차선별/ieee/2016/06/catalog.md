# IEEE Xplore — 2016-06 (1차선별 통과)


## Construction of Multiple-Rate QC-LDPC Codes Using Hierarchical Row-Splitting

- **Status**: ✅
- **Reason**: 다중률 바이너리 QC-LDPC를 위한 hierarchical row-splitting 신규 코드설계(E), HW 자원 공유
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7452367
- **Type**: journal
- **Published**: June 2016
...
- **Status**: ✅
- **Reason**: partial geometry 기반 QC-LDPC 신규 구성(바이너리)·trapping set·expander 분석으로 코드설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7355344
- **Type**: journal
- **Published**: June 2016
...
- **Status**: ✅
- **Reason**: 바이너리 LDPC용 ADMM penalized/reweighted LP 디코더 신규 알고리즘(C), BP 대비 개선
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7456284
- **Type**: journal
- **Published**: June 2016
...
- **Status**: ✅
- **Reason**: QC 제약 없이 SC-LDPC(LDPCC) syndrome former 직접 설계로 작은 constraint length + girth bound — 신규 바이너리 코드설계(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7901543
- **Type**: conference
...
- **Status**: ✅
- **Reason**: 유한정밀 min-sum용 code-aware quantizer 설계 + error floor용 양자화 최적화 — NAND LLR 양자화/min-sum에 직접 이식(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7901540
- **Type**: conference
- **Published**: 6-9 June 2
...
- **Status**: ✅
- **Reason**: irregular QC-LDPC 구성으로 error floor 제거(BER 10^-10), 카테고리 E 코드설계 이식 가능.
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7788012
- **Type**: conference
- **Published**: 5-10 June 
...
- **Status**: ✅
- **Reason**: SIMD 적응형 양자화 LDPC 디코더 FPGA 구현(1/2/4bit 다중 양자화·가변 throughput), 이식 가능 HW/양자화 기법(C/D)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7760912
- **Type**: conference
...
- **Status**: ✅
- **Reason**: 바이너리 regular random LDPC FPGA 인코더/디코더 HW 구현(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:7589691
- **Type**: conference
...
- **Status**: ✅
- **Reason**: LDPC SPA용 비균일 LLR 양자화(3-bit), NAND LLR 양자화에 직접 이식 가능(A/C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7589702
- **Type**: conference
- **Published**: 17-19 June
...
- **Status**: ✅
- **Reason**: self-orthogonal code에 min-sum 적용 + MTD/min-sum 결합 디코더 제안, 바이너리 LDPC min-sum 변형으로 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7525744
- **Type**: conference
...
- **Status**: ✅
- **Reason**: LDPC UMP-APP self-correction 디코딩(불신뢰 메시지 소거 변형), 바이너리 LDPC 디코더 개선(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7525774
- **Type**: conference
- **Published**: 12-16 June
...
- **Status**: ✅
- **Reason**: 유한길이 SC-LDPC rate loss 분석(E) — 바이너리 SC-LDPC 코드설계 유한길이 통찰 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7521994
- **Type**: conference
...
- **Status**: ✅
- **Reason**: horizontal shuffled min-sum의 가변 LLR 스케일링 GMI 기반 인자 선택(C) — 바이너리 LDPC BP에 이식 가능한 디코더 개선
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7521937
- **Type**: conference
- **Published**: 1-3 June 2

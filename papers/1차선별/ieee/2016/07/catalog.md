# IEEE Xplore — 2016-07 (1차선별 통과)


## A Combined Algebraic- and Graph-Based Method for Constructing Structured RC-LDPC Codes

- **Status**: ✅
- **Reason**: 대수+그래프 결합으로 QC 구조 RC-LDPC 신규 구성법(masking matrix, PEXIT); 바이너리 QC-LDPC 코드설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7458815
- **Type**: journal
- **Published**: July 2016
- **Authors**: Xijin Mu, Conghui Shen, Baoming Bai
- **PDF**: https://ieeexplore.ieee.org/document/7458815
...
- **Status**: ✅
- **Reason**: replacement product 기반 QC cycle LDPC 재귀 구성, girth 6 보장 — 신규 바이너리 QC-LDPC 코드설계(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7546443
- **Type**: conference
- **Published**: 6-8 July 2
- **Authors**: Jiayi Huang, Xue-Qin Jiang, Xiao-Dong Zhang +2
- **PDF**: https://ieeexplore.ieee.org/document/7546443
...
- **Status**: ✅
- **Reason**: QC-LDPC 인코더 FPGA 아키텍처(병렬 구현, non-power-of-2 circulant 처리)=이식 가능 HW(D)
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: ieee:7604689
- **Type**: conference
- **Published**: 4-6 July 2
- **Authors**: Dimitris Theodoropoulos, Nektarios Kranitis, Antonios Paschalis
- **PDF**: https://ieeexplore.ieee.org/document/7604689
...
- **Status**: ✅
- **Reason**: LDPC 부호 distance verification 알고리즘 — 코드 설계/분석 기법(E), 바이너리 LDPC 대상
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7541755
- **Type**: conference
- **Published**: 10-15 July
- **Authors**: Ilya Dumer, Alexey A. Kovalev, Leonid P. Pryadko
- **PDF**: https://ieeexplore.ieee.org/document/7541755
...
- **Status**: ✅
- **Reason**: LDPC PEG 기반 bit-mapping 설계, PEG/Tanner 그래프 코드설계 기법(E) 이식 가능성→살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7541675
- **Type**: conference
- **Published**: 10-15 July
- **Authors**: Junyi Du, Jinhong Yuan, Liang Zhou +1
- **PDF**: https://ieeexplore.ieee.org/document/7541675
...
- **Status**: ✅
- **Reason**: BP+list erasure 디코더로 ML 근접하는 저복잡도 바이너리 LDPC 디코딩 알고리즘 — 이식 가능 디코더(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7541790
- **Type**: conference
- **Published**: 10-15 July
- **Authors**: Irina E. Bocharova, Boris D. Kudryashov, Vitaly Skachek +1
- **PDF**: https://ieeexplore.ieee.org/document/7541790
...
- **Status**: ✅
- **Reason**: LDPC trapping redundancy 상계 - 반복 디코딩용 패리티검사 행렬 설계(trapping set 회피) 코드설계 기법(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:7541598
- **Type**: conference
- **Published**: 10-15 July
- **Authors**: Yu Tsunoda, Yuichiro Fujiwara
- **PDF**: https://ieeexplore.ieee.org/document/7541598

# arXiv — 2008-11 (1차선별 통과)


## Computation of Grobner basis for systematic encoding of generalized quasi-cyclic codes

- **Status**: ✅
- **Reason**: FG LDPC 등 systematic 인코딩용 Grobner basis 알고리즘 + LFSR 기반 serial 인코더 아키텍처(2n 가산기/메모리) — 바이너리 LDPC 인코더 HW 이식 가능(D/E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:0811.4033v1
- **Type**: preprint
- **Published**: 2008-11-25
- **Authors**: Vo Tam Van, Hajime Matsui, Seiichi Mita
- **PDF**: https://arxiv.org/pdf/0811.4033v1

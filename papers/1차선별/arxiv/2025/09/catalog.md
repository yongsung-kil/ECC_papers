...
- **Status**: ✅
- **Reason**: Reconfigurable rate-memory-compatible SC-LDPC code design with cycle-count optimization; explicitly targets storage aging, new binary code construction (E).
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2509.21112v3
- **Type**: preprint
- **Published**: 2025-09-25
- **Authors**: Bade Aksoy, Doğukan Özbayrak, Ahmed Hareedy
- **PDF**: https://arxiv.org/pdf/2509.21112v3
...
- **Status**: ✅
- **Reason**: Linear-complexity algorithm to compute code distance and minimum trapping sets for binary LDPC with bounded treewidth; portable error-floor/code-design analysis tool (E).
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2509.13040v2
- **Type**: preprint
- **Published**: 2025-09-16
- **Authors**: Qingqing Peng, Ke Liu, Guiying Yan +1
- **PDF**: https://arxiv.org/pdf/2509.13040v2
...
- **Status**: ✅
- **Reason**: 하드웨어 가속 LDPC 디코딩(ACC100 eASIC) 스케줄링·자원할당 시스템; 이식 가능 HW 운용 기법 존재 가능성 (D), 애매하여 in
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: arxiv:2509.04625v2
- **Type**: preprint
- **Published**: 2025-09-04
- **Authors**: Zhenzhou Qi, Chung-Hsuan Tung, Zhihui Gao +1
- **PDF**: https://arxiv.org/pdf/2509.04625v2

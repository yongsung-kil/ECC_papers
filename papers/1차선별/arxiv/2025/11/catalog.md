# arXiv — 2025-11 (1차선별 통과)


## TransCoder: A Neural-Enhancement Framework for Channel Codes

- **Status**: ✅
- **Reason**: LDPC 포함 신경망 디코더 향상 프레임워크(TransCoder) — 이식 가능 디코더 알고리즘(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2511.22539v1
- **Type**: preprint
- **Published**: 2025-11-27
- **Authors**: Anastasiia Kurmukova, Selim F. Yilmaz, Emre Ozfatura +1
- **PDF**: https://arxiv.org/pdf/2511.22539v1
...
- **Status**: ✅
- **Reason**: 바이너리 block MDS QC-LDPC 신규 구성·4-cycle 회피 조건 — 코드 설계(E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2511.22183v1
- **Type**: preprint
- **Published**: 2025-11-27
- **Authors**: Hongwei Zhu, Xuantai Wu, Jingjie Lv +2
- **PDF**: https://arxiv.org/pdf/2511.22183v1
...
- **Status**: ✅
- **Reason**: 고전 LDPC 디코더의 CPU/GPU/ASIC 가속 벤치마킹 — HW 구현/병렬화 관점 이식 가능(D), 애매하므로 살림
- **알고리즘 기여**: 🔧 하드웨어 수정만
- **ID**: arxiv:2511.02952v1
- **Type**: preprint
- **Published**: 2025-11-04
- **Authors**: Zhenzhou Qi, Yuncheng Yao, Yiming Li +4
- **PDF**: https://arxiv.org/pdf/2511.02952v1
...
- **Status**: ✅
- **Reason**: MBBP-LD 리스트 디코더가 고전 cyclic LDPC에서 유래, BP 후처리/결정규칙 개선 — 고전 BP 디코더 기법 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2511.02951v1
- **Type**: preprint
- **Published**: 2025-11-04
- **Authors**: Sheida Rabeti, Hessam Mahdavifar
- **PDF**: https://arxiv.org/pdf/2511.02951v1

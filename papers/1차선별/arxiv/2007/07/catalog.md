# arXiv — 2007-07 (1차선별 통과)


## Use of a $d$-Constraint During LDPC Decoding in a Bliss Scheme

- **Status**: ✅
- **Reason**: RLL d-constraint 노드를 팩터그래프에 추가하는 LDPC 디코딩 변형 — 제약노드 메시지패싱 기법 이식 가능(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:0707.3925v1
- **Type**: preprint
- **Published**: 2007-07-26
- **Authors**: Andries P. Hekstra
- **PDF**: https://arxiv.org/pdf/0707.3925v1

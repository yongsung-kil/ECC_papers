# arXiv — 2021-08 (1차선별 통과)


## KO codes: Inventing Nonlinear Encoding and Decoding for Reliable Wireless Communication via Deep-learning

- **Status**: ✅
- **Reason**: KO codes — 신경망 기반 비선형 (encoder,decoder) 설계; 신경망 디코더 기법(C)으로 이식 검토 여지, 애매하여 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:2108.12920v1
- **Type**: preprint
- **Published**: 2021-08-29
- **Authors**: Ashok Vardhan Makkuva, Xiyang Liu, Mohammad Vahid Jamali +3
- **PDF**: https://arxiv.org/pdf/2108.12920v1

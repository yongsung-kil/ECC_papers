# arXiv — 2009-02 (1차선별 통과)


## On the Dynamics of the Error Floor Behavior in (Regular) LDPC Codes

- **Status**: ✅
- **Reason**: regular LDPC error floor/absorption set 동역학 분석으로 정확한 error floor 예측(E), NAND 핵심인 error floor 코드설계에 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:0902.1786v2
- **Type**: preprint
- **Published**: 2009-02-11
- **Authors**: Christian Schlegel, Shuai Zhang
- **PDF**: https://arxiv.org/pdf/0902.1786v2

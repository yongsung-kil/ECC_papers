# arXiv — 2022-06 (1차선별 통과)


## Reducing the Error Floor of the Sign-Preserving Min-Sum LDPC Decoder via Message Weighting of Low-Degree Variable Nodes

- **Status**: ✅
- **Reason**: Sign-preserving min-sum 디코더의 저차수 변수노드 message weighting으로 error floor 3자릿수 개선 — 이식 가능 min-sum 변형(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
...
- **Status**: ✅
- **Reason**: 딥러닝 기반 LDPC 디코더를 포함한 무선 트랜시버 — 신경망 디코더(C)가 떼어낼 만한 기법일 수 있어 애매하므로 살려 Phase 3 재검토
- **알고리즘 기여**: ✅ 알고리즘/코드 기여

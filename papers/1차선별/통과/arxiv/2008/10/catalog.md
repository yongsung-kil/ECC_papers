# arXiv — 2008-10 (1차선별 통과)


## Low-Density Parity-Check Codes Which Can Correct Three Errors Under Iterative Decoding

- **Status**: ✅
- **Reason**: column-weight 3/4 바이너리 LDPC가 3오류 정정하는 충분조건 + 구성 기법 — 하드디시전 메시지패싱 디코더/코드설계 이식 가능(C/E)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:0810.1105v1
- **Type**: preprint
- **Published**: 2008-10-07
- **Authors**: Shashi Kiran Chilappagari, Anantha Raman Krishnan, Bane Vasic +1
- **PDF**: https://arxiv.org/pdf/0810.1105v1

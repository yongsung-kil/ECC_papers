...
- **Status**: ✅
- **Reason**: C: QC-LDPC용 저복잡도 near-ML 디코딩 알고리즘 신규 제안, BEC 기반이나 바이너리 LDPC 디코더로 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:1709.01455v3
- **Type**: preprint
- **Published**: 2017-09-05
- **Authors**: Irina E. Bocharova, Boris D. Kudryashov, Vitaly Skachek +2
- **PDF**: https://arxiv.org/pdf/1709.01455v3
...
- **Status**: ✅
- **Reason**: E: QC-LDPC lifting degree 하한과 girth 6/10/12 구성 기법, 바이너리 QC-LDPC 코드설계에 직접 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:1709.00825v1
- **Type**: preprint
- **Published**: 2017-09-04
- **Authors**: Farzane Amirzade, Mohammad-Reza Sadeghi
- **PDF**: https://arxiv.org/pdf/1709.00825v1

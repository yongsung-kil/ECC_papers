# arXiv — 2015-07 (1차선별 통과)


## Triggering Wave-Like Convergence of Tail-biting Spatially Coupled LDPC Codes

- **Status**: ✅
- **Reason**: tail-biting SC-LDPC의 termination rate-loss 저감을 위한 random shortening 신규 구성 — 바이너리 SC-LDPC 코드설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: arxiv:1507.01970v2
- **Type**: preprint
- **Published**: 2015-07-07
- **Authors**: Sebastian Cammerer, Vahid Aref, Laurent Schmalen +1
- **PDF**: https://arxiv.org/pdf/1507.01970v2

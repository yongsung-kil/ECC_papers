# arXiv — 2024-10 (1차선별 통과)


## A Comparative Study of Ensemble Decoding Methods for Short Length LDPC Codes

- **Status**: ✅
- **Reason**: 단길이 LDPC BP 개선을 위한 앙상블 디코딩(MBBP/AED/SED 등) 비교 — 이식 가능 디코더 알고리즘(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
...
- **Status**: ✅
- **Reason**: 팩터그래프 기반 아날로그 LDPC 디코더 자동 합성 툴킷 — 이식 가능 디코더 HW 합성 기법(C/D), 애매하나 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
...
- **Status**: ✅
- **Reason**: 가중 잔차 계층 BP(WR-LBP) — 반복 수 감소 위한 정보 기반 동적 스케줄링 디코더, 이식 가능 디코더 개선(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
...
- **Status**: ✅
- **Reason**: QC-MDPC Tanner gra프 4-cycle 열거·필터링 기법, 일반 parity-check 코드에 적용 가능하다고 명시 — 사이클 제거/girth 코드설계(E)로 이식 가능, 애매하나 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
...
- **Status**: ✅
- **Reason**: 고전 LDPC 사이클 분석 도구 차용한 신규 8-cycle 카운팅·girth 하한 기법 — 코드설계(E) 이식 가능성, 3-layer 구조 종속이라 애매하나 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여

# IEEE Xplore — 2014-04 (1차선별 통과)


## Deterministic Girth-Eight QC-LDPC Codes with Large Column Weight

- **Status**: ✅
- **Reason**: 결정론적 girth-8 QC-LDPC 구성, 기존 CPM 크기 한계 개선 + J≥7 첫 체계적 구성 — 바이너리 코드설계(E) 이식 가능
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6763131
- **Type**: journal
- **Published**: April 2014
- **Authors**: Jianhua Zhang, Guohua Zhang
- **PDF**: https://ieeexplore.ieee.org/document/6763131
...
- **Status**: ✅
- **Reason**: PAPR용이나 신규 IS-LDPC 부호족 + 수정 PEG 구성 알고리즘 제시 — 바이너리 LDPC 코드설계(E) 이식 가능, 애매하나 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6775375
- **Type**: journal
- **Published**: April 2014
- **Authors**: Daiming Qu, Li Li, Tao Jiang
- **PDF**: https://ieeexplore.ieee.org/document/6775375
...
- **Status**: ✅
- **Reason**: GLDPC(LDPC-BCH) 신규 구성 + APP fast BCH transform 기반 저복잡도 메시지패싱 디코딩 — 이식 가능 디코더(C)/GLDPC 구성, 애매하나 살림
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6787374
- **Type**: journal
- **Published**: April 2014
- **Authors**: Qi Li, Xinru Qu, Liuguo Yin +1
- **PDF**: https://ieeexplore.ieee.org/document/6787374
...
- **Status**: ✅
- **Reason**: 바이너리 LDPC용 신규 two-bit bit-flipping 알고리즘 + trapping set 기반 failure 분석, 저 error floor — 디코더 신규 기여(C)
- **알고리즘 기여**: ✅ 알고리즘/코드 기여
- **ID**: ieee:6750416
- **Type**: journal
- **Published**: April 2014
- **Authors**: Dung Viet Nguyen, Bane Vasic
- **PDF**: https://ieeexplore.ieee.org/document/6750416
